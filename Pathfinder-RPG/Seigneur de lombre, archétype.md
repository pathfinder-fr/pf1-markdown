...
à volonté – *[rayon de fièvre](./Rayon de fièvre.md)* ; 3/jour – *[convocation d’ombres](./Convocation dombres.md)*, *[pas de l’ombre](./Pas de lombre.md)* ; 1/jour – *[convocation d’ombres suprême](./Convocation dombres suprême.md)* (si le seigneur de l’ombre possède 11 dés de vie ou plus), *[traversée des ombres](./Traversée des ombres.md)*.
Une créature créée avec les sorts convocation d’ombres ou convocation d’ombre suprême et qui devrait normalement posséder l’archétype de créature céleste ou fiélone (tel qu’un ours) gagne à la place l’[archétype créature de l’ombre](./Archétypes.md#Créature_de_l’ombre_FP_+B_2).
...
</td><td><div>Voir aussi l'archétype [créature de l'ombre](./Archétypes.md#CREATUREDELOMBRE) et l'exemple : l'[Enlaceur de l'ombre](./enlaceur de lombre.md)
