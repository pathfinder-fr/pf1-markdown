---
Name: Pathfinder-RPG.Ancre dombre
Title: Ancre d'ombre
LastModified: 2022-12-17 18:34
Categories:
- Règle officielle
- Sort
- Sort barde 2
...
La cible reçoit un malus de -1 pour chaque tranche de 1,5 mètre (1 {s:c}) de distance la séparant de sa case d’ancrage. Si elle échoue à son test, son déplacement est gâché et elle ne peut plus aller plus loin. Si elle échoue de 10 ou plus, elle est ramenée de 1,5 mètre (1 {s:c}) en direction de la case d’ancrage et tombe [[à terre]]. Si elle réussit son test de 10 ou plus, le sort prend fin. Ce sort ne fonctionne pas sur les créatures ne projetant aucune ombre ni reflet. Si la cible utilise un effet de [[branche téléportation|téléportation]] ou quitte le [[Plans|plan]] sur lequel elle se trouve, le sort prend fin.
