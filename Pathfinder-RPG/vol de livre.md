---
Name: Pathfinder-RPG.vol de livre
Title: vol de livre
LastModified: 2020-02-15 15:04
Categories:
- Sort
- Sort barde 3
- Sort inquisiteur 3
...
En procédant de la sorte, les pages originales sont effacées, bien que leur couverture et la reliure restent inchangées. Les différences de taille entre l'original et la copie vierge sont indifférents bien que le support de destination de la copie transférée doive être d'une taille équivalente ou supérieure (en nombre de pages ou centimètre de parchemin) ou alors tout ce qui dépasse la taille du document est perdu pour toujours.
