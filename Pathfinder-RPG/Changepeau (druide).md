---
Name: Pathfinder-RPG.Changepeau (druide)
Title: Changepeau
LastModified: 2023-01-16 23:56
Categories:
- Archétype
- Archétype druide
...
Au niveau 4, un changepeau gagne la capacité de se transformer en n'importe quel humanoïde de taille P ou M et de reprendre sa forme normale une fois par jour. Cette capacité fonctionne comme *[[modification dapparence|modification d'apparence]]*, avec les exceptions suivantes. L'effet dure 1 heure par niveau de druide, ou jusqu'à ce qu'il reprenne sa forme normale. Changer de forme est une [[action simple]] qui ne provoque pas d'[[AO|attaque d'opportunité]]. Le changepeau doit être familier avec la forme qu'il choisit. Il peut utiliser cette compétence une fois de plus par jour au niveau 6 et tous les 2 niveaux de druide par la suite, jusqu'à un total de huit fois au niveau 18. Au niveau 20, il peut utiliser changement de peau à volonté.

Le changepeau apprend intuitivement à utiliser son corps comme une arme. Lorsqu'il utilise changement de peau, il obtient les avantages du don [[Science du combat à mains nues]], et ses [[attaque à mains nues|attaques à mains nues]] infligent des dégâts comme s'il était un [[moine]] avec un niveau de moine égal à son niveau de druide - 3.
...
Au niveau 8, un changepeau peut imiter les créatures humanoïdes avec encore plus de précision. Il gagne n'importe laquelle des capacités suivantes si la forme qu'il adopte les possèdent : [[Férocité (capacité)|férocité]], [[Demi-orque#FEROCITEORQUE|férocité orque]], [[Odorat (capacité)|odorat]], [[Retenir son souffle (capacité)|retenir son souffle]], [[Vision dans le noir (capacité)|vision dans le noir]] (27 m), [[Vision nocturne (capacité)|vision nocturne]], vitesse d'escalade (18 m), vitesse de nage (18 m) et vitesse de vol (18 m, bonne). Si la forme qu'il adopte possède le sous-type [[sous-type Aquatique|aquatique]], il obtient le sous-type aquatique et la particularité [[Amphibie (capacité)|amphibie]].
...
Cette capacité remplace [[Druide#FORMEANIMALE|forme animale]].

#### Métamorphose éclair (Sur)
Au niveau 13, un changepeau apprend à changer de forme extrêmement vite. Il peut utiliser changement de peau par une [[action rapide]]. Cette capacité remplace [[Druide#MILLEVISAGES|mille visages]].
