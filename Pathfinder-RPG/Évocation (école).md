...
{s:MenuÉcoles}{s:Desambi|Plus d'information sur les sorts de cette école [[Présentation des sorts#EVOCATION|ici]].}*Les évocateurs s’intéressent à la puissance brute de la magie et parviennent à l’utiliser pour créer ou détruire avec une aisance déconcertante.*
...
**Projectile de force (Mag).** Par une [[action simple]], l’évocateur peut créer un projectile de force qui touche automatiquement sa cible, comme un *[[projectile magique]]*. Le projectile de force inflige 1d4 points de dégâts en plus du bonus découlant du pouvoir de sorts intenses. Il s’agit d’un [[intangible|effet de force]]. Chaque jour, l’évocateur peut utiliser cette capacité un nombre de fois égal à 3 + son modificateur d’[[Intelligence]].
