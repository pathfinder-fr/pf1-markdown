...
**Avantages uniques.** Cette section détaille les avantages que les PJs peuvent obtenir de l'organisation en plus de ceux listés dans la section [[Influence organisationnelle#AVANTAGESCOMMUNS|Avantages communs]].
...
{s:BDSorts|**Greedy Jenny** ([[humain]] <nowiki>[[</nowiki>f<nowiki>]]</nowiki> [[ensorceleur]] 1, LM}
{s:BDSorts|**Martin Quickfingers** ([[halfelin]] [[roublard]] 2, CN}
...
{s:BDSorts|*Case.* Un groupe de voleurs examine une zone, à la recherche de gardes, de cachettes et d'entrées. Le bonus total en [[Perception]] des voleurs est de +6.}
{s:BDSorts|*Diversion.* Un groupe de voleurs crée une diversion pour permettre aux PJs de se faufiler entre les gardes ou autres yeux vigilants. Le bonus total en [[Bluff]] des voleurs est de +6.}
{s:BDSorts|*Pickpocket.* Un voleur tente de prendre un objet spécifique à une personne spécifique. Le bonus total du voleur en [[Escamotage]] est de +8. Si le voleur estime que la situation est trop dangereuse, il en informe les PJs et refuse de tenter la tâche - dans ce cas, la faveur n'est pas dépensée.}
{s:BDSorts|*Vigie.* Un voleur agit comme un guetteur, surveillant un chemin à l'affut des gardes ou des témoins qui y passent. Le bonus total en [[Perception]] du voleur est de +6.}
</div>
...
{s:BDTexte|**Membres clés.** }
{s:BDSorts|**Chef** ([[demi-orque]] [[rôdeur]] 7, LM)}
{s:BDSorts|**Kalgeen** ([[humain]] [[rat-garou]] <nowiki>[[</nowiki>f<nowiki>]]</nowiki> [[roublard]] 5, LM)}
...
{s:BDTexte|**Limites d'influence.** Un PJ doit rejoindre officiellement la guilde des voleurs pour passer au rang 2. Pour monter au rang 4, les PJs doivent exécuter un casse complexe (voir [[Casses|Les Casses]]).}
...
{s:BDSorts|*Case.* Fonctionne comme l'avantage de la petite bande, sauf que le bonus total en [[Perception]] des voleurs est de +10.}
{s:BDSorts|*Diversion.* Fonctionne comme l'avantage de la petite bande, sauf que le bonus total en [[Bluff]] des voleurs est de +10.}
...
{s:BDSorts|*Pickpocket.* Fonctionne comme l'avantage de la petite bande, sauf que le bonus total en [[Escamotage]] des voleurs est de +12.}
...
{s:BDSorts|*Vigie.* Deux voleurs agissent comme des guetteurs, surveillant jusqu'à deux chemins à l'affut des gardes ou des témoins qui y passent. Le bonus total en [[Perception]] des voleurs est de +10.}
</div>
...
{s:BDTexte|**Membres clés.** }
{s:BDSorts|**Archimage Theona Tethril** ([[humain]] <nowiki>[[</nowiki>f<nowiki>]]</nowiki> [[magicien|devin]] 9, N)}
{s:BDSorts|**Maître des sceaux Falariel** ([[elfe]] [[magicien|abjurateur]] 7, NB)}
...
{s:BDSorts|*Bibliothèque érudite.* Les PJs ont accès à la bibliothèque de la guilde, ce qui leur permet d'apprendre des secrets pertinents pour leurs aventures actuelles (pensez à utiliser le système de [[Recherches|recherche des pages 148-153]] pour gérer les recherches dans la bibliothèque érudite).}
...
{s:BDTexte|**Membres clés.** }
{s:BDSorts|**Dame Alixis Drosain/Lyra** ([[humain]] <nowiki>[[</nowiki>f<nowiki>]]</nowiki> [[justicier]] 12, N/NM)}
{s:BDSorts|**Nikolas Trivoy** ([[humain]] [[enquêteur]] 7, N)}
{s:BDSorts|**Murmure** ([[humain]] <nowiki>[[</nowiki>f<nowiki>]]</nowiki> [[tueur]] 10, NM)}
{s:BDSorts|**Zadreni** ([[humain]] [[barde]] 9, N)}
...
{s:BDSorts|*Case.* Fonctionne comme l'avantage de la petite bande, sauf que le bonus total en [[Perception]] des voleurs est de +15.}
{s:BDSorts|*Diversion.* Fonctionne comme l'avantage de la petite bande, sauf que le bonus total en [[Bluff]] des voleurs est de +15.}
...
{s:BDTexte|**Membres clés.** }
{s:BDSorts|**Général Agnar** ([[nain]] <nowiki>[[</nowiki>f<nowiki>]]</nowiki> [[guerrier]] 10, LB)}
{s:BDSorts|**Général Rortian** ([[humain]] [[chevalier]] 12, LN)}
...
{s:BDSorts|*Rang 2.* collecte d'information, direction d'équipe (1d4 [[homme darme|hommes d'arme]] de niveau 1), emprunt de ressources (750 po), obtention d'arsenal (750 po), réapprentissage, recommandation}
