...
| Objet || Prix
|- CLASS="premier"
| [Volume 1](./Chroniques des Éclaireurs.md#Volume 1) || 200 po
|-
| [Volume 2](./Chroniques des Éclaireurs.md#Volume 2) || 100 po
|-
| [Volume 11](./Chroniques des Éclaireurs.md#Volume 11) || 100 po
|-
| [Volume 14](./Chroniques des Éclaireurs.md#Volume 14) || 150 po
|-
| [Volume 27](./Chroniques des Éclaireurs.md#Volume 27) || 150 po
|-
| [Volume 44](./Chroniques des Éclaireurs.md#Volume 44) || 200 po
|}</div></div>Les volumes des *Chroniques des Explorateurs* qui suivent ne représentent qu’une petite partie de tous ceux que les Explorateurs peuvent rencontrer lors de leurs aventures. Chacun contient des histoires spécifiques qui donnent des bonus uniques. Ils sont parfois une véritable bénédiction pour les aventuriers qui se retrouvent dans des situations similaires à celle de leurs héros. Un [MJ](./MJ.md) peut créer ses propres volumes en se basant sur les suivants, selon le format que voici.
...
Quand vous faites référence à un volume des *Chroniques des Explorateurs* qui n’est pas détaillé ici (et des dizaines d’ouvrages de ce type ont été imprimés), utilisez les règles génériques des volumes de la série, comme indiqué [ici](./Équipement daventurier.md#Chronique des Explorateurs).

<table width="100%"><tr><td width="49%">
<div class="BD">
{s:BDTitre|Volume 1|{s:Reference|VOLUME1}}
Le premier volume des Chroniques des Explorateurs (publié pour la première fois en 4317 AR), comporte un récit de l’exploration des ruines de l'Empire des premiers hommes par le fondateur de la Compagnie, les détails de la course d'un prince marchand Explorateur contre une [maride](./Marid.md) et un [éfrit](./Efrit.md) ainsi que les aventures d'un marin Explorateur dans la Jungle sauvage.
(((Bonus de compétences)))
• Améliorer les interactions avec les génies ([Diplomatie](./Diplomatie.md) et [Connaissances](./Connaissances.md) (plans) +2)
• Meilleure compréhension des constructions grammaticales et des idiomes de la langue des premiers hommes ([Linguistique](./Linguistique.md) +2)
• Circuler dans les forêts denses de la Jungle sauvage ([Survie](./Survie.md) +2)
• Comprendre l’histoire de l'Empire des premiers hommes ([Connaissances](./Connaissances.md) (histoire) +2)
</div>
...
(((Bonus de compétences)))
• Parcourir les nombreux donjons traîtres situés sous les citadelles de siège de la plaine autour de la Ville au Centre du Monde et en leur sein ([Connaissances](./Connaissances.md) (exploration souterraine) +2)
• Améliorer l’efficacité et la sécurité des voyages sur les cours d’eau ([Profession](./Profession.md) (marin) +2)
</div>
...
(((Bonus de compétences)))
• Meilleure compréhension de la nature et des coutumes des dragons ([Connaissances](./Connaissances.md) (mystères) +2)
• Faire la distinction entre les vérités et les exagérations concernant les sujets ésotériques ([Psychologie](./Psychologie.md) +2)
</div>
...
(((Bonus de compétences)))
• Faire des blagues de mauvais goût ([Représentation](./Représentation.md) (comédie) +2)
• Identifier des démons et d’autres extérieurs originaires des Abysses ([Connaissances](./Connaissances.md) (plans) +2)
• Se repérer dans l’immense capitale du domaine des éfrits dans le Plan du Feu et dans ses alentours ([Connaissances](./Connaissances.md) (géographie) +2)
</div>
...
(((Bonus de compétences)))
• Se repérer et suivre une piste dans les environnements arctiques ([Survie](./Survie.md) +2)
• Repérer et désamorcer les pièges magiques avec une célérité impressionnante ([Sabotage](./Sabotage.md) +2, [Perception](./Perception.md) +2)
</div>

<div class="BD">
{s:BDTitre|Volume 44|{s:Reference|VOLUME44}}
Ce volume, publié en 4707 AR, est connu pour son récit détaillé de l’exploration des Tréfonds par un [Agent de terrain des Explorateurs](./Agent de terrain des Éclaireurs.md). Elle y confirme que les [drows](./Drow.md) des légendes sont bien réels, ce qui a poussé les natifs du Royaume des elfes (qui avaient caché leur existence pendant des millénaires) à proposer des pots-de-vin au Conseil pour qu’il rappelle les ouvrage publiés et les modifie. La Compagnie a refusé et, en quelques années, l’existence des elfes noirs est devenue un fait reconnu. Parmi les autres récits, on trouve un bref essai de la capitaine-aventurière actuelle sur d’antiques reliques de l’ancien Empire du péché.
(((Bonus de compétences)))
• Identifier les [drows](./Drow (race).md) et leurs coutumes, leurs faiblesses et leurs tactiques ([Connaissances](./Connaissances.md) (folklore local) +2)
• En apprendre plus sur les artefacts de l'Empire du péché ([Connaissances](./Connaissances.md) (histoire) +2)
• Parcourir les tunnels des Tréfonds et en identifier les occupants ([Connaissances](./Connaissances.md) (exploration souterraine) +2 et [Connaissances](./Connaissances.md) (géographie) +2)
</div>
