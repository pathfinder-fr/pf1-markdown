---
Name: Pathfinder-RPG.Liste des formules dalchimiste
Title: Liste des formules d'alchimiste
LastModified: 2025-01-11 15:52
Categories:
- Liste de sorts
- Règle officielle
- Sort
...
**[[Dés de vie]].** Le terme « dés de vie » (ou DV) est synonyme de « niveau de personnage » pour les cibles affectées par les formules (en effet, nombre de créatures ne peuvent pas progresser dans une classe de personnage ; elles n’ont pas de niveau mais des dés de vie).
...
**Créatures et personnages.** Les termes « créature » et « personnage » sont considérés comme synonymes dans la description des formules.

Retour vers l'[[alchimiste]].
...
- ***[[Mixture pour bombe ciblée]]*** *(AG)*. Améliore une bombe qui inflige plus de dégâts à une unique créature.
...
- ***[[Œil du mitrailleur]]*** *(MJRA)*. Augmente la portée des armes de jet ; +1 attaque.
...
- ***[[Eaux de Lamashtu|Eaux de folie]] (M, Y)*** *(CCMI)*. Créé un poison qui a l'apparence d'eau pure et propre.
...
- ***[[Mixture pour bombe dombre|Mixture pour bombe d'ombre]]*** *(AG)*. La bombe du personnage recouvre sa cible d’une substance sombre qui lui donne un camouflage mais limite sa visibilité.
...
- ***[[Retardement des maladies]] ([[Homme-rat (race)|Homme-rat]])*** *(MR)*. Le personnage obtient une immunité temporaire aux maladies.
...
- ***[[Amplification délixir|Amplification d'élixir]]*** *(MJRA)*. Augmente la puissance ou la durée des effets d'une potion ou d'un élixir.
...
- ***[[Goutte dorchidée|Goutte d'orchidée]] (M)*** *(MMI)*. Ajoute un puissant effet guérisseur aux mutagènes du personnage.
...
- ***[[Chaleur curative]] ([[Ifrit (race)|Ifrit]])*** *(MR)*. Le personnage obtient une immunité temporaire aux dégâts de feu qu'il peut transformer en énergie curative.
...
- ***[[Mixture pour bombe demprisonnement|Mixture pour bombe d'emprisonnement]]*** *(AG)*. La bombe du personnage crée une cage de force qui piège les créatures qui se trouvent dans le rayon d’aspersion.
