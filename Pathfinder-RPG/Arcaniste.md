...
{| CLASS="tablo centre"
|+ {s:Reference|TABLEARCANISTE}L'arcaniste
|- CLASS="titre"
| ROWSPAN="2" | Niveau
| ROWSPAN="2" | BBA
| ROWSPAN="2" | Réflexes
...
|+ {s:Reference|SORTSPREPARESDELARCANISTE}Sorts d'arcaniste préparés
|- CLASS="titre"
| ROWSPAN="2" | Niveau
| COLSPAN="10" CLASS="avecsoustitre gauche" | Sorts préparés
|- CLASS="soustitre"
