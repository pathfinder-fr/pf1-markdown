---
Name: Pathfinder-RPG.Gantelet darmes (armure)
Title: Gantelet d'armes
...
Tant que le gantelet est fixé, le personnage ne peut pas utiliser la main qui le porte pour lancer des sorts ou utiliser des compétences. (Il peut quand même lancer des sorts à [[composantes|composante gestuelle]], à condition de garder l’autre main libre).   
  
Comme le [[gantelet (arme)|gantelet normal]], le gantelet d’armes permet d’infliger des dégâts létaux plutôt que des dégâts non létaux avec un [[attaque à mains nues|coup à mains nues]].
