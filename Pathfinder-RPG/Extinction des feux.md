---
Name: Pathfinder-RPG.Extinction des feux
Title: Extinction des feux
LastModified: 2013-09-17 15:04
Categories:
- Manuel des joueurs
- Règles officielles
- Sort
...
Les créatures appartenant au sous-type du [[sous-type feu|Feu]] qui sont prises dans la [[zone deffet|zone d’effet]] subissent 1d6 points de dégâts par [[niveau de lanceur de sorts]] (jusqu’à un maximum de 10d6, sans [[jet de sauvegarde]]).

Le personnage peut également cibler ce sort sur un objet magique qui crée ou contrôle le feu. Cet objet perd alors tous ses pouvoirs relatifs au feu pendant 1d4 heures, à moins qu’il ne réussisse un jet de [[Volonté]]. Cet effet ne fonctionne pas sur les [[artefacts]].
