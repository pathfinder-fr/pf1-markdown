---
Name: Pathfinder-RPG.Maître du bouclier (guerrier)
Title: Maître du bouclier
LastModified: 2013-03-30 21:13
Categories:
- Classe
...
Au niveau 17, par une [[action rapide]], le [[guerrier]] peut désigner un espace voisin de celui qu'il occupe, deux espaces s'il utilise un [[Descriptions individuelles des armures#Écu|bouclier lourd]], trois s'il utilise un  [[Descriptions individuelles des armures#pavois|pavois]]. Ces espaces doivent néanmoins être contigus. Les adversaires qui s'y trouvent ne peuvent le [[pris en tenaille|prendre en tenaille]] et ne comptent pas dans le nombre de créatures nécessaires pour le prendre en tenaille. Cet effet dure jusqu'à ce qu'il change de place ou jusqu'à ce qu'il utilise une [[action rapide]] pour modifier les espaces concernés. Cette capacité remplace [[guerrier#ENTRAINEMENTAUXARMES|entraînement aux armes 4]].

#### Maîtrise du bouclier (Ext).
Au niveau 19, le personnage reçoit une [[RD]] 5/- lorsqu'il tient un bouclier. Cette capacité remplace [[guerrier#MAITRISEDESARMURES|maîtrise des armures]].

#### Protection du bouclier (Ext).
AU niveau 20, le maître du bouclier bénéficie de l'[[esquive totale]] (comme le [[roublard]]) lorsqu'il porte un bouclier. il ajoute le [[Caractéristiques des armures#BONUSARMUREBOUCLIER|bonus de bouclier à la CA]] (sans les [[armures magiques#BONUSALTERATION|bonus d'altération]]) sur ses [[Valeurs de combat#jets de sauvegarde|jets de réflexes]] et à sa [[CA]] contre les [[Valeurs de combat#ATTAQUESDECONTACT|attaques de contact]]. De plus, le bouclier ne peut lui être arraché ni être détruit. Cette capacité remplace [[guerrier#MAITRISEDESARMES|maîtrise des armes]].
