---
Name: Pathfinder-RPG.Domination
Title: Domination
...
Si le personnage ne passe pas au moins 1 [[round]] par jour à se [[concentration|concentrer]] sur le sort, le sujet bénéficie d’un nouveau [[jet de sauvegarde]] pour se libérer de la domination.
...
### Version mythique
{s:CMy}Le [[DD]] des tests de [[Psychologie]] effectués pour remarquer que la cible du personnage est dominée augmente du double du [[grade]] du personnage. Il peut donner des ordres à sa cible même si celle-ci est protégée par des effets [[non-mythiques]] qui bloquent le contrôle magique, tel que protection contre le Mal. Si la cible est protégée par un effet mythique, le personnage peut tenter d’ignorer cette protection grâce à un test de [[NLS|niveau de lanceur de sorts]] ([[DD]] 15 + [[NLS]] de l’effet) ; ajoutez le [[grade]] du personnage à ce test et le [[grade]] du lanceur adverse au [[DD]]. Si la cible réussit son jet de [[Volonté]] pour annuler le contrôle du personnage, ce dernier peut, par une [[action immédiate]], dépenser une utilisation de [[pouvoir mythique]] pour l’obliger à refaire son jet de sauvegarde et à conserver le pire.



((({s:sortssimilaires|domination}
## [[Pacte de mort]]
{s:OO}**École** [[Enchantement]] <nowiki>[</nowiki>[[registre|effet mental]]<nowiki>]</nowiki> ; **Niveau** [[Barde|Bard]] 5, [[Sorcière|Sor]] 6    
**Temps d’incantation** 1 minute  
**Composantes** [[composantes|V, G, M]] (un contrat signé par le sang)  
**Portée** [[contact]]  
**Cible** une créature  
**Durée** 24 heures  
**Jet de sauvegarde** [[Volonté]], [[Présentation des sorts#JETSDESAUVEGARDE|annule]] (voir texte) ; **Résistance à la magie** oui
<hr />
Le personnage prend le contrôle de l'esprit d'une créature et y implante des commandes subconscientes mortelles. Ce sort fonctionne comme *[[domination]]*, permettant au personnage de contrôler son sujet et de voir à travers ses sens, mais implante aussi une puissante rafale psychique dans l'esprit du sujet. À n'importe quel moment pendant la durée du sort, le personnage peut déclencher cette rafale par une [[action immédiate]], infligeant 1d8 points de dégâts par [[NLS|niveau de lanceur de sorts]] ([[Vigueur]], [[Présentation des sorts#JETSDESAUVEGARDE|1/2 dégâts]]) au sujet. Si ces dégâts sont suffisants pour réduire la cible à 0 points de vie ou moins, elle meurt instantanément.

La cible peut également déclencher volontairement cette rafale psychique par une [[action immédiate]]. Le personnage peut spécifier des conditions (comme « être capturé ») pour définir quand elle devrait le faire, mais si ces ordres sont considérés comme dangereux, ils permettent au sujet un nouveau jet de [[Volonté]] avec un bonus de +2.
