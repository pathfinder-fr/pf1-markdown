...
**Sorts supplémentaires.** *[[contact glacial]]* (niveau 3), *[[simulacre de vie]]* (niveau 5), *[[baiser du vampire]]* (niveau 7), *[[animation des morts]]* (niveau 9), *[[vagues de fatigue]]* (niveau 11), *[[annihilation de mort-vivant]]* (niveau 13), *[[doigt de mort]]* (niveau 15), *[[flétrissure]]* (niveau 17), *[[absorption dénergie|absorption d’énergie]]* (niveau 19)
...
**Toucher du tombeau (Mag).** Au niveau 1, le personnage peut utiliser une [[action simple]] pour [[secoué|secouer]] une créature vivante en réussissant une [[attaque de contact au corps à corps]]. L’effet persiste pendant un nombre de rounds égal à la moitié du niveau d’[[ensorceleur]] du personnage (1 round au minimum). Si le personnage touche à nouveau une créature déjà [[secoué|secouée]] par ce pouvoir, elle devient [[effrayé|effrayée]] pendant 1 round si elle possède un nombre de [[DV]] inférieur au niveau d’[[ensorceleur]] du personnage. Chaque jour, l’[[ensorceleur]] peut utiliser ce pouvoir un nombre de fois égal à 3 + son modificateur de [[Charisme]].
