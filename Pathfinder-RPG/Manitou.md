---
Name: Pathfinder-RPG.Manitou
Title: Manitou
LastModified: 2017-03-18 20:17
---

<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Manitou|FP 15}
...
(((Défense)))
- **CA **29, contact 18, pris au dépourvu 22 (Dex +6, esquive +1, naturelle +11, parade +3, taille -2)
- **pv **237 (19d10+133) ; guérison accélérée 5
- **Réf **+12, **Vig **+18, **Vol **+17
- **Capacités défensives** liberté de mouvement, invisibilité suprême ; **RD **10/fer froid et Mal ; **Immunités **acide, froid ; **Résistances** électricité 30, feu 30 ; **RM **26
(((Attaque)))
- VD 9 m
- **Corps à corps** 2 coups, +30 (4d10+12)
...
(((Écologie)))
- **Environnement **forêts ou plaines
- **Organisation **solitaire
- **Trésor **standard
(((Pouvoirs spéciaux)))
- **Aura d’énergie positive (Sur)**. Les créatures vivantes situées à l’intérieur de l’aura du manitou récupèrent 5 points de vie chaque round pendant leur tour. Le manitou peut exclure des effets de son aura un nombre de créatures égal à son modificateur de Charisme (généralement 7) et peut désactiver ou activer ce pouvoir par une action libre.
- **Déferlante d’esprits (Sur)**. Tous les 1d4 rounds, le manitou peut invoquer des esprits animaux pour attaquer ses adversaires, affectant un cône de 18 mètres de long et infligeant 10d6 points de dégâts de force (Réflexes DD 26, ½ dégâts). L’utilisation de ce pouvoir affaiblit temporairement le lien du manitou avec le monde naturel, ce qui met fin à son aura d’énergie positive tant que la déferlante n’est pas de nouveau disponible.
- **Gage de chance (Sur)**. Le manitou peut bénir un petit objet tel qu’un collier ou une pierre. Le porteur de cet objet ainsi que ses alliés dans un rayon de 3 mètres gagnent un bonus de chance de +2 aux jets de sauvegarde. Le manitou peut utiliser scrutation à volonté sur ce gage. Il peut se téléporter jusqu’à lui (sans risque d’erreur) une fois par jour par une action rapide. Ces pouvoirs sont perdus si le gage quitte le territoire du manitou. Le manitou ne peut maintenir actif qu’un seul gage à la fois.
