...
{s:FAQ|***[[FAQ- Manuel des joueurs (Races et classes)#1|→]] Accroissements de caractéristiques : D'après la table et le texte de la page 30, un personnage bénéficie d'un accroissement de caractéristique aux niveaux 4, 8, 12, 16 et 20. De combien est cet accroissement ? Quelles caractéristiques affecte-t-il ?***
...
Il existe également une [[variante de multiclassage]].{S:PU}
...
{s:VoirAussiAvant}
- Vous pouvez également accéder à la progression pécuniaire des PJ sur le tableau [[Rencontres#TABLERICHESSEPJPARNIVEAU|Richesse du personnage par niveau]] et à celle des PNJ sur le tableau [[Créer des PNJ#TABLEEQUIPEMENTPNJ|Équipement des PNJ]].
{s:VoirAussiAprès}
