---
Name: Pathfinder-RPG.filet (arme)
Title: Filet
LastModified: 2021-10-01 18:33
Categories:
- Arme
...
Pour lancer le filet, il faut d’abord le plier. La première fois que le personnage lance son filet en combat, il doit faire une [[attaque de contact]] à distance. Une fois que le filet est déplié, il reçoit un malus de -4 à ses [[jet dattaque|jets d’attaque]] au filet. Il faut 2 [[round|rounds]] à un utilisateur chevronné pour plier un filet et deux fois plus de temps à un utilisateur non formé.
