---
Name: Pathfinder-RPG.Attiseur de tempêtes
Title: Attiseur de tempêtes
LastModified: 2025-01-25 17:56
Categories:
- Classe de prestige
- Src Paths of Prestige
---

{s:MenuClassesDePrestige}{s:cs}{s:PP}''Ceux qui se dédient à l’étude de l’Œil-ouragan peuvent apprendre et maîtriser des techniques puissantes pour améliorer leur contrôle déjà très impressionnant sur les tempêtes et le vent. Ces rejetons de l’ouragan prennent le nom d'attiseur de tempêtes. Cette organisation à laquelle ils appartiennent cherche a développer non seulement le pouvoir de manipuler les tempêtes, mais aussi la capacité de faire naître ces tempêtes de leur propre corps, et de se transformer physiquement en vortex de destruction.

Les premiers à apprendre ces secrets faisaient partie membres originaux de l’organisation, qui ont affronté l’Œil-ouragan il y a des siècles. Pendant des générations, les méthodes pour engendrer des tempêtes de cette manière ont été perdues, mais l’organisation actuelle a retrouvé ces secrets, et aujourd’hui la tradition s’est répandue plus que jamais. Beaucoup de ceux qui rejoignent la secte des attiseurs de tempêtes cherchent à gagner le pouvoir des véritables attiseurs de tempêtes.
...
<table CLASS="tablo">
  <caption>L'attiseur de tempêtes</caption>
  <tr CLASS="titre">
    <td>Niveau</td>
    <td>BBA</td>
    <td>Réflexes</td>
  ...
  <tr CLASS="premier">
    ...
    <td>+1</td>
    <td>+1</td>
    <td CLASS="gauche">[[Attiseur de tempêtes#ESPRITDELOCEAN|Esprit de l'Océan]]</td>
    <td CLASS="gauche">—</td>
  </tr>
  <tr CLASS="alt">
    <td>2</td>
    ...
    <td>+1</td>
    <td CLASS="gauche">
      [[Attiseur de tempêtes#VISIONDUMARIN|Vision du marin]], [[Attiseur de tempêtes#FORMEDETEMPETE|forme de
      tempête]] (6m, Petit)
    </td>
  ...
  <tr>
    ...
    <td>+2</td>
    <td>+2</td>
    <td CLASS="gauche">[[Attiseur de tempêtes#AURADECALME|Aura de calme]] (1,5m)</td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr CLASS="alt">
    <td>4</td>
    ...
    <td>+2</td>
    <td CLASS="gauche">
      [[Attiseur de tempêtes#FORMEDETEMPETE|Forme de tempête]] (9m, Moyen), [[Attiseur de
      tempêtes#BRISEURDEVAGUE|briseur de vague]]
    </td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr>
    ...
    <td>+3</td>
    <td CLASS="gauche">
      [[Attiseur de tempêtes#AURADECALME|Aura de calme]] (3m), [[Attiseur de tempêtes#COUPDETONNERRE|coup de
      tonnerre]]
    </td>
    <td CLASS="gauche">—</td>
  </tr>
  <tr CLASS="alt">
    ...
    <td>+3</td>
    <td CLASS="gauche">
      [[Attiseur de tempêtes#FORMEDETEMPETE|Forme de tempête]] (12m, Grand), [[Attiseur de
      tempêtes#FUREURCLIMATIQUE|fureur climatique]] 3d6
    </td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr>
    ...
    <td>+4</td>
    <td CLASS="gauche">
      [[Attiseur de tempêtes#AURADECALME|Aura de calme]] (4,5m), [[Attiseur de tempêtes#OEILDUCYCLONE|œil du
      cyclone]]
    </td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr CLASS="alt">
    ...
    <td>+4</td>
    <td CLASS="gauche">
      [[Attiseur de tempêtes#VENTSCAPRICIEUX|Vents capricieux]], [[Attiseur de tempêtes#FORMEDETEMPETE|forme de
      tempête]] (15m, Très Grand), [[Attiseur de tempêtes#FUREURCLIMATIQUE|fureur climatique]] 4d6
    </td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr>
    ...
    <td>+5</td>
    <td CLASS="gauche">
      [[Attiseur de tempêtes#AURADECALME|Aura de calme]] (6m), [[Attiseur de tempêtes#ECHODUTONNERRE|écho du
      tonnerre]]
    </td>
    <td CLASS="gauche">—</td>
  </tr>
  <tr CLASS="alt">
    ...
    <td>+5</td>
    <td CLASS="gauche">
      [[Attiseur de tempêtes#MAITRISEDESTEMPETES|Maîtrise des tempêtes]], [[Attiseur de
      tempêtes#FORMEDETEMPETE|forme de tempête]] (18m, Très Grand), [[Attiseur de tempêtes#FUREURCLIMATIQUE|fureur
      climatique]] 5d6
    </td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
...
### Conditions requises
Pour pouvoir devenir un attiseur de tempêtes, le personnage doit satisfaire aux conditions suivantes.

**Alignement.**  N’importe quel alignement Neutre.

**Compétences.**  6 rangs en [[Connaissances]] (histoire), 6 rangs en [[Connaissances]] (nature), 3 rangs en [[Natation]], 3 rangs en [[Vol]].

**Divinité.** Doit prier le [[Golarion.Gozreh|dieu de la nature]].

**Dons.** [[Battu par les vents]].

**Sorts.** Capacité à lancer des sorts de 2e niveau.

### Compétences de classe
Voici les compétences de classe de l’attiseur de tempêtes : [[Connaissances]] (histoire) (Int), [[Connaissances]] (nature) (Int), [[Connaissances]] (religion) (Int), [[Natation]] (For), [[Perception]] (Sag), [[Survie]] (Sag) et [[Vol]] (Dex).
...
Par une [[action rapide]], l’attiseur de tempêtes peut changer la hauteur de son tourbillon d'un minimum de 3 m (2 {s:c}) à un maximum de 6 m (4 {s:c}). Au niveau 4 et tous les 2 niveaux par la suite, cette hauteur maximale augmente de 3 m, pour un maximum de 18 m (12 {s:c}) de haut au niveau 10.
