---
Name: Pathfinder-RPG.Disciplines psychiques
Title: Les disciplines psychiques du psychiste
LastModified: 2024-10-03 15:40
---

{s:Menuclassesoccultes}<div style="background-color: #fff; float: right; padding: 0 0 8px 8px"><nav class="wiki-toc"></nav></div>{s:AO}*Les disciplines suivantes sont parmi les plus communément suivies par les psychistes. Les adeptes de ces disciplines appliquent leurs préceptes de différentes façons : certains se rassemblent au sein d’ordres alors que d’autres les interprètent seuls, de manière personnelle et parfois très singulière.*

{s:Reference|ABOMINATION}
### Abomination
L’esprit du personnage est impur car corrompu par des forces extérieures. Celles-ci proviennent peut-être d’ancêtres monstrueux dont le sang coule encore dans les veines du personnage ou de forces psychiques puissantes et mystérieuses qui se sont infiltrées dans son esprit. Telle une maladie mentale, cette influence dévore une partie de son cerveau afin de créer un obscur alter ego de sa propre identité. Chaque fois qu’il lance un sort psychique, le personnage puise dans cette dangereuse énergie qui peut à tout moment resserrer son emprise sur lui. Cette influence malveillante peut provenir de créatures, telles que les [Rakshasa|rakshasas] et les [Aboleth|aboleths], ou d’entités malfaisantes qui infestent les immenses espaces vides entre les étoiles.

**Caractéristique associée à la réserve phrénique.** [Charisme].

**Sorts supplémentaires. **[Rayon affaiblissant] (1), [Modification dapparence|modification d’apparence] (4), [Déformation douloureuse|douloureuse déformation] (6), [tentacules noirs] (8), [tête explosive] (10), [champ de force] (12), [aliénation mentale] (14), [orbe du néant] (16), [tempête télékinétique] (18).
...
**Sorts supplémentaires.** [Compréhension des langages] (1), [hypercognition] (4), [dissipation de la magie] (6), [sonde mentale] (8), [rétrocognition] (10), [mythes et légendes] (12), [vision magique suprême] (14), [moment de prescience] (16), [diviser lesprit|diviser l’esprit] (18).
...
**Sorts supplémentaires.** [Aiguillon persuasif|Aiguillon persuasif] (1), [Frappe douloureuse|frappe douloureuse] (4), [baiser du vampire] (6), [Frappe douloureuse de groupe|frappe douloureuse de groupe] (8), [surcharge synaptique] (10), [infliger des souffrances de groupe] (12), [Vagues dépuisement|vagues d’épuisement] (14), [flétrissure] (16), [suffocation de groupe|suffocation de groupe] (18).
...
**Sorts supplémentaires.** [Charme-personne] (1), [discours captivant] (4), [Efforts coordonnés|efforts coordonnés] (6), [mission] (8), [télépathie] (10), [Lien des esprits combatifs|lien des esprits combatifs] (12), [immobilisation de personne de groupe] (14), [charme-monstre de groupe] (16), [Présence écrasante|présence écrasante] (18).
...
*Partage des souvenirs (Mag).* Au niveau 5, le personnage peut utiliser [Partage des souvenirs|partage des souvenirs] à volonté, mais uniquement sur une cible consentante.
...
**Sorts supplémentaires.** [Bénédiction] (1), [arme spirituelle] (4), [panoplie magique] (6), [Gardien de la foi|gardien de la foi] (8), [communion] (10), [chirurgie psychique] (12), [scrutation suprême] (14), [Allié suprême doutreplan|allié suprême d’outreplan] (16), [miracle] (18).
...
{s:Reference|ILLUMINATION}{s:OO}
### Illumination
{s:cs}La quête de l’illumination du personnage a ouvert ses yeux à de nouveaux concepts et à une conscience psychique plus étendue. Il recherche les connaissances qui pourraient lui permettre d’évoluer tant dans son âme que dans son esprit, pour perfectionner sa prochaine incarnation.

**Caractéristique associée à la réserve phrénique.** [Sagesse](./Sagesse.md).

**Sorts supplémentaires.** *[Sens aiguisés](./Sens aiguisés.md)* (1), *[identification](./Identification.md)* (4), *[clairaudience/clairvoyance](./Clairaudienceclairvoyance.md)* (6), *[perception des pensées](./Perception des pensées.md)* (8), *[pénitence](./Pénitence.md)* (10), *[vision magique suprême](./Vision magique suprême.md)* (12), *[cercle de clarté](./Cercle de clarté.md)* (14), *[protection contre les sorts](./Protection contre les sorts.md)* (16), *[présence écrasante](./Présence écrasante.md)* (18).

**Pouvoirs de discipline.** L'esprit illuminé du personnage soulage son fardeau et permet aux troubles de le traverser sans l'affecter.

*Vigilance étendue (Sur).* Par une [action de mouvement](./Action de mouvement.md), le personnage peut se focaliser sur ses sens et gagner une des capacité sensorielle suivante : [perception aveugle](./Perception aveugle (capacité).md) à 3 m, [vision dans le noir](./vision dans le noir (capacité).md) à 9 m, [vision nocturne](./Vision nocturne (capacité).md), ou [odorat](./Odorat (capacité).md). Ce nouveau sens dure pendant 1 [round](./round.md) par niveau de psychiste. Le personnage peut utiliser ce pouvoir une nombre de fois par jour égal à son modificateur de [Sagesse](./Sagesse.md). Au niveau 11, le personnage peut utiliser vigilance étendue pour obtenir la [vision dans les ténèbres](./Vision dans les ténèbres (capacité).md) ou la [perception des pensées](./Perception des pensées (capacité).md) à 6 m. Au niveau 15, il peut l'utiliser pour obtenir la [perception de la vie](./Perception de la vie (capacité).md).

*Intuition patiente (Ext).* Lorsque le personnage effectue un test de [Connaissances](./Connaissances.md), de [Premiers secours](./Premiers secours.md), de [Psychologie](./Psychologie.md) ou de [Survie](./Survie.md), il peut dépenser 1 point de sa [réseve phrénique](./Psychiste.md#RESERVEPHRENIQUE) pour lancer le dé deux fois et garder le meilleur résultat.

*Transe focalisée (Ext).* Au niveau 5, le personnage peut entrer dans une profonde méditation qui lui permet de se concentrer sur un problème, une question philosophique, ou un souvenir. Cette transe dure 1d6 [rounds](./round.md) pendant lesquels le personnage peut seulement effectuer des [actions de mouvement](./Action de mouvement.md) et obtient un bonus égal à son niveau de psychiste aux [jets de sauvegarde](./JDS.md) contre les effets de son et les attaques de [regard](./Regard (capacité).md). Lorsqu'il sort de sa transe, le personnage peut effectuer un unique test d'[Art de la magie](./Art de la magie.md), de [Connaissances](./Connaissances.md) ou d’[Estimation](./Estimation.md) avec un bonus de circonstances de +20. Le personnage peut entrer dans une transe focalisée un nombre de fois par jour égal à son modificateur de [Sagesse](./Sagesse.md).

*Esprit vide (Sur).* Au niveau 13, le personnage peut vider son esprit en se concentrant sur un sentiment de vacuité, le purgeant de tout doute ou inconfort dont il est victime. Le personnage peut dépenser 1 point de sa [réserve phrénique](./Psychiste.md#RESERVEPHRENIQUE) à son tour par une [action libre](./Action libre.md) pour dissiper un des états préjudiciables suivants dont il souffre : [assourdi](./Assourdi.md), [aveuglé](./Aveuglé.md), [chancelant](./Chancelant.md), [confus](./Confus.md), [ébloui](./Ébloui.md) ou [étourdi](./Étourdi.md).

{s:Reference|PERFECTIONPERSONNELLE}
...
**Sorts supplémentaires.** [Repli expéditif] (1), [Endurance de lours|endurance de l’ours] (4), [rapidité] (6), [liberté de mouvement] (8), [Écholocalisation|écholocalisation] (10), [transformation martiale] (12), [forme éthérée] (14), [corps de fer] (16), [forme akashique] (18).
...
**Sorts supplémentaires.** [Panacée universelle|Panacée universelle] (1), [Folle hallucination|folle hallucination] (4), [synesthésie] (6), [confusion] (8), [mirage] (10), [Extase|extase] (12), [vagues dextase|vagues d’extase] (14), [Tranquillité euphorique|tranquillité euphorique] (16), [projection astrale] (18).
...
**Sorts supplémentaires.** [Projection télempathique] (1), [silence] (4), [manteau de calme|manteau de calme] (6), [Hébétement de groupe|hébétement de groupe] (8), [Sérénité|sérénité] (10), [chirurgie psychique] (12), [esprit impénétrable] (14), [Tranquillité euphorique|tranquillité euphorique] (16), [arrêt du temps] (18).

**Pouvoirs de discipline.** La stabilité mentale du personnage le protège lui et ses alliés.

*Placidité mentale (Sur).* Par une action immédiate, le personnage peut bénéficier d’un bonus de +2 aux [Valeurs de combat#JETDEVOLONTE|jets de Volonté] qu’il est sur le point d’effectuer. Ce bonus s’élève à +4 contre les sorts ou les effets d’enchantement. Les alliés qui effectuent un jet de sauvegarde contre le même effet que le personnage bénéficient d’un bonus de +1 à leur [Valeurs de combat#JETDEVOLONTE|jet de Volonté] ou d’un bonus de +2 si l’effet est un enchantement. Le personnage récupère 1 point dans sa réserve phrénique s’il réussit ce jet de sauvegarde. Il peut utiliser ce pouvoir un nombre de fois par jour égal à son modificateur de [Sagesse].
...
{s:Reference|RENAISSANCE}{s:OO}
### Renaissance
{s:cs}L'esprit du personnage est forgé par les plus puissants souvenirs de ses nombreuses vies passées. Le personnage possède des connaissances fragmentées de ses vies antérieures et peut puiser dans l'expérience acquise au cours de ces vies pour acquérir un pouvoir psychique brut.

**Caractéristique associée à la réserve phrénique.** [Charisme](./Charisme.md).

**Sorts supplémentaires.** *[Bouffée d'intuition](./Bouffée dintuition.md)* (1), *[simulacre de vie](./Simulacre de vie.md)* (4), *[contact avec les plans](./Contact avec les plans.md)* (6), *[mémoire ancestrale](./Mémoire ancestrale.md)* (8), *[réincarnation](./Réincarnation.md)* (10), *[transformation martiale](./Transformation martiale.md)* (12), *[forme éthérée](./Forme éthérée.md)* (14), *[bilocation](./Bilocation.md)* (16), *[forme akashique](./Forme akashique.md)* (18).

**Pouvoirs de discipline.** Les nombreuses vies du personnage lui ont inspirées diverses capacités exceptionnelles.

*Souvenirs des vies passées (Ext).* Le personnage ajoute un bonus égal à la moitié de son niveau de psychiste (minimum 1) à tous ses tests de [Connaissances](./Connaissances.md) et peut effectuer n’importe quel test de Connaissances même sans formation.

*Ésotérisme mnémotechnique (Ext).* En cherchant dans les réminiscences de ses vies passées, le personnage découvre un savoir inconnu de la plupart des psychistes. Le personnage choisit une classe de lanceur de sorts supplémentaire. Une fois par jour lorsqu'il prépare ses sorts, il peut ajouter un sort de la liste de sorts de cette classe à sa liste de sorts connus et à sa liste de sorts de classe pendant 24 heures. Ce sort doit être d'un niveau inférieur au plus haut niveau de sort qu'il est capable de lancer, et le psychiste le lance comme un [sort psychique](./La magie psychique.md). Le personnage peut décider de changer la classe de lanceur de sorts dont il emprunte des sorts chaque fois qu'il prend un niveau.

*Résurgence (Sur).* Au niveau 5, lorsqu'il devrait être réduit à 0 [points de vie](./pv.md) ou moins après une attaque, le personnage peut dépenser 2 points de sa [réserve phrénique](./Psychiste.md#RESERVEPHRENIQUE) par une [action immédiate](./Action immédiate.md) pour récupérer un nombre de points de vie égal à 1d8 + son niveau de psychiste. Au niveau 10, ces soins passent à 3d8 + son niveau de psychiste. Si ces soins sont insuffisants pour ramener le personnage au-dessus de points de vie négatifs, il est automatiquement [stabilisé](./Blessures et mort.md#STABLE). S'il doit tout de même être tué par les dégâts subis, le corps du personnage projette une aura d'énergie positive qui soigne ses alliés dans un rayon de 9 mètres autour de lui du même montant qu'il s'est soigné lui-même.

*Régression physique (Sp).* Au niveau 13, le personnage peut dépenser 2 points de sa [réserve phrénique](./Psychiste.md#RESERVEPHRENIQUE) par une [action simple](./Action simple.md) une fois par jour pour prendre la forme d'une de ses anciennes incarnations. Ce pouvoir fonctionne comme le sort *[métamorphose](./métamorphose.md)*, mais sa portée est personnelle et sa durée passe à 10 minutes par [niveau de lanceur de sorts](./NLS.md).
