...
{s:BDTexte|**pv** 31 (7d8)}
{s:BDTexte|**Réf** +1, **Vig** +2, **Vol** +5}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9 m (6 {s:c})}
{s:BDTexte|**Corps à corps** dague, +4 (1d4–1/19–20)}
{s:BDTexte|**A distance** arbalète légère de maître, +5 (1d8/19–20}
{s:BDSousTitre|Caractéristiques}
...
Les marchands itinérants font d’excellents diplomates, espions, informateurs ou même de bons nobles ou gentlemen à la fois
...
Les princes marchands sont les capitaines du commerce, des individus mercantiles et sournois qui s’occupent aussi bien de
