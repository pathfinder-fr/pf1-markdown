...
|+ Potions et huiles aléatoires
|- CLASS="titre"
| Faible inférieure || Faible supérieure || Intermédiaire inférieure || Intermédiaire supérieure || Puissante inférieure || Puissante supérieure || Niveau de sort* || NLS
|- CLASS="premier"
| 01-40 || 01-10 || — || — || — || — || 0 || 1
|-
...
|- CLASS="note"
| | COLSPAN="8" | *(*) Consultez la table ci-contre pour déterminer la rareté des potions et des huiles, puis les tables ci-dessous pour déterminer le sort.*
|}
</td><td width="28%">
{| CLASS="tablo centre autoalt" WIDTH="94%"
|+ Type de potion ou d'huile
|- CLASS="titre"
...
|- CLASS="note"
| | COLSPAN="2" | *(*) Sauf pour les potions et huiles de niveau 0 qui sont toujours communes.*
|}
</td></tr></table>
