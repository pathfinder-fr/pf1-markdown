---
Name: Pathfinder-RPG.Détection du Mal
Title: Détection du Mal
LastModified: 2022-06-12 14:41
Categories:
- Règle officielle
- Sort
- Sort adepte 1
...
Grâce à *détection du Mal*, le lanceur de sorts peut détecter la présence du Mal. Les informations qu’il reçoit dépendent du temps passé à étudier la zone ou le sujet choisi.

Premier [round](./round.md) : présence ou absence d’auras maléfiques.

Deuxième [round](./round.md) : nombre d’auras maléfiques (émanant de créatures, de sorts ou d’objets) dans la zone sondée et intensité de la plus puissante.

Si le jeteur de sorts est d’[alignement](./Alignement.md) Bon, si l’aura détectée est surpuissante (voir ci-dessous) et correspond à une créature possédant un nombre de [dés de vie](./dés de vie.md) supérieur ou égal au double du [niveau](./niveau.md) du personnage, il est [étourdi](./Étourdi.md) pendant 1 [round](./round.md) et le sort prend fin immédiatement.
