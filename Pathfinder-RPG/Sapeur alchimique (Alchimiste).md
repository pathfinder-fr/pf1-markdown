...
Un sapeur alchimique ajoute [[Connaissances]] (ingénierie) et [[Discrétion]] à sa liste de compétences de classe.

Cela altère les compétences de classe de l'[[alchimiste]].

#### Bombe de démolition (Sur)
Au niveau 1, un sapeur alchimique peut créer une bombe de démolition. Cette bombe inflige deux fois plus de dégâts qu'une bombe normale, la première moitié inflige des dégâts contondants et perçants, le seconde des dégâts de feu. Cette bombe ignore un nombre de points de solidité égaux à 1/2 du niveau de sapeur alchimique (minimum 1). Cela compte comme une comme une aptitude qui modifie la bombe du sapeur alchimique, cela ne se cumule donc pas avec d'autres [[découvertes]] qui modifient les bombes. Le sapeur alchimique ne peut pas utiliser sa bombe de démolition avec la découverte [[Découvertes#BOMBESRAPIDES|bombes rapides]]. Un sapeur alchimique ne peut se servir d'une utilisation par jour de sa compétence de classe bombes pour créer une bombe de démolition. Il peut créer une bombe de démolition supplémentaire à partir du niveau 5 et une de plus tous les quatre niveaux après.

Ce pouvoir modifie [[alchimiste#BOMBES|bombes]].

#### Bombe à retardement (Sur)
Un sapeur alchimique gagne la découverte [[Découvertes#BOMBEARETARDEMENT|bombe à retardement]] au niveau 1. Il ne peut apprendre les découvertes [[Découvertes#MUTAGENE|mutagène]] et [[Découvertes#COGNATOGENE|cognatogène]] avant le niveau 8.

Ce pouvoir remplace [[alchimiste#MUTAGENES|mutagène]].

#### Maître ingénieur (Ext)
Au niveau 2, un sapeur alchimique ajoute 1/2 de son niveau d'alchimiste à ses tests de [[Connaissances]] (ingénierie), [[Artisanat]] (constructions en pierre) et [[Artisanat]] (pièges).

Ce pouvoir remplace la [[alchimiste#RESISTPOISON|résistance aux poisons]].

#### Bombe camouflée (Ext)
Au niveau 3, un sapeur alchimique devient capable de cacher ses bombes. Lorsqu'il déploie une [[Découvertes#BOMBEARETARDEMENT|bombe à retardement]] ou une mine de proximité (voir plus bas), le sapeur alchimique peut camoufler la bombe en dépensant un [[round]] complet. Les créatures recherchant les pièges doivent réussir un test de [[Perception]] ([[DD]] = 10 + le [[niveau]] de sapeur alchimique + son modificateur d'[[Intelligence]]) pour dénicher les bombes camouflées.

Ce pouvoir remplace [[alchimiste#ALCHIMIERAPIDE|alchimie rapide]].

#### Mine de proximité (Sur)
Au niveau 6, un sapeur alchimique peut dépenser deux utilisations de sa compétence de classe bombes (Sur) pour préparer un piège spécifique appelé une mine de proximité. Cette bombe spéciale reste inactive 1 round après avoir quitté la possession du sapeur alchimique, après ce délai elle s'arme. Lorsqu'une créature entre sur une case contenant une mine de proximité armée, elle explose, causant des dégâts de bombe habituels à toutes les créatures dans la case ([[DD]] = 10 + 1/2 la moitié du niveau d'alchimiste du sapeur alchimique + son modificateur d'[[Intelligence]] ; [[jet de sauvegarde|jet de Réflexes]] pour réduire les dégâts de moitié) et des dégâts d'éclaboussure sur les cases adjacentes à ce carré. Une mine de proximité peut être désarmée en réussissant un test de [[Sabotage]] ([[DD]] = 10 + 1/2 niveau d'alchimiste du sapeur alchimique + son modificateur d'[[Intelligence]]) ; sinon, elle reste active jusqu'à ce que l'alchimiste prépare son prochain lot de bombes quotidiennes.

Si le sapeur alchimique dépense quatre utilisations de sa compétence de classe bombes, la mine de proximité fait autant de dégâts qu'une bombe de démolition ; cela ne compte pas comme une utilisation quotidienne de la compétence bombe de démolition. A part la modification de bombe de démolition, les [[découvertes]] qui modifient la mine de proximité ne sont pas applicables.

Ce pouvoir remplace la [[alchimiste#DECOUVERTES|découverte]] gagnée au niveau 6.
...
Ce pouvoir remplace l'[[alchimiste#RESISTPOISON|immunité aux poisons]] du niveau 10.
