---
Name: Pathfinder-RPG.Dragon impérial des mers
Title: Dragon impérial des mers
LastModified: 2024-08-25 15:56
Categories:
- Monstre
- Règle officielle
- Src Bestiaire 3
...
<div class="BD">
{s:BDTitre|Dragon impérial des mers}
{s:pucem|Dragon|Aquatique|Tempéré}
{s:BDTexte|*Source : Bestiaire 3* p.100}
{s:BDTexte|[[type Dragon|Dragon]] ([[sous-type Eau|Eau]]), CB}
{s:BDSousTitre|Statistiques de base}
{s:BDTexte|**FP** 4 ; **Taille** P ; **DV** 5d12}
{s:BDTexte|**VD** 12 m (8 {s:c}), nage 18 m (12 {s:c})}
{s:BDTexte|**Armure naturelle** +5 ; **Souffle** [[cône]], 2d6 feu}
...
{s:BDTexte|**Changement de forme (Sur).** Un jeune dragon des mers, ou un dragon plus âgé, peut prendre n’importe quelle forme humanoïde trois fois par jour, comme s’il utilisait *[[métamorphose]]*.}
{s:BDTexte|**Écumeur des mers (Sur).** Trois fois par jour, par une [[action simple]], un vieux dragon des mers, ou un dragon plus âgé, peut passer d’une étendue d’eau à une autre comme s’il utilisait le sort de *[[téléportation]]* (sur lui-même uniquement).}
{s:BDTexte|**Nageur débridé (Sur).** Le dragon adolescent des mers gagne un bonus de 3 m (2 {s:c}) à sa vitesse de nage. La vitesse de nage du dragon des mers continue d’augmenter de 3 m (2 {s:c}) supplémentaires toutes les deux catégories d’âge. De plus, on considère que le dragon des mers est sous l’effet du sort *[[liberté de mouvement]]* lorsqu’il nage.}
{s:BDTexte|**Raz-de-marée (Sur).** Un grand dracosire des mers peut faire en sorte que la mer se lève et qu'elle écrase ses ennemis une fois par jour par une [[action simple]]. Cette capacité affecte une zone côtière de 36 m (24 {s:c}) de longueur et touche toutes le créatures situées à 12 m (8 {s:c}) ou moins de la côte. L'effet est le même que si les créatures avaient été touchées par une avalanche (voir la section "[[Aventures en extérieur#AVALANCHES|Avalanches]]", considérez que toutes les créatures se trouvent dans la zone de coulée). Le [[DD]] du [[jet de sauvegarde]] permettant de diviser par deux les dégâts est égal à celui du souffle du dragon. Les créatures qui ratent leur [[jet de sauvegarde]] subissent les dégâts entiers, sont emportées à 18 m (12 {s:c}) de la côte et se retrouvent 6 m (4 {s:c}) sous la surface le round après que la vague ait frappé.}
