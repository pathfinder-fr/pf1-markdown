---
Name: Pathfinder-RPG.Créature foo, archétype
Title: Créature foo, archétype
LastModified: 2021-02-22 00:10
---

<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Créer une créature foo|FP +1}
...
rarement pour servir de soldats dans les armées. En général, elles n’apprécient pas non plus de servir de monture, bien qu’elles consentent à faire quelques exceptions pour des gens particulièrement pieux ou bienveillants.

#### Créer une créature foo impériale
Il existe, parmi les créatures foo, ce que l’on nomme des « impériales » : les dirigeants des différentes races de
