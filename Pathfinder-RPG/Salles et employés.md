...
Sauf indication contraire, les employés possèdent des vêtements, quelques pièces d’équipement personnel appropriées à leur spécialité professionnelle et un endroit où vivre ; en d’autres termes, ils ont une vie en dehors du travail au service de votre personnage. Ce dernier peut leur octroyer un équipement de meilleure qualité et leur construire ou leur procurer un endroit où vivre.

Votre personnage n’est pas obligé de recruter tous les employés d’une organisation au même moment. Le prix de recrutement d’une troupe de mendiants et d’une troupe de cambrioleurs reste le même, que votre personnage décide de les recruter en même temps ou l’une tout de suite et l’autre plus tard.
...
Votre personnage peut uniquement recruter des équipes composées d’employés dont le niveau de personnage est inférieur ou égal à sa valeur de Prestige. Si votre personnage ne possède pas ce don, calculez cette valeur en additionnant son niveau et son modificateur de [Charisme](./Charisme.md).
...
Entre autres avantages, la présence de suivants conférée par le don [Prestige](./Prestige.md) permet d’augmenter l’effet de l’[Influence](./Intermèdes.md#Influence) et du [Travail](./Intermèdes.md#Travail) que votre personnage dépense dans une communauté (voir [Utilisation des suivants](./Acquisition des capitaux.md#Utilisation des suivants)). L’influence est le principal capital dépensé pour payer le recrutement des employés et la présence de suivants dans une communauté permet ainsi de propager plus facilement la nouvelle selon laquelle votre personnage souhaite créer une organisation.

Les individus qui travaillent dans l’organisation de votre personnage lui obéissent parce qu’il les rémunère ou tout du moins parce qu’il entretient un contact régulier avec eux et supervise leurs activités. À la différence des cohortes et des suivants obtenus grâce au don [Prestige](./Prestige.md) (ceux-là sont loyaux envers votre personnage grâce à sa réputation et à son comportement), si votre personnage s’absente trop longtemps, il risque de rompre les liens avec ses organisations. Dans le paragraphe sur la phase d’entretien, référez-vous à la troisième étape : [Déterminez l’usure des capitaux](./Phases dintermède.md#4ème étape – Déterminez l’usure des entreprises).

En plus des méthodes applicables pour empêcher l’usure indiquées dans le paragraphe sur la [phase d’entretien](./Phases dintermède.md#Phase d’entretien), le personnage peut résoudre ce problème en intégrant des suivants au sein de ses organisations. Votre personnage peut ajouter automatiquement des suivants dans ses organisations, de la même façon qu’il recrute des employés. Pour chaque groupe de cinq suivants désignés pour devenir membres d’une organisation, le personnage gagne un bonus de +1 à son test de prestige effectué pour prévenir l’usure. Comme la plupart des suivants sont des personnages de bas niveau avec des classes de PNJ, beaucoup ne sont pas formés au combat et sont souvent recrutés en tant qu’[acolytes](./Salles et employés.md#ACOLYTE), [bureaucrates](./Salles et employés.md#BUREAUCRATES), [artisans](./Salles et employés.md#ARTISANS), [laquais](./Salles et employés.md#LAQUAIS), etc. (voir [Les employés](./Salles et employés.md#Récapitulatif des employés)).

{s:Reference|Combiner salles et employés}
#### Combiner salles et employés
Ce système permet à votre personnage de construire un [bâtiment](./Bâtiments et organisations.md#Bâtiments) dans lequel personne ne travaille, de créer une [organisation](./Bâtiments et organisations.md#Organisations) sans base d’opérations ou de combiner les deux pour créer un [bâtiment](./Bâtiments et organisations.md#Bâtiments) doté d’un effectif au grand complet ou une organisation installée dans un quartier général. Par exemple, si votre personnage construit un temple et recrute des acolytes dans la même communauté, il peut mettre les acolytes au travail dans son temple. Si le temple contient une salle dans laquelle les acolytes peuvent dormir, ils peuvent même vivre sur place. Si plus tard, votre personnage désire déplacer les acolytes ou de s’en débarrasser, il possède toujours le temple et peut en disposer comme il lui sied.
...
- *Exemple.* l’[auberge](./Bâtiments et organisations.md#AUBERGE) contient un [bar](./Salles et employés.md#BAR), une [salle commune](./Salles et employés.md#SALLE COMMUNE), une [cuisine](./Salles et employés.md#CUISINE), un [logement](./Salles et employés.md#LOGEMENT) et une [stabulation](./Salles et employés.md#STABULATION). Le bar confère +10 en po et en [Influence](./Intermèdes.md#Influence) ; la salle commune +7 en po et en [Influence](./Intermèdes.md#Influence) ; la cuisine +4 en po et en [Marchandises](./Intermèdes.md#Marchandises) ; le logement +12 en po et la stabulation +8 en po, [Marchandises](./Intermèdes.md#Marchandises) et [Travail](./Intermèdes.md#Travail). Toutes ces salles peuvent produire des po et si votre personnage le souhaite, vous devez simplement faire la somme de leurs bonus (pour un total de +41) et effectuer le test de [travail qualifié](./Acquisition des capitaux.md#Travail qualifié) de l’auberge afin de déterminer le montant de po produit. Si vous souhaitez utiliser le bonus du bar pour produire de l’[Influence](./Intermèdes.md#Influence) et les bonus des autres salles pour produire des po, vous effectuez un test de [travail qualifié](./Acquisition des capitaux.md#Travail qualifié) pour l’[Influence](./Intermèdes.md#Influence) avec un modificateur de +10 (le bonus du bar) et un autre test de travail qualifié pour les po avec un modificateur de +31 (le total des bonus conférés par la salle commune, le logement et la stabulation). 

{s:Reference|Restrictions sur les recettes}
##### <u>Restrictions sur les recettes</u>
La production des capitaux indiqués dans la section recettes d’une unité dépend de vos intentions en ce qui concerne le bâtiment ou l’organisation. Il faut donc faire preuve de bon sens. Par exemple, si votre personnage construit un bâtiment contenant un bar, une salle commune et une cuisine, il peut en faire une taverne ou le quartier général de son groupe d’aventuriers. Si c’est une taverne, elle accueillera des clients et produira des capitaux. Sinon, c’est un lieu privé qui ne produira aucun capital car il est occupé uniquement par votre personnage et ses amis. S’il crée son propre culte en recrutant des acolytes et des curés, il peut décider de tarifer les soins pour produire des recettes. Si sa guilde de voleurs recrute des acolytes, il peut décider que ceux-ci soignent uniquement les membres de la guilde, ce qui ne produira aucune recette.

Si votre personnage prévoit que son bâtiment ou son organisation produise des capitaux, vous devez expliquer au MJ comment il compte procéder. Il peut changer la fonction d’un bâtiment ou d’une organisation (par exemple, en rénovant d’anciens baraquements militaires pour en faire une auberge ou en incitant les membres autrefois avares de son culte à faire désormais preuve de générosité) pour changer le type de capitaux produits. Vous devrez toutefois sélectionner une idée et vous y tenir car une entreprise qui ouvre ses portes de manière sporadique produira moins de recettes, tout comme une autre qui change régulièrement de fonction. Dans de telles circonstances, le MJ peut réduire les capitaux produits par les bâtiments concernés.

{s:Reference|Avantages (pour les salles uniquement)}
#### Avantages (pour les salles uniquement)
Cette section donne la liste des bonus hors système d’intermède que la salle confère, tels que des bonus de compétence ou des changements sur les [modificateurs de communauté](./Villes.md#Les_modificateurs_de_communauté_2) (comme la Corruption, la Criminalité et le Danger). Si une salle confère un bonus de compétence, celui-ci s’applique uniquement lorsque votre personnage se trouve dans la salle en question. Par exemple, ce n’est pas parce que votre personnage possède une salle de bal dans son château qu’il bénéficie de son bonus en [Représentation](./Représentation.md) s’il se trouve dans un donjon.

Le profil ne donne pas la liste des avantages qui ne sont pas liés aux mécanismes de jeu. Par exemple, un bar permet de vendre des boissons, une cuisine de préparer de la nourriture (pour les invités personnels du personnage ou pour des clients contre de l’argent si le bâtiment qui les contient est une auberge) et une bibliothèque magique permet de faire des recherches sur des sorts.

{s:Reference|Création}
#### Création
Cette section donne le montant de [Marchandises](./Intermèdes.md#Marchandises), [Influence](./Intermèdes.md#Influence), [Travail](./Intermèdes.md#Travail) et [Magie](./Intermèdes.md#Magie) qu’il faut dépenser pour construire la salle ou recruter les employés. Est également indiqué une valeur en po qui correspond au prix à payer pour acheter une salle entièrement terminée ou pour recruter des employés prêts à travailler de ce type.

{s:Reference|Durée}
#### Durée
Cette section indique la durée des travaux nécessaires pour terminer la construction de la salle ou la durée du recrutement des employés. Vous pouvez diviser la Durée de construction d’une salle par 2, 3 ou 4 en multipliant par 2, 3 ou 4 le montant de [Travail](./Intermèdes.md#Travail) à dépenser. Vous pouvez également diviser la Durée de recrutement des employés par 2, 3 ou 4 en multipliant par 2, 3 ou 4 le montant d’[Influence](./Intermèdes.md#Influence) à dépenser. Votre personnage doit se trouver dans la communauté au début de la période de construction ou de recrutement, mais il n’a pas à dépenser de jours d’intermède pour la faire débuter. Il doit être présent simplement pour initier l’opération.
...
#### Amélioration
Certaines salles et certains employés sont des variantes ou des versions améliorées d’autres unités. Vous pouvez améliorer la salle ou les employés en les transformant selon les indications données dans cette section, en dépensant la différence de capitaux et de durée entre l’original et la nouvelle version. Par exemple, si votre personnage possède un bâtiment contenant une [bibliothèque](./Salles et employés.md#BIBLIOTHÈQUE) qu’il souhaite améliorer en [bibliothèque magique](./Salles et employés.md#BIBLIOTHÈQUE MAGIQUE), il doit dépenser 1 point de [Marchandises](./Intermèdes.md#Marchandises), 1 point d’[Influence](./Intermèdes.md#Influence), 1 point de [Travail](./Intermèdes.md#Travail) et 2 points de [Magie](./Intermèdes.md#Magie), ou 270 po (la différence entre la création d’une [bibliothèque](./Salles et employés.md#BIBLIOTHÈQUE) et celle d’une [bibliothèque magique](./Salles et employés.md#BIBLIOTHÈQUE MAGIQUE)). Il doit également y consacrer quatre jours (la différence de durée entre une [bibliothèque](./Salles et employés.md#BIBLIOTHÈQUE) et une [bibliothèque magique](./Salles et employés.md#BIBLIOTHÈQUE MAGIQUE)).

Pour chaque type de capitaux, réglez uniquement le prix pour des différences positives. Par exemple, si votre personnage transforme un [dortoir](./Salles et employés.md#DORTOIR) en [logement](./Salles et employés.md#LOGEMENT), vous dépensez 3 points de [Marchandises](./Intermèdes.md#Marchandises), 3 points de [Travail](./Intermèdes.md#Travail) et 6 jours. Même si un logement coûte moins d’[Influence](./Intermèdes.md#Influence), vous ne récupérer pas la différence en effectuant l’amélioration.
...
{s:Reference|Retards sur les constructions et le recrutement}
### Retards sur les constructions et le recrutement
Si la nature de la communauté va à l’encontre du type de bâtiment ou d’organisation que votre personnage tente de construire ou de créer (tel qu’un marché noir ou une guilde de voleurs dans une communauté avec un modificateur de [Criminalité](./Villes.md#Les_modificateurs_de_communauté_2) réduit et un modificateur de [Lois](./Villes.md#Les_modificateurs_de_communauté_2) élevé), le MJ peut décider que cette construction ou ce recrutement prend 1d6 × 10% plus de temps que la normal (1 jour supplémentaire au minimum) si votre personnage ne supervise pas lui-même le travail.

Vous pouvez raccourcir ce délai supplémentaire avant ou pendant la période de retard en dépensant 1 point d’[Influence](./Intermèdes.md#Influence), ce qui le réduit de 1d6 jours (0 jour de retard au minimum).
Votre personnage peut ordonner à un compagnon d’arme de superviser le travail à sa place ou embaucher un [employé compétent](./gestionnaires.md) pour le faire ; l’une ou l’autre de ces options prévient tout risque de retard.
...
Au lieu de délocaliser une organisation entière, votre personnage peut décider de délocaliser une partie seulement des employés qui y travaillent. Par exemple, si deux groupes de [cambrioleurs](./Salles et employés.md#CAMBRIOLEURS) travaillent dans la [guilde de voleurs](./Bâtiments et organisations.md#GUILDE DE VOLEURS) de votre personnage, il peut délocaliser l’un d’eux vers une communauté différente en dépensant 2 points d’[Influence](./Intermèdes.md#Influence) et 1 point de [Travail](./Intermèdes.md#Travail) (la moitié du prix de recrutement d’un groupe de [cambrioleurs](./Salles et employés.md#CAMBRIOLEURS) dans la nouvelle communauté). Tout le reste fonctionne comme si vous délocalisiez une organisation dans son ensemble. Votre personnage peut intégrer ces employés dans une organisation déjà existante dans la nouvelle communauté ou les utiliser pour créer une nouvelle organisation.
...
|+ {s:Reference|TABLE}Liste des salles
|- CLASS="titre"
| Nom
|- CLASS="premier"
| [Abri pour animaux](./Salles et employés.md#ABRI POUR ANIMAUX) || [Bretèche](./Salles et employés.md#BRETÈCHE) || [Crèche](./Salles et employés.md#CRÈCHE) || [Issue de secours](./Salles et employés.md#ISSUE DE SECOURS) || [Poste de travail](./Salles et employés.md#POSTE DE TRAVAIL) || [Salle des trophées](./Salles et employés.md#SALLE DES TROPHÉES)
|-
| [Accès aux égouts](./Salles et employés.md#ACCÈS AUX ÉGOUTS) || [Bureau](./Salles et employés.md#BUREAU) || [Crypte](./Salles et employés.md#CRYPTE) || [Jardin](./Salles et employés.md#JARDIN) || [Quai](./Salles et employés.md#QUAI) || [Salle du trône](./Salles et employés.md#SALLE DU TRÔNE)
|-
| [Armurerie](./Salles et employés.md#ARMURERIE) || [Cabanon](./Salles et employés.md#CABANON) || [Cuisine](./Salles et employés.md#CUISINE) || [Laboratoire d'alchimie](./Salles et employés.md#LABORATOIRE D’ALCHIMIE) || [Reliquaire](./Salles et employés.md#RELIQUAIRE) || [Salle piégée](./Salles et employés.md#SALLE PIÉGÉE)
|-
| [Atelier de couture](./Salles et employés.md#ATELIER DE COUTURE) || [Cellule](./Salles et employés.md#CELLULE) || [Dojo](./Salles et employés.md#DOJO) || [Labyrinthe](./Salles et employés.md#LABYRINTHE) || [Remise](./Salles et employés.md#REMISE) || [Salon](./Salles et employés.md#SALON)
|-
| [Atelier d'artisan](./Salles et employés.md#ATELIER D’ARTISAN) || [Chambre à coucher](./Salles et employés.md#CHAMBREACOUCHER) || [Dôme d'observation](./Salles et employés.md#DÔME D’OBSERVATION) || [Latrines](./Salles et employés.md#LATRINES) || [Salle à mâchicoulis](./Salles et employés.md#SALLE À MÂCHICOULIS) || [Sanctuaire](./Salles et employés.md#SANCTUAIRE)
|-
| [Atelier de mécanique](./Salles et employés.md#ATELIER DE MÉCANIQUE) || [Chambre de divination](./Salles et employés.md#CHAMBRE DE DIVINATION) || [Dortoir](./Salles et employés.md#DORTOIR) || [Lavoir](./Salles et employés.md#LAVOIR) || [Salle commune](./Salles et employés.md#SALLE COMMUNE) || [Sauna](./Salles et employés.md#SAUNA)
|-
| [Atelier de tanneur](./Salles et employés.md#ATELIER DE TANNEUR) || [Chambre de torture](./Salles et employés.md#CHAMBRE DE TORTURE) || [Écloserie](./Salles et employés.md#ÉCLOSERIE) || [Logement](./Salles et employés.md#LOGEMENT) || [Salle de bain](./Salles et employés.md#SALLE DE BAIN) || [Scriptorum](./Salles et employés.md#SCRIPTORIUM)
|-
| [Auditorium](./Salles et employés.md#AUDITORIUM) || [Chambre d'invocation](./Salles et employés.md#CHAMBRE D’INVOCATION) || [Enclos](./Salles et employés.md#ENCLOS) || [Meule](./Salles et employés.md#MEULE) || [Salle de bal](./Salles et employés.md#SALLE DE BAL) || [Serre](./Salles et employés.md#SERRE)
|-
| [Autel](./Salles et employés.md#AUTEL) || [Chambre-forte](./Salles et employés.md#CHAMBRE-FORTE) || [Étalage](./Salles et employés.md#ÉTALAGE) || [Mur défensif](./Salles et employés.md#MUR DÉFENSIF) || [Salle de cérémonie](./Salles et employés.md#SALLE DE CÉRÉMONIE) || [Site funéraire](./Salles et employés.md#SITE FUNÉRAIRE)
|-
| [Bar](./Salles et employés.md#BAR) || [Champ](./Salles et employés.md#CHAMP) || [Forge](./Salles et employés.md#FORGE) || [Péage](./Salles et employés.md#PÉAGE) || [Salle de classe](./Salles et employés.md#SALLE DE CLASSE) || [Société de façade](./Salles et employés.md#SOCIÉTÉ DE FAÇADE)
|-
| [Bibliothèque](./Salles et employés.md#BIBLIOTHÈQUE) || [Clocher](./Salles et employés.md#CLOCHER) || [Fosse](./Salles et employés.md#FOSSE) || [Pièce secrète](./Salles et employés.md#PIÈCE SECRÈTE) || [Salle de combat](./Salles et employés.md#SALLE DE COMBAT) || [Stabulation](./Salles et employés.md#STABULATION)
|-
| [Bibliothèque magique](./Salles et employés.md#BIBLIOTHÈQUE MAGIQUE) || [Confessionnal](./Salles et employés.md#CONFESSIONNAL) || [Imprimerie](./Salles et employés.md#IMPRIMERIE) || [Pont-levis](./Salles et employés.md#PONT-LEVIS) || [Salle de guerre](./Salles et employés.md#SALLE DE GUERRE) || [Statue](./Salles et employés.md#STATUE)
|-
| [Brasserie](./Salles et employés.md#BRASSERIE) || [Cour](./Salles et employés.md#COUR) || [Infirmerie](./Salles et employés.md#INFIRMERIE) || [Poste de garde](./Salles et employés.md#POSTE DE GARDE) || [Salle de jeux](./Salles et employés.md#SALLE DE JEUX) || [Terrain de sport](./Salles et employés.md#TERRAIN DE SPORT)
|}
...
{s:Reference|Extensions de salle}
### Les extensions de salle
Les extensions augmentent la productivité, la solidité ou l’utilité d’une salle. Elles sont permanentes et ne peuvent être retirées. Si vous améliorez une salle qui bénéficie d’une extension, cette extension s’applique aussi à l’amélioration, en revanche, son prix ne rentre pas en compte lorsqu’il s’agit de calculer la différence entre la valeur de la salle de base et celle de son amélioration.

Une salle peut bénéficier de plusieurs extensions du moment qu’elles sont différentes.
...
{s:Reference|PIÈGE}
<div class=BD>
{s:BDTitre|Piège (extension)|{s:GC}}
Le prix d’une extension de piège dans une salle est le même que celui d’une salle piégée ; voir [salle piégée](./Salles et employés.md#SALLE PIÉGÉE).
</div>

</td></tr></table>

{s:Reference|Employés}
### Les employés
...
{| CLASS="tablo centre autoalt toutgauche" WIDTH="96%"
|+ {s:Reference|TABLE}Liste des employés
|- CLASS="titre"
| Nom
|- CLASS="premier"
| [Acolyte](./Salles et employés.md#ACOLYTE) || [Artisans](./Salles et employés.md#ARTISANS) || [Curé](./Salles et employés.md#CURÉ) || [Laquais](./Salles et employés.md#LAQUAIS) || [Soldats](./Salles et employés.md#SOLDATS)
|-
| [Apprenti-mage](./Salles et employés.md#APPRENTI-MAGE) || [Bureaucrates](./Salles et employés.md#BUREAUCRATES) || [Fraudeurs](./Salles et employés.md#FRAUDEURS) || [Mage](./Salles et employés.md#MAGE) || [Soldats d’élite](./Salles et employés.md#SOLDATS D’ÉLITE)
|-
| [Archers](./Salles et employés.md#ARCHERS) || [Cambrioleurs](./Salles et employés.md#CAMBRIOLEURS) || [Gardes](./Salles et employés.md#GARDES) || [Marins](./Salles et employés.md#MARINS) || [Tire-laine](./Salles et employés.md#TIRE-LAINE)
|-
| [Archers d’élite](./Salles et employés.md#ARCHERS D’ÉLITE) || [Cavaliers](./Salles et employés.md#CAVALIERS) || [Gardes d’élite](./Salles et employés.md#GARDES D’ÉLITE) || [Sage](./Salles et employés.md#SAGE) || [Travailleurs](./Salles et employés.md#TRAVAILLEURS)
|-
| [Archers montés](./Salles et employés.md#ARCHERS MONTÉS) || [Conducteur d’attelage](./Salles et employés.md#CONDUCTEUR D’ATTELAGE) || &emsp; || &emsp; || &emsp;
|}
