...
Chaque salle ou employé coûte un certain montant d’un ou plusieurs types de capitaux (po, [[Intermèdes#Marchandises|Marchandises]], [[Intermèdes#Influence|Influence]], [[Intermèdes#Travail|Travail]] ou [[Intermèdes#Magie|Magie]]). Lorsque votre personnage construit un bâtiment ou créer une organisation, sélectionnez les salles ou les employés de votre choix, faites la somme de leurs prix en po, [[Intermèdes#Marchandises|Marchandises]], [[Intermèdes#Influence|Influence]], [[Intermèdes#Travail|Travail]] et [[Intermèdes#Magie|Magie]] et dépensez les capitaux correspondants pour débuter la construction ou le recrutement.
...
Entre autres avantages, la présence de suivants conférée par le don [[Prestige]] permet d’augmenter l’effet de l’[[Intermèdes#Influence|Influence]] et du [[Intermèdes#Travail|Travail]] que votre personnage dépense dans une communauté (voir [[Acquisition des capitaux#Utilisation des suivants|Utilisation des suivants]]). L’influence est le principal capital dépensé pour payer le recrutement des employés et la présence de suivants dans une communauté permet ainsi de propager plus facilement la nouvelle selon laquelle votre personnage souhaite créer une organisation.
...
#### Recettes
Cette section indique les bonus que la salle ou les employés confèrent aux tests effectués lorsque l’organisation ou le bâtiment produit des capitaux. Les bâtiments et les organisations sont traités comme des personnages, en ce qu’ils peuvent effectuer un test par jour pour produire des capitaux par le biais d’un [[Acquisition des capitaux#Travail qualifié|travail qualifié]] (sans que le personnage n’ait à y consacrer de période d’intermède). Le personnage doit tout de même payer les [[Acquisition des capitaux#Valeurs des capitaux|coûts occasionnés]] par ce type d’acquisition de capitaux.

Si la section d’une salle ou d’un type d’employés indique « Capitaux » suivi d’un nombre, cela signifie que la salle ou les employés confèrent un bonus aux tests de [[Acquisition des capitaux#Travail qualifié|travail qualifié]] effectués pour produire n’importe quel type de capitaux (po, [[Intermèdes#Marchandises|Marchandises]], [[Intermèdes#Influence|Influence]], [[Intermèdes#Travail|Travail]] ou [[Intermèdes#Magie|Magie]]). Si la section Recettes indique certains types de capitaux, cela signifie que la salle ou les employés confèrent un bonus aux tests de travail qualifié effectués pour produire uniquement les types de capitaux précisés. Chaque jour, vous pouvez appliquer la totalité du bonus conféré par une salle ou par des employés à un unique type de capital indiqué dans l’occurrence ou le répartir sur différents types de capitaux indiqués. Par exemple, un laboratoire d’alchimie peut produire des po, des [[Intermèdes#Marchandises|Marchandises]] ou de la [[Intermèdes#Magie|Magie]], mais ni [[Intermèdes#Influence|Influence]] ni [[Intermèdes#Travail|Travail]]. Pendant une journée, vous pouvez appliquer la totalité du bonus de +10 conféré par cette salle au test de capital du bâtiment pour produire des po et le jour d’après, appliquer un bonus de +5 au test pour générer des po et un autre bonus de +5 au test pour générer des [[Intermèdes#Marchandises|Marchandises]], par exemple.
...
Cette section donne la liste des bonus hors système d’intermède que la salle confère, tels que des bonus de compétence ou des changements sur les [[Villes#Les_modificateurs_de_communauté_2|modificateurs de communauté]] (comme la Corruption, la Criminalité et le Danger). Si une salle confère un bonus de compétence, celui-ci s’applique uniquement lorsque votre personnage se trouve dans la salle en question. Par exemple, ce n’est pas parce que votre personnage possède une salle de bal dans son château qu’il bénéficie de son bonus en [[Représentation]] s’il se trouve dans un donjon.
...
{s:Reference|Durée}
#### Durée
Cette section indique la durée des travaux nécessaires pour terminer la construction de la salle ou la durée du recrutement des employés. Vous pouvez diviser la Durée de construction d’une salle par 2, 3 ou 4 en multipliant par 2, 3 ou 4 le montant de [[Intermèdes#Travail|Travail]] à dépenser. Vous pouvez également diviser la Durée de recrutement des employés par 2, 3 ou 4 en multipliant par 2, 3 ou 4 le montant d’[[Intermèdes#Influence|Influence]] à dépenser. Votre personnage doit se trouver dans la communauté au début de la période de construction ou de recrutement, mais il n’a pas à dépenser de jours d’intermède pour la faire débuter. Il doit être présent simplement pour initier l’opération.
...
#### Amélioration
Certaines salles et certains employés sont des variantes ou des versions améliorées d’autres unités. Vous pouvez améliorer la salle ou les employés en les transformant selon les indications données dans cette section, en dépensant la différence de capitaux et de durée entre l’original et la nouvelle version. Par exemple, si votre personnage possède un bâtiment contenant une [[Salles et employés#BIBLIOTHÈQUE|bibliothèque]] qu’il souhaite améliorer en [[Salles et employés#BIBLIOTHÈQUE MAGIQUE|bibliothèque magique]], il doit dépenser 1 point de [[Intermèdes#Marchandises|Marchandises]], 1 point d’[[Intermèdes#Influence|Influence]], 1 point de [[Intermèdes#Travail|Travail]] et 2 points de [[Intermèdes#Magie|Magie]], ou 270 po (la différence entre la création d’une [[Salles et employés#BIBLIOTHÈQUE|bibliothèque]] et celle d’une [[Salles et employés#BIBLIOTHÈQUE MAGIQUE|bibliothèque magique]]). Il doit également y consacrer quatre jours (la différence de durée entre une [[Salles et employés#BIBLIOTHÈQUE|bibliothèque]] et une [[Salles et employés#BIBLIOTHÈQUE MAGIQUE|bibliothèque magique]]).
...
| Nom
|- CLASS="premier"
| [[Salles et employés#ABRI POUR ANIMAUX|Abri pour animaux]] || [[Salles et employés#BRETÈCHE|Bretèche]] || [[Salles et employés#CRÈCHE|Crèche]] || [[Salles et employés#ISSUE DE SECOURS|Issue de secours]] || [[Salles et employés#POSTE DE TRAVAIL|Poste de travail]] || [[Salles et employés#SALLE DES TROPHÉES|Salle des trophées]]
|-
| [[Salles et employés#ACCÈS AUX ÉGOUTS|Accès aux égouts]] || [[Salles et employés#BUREAU|Bureau]] || [[Salles et employés#CRYPTE|Crypte]] || [[Salles et employés#JARDIN|Jardin]] || [[Salles et employés#QUAI|Quai]] || [[Salles et employés#SALLE DU TRÔNE|Salle du trône]]
|-
| [[Salles et employés#ARMURERIE|Armurerie]] || [[Salles et employés#CABANON|Cabanon]] || [[Salles et employés#CUISINE|Cuisine]] || [[Salles et employés#LABORATOIRE D’ALCHIMIE|Laboratoire d'alchimie]] || [[Salles et employés#RELIQUAIRE|Reliquaire]] || [[Salles et employés#SALLE PIÉGÉE|Salle piégée]]
|-
| [[Salles et employés#ATELIER DE COUTURE|Atelier de couture]] || [[Salles et employés#CELLULE|Cellule]] || [[Salles et employés#DOJO|Dojo]] || [[Salles et employés#LABYRINTHE|Labyrinthe]] || [[Salles et employés#REMISE|Remise]] || [[Salles et employés#SALON|Salon]]
|-
| [[Salles et employés#ATELIER D’ARTISAN|Atelier d'artisan]] || [[Salles et employés#CHAMBREACOUCHER|Chambre à coucher]] || [[Salles et employés#DÔME D’OBSERVATION|Dôme d'observation]] || [[Salles et employés#LATRINES|Latrines]] || [[Salles et employés#SALLE À MÂCHICOULIS|Salle à mâchicoulis]] || [[Salles et employés#SANCTUAIRE|Sanctuaire]]
|-
| [[Salles et employés#ATELIER DE MÉCANIQUE|Atelier de mécanique]] || [[Salles et employés#CHAMBRE DE DIVINATION|Chambre de divination]] || [[Salles et employés#DORTOIR|Dortoir]] || [[Salles et employés#LAVOIR|Lavoir]] || [[Salles et employés#SALLE COMMUNE|Salle commune]] || [[Salles et employés#SAUNA|Sauna]]
|-
| [[Salles et employés#ATELIER DE TANNEUR|Atelier de tanneur]] || [[Salles et employés#CHAMBRE DE TORTURE|Chambre de torture]] || [[Salles et employés#ÉCLOSERIE|Écloserie]] || [[Salles et employés#LOGEMENT|Logement]] || [[Salles et employés#SALLE DE BAIN|Salle de bain]] || [[Salles et employés#SCRIPTORIUM|Scriptorum]]
|-
| [[Salles et employés#AUDITORIUM|Auditorium]] || [[Salles et employés#CHAMBRE D’INVOCATION|Chambre d'invocation]] || [[Salles et employés#ENCLOS|Enclos]] || [[Salles et employés#MEULE|Meule]] || [[Salles et employés#SALLE DE BAL|Salle de bal]] || [[Salles et employés#SERRE|Serre]]
|-
| [[Salles et employés#AUTEL|Autel]] || [[Salles et employés#CHAMBRE-FORTE|Chambre-forte]] || [[Salles et employés#ÉTALAGE|Étalage]] || [[Salles et employés#MUR DÉFENSIF|Mur défensif]] || [[Salles et employés#SALLE DE CÉRÉMONIE|Salle de cérémonie]] || [[Salles et employés#SITE FUNÉRAIRE|Site funéraire]]
|-
| [[Salles et employés#BAR|Bar]] || [[Salles et employés#CHAMP|Champ]] || [[Salles et employés#FORGE|Forge]] || [[Salles et employés#PÉAGE|Péage]] || [[Salles et employés#SALLE DE CLASSE|Salle de classe]] || [[Salles et employés#SOCIÉTÉ DE FAÇADE|Société de façade]]
|-
| [[Salles et employés#BIBLIOTHÈQUE|Bibliothèque]] || [[Salles et employés#CLOCHER|Clocher]] || [[Salles et employés#FOSSE|Fosse]] || [[Salles et employés#PIÈCE SECRÈTE|Pièce secrète]] || [[Salles et employés#SALLE DE COMBAT|Salle de combat]] || [[Salles et employés#STABULATION|Stabulation]]
|-
| [[Salles et employés#BIBLIOTHÈQUE MAGIQUE|Bibliothèque magique]] || [[Salles et employés#CONFESSIONNAL|Confessionnal]] || [[Salles et employés#IMPRIMERIE|Imprimerie]] || [[Salles et employés#PONT-LEVIS|Pont-levis]] || [[Salles et employés#SALLE DE GUERRE|Salle de guerre]] || [[Salles et employés#STATUE|Statue]]
|-
| [[Salles et employés#BRASSERIE|Brasserie]] || [[Salles et employés#COUR|Cour]] || [[Salles et employés#INFIRMERIE|Infirmerie]] || [[Salles et employés#POSTE DE GARDE|Poste de garde]] || [[Salles et employés#SALLE DE JEUX|Salle de jeux]] || [[Salles et employés#TERRAIN DE SPORT|Terrain de sport]]
|}
...
Le prix d’une extension de piège dans une salle est le même que celui d’une salle piégée ; voir [[Salles et employés#SALLE PIÉGÉE|salle piégée]].
</div>
...
| Nom
|- CLASS="premier"
| [[Salles et employés#ACOLYTE|Acolyte]] || [[Salles et employés#ARTISANS|Artisans]] || [[Salles et employés#CURÉ|Curé]] || [[Salles et employés#LAQUAIS|Laquais]] || [[Salles et employés#SOLDATS|Soldats]]
|-
| [[Salles et employés#APPRENTI-MAGE|Apprenti-mage]] || [[Salles et employés#BUREAUCRATES|Bureaucrates]] || [[Salles et employés#FRAUDEURS|Fraudeurs]] || [[Salles et employés#MAGE|Mage]] || [[Salles et employés#SOLDATS D’ÉLITE|Soldats d’élite]]
|-
| [[Salles et employés#ARCHERS|Archers]] || [[Salles et employés#CAMBRIOLEURS|Cambrioleurs]] || [[Salles et employés#GARDES|Gardes]] || [[Salles et employés#MARINS|Marins]] || [[Salles et employés#TIRE-LAINE|Tire-laine]]
|-
| [[Salles et employés#ARCHERS D’ÉLITE|Archers d’élite]] || [[Salles et employés#CAVALIERS|Cavaliers]] || [[Salles et employés#GARDES D’ÉLITE|Gardes d’élite]] || [[Salles et employés#SAGE|Sage]] || [[Salles et employés#TRAVAILLEURS|Travailleurs]]
|-
| [[Salles et employés#ARCHERS MONTÉS|Archers montés]] || [[Salles et employés#CONDUCTEUR D’ATTELAGE|Conducteur d’attelage]] || &emsp; || &emsp; || &emsp;
|}
