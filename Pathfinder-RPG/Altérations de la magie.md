---
Name: Pathfinder-RPG.Altérations de la magie
Title: Altérations de la magie
LastModified: 2023-07-28 18:51
Categories:
- Src Pathfinder unchained
---

{s:MenuPathfinderunchained}<nav class="wiki-toc"></nav>Les règles optionnelles qui suivent altèrent les règles d’incantation normales de manière inédite et amusante. Chacun de ces systèmes s’appuie sur un concept assez simple pouvant néanmoins générer des ramifications qui ne sont pas entièrement détaillées ici. Les MJ devraient donc se préparer à concilier ou à arbitrer les effets inattendus.

{s:Reference|MAGIELIMITEE}
### La magie limitée
...
### L'incantation active
D’après les règles de base, un lanceur de sorts est assez passif quand il résout les effets de ses sorts. Il annonce le sort qu’il lance tandis que les cibles font leur jet de sauvegarde en réaction, ce qui est peu comparable au système des attaques combat où l’agresseur lance tous les dés. Les variantes qui suivent aideront les utilisateurs de magie à se sentir plus impliqués dans la résolution des effets de leurs sorts.
