---
Name: Pathfinder-RPG.Lacridaémon
Title: Daémon, Lacridaémon
...
{s:BDTexte|**RD** 5/Bien et argent ; **Immunité** acide, effets de mort, maladie, poison ; **Résistance** froid 10,  électricité 10, feu 10  ; **RM** 14}
(((Attaque)))
{s:BDTexte|**VD** 12m}
{s:BDTexte|**Corps à corps** morsure, +6 (1d4+2 plus 1d4 acide et poison); 2 griffes, +7 (1d4+2 plus 1d4 acide) }
...
{s:BDTexte|**Organisation** solitaire, couple ou affût (3–6)}
{s:BDTexte|**Trésor** standard}
(((Pouvoirs spéciaux)))
{s:BDTexte|**Larmes empoisonnées (Sur)** Les larmes d’un lacridaémon sont
...
{s:BDTexte|**Aura éplorée (Sur)** Il émane d’un lacridaémon une aura invisible qui
...
son corps. Ses larmes grésillent violemment en touchant le sol.''

Les lacridaémons figurent parmi les fiélons les moins puissants
