---
Name: Pathfinder-RPG.Sorts doccultiste
Title: Liste des sorts d'occultiste
LastModified: 2025-01-11 16:12
Categories:
- Règle officielle
- Sort
...
- ***[[Détection dimportance psychique|Détection d'importance psychique]]*** *(AO)*. Trouve les objets à charge psychique.
...
- ***[[Lecture dobjet|Lecture d'objet]]*** *(AO)*. Lit les impressions psychiques laissées sur un objet.
...
- ***[[Négation de larôme|Négation de l'arôme]]*** *(MJRA)*. Impossible de traquer le personnage à l’ôdeur.
...
#### Divination
- ***[[Analyse daura|Analyse d'aura]]*** *(AO)*. Déchiffre les auras d’alignement, d’émotion, de santé et de magie d’une créature ou d’un objet.
...
- ***[[Effacement dimpression|Effacement d'impression]]*** *(AO)*. Efface les impressions psychiques émanant d’un objet.
...
- ***[[Traquer laura|Traquer l'aura]]*** *(MJRA)*. Permet de suivre la piste laissée par l'aura d'un alignement.
...
- ***[[Flèche de laube|Flèche de l'aube]] (Y)*** *(AG)*. Les munitions ciblées émettent une énergie radieuse.
...
- ***[[Négation de linvisibilité|Négation de l'invisibilité]]***. Dissipe l'invisibilité sur 1,50 m/niveau.
...
- ***[[Modification daura|Modification d'aura]]*** *(AO)*. Masque les auras d’alignement, d’émotion, de santé et de magie d’une créature ou d’un objet.
...
- ***[[sort Résistance à la magie|Résistance à la magie]]***. Le sujet gagne une RM de 12, +1/niveau.
...
- ***[[Animation dobjets|Animation d'objets]] (Y)***. Les objets attaquent les adversaires du PJ.
