---
Name: Pathfinder-RPG.Domination danimal
Title: Domination d'animal
...
*Domination d’animal* établit un lien mental entre le lanceur de sorts et l’[[type animal|animal]] dominé. Ce dernier peut être contrôlé télépathiquement tant qu’il reste dans les limites de portée du sort, même si le personnage ne peut pas le voir. Le lanceur de sorts ne reçoit pas les informations que l’animal perçoit grâce à ses cinq sens mais il sait ce que ce dernier ressent à tout moment. Comme l’animal dominé est guidé par un lanceur de sorts intelligent, il peut entreprendre des actions qui lui seraient impossibles en temps normal. Le personnage n’a pas besoin de rester [[concentration|concentré]] pour contrôler l’animal ; par contre, cela devient nécessaire s’il le guide pour accomplir une tâche dont il ne serait normalement pas capable. Une [[action de mouvement]] est nécessaire pour modifier les instructions données ou donner un nouvel ordre (cela revient à rediriger le sort).
