...
{s:BDTexte|**PX** 9.600}
{s:BDTexte|[[type Fée|Fée]] ([[sous-type Eau|Eau]]) de taille M, CN}
{s:BDTexte|**Init** +9 ; **Sens** [[vision nocturne]] ; [[Perception]] +21}
...
{s:BDSorts|A volonté — *[[Contrôle de leau|contrôle de l'eau]]*, *[[suggestion]]* (DD 18 ; uniquement sur les créatures fascinées par son aura enchanteresse) }
{s:BDSorts|1/jour — *[[convocation de monstres VI]]* (élémentaires de l’Eau uniquement)}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 11, **Dex** 29, **Con** 24, **Int** 14, **Sag** 22, **Cha** 21}
{s:BDTexte|**BBA** +6, **BMO** +15, **DMD** 37}
{s:BDTexte|**Dons** [[Attaque en finesse]], [[Attaque spéciale renforcée]] (aura enchanteresse), [[Esquive]], [[Maîtrise du combat défensif]], [[Manœuvres agiles]], [[Souplesse du serpent]]}
{s:BDTexte|**Compétences** [[Bluff]] +20, [[Connaissances]] (nature) +17, [[Discrétion]] +24, [[Évasion]] +24, [[Natation]] +23, [[Perception]] +21, [[Psychologie]] +21, [[Représentation]] (chant) +20}
{s:BDTexte|**Langues** aquatique, commun, sylvestre}
{s:BDTexte|**Particularités** changement de forme (élémentaire de l’Eau de taille M, [[corps élémentaire II]]), grâce surnaturelle}
...
Pour détruire ou dérober le châle d’une néréide, il faut utiliser une manoeuvre de [[Manœuvres offensives#DESTRUCTION|destruction]] ou de [[Manœuvres offensives#DESARMEMENT|désarmement]].}
{s:BDTexte|**Grâce surnaturelle (Sur).** Une néréide ajoute son bonus de [[Charisme]] comme bonus de parade à sa [[CA]] et à son [[DMD]] si elle ne porte aucune armure.}
...
Elle peut devenir visible ou transparente à volonté par une [[action libre]].}
</div>
