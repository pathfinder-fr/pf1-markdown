...
Au niveau 1, un combattant intuitif peut effectuer une [[action de mouvement]] pour bénéficier des avantages d’un don de combat qu’il ne possède pas. Cet effet dure une minute. Le combattant intuitif doit par ailleurs satisfaire toutes les conditions requises par ce don. Il peut utiliser cette aptitude un nombre de fois par jour égal à 3 + la moitié de son niveau d’oracle.

Le combattant intuitif peut utiliser cette aptitude à nouveau avant que la durée n’arrive à son terme pour remplacer le don de combat par un autre de son choix. Si un don de combat est doté d’une limite en termes d’utilisations quotidiennes ([[Coup étourdissant]] par exemple), toutes les utilisations de ce don de combat dépensées pendant qu’il utilise cette aptitude sont défalquées du nombre d’utilisations quotidiennes du don. Aux niveaux suivants, quand il acquiert plusieurs dons grâce
...
même temps. Il peut choisir un don par une [[action rapide]] ou deux dons par une [[action de mouvement]].

Au niveau 11, un combattant intuitif peut utiliser cette aptitude pour bénéficier des avantages de trois dons de combat en même temps. Il peut choisir un don par une [[action libre]], deux dons par une action rapide ou trois dons par une action de mouvement.
