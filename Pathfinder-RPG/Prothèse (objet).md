---
Name: Pathfinder-RPG.Prothèse (objet)
Title: Prothèse
...
{s:AE}**Prix** 1 po (main), 1 po (pied), 10 po (bras), 20 po (jambe) ; **Poids** 0,5 kg (main), 1 kg (pied), 1,5 kg (bras), 3 kg (jambe)<sup>[1](./Équipement daventurier.md#1)</sup>
