---
Name: Pathfinder-RPG.Familiers temporaires
Title: Familiers temporaires
LastModified: 2012-11-11 12:10
---

Un familier est un animal adopté par un lanceur de sorts dans le but de l’aider dans son étude de la magie. Il conserve l’apparence, les [dés de vie](./dés de vie.md), le [bonus de base à l’attaque](./BBA.md), les bonus de base aux [jets de sauvegarde](./jet de sauvegarde.md), les [compétences](./Compétences.md) et les [dons](./Dons.md) de l’animal normal qu’il était autrefois mais est désormais considéré comme une [créature magique](./type Créature magique.md) lorsqu’il s’agit de lui appliquer des effets qui dépendent du type de créature. Seul un animal normal sans modification spéciale peut devenir un familier. Un animal ne peut être à la fois [compagnon animal](./compagnon animal.md) et familier.
...
|- CLASS="premier"
| [Araignée écarlate](./Araignée écarlate.md)<sup>*UM*</sup>
| CLASS="gauche" | Le maître gagne un bonus de +3 aux tests d’[Escalade](./Escalade.md)
|- CLASS="alt"
| [Belette](./Belette.md)
| CLASS="gauche" | Le maître obtient un bonus de +2 aux jets de [Réflexes](./Réflexes.md).
|-
| [Chat](./Chat.md)
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [Discrétion](./Discrétion.md).
|- CLASS="alt"
| [Chauve-souris](./Chauve-souris.md)
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [Vol](./Vol.md).
|-
| [Chèvre](./Chèvre.md)<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +3 aux jets de [Survie](./Survie.md).
|- CLASS="alt"
| [Chouette](./Chouette.md)
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [Perception](./Perception.md)   
opposés ou dépendant de la vue dans l’obscurité ou les zones d’ombres.
|-
| [Cochon](./Cochon.md)<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [Diplomatie](./Diplomatie.md).
|- CLASS="alt"
| [Corbeau](./Corbeau.md)<sup>*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests d’[Estimation](./Estimation.md).
|-
| [Crabe royal](./Crabe royal.md)<sup>*UM*</sup>
| CLASS="gauche" | Le maître gagne un bonus de +2 aux tests de [BMO](./BMO.md) pour démarrer et maintenir une [lutte](./lutte.md)
|- CLASS="alt"
| [Crapaud](./Crapaud.md)
| CLASS="gauche" | Le maître obtient +3 [points de vie](./pv.md).
|-
| [Faucon](./Faucon.md)
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [Perception](./Perception.md)   
opposés ou dépendant de la vue sous une lumière vive.
|- CLASS="alt"
| [Grive](./Grive.md)<sup>*UM*</sup> <sup>**</sup>
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [Diplomatie](./Diplomatie.md)
|-
| [Hérisson](./Hérisson.md)<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +2 aux jets de [Volonté](./Volonté.md).
|- CLASS="alt"
| [Lézard](./Lézard.md)
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests d’[Escalade](./Escalade.md).
|-
| [Mille-pattes domestique](./Mille-pattes domestique.md)<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +3 aux jets de [Discrétion](./Discrétion.md).
|- CLASS="alt"
| [Pieuvre](./Pieuvre.md)
| CLASS="gauche" | Le maître obtient un bonus de +3 aux jets de [Natation](./Natation.md).
|-
| [Pieuvre à anneaux bleus](./Pieuvre à anneaux bleus.md)<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient +3 aux jets de [Natation](./Natation.md).
|- CLASS="alt"
| [Rat](./Rat.md)
| CLASS="gauche" | Le maître obtient un bonus de +2 aux jets de [Vigueur](./Vigueur.md).
|-
| [Rat-âne](./Rat-âne.md)<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +2 aux jets de [Vigueur](./Vigueur.md).
|- CLASS="alt"
| [Renard](./Renard.md)<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +2 aux jets de [Réflexes](./Réflexes.md).
|-
| [Scorpion vert](./Scorpion vert.md)
| CLASS="gauche" | Le maître obtient un bonus de +4 aux jets d’[Initiative](./initiative.md).
|- CLASS="alt"
| [Singe](./Singe.md)
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests d’[Acrobaties](./Acrobaties.md).
|-
| [Tortue](./Tortue.md)<sup>*UM*</sup>
| CLASS="gauche" | Le maître gagne un bonus d’armure naturelle de +1 à la [CA](./CA.md).
|- CLASS="alt"
| [Vipère](./Vipère.md)
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [Bluff](./Bluff.md).
|-
| COLSPAN="3" CLASS="note" | *(*) Un familier corbeau peut parler une langue (choisie par son maître). C’est un pouvoir surnaturel.  
(**) Une grive peut apprendre une des langues de son maître comme pouvoir surnaturel*
|}
</center>

### Profil des familiers
Pour déterminer le profil du familier, partez de celui d’une créature de la même espèce (comme présenté dans le *[Bestiaire](./../_Snippets/Monstre.md)*) puis apportez-y les modifications suivantes.
...
| +1
| 6
| CLASS="gauche" | [Esquive extraordinaire](./Familiers.md#ESQUIVEEXTRAORDINAIRE), [transfert de sorts](./Familiers.md#TRANSFERTDESORTS), [lien empathique](./Familiers.md#LIENEMPATHIQUE), [vigilance](./Familiers.md#VIGILANCE)
|- CLASS="alt"
| 3-4
| +2
| 7
