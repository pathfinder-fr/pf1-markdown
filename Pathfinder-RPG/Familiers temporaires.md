...
Un familier est un animal adopté par un lanceur de sorts dans le but de l’aider dans son étude de la magie. Il conserve l’apparence, les [[dés de vie]], le [[BBA|bonus de base à l’attaque]], les bonus de base aux [[jet de sauvegarde|jets de sauvegarde]], les [[compétences]] et les [[dons]] de l’animal normal qu’il était autrefois mais est désormais considéré comme une [[type Créature magique|créature magique]] lorsqu’il s’agit de lui appliquer des effets qui dépendent du type de créature. Seul un animal normal sans modification spéciale peut devenir un familier. Un animal ne peut être à la fois [[compagnon animal]] et familier.
...
|- CLASS="premier"
| [[Araignée écarlate]]<sup>*UM*</sup>
| CLASS="gauche" | Le maître gagne un bonus de +3 aux tests d’[[Escalade]]
|- CLASS="alt"
| [[Belette]]
| CLASS="gauche" | Le maître obtient un bonus de +2 aux jets de [[Réflexes]].
|-
| [[Chat]]
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [[Discrétion]].
|- CLASS="alt"
| [[Chauve-souris]]
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [[Vol]].
|-
| [[Chèvre]]<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +3 aux jets de [[Survie]].
|- CLASS="alt"
| [[Chouette]]
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [[Perception]]   
opposés ou dépendant de la vue dans l’obscurité ou les zones d’ombres.
|-
| [[Cochon]]<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [[Diplomatie]].
|- CLASS="alt"
| [[Corbeau]]<sup>*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests d’[[Estimation]].
|-
| [[Crabe royal]]<sup>*UM*</sup>
| CLASS="gauche" | Le maître gagne un bonus de +2 aux tests de [[BMO]] pour démarrer et maintenir une [[lutte]]
|- CLASS="alt"
| [[Crapaud]]
| CLASS="gauche" | Le maître obtient +3 [[pv|points de vie]].
|-
| [[Faucon]]
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [[Perception]]   
opposés ou dépendant de la vue sous une lumière vive.
|- CLASS="alt"
| [[Grive]]<sup>*UM*</sup> <sup>**</sup>
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [[Diplomatie]]
|-
| [[Hérisson]]<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +2 aux jets de [[Volonté]].
|- CLASS="alt"
| [[Lézard]]
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests d’[[Escalade]].
|-
| [[Mille-pattes domestique]]<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +3 aux jets de [[Discrétion]].
|- CLASS="alt"
| [[Pieuvre]]
| CLASS="gauche" | Le maître obtient un bonus de +3 aux jets de [[Natation]].
|-
| [[Pieuvre à anneaux bleus]]<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient +3 aux jets de [[Natation]].
|- CLASS="alt"
| [[Rat]]
| CLASS="gauche" | Le maître obtient un bonus de +2 aux jets de [[Vigueur]].
|-
| [[Rat-âne]]<sup>*UM*</sup>
| CLASS="gauche" | Le maître obtient un bonus de +2 aux jets de [[Vigueur]].
|- CLASS="alt"
...
|-
| [[Scorpion vert]]
| CLASS="gauche" | Le maître obtient un bonus de +4 aux jets d’[[Initiative]].
|- CLASS="alt"
| [[Singe]]
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests d’[[Acrobaties]].
|-
| [[Tortue]]<sup>*UM*</sup>
| CLASS="gauche" | Le maître gagne un bonus d’armure naturelle de +1 à la [[CA]].
|- CLASS="alt"
| [[Vipère]]
| CLASS="gauche" | Le maître obtient un bonus de +3 aux tests de [[Bluff]].
|-
...
Pour déterminer le profil du familier, partez de celui d’une créature de la même espèce (comme présenté dans le *[[Monstre|Bestiaire]]*) puis apportez-y les modifications suivantes.
...
| +1
| 6
| CLASS="gauche" | [[Familiers#ESQUIVEEXTRAORDINAIRE|Esquive extraordinaire]], [[Familiers#TRANSFERTDESORTS|transfert de sorts]], [[Familiers#LIENEMPATHIQUE|lien empathique]], [[Familiers#VIGILANCE|vigilance]]
|- CLASS="alt"
| 3-4
| +2
| 7
