---
Name: Pathfinder-RPG.Ifrit (race)
Title: Les ifrits
LastModified: 2025-01-15 17:11
Categories:
- Race
- Règle officielle
...
{s:menuracesadditionnelles}<div style="background-color: #fff; float: right; padding: 0 0 8px 8px"><nav class="wiki-toc"></nav></div>{s:MR}***Voir aussi la [[Ifrit|fiche de créature]] d'un ifrit standard.***
...
- **Extérieur natif.** Les ifrits sont des [[type Extérieur|extérieurs]] de sous-type [[sous-type natif|natif]].
- **Taille M.** Les ifrits sont des créatures de [[taille M]] qui ne reçoivent ni bonus ni malus de taille.
- **Vitesse normale.** Les ifrits ont une [[VD|vitesse de base]] de 9 mètres.
- **Vision dans le noir.** Les ifrits [[Vision dans le noir (capacité)|voient dans le noir]] à 18 mètres.
- **Pouvoir magique.** Les ifrits peuvent utiliser *[[mains brûlantes]]* comme un [[Pouvoirs magiques (capacité)|pouvoir magique]] 1/jour ([[NLS|niveau de lanceur de sorts]] égal au niveau de personnage de l’ifrit ; DD 11 + modificateur de [[Charisme]]).
- **Résistance élémentaire.** Les ifrits ont une [[Résistance (capacité)|résistance]] de 5 au feu.
- **Affinité avec le feu.** Les [[Ensorceleur|ensorceleurs]] ifrits de [[Lignage Élémentaire|lignage élémentaire (feu)]] traitent leur valeur de [[Charisme]] comme supérieure de 2 points pour tous les sorts d’ensorceleur et les capacités de classe. Les lanceurs de sorts ifrits du [[domaine du Feu]] utilisent leurs sorts et pouvoirs de domaine à un niveau de lanceur de sorts augmenté de +1.
- **Langues.** Les ifrits commencent le jeu en parlant le commun et l’igné. Ceux qui ont une valeur d’[[Intelligence]] élevée peuvent apprendre d’autres langues choisies parmi celles-ci : aérien, aquatique, elfique, gnome, halfelin, nain et terreux.

</div>

{s:Reference|TRAITSALTERNATIFS}
### Traits raciaux alternatifs
{s:MR}Vous pouvez choisir les traits raciaux suivants au lieu des traits raciaux ifrits standard mais consultez d’abord votre MJ.

<u>*Remplace « affinité avec le feu » :*</u>
- **Débuts enflammés.** Les ifrits ayant ce trait racial tirent un plaisir sadique à regarder les autres brûler. Chaque fois que l’ifrit participe à [[Dangers naturels#PRENDREFEU|enflammer]] une créature, il gagne un bonus de moral de +1 au prochain [[jet dattaque|jet d’attaque]], [[jds|jet de sauvegarde]], test de [[Compétences|compétence]] ou test de [[Caractéristiques]] qu’il fait lors du prochain round. L’ifrit ne bénéficie de ce bonus que la première fois où il provoque l’embrasement d’une créature donnée ; les autres fois où une créature prend feu ne lui apportent aucun bonus. Ce trait racial remplace affinité avec le feu.
- **Hypnotique.** Les ifrits ayant ce trait racial invoquent la nature enchanteresse des flammes, ajoutant +1 au [[DD]] de tous les [[jds|jets de sauvegarde]] contre les sorts ou les effets qu’ils lancent et qui rendent [[fasciné]]. Une fois par jour, lorsqu’une créature fait un jet de sauvegarde contre un tel effet provoqué par l’ifrit, ce dernier peut dépenser une [[action immédiate]] pour la forcer à relancer son jet et à conserver le second résultat, même s’il est pire. L’ifrit doit annoncer l’utilisation de cette capacité avant que ne soit révélé le résultat du premier jet. Ce trait racial remplace affinité avec le feu.
- **Intuition du feu.** Les lanceurs de sorts ifrits découvrent parfois que, du fait de leur héritage élémentaire, les créatures de feu sont plus facilement prêtes à les servir. Les sorts *[[convocation de monstres I|convocation de monstres]]* et *[[convocation dalliés naturels|convocation d’alliés naturels]]* que lance l’ifrit durent 2 rounds de plus que la normale lorsqu’ils sont utilisés pour convoquer des créatures de sous-type [[sous-type feu|feu]]. Ce trait racial remplace affinité avec le feu.
- **Mirage du désert.** Les ifrits s’épanouissent dans les déserts du monde, là où leurs instincts et leur résistance à la chaleur leur donnent un énorme avantage sur leurs concurrents. Ceux qui ont ce trait gagnent un bonus racial de +2 à leurs tests de [[Discrétion]] dans les environnements désertiques et à leurs [[jds|jets de sauvegarde]] pour résister à la [[Dangers naturels#FAIMSOIF|faim]] et à la [[Dangers naturels#FAIMSOIF|soif]]. Ce trait racial remplace affinité avec le feu.
- **Veines de feu. **Les ifrits ayant ce trait racial reproduisent les capacités de guérison des méphites, gagnant donc une [[Guérison accélérée (capacité)|guérison accélérée 2]] pendant 1 round chaque fois qu’ils reçoivent des dégâts de feu (que ces dégâts passent leur [[Résistance (capacité)|résistance]] au feu ou non). Les ifrits peuvent guérir de 2 [[pv|points de vie]] maximum par niveau par jour avec cette capacité, après quoi elle cesse de fonctionner. Ce trait racial remplace affinité avec le feu.
...
- **Formé à la forge.** Tous les ifrits ne descendent pas des éfrits : certains descendent des azers ou même des salamandres. Ces ifrits gagnent un bonus racial de +2 à leurs tests d’[[Artisanat]] (armure ou armes) et à leurs [[jds|jets de sauvegarde]] pour résister à la [[fatigué|fatigue]] et à l’[[épuisé|épuisement]]. Ce trait racial remplace celui de pouvoir magique.
- **Magie éfrite.** Certains ifrits héritent de la capacité de leurs ancêtres à modifier magiquement la taille d’une créature. Ils peuvent utiliser *[[agrandissement]]* ou *[[rapetissement]]* comme un [[Pouvoirs magiques (capacité)|pouvoir magique]] (l’ifrit choisit lorsqu’il utilise cette capacité) une fois par jour ([[NLS|niveau de lanceur de sorts]] égal au niveau de l’ifrit). L’ifrit peut utiliser cette capacité pour affecter d’autres ifrits comme s’ils étaient des créatures [[type Humanoïde|humanoïdes]]. Ce trait racial remplace celui de pouvoir magique.

<u>*Remplace « pouvoir magique » et « résistance élémentaire » :*</u>
- {s:cs}{s:ISR}**Flamme d'Airain.** Un nombre surprenant d'ifrits sont issus de la région des Pics d'Airain, dernière demeure des restes de Xotani le Saignefeu, et leurs flammes imprègnent leurs armes lors de combats mortels, plutôt que de les protéger ou de leur offrir des sorts. Un ifrit avec ce trait racial inflige 1 point de dégât de feu avec ses attaques au corps à corps. Ce trait racial remplace pouvoir magique et résistance élémentaire.
...
{s:MR}**[[Barde]].** Le barde rajoute +1/6 au nombre de personnes qu’il peut affecter avec sa [[Barde#REPRESENTATIONBARDIQUE|représentation bardique]] [[Représentations#FASCINATION|fascination]].

{s:MR}**[[Ensorceleur]].** L’ensorceleur choisit un pouvoir de [[Lignage Élémentaire|lignage élémentaire (feu)]] ou [[Lignage Éfrit|éfrit]] qu’il peut utiliser. Il considère son niveau de classe comme s’il était supérieur de +1/6 niveau (jusqu’à un maximum de +2) lorsqu’il s’agit de déterminer les effets de ce pouvoir.

{s:MR}**[[Inquisiteur]].** L’inquisiteur rajoute un bonus de +1/2 à ses tests d’[[Intimidation]] contre les créatures de sous-type [[sous-type feu|feu]] et un bonus de +1/2 à ses tests de [[Connaissances]] (plans) relatifs au [[Grand au-delà#PLANFEU|plan du Feu]].
</td><td width="1%">
<td style="border-left:1px solid #4b3124" width="1%"></td>
</td><td width="49%">
{s:MR}**[[Oracle]].** L’oracle rajoute +1/6 à son niveau quand il s’agit de déterminer les effets d’une [[Oracle#REVELATION|révélation]].

{s:MR}**[[Pistolier]].** Le pistolier rajoute un bonus de +1/2 à ses tests d’[[initiative]] quand il utilise son [[Pistolier#EXPLOITS|exploit]] [[Exploits#INITIATIVEDUPISTOLIER|initiative du pistolier]].

{s:MR}**[[Prêtre]].** Le prêtre rajoute un bonus de +1/2 à ses tests de [[Connaissances]] (plans) relatifs au [[Grand au-delà#PLANFEU|plan du Feu]] et aux créatures de sous-type [[sous-type feu|feu]].

{s:MR}**[[Roublard]].** Le roublard rajoute un bonus de +1/2 à ses tests d’[[Acrobaties]] pour sauter et un bonus de +1/2 à ses tests d’[[Intimidation]] pour démoraliser ses ennemis.
</td></tr></table>
...
|- CLASS="premier"
| [[Armes ardentes]] || <sup>MR</sup> || [[ifrit (race)|Ifrit]] || Le personnage est plus résistant au feu et transmet sa chaleur à ses armes
|-
| &emsp;[[Flamme intérieure]] || <sup>MR</sup> || [[ifrit (race)|Ifrit]], [[Armes ardentes]], niveau 7 || La résistance au feu du personnage augmente et ses armes s'enflamment
|-
| &emsp;&emsp;[[Aura ardente]] || <sup>MR</sup> || [[ifrit (race)|Ifrit]], [[Armes ardentes]], [[Flamme intérieure]], niveau 13 || Le personnage dégage une aura brûlante

|- CLASS="premier"
| [[Feinte brûlante]] || <sup>MR</sup> || [[ifrit (race)|Ifrit]], [[Expertise du combat]], [[Science de la feinte]]. || Les feintes du personnage avec des armes de feu sont facilitées et brûlent
...
|- CLASS="premier"
| [[Saut élémentaire]] || <sup>MR</sup> || [[ifrit (race)|Ifrit]], [[sylphe (race)|sylphe]], [[ondin (race)|ondin]] ou [[oréade (race)|oréade]], niveau 15 || Le personnage peut se transporter sur le plan élémentaire avec lequel il possède une affinité

|- CLASS="premier"
| [[Vision à travers le feu]] || <sup>MR</sup> || [[ifrit (race)|Ifrit]] || Le personnage voit à travers le feu et la fumée
|}

<table width="100%"><tr><td width="49%">
#### Archétypes de classe
- [[Forgeur de souhaits (ensorceleur)]] *(MR)*
- [[Immolateur (inquisiteur)]] *(MR)*

#### Équipement
- [[Encre de feu ifrit (objet)|Encre de feu ifrit]] *(MR)*
- [[Sang difrit (objet)|Sang d’ifrit]] *(MR)*

</td><td width="1%">
<td style="border-left:1px solid #4b3124;width=" width="1%"></td>
</td><td width="49%">
#### Objets magiques
- [[enflammée (propriété)|Enflammée (propriété d'arme)]] *(MR)*
- [[Cape de dissimulation enflammée]] *(MR)*

#### Sorts
- [[Chaînes de feu]] *(MR)*
- [[Chaleur curative]] *(MR)*
- [[Cierge de mort]] *(MR)*
- [[Forme cendrée brûlante]] *(MR)*
- [[Fureur solaire]] *(MR)*
- [[Maîtrise élémentaire]] *(ISR)*
- [[Onde de feu]] *(MR)*
- [[Toucher de combustion]] *(MR)*
