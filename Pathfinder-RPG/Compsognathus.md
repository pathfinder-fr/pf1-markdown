...
{s:BDTexte|**Compétences** [[Natation]] +10, [[Perception]] +4}
...
{s:BDTexte|**Poison (Ext).** Morsure — blessure ; *JdS* Vigueur DD 12 ; *fréquence* 1/round pendant 4 rounds ; *effet* [[affaiblissement temporaire]] 1d2 For ; *guérison* 1 réussite.}
</div>
</td><td><div><ul style="margin: 0 0 -10 0;margin-top: 6px;margin-bottom: 12px;"><li>***Voir la description des [[Dinosaure|dinosaures]].***</li></ul>*Ce petit reptile a un cou et une tête de serpent, un corps d’oiseau doté de puissantes pattes pour la course et une queue ressemblant à un fouet.*
...
de [[familiers|familier]] aux lanceurs de sort. Un
...
**Caractéristiques de départ. Taille** P ; **Vitesse** 12 m (8 {s:c}), nage 6 m (4 {s:c}) ; **Attaque** morsure (1d4) ; **Caractéristiques** For 10, Dex 17, Con 12, Int 2, Sag 12, Cha 4 ; **Particularités** [[odorat]], [[vision nocturne]].
