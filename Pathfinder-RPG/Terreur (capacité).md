...
{s:Desambi|Il peut aussi s'agir d'un [[Terreur|sort]].}
...
:**[[Secoué]].** Le sujet subit un malus de -2 aux [[jet dattaque|jets d’attaque]] et de [[jet de sauvegarde|sauvegarde]], ainsi qu’aux [[test de compétence|tests de compétence]] et de caractéristique.
...
- Cône de terreur (Mag) et rayon de terreur (Sur). Ces effets fonctionnent généralement comme le sort de *[[terreur]]*.
