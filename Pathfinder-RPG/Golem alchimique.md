---
Name: Pathfinder-RPG.Golem alchimique
Title: Golem, Golem alchimique
LastModified: 2021-07-15 16:08
Categories:
- Monstre
- Règle officielle
- Src Bestiaire 2
...
<div class="BD">
{s:BDTitre|Golem alchimique|FP 9}
...
- **Init** +4 ; **Sens** [[vision dans le noir]] 18 m (12 {s:c}), [[vision nocturne]] ; [[Perception]] +0
(((Défense)))
...
- **Trésor** aucun
(((Capacités spéciales)))
- **Alchimie (Ext).** Quand un golem alchimique frappe un ennemi, l’attaque a un effet supplémentaire déterminé aléatoirement parmi les options suivantes : l’attaque inflige 1d6 points de dégâts d’acide, d’électricité, de feu ou de froid, rend la victime [[fiévreux|fiévreuse]] ([[Vigueur]] [[DD]] 16 annule) ou l’[[enchevêtré|enchevêtre]] ([[Réflexes]] [[DD]] 16 annule) pendant 1d4 rounds. Les [[DD]] des [[jet de sauvegarde|jets de sauvegarde]] dépendent de la [[Constitution]].
- **Bombes (Ext).** Par une action simple, un golem alchimique peut lancer une bombe en effectuant une [[attaque de contact à distance]] avec une portée maximale de 18 mètres (12 {s:c}) (sans [[facteur de portée]]). Si l’attaque rate, les règles relatives aux [[Actions spéciales#ARMEIMPACT|armes d’aspersion]] s’appliquent pour déterminer le point d’impact de la bombe. Toutes les créatures touchées par une bombe de golem alchimique subissent 8d6 points de dégâts d’acide, d’électricité, de feu ou de froid (déterminé aléatoirement). Toutes les créatures adjacentes subissent 1d6 points de dégâts du même type.
...
- **Immunité à la magie (Ext).** Les golems alchimiques sont immunisés contre tous les sorts et pouvoirs magiques contre lesquels la [[RM|résistance à la magie]] s’applique, à l’exception des sorts du registre du son. *[[Fracassement]]* affecte un golem alchimique comme s’il s’agissait d’une créature cristalline.
...
**NLS** 10<sup>e</sup> ; **Prix** 33 000 po
...
{s:ImageCentre|Bestiaire/Golem alchimique.jpg|95%}</td></tr></table>
