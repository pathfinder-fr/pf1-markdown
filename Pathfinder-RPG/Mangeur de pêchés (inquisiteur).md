...
Au niveau 8, quand l’inquisiteur mange les péchés d’une créature qui devrait se relever sous forme de [mort-vivant](./type Mort-vivant.md) (comme une personne tuée par une [ombre](./Ombre.md), un [spectre](./Spectre.md) ou un [vampire](./Vampire, archétype.md)), il peut décider de recevoir un niveau négatif temporaire pour absorber la souillure du cadavre et l’empêcher de se relever. Il se débarrasse ensuite du niveau négatif à l’aide de la magie adéquate ou attend 24 heures qu’il se dissipe automatiquement. Ce niveau ne devient jamais permanent. Si le MJ le souhaite, ce pouvoir peut empêcher un [fantôme](./Fantôme, archétype.md) de se servir de sa reconstitution.

Ce pouvoir remplace un [domaine](./Inquisiteur.md#DOMAINE) d’inquisiteur.

#### Communication avec les morts (Mag)
Au niveau 6, quand l’inquisiteur dévore les péchés d’un ennemi, il peut, dans les 10 minutes qui suivent, poser des questions à son âme, comme s’il utilisait *[communication avec les morts](./Communication avec les morts.md)* avec un [niveau de lanceur de sorts](./NLS.md) égal à son niveau d’inquisiteur.

Il n’a pas besoin de disposer du cadavre ennemi (il peut manger les péchés, s’éloigner et utiliser ensuite *[communication avec les morts](./Communication avec les morts.md)*). L’âme a droit à un [jet de sauvegarde](./jet de sauvegarde.md), comme le cadavre. Ce pouvoir remplace le don supplémentaire de [travail en équipe](./don.md#DONEQUIPE) du niveau 6.

#### Poids du péché (Mag)
Au niveau 14, le mangeur de péchés peut utiliser une [action complexe](./Action complexe.md) pour transférer une [affliction](./Afflictions.md), une [condition](./États préjudiciables.md) ou un effet de sort néfaste d’une créature sur lui (ce qui comprend les [malédictions](./Malédictions.md), les possessions et les effets permanents comme la [pétrification](./Pétrifié.md) ou toute condition que l’on peut dissiper ou inverser à l’aide d’une *[annulation d’enchantement](./Annulation denchantement.md)*). C’est au mangeur de péchés de choisir quel effet transférer. Il est ensuite affecté comme s’il était la cible originelle de l’effet. Il se poursuit jusqu’au terme de sa durée (le cas échéant) et n’affecte plus la cible originelle. L’inquisiteur peut, par exemple, transférer une maladie mortelle sur lui ou se pétrifier pour libérer un camarade. Le mangeur de péchés peut utiliser ce pouvoir aussi souvent qu’il le souhaite, même à plusieurs reprises sur une même créature.

Ce pouvoir remplace [exploiter les faiblesses](./Inquisiteur.md#EXPLOITERLESFAIBLESSES).
