...
**Avantages.** Quand le personnage voit un de ses alliés mourir ou passer en dessous de 0 point de vie, il peut, à son tour et par une [action libre](./Action libre.md), entrer dans un état de [rage](./Barbare.md#RAGEDEBERSERKER) similaire à celui du [barbare](./Barbare.md), en moins puissant. Si le personnage possède déjà la rage comme pouvoir de classe et qu’il est déjà en rage, ses bonus de moral à la [Force](./Force.md) et à la [Constitution](./Constitution.md) augmentent de +2 pendant le reste de sa rage.
