---
Name: Pathfinder-RPG.Arme protectrice
Title: Arme protectrice
LastModified: 2022-06-11 19:42
Categories:
- Règle officielle
- Sort
- Sort conjurateur 2
...
Si une créature possède le don [[Perturbateur]], elle n’a aucun mal à franchir les défenses de ce sort. Le personnage provoque des [[attaque dopportunité|attaques d’opportunité]] de sa part quand elle lui lance un sort, même quand il est sous la protection d’une *arme protectrice*, mais rien ne l’empêche d’[[Actions simples#LANCERSORT|incanter sur la défensive]].
