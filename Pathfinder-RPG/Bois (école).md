---
Name: Pathfinder-RPG.Bois (école)
Title: L'école élémentaire du Bois
...
**Lance brisée (Sur).** Le magicien peut, par une [[action simple]], créer un épieu de bois adapté à sa taille. Il fait une [[attaque à distance]] pour le lancer contre toute cible située dans les 30 mètres (20{s:c}) (il faut appliquer les malus de distance) et utilise son [[Caractéristiques#DETERMINERLESMODIFICATEURS|bonus]] d’Intelligence comme [[BBA|bonus d’attaque]] au lieu de son [[Caractéristiques#DETERMINERLESMODIFICATEURS|modificateur]] de Force ou de Dextérité. L’épieu inflige les dégâts requis pour sa taille, plus le [[Caractéristiques#DETERMINERLESMODIFICATEURS|modificateur]] d'Intelligence, avant de se briser en milliers d’échardes. La cible reçoit 1 point de [[saignement]] par [[round]] à son tour. Au niveau 6 puis tous les six niveaux, l’épieu gagne un bonus d’altération de +1 et les dégâts de [[saignement]] augmentent de +1. Chaque jour, le personnage peut utiliser ce pouvoir un nombre de fois égal à 3 + [[Caractéristiques#DETERMINERLESMODIFICATEURS|modificateur]] d’Intelligence.

**Défense coopérative (Sur).** Au niveau 8, quand le magicien et un ou plusieurs alliés situés à moins de 9 mètres (6{s:c})  sont visés par un sort ou un effet, le magicien peut utiliser ce pouvoir pour que les alliés se servent de son [[jet de sauvegarde]] à la place du leur. Chaque allié doit faire ce choix individuellement avant de lancer les dés. Ce pouvoir s’active par une [[action immédiate]]. Le magicien peut se servir de ce pouvoir une fois par jour au niveau 8 et une fois de plus tous les quatre niveaux de magicien au-delà du 8ème.
