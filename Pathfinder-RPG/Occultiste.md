---
Name: Pathfinder-RPG.Occultiste
Title: L'occultiste
LastModified: 2024-10-03 15:26
Categories:
- Règle officielle
...
{| CLASS="tablo centre"
|+ {s:Reference|TABLEOCCULTISTE}L'occultiste
|- CLASS="titre"
| ROWSPAN="2" | Niveau
| ROWSPAN="2" | BBA
| ROWSPAN="2" | Vigueur
...
{s:ImageDroite|Illustrations/PNJ/Mavaro.jpg|30%}
#### Armes et armures
Les occultistes sont formés au maniement de toutes les armes courantes et de guerre, ainsi qu’au port des armures légères et intermédiaires. Ils sont également formés au maniement des boucliers (à l’exception des pavois).
...
À la différence de la dépense normale de focalisation, ce transfert peut réduire les effets du pouvoir de résonance d’un instrument dans lequel la focalisation a été prélevée. Quoi qu’il en soit, il ne permet pas d’augmenter la puissance du pouvoir de résonance de l’instrument vers lequel la focalisation a été transférée.
...
Au niveau 16, au lieu de poser des questions, l’occultiste peut exiger de l’Extérieur qu’il délivre un message à une créature amicale de sa connaissance. L’occultiste peut également exiger de l’Extérieur qu’il remette à cette créature un objet dont le poids ne dépasse pas 250 grammes. L’une ou l’autre de ces exigences nécessite la réussite d’un test opposé comme décrit plus haut. La livraison prend généralement 1d4 heures mais cette période est réduite à 1d6 minutes si le destinataire se situe à 1,5 kilomètre ou moins de l’occultiste (et l’Extérieur prend moins de temps encore si le destinataire est à portée de vue). L’occultiste doit être capable de fournir le nom et une description physique précise du destinataire. Cette aptitude ne peut pas être utilisée pour livrer quelque chose à un endroit, ou à des ennemis ou des créatures inamicales envers l’occultiste.
...
Au niveau 16, l’occultiste apprend à tracer des cercles magiques très rapidement. Il peut tracer un cercle magique par une action complexe mais un cercle tracé aussi rapidement voit sa durée réduite à une minute par niveau d’occultiste (à moins qu’il soit tracé en conjonction avec l’aptitude de classe appel d’un Extérieur, auquel cas il dure 10 minutes comme à l’accoutumée). S’il trace un cercle d’entrave de cette façon, sa durée est égale à un round par niveau d’occultiste.
