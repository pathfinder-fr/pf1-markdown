---
Name: Pathfinder-RPG.dons dobjet
Title: Les dons de maîtrise d'objets magiques
LastModified: 2020-09-02 17:44
---
...
You can protect yourself from harm by using abjuration magic items.
...
You can heal more than just injuries of the flesh.
...
Une décharge symbolic inflige des dégâts égaux à 1d6 + ½ votre nombre total de rangs dans la compétence Utilisation d’objets magiques. Vous choisissez le type de dégâts infligés par votre décharge symbolique chaque fois que vous utilisez ce don à partir de ceux qui sont offerts par les domaines de la divinité à laquelle appartient le symbole sacré.

Les types de dégâts (et les domaines qui les accordent) sont les suivants.
-	acide (Magie,Terre, Rune)
-	électricité (Air, Climat, Magie, Rune)
-	énergie négative (Destruction, Mort, Vide)
-	énergie positive (Gloire, Soins, Repos, Soleil)
-	feu (Destruction, Feu, Magie, Rune)
-	froid (Climat, Eau, Magie, Rune, Ténèbres, Vide)
-	son (Climat, Magie, Rune)
-	ou non-typé (tous)
Si une décharge symbolique est utilisée pour infliger des dégâts non typés, les dégâts de la décharge sont réduits à 1d3 + ½ du nombre de rangs dans la compétence Utilisation d’objets magiques.
