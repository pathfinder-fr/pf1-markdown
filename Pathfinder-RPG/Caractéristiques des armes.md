---
Name: Pathfinder-RPG.Caractéristiques des armes
Title: Caractéristiques des armes
LastModified: 2026-04-09 20:01
Categories:
- Règle officielle
...
### Attributs des armes
Voici le format de présentation des armes (qui suit les en-têtes de colonne des [[Tableau récapitulatif des armes#TABCOURANTES|tables récapitulatives des armes]]).
...
{s:Reference|FACTEURDEPORTEE}
#### Portée
Au delà de cette distance, les attaques sont pénalisées et subissent un malus cumulatif de -2 pour chaque facteur de portée (ou fraction de ce facteur) séparant le personnage de sa cible. Par exemple, une [[dague (arme)|dague]] (avec une portée de 3 mètres) lancée sur une cible située à 7,5 mètres s’accompagne d’un malus de -4. Une [[Caractéristiques des armes#ARMEDEJET|arme de jet]] a une portée maximale de cinq facteurs de portée. Une [[Caractéristiques des armes#ARMEAPROJECTILES|arme à projectiles]] peut aller jusqu’à 10 facteurs de portée.
...
#### Type
Les armes sont classées par type de dégâts qu’elles infligent : C pour contondants, P pour perforants, T pour tranchants. Il arrive que certains monstres soient [[Réduction de dégâts (capacité)|résistants]] ou [[Immunité (capacité)|immunisés]] contre les attaques de certains types d’arme.
...
Dans les autres cas, une arme ne peut infliger un type de dégâts ou un autre. Dans une situation où le type de dégâts est important, le porteur peut choisir quel type infliger. Par exemple, les dégâts causés par une [[dague (arme)|dague]] dépendent de ce que fait le porteur : s’il frappe d’estoc, il inflige des dégâts perforants, s’il frappe de taille, il inflige des dégâts tranchants

{s:Reference|ALLONGE}{s:Reference|CROCENJAMBE}{s:Reference|DESARMEMENT}{s:Reference|DIVERSION}{s:Reference|DOUBLE}{s:Reference|FRAGILE}{s:Reference|LUTTE}{s:Reference|MOINE}{s:Reference|MORTELLE}{s:Reference|NONLETAL}{s:Reference|NONLETAUX}{s:Reference|PARADE}{s:Reference|RECEPTION}{s:Reference|SPECTACLE}
#### Spécial
...
**Allonge.** Le personnage peut utiliser une [[Caractéristiques des armes#ARMEAALLONGE|arme à allonge]] pour frapper des adversaires situés à 3 mètres de lui mais il ne peut pas l’utiliser contre un adversaire adjacent.
...
**Désarmement.** Lorsque le personnage utilise cette arme, il reçoit un bonus de +2 à ses tests de manœuvre offensive pour [[désarmement|désarmer]] un ennemi.

**Diversion.** Le personnage gagne un bonus de +2 à ses tests de [[Bluff]] pour [[feinte|feinter]] en combat tant qu’il manie cette arme.

**Double.** Le personnage peut utiliser une [[Caractéristiques des armes#ARMEDOUBLE|arme double]] pour se battre comme s’il combattait à deux armes, mais si tel est le cas, il subit tous les malus d’attaque normaux associés au [[Actions spéciales#COMBAT2ARMES|combat à deux armes]], exactement comme s’il utilisait une arme à une main et une arme légère. Le personnage peut décider de n’utiliser qu’une extrémité de l’arme double à deux mains mais il ne peut pas l’utiliser comme une arme double quand il la manie ainsi : il n’utilise qu’une seule extrémité de l’arme par round.

**Fragile.** Les armes fragiles ne peuvent pas encaisser les coups comme le font les armes plus solides. Une arme fragile se [[brisé|brise]] si le porteur fait un 1 naturel sur un jet d’attaque. Si une arme fragile est déjà brisée, elle est détruite au 1 naturel suivant. Les armes fragiles [[armes magiques|magiques]] et [[Caractéristiques des armes#ARMESDEMAITRE|de maître]] n’ont pas ces défauts, sauf si leur description précise le contraire.

Si une arme se brise de cette manière, on considère qu’elle a reçu un nombre de dégâts égal à la moitié de ses points de vie +1. on peut réparer ces dégâts en employant quelque chose agissant sur l’effet qui a brisé l’arme (comme un nettoyage rapide dans le cas d’un raté sur une [[Armes à feu|arme à feu]] ou le don [[Réparations de fortune]]) ou en appliquant les méthodes de réparations indiquées pour l’état [[brisé]]. Lorsqu’un effet brisant l’arme est annulé, l’arme regagne le nombre de points de vie qu’elle a perdus au moment où elle s’est brisée. Les dégâts infligés par une attaque sur l’arme (comme une manœuvre de destruction) ne peuvent pas être réparés par des effets annulant l’état brisé.

**Lutte.** Sur un [[coup critique]] réussi avec une arme de ce type, le personnage peut tenter un test de manœuvre offensive pour [[lutte|saisir]] son adversaire par une [[action libre]]. Cette tentative de lutte ne provoque pas d’[[AO|attaque d’opportunité]] de la part de la créature que le personnage tente d’agripper si elle ne le menace pas. Tant qu’il agrippe la créature en utilisant une arme de lutte, le personnage ne peut déplacer ou blesser la créature que lors de son tour. Le personnage est considéré comme agrippé mais il ne doit pas forcément être adjacent à la créature pour maintenir sa prise. Le personnage met fin à la lutte s’il s’éloigne suffisamment de la créature qu’il agrippe pour que celle-ci ne soit plus à portée d’allonge de son arme.

**Moine.** Un [[Moine]] peut utiliser une arme de moine pour effectuer un [[Moine#DELUGEDECOUPS|déluge de coups]].
...
**Non-létal.** Une arme de ce type inflige des dégâts [[Blessures et mort#NONLETAL|non-létaux]] sur une attaque réussie.

**Parade.** Lorsque le personnage utilise cette arme pour [[combat sur la défensive|combattre sur la défensive]], il gagne un bonus de bouclier de +1 à la [[CA]].

**Réception.** Si le personnage dépense une [[Actions modifiant linitiative#PREPARER|action préparée]] pour ficher son arme en terre afin de réceptionner une [[charge]], il inflige le double des dégâts sur une attaque réussie contre la créature qui charge.

**Spectacle.** Lorsque le personnage manie cette arme et fait une attaque ou une manœuvre offensive qui entraîne un test de [[combat de spectacle]], il gagne un bonus de +2 au test.

{s:Reference|ARMECOURANTE}{s:Reference|ARMEDEGUERRE}{s:Reference|ARMEEXOTIQUE}
...
{s:Reference|ARMEDEJET}**Les armes de jet.** Les [[dague (arme)|dagues]], les [[fléchette (arme)|fléchettes]], les [[javeline (arme)|javelines]], les [[hache de lancer (arme)|haches de lancer]], les [[marteau léger (arme)|marteaux légers]] et les [[filet (arme)|filets]] sont des exemples d’armes de jet. Le porteur applique son modificateur de [[Force]] aux dégâts infligés par l’arme de jet (sauf pour les [[Actions spéciales#ARMEASPERSION|armes à aspersion]]).

On peut lancer une arme qui n’est pas conçue pour être lancée (comme, par exemple, une arme de corps à corps n’ayant pas d’entrée dans la colonne Portée de la [[Tableau récapitulatif des armes|table des armes]]). Dans ce cas, le personnage subit un malus de -4 à son [[jet dattaque|jet d’attaque]]. Il faut une [[action simple]] pour lancer une arme légère ou à une main et une [[action complexe]] pour lancer une arme à deux mains. Quel que soit le type de l’arme, ce genre d’attaque ne peut faire un [[coup critique|critique potentiel]] que sur un 20 naturel et inflige le double des dégâts sur un coup critique. Ces armes ont un [[facteur de portée]] de 3 mètres.

{s:Reference|ARMEAPROJECTILES}**Les armes à projectiles.** Les [[sarbacane (arme)|sarbacanes]], les [[arbalète légère (arme)|arbalètes]], les [[arc court (arme)|arcs courts]], les [[fronde (arme)|frondes]], les [[arc long (arme)|arcs longs]] et les [[fustibale halfelin (arme)|fustibales halfelins]] sont des exemples d’armes à projectiles (des armes qui lancent des munitions sur la cible). La plupart des armes à projectiles se manient à deux mains (voir les descriptions spécifiques des armes). Un personnage ne peut pas appliquer son modificateur de [[Force]] aux jets de dégâts d’une arme à projectiles à moins qu’il ne s’agisse d’une [[fronde (arme)|fronde]], d’un [[arc court composite (arme)|arc court composite]] ou d’un [[arc long composite (arme)|arc long composite]] de fabrication spéciale. Si le personnage a un malus dû à une faible valeur de Force, appliquez-le aux jets de dégâts lorsqu’il utilise un arc ou une fronde.

{s:Reference|MUNITIONS}**Les munitions.** Les armes à projectiles utilisent des munitions, comme les [[flèches (arme)|flèches]] pour les arcs, les [[carreaux darbalète (arme)|carreaux]] pour les arbalètes, les [[fléchette (arme)|fléchettes]] pour les sarbacanes ou les [[billes de fronde (arme)|billes]] pour les frondes et les fustibales halfelins. Lorsqu’il utilise un arc, le personnage dégaine une flèche par une [[action libre]]. Le rechargement des arbalètes et des frondes nécessite une action (comme indiqué dans leur description). En règle générale, une munition qui touche sa cible est détruite ou devient inutile, tandis qu’une munition qui rate sa cible a 50% de chances d’être détruite ou perdue.

Si les [[shurikens (arme)|shurikens]] sont des armes de jet, ils sont traités comme des munitions quand il s’agit de les dégainer et d’en fabriquer des versions [[Caractéristiques des armes#ARMESDEMAITRE|de maître]] ou spéciales et quand on veut savoir ce qui leur arrive une fois lancés.

{s:Reference|ARMELEGERE}{s:Reference|ARMEAUNEMAIN}{s:Reference|ARMEADEUXMAINS}
...
Comme pour n’importe quelle action libre, c’est le MJ qui décide d’un nombre de fois raisonnable par round où le personnage peut lâcher et ressaisir l’arme (pouvoir lâcher et ressaisir une fois par round est acceptable).}Cette appellation renseigne sur l’effort nécessaire au maniement de l’arme. Elle indique si une arme de corps à corps, quand elle est maniée par un personnage correspondant à la catégorie de taille de l’arme, est considérée comme une arme légère, à une main ou à deux mains.

**Les armes légères.** Une arme légère se manie à une main. Elle est plus facile à manier de la main non-directrice qu’une arme à une main et elle peut être utilisée en [[lutte]]. Ajoutez le modificateur de [[Force]] de l’utilisateur aux [[Valeurs de combat#DEGATS|jets de dégâts]] pour les attaques de corps à corps portées avec une arme légère si elle est utilisée avec la [[Actions spéciales#COMBAT2MAINS|main directrice]] ou la moitié du modificateur de Force du porteur s’il l’utilise avec sa main non-directrice. Si un personnage manie une arme légère à deux mains, il ne gagne aucun avantage aux dégâts, le modificateur de Force s’applique juste comme s’il tenait l’arme dans sa main directrice.

Un coup à [[mains nues (arme)|mains nues]] est toujours considéré comme une arme légère.

**Les armes à une main.** Une arme à une main peut être utilisée de la main directrice ou de la main non-directrice. Ajoutez le modificateur de [[Force]] du porteur aux [[Valeurs de combat#DEGATS|jets de dégâts]] pour les attaques de corps à corps portées avec une arme à une main si elle est maniée de la [[Actions spéciales#COMBAT2MAINS|main directrice]] ou la moitié de son modificateur de Force s’il la manie de la main non-directrice. Si une arme à une main est maniée avec les deux mains en combat au corps à corps, ajoutez 1,5 fois le modificateur de [[Force]] du personnage aux jets de dégâts faits avec cette arme.
...
{s:Reference|TAILLEARME}
### Taille de l’arme
<div style="float:right; background-color: #fff; padding: 0 0 16px 16px">
<div style="border: 1px solid #4b3124; padding: 4px">

<p class="tablo-caption">Dégâts des armes de taille TP ou G</p>
...
{s:ClearRight}{s:Reference|ARMESIMPROVISEES}
### Armes improvisées
Parfois, les objets qui ne sont pas fabriqués pour être des armes peuvent néanmoins servir en combat (il s’agit généralement des bouteilles, des pieds de chaise, d’un fémur perdu, ce genre de choses…). Ces objets n’étant pas prévus pour cet usage, toute créature qui utilise une arme improvisée en combat est considérée comme ne maîtrisant pas l’arme et reçoit un malus de -4 à ses [[jet dattaque|jets d’attaque]] avec cet objet. Pour déterminer la catégorie de taille et les dégâts d’une arme improvisée, comparez sa taille relative et ses dégâts potentiels à la liste des armes pour trouver un équivalent raisonnable. Une arme improvisée ne peut faire un critique potentiel que sur un 20 naturel et inflige le double des dégâts sur un [[coup critique]]. Une [[Caractéristiques des armes#ARMEDEJET|arme de jet]] improvisée a un [[facteur de portée]] de 3 mètres (2 {s:c}).

{s:Reference|ARMESMAITRE}{s:Reference|ARMESDEMAITRE}
### Armes de maître
Les armes de maître sont des versions plus raffinées des armes normales. Elles apportent un bonus d’altération de +1 aux [[jet dattaque|jets d’attaque]].
...
La propriété de maître rajoute 300 po au coût d’une arme normale (ou 6 po au coût d’une seule munition). L’ajout de la
propriété de maître à une [[Caractéristiques des armes#ARMEDOUBLE|arme double]] coûte deux fois l’augmentation normale (+600 po).

Les [[Caractéristiques des armes#MUNITION|munitions]] de maître sont endommagées (et effectivement détruites) après utilisation. Le bonus d’altération des
armes de maître ne se cumule pas avec le bonus d’altération de l’[[Caractéristiques des armes#ARMEAPROJECTILES|arme à projectiles]] qui les tire.
...
Même si on peut utiliser certains types d’[[Caractéristiques des armures|armures et de boucliers]] comme armes, il n’est pas possible d’en créer des versions de maître accordant un bonus d’altération aux jets d’attaque. Au lieu de cela, les armures et boucliers de maître ont un malus d’armure moindre.
