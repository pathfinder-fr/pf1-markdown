---
Name: Pathfinder-RPG.Tunche
Title: Tunche
LastModified: 2017-03-22 22:08
---

<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Tunche|FP 17}
...
(((Attaque)))
- **VD **15 m, escalade 6 m, nage 6 m ; démarche légère
...
- **Trésor **standard
(((Pouvoirs spéciaux)))
- **Démarche légère (Sur).** Un tunche dans une forêt ignore les restrictions de déplacement occasionnées par un terrain difficile et peut même effectuer un pas de placement sur ce type de terrain.
...
*Debout sur trois pattes, cette créature prédatrice et mortelle associe les caractéristiques physiques des plantes et des animaux dangereux de la jungle.*
