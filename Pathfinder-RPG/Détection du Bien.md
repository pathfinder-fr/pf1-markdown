---
Name: Pathfinder-RPG.Détection du Bien
Title: Détection du Bien
LastModified: 2022-06-12 14:39
Categories:
- Règle officielle
- Sort
- Sort adepte 1
...
**École** [Divination](./Divination.md) ; **Niveau** [Cham](./Chaman.md) 1, [Inq](./Inquisiteur.md) 1, [Prê](./Prêtre.md) 1, [Spi](./Spirite.md) 1  
...
**Durée** [concentration](./Présentation des sorts.md#DUREE), jusqu’à 10 minutes/[niveau](./niveau.md) (T)  

**Jet de sauvegarde** aucun ; **Résistance à la magie** non

Grâce à *détection du Bien*, le lanceur de sorts peut détecter la présence du Bien. Les informations qu’il reçoit dépendent du temps passé à étudier la zone ou le sujet choisi.

Premier [round](./round.md) : présence ou absence d’auras bénéfiques.

Deuxième [round](./round.md) : nombre d’auras bénéfiques (émanant de créatures, de sorts ou d’objets) dans la zone sondée et intensité de la plus puissante.

Si le jeteur de sorts est d’[alignement](./Alignement.md) Mauvais, si l’aura détectée est surpuissante (voir ci-dessous) et correspond à une créature possédant un nombre de [dés de vie](./dés de vie.md) supérieur ou égal au double du [niveau](./niveau.md) du personnage, il est [étourdi](./Étourdi.md) pendant 1 [round](./round.md) et le sort prend fin immédiatement.
...
|-
| Objet magique ou sort aligné (selon le [NLS](./NLS.md)) || 5 ou moins || 6–10 || 11–15 || 16–20 || 21 ou plus
|}

*(*) Certains personnages qui ne sont pas des [prêtres](./Prêtre.md) possèdent une aura de puissance équivalente (voir les descriptions de classe).*
</center>
...
Le personnage peut pivoter sur lui-même pour étudier une nouvelle zone chaque [round](./round.md). Le sort fonctionne à travers les barrières si celles-ci ne sont pas trop épaisses : il est bloqué par 30 cm de pierre, 2,5 cm de métal, une mince feuille de plomb ou 90 cm de bois ou de terre.



(((Ce sort fonctionne comme *[détection du Mal](./Détection du Mal.md)*, si ce n’est qu’il détecte les créatures, [prêtres](./Prêtre.md), [paladins](./Paladin.md), sorts et objets magiques d’[alignement](./Alignement.md) Bon. Si le lanceur de sorts est d’[alignement](./Alignement.md) Mauvais, il est vulnérable à une aura Bonne particulièrement prononcée.)))
