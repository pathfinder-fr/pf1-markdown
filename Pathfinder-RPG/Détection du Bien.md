...
**Intensité de l’aura.** La puissance de l’aura dépend du type de créature (ou d’objet) dont elle émane et de son nombre de [[DV]], de son [[NLS|niveau de lanceur de sorts]] ou de son [[niveau|niveau de classe]] (pour un [[prêtre]]). Si une aura correspond à plusieurs catégories, le sort indique la plus puissante d’entre elles.
...
(((Ce sort fonctionne comme *[[détection du Mal]]*, si ce n’est qu’il détecte les créatures, [[prêtre|prêtres]], [[paladin|paladins]], sorts et objets magiques d’[[alignement]] Bon. Si le lanceur de sorts est d’[[alignement]] Mauvais, il est vulnérable à une aura Bonne particulièrement prononcée.)))
