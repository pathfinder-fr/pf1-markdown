---
Name: Pathfinder-RPG.Liste des sorts par registre
Title: Liste des sorts par registre
...
- ***[[Épreuve de lacide et du feu|Épreuve de l'acide et du feu]] ([[Troll]])*** *(CM)* (Cham 3, Ens/Mag 3, Magus 3, Prê 3, San 3, Sor 3). Couvre la cible d'un acide brûlant.
...
- ***[[Invasion dorties|Invasion d'orties]]*** *(AM)* (Dru 3). Une explosion inflige 3d6 points de dégâts et 1d6 d'acide.
- ***[[Jet dacide|Jet d'acide]] (M)*** *(AM)* (Ens/Mag 5, Magus 5). 1d6 points de dégâts d'acide/niveau plus 1 round d'acide.

#### Nécromancie
- ***[[Bombe boursouflée]]*** *(MCA)* (Apal 4, Ens/Mag 4, Prê 4). Tue une créature et transforme son cadavre en un piège explosif.
- ***[[Fléau des cavaliers]]*** *(LD)* (Ens/Mag 9, Prê 9). Fait exploser une zone avec une énergie qui déchire les âmes, infligeant 1d4 niveaux négatifs et 1d6 dégâts d'acide/niveau.

#### Transmutation
- ***[[Éruption de pustules]]*** *(AM)* (Alch 3, Ens/Mag 3, San 3, Sor 3). Des bubons acides explosent quand le personnage est attaqué.
- ***[[Fouet de la bouche de lenfer|Fouet de la bouche de l'enfer]] ([[Tieffelin (race)|Tieffelin]])*** *(MR)* (Ens/Mag 4, San 4, Sor 4). Transforme la langue du personnage en un fouet d'énergie.
- ***[[Gueule acide]]*** *(MCA)* (Dru 1, Rôd 1). L'attaque de morsure du compagnon animal du personnage inflige 1d4 points de dégâts d'acide à l'impact, puis à chaque round pendant 1 + 1 round/4 niveau (+6 maximum).
- ***[[Sang caustique]]*** *(ISG)* (Alch 4, Con 4, ConU 4, Dru 4, Ens/Mag 5, Magus 4, Prê 5, San 4). Imprègne le sang du lanceur d'un acide corrosif qui blesse ceux qui l'attaquent.
- ***[[Substitution dénergie destructive|Substitution d'énergie destructive]]*** *(MCA)* (Ens/Mag 4). Quand le personnage subit des dégâts d'énergie, il peut faire en sorte que ses sorts, ses pouvoirs magiques et certaines capacités de classes infligent des dégâts de ce type d'énergie au lieu du leur.
...
- ***[[Pistage aérien]]*** *(UI)* (Cham 4, Dru 4, Inq 4, Rôd 3). Le personnage peut traquer les créatures volantes dans les airs.
...
- ***[[Éternuement de feu]] ([[Gobelin (race)|Gobelin]])*** *(MR)* (Alch 2, Dru 2, Ens/Mag 2). Le personnage éternue des flammes pour mettre ses ennemis en feu et les faire tomber à terre.
- ***[[Geyser dair|Geyser d'air]]*** *(MCA)* (Cham 4, Dru 3, Ens/Mag 3, Magus 3, San 3, Sor 3). Explosion d’air qui inflige 2d6 points de dégâts contondants et envoie les adversaires dans les airs.
...
- ***[[Sphère de bourrasques]] ([[Sylphe (race)|Sylphe]])*** *(MR)* (Dru 2, Ens/Mag 2, Magus 2, San 2). Sphère de vent tourbillonante qui roule au sol et souffle les créatures à l'intérieur.
...
- ***[[Voie des vents]] ([[Sylphe (race)|Sylphe]])*** *(MR)* (Dru 6, Ens/Mag 6). Le personnage fait appel à des vents puissants pour dégager un passage devant lui.

#### Transmutation
- ***[[Contrôle des vents]]*** (Cham 5, Dru 5, Occ 5). Modifie la direction et la force du vent.
- ***[[Forme du nuage]] ([[Sylphe (race)|Sylphe]])*** *(MR)* (Dru 4, Ens/Mag 4, Rôd 4). Permet d'adopter la forme d'un nuage colossale.
- ***[[Forme miasmatique]] ([[Sylphe (race)|Sylphe]])*** *(MR)* (Alch 4, Ens/Mag 4). Comme *état gazeux*, mais le corps vaporeux de la cible est dangereux pour les créatures qui le touchent.
- ***[[Fuite aérienne]] ([[Sylphe (race)|Sylphe]])*** *(MR)* (Bard 1, Dru 1, Ens/Mag 1, Magus 1, San 1). Le lanceur de sorts réagit à une attaque en devenant brièvement vaporeux et intangible, ce qui permet à l’attaque de le traverser sans le blesser.
- ***[[Inhalation absorbante]] ([[Sylphe (race)|Sylphe]])*** *(MR)* (Alch 4, Dru 4, Ens/Mag 4, San 4). Absorbe un effet gazeux, le conservant sans danger dans le corps du personnage.
- ***[[Lames de vent]] ([[Sylphe (race)|Sylphe]])*** *(MR)* (Dru 5, Ens/Mag 5, Magus 5, Sor 5). Densifie l'air autour de la cible pour en faire des lames dentées invisibles.
...
- ***[[Natation aérienne]] ([[Gozreh (technique)|Gozreh]])*** *(D&M)* (Cham 3, Dru 3, Prê 3, San 3, Sor 3). Permet à la cible de nager dans l'air.
...
- ***[[Vélocité du zéphyr]] ([[Golarion.Kéléshites|Kéléshite]])*** *(ISR)* (Rôd 3). +9 mètres à la vitesse de vol (déjà existante) des cibles.
...
- ***[[Vol de souffle]] ([[Homme-félin (race)|Homme-félin]])*** *(MR)* (Bard 2, Dru 2, Hyp 2, Ens/Mag 2, Psy 2, San 2, Sor 2). Extrait l'air des poumons d'une créature.
...
- ***[[Cercle magique contre le Mal]]*** (Cham 3, Con 3, ConU 3, Inq 3, Ens/Mag 3, Méd 3, Occ 3, Pal 3, Prê 3, Spi 3). Comme *protection contre le Mal*, mais avec un rayon de 3 m et une durée de 10 minutes/niveau.
- ***[[Lamentation des derniers jours dété|Lamentation des derniers jours d'été]] ([[Golarion.Ulfes|Ulfe]])*** *(ISR)* (Bard 2, Rôd 2). Enveloppe la cible dans un manteau d'air estival chaud qui blesse les créatures de froid.
...
- ***[[Voile dénergie positive|Voile d'énergie positive]]*** *(MJRA)* (Pal 1). +2 CA, +2 aux jets de sauvegarde contre les morts-vivants.
- ***[[Voile du paradis]] ([[Aasimar (race)|Aasimar]])*** *(MR)* (Pal 1). Crée un voile de protection contre les extérieurs Mauvais sur le lanceur.

#### Divination
- ***[[Bénédiction karmique]] ([[Samsaran (race)|Samsaran]])*** *(MR)* (Prê 1, Sor 1). La cible traite une compétence de son choix comme une compétence de classe.
- ***[[Traquer laura|Traquer l'aura]]*** *(MJRA)* (Inq 2, Occ 3). Permet de suivre la piste laissée par l'aura d'un alignement.

#### Enchantement
- ***[[Point de ralliement]]*** *(MJRA)* (Pal 1). La case donne des bonus aux créatures bonnes.

#### Évocation
- ***[[Aura darchon|Aura d'archon]]*** *(AM)* (Pal 3, Prê 3). L'aura pénalise l'attaque et la CA des ennemis.
- ***[[Bouclier de la fleur de laube|Bouclier de l'aube]] (Y)*** *(CCMI)* (Bard 4, Magus 4, Pal 4, Prê 4, Rôd 4). Créé un bouclier protecteur fait de lumière solaire.
- ***[[Bouclier de la Fleur de lAube suprême|Bouclier de la Fleur de l'Aube suprême]] ([[Sarenraé (technique)|Sarenraé]])*** *(ISG)* (Bard 6, Magus 6, Prê 6). Crée un bouclier fait de lumière solaire en partie sacrée.
...
- ***[[Corruption consumée]] ([[Elfe]])*** *(ISR)* (Ens/Mag 5, Magus 5, San 4). Purge la vie dans la zone d'effet, en particulier la vie abyssale.
- ***[[Épée sainte]]*** (Pal 4). L'arme devient +5 et inflige +2d6 points de dégâts contre le Mal.
- ***[[Espace sacré]] ([[Aasimar (race)|Aasimar]])*** *(MR)* (Pal 2, Prê 2). Crée une zone de pouvoir divin contrant les pouvoirs des extérieurs Mauvais.
...
- ***[[Rayon aveuglant]] (Y) ([[Dhampir (race)|Dhampir]])*** *(MR)* (Inq 3, Pal 2, Prê 2). Rayon frappant avec la lumière du soleil, +1 rayon/4 niveaux (max. 3).
...
#### Invocation
- ***[[Aire de laigle|Aire de l'aigle]]*** *(AM)* (Con 6, ConU 6, Dru 6). Convoque 1 aigle géant/3 niveaux.
- ***[[Âme daigle|Âme d'aigle]]*** *(MMI)* (Con 5, ConU 5, Pal 4, Prê 6). Insufle le personnage avec la puissance d'un Extérieur Bon.
- ***[[Halo de gloire]]*** *(MJRA)* (Pal 4). Un dernier sursaut soigne les créatures bonnes et blesse les mauvaises.
- ***[[Lumière de Iomédae|Lumière de l'Héritière]]*** *(MMI)* (Inq 3, Pal 2, Prê 3). Illumine tous les morts-vivants dans la zone et les rends plus vulnérables à l'énergie positive.
...
- ***[[Bénédiction de leau|Bénédiction de l'eau]] (M)*** (Inq 1, Pal 1, Prê 1). Crée de l'eau bénite.
...
- ***[[Manteau des guerriers magiques]] ([[Golarion.Mwangi|Mwangi]])*** *(ISR)* (Cham 5, Dru 5, Ens/Mag 5). Investi les cibles d'animaux spirituels avec des bonus de *forme bestiale I* uniques.
...
#### Abjuration
- ***[[Cercle magique contre la Loi]]*** (Apal 3, Cham 3, Con 3, ConU 3, Inq 3, Ens/Mag 3, Méd 3, Occ 3, Prê 3, Spi 3). Comme *protection contre la Loi*, mais avec un rayon de 3 m et une durée de 10 minutes/niveau.
...
#### Invocation
- ***[[Appel de rejeton]] (Y) ([[Rovagug (technique)|Rovagug]])*** *(ISG)* (Ens/Mag 9, Prê 9, Sor 9). Appelle un rejeton de Rovagug.
- ***[[Crevasse dévastatrice]]*** *(BD)* (Ens/Mag 8, Prê 8, Sor 8). Appelle une faille remplie de démons qui s'étend dans les Abysses.
- ***[[Résurrection factice]] (M)*** *(UI)* (Cham 8, Prê 7, Sor 8). Ressemble à *résurrection*, mais permet à un démon des ombres de posséder le cadavre ciblé.
...
#### Divination
- ***[[Choc mental]]*** *(OO)* (Apal 2, Cham 2, Inq 2, Méd 2, Occ 2, Psy 2, San 2, Sor 2, Spi 2). Renforce les attaques du personnage avec une violente énergie psychique.
- ***[[Éveiller les dévorés]]*** *(BD)* (Cham 5, Inq 4, Ens/Mag 5, Prê 5, Psy 5, Sor 5, Spi 5). Inflige 1d8 dégâts non létaux/niveau à un daémon et le rend confus.
...
#### Illusion
- ***[[Reproche déchirant]] ([[Hobgobelin (race)|Hobgobelin]])*** *(MR)* (Apal 2, Hyp 3, Inq 3, Prê 3, Psy 3, Sor 3). La cible qui attaque le lanceur de sort subi des dégâts non-létaux.
...
- ***[[Hurlement dagonie|Hurlement d'agonie]]*** *(AM)* (Hyp 2, Inq 2, Ens/Mag 3, Psy 2, San 3, Sor 3, Spi 3). Une douleur à hurler limite les actions de la cible.
...
- ***[[Sadomasochisme]] ([[Zon-Kuthon (technique)|Zon-Kuthon]])*** *(ISG)* (Apal 3, Inq 3, Ens/Mag 4, Magus 4, Prê 3, San 4, Sor 4). Le lanceur subit plus de dégâts mais démoralise ses assaillants.
- ***[[Symbole de douleur]] (M)*** (Hyp 5, Ens/Mag 5, Occ 4, Prê 5, Sor 5). La rune inflige de terribles douleurs.

#### Transmutation
- ***[[Déformation douloureuse]]*** *(AM)* (Ens/Mag 3, Psy 3, San 3, Sor 3). La cible subit un affaiblissement de Dex et de Con.
- ***[[Transmutation du sang en acide]] (M)*** *(AM)* (Ens/Mag 9, Psy 9). La cible reçoit des dégâts d'acide à chaque round et ses assaillants en reçoivent aussi.
...
#### Abjuration
- ***[[Bouclier donde|Bouclier d'onde]]*** *(MCA)* (Cham 1, Dru 1, Ens/Mag 1, Magus 1, San 1, Sor 1). L’eau amortit une attaque ou un effet de feu.
...
#### Invocation
- ***[[Création deau|Création d'eau]]*** (Cham 0, Dru 0, Inq 0, Occ 0, Pal 1, Prê 0). Crée huit litres d'eau pure/niveau.
...
- ***[[Mur de saumure]] ([[Homme-poisson (race)|Homme-poisson]])*** *(ISR)* (Cham 4, Dru 4, Ens/Mag 4, Magus 4, Rôd 3). Crée un mur de 1,5 m d'épaisseur d'eau salée avec un puissant courant.
...
- ***[[Arme de glace sacrée]] (M)*** *(MCA)* (Inq 2, Prê 2). Crée une arme de maître faite d’eau bénite gelée.
- ***[[Armure de glace]] ([[Gozreh (technique)|Gozreh]])*** *(ISG)* (Dru 1, Prê 1, San 1). Forme une cuirasse de glace temporaire.
- ***[[Chevaucher les vagues]]*** *(AM)* (Cham 4, Dru 4, Ens/Mag 4, Prê 4, San 4, Sor 4). La cible peut respirer sous l'eau et nager.
- ***[[Contrôle de leau|Contrôle de l'eau]]*** (Cham 4, Dru 4, Ens/Mag 6, Prê 4). Abaisse ou élève le niveau de l'eau.
- ***[[Façonnage de la neige]] ([[Golarion.Ulfes|Ulfe]])*** *(MR)* (Dru 1, Ens/Mag 2, Prê 2). Donne à la neige toute forme voulue, dont des armes en glace dure.
...
- ***[[Maîtrise des marids]] ([[Ondin (race)|Ondin]])*** *(MR)* (Dru 1, Ens/Mag 1, Prê 1, Rôd 1, San 1, Sor 1). La cible obtient des bonus à l'attaque et aux dégâts quand elle se bat sous l'eau, et des malus quand elle se bat sur terre.
- ***[[Marche sur londe|Marche sur l'onde]]*** (Cham 3, Méd 2, Prê 3, Psy 3, Rôd 3, Sor 3). Permet de marcher sur l'eau.
- ***[[Marche sur londe (partagé)|Marche sur l'onde (partagé)]]*** *(AG)* (Prê 2, Psy 4, Rôd 2). Comme *marche sur l’onde* mais la durée d’effet se divise entre les créatures touchées.
- ***[[Vague mondiale]]*** *(MJRA)* (Dru 9, Ens/Mag 9). Une vague d'eau ou de terre emporte le personnage sur une grande distance.


{s:Reference|EFFETMENTAL}
### Effet mental
...
- ***[[Marques dinterdiction|Marques d'interdiction]]*** *(MJRA)* (Pal 3). 2 créatures doivent réussir des jets de Volonté si elles veulent s’attaquer.
...
#### Divination
- ***[[Amplificateur sensoriel]]*** *(OO)* (Dru 4, Hyp 3, Méd 2, Psy 3, Sor 3). Stimule les sens de toutes les créatures autour du personnage.
...
- ***[[Détection des angoisses]]*** *(UI)* (Apal 2, Bard 3, Hyp 2, Inq 3, Ens/Mag 3, Méd 2, Pal 3, Prê 3, Psy 2, Sor 3, Spi 3). Révèle les pires angoisses des créatures à 18 m à la ronde.
- ***[[Détection des désirs]]*** *(UI)* (Apal 2, Bard 2, Hyp 3, Inq 3, Ens/Mag 3, Méd 2, Pal 3, Prê 3, Psy 2, Sor 3, Spi 3). Révèle les plus grands désirs des créatures à 18 m à la ronde.
...
- ***[[Jauge de sort]] ([[Néthys (technique)|Néthys]])*** *(D&M)* (Bard 2, Inq 2, Ens/Mag 2, Prê 2, Sor 2). Révèle certains des sorts préparés de la cible.
- ***[[Lien des esprits combatifs]] (Y)*** *(AM)* (Hyp 4, Inq 4, Ens/Mag 6, Méd 4, Occ 5, Psy 6). Le personnage et un allié tirent le meilleur de chacun au combat.
...
- ***[[Mondanité]]*** *(UI)* (Bard 1, Hyp 2, Inq 2, Ens/Mag 2, Méd 1, Occ 2, Pal 1, Prê 2, Psy 2). La cible utilise les rangs de Connaissances (noblesse) du personnage.
...
- ***[[Télépathie (sort)|Télépathie]]*** *(AO)* (Hyp 4, Ens/Mag 6, Méd 4, Psy 5, Spi 6). Communication mentale avec des créatures situées dans un rayon de 30 mètres.

#### Enchantement
- ***[[Accoutrement honteux]]*** *(UI)* (Bard 2, Hyp 2, Inq 2, Psy 3). Force la cible à retirer un équipement.
- ***[[Action interdite]]*** *(AM)* (Hyp 1, Inq 1, Occ 1, Prê 1, Psy 1). La cible obéit au personnage qui lui interdit de faire quelque chose.
- ***[[Action interdite supérieure]]*** *(AM)* (Hyp 4, Inq 5, Occ 5, Prê 5, Psy 5). Comme *action interdite* mais cible 1 créature/niveau.
...
- ***[[Ambassadeur animal]]*** *(UI)* (Bard 4, Cham 4, Dru 4, Rôd 3). Offre une conscience temporaire à un messager animal pour qu'il délivre le message du personnage.
...
- ***[[Aphasie]]*** *(UI)* (Bard 1, Hyp 1, Ens/Mag 1, Psy 1, Sor 1). Empêche la cible de comprendre un quelconque langage.
...
- ***[[Appel dun animal|Appel d'un animal]] (Y)*** *(MJRA)* (Dru 1, Hyp 1, Rôd 1). Fait venir un animal au personnage.
- ***[[Appel des nixes]] ([[Ondin (race)|Ondin]])*** *(MR)* (Bard 3, Con 4, ConU 4, Dru 4, Hyp 3, Ens/Mag 4, Psy 3, Sor 4). Force 24 DV de créatures à s'avancer vers le lanceur de sort.
...
- ***[[Aura de linsignifiant|Aura de l'insignifiant]]*** *(UI)* (Bard 3, Hyp 3, Ens/Mag 4, Méd 2, Psy 3). Les actions du personnages paraissent ordinaires pour les créatures affectées.
...
- ***[[Baroud des champions]] ([[Golarion.Shoantis|Shoanti]])*** *(ISR)* (Bard 3, Prê 3). Empêche les importuns d'interférer avec un duel officiel.
...
- ***[[Bénédiction du guet]] ([[Abadar (technique)|Abadar]])*** *(D&M)* (Inq 1, Pal 1, Prê 1). Comme *bénédiction*, mais dure 1 heure/niveau et ne fonctionne que dans la ville natale du personnage.
...
- ***[[Brume de rêves]] ([[Desna (technique)|Desna]])*** *(D&M)* (Bard 1, Cham 1, Inq 1, Pal 1, Prê 1, Sor 1). Emplit la tête d'un ennemi de rêves éveillés, ce qui le ralentit.
...
- ***[[Charme-personne de groupe]]*** *(UI)* (Bard 4, Cham 5, Hyp 4, Ens/Mag 5, Occ 4, Psy 5, Sor 5). Comme *charme-personne* mais affecte plusieurs créatures dans un rayon de 9 m.
...
- ***[[Crime de situation]]*** *(UI)* (Apal 1, Hyp 1). Pousse la cible à commettre un acte criminel.
- ***[[Damnation de la mémoire]] ([[Golarion.Garundais|Garundi]])*** *(ISR)* (Bard 6). Excise les souvenirs impliquant une unique créature chez les cibles.
...
- ***[[Diviser lesprit|Diviser l'esprit]]*** *(AO)* (Psy 9). Compartimente l’esprit, ce qui permet de lancer deux fois le dé sur les jets de Volonté et les tests d’Intelligence et de faire des actions mentales supplémentaires.
- ***[[Domination]] (Y)*** (Bard 4, Cham 5, Hyp 4, Ens/Mag 5, Occ 5, Psy 5, Sor 5, Spi 5). Permet de contrôler un humanoïde par télépathie.
- ***[[Domination danimal|Domination d'animal]]*** (Cham 3, Dru 3, Hyp 3, Psy 4). L'animal obéit aux ordres télépathiques du PJ.
- ***[[Domination universelle]]*** (Con 6, Ens/Mag 9, Psy 9, Sor 9). Comme *domination*, mais sur n'importe qui.
- ***[[Échange desprits|Échange d'esprits]]*** *(AO)* (Con 5, Hyp 5, Ens/Mag 6, Méd 3, Occ 4, Psy 5, Sor 6, Spi 4). Échange son esprit avec celui d’une autre créature pendant 1 heure par niveau.
- ***[[Échange desprits majeur|Échange d'esprits majeur]] (M)*** *(AO)* (Psy 9). Échange définitivement l’esprit du personnage avec celui d’une autre créature.
- ***[[Effacement de lesprit|Effacement de l'esprit]]*** *(AO)* (Hyp 4, Ens/Mag 4, Méd 4, Occ 4, Psy 4, Spi 4). Efface une portion des expériences et de l’esprit de la cible, lui imposant des niveaux négatifs.
...
- ***[[Entremise]]*** *(UI)* (Bard 2, Hyp 2, Ens/Mag 3, Sor 3). Pousse deux créatures à tomber amoureuses.
- ***[[Épidémie de rumeurs]]*** *(UI)* (Bard 5, Hyp 5, Ens/Mag 7, Prê 7, Psy 7, Sor 7, Spi 5). Maudit la cible pour qu'elles attire des rumeurs peu flatteuses.
- ***[[Équité]] ([[Abadar (technique)|Abadar]])*** *(D&M)* (Inq 2, Pal 2, Prê 1). Oblige des créatures à conclure une affaire de façon équitable.
- ***[[Erreur malencontreuse]]*** *(ISG)* (Inq 2, Prê 2, Sor 2). Empêche la cible de confirmer un coup critique.
...
- ***[[Explosion de gloire]] ([[Iomédae (technique)|Iomédae]])*** *(D&M)* (Inq 4, Pal 4, Prê 5). Confère aux alliés un bonus aux jets d'attaque et de sauvegarde contre la peur, ainsi que des points de vie temporaires.
- ***[[Expression du psychonaute]]*** *(OO)* (Psy 2). Bonus de +4 à une valeur de caractéristique aléatoire et malus de -2 à une autre.
- ***[[Faux alibi]] ([[Norgorber (technique)|Norgorber]])*** *(SS)* (Bard 3, Inq 3, Prê 3). Modifie les souvenirs de la cible d'une façon prédéfinie.
- ***[[Faux souvenir]]*** *(UI)* (Bard 2, Hyp 2, Psy 2). Implante temporairement un mauvais souvenir dans l'esprit de la cible.
...
- ***[[Fouet dego I|Fouet d'ego I]]*** *(AO)* (Psy 3). Une créature reçoit un malus de -2 à l’Int, la Sag ou le Cha et est chancelante pendant 1 round.
- ***[[Fouet dego II|Fouet d'ego II]]*** *(AO)* (Psy 4). Comme *fouet d’ego I* mais avec un malus de –4 et chancellement pendant 1d4 rounds.
- ***[[Fouet dego III|Fouet d'ego III]]*** *(AO)* (Psy 5). Comme *fouet d’ego I* mais avec un malus de –5 et chancellement pendant 1d6 rounds.
- ***[[Fouet dego IV|Fouet d'ego IV]]*** *(AO)* (Psy 6). Comme *fouet d’ego I* mais avec un malus de –8 et chancellement pendant 1d8 rounds.
- ***[[Fouet dego V|Fouet d'ego V]]*** *(AO)* (Psy 7). Comme *fouet d’ego I* mais avec un malus de –10 et chancellement pendant 1d10 rounds.
...
- ***[[Héroïsme]] (Y)*** (Alch 3, Bard 2, Con 3, ConU 3, Inq 3, Ens/Mag 3, Méd 2, Psy 3, San 3, Sor 3, Spi 3). Confère +2 aux jets d'attaque, aux jets de sauvegarde et aux tests de compétence.
- ***[[Héroïsme insipide]]*** *(UI)* (Bard 3, Con 4, ConU 4, Inq 4, Ens/Mag 4, Méd 3, Psy 4, San 4, Sor 4, Spi 4). Comme *héroïsme* mais le personnage peut en inverser les effets à tout moment.
- ***[[Héroïsme insipide suprême]]*** *(UI)* (Bard 6, Ens/Mag 7, Psy 7, Sor 7). Comme *héroïsme suprême* mais le personnage peut en inverser les effets à tout moment.
...
- ***[[Immobilisation danimal|Immobilisation d'animal]]*** (Dru 2, Hyp 2, Psy 2, Rôd 2). Immobilise un animal pour 1 round/niveau.
...
- ***[[Impasse égarée]] ([[Samsaran (race)|Samsaran]])*** *(ISR)* (Bard 4, Ens/Mag 4). Enchante la zone d'effet pour désorienter ceux qui s'y déplacent.
- ***[[Implantation de pensées]] ([[Changelin (race)|Changelin]])*** *(MR)* (Bard 1, Hyp 1, Ens/Mag 1, Psy 1, Sor 1). Implante des idées dans l'esprit de la cible.
...
- ***[[Instinct criminel]]*** *(UI)* (Apal 4, Bard 6, Hyp 6, Ens/Mag 8, Psy 8). Maudit la cible pour qu'elle devienne un criminel désaxé. 
...
- ***[[Invocation héroïque]]*** *(AG)* (Ens/Mag 9, Psy 9, Sor 9). Des créatures bénéficient de bonus aux jets d’attaque et de dégâts, de points de vie temporaires et d’une immunité contre les effets de peur et de charme.
...
- ***[[Les yeux du séducteur]] ([[Calistria (technique)|Calistria]])*** *(D&M)* (Bard 2, Ens/Mag 2, Sor 2). Bonus aux tests relatifs au Charisme envers ceux qui peuvent trouver le personnage attirant.
...
- ***[[Litanie déloquence|Litanie d'éloquence]]*** *(AG)* (Apal 2, Inq 3, Pal 2). Fascine une créature pendant 1 round.
...
- ***[[Localité égarée]] ([[Samsaran (race)|Samsaran]])*** *(ISR)* (Ens/Mag 9). Comme *impasse égarée*, mais couvre une zone bien plus grande.
- ***[[Loin des yeux]]*** *(OO)* (Hyp 3, Méd 3, Psy 4). Les créatures qui voient le personnage l'oublient dès qu'il quitte leur champ de vision.
- ***[[Malédiction de dégoût]]*** *(AM)* (Bard 3, Hyp 3, Ens/Mag 5, Occ 4, Psy 6, Sor 5). Cible fiévreuse quand elle voit le déclencheur.
- ***[[Malédiction du paria]]*** *(UI)* (Bard 4, Cham 6, Hyp 4, Inq 4, Prê 6, Sor 6). Maudit la cible pour qu'elle peine à interagir socialement.
...
- ***[[Menteur compulsif]]*** *(UI)* (Bard 1, Hyp 1, Ens/Mag 2, Psy 2, Sor 2). Empêche la cible de dire la vérité.
- ***[[Message suggestif]]*** *(UI)* (Bard 3, Hyp 3, Ens/Mag 4, Méd 3, Occ 4, Psy 3, Sor 4). Permet de communiquer comme avec *message* mais lance une *suggestion* sur une des cibles.
- ***[[Message suggestif de groupe]]*** *(UI)* (Bard 6, Hyp 6, Ens/Mag 7, Occ 6, Psy 6, Sor 7). Permet de communiquer comme avec *message* mais lance une *suggestion* sur chaque cible.
...
- ***[[Négligence]] ([[Halfelin]])*** *(ISR)* (Bard 3). Aide le personnage a paraître petit et insignifiant, améliorant sa Discrétion.
...
- ***[[Ombre du doute]] ([[Tieffelin (race)|Tieffelin]])*** *(ISR)* (Apal 4, Bard 4). Instille chez un adversaire une aura de doutes alimentée par ses angoisses personnelles.
...
- ***[[Pacte de mort]]*** *(OO)* (Bard 5, Sor 6). Prend le contrôle de l'esprit d'une créature et implante un ordre subconscient mortel.
...
- ***[[sort Présence cachée|Présence cachée]]*** *(UI)* (Bard 2, Hyp 2, Inq 2, Ens/Mag 2, Psy 2, Sor 2). Empêche les autres créatures de remarquer la présence du personnage.
...
- ***[[Projection implantée]]*** *(OO)* (Hyp 3, Psy 3). Comme *projection télempathique*, mais les effets restent dormants.
...
- ***[[Rage jalouse]]*** *(OO)* (Apal 2, Bard 2, Cham 3, Hyp 2, Psy 3, San 2, Sor 3, Spi 2). Emplit la cible d'un sentiment d'arrogance injustifiée.
- ***[[Rage sanguinaire]] ([[Orque (race)|Orque]])*** *(MR)* (Bard 2, Ens/Mag 3, Prê 3). Les cibles entrent dans une rage qui s’intensifie avec les dégâts qu’ils subissent, augmentant leur Force et baissant leur CA.
...
- ***[[Rejeter la faute]]*** *(UI)* (Bard 2, Hyp 2, Ens/Mag 3, Psy 2, Sor 3). La cible croit qu'une autre créature est responsable de l'action du personnage.
- ***[[Repentir forcé]]*** *(MJRA)* (Inq 4, Pal 4). La cible se laisse tomber à terre et confesse tous ses pêchés.
- ***[[Résistance à lAffadissement|Résistance à l'Affadissement]] ([[Gnome]])*** *(ISR)* (Alch 4, Dru 6, Ens/Mag 6, Sor 6). Les diminutions de caractéristiques dues à l'Affadissement n'affecte plus les modificateurs du personnage.
...
- ***[[Sacrifice]]*** *(BD)* (Ens/Mag 4, Prê 4). Officialise un sacrifice pour faciliter l'invocation, la négociation et le contrôle d'une créature planaire.
- ***[[Sangsue psychique]]*** *(OO)* (Hyp 2, Ens/Mag 3, Magus 3, Méd 3, Psy 2, San 3, Sor 2, Spi 2). Ponctionne la force de la cible, la forçant à devenir fatiguée pour renforcer le personnage.
...
- ***[[Sommeil de lamnésique|Sommeil de l'amnésique]] ([[Demi-elfe]])*** *(MR)* (Bard 4, Hyp 4, Ens/Mag 4, Psy 4, Sor 4). Comme *sommeil profond*, mais n'affecte qu'une seule créature et lui fait perdre ses derners souvenirs.
...
- ***[[Symbole daliénation mentale|Symbole d'aliénation mentale]] (M)*** (Ens/Mag 8, Occ 6, Prê 8, Sor 8). La rune frappe les créatures proches de démence.
- ***[[Symbole détourdissement|Symbole d'étourdissement]] (M)*** (Ens/Mag 7, Occ 5, Prê 7, Sor 7). La rune étourdit les créatures proches.
- ***[[Symbole de débauche]] (M)*** *(ISG)* (Bard 6, Ens/Mag 8, Prê 8, Sor 8). Trace un symbole qui rend tous ceux qui le voit attirants les uns pour les autres.
...
- ***[[Terreur miasmatique]] ([[Demi-orque]])*** *(ISR)* (Apal 2, Bard 2, Inq 3, San 2). Crache une brume d'un vert maladif qui démoralise les créatures dans la zone.
- ***[[Terrible remords]]*** *(AM)* (Bard 3, Hyp 3, Inq 3, Ens/Mag 4, Prê 4, Psy 4, Spi 4). La créature est obligée de se blesser.
...
- ***[[Vague de criminalité]]*** *(UI)* (Apal 4, Bard 5, Hyp 5, Ens/Mag 7, Psy 7). Pousse les cibles à commettre des actes criminels.
- ***[[Vagues dextase|Vagues d'extase]]*** *(AM)* (Bard 6, Hyp 6, Ens/Mag 7, Prê 7, Psy 7, Sor 7). Les créatures sont étourdies et chancelantes de plaisir.
- ***[[Vengeance de lamoureux|Vengeance de l'amoureux]] (M)*** *(CCMI)* (Bard 3, Cham 3, Ens/Mag 3, Prê 3, Sor 3). Inspire une rage incontrôlée chez le personnage ou son amour contre une personne qui a fait du tord au personnage.
- ***[[Vengeance pour outrage]]*** *(AM)* (Bard 5, Hyp 5, Ens/Mag 6, Psy 6, Sor 6). La cible est obligée de détruire un ennemi.
- ***[[Vérité dAbadar|Vérité d'Abadar]] ([[Abadar (technique)|Abadar]])*** *(D&M)* (Inq 1, Pal 1, Prê 1). Force la cible à dire la vérité.
...
#### Illusion
- ***[[Affliction imaginaire]]*** *(UI)* (Hyp 2, Ens/Mag 3, Psy 3, Sor 3). Convainc la cible qu'elle subit une affliction.
...
- ***[[sort Cauchemar|Cauchemar]] (Y)*** (Alch 5, Bard 5, Hyp 5, Ens/Mag 5, Méd 4, Psy 5, Spi 5). Envoie des visions causant fatigue et perte de 1d10 pv.
...
- ***[[Hallucination audiovisuelle]]*** *(UI)* (Bard 3, Hyp 3, Ens/Mag 3, Magus 3, Méd 2, Occ 3, Psy 3). Crée un fantasme qui inclut des éléments auditifs et visuels.
- ***[[Hallucination auditive]]*** *(UI)* (Bard 1, Hyp 1, Ens/Mag 1, Magus 1, Méd 1, Occ 1, Psy 1). Crée un fantasme qui inclut des éléments auditifs.
- ***[[Hallucination complexe]]*** *(UI)* (Bard 4, Hyp 4, Ens/Mag 4, Magus 4, Méd 3, Occ 4, Psy 4, Sor 4). Crée un fantasme qui inclut des éléments auditifs, olfactifs, tactils, thermaux et visuels.
- ***[[Hallucination permanente]]*** *(UI)* (Ens/Mag 7, Psy 7). Comme *hallucination scénarisée* mais permanent.
- ***[[Hallucination programmée]] (M)*** *(UI)* (Bard 6, Hyp 6, Ens/Mag 6, Magus 6, Occ 6, Psy 6). Comme *hallucination scénarisée* mais n'apparaît que lorsqu'elle est déclenchée.
- ***[[Hallucination scénarisée]]*** *(UI)* (Bard 5, Hyp 5, Ens/Mag 5, Magus 5, Méd 4, Occ 5, Psy 5). Comme *hallucination complexe* mais sans nécessiter de concentration.
...
- ***[[Lueur darc-en-ciel|Lueur d'arc-en-ciel]]*** (Bard 4, Ens/Mag 4, Psy 4). Fascine jusqu'à 24 DV de créatures.
- ***[[Lueurs hypnotiques]]*** (Bard 2, Hyp 2, Ens/Mag 2, Psy 2). Fascine (2d4 + niveau) DV de créatures.
- ***[[Manteau de doutes]]*** *(OO)* (Hyp 6, Psy 8). Envoi des spectres de doute paralysant sur ceux qui attaquent le personnage.
...
- ***[[Objet fantomatique mineur]] ([[Gnome]])*** *(MR)* (Hyp 4, Ens/Mag 4, Psy 4). Comme *création mineure*, mais l'objet créé est une illusion semi-réelle.
...
- ***[[Poussière détoile|Poussière d'étoile]]*** *(MJRA)* (Bard 4, Cham 4, Ens/Mag 4, Occ 4, Psy 4, Sor 4). Silhouette la cible et émet de la lumière.
- ***[[Réalité subjective]]*** *(OO)* (Bard 6, Hyp 5, Ens/Mag 7, Méd 5, Psy 6). Le personnage se convainc qu'une chose est irréelle, ce qui lui permet d'ignorer sa présence.
- ***[[Reproche déchirant]] ([[Hobgobelin (race)|Hobgobelin]])*** *(MR)* (Apal 2, Hyp 3, Inq 3, Prê 3, Psy 3, Sor 3). La cible qui attaque le lanceur de sort subi des dégâts non-létaux.
...
- ***[[Vision de Lamashtu|Vision de folie]]*** *(CCMI)* (Cham 7, Inq 6, Prê 7, Sor 7). Comme *cauchemar*, mais permet de livrer un second sort quand la cible se réveille.
- ***[[Voile répugnant]]*** *(AM)* (Hyp 3, Ens/Mag 3, Psy 3, Sor 3). La nausée et/ou la fièvre affaiblit les créatures.

#### Invocation
- ***[[Choisis ton poison]] ([[Cayden Cailéan (technique)|Cayden Cailéan]])*** *(D&M)* (Bard 1, Inq 1, Prê 1, Sor 1). Convertit temporairement un poison en un alcool enivrant.
- ***[[Halo de gloire]]*** *(MJRA)* (Pal 4). Un dernier sursaut soigne les créatures bonnes et blesse les mauvaises.
...
- ***[[Faim de la goule]] ([[Urgathoa (technique)|Urgathoa]])*** *(D&M)* (Apal 2, Ens/Mag 2, Prê 2, Sor 2). Éveille une faim surnaturelle chez la cible, la forçant à chercher de la chair humanoïde.
...
- ***[[Linceul de foudre]]*** *(MPNJ)* (Dru 3, Ens/Mag 3). Créé une zone d'électricité qui hébète les créatures à l'intérieur.
...
- ***[[Nuées dorage|Nuées d'orage]]*** *(MJRA)* (Cham 8, Dru 8, Ens/Mag 8, Prê 8, Sor 8). 1d8 dégâts par niveau (max 20d8) aux cibles.
...
- ***[[Réservoir draconique]] (Y)*** *(MJRA)* (Alch 3, Ens/Mag 3, San 3). Le personnage peut absorber les dégâts d'énergie et s'en servir pour améliorer une attaque de contact.
- ***[[Souffle de dragon]] (Y)*** *(MJRA)* (Alch 4, Ens/Mag 4, Magus 4, San 4). Le personnage bénéficie du souffle d'un dragon.
- ***[[Trident de Gozreh|Trident de la nature]] ([[Gozreh (technique)|Gozreh]])*** *(D&M)* (Dru 2, Prê 2, San 2, Sor 2). Créé un trident d'électricité fourchu.
- ***[[Violent nuage dorage|Violent nuage d'orage]]*** *(MCA)* (Dru 2, Ens/Mag 2, Magus 2, Sor 2). Nuage d’orage volant qui inflige 3d6 points de dégâts d’électricité.
- ***[[Violent nuage dorage suprême|Violent nuage d'orage suprême]]*** *(MCA)* (Dru 4, Ens/Mag 4, Magus 4, Sor 4). Nuage d’orage volant qui inflige 6d6 points de dégâts d’électricité.
...
- ***[[Sangsue psychique]]*** *(OO)* (Hyp 2, Ens/Mag 3, Magus 3, Méd 3, Psy 2, San 3, Sor 2, Spi 2). Ponctionne la force de la cible, la forçant à devenir fatiguée pour renforcer le personnage.
- ***[[Secret dévoilé]]*** *(UI)* (Bard 3, Cham 4, Hyp 3, Inq 3, Pal 3, Psy 4, Sor 4). Convainc la cible qu'une créature proche connaît son plus grand secret.
- ***[[Sérénité]]*** *(AM)* (Bard 4, Hyp 4, Ens/Mag 6, Prê 5, Psy 5). Sentiment paisible qui blesse les créatures violentes.
- ***[[Symbole de débauche]] (M)*** *(ISG)* (Bard 6, Ens/Mag 8, Prê 8, Sor 8). Trace un symbole qui rend tous ceux qui le voit attirants les uns pour les autres.
- ***[[Terrible remords]]*** *(AM)* (Bard 3, Hyp 3, Inq 3, Ens/Mag 4, Prê 4, Psy 4, Spi 4). La créature est obligée de se blesser.
- ***[[Tranquillité euphorique]]*** *(MJRA)* (Bard 6, Dru 8, Hyp 6, Ens/Mag 8, Prê 8, Psy 8). Rend une unique créature pacifique et amicale.
...
#### Invocation
- ***[[Bénédiction de vie et de courage]]*** *(MJRA)* (Pal 2, Prê 2). +2 aux jets de sauvegarde contre la peur et la mort.
...
#### Évocation
- ***[[Ami du feu]] (Y) ([[Gobelin (race)|Gobelin]])*** *(ISR)* (Alch 2, Magus 2, San 2). Enveloppe le personnage de flammes qui blessent les ennemis proches.
- ***[[Arc brûlant]] ([[Golarion.Kéléshites|Kéléshite]])*** *(MR)* (Ens/Mag 2). Un arc de flammes jaillit des doigts du personnage et rebondit de cibles en cibles.
- ***[[Aura élémentaire]]*** *(MJRA)* (Alch 3, Ens/Mag 3, Magus 3, San 3). Crée une aura d'énergie autour du personnage.
...
- ***[[Boule de feu contrôlée]]*** *(UI)* (Ens/Mag 4, Magus 4, Occ 4, San 4). Comme *boule de feu* mais inflige secrètement moins de dégâts aux alliés du personnage.
- ***[[Caresse élémentaire]]*** *(MJRA)* (Alch 2, Ens/Mag 2, Magus 2, San 2). Gagne une attaque de contact d’énergie.
- ***[[Chaînes de feu]] ([[Ifrit (race)|Ifrit]])*** *(MR)* (Ens/Mag 6, Magus 6). Le sort crée une langue de feu qui inflige 1d6 points de dégâts de feu/niveau et une langue de feu secondaire/niveau.
...
- ***[[Onde de feu]] (Y) ([[Ifrit (race)|Ifrit]])*** *(MR)* (Ens/Mag 3, Magus 3, San 3). Le personnage fait jaillir une ligne de feu infligeant 2d6 points de dégâts pendant 1 round par niveau.
...
- ***[[Toucher de combustion]] ([[Ifrit (race)|Ifrit]])*** *(MR)* (Dru 1, Inq 1, Ens/Mag 1, Magus 1, Psy 1, San 1, Sor 1). Le personnage porte une attaque qui inflige 1d6 points de dégâts et qui risque d'enflammer son adversaire.
...
- ***[[Sentier de la damnation]] (Y) ([[Tieffelin (race)|Tieffelin]])*** *(MR)* (Con 4, ConU 4, Ens/Mag 5, Sor 5). Comme *porte dimensionnelle*, mais une explosion de flamme se manifeste au point de départ du sort.
...
#### Nécromancie
- ***[[Cierge de mort]] ([[Ifrit (race)|Ifrit]])*** *(MR)* (Apal 1, Inq 2, Prê 2, Sor 2). Le personnage achève un ennemi pour le transformer en élémentaire de feu.
...
- ***[[Dragon dartifice|Dragon d'artifice]]*** *(AM)* (Bard 2, Ens/Mag 1). Crée un dragon en feu d'artifice/niveau.
- ***[[Flambée de sang]] ([[Orque (race)|Orque]])*** *(MR)* (Alch 2, Apal 1, Ens/Mag 2, Magus 2, Prê 2, Psy 2, San 2, Sor 2). Enflamme le sang de ceux qui s'approchent du personnage.
...
- ***[[Forme cendrée brûlante]] (Y) ([[Ifrit (race)|Ifrit]])*** *(MR)* (Alch 4, Ens/Mag 4). Le personnage se transforme en un tourbillon de cendres.
- ***[[Fouet de la bouche de lenfer|Fouet de la bouche de l'enfer]] ([[Tieffelin (race)|Tieffelin]])*** *(MR)* (Ens/Mag 4, San 4, Sor 4). Transforme la langue du personnage en un fouet d'énergie.
- ***[[Fureur solaire]] ([[Ifrit (race)|Ifrit]])*** *(MR)* (Dru 2, Sor 2). La cible maudite endure une chaleur insupportable.
...
- ***[[Piste de feu]] ([[Gobelin (race)|Gobelin]])*** *(MR)* (Alch 3, Ens/Mag 3, Magus 3, San 3). Laisse une traînée de flammes qui suit le personnage à chaque pas.
- ***[[Substitution dénergie destructive|Substitution d'énergie destructive]]*** *(MCA)* (Ens/Mag 4). Quand le personnage subit des dégâts d'énergie, il peut faire en sorte que ses sorts, ses pouvoirs magiques et certaines capacités de classes infligent des dégâts de ce type d'énergie au lieu du leur.
...
- ***[[Enceinte parfaite dÉchéan|Enceinte parfaite du mercenaire]] (M)*** *(MPNJ)* (Ens/Mag 9). Créé une combinaison de *mur de force* et de *zone d'antimagie*.
...
#### Évocation
- ***[[sort Abri|Abri]]*** (Bard 3, Ens/Mag 3, Occ 3). Crée un abri pour dix créatures.
...
- ***[[Écuyer spirituel]]*** *(AMH)* (Apal 2, Cham 2, Inq 2, Pal 2, Prê 2, Spi 2). Manifeste un allié de force qui assiste le lanceur au combat.
...
- ***[[Mixture pour bombe demprisonnement|Mixture pour bombe d'emprisonnement]]*** *(AG)* (Alch 6). La bombe du personnage crée une cage de force qui piège les créatures qui se trouvent dans le rayon d’aspersion.
...
- ***[[Rafale du bélier]]*** *(CSU)* (Ens/Mag 3). Projette une boule de force de la taille d'un poing pour blesser et pousser un ennemi.
...
- ***[[Sphère disolement|Sphère d'isolement]]*** (Ens/Mag 4, Occ 4, Psy 4). Globe de force emprisonne ou protège le sujet.
- ***[[Sphère de force durgence|Sphère de force d'urgence]]*** *(RSE)* (Ens/Mag 4). Créé un *mur de force* hémisphérique pour protéger le personnage des avalanches et des embuscades.
...
#### Illusion
- ***[[Sombres murmures]]*** *(UI)* (Apal 1, Bard 2, Con 2, ConU 2, Ens/Mag 2, Prê 2, Sor 2). Transmet des messages par les ombres.

#### Invocation
- ***[[Litanie denchevêtrement|Litanie d'enchevêtrement]]*** *(AG)* (Apal 2, Inq 3, Pal 2). Enchevêtre une créature pendant un round.
- ***[[Litanie de fuite]]*** *(AG)* (Apal 3, Inq 4, Pal 3). Téléporte un allié agrippé pour le libérer.

#### Nécromancie
- ***[[Communication avec les apparitions]]*** *(MCA)* (Cham 3, Méd 2, Prê 4, Psy 4, Sor 4, Spi 4). Une apparition répond à une question par tranche de 2 niveaux.
- ***[[Communication avec les morts]]*** (Cham 3, Inq 3, Méd 2, Prê 3, Psy 3, Sor 3, Spi 3). Un cadavre répond à 1 question/2 niveaux.
...
- ***[[Cercle magique contre le Chaos]]*** (Cham 3, Con 3, ConU 3, Inq 3, Ens/Mag 3, Méd 3, Occ 3, Pal 3, Prê 3, Spi 3). Comme *protection contre le Chaos*, mais avec un rayon de 3 m et une durée de 10 minutes/niveau.
...
#### Évocation
- ***[[Aura darchon|Aura d'archon]]*** *(AM)* (Pal 3, Prê 3). L'aura pénalise l'attaque et la CA des ennemis.
- ***[[Courroux de lordre|Courroux de l'ordre]] (Y)*** (Inq 4, Prê 4). Blesse et étourdit les créatures Chaotiques (1d8 pts de dégâts/2 niveaux).
...
#### Invocation
- ***[[Convocation daccusateur|Convocation d'accusateur]]*** *(MPNJ)* (Bard 4, Con 4, ConU 4, Ens/Mag 4, Prê 4, Sor 4). Appelle un diable accusateur pour exécuter la volonté du lanceur.
- ***[[Convocation dhôte infernal|Convocation d'hôte infernal]]*** *(MPNJ)* (Bard 5, Con 5, ConU 5, Ens/Mag 5, Prê 5, Sor 5). Appelle des diables de l'ost.
- ***[[Résurrection factice suprême]] (M)*** *(UI)* (Prê 9). Ressemble à *résurrection suprême*, mais permet à un diable trompeur de posséder le cadavre ciblé.
...
- ***[[Flèche de laube|Flèche de l'aube]] (Y)*** *(AG)* (Inq 3, Occ 3, Pal 3, Prê 3). Les munitions ciblées émettent une énergie radieuse.
...
- ***[[Halo indésirable]] ([[Sarenraé (technique)|Sarenraé]])*** *(ISG)* (Ens/Mag 1, Pal 1, Prê 1). Manifeste un halo autour d'une cible, l'empêchant de se cacher dans l'obscurité.
...
- ***[[Manteau de colère]]*** *(MJRA)* (Pal 3, Prê 3). La cible gagne +1/quatre niveaux à tous les jets de sauvegarde.
- ***[[Prison de lumière]] ([[Iomédae (technique)|Iomédae]])*** *(ISG)* (Bard 2, Inq 2, Ens/Mag 2, Magus 2, Prê 2). Enferme une créature dans une prison lumineuse qui aveugle et blesse quiconque s'en échappe.
- ***[[Rayon aveuglant]] (Y) ([[Dhampir (race)|Dhampir]])*** *(MR)* (Inq 3, Pal 2, Prê 2). Rayon frappant avec la lumière du soleil, +1 rayon/4 niveaux (max. 3).
...
- ***[[Blessure sympathique]] ([[Zon-kuthon (technique)|Zon-kuthon]])*** *(D&M)* (Dru 2, Prê 2). Redirige la moitié des dégâts subis sur une autre créature.
- ***[[Cercle magique contre le Bien]]*** (Apal 3, Cham 3, Con 3, ConU 3, Inq 3, Ens/Mag 3, Méd 3, Occ 3, Prê 3, Spi 3). Comme *protection contre le Bien*, mais avec un rayon de 3 m et une durée de 10 minutes/niveau.
...
#### Évocation
- ***[[Agonie]]*** *(AM, LD)* (Con 3, ConU 4, Ens/Mag 4, Occ 3, Prê 3, Psy 4). La douleur encourage un extérieur à obéir au personnage.
...
- ***[[Rayon de feu infernal]]*** *(BD)* (Ens/Mag 6, Magus 6, Prê 6, Sor 6). Tire un rayon (+1/4 niveaux) de pure énergie infernale et damne l'âme de ceux qui y succombent aux Enfers.
...
- ***[[sort Cauchemar|Cauchemar]] (Y)*** (Alch 5, Bard 5, Hyp 5, Ens/Mag 5, Méd 4, Psy 5, Spi 5). Envoie des visions causant fatigue et perte de 1d10 pv.
- ***[[Vision de Lamashtu|Vision de folie]]*** *(CCMI)* (Cham 7, Inq 6, Prê 7, Sor 7). Comme *cauchemar*, mais permet de livrer un second sort quand la cible se réveille.
- ***[[Vision infernale]]*** *(AM, LD)* (Bard 3, Hyp 3, Ens/Mag 3, Occ 3, Prê 3, Psy 3, San 3, Sor 3). Un paysage infernal illusoire secoue les créatures.

#### Invocation
- ***[[Appel de rejeton]] (Y) ([[Rovagug (technique)|Rovagug]])*** *(ISG)* (Ens/Mag 9, Prê 9, Sor 9). Appelle un rejeton de Rovagug.
- ***[[Convocation daccusateur|Convocation d'accusateur]]*** *(MPNJ)* (Bard 4, Con 4, ConU 4, Ens/Mag 4, Prê 4, Sor 4). Appelle un diable accusateur pour exécuter la volonté du lanceur.
- ***[[Convocation dérodaémon|Convocation d'érodaémon]]*** *(LD)* (Con 6, ConU 6, Ens/Mag 8, Prê 8, Sor 8). Convoque un érodaémon.
- ***[[Convocation dhôte infernal|Convocation d'hôte infernal]]*** *(MPNJ)* (Bard 5, Con 5, ConU 5, Ens/Mag 5, Prê 5, Sor 5). Appelle des diables de l'ost.
- ***[[Convocation de cacodaémon]]*** *(LD)* (Con 2, ConU 2, Ens/Mag 2, Prê 2, Sor 2). Convoque un cacodaémon.
- ***[[Convocation de cacodaémon suprême]]*** *(LD)* (Con 3, ConU 3, Ens/Mag 4, Prê 4, Sor 4). Convoque 1d4+1 cacodaémons.
- ***[[Convocation de ceustodaémon]]*** *(LD)* (Con 4, ConU 4, Ens/Mag 5, Prê 5, Sor 5). Convoque un ceustodaémon.
- ***[[Convocation de derghodaémon]]*** *(LD)* (Ens/Mag 9, Prê 9, Sor 9). Convoque un derghodaémon.
- ***[[Convocation de méladaémon]]*** *(LD)* (Con 6, ConU 6, Ens/Mag 8, Prê 8, Sor 8). Convoque un méladaémon.
- ***[[Convocation de thanadaémon]]*** *(LD)* (Ens/Mag 9, Prê 9, Sor 9). Convoque un thanadaémon.
- ***[[Crevasse dévastatrice]]*** *(BD)* (Ens/Mag 8, Prê 8, Sor 8). Appelle une faille remplie de démons qui s'étend dans les Abysses.
...
#### Nécromancie
- ***[[Âme parasite]] (F)*** *(BD)* (Cham 9, Ens/Mag 9, Prê 9, Psy 9, Sor 9). Force une âme piégée à entrer dans un nouveau corps.
...
- ***[[Armée de Khain|Armée du Roi goule]]*** *(MMI)* (Ens/Mag 5, Prê 5, Sor 5). Créé un petit groupe de goules menées par un blême, chargés d'énergie nécromantique.
- ***[[Aura de cannibalisme]] ([[Bourbiérin]])*** *(CM)* (Ens/Mag 3, Prê 3, Sor 3). Vol l'énergie vitale des créatures autour du personnage.
- ***[[Aura de mise à mort]]*** *(LD)* (Inq 4, Ens/Mag 4, Prê 4, Sor 4). Émet une aura qui se nourrit de l'âme de ceux qui s'y trouvent,
- ***[[Aura de mise à mort suprême]]*** *(LD)* (Inq 6, Ens/Mag 6, Prê 6, Sor 6). Comme *aura de mise à mort* mais les créatures mourantes succombent plus rapidement à l'intérieur de l'aura.
- ***[[Cierge de mort]] ([[Ifrit (race)|Ifrit]])*** *(MR)* (Apal 1, Inq 2, Prê 2, Sor 2). Le personnage achève un ennemi pour le transformer en élémentaire de feu.
- ***[[Cœur de lennemi|Cœur de l'ennemi]] ([[Orque (race)|Orque]])*** *(MR)* (Apal 2, Prê 2, Sor 2). Dévore le cœur d'un adversaire sans défense pour gagner en puissance.
...
- ***[[Crâne de sentinelle]] ([[Orque (race)|Orque]])*** *(MR)* (Apal 1, Ens/Mag 2, Prê 2, Sor 2). Créé une sentinelle macabre à partir de la tête coupée d'un humanoïde ou d'un humanoïde monstrueux.
- ***[[Création de gemme spirituelle]] (F)*** *(BD)* (Cham 3, Ens/Mag 3, Occ 3, Prê 3, Sor 3, Spi 3). Piège l'âme d'une créature récemment morte dans une gemme.
...
- ***[[Damnation]]*** *(BD)* (Apal 4, Cham 4, Prê 4, Sor 4, Spi 4). Bannit une âme aux Enfers si elle meurt dans la minute.
...
- ***[[Faim de la goule]] ([[Urgathoa (technique)|Urgathoa]])*** *(D&M)* (Apal 2, Ens/Mag 2, Prê 2, Sor 2). Éveille une faim surnaturelle chez la cible, la forçant à chercher de la chair humanoïde.
- ***[[Faim vampirique]] ([[Urgathoa (technique)|Urgathoa]])*** *(D&M)* (Apal 3, Dru 3, Ens/Mag 3, Prê 3, Sor 3). Confère à la cible les crocs et la soif d'un vampire.
- ***[[Fléau des cavaliers]]*** *(LD)* (Ens/Mag 9, Prê 9). Fait exploser une zone avec une énergie qui déchire les âmes, infligeant 1d4 niveaux négatifs et 1d6 dégâts d'acide/niveau.
- ***[[Fouet de lastradaémon|Fouet de l'astradaémon]]*** *(BD)* (Ens/Mag 6, Magus 5, Prê 6, Sor 6). Transforme les mains du lanceur en griffes redoutables qui infligent des niveaux négatifs.
- ***[[Interrogatoire]]*** *(AM)* (Hyp 1, Inq 1, Ens/Mag 1, Psy 1, Sor 1). La cible répond aux questions ou souffre.
- ***[[Interrogatoire supérieur]]*** *(AM)* (Inq 4, Psy 4). Comme *interrogatoire* mais avec plus de douleur et de questions.
- ***[[Légion de la tombe]]*** *(RSE)* (Ens/Mag 8, Prê 8). Appelle 1d4+2 momies évoluées.
- ***[[Malédiction de leau|Malédiction de l'eau]] (M)*** (Apal 1, Inq 1, Prê 1). Crée de l'eau maudite.
- ***[[Malédiction des ondins]] ([[Ondin (race)|Ondin]])*** *(MR)* (Ens/Mag 1, Sor 1). Le corps de la cible perd sa capacité à respirer automatiquement.
...
- ***[[Porteur de peste]] ([[Urgathoa (technique)|Urgathoa]])*** *(ISG)* (Alch 6, Apal 6, Dru 6, Inq 6, Ens/Mag 7, Prê 6, Sor 6). Fait de la cible un porteur de nombreuses maladies contagieuses.
- ***[[Projection dombre|Projection d'ombre]]*** *(MJRA)* (Ens/Mag 4). Le personnage devient temporairement une ombre.
- ***[[Représailles]]*** *(MJRA)* (Inq 3). Le dernier attaquant est affligé de malus.
- ***[[Sacrifice partagé]] ([[Asmodéus (technique)|Asmodéus]])*** *(D&M)* (Apal 3, Cham 2, Con 3, ConU 3, Prê 2, Sor 2). Redirige la moitié des dégâts subis sur une autre créature.
...
- ***[[Réceptacle divin]] ([[Oracle]] uniquement)*** *(MJRA)* (Prê 8). Transforme l'oracle en une énorme créature d'un autre monde.
- ***[[Transplantation faciale]]*** *(ISG)* (Alch 5, Apal 4, Cham 4, Inq 4, Ens/Mag 5, Magus 5, Prê 4, Sor 5). Extrait le visage et les yeux d'une créature, les fondant magiquement avec ceux du lanceur.
...
#### Transmutation
- ***[[Frappes fébriles]] ([[Homme-rat (race)|Homme-rat]])*** *(MR)* (Alch 2, Apal 2, Dru 2, Magus 3, Rôd 4, Sor 2). Les attaques au corps à corps infligées au personnage rendent ses attaquants fiévreux.


{s:Reference|MALEDICTION}
### Malédiction
...
#### Divination
- ***[[Échec annoncé]]*** *(AM)* (Ens/Mag 8, Occ 6, Psy 8, Sor 8). La cible est secouée et fiévreuse de façon permanente et peut même recevoir une plaie magique.
- ***[[Livre ouvert]]*** *(UI)* (Apal 2, Bard 2, Hyp 2, Inq 2, Ens/Mag 3, Psy 2, Sor 3). Maudit la cible pour qu'il soit plus facile d'en apprendre plus sur elle.
- ***[[Marque dévidente morale|Marque d'évidente morale]]*** *(MCA)* (Prê 3). Les autres créatures peuvent déterminer l’alignement de la cible.
...
#### Nécromancie
- ***[[Cécité nocturne]]*** *(CSU)* (Apal 1, Bard 1, Cham 2, Ens/Mag 1, Prê 2, San 1, Sor 1). Détériore la vision de la cible comme s'il faisait plus sombre.
- ***[[Cécitésurdité|Cécité/surdité]] (Y)*** (Apal 2, Bard 2, Cham 3, Hyp 2, Ens/Mag 2, Prê 3, Psy 2, San 2, Sor 2, Spi 3). Rend la cible aveugle ou sourde.
- ***[[Compensation rétributive]]*** *(OO)* (Apal 3, Inq 3, Occ 3, Sor 4, Spi 3). Les créatures qui prennent l'objet ciblé subissent une malédiction de fatigue.
- ***[[Damnation]]*** *(BD)* (Apal 4, Cham 4, Prê 4, Sor 4, Spi 4). Bannit une âme aux Enfers si elle meurt dans la minute.
- ***[[Étrange fièvre]]*** *(AM)* (Inq 3, Ens/Mag 3, Psy 3, Sor 3). La cible est atteinte de la plaie étrange fièvre.
- ***[[Fardeau de loracle|Fardeau de l'oracle]] ([[Oracle]] uniquement)*** *(MJRA)* (Prê 2). La créature est affectée par les effets négatifs de la malédiction de l’oracle.
...
- ***[[sort Malédiction|Malédiction]]*** (Apal 3, Cham 3, Hyp 3, Ens/Mag 4, Méd 2, Occ 3, Prê 3, San 4, Sor 3, Spi 3). -6 à une caractéristique, -4 aux jets d'attaque, aux jets de sauvegarde et aux tests de compétence, ou 50 % de chances de perdre chaque action.
- ***[[Malédiction conditionnelle]]*** *(UI)* (Apal 4, Cham 4, Hyp 3, Inq 4, Ens/Mag 5, Méd 3, Occ 4, Prê 4, Psy 5, Sor 4, Spi 5). Impose une malédiction difficile à dissiper sans remplir les conditions établies.
- ***[[Malédiction des ondins]] ([[Ondin (race)|Ondin]])*** *(MR)* (Ens/Mag 1, Sor 1). Le corps de la cible perd sa capacité à respirer automatiquement.
...
#### Transmutation
- ***[[Contact défigurant]] (Y)*** *(AM, LD)* (Hyp 2, Ens/Mag 2, Occ 2, Prê 2, Psy 2, San 2, Sor 2, Spi 2). La cible est défigurée.
...
- ***[[Fureur solaire]] ([[Ifrit (race)|Ifrit]])*** *(MR)* (Dru 2, Sor 2). La cible maudite endure une chaleur insupportable.
- ***[[Malchance de lartisan|Malchance de l'artisan]]*** *(MJRA)* (Ens/Mag 1, Occ 1). Le sujet perd -5 au prochain test d’Artisanat.
- ***[[Malédiction du sommeil brûlant]]*** *(MCA)* (Cham 4, Ens/Mag 4, Psy 4, Sor 4). La créature prendra feu la prochaine fois qu’elle dormira pendant une heure.
...
- ***[[Conversion canope]] (F, M)*** *(RSE)* (Ens/Mag 9, Prê 9). Éviscère la cible, créant une momie à partir de son essence vitale.
- ***[[Création de gemme spirituelle]] (F)*** *(BD)* (Cham 3, Ens/Mag 3, Occ 3, Prê 3, Sor 3, Spi 3). Piège l'âme d'une créature récemment morte dans une gemme.
- ***[[sort Destruction|Destruction]] (F)*** (Cham 8, Prê 7, Sor 8). Tue la cible et détruit son corps.
...
- ***[[Mise à mort]] (Y)*** (Apal 1, Inq 2, Prê 2, Sor 2, Spi 2). Achève une créature mourante ; le PJ gagne temporairement 1d8 pv, +2 en Force et +1 niveau de lanceur de sorts.
- ***[[Plainte doutre-tombe|Plainte d'outre-tombe]]*** (Cham 9, Ens/Mag 9, Psy 9, Sor 9). Inflige 10 points de dégâts/niveau à une créature/niveau.
- ***[[Ravageur dâme|Ravageur d'âme]] (Y)*** *(CMy)* (Ens/Mag 8, Prê 8, Sor 8). Inflige 1d6 points de dégâts/niveau aux créatures vivantes dans une zone de 6m de rayon.
- ***[[Souffle de la banshie]]*** *(MCA)* (Ens/Mag 6, Sor 6, Spi 6). Cône qui inflige 1d4 points de dégâts par niveau et panique les créatures.
- ***[[Suffocation instantanée]]*** *(CSU)* (). Tue une créature par la consommation de pesh.
- ***[[Suffocation lente]]*** *(CSU)* (). Provoque une overdose de pesh chez la cible, la faisant suffoquer lentement.
...
- ***[[Ancre dombre|Ancre d'ombre]] (Y) ([[Wayang (race)|Wayang]])*** *(MR)* (Bard 2, Hyp 2, Ens/Mag 2, Psy 2, Sor 2). Ancre l'ombre de la cible au sol, ce qui empêche tout déplacement.
- ***[[Arme dombre|Arme d'ombre]] (Y)*** *(AM)* (Ens/Mag 1, Occ 1, Psy 1, San 1, Sor 1). Crée une arme de maître quasi réelle.
- ***[[Barde dombre|Barde d'ombre]]*** *(AM)* (Bard 5). Clone d'ombre qui commence une représentation bardique.
...
- ***[[Convocation dombres|Convocation d'ombres]]*** (Bard 4, Hyp 4, Ens/Mag 4, Spi 4). Reproduit les invocations de 3e niveau ou moins ; 20 % sont réelles.
- ***[[Convocation dombres suprême|Convocation d'ombres suprême]]*** (Ens/Mag 7). Comme *convocation d'ombres*, mais jusqu'au 6e niveau ; 60 % sont réelles.
...
- ***[[Objet fantomatique majeur]] ([[Gnome]])*** *(MR)* (Hyp 5, Ens/Mag 5, Psy 5). Comme *création majeure*, mais l'objet créé est une illusion semi-réelle.
- ***[[Pas de lombre|Pas de l'ombre]]*** *(AM)* (Bard 4, Ens/Mag 4, Psy 4, Sor 4, Spi 4). Téléportation d'une ombre à une autre.
- ***[[Projection dimage|Projection d'image]] (M)*** (Bard 6, Hyp 6, Ens/Mag 7, Occ 6, Psy 7). Double illusoire pouvant parler et lancer des sorts.
- ***[[Reflets dombre|Reflets d'ombre]]*** (Ens/Mag 9). Comme *convocation d'ombres*, mais jusqu'au 8e niveau ; 80 % sont réelles.
- ***[[Sombres murmures]]*** *(UI)* (Apal 1, Bard 2, Con 2, ConU 2, Ens/Mag 2, Prê 2, Sor 2). Transmet des messages par les ombres.
- ***[[Tapisserie de fables]] ([[Golarion.Varisiens|Varisien]])*** *(ISR)* (Bard 5). Convoque l'ombre une personnalité légendaire.
...
#### Invocation
- ***[[Éclairs dobscurité aveuglante|Éclairs d'obscurité aveuglante]] ([[Fetchelin (race)|Fetchelin]])*** *(MR)* (Ens/Mag 3, Magus 3, San 3, Sor 3). Créé des éclairs d'énergie négative qui blessent les vivants, soignent les morts-vivants, et qui peuvent aveugler les cibles.

#### Transmutation
- ***[[Marque fantôme]] (M)*** *(UI)* (Bard 4, Occ 3, Sor 4, Spi 4). Permet à un objet de se transformer en marque et vice versa.
...
#### Invocation
- ***[[Baume empoisonné]]*** *(UI)* (Cham 4, Dru 5, Occ 4, Prê 4, Sor 5). Comme *soins importants* mais inflige un poison à retardement.
...
- ***[[Poison écrasant]]*** *(UI)* (Apal 4, Cham 6, Dru 6, Prê 6, Rôd 4, Sor 6). Rend un poison plus difficile à combattre.
...
- ***[[Venin conditionné]] (M)*** *(UI)* (Cham 4, Ens/Mag 4). Comme *venin latent* mais avec une condition de déclenchement.
- ***[[Venin latent]] (M)*** *(UI)* (Alch 2, Cham 2, Ens/Mag 2). Retarde le temps d'incubation d'un poison et dissimule sa présence.

#### Transmutation
- ***[[Accélération du poison]]*** *(MJRA)* (Dru 2, Ens/Mag 2, Occ 2, Rôd 2). Accélère le délai d'action du poison ciblé.
- ***[[Crachat venimeux]]*** *(AM)* (Cham 4, Dru 3, Prê 4, Sor 3). Crache du venin de vipère noire aveuglant.
- ***[[Dard vengeur]] ([[Calistria (technique)|Calistria]])*** *(ISG)* (Cham 5, Con 5, ConU 5, Ens/Mag 5, Prê 6, Sor 5). Le lanceur se voit pousser une longue queue de guêpe munie d'un dard.
- ***[[Enchevêtrement répugnant]]*** *(MCA)* (Cham 2, Dru 2, Rôd 2). Comme *enchevêtrement*, mais les plantes ont une sève qui rend malade.
- ***[[Forme miasmatique]] ([[Sylphe (race)|Sylphe]])*** *(MR)* (Alch 4, Ens/Mag 4). Comme *état gazeux*, mais le corps vaporeux de la cible est dangereux pour les créatures qui le touchent.
- ***[[Œuf empoisonné]] ([[Norgorber (technique)|Norgorber]])*** *(D&M)* (Bard 1, Cham 1, Inq 1, Ens/Mag 1, Magus 1, Prê 1, Sor 1). Transforme un unique œuf en une dose de poison de petit mille-pattes.
- ***[[Putréfaction de leau et de la nourriture|Putréfaction de l'eau et de la nourriture]]*** *(MJRA)* (Sor 0). Rend l’eau et la nourriture immangeables.
...
- ***[[Résurrection factice]] (M)*** *(UI)* (Cham 8, Prê 7, Sor 8). Ressemble à *résurrection*, mais permet à un démon des ombres de posséder le cadavre ciblé.
- ***[[Résurrection factice suprême]] (M)*** *(UI)* (Prê 9). Ressemble à *résurrection suprême*, mais permet à un diable trompeur de posséder le cadavre ciblé.
- ***[[Téléportation perfide]]*** *(UI)* (Con 6, ConU 6, Ens/Mag 6, Magus 6, Occ 6, Psy 6, Sor 6, Spi 6). Comme *téléportation* mais le personnage peut imposer un incident à certaines créatures ou changer leur destination.
...
#### Illusion
- ***[[Démarche décalibrée]]*** *(UI)* (Alch 2, Apal 2, Bard 2, Hyp 2, Inq 2, Ens/Mag 2, Magus 2, Méd 2, Occ 2, Psy 2, Spi 2). Les sons produits par la cible semblent venir d'un autre point de l'espace.
...
- ***[[Carillon damplification|Carillon d'amplification]]*** *(MCA)* (Bard 6). L’objet touché inflige des dégâts de son, qui augmentent chaque round.
...
#### Évocation
- ***[[Dispersion des sièges]] ([[Nain]])*** *(ISR)* (Cham 5, Dru 5, Rôd 4). Déclenche une explosion qui éloigne et deséquilibre ceux présents dans la zone.
- ***[[Orbe en fusion]]*** *(MCA)* (Ens/Mag 2, Magus 2, San 2, Sor 2). Arme à aspersion de métal en fusion qui inflige 2d6 points de dégâts de feu en plus de dégâts continus.
...
- ***[[Bouclier de pierre]] ([[Oréade (race)|Oréade]])*** *(MR)* (Cham 1, Con 1, ConU 1, Dru 1, Ens/Mag 1, Magus 2, Prê 1, San 1). La pierre offre un bonus de +4 à la CA et un bonus de +2 à ses jets de Réflexes.
- ***[[Boule de boue]] ([[Gobelin (race)|Gobelin]])*** *(MR)* (Dru 1, Ens/Mag 1, Magus 1, San 1, Sor 1). Crée une boule de boue collante qui aveugle une cible.
...
- ***[[Poing invincible de la terre]] (Y) ([[Oréade (race)|Oréade]])*** *(MR)* (Dru 1, Prê 1). Lance une pierre de la taille d'un poing capacble de canaliser le ki du personnage sur la cible.
...
- ***[[Creuser un passage]] ([[Kobold (race)|Kobold]])*** *(ISR)* (Dru 5, Ens/Mag 5). Extrait et déplace de la neige, de la poussière et de la roche ou glace meuble ou compacte.
- ***[[Déchaînement de débris]] ([[Oréade (race)|Oréade]])*** *(MR)* (Bard 3, Dru 3, Ens/Mag 3, Prê 3, San 3, Sor 3). Anime une zone rocailleuse pour en faire une dangereuse nuée de débris.
- ***[[Élévation du sol]] ([[Nain]])*** *(MR)* (Dru 2, Magus 2, Prê 2, Rôd 2). Le sol sous la cible s'élève d'1,5 mètres.
- ***[[Entrave de terre]] ([[Oréade (race)|Oréade]])*** *(MR)* (Dru 2, Sor 2). Les zones de terre et de pierre sous la cible tentent de l'abattre.
- ***[[Entrave de terre de groupe]] ([[Oréade (race)|Oréade]])*** *(MR)* (Dru 6, Sor 6). Comme *entrave de terre* mais affecte plusieurs cibles.
...
- ***[[Nage dans la terre]] ([[Svirfneblin (race)|Svirfneblin]])*** *(MR)* (Alch 4, Cham 4, Dru 4, Ens/Mag 4, San 4). Permet à la cible de nager à travers la pierre, la terre, et d'autres terrains.
- ***[[Nappe de goudron]]*** *(AG)* (Con 5, ConU 6, Dru 6, Ens/Mag 6). Transforme la couche supérieure du sol en goudron brûlant.
- ***[[Peau en fer]] ([[Duergar (race)|Duergar]])*** *(CM)* (Alch 2, Apal 2, Dru 2, Pal 2, Prê 2, Psy 2, Rôd 2, San 2, Sor 2). La peau du personnage durcit et prend la couleur et la texture du fer.
- ***[[Petites fractures]] ([[Torag (technique)|Torag]])*** *(D&M)* (Cham 1, Dru 1, Prê 1, Sor 1). Fragilise la terre et la pierre.
