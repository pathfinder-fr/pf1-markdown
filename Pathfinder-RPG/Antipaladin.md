---
Name: Pathfinder-RPG.Antipaladin
Title: L'antipaladin
LastModified: 2024-09-29 16:11
Categories:
- Classe
- Règle officielle
...
{| CLASS="tablo centre"
|+ {s:Reference|TABLEANTIPALADIN}L'antipaladin
|- CLASS="titre"
| ROWSPAN="2" | Niveau
| ROWSPAN="2" | BBA
| ROWSPAN="2" | Réflexes
...
| +2
| +2
| CLASS="gauche" | [[Antipaladin#AURADUMAL|Aura du mal]], [[Antipaladin#CHATIMENTDUBIEN|châtiment du bien]] 1/jour, [[Antipaladin#DETECTIONDUBIEN|détection du bien]]
| -
| -
| -
| -
...
| +3
| +3
| CLASS="gauche" | [[Antipaladin#RESISTANCEMAUDITE|Résistance maudite]], [[Antipaladin#TOUCHERDECORRUPTION|toucher de la corruption]]
| -
| -
| -
| -
...
| +3
| +3
| CLASS="gauche" | [[Antipaladin#AURADELACHETE|Aura de lâcheté]], [[Antipaladin#CRUAUTE|cruauté]], [[Antipaladin#VECTEURDEMALADIE|vecteur de maladie]]
| -
| -
| -
| -
...
| +4
| +4
| CLASS="gauche" | [[Antipaladin#CANALISATIONDENERGIENEGATIVE|Canalisation d'énergie negative]], [[Antipaladin#CHATIMENTDUBIEN|châtiment du bien]] 2/jour
| 0
| -
| -
| -
...
| +4
| +4
| CLASS="gauche" | [[Antipaladin#FAVEURDESFIELONS|Faveur des fiélons]]
| 1
| -
| -
| -
...
| +5
| +5
| CLASS="gauche" | [[Antipaladin#CRUAUTE|Cruauté]]
| 1
| -
| -
| -
...
| +5
| +5
| CLASS="gauche" | [[Antipaladin#CHATIMENTDUBIEN|Châtiment du bien]] 3/jour
| 1
| 0
| -
| -
...
| +6
| +6
| CLASS="gauche" | [[Antipaladin#AURADEDESESPOIR|Aura de désespoir]]
| 1
| 1
| -
| -
...
| +7
| +7
| CLASS="gauche" | [[Antipaladin#CHATIMENTDUBIEN|Châtiment du bien]] 4/jour
| 2
| 1
| 0
| -
...
| +7
| +7
| CLASS="gauche" | [[Antipaladin#AURADEVENGEANCE|Aura de vengeance]]
| 2
| 1
| 1
| -
...
| +8
| +8
| CLASS="gauche" | [[Antipaladin#CHATIMENTDUBIEN|Châtiment du bien]] 5/jour
| 3
| 2
| 1
| 0
...
| +9
| +9
| CLASS="gauche" | [[Antipaladin#AURADUPECHE|Aura de péché]]
| 3
| 2
| 1
| 1
...
| +10
| +10
| CLASS="gauche" | [[Antipaladin#CHATIMENTDUBIEN|Châtiment du bien]] 6/jour
| 3
| 3
| 2
| 1
...
| +10
| +10
| CLASS="gauche" | [[Antipaladin#AURADEDEPRAVATION|Aura de dépravation]]
| 4
| 3
| 2
| 1
...
| +11
| +11
| CLASS="gauche" | [[Antipaladin#CHATIMENTDUBIEN|Châtiment du bien]] 7/jour
| 4
| 3
| 3
| 2
...
| +12
| +12
| CLASS="gauche" | [[Antipaladin#CHAMPIONMAUDIT|Champion maudit]]
| 4
| 4
| 3
| 3
...
{s:ImageDroite|Illustrations/PNJ/Urgraz.jpg|35%}
### Descriptif de la classe
Les aptitudes de l’antipaladin sont décrites ci-dessous.

#### Armes et armures
Les antipaladins sont formés à l’utilisation de toutes les [[Caractéristiques des armes#ARMECOURANTE|armes courantes]] et [[Caractéristiques des armes#ARMEDEGUERRE|armes de guerre]] ainsi qu’au port de tous les types d’armures ([[Tableau récapitulatif des armures#armures lourdes|lourdes]], [[Tableau récapitulatif des armures#armures intermédiaires|intermédiaires]] et [[Tableau récapitulatif des armures#armures légères|légères]]) et des [[Tableau récapitulatif des armures#armures boucliers|boucliers]] (à l’exception des [[Descriptions individuelles des armures#pavois|pavois]]).

{s:Reference|AURADUMAL}
#### Aura du Mal (Ext)
La puissance de l’aura de Mal (voir *[[détection du Mal]]*) qui entoure un antipaladin est égale à son niveau. Lorsqu’un [[paladin]] utilise sa capacité de [[paladin#Châtiment du Mal|châtiment du Mal]] sur un antipaladin, il inflige 2 points de dégâts par niveau de paladin lors de la première attaque réussie.

{s:Reference|DETECTIONDUBIEN}
...
{s:Reference|CHATIMENTDUBIEN}
#### Châtiment du Bien (Sur)
Une fois par jour, un antipaladin peut faire appel aux puissances du mal pour écraser les forces du bien. Par une [[action rapide]], l’antipaladin désigne un ennemi situé dans son champ de vision et le prend pour cible de son châtiment du Bien. Si la cible est d’[[alignement]] [[Bon]], l’antipaladin ajoute son bonus de [[Charisme]] (s’il en a un) à ses jets d’attaques et son niveau d’antipaladin à tous les jets de dégâts contre elle. Si la cible est un [[type Extérieur|Extérieur]] du sous-type [[sous-type Bien|bien]], un [[dragon]] d’alignement Bon ou un individu d’alignement Bon possédant des niveaux de [[prêtre]] ou de [[paladin]], le bonus aux dégâts passe à 2 points de dégâts par niveau de l’antipaladin pour la première attaque réussie. Dans tous les cas, les attaques du châtiment du Bien ignorent toutes les [[RD|réductions de dégâts]] dont la cible pourrait bénéficier.
...
{s:Reference|RESISTANCEMAUDITE}
#### Résistance maudite (Sur)
Au niveau 2, l’antipaladin gagne un bonus à tous ses [[jet de sauvegarde|jets de sauvegarde]] égal à son bonus de [[Charisme]] (s’il en a un).

{s:Reference|TOUCHERDECORRUPTION}
...
L’antipaladin peut également utiliser cette capacité pour guérir les [[type mort-vivant|morts-vivants]] et ainsi soigner 1d6 [[point de vie|points de vie]] par tranche de deux niveaux d’antipaladin.

Cette capacité peut être modifiée par tous les dons, sorts ou autres effets qui influencent la capacité d’[[paladin#imposition des mains|imposition des mains]] des [[paladin|paladins]]. Par exemple, le don [[Imposition des mains supplémentaire]] donne à un antipaladin deux utilisations quotidiennes supplémentaires de sa capacité de toucher de corruption.

{s:Reference|AURADELACHETE}
#### Aura de lâcheté (Sur)
Il émane d’un antipaladin de niveau  3 une aura intimidante qui impose à tous les ennemis situés dans un rayon de 3 m un malus de –4 aux [[jet de sauvegarde|jets de sauvegarde]] contre la [[Terreur (capacité)|terreur]]. Les créatures qui sont normalement immunisées contre la [[Terreur (capacité)|terreur]] perdent cette immunité lorsqu’ils se trouvent dans cette aura. Cette capacité fonctionne seulement lorsque l’antipaladin est conscient, mais pas s’il est [[inconscient]] ou [[mort]].

{s:Reference|VECTEURDEMALADIE}
...
- **Effrayé** : la cible est plus [[effrayé|effrayée]] pendant 1 round par deux niveaux d’antipaladin (L'antipaladin doit posséder la cruauté *Secoué* avant de pouvoir choisir cette option).
- **Épuisé** : la cible est [[épuisé|épuisée]] (l’antipaladin doit posséder la cruauté Fatigué avant de pouvoir choisir cette option).
...
- **Nauséeux** : la cible est [[nauséeux|nauséeuse]] pendant 1  round par trois niveaux d’antipaladin (l’antipaladin doit posséder la cruauté Fiévreux avant de pouvoir choisir cette option).

Au niveau 12,  les choix suivants s’ajoutent à la liste des cruautés disponibles :
- **Aveugle** : la cible est [[aveuglé|aveugle]] pendant 1  round par niveau d’antipaladin.
- **Assourdi** : la cible est [[sourd|assourdie]] pendant 1  round par niveau d’antipaladin.
- **Étourdi** : la cible est [[étourdi|étourdie]] pendant 1  round par quatre niveaux d’antipaladin.
- **Paralysé** : la cible est [[paralysé|paralysée]] pendant 1  round.

Ces effets ne se cumulent pas. Par exemple, lorsqu’un antipaladin de niveau 12 utilise son [[Antipaladin#TOUCHERDECORRUPTION|toucher de corruption]], il inflige 6d6 points de dégâts et peut également rendre la cible fatiguée, hébétée, empoisonnée ou malade. Une fois qu’une cruauté a été sélectionnée, ce choix ne peut plus être modifié.

{s:Reference|CANALISATIONDENERGIENEGATIVE}
#### Canalisation d’énergie négative (Sur)
Lorsque l’antipaladin atteint le niveau  4, il acquiert la capacité surnaturelle de [[prêtre#CANALISATIONDENERGIE|canaliser de l’énergie négative]] avec un niveau effectif de [[prêtre]] égal à son niveau d’antipaladin. Chaque canalisation d’énergie consomme deux utilisations de sa capacité de [[antipaladin#toucher de corruption|toucher de corruption]]. Il s’agit d’une capacité basée sur le [[Charisme]].

{s:Reference|SORTS}
#### Sorts
Dès le niveau  4, un antipaladin peut lancer un petit nombre de sorts divins appartenant à la [[liste des sorts dantipaladin|liste de sorts d’antipaladin]]. Un antipaladin doit choisir et préparer ses sorts à l’avance. Pour préparer ou lancer un sort, un antipaladin doit avoir une valeur de [[Charisme]] au moins égale à 10  +  le niveau du sort. Le DD des jets de sauvegarde contre les sorts de l’antipaladin est égal à 10 +  le niveau du sort + le modificateur de [[Charisme]] de l’antipaladin.

Comme les autres lanceurs de sorts, l’antipaladin ne peut lancer qu’un nombre de sorts donné de chaque niveau chaque jour. Son quota de sorts quotidiens est indiqué sur la Table 2-11. En plus de cela, il reçoit des sorts supplémentaires si sa valeur de [[Charisme]] est [[caractéristiques#TABLEAUCARACTERISTIQUES|suffisamment élevée]]. Quand la Table 2-11 indique que l’antipaladin peut lancer quotidiennement 0  sort d’un niveau donné, il ne dispose, pour ce niveau de sorts, que des sorts supplémentaires que lui accorde un Charisme élevé.

Chaque jour, l’antipaladin doit passer 1  heure à  prier et à méditer afin de renouveler son quota journalier de sorts. L’antipaladin peut préparer et lancer n’importe quel sort de la [[liste des sorts dantipaladin|liste de sorts d’antipaladin]] pour autant qu’il puisse lancer des sorts de ce niveau. Il doit cependant choisir quels sorts préparer au cours de sa méditation quotidienne.

Jusqu’au niveau 3, l’antipaladin n’a pas de [[NLS|niveau de lanceur de sorts]]. À partir du niveau 4, son niveau de lanceur de sorts est égal son niveau d’antipaladin –3.

{s:Reference|FAVEURDESFIELONS}
...
Au niveau 11, le serviteur acquiert l’archétype [[archétypes#CREATUREEVOLUEE|évolué]]. Au niveau  15, il gagne une [[résistance à la magie]] égale au niveau de l’antipaladin + 11.
...
{s:Reference|AURADEDESESPOIR}
#### Aura de désespoir (Sur)
Au niveau  8,  tous les ennemis situés dans un rayon de 3 m autour de l’antipaladin subissent un malus de –2 sur tous leurs [[jet de sauvegarde|jets de sauvegarde]]. Ce malus ne se cumule pas avec les pénalités imposées par l’[[Antipaladin#AURADELACHETE|aura de lâcheté]]. Cette aptitude fonctionne tant que l’antipaladin est conscient, mais pas s’il est [[inconscient]] ou [[mort]].

{s:Reference|AURADEVENGEANCE}
#### Aura de vengeance (Sur)
Au niveau 11, un antipaladin peut sacrifier deux utilisations de sa capacité de [[antipaladin#CHATIMENTDUBIEN|châtiment du Bien]] pour permettre à tous ses alliés situés à 3 m ou moins d’utiliser un châtiment du Bien avec ses propres bonus. Les alliés doivent utiliser ce châtiment du Bien avant que le début du prochain tour de l’antipaladin et les bonus persistent pendant 1 minute. Ce pouvoir s’utilise par une [[action libre]]. Les créatures d’alignement [[Bon]] ne tirent aucun avantage de l’aura de vengeance.

{s:Reference|AURADUPECHE}
#### Aura du péché (Sur)
Au niveau  14, les armes d’un antipaladin sont considérées comme dotées de l’[[alignement]] [[Mauvais]] lorsqu’il s’agit de déterminer si elles ignorent les [[RD|réductions de dégâts]]. De plus, toutes les attaques faites contre un ennemi situé dans un rayon de 3 m autour de l’antipaladin sont également considérées comme dotées de l’alignement Mauvais lorsqu’il s’agit de déterminer si elles ignorent les réductions de dégâts. Cette capacité fonctionne tant que l’antipaladin est conscient, mais pas s’il est [[inconscient]] ou [[mort]].

{s:Reference|AURADEDEPRAVATION}
#### Aura de dépravation (Sur)
Au niveau  17, un antipaladin gagne une [[RD]] 5/Bien. De plus, tous ses ennemis situés à 3 m ou moins subissent un malus de –4 aux  [[jet de sauvegarde|jets de sauvegarde]] contre tous les effets de [[coercition]]. Cette aptitude fonctionne tant que l’antipaladin est conscient, mais pas s’il est [[inconscient]] ou [[mort]].

{s:Reference|CHAMPIONMAUDIT}
#### Champion maudit (Sur)
Au niveau 20,  l’antipaladin incarne vraiment la puissance des entités maléfiques qu’il vénère. Sa [[RD]] augmente jusqu’à 10/Bien. Chaque fois qu’il utilise un [[antipaladin#CHATIMENTDUBIEN|châtiment du Bien]] et frappe un [[type Extérieur|Extérieur]] d’[[alignement]] [[Bon]], celui-ci est également soumis à un  [[bannissement]] de [[NLS]] égal au niveau de l’antipaladin (l’arme et le symbole maudit de l’antipaladin comptent automatiquement comme objets que la cible haït). Le châtiment du Bien se termine immédiatement après que l’effet de bannissement et les dégâts de l’attaque aient été appliqués. De plus, chaque fois que l’antipaladin [[antipaladin#CANALISATIONDENERGIE|canalise de l’énergie négative]] ou utilise un [[antipaladin#TOUCHERDECORRUPTION|toucher de corruption]] pour blesser une créature, il inflige toujours le maximum de dégâts possible.

{s:Reference|CODEDECONDUITE}
### Code de conduite
