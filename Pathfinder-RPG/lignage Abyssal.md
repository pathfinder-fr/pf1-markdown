---
Name: Pathfinder-RPG.lignage Abyssal
...
{s:MenuLignages}*Il y a de cela plusieurs générations, un démon a corrompu le lignage de l’ensorceleur. Son influence ne se manifeste pas chez tous les membres de sa famille mais, chez lui, elle est particulièrement forte. Le personnage ressent peut-être des envies soudaines de répandre le chaos ou de faire le mal, mais il reste maître de sa destinée (et de son alignement).*

**Compétence de classe.** [[Connaissances]] (plans)

**Sorts supplémentaires.** *[[frayeur]]* (niveau 3), *[[force de taureau]]* (niveau 5), *[[rage]]* (niveau 7), *[[peau de pierre]]* (niveau 9), *[[renvoi]]* (niveau 11), *[[transformation martiale]]* (niveau 13), *[[téléportation suprême]]* (niveau 15), *[[aura maudite]]* (niveau 17), *[[convocation de monstres IX]]* (niveau 19)

**Dons supplémentaires.** [[Amélioration des créatures convoquées]], [[Attaque en puissance]], [[Enchaînement]], [[Extension deffet|Extension d’effet]], [[Science de la bousculade]], [[Science de la destruction]], [[Talent]] ([[Connaissances]] plans), [[Vigueur surhumaine]]
...
### Pouvoirs de lignage
*Certains pensent que le personnage est possédé, mais lui sait que ce n’est pas le cas. L’influence démoniaque qu’exerce le sang qui coule dans ses veines se renforce au fil de l’évolution du personnage.*
...
**Résistances démoniaques (Ext).** Au niveau 3, le personnage gagne une [[résistance]] à l’électricité de 5 points et un bonus de +2 aux [[jet de sauvegarde|jets de sauvegarde]] contre le [[poison]]. Au niveau 9, la résistance passe à 10 points et le bonus contre le poison à +4.
...
**Invocations supplémentaires (Sur).** Au niveau 15, chaque fois que le personnage invoque une créature appartenant au sous-type [[sous-type démon|démon]] ou possédant l’archétype fiélon grâce à un sort de *[[convocation de monstres]]*, le sort invoque une créature supplémentaire de même type.

**Puissance démoniaque (Sur).** Au niveau 20, la puissance de l’Abysse coule dans les veines du personnage. Il développe une [[immunité]] à l’électricité et au poison. Il gagne également une [[résistance]] à l’acide de 10 points, une résistance au froid de 10 points et une [[résistance]] au feu de 10 points. Enfin, il acquiert le pouvoir de [[télépathie]] avec une portée de 18 m (12 cases), ce qui lui permet de communiquer avec n’importe quelle créature capable de parler un langage.

{s:um}
## Lignage sauvage Brute
...
**Ailes des Abysses (Sur).** Au niveau 9, le personnage peut, chaque jour, faire sortir des ailes membraneuses de son dos et voler pendant un nombre de minutes égal à son niveau d’ensorceleur, avec une vitesse de 18 mètres (12{s:c}) et une bonne manœuvrabilité. Cette durée n’est pas forcément continue mais doit se diviser en segments de 1 minute. Ce pouvoir de lignage remplace Force de l'abysse.
