---
Name: Pathfinder-RPG.Compétences fusionnées, Acrobaties
Title: Compétences fusionnées, Acrobaties
LastModified: 2022-10-24 18:53
Categories:
- Src Pathfinder unchained
---

{s:MenuPathfinderunchained}{s:PU}*Le personnage a un excellent équilibre et sait coordonner ses mouvements. Il sait également effectuer des manœuvres aériennes et acrobatiques, ainsi que des cabrioles.*

**Caractéristique associée :** [[Dextérité]] ; **Formation nécessaire :** Non ; **Malus d'armure :** Oui

**Fonctions.** [[Compétences fusionnées, Acrobaties#AMORTIRLESCHUTES|Amortir les chutes]], [[Compétences fusionnées, Acrobaties#CHEVAUCHERDESMONTURES|chevaucher une monture]], [[Compétences fusionnées, Acrobaties#GARDERLEQUILIBRE|garder l’équilibre]], [[Compétences fusionnées, Acrobaties#REALISERDESMANOEUVRESAERIENNES|réaliser des manœuvres aériennes]], [[Compétences fusionnées, Acrobaties#SEDEPLACERACROBATIQUEMENTENCOMBAT|se déplacer acrobatiquement en combat]], [[Compétences fusionnées, Acrobaties#SEFAUFILERDANSDESCONDUITSETROITS|se faufiler dans des conduits étroits]], [[Compétences fusionnées, Acrobaties#SELIBERERDENTRAVES|se libérer d’entraves]].
...
{s:Reference|CHEVAUCHERDESMONTURES}
...
{s:ClearRight}{s:Reference|REALISERDESMANOEUVRESAERIENNES}
...
{s:Reference|SEDEPLACERACROBATIQUEMENTENCOMBAT}
...
{s:Reference|SEFAUFILERDANSDESCONDUITSETROITS}
...
{s:Reference|SELIBERERDENTRAVES}
