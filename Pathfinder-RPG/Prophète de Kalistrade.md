---
Name: Pathfinder-RPG.Prophète de Kalistrade
Title: Disciple des Prophéties
...
{s:MenuClassesDePrestige}{s:cs}{s:PP}''N'importe quel imbécile de la rue peut gagner quelques pièces de cuivre pour son labeur, mais les dirigeants du Paradis religieux des marchands aux gants blancs savent que le seul chemin vers le succès est celui prédit dans les grandes Prophéties du déni de soi, une série de directives qui détaillent un régime strict que les croyants doivent suivre pour obtenir richesse et prospérité. Ces interdictions incluent l'abstention de certains types de viandes, la plupart des activités sexuelles, et quasiment tout contact physique avec d'autres personnes (d'où le port de grands gants blancs, pour éviter tout contact accidentel).
...
<table CLASS="tablo centre">
  <caption>Le disciple des Prophéties</caption>
  <tr CLASS="titre">
    ...
    <td COLSPAN="4" CLASS="avecsoustitre">[[Prophète de Kalistrade#SORTS|Sorts par jour]]</td>
  </tr>
  ...
  <tr CLASS="premier">
    ...
    <td>+0</td>
    <td>+1</td>
    <td CLASS="gauche">[[Prophète de Kalistrade#DEMONSTRATIONDAUSPICE|Démonstration d'auspice]] +1</td>
    <td>1</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
  ...
  <tr CLASS="alt">
    ...
    <td>+1</td>
    <td>+1</td>
    <td CLASS="gauche">[[Prophète de Kalistrade#ACHATDESORTS|Achat de sorts]]</td>
    <td>2</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
  ...
  <tr CLASS="alt">
    ...
    <td>+2</td>
    <td CLASS="gauche">
      [[Prophète de Kalistrade#DEMONSTRATIONDAUSPICE|Démonstration d'auspice]] +2, [[Prophète de
      Kalistrade#PERSPICACITECOMMERCIALE|perspicacité commerciale]]
    </td>
    <td>3</td>
    <td>1</td>
    <td>-</td>
  ...
  <tr CLASS="alt">
    ...
    <td>+2</td>
    <td>+3</td>
    <td CLASS="gauche">[[Prophète de Kalistrade#CONTACTSMYSTIQUES|Contacts mystiques]]</td>
    <td>4</td>
    <td>3</td>
    <td>-</td>
    <td>-</td>
  ...
  <tr>
    ...
    <td>+2</td>
    <td>+4</td>
    <td CLASS="gauche">[[Prophète de Kalistrade#DEMONSTRATIONDAUSPICE|Démonstration d'auspice]] +3</td>
    <td>4</td>
    <td>3</td>
    <td>1</td>
    <td>-</td>
  ...
  <tr CLASS="alt">
    ...
    <td>+3</td>
    <td>+4</td>
    <td CLASS="gauche">[[Prophète de Kalistrade#COFFREDUPROPHETE|Coffre du prophète]]</td>
    <td>4</td>
    <td>4</td>
    <td>2</td>
    <td>-</td>
  ...
  <tr>
    ...
    <td>+3</td>
    <td>+5</td>
    <td CLASS="gauche">[[Prophète de Kalistrade#CONTACTSPLANAIRES|Contacts planaires]]</td>
    <td>5</td>
    <td>4</td>
    <td>3</td>
    <td>-</td>
  ...
  <tr CLASS="alt">
    ...
    <td>+3</td>
    <td>+5</td>
    <td CLASS="gauche">[[Prophète de Kalistrade#DEMONSTRATIONDAUSPICE|Démonstration d'auspice]] +4</td>
    <td>5</td>
    <td>4</td>
    <td>3</td>
    <td>1</td>
...
#### Achat de sorts (Sur)
À partir du niveau 2, un disciple des Prophéties peut lancer des sorts qui ne lui sont normalement pas accessibles en dépensant un certain montant d'or. Un disciple des Prophéties peut lancer spontanément n'importe quel sort de niveau 1 qu'il connaît – même s'il a dépensé tous ses emplacements de sort quotidiens – en sacrifiant un montant total de 500 po de pièces ou de gemmes. Si le sort nécessite une composante matérielle coûteuse, elle est ajoutée au coût de base de cette capacité. Le disciple doit porter les pièces et les gemmes utilisées ainsi, et les objets autres que les pièces ou les gemmes ne peuvent pas être sacrifiés pour utiliser cette capacité. Lancer un sort de cette manière ne coûte aucun emplacement de sort, et une fois sacrifiée, la monnaie utilisée pour ce sort ne peut jamais être récupéré – la monnaie a disparu pour toujours.

Au niveau 4, il peut lancer un sort de niveau 2 qu'il connaît avec un prix de base de 1.500 po. Au niveau 7, il peut lancer un sort de niveau 3 avec un prix de 3.000 po. Au niveau 10, il peut lancer un sort de niveau 4 avec un prix de base de 5.000 po.
