---
Name: Pathfinder-RPG.Œil indiscret
Title: Œil indiscret
LastModified: 2022-06-17 23:11
Categories:
- Règle officielle
- Sort
- Sort hypnotiseur 5
...
**École** [[Divination]] ; **Niveau** [[Hypnotiseur|Hyp]] 5, [[Ensorceleur|Ens]]/[[Magicien|Mag]] 5, [[Occultiste|Occ]] 5, [[Psychiste|Psy]] 5, [[Sorcière|Sor]] 5, [[Spirite|Spi]] 5  
...
Ce sort fait apparaître des orbes magiques, semi-tangibles et visibles (appelés « yeux ») en nombre égal à 1d4 + [[niveau de lanceur de sorts]]. Ces orbes s’éloignent en tous sens et reviennent en fonction des instructions reçues au cours de l’incantation. Chaque œil voit à 36 m (24 {s:c}) dans toutes les directions (vision normale seulement).

Les yeux sont très fragiles mais, en raison de leur petite taille, il sont difficiles à remarquer. Chaque œil est une [[type créature artificielle|créature artificielle]] de [[taille I]] (taille d’une petite pomme) dont les caractéristiques sont : 1 [[points de vie|point de vie]], [[CA]] 18 (+8 taille), [[VD]] 9 m (6 {s:c}) (bonus de +20 aux tests de [[Vol]]), +16 aux tests de [[Discrétion]]. Son modificateur de [[Perception]] est égal au [[niveau de lanceur de sorts]] du mage (maximum +15). Il peut être trompé par les [[illusion|illusions]] et il est gêné par l’obscurité, le brouillard et tout autre facteur modifiant les informations visuelles. Un œil qui avance dans le noir est obligé de progresser à tâtons.
