---
Name: Pathfinder-RPG.duergar (race)
Title: Les duergars
LastModified: 2025-01-10 18:00
Categories:
- Règle officielle
...
{s:MR}Les options suivantes sont accessibles aux duergars. Selon décision du MJ, d’autres races peuvent y accéder.
#### Dons
...
<table CLASS="tablo autoalt toutgauche">
  ...
  <tr CLASS="premier">
    <td>[[Pas de géant]]</td>
    <td><sup>MR</sup></td>
    <td>[[duergar (race)|duergar]], trait racial lentement mais sûrement</td>
    <td>Voir description du don</td>
  </tr>
</table>
