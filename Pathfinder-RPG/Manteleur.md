---
Name: Pathfinder-RPG.Manteleur
Title: Manteleur
LastModified: 2026-05-24 01:15
Categories:
- Monstre
- Règle officielle
- Src Bestiaire
...
{s:BDTexte|**Réf** +5, **Vig** +6, **Vol** +7}
{s:BDTexte|**Capacités défensives** manipulation des ombres }
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 3 m (2 {s:c}), vol 12 m (8 {s:c}) (moyenne)}
{s:BDTexte|**Corps à corps** morsure +8 (1d6+5), coup de queue +3 (1d8+2)}
{s:BDTexte|**Espace** 3 m (2 {s:c}) ; **Allonge** 3 m (2 {s:c}) (1,5 m (1 {s:c}) pour la morsure)}
{s:BDTexte|**Attaques spéciales** enveloppement, gémissement}
