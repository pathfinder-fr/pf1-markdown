---
Name: Pathfinder-RPG.Consécration
Title: Consécration
LastModified: 2022-08-22 20:27
Categories:
- Règle officielle
- Sort
- Sort inquisiteur 2
...
### Mythique
{s:CMy}
Choisissez une composante d’alignement du personnage (Chaos, Bien ou Loi). Le malus infligé par le sort aux jets d’attaque, de dégâts et de sauvegarde affecte également les Extérieurs dotés du sous-type d’alignement opposé à celui choisi, comme s’ils étaient des morts-vivants.
