...
Une diva peut accomplir les représentations bardiques suivantes. Ces représentations peuvent être accomplies au plus vite par une [[action simple]].
- *Aria dévastatrice (Sur).* Au niveau 3, la diva peut dépenser 1 [[round]] de [[Barde#REPRESENTATIONBARDIQUE|représentation bardique]] par une [[action simple]] pour projeter une déflagration de paroles et de sons sur une créature ou un objet. Cette représentation inflige 1d4 points de dégâts + le niveau de la diva à un objet ou la moitié de ces dégâts à une créature vivante. Cette représentation remplace [[Représentations#INSPIRATIONTALENTUEUSE|inspiration talentueuse]].

- *Diatribe blessante (Sur).* Une diva de niveau 8 ou plus peut utiliser cette représentation pour fustiger une créature qui devient alors [[effrayé|effrayée]]. L’ennemi ciblé doit être situé à 9 mètres ou moins de la diva et doit pouvoir voir et entendre sa représentation. L’effet persiste aussi longtemps que l’ennemi reste à 9 mètres ou moins et que la diva poursuit sa représentation, plus 1d4 [[round|rounds]].
