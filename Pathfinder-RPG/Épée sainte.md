---
Name: Pathfinder-RPG.Épée sainte
Title: Épée sainte
LastModified: 2022-06-12 18:47
Categories:
- Règle officielle
- Sort
- Sort paladin 4
...
Si ce sort est lancé sur une [[armes magiques|arme magique]], les propriétés accordées par le sort remplacent celles que l’arme possédait et le [[bonus daltération|bonus d’altération]] normal de celle-ci, ainsi que ses éventuels pouvoirs, sont rendus inopérants pendant toute la durée du sort. Les effets de ce sort ne se cumulent pas avec ceux d’une *[[bénédiction darme|bénédiction d’arme]]* ou de tout autre sort modifiant l’arme enchantée d’une manière ou d’une autre. Ce sort ne fonctionne pas sur les [[artefacts]]. Le bonus au [[jet dattaque|jet d’attaque]] d’une [[arme de maître]] ne se cumule pas non plus avec son [[bonus daltération|bonus d’altération]] au [[jet dattaque|jet d’attaque]].
