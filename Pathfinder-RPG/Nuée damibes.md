...
{s:BDTexte|**PX** 400}
{s:BDTexte|[[type Vase|Vase]] ([[sous-type nuée|nuée]]) de taille I, N}
...
{s:BDTexte|**Capacités défensives** traits des [[type Vase|vases]] et des [[sous-type nuée|nuées]]}
{s:BDTexte|**Immunités** dégâts des armes}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 3 m (2 {s:c}), escalade 3 m (2 {s:c}), nage 6 m (4 {s:c})}
{s:BDTexte|**Corps à corps** nuée (1d6 acide plus [[distraction]])}
...
{s:BDTexte|**Compétences** [[Escalade]] +3, [[Natation]] +3}
