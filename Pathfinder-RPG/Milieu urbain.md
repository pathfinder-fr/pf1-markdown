---
Name: Pathfinder-RPG.Milieu urbain
Title: Le milieu urbain
LastModified: 2024-08-25 16:00
Categories:
- Maitre du jeu
- Règle officielle
...
La majorité de ces troupes est constituée d'[hommes d'armes](./Homme darme.md), la plupart de niveau 1. Parmi les officiers, on trouve des [combattants](./combattant.md) de niveau supérieur, des [guerriers](./Guerrier.md), un bon nombre de [prêtres](./Prêtre.md) et de [magiciens](./Magicien.md) ou d’[ensorceleurs](./Ensorceleur.md) ainsi que des guerriers/lanceurs de sorts multiclassés.
...
|- CLASS="premier"
| [Baliste](./Milieu urbain.md#BALISTE) || 500 po || 3d8 || 19-20 || 36 m || 1
|- CLASS="alt"
| [Bélier](./Milieu urbain.md#BELIER) || 1&nbsp;000&nbsp;po || 3d6* || — || — || 10
|-
| [Catapulte légère](./Milieu urbain.md#CATAPULTELEGERE) || 550 po || 4d6 || — || 45 m (30 m minimum) || 2
|- CLASS="alt"
| [Catapulte lourde](./Milieu urbain.md#CATAPULTE LOURDE) || 800 po || 6d6 || — || 60 m (30 m minimum) || 4
|-
| [Tour de siège](./Milieu urbain.md#TOURDESIEGE) || 2&nbsp;000&nbsp;po || — || — || — || 20
|-
| COLSPAN="6" CLASS="note" | (*) Se référer à la description pour ce qui est des règles spéciales.
|}
</div></div>
{s:Desambi|L’*Art de la guerre* introduit des règles avancées relatives aux [engins de siège](./Engins de siège.md).}Ces armes et ces structures temporaires sont habituellement utilisées lors des sièges.

Si quelqu’un essaie de saboter un engin de siège, on le considère comme un élément difficile. Il faut 2d4 rounds et un test de [Sabotage](./Sabotage.md) ([DD](./DD.md) 20) pour parvenir à saboter l’engin. Les engins de siège sont habituellement faits en bois et ont une [CA](./CA.md) de 3 (-5 Dextérité, -2 taille), une solidité de 5 et 80 points de vie. Les engins de siège faits de différents matériaux auront des valeurs différentes. Certains engins de siège sont renforcés d’une armure. Considérez-les comme une créature de [taille TG](./taille.md) quand il s’agit de déterminer le prix de cette armure. On peut fabriquer les engins de siège comme des objets de maître ou les enchanter comme des armes pour ajouter un bonus aux jets d’attaque qui permettent à l’engin de siège de toucher sa cible. Un engin de maître coûte deux fois plus cher qu’une version ordinaire. Par exemple, une catapulte lourde de feu +1 renforcée d’une armure de plate complète a une [CA](./CA.md) de 11 et coûte 23 100 po (800 po de base + 6 000 po pour l’armure + 300 po de travail de maître + 16 000 po pour l’amélioration).

{s:Reference|BALISTE}**Baliste.** La baliste est l’équivalent d’une énorme arbalète de [taille TG](./taille.md). Sa taille la rend difficile à manipuler pour la plupart des créatures. Ainsi, une créature de [taille M](./taille.md) reçoit un malus de -4 aux jets d’attaque tandis qu’une créature de [taille P](./taille.md) subit un malus de -6. Une créature de [taille inférieure à G](./taille.md) nécessite 2 [actions complexes](./Action complexe.md) pour recharger une baliste après avoir tiré.

Une baliste remplit un espace de 1,50 m de large.

{s:Reference|BELIER}**Bélier.** Ce tronc d’arbre élagué est suspendu à un échafaudage qui permet aux utilisateurs de le balancer de manière répétée. Au prix d’une [action complexe](./Action complexe.md), le personnage se trouvant le plus près de la tête du bélier effectue un jet d’attaque contre la [CA](./CA.md) de la construction, en tenant compte d’un malus de -4 du fait qu’il n’est pas habitué à manier un tel objet (il est impossible de se former au maniement du bélier). En plus des dégâts qui apparaissent sur la table ci-dessus, neuf personnes au maximum peuvent aider à manier l’engin et additionner leur modificateur de [Force](./Force.md) aux dégâts s’ils y consacrent une [action d’attaque](./Action simple.md). Balancer le bélier nécessite une créature de [taille TG](./taille.md) ou plus, deux créatures de [taille G](./taille.md), quatre de [taille M](./taille.md) ou huit de [taille P](./taille.md).
...
{s:Reference|CATAPULTELOURDE}**Catapulte lourde.** Cette machine de guerre lance des pierres et autres objets lourds avec une force terrible. Comme elle tire ses projectiles selon un arc de cercle, elle est capable de frapper des cibles se trouvant en dehors de sa ligne de mire. Pour s’en servir, son responsable effectue un test de [DD](./DD.md) 15 ([bonus de base à l’attaque](./BBA.md), modificateur d’[Intelligence](./Intelligence.md), malus de portée et modificateur de la table ci-dessus. En cas de réussite, la catapulte touche la case visée, infligeant les dégâts indiqués à tout objet ou personnage s’y trouvant. Les personnages qui réussissent un test de [Réflexes](./jet de sauvegarde.md) ([DD](./DD.md) 15) ne subissent que la moitié des dégâts. Dès lors que la pierre a touché une case, les tirs suivants la touchent automatiquement, à moins que le vent ne change de direction ou de vitesse.
...
Pour charger une catapulte, il faut amorcer toute une série d’[actions complexes](./Action complexe.md). Il faut effectuer avec succès un test de [Force](./Force.md) ([DD](./DD.md) 15) pour baisser le levier. Ceci dit, la plupart des catapultes sont dotée d’une manivelle permettant à deux serviteurs de s’entraider. Un test de [Profession](./Profession.md) (ingénieur de siège) permet de positionner le bras, alors qu’un autre est nécessaire pour charger la catapulte (tous deux ont un [DD](./DD.md) de 15). Les utilisateurs de la catapulte ont besoin de 4 [actions complexes](./Action complexe.md) pour viser leur cible, nombre divisé par le nombre d’individus s’attelant à cette tâche . Ainsi, une catapulte manipulée par quatre personnes est opérationnelle en 1 round.

Une catapulte lourde remplit un espace de 4,50 m de large.

{s:Reference|CATAPULTELEGERE}**Catapulte légère.** Cette version plus légère de la catapulte lourde fonctionne de la même manière mais le [DD](./DD.md) du test de [Force](./Force.md) est de 10. De plus, les utilisateurs ont besoin de 2 [actions complexes](./Action complexe.md) seulement pour viser leur cible.

Une catapulte légère remplit un espace de 3 m de large.

{s:Reference|TOURDESIEGE}**Tour de siège.** Cette grande tour en bois montée sur roues est conçue pour être poussée contre un mur d’enceinte afin de permettre aux attaquants d’arriver jusqu’aux remparts sans se trouver à découvert. Ses parois mesurent généralement une trentaine de centimètres d’épaisseur.
...
**Foule.** Les rues d’une ville grouillent souvent d’individus vaquant à leurs occupations quotidiennes. Généralement, quand une bagarre éclate sur la voie publique, il n’est pas nécessaire d’indiquer chaque homme du peuple de niveau 1 sur la carte. On peut seulement indiquer les cases qui comportent des individus. Si la foule perçoit un éventuel danger, elle s’en écarte de 9 m par round avec une [initiative](./initiative.md) de 0. Il faut dépenser 2 cases de mouvement pour pénétrer dans une case occupée par la foule. Cette dernière offre un [abri](./abri.md) à toute personne qui s’y infiltre, ce qui permet à cette dernière de faire un test de [Discrétion](./Discrétion.md) et offre un bonus à la [CA](./CA.md) et aux [jets de Réflexes](./jet de sauvegarde.md).

*Diriger une foule.* Il faut de faire un test de [Diplomatie](./Diplomatie.md) ([DD](./DD.md) 15) ou d’[Intimidation](./Intimidation.md) ([DD](./DD.md) 20) pour convaincre une foule de se déplacer dans une direction particulière. De plus, celle-ci doit pouvoir entendre ou voir le personnage quand il fait sa tentative. Le test de [Diplomatie](./Diplomatie.md) coûte une [action complexe](./Action complexe.md) mais le test d’[Intimidation](./Intimidation.md) exige seulement une [action libre](./Action libre.md).

Si deux personnages au minimum tentent de diriger la foule dans des directions différentes, ils effectuent un test de [Diplomatie](./Diplomatie.md) ou d’[Intimidation](./Intimidation.md) opposé pour déterminer celui à qui la foule obéira. Elle ne fera attention à personne si aucun des tests ne dépasse les [DD](./DD.md) indiqués plus haut.

#### Au-dessus et en dessous des rues
**Les toits.** Pour avoir accès à un toit, il faut généralement escalader un mur (voir [Murs d'enceinte et portes](./Milieu urbain.md#Murs_denceinte_et_portes_0)), sauf si le personnage peut atteindre le toit en sautant d’une fenêtre, d’un balcon ou d’un point situé à une hauteur supérieure. Les toits plats, présents uniquement sous les climats chauds (un excès de neige risquerait de les faire effondrer) sont faciles à traverser. Il faut effectuer avec succès un test d’[Acrobaties](./Acrobaties.md) de DD 20 pour se déplacer au sommet d’un toit. Pour se mouvoir sur un toit pentu sans changer de hauteur (en d’autres termes, pour se déplacer parallèlement au sommet), il faut faire un test d’[Acrobaties](./Acrobaties.md) de [DD](./DD.md) 15. Pour monter et descendre en travers du sommet d’un toit, il faut effectuer avec succès un test d’[Acrobaties](./Acrobaties.md) de [DD](./DD.md) 10.

Lorsque le personnage arrive en bout du toit, il doit effectuer un long saut pour atteindre le toit suivant ou pour atterrir au sol. La distance séparant les deux toits est généralement de 1d3 x 1,50 m mais il peut également être plus haut ou plus bas de 1,50 m ou être à la même hauteur. Référez vous aux indications de la compétence [Acrobaties](./Acrobaties.md) pour savoir si le personnage arrive à sauter ou non (la hauteur maximale d’un saut à la verticale est égale au quart de la distance horizontale).

**Les égouts.** Pour aller dans les égouts, la plupart des personnages ouvrent une grille ([action complexe](./Action complexe.md)) et sautent d’une hauteur de 3 m. Les égouts sont construits sur le même principe qu’un donjon mais ils ont bien plus de chances d’avoir un sol glissant ou recouvert d’eau. Les égouts sont également similaires aux donjons en ce qui concerne les créatures que l’on peut y rencontrer. Les égouts de certaines villes construites sur les ruines de civilisations plus anciennes mènent parfois à des trésors ou des dangers d’une époque oubliée.

#### Bâtiments
{s:Desambi|Le *Guide de campagne* introduit des règles avancées relatives aux [bâtiments urbains](./Communautés et quartiers.md#BATIMENTS) dans le cadre du système de [royaumes](./Royaumes et guerre.md).}La plupart des bâtiments urbains se divisent en trois branches. La majorité des bâtiments de la ville s’élèvent de un à quatre étages et sont construits les uns à côté des autres pour former de longues rangées séparées par des rues secondaires ou principales. Ces maisons en rangs abritent habituellement un commerce au rez-de-chaussée et des bureaux ou des appartements aux étages supérieurs.
