---
Name: Pathfinder-RPG.Maître des ombres
...
|- CLASS="premier"
| 1 || +0 || +1 || +0 || +0
| CLASS="gauche" | [[maître des ombres#DISCRETIONTOTALE|Discrétion totale]]
|- CLASS="alt"
| 2 || +1 || +1 || +1 || +1
| CLASS="gauche" | [[maître des ombres#ESQUIVETOTALE|Esquive totale]], [[maître des ombres#VISIONDANSLENOIR|vision dans le noir]], [[maître des ombres#ESQUIVEINSTINCTIVE|esquive instinctive]]
|-
| 3 || +2 || +2 || +1 || +1
| CLASS="gauche" | [[maître des ombres#POUVOIRDEROUBLARD|Talent de roublard]], [[maître des ombres#OMBRESILLUSOIRES|ombres illusoires]], [[maître des ombres#APPELDUCOMPAGNONDOMBRE|appel du compagnon d’ombre]]
|- CLASS="alt"
| 4 || +3 || +2 || +1 || +1
| CLASS="gauche" | [[maître des ombres#CONVOCATIONDOMBRE|Convocation d’ombre]], [[maître des ombres#TELEPORTATIONPARLESOMBRES|téléportation par les ombres]] (12 m / 8 cases)
|-
| 5 || +3 || +3 || +2 || +2
| CLASS="gauche" | [[maître des ombres#ROULEBOULE|Roulé-boulé]], [[maître des ombres#ESQUIVEINSTINCTIVESUPERIEURE|esquive instinctive supérieure]]
|- CLASS="alt"
| 6 || +4 || +3 || +2 || +2
| CLASS="gauche" | [[maître des ombres#POUVOIRDEROUBLARD|Talent de roublard]], [[maître des ombres#TELEPORTATIONPARLESOMBRES|téléportation par les ombres]] (24 m / 16 cases)
|-
| 7 || +5 || +4 || +2 || +2
| CLASS="gauche" | [[maître des ombres#ESPRITFUYANT|Esprit fuyant]]
|- CLASS="alt"
| 8 || +6 || +4 || +3 || +3
| CLASS="gauche" | [[maître des ombres#TELEPORTATIONPARLESOMBRES|Téléportation par les ombres]] (48 m / 32 cases), [[maître des ombres#POUVOIRDESOMBRES|pouvoir des ombres]]
|-
| 9 || +6 || +5 || +3 || +3
| CLASS="gauche" | [[maître des ombres#POUVOIRDEROUBLARD|Talent de roublard]]
|- CLASS="alt"
| 10 || +7 || +5 || +3 || +3
| CLASS="gauche" | [[maître des ombres#ESQUIVEEXTRAORDINAIRE|Esquive extraordinaire]], [[maître des ombres#TELEPORTATIONPARLESOMBRES|téléportation par les ombres]] (96 m / 64 cases), [[maître des ombres#MAITREDESOMBRES|maître des ombres]]
|}
</center>
...
**Alignement.** De part sa nature de fourbe illusionniste, le maître des ombres n'est pas très à l'aise avec les alignements [[Loyal|Loyaux]]. Nombre sont ceux qui utilisent leurs pouvoirs pour échapper à la scrutation des autorités. Cependant, bien qu'il soit l'allié des ténèbres, il n'est ni intrinsèquement [[Mauvais]], ni prédisposé à faire le [[Bon|Bien]]. Pour lui, l'ombre est simplement l'ombre, sans les connotations morales habituelles de ceux qui vivent en pleine lumière.
...
Dès le niveau 2, le maître des ombres conserve son éventuel bonus de [[Dextérité]] à la [[CA]] et ne peut être [[pris au dépourvu]], même s'il est attaqué par un adversaire [[invisible]] (il perd toujours ce bonus s’il est [[immobilisé]] ou s’il est victime d’une [[feinte]]). Si un maître des ombres possède déjà cette aptitude grâce à une autre classe, il obtient l'[[maître des ombres#ESQUIVEINSTINCTIVESUPERIEURE|esquive instinctive supérieure]] au lieu de l’esquive instinctive.

{s:Reference|POUVOIRDEROUBLARD}
#### Talents de roublard
Aux niveaux 3, 6 et 9, le maître des ombres gagne une capacité qui lui permet de confondre ses adversaires. Cela fonctionne comme les [[talents|talents de la classe de roublard]]. Il ne peut sélectionner un [[talents|talent]] plus d'une fois. S'il a accès aux [[talents|talents de maître roublard]], il peut faire son choix dans cette liste.

{s:Reference|OMBRESILLUSOIRES}
...
{s:Reference|APPELDUCOMPAGNONDOMBRE}
#### Appel du compagnon d’ombre (Sur)
Au niveau 3, le personnage peut convoquer un compagnon ombre, qui est une créature [[type mort-vivant|morte-vivante]]. Contrairement aux [[ombre|ombres]] normales, le compagnon est du même alignement que le personnage et il ne peut créer de rejetons. Il reçoit un bonus de +4 sur ses jets de [[Volonté]] pour réduire les dommages causés par l'énergie positive et ne peut être ni [[Renvoi des morts-vivants|repoussé]] ni [[Contrôle des morts-vivants|contrôlé]]. L’ombre accompagne fidèlement le maître des ombres, avec qui elle peut communiquer intelligiblement. Elle a un nombre de [[pv|points de vie]] égal à la moitié des points de vie totaux de son maître. Elle utilise le [[BBA|bonus de base à l'attaque]], ainsi que les bonus aux [[jet de sauvegarde|jets de sauvegarde]] du maître des ombres. À part cela, cette ombre est identique à celle que l'on trouve dans le *Bestiaire Pathfinder*.
...
{s:Reference|CONVOCATIONDOMBRES}{s:Reference|CONVOCATIONDOMBRE}


#### Convocation d'ombres (Mag)
À parti du niveau 4, le maître des ombres peut créer des créatures et des effets à partir d'ombre brute. Ce pouvoir fonctionne comme *[[convocation dombres|convocation d'ombres]]*. Le niveau du lanceur de sort effectif est celui du maître des ombres. Le personnage peut utiliser ce pouvoir une fois par jour au niveau 4, puis une fois supplémentaire tous les deux niveaux au-delà (2/jour au niveau 6, 3/jour au niveau 8 et 4/jour au niveau 10). Au niveau 10, cette faculté devient une *[[convocation dombres suprême|convocation d'ombres suprême]]*. Le [[DD]] de ce pouvoir est basé sur le [[Charisme]].

{s:Reference|TELEPORTATIONPARLESOMBRES}
...
#### Roulé-boulé (Ext)
À partir du niveau 5, le maître des ombres peut accompagner les coups mortels. Cette capacité est la même que le pouvoir spécial [[talents#ROULEBOULE|Roulé-boulé]] de la classe de [[roublard]].

{s:Reference|ESQUIVEINSTINCTIVESUPERIEURE}
#### Esquive instinctive supérieure (Ext)
Au niveau 5, le maître des ombres ne peut plus être [[pris en tenaille]]. Les [[roublard|roublards]] ne peuvent plus lui porter d’[[attaque sournoise|attaques sournoises]] de cette manière, à moins d’avoir au moins quatre niveaux de [[roublard]] de plus que le personnage n’a de niveaux de maître des ombres.
...
#### Esprit fuyant (Ext)
Ce pouvoir acquis au niveau 7 représente l’aisance avec laquelle le maître des ombres parvient à échapper aux effets magiques cherchant à le contrôler. Il fonctionne comme le pouvoir spécial [[talents#ESPRITFUYANT|Esprit fuyant]] de la classe de [[roublard]].

{s:Reference|POUVOIRDESOMBRES}
