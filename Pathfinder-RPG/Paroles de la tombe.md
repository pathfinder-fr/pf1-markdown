---
Name: Pathfinder-RPG.Paroles de la tombe
Title: Paroles de la tombe
LastModified: 2024-02-17 21:27
Categories:
- Sort
- Sort médium 0
- Sort occultiste 0
...
Une fois qu'un cadavre a été soumis à *paroles de la tombe* par un lanceur de sort, toute nouvelle tentative d'utiliser *paroles de la tombe* sur ce cadavre échoue. Vous pouvez jeter ce sort sur un cadavre qui est mort depuis un certain temps, mais, la tête du cadavre doit avoir une bouche pour parler. Ce sort n'affecte pas un cadavre qui a été transformé en créature morte-vivante.
