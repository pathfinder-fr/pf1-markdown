...
{s:BDTexte|**Init** +0 ; **Sens** *[[détection de linvisibilité|détection de l'invisibilité]]*, [[vision dans le noir]] à 18 m (12 {s:c}), [[vision nocturne]] ; [[Perception]] +1}
...
{s:BDTexte|**RD** 15/adamantium ; **Immunité** feu, magie, [[traits des créatures artificielles]]}
...
{s:BDTexte|**Attaques spéciales** chaleur (2d6 feu), souffle ([[DD]] 20)}
...
{s:BDTexte|**Cimeterre en cuivre à deux mains (Ext).** Le cimeterre à deux mains du golem de cuivre inflige les mêmes dégâts qu’un cimeterre de taille TG mais correspond, en réalité, à une attaque naturelle principale, non à une arme manufacturée, et ne peut pas être [[désarmement|désarmé]].}
{s:BDTexte|**Dernier sursaut (Ext).** Le golem de cuivre explose lorsqu’il est détruit. Toutes les créatures situées dans un rayon de 9 mètres (6 {s:c}) autour de lui reçoivent 12d8 points de dégâts de feu ([[Réflexes]] [[DD]] 20, 1/2 dégâts). Le [[DD]] du [[jet de sauvegarde]] est basé sur la [[Constitution]].}
{s:BDTexte|**Immunité contre la magie (Ext).** Le golem de cuivre est immunisé contre les sorts et les pouvoirs magiques autorisant une [[RM|résistance à la magie]]. En outre, certains sorts et certains effets fonctionnent différemment contre lui :}
{s:BDTexte|• Les attaques magiques infligeant des dégâts de froid ralentissent le golem de cuivre (comme le sort *[[lenteur]]*) pendant 1d6 [[round|rounds]], sans de [[jet de sauvegarde]].}
{s:BDTexte|• Les attaques magiques infligeant des dégâts de feu dissipent les effets de *[[lenteur]]* dont le golem est affligé et guérissent 1 point de dégât par tranche de 3 points de dégâts que l’attaque aurait dû infliger. Si le nombre de points de vie soignés est supérieur au nombre normal de points de vie du golem, il gagne alors les points en excédent sous la forme de points de vie temporaires. Le golem de cuivre n’a pas de [[jet de sauvegarde]] contre les attaques infligeant des dégâts de feu.}
{s:BDTexte|**Souffle (Ext).** Par une [[action libre]], tous les 1d4 [[round|rounds]], le golem de cuivre peut cracher un nuage de fumée et de braises emplissant un cube de 6 mètres (4 {s:c}) de côté. Cette capacité fonctionne comme le sort *[[nuage incendiaire]]* qui dure 1d6 [[round|rounds]] et inflige 6d6 points de dégâts de feu ([[Réflexes]] [[DD]] 20, 1/2 dégâts). Le [[DD]] du [[jet de sauvegarde]] est basé sur la [[Constitution]].}
