---
Name: Pathfinder-RPG.double terrifiant
Title: Double terrifiant
...
Le double disparaît si une attaque le touche, s’il se trouve dans la zone d’effet d’un sort ou s’il passe hors de portée du sort.
