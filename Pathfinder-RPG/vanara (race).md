...
{s:menuracesextraordinaires}<div style="background-color: #fff; float: right; padding: 0 0 8px 8px"><nav class="wiki-toc"></nav></div>{s:MR}***Voir aussi la [[Vanara|fiche de créature]] d'un vanara standard.***
...
- **+2 [[Dextérité]], +2 [[Sagesse]], -2 [[Charisme]].** Les vanaras sont agiles et perspicaces, mais également assez espiègles.
- **Vanara.** Les vanaras sont des [[type Humanoïde|humanoïdes]] de sous-type [[sous-type vanara|vanara]].
- **Taille M.** Les vanaras sont des créatures de [[taille M]] et n’ont aucun bonus ni malus de taille.
- **Vitesse normale.** Les vanaras ont une [[VD|vitesse de base]] de 9 mètres et une [[Escalade#SPECIAL|vitesse d’escalade]] de 9 mètres.
- **Vision nocturne.** Les vanaras [[Vision nocturne (capacité)|voient deux fois plus loin]] que les humains en cas de faible luminosité.
- **Agilité.** Les vanaras ont un bonus racial de +2 à leurs tests d’[[Acrobaties]] et de [[Discrétion]].
- **Queue préhensile.** Le vanara a une longue queue souple qu’il peut utiliser pour porter des objets. Il ne peut pas manier d’arme avec sa queue, mais celle-ci lui permet de récupérer de petits objets rangés sur sa personne par une [[action rapide]].
- **Langues.** Les vanaras commencent le jeu en parlant le commun et le vanara. Ceux qui ont une valeur d’[[Intelligence]] élevée peuvent apprendre d’autres langues parmi celles-ci : aklo, céleste, elfique, gnome, gobelin et sylvestre.
...
**[[Alchimiste]].** L'alchimiste rajoute +1/2 aux dégâts de ses [[Alchimiste#BOMBES|bombes]].

**[[Druide]].** Le druide rajoute un bonus de +1/2 à ses tests d’[[Druide#EMPATHIESAUVAGE|empathie sauvage]] et un bonus de +1/2 à ses tests de [[Dressage]].

**[[Guerrier]].** Le guerrier rajoute +1 à son [[DMD]] lorsqu’il résiste à une tentative de [[repositionnement]] ou de [[croc-en-jambe]].

**[[Moine]].** Le moine rajoute un bonus de +1 à ses tests d’[[Acrobaties]] pour sauter.
</td><td width="1%">
<td style="border-left:1px solid #4b3124" width="1%"></td>
</td><td width="49%">
**[[Rôdeur]].** Le rôdeur rajoute un bonus d’esquive de +1/4 à la [[CA]] contre ses [[Rôdeur#ENNEMIJURE|ennemis jurés]].
...
|- CLASS="premier"
| [[Trapéziste des arbres]] || <sup>MR</sup> || [[vanara (race)|vanara]], 1 rang en Acrobaties || Le vanara utilise sa queue pour se suspendre et améliorer sa défense contre les manœuvres offensives de croc-en-jambe, de bousculade et de repositionnement
|}
</center>
...
- ***[[Voleuse préhensile]]*** *(MR)* ([[Alchimiste|Alch 3]], [[Barde|Apal 3]], [[Ensorceleur|Ens]]/[[Magicien|Mag 3]], [[Magus|Magus 3]]). Permet à la queue de la cible d'effectuer des manoeuvres de sale coup et de subtilisation.
