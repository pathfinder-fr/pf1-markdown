---
Name: Pathfinder-RPG.type Créature artificielle
Title: Créature artificielle
LastModified: 2021-02-14 18:35
Categories:
- Glossaire
- Monstre
- Règle officielle
...
{s:MenuTypes}*Source : Bestiaire* p.308

Les créatures artificielles sont des objets animés ou des créatures construites de toutes pièces. Elles partagent les attributs suivants.

- Dés de vie : d10
- BBA égal au nombre de DV (progression rapide)
- Jet de sauvegarde forts : Aucun.
- Points de compétence par DV : 2 + leur modificateur d'[Intelligence](./Intelligence.md) (au minimum 1). La plupart des créatures artificielles sont cependant dénuées d'Intelligence et ne gagnent donc aucun point de compétence. Compétences de classe : Aucune, quelle que soit leur valeur d'intelligence.

### Traits
Les créatures artificielles possèdent les traits suivant (sauf mention contraire dans leur profil).
- Pas de valeur de [Constitution](./Constitution.md). Tous les [DD](./DD.md) et toutes les autres valeurs qui dépendent normalement de la Constitution fonctionnent comme si ces créatures avaient une constitution de 10 (ni bonus ni malus).
...
- Immunité contre tous les effets qui imposent un jet de [Vigueur](./Vigueur.md) (sauf ceux qui fonctionnent également sur les objets ou sont inoffensifs).
...
- Ne peuvent être ni [rappelées à la vie](./Rappel à la vie.md) ni [ressuscitées](./Résurrection.md)
...
- Aucune formation en matière de port d'armures.
