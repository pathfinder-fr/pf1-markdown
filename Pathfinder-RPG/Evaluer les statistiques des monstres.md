...
<table CLASS="tablo autoalt toutgauche">
  <caption>Statistiques des monstres par FP</caption>
  <tr CLASS="titre">
    <td>FP</td>
    <td>PV</td>
    <td>CA</td>
    <td>Attaque supérieure</td>
    <td>Attaque inférieure</td>
    <td>Dégâts moyens supérieurs</td>
    <td>Dégâts moyens inférieurs</td>
    <td>DD du pouvoir principal</td>
    <td>DD du pouvoir secondaire</td>
    <td>Bon JS</td>
    <td>Mauvais JS</td>
  </tr>
  <tr CLASS="premier">
