---
Name: Pathfinder-RPG.Saboteur (alchimiste)
Title: Saboteur
LastModified: 2020-07-15 19:35
Categories:
- Archétype
- Manuel des races
---

{s:menuarchétypealchimiste}{s:racial|Gnome|gnomes|Illustrations/PNJ/Gnome.jpg}{s:MR}
...
Au niveau 1, le saboteur découvre comment créer un élixir spécial qui augmente sa mobilité et sa capacité à se déplacer sans être vu, au détriment de sa force physique. Quand il absorbe ce mutagène, sa peau change de couleur pour prendre celle de son environnement tandis que ses mains et ses pieds sécrètent une substance adhésive. Il bénéficie alors d’un bonus de circonstances aux tests de [[Discrétion]] égal à la moitié de son niveau d’alchimiste (+1 au minimum) et gagne une vitesse d’escalade égale à la moitié de sa [[VD|vitesse de base]], le tout pendant 10 minutes par niveau de saboteur. En revanche, tant que l’extrait du caméléon fait effet, le saboteur subit un malus de -2 à la [[Force]]. Ce pouvoir remplace [[alchimiste#MUTAGENES|mutagène]].

Un saboteur qui boit un mutagène d’alchimiste n’est pas considéré comme un alchimiste. Toutes les limitations qui s’appliquent aux mutagènes valent également pour le mutagène du caméléon, comme si les deux pouvoirs étaient identiques. Les découvertes [[mutagène imprégné (découverte)|mutagène imprégné]] et [[mutagène persistant (découverte)|mutagène persistant]] s’appliquent au mutagène du caméléon.

#### Découvertes de saboteur
Voici les nouvelles découvertes que peut faire un saboteur.
- ***Bombe gros calibre*.*** Quand le saboteur prépare une bombe, il peut la faire de gros calibre. Si elle touche un mur, une grille, un engin de siège ou une autre structure résistante inanimée de grande taille, elle ignore la moitié de sa [[solidité]] et inflige 1 point de dégâts par niveau du saboteur. Si la bombe gros calibre réduit une cible inanimée à la moitié de ses [[pv|points de vie]] ou moins, elle y creuse un trou de 1,50 mètre de diamètre pour 1,50 mètre de profondeur.
- ***Bombe complexe.*** Quand le saboteur fabrique une bombe, il peut la modifier à l’aide de deux découvertes qui modifient ses dégâts (donc les découvertes marquées d’un astérisque). Chaque découverte modifie la moitié des dés de dégâts de la bombe, arrondis à l’inférieur. Par exemple, la [[Découvertes#BOMBEASSOURDISSANTE|bombe assourdissante]]/[[Découvertes#BOMBEDEGIVRE|de givre]] d’un saboteur de niveau 9 inflige 2d4 points de dégâts sonores et 2d6 points de dégâts de froid. Pour créer une bombe complexe, il faut dépenser deux utilisations quotidiennes du pouvoir de [[alchimiste#BOMBES|bombe]].
- ***Mutagène supérieur du caméléon.*** Le mutagène du caméléon du saboteur lui confère à présent le pouvoir [[rôdeur#DISCRETIONTOTALE|discrétion totale]], comme le pouvoir de rôdeur du même nom, mais il fonctionne dans tous les environnements. Le saboteur doit avoir atteint le niveau 12 avant de faire cette découverte.
...
Voici les découvertes qui viennent compléter l’archétype de saboteur : [[bombe acide (découverte)|bombe acide]], [[bombe assourdissante (découverte)|bombe assourdissante]], [[bombe aveuglante (découverte)|bombe aveuglante]], [[bombe à retardement (découverte)|bombe à retardement]], [[bombe de confusion (découverte)|bombe de confusion]], [[bombe de démence (découverte)|bombe de démence]], [[bombe de précision (découverte)|bombe de précision]], [[bombe de siège (découverte)|bombe de siège]], [[bombe dimmolation (découverte)|bombe d’immolation]], [[bombe explosive (découverte)|bombe explosive]], [[bombe fumigène (découverte)|bombe fumigène]], [[bombe immobilisante (découverte)|bombe immobilisante]], [[bombe incendiaire (découverte)|bombe incendiaire]], [[bombe puante (découverte)|bombe puante]], [[bombes rapides (découverte)|bombes rapides]], [[cognatogène (découverte)|cognatogène]], [[projectile explosif (découverte)|projectile explosif]].
