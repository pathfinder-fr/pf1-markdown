---
Name: Pathfinder-RPG.Nappe de brouillard (mot de pouvoir)
Title: Nappe de brouillard (mot de pouvoir)
LastModified: 2021-07-19 00:42
Categories:
- Mot de pouvoir
- Règle officielle
- Src Art de la magie
...
**Augmentation.** Si un sort incluant ce mot effet utilise le mot cible *[[explosion]]*, le lanceur peut diriger son sort et le mettre en mouvement par une [[action rapide]], sur une distance maximale de 3 mètres (2 {s:c}) par round.
