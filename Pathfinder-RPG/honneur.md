...
L’honneur est représenté par une échelle de points allant de 0 à 100. Une valeur de 0 indique une personne que l’on considère comme totalement indigne de confiance, prête à sacrifier tout et n’importe qui, même pour n’en retirer qu’un bénéfice temporaire. Une valeur de 100 indique une personne de stature légendaire dont la réputation est sans tache. L’honneur n’est pas tant une mesure d’alignement, de renommée ou de bonne volonté qu’un moyen d’estimer la loyauté, la fiabilité et l’équité du personnage : on peut être un shogun au grand coeur mais inconstant avec 0 point d’honneur comme on peut être un moine cruel mais loyal avec 100 points d’honneur.
- **Les points d’honneur de base des PNJ.** Le nombre de base de points d’honneur d’un PNJ est égal à son [FP](./FP.md) × 5. Le MJ modifie cette valeur en s’appuyant sur la section Gagner et perdre des points d’honneur. Un PNJ qui s’écarte des principes de sa société peut avoir une valeur d’honneur très différente de ce nombre de base. La plupart des valeurs d’honneur des PNJ changent rarement bien que le MJ puisse décider de bénir ou de disgracier un PNJ donné pour fournir une accroche d’histoire ou d’aventure pour les PJ. 

- **Les points d’honneur de base des PJ.** Le personnage commence avec un nombre de points d’honneur égal à sa valeur de [Charisme](./Charisme.md) + son niveau de personnage. Par exemple, un PJ de niveau 1 ayant une valeur de Charisme de 13 commence le jeu avec une valeur d’honneur de 14. Quand son niveau d’expérience ou son Charisme change de manière permanente, ajustez cette valeur en conséquence. Le personnage peut également gagner ou perdre des points d’honneur en cours de jeu.
...
|-
| Faire 30 ou plus sur un test d’Artisanat pour créer une oeuvre d’art ou un objet de maître<sup>[1](./honneur.md#NOTE1)</sup> || +2
|-
| Faire 30 ou plus sur un test de Diplomatie ou d’Intimidation<sup>[1](./honneur.md#NOTE1)</sup> || +2
|-
| Terminer une aventure de FP approprié<sup>[2](./honneur.md#NOTE2)</sup> || +1
|-
| Créer un puissant objet magique<sup>[3](./honneur.md#NOTE3)</sup> || +1
|-
| Détruire un objet magique maléfique ou dangereux<sup>[4](./honneur.md#NOTE4)</sup> || +1
|-
...
|- CLASS="note"
| COLSPAN="2" | {s:Reference|NOTE1}*(1) Le personnage peut gagner des points d’honneur de cette manière une fois par mois.*
|- CLASS="note"
| COLSPAN="2" | {s:Reference|NOTE2}*(2) Aventure du commerce d’environ 32 ou 48 pages.*
|- CLASS="note"
| COLSPAN="2" | {s:Reference|NOTE3}*(3) Par tranche de 40 000 po du prix de l’objet.*
|- CLASS="note"
| COLSPAN="2" | {s:Reference|NOTE4}*(4) Par tranche de 40 000 po du prix de l’objet. Les artéfacts sans prix accordent 5 points d’honneur dans ces cas-là.*
|}
...
| Évènements || Points d'honneur
|- CLASS="premier"
| Devenir maître de guilde (population urbaine de 25 000 habitants ou plus)<sup>[5](./honneur.md#NOTE5)</sup> || +50
|-
| Devenir maître de guilde (population urbaine de 10 000 habitants ou plus)<sup>[5](./honneur.md#NOTE5)</sup> || +25
|-
| Adopter un code criminel spécifique<sup>[6](./honneur.md#NOTE6)</sup> || +4
|-
| Mettre fin à une vieille querelle (1 an ou plus)avec un criminel plus honorable que soi<sup>[7](./honneur.md#NOTE7)</sup> || +3
|-
| Le groupe humilie un noble honorable<sup>[8](./honneur.md#NOTE8)</sup> || +3
|-
| Corrompre un fonctionnaire public de haut-rang<sup>[8](./honneur.md#NOTE8)</sup> || +2
|-
| Volontairement endosser le blâme pour un criminel de haut-vol || +2
|-
| Les ménestrels chantent volontiers les exploits du personnage<sup>[9](./honneur.md#NOTE9)</sup> || +1
|-
...
|-
| Voler un puissant objet magique ou un trésor de valeur<sup>[10](./honneur.md#NOTE10)</sup> || +1
|-
...
|-
| Initier une longue querelle (1 an ou plus) avec un criminel moins honorable que soi<sup>[7](./honneur.md#NOTE7)</sup> || -4
|-
...
|- CLASS="note"
| COLSPAN="2" | {s:Reference|NOTE5}*(5) Ces évènements ne se cumulent pas pour une même ville. Si la population de la ville augmente après que le personnage est devenu maître de guilde, il gagne la différence de points d’honneur entre les deux évènements.*
|- CLASS="note"
| COLSPAN="2" | {s:Reference|NOTE6}*(6) Tel que « Ne commettre que des crimes sur la propriété » ou « Je ne pratique pas le vol, uniquement le meurtre. »*
|- CLASS="note"
| COLSPAN="2" | {s:Reference|NOTE7}*(7) La valeur d’honneur du personnage et celle de l’autre criminel doivent présenter un écart minimum de 20 points.*
|- CLASS="note"
| COLSPAN="2" | {s:Reference|NOTE8}*(8) 50 points d’honneur non-criminel ou plus.*
|- CLASS="note"
| COLSPAN="2" | {s:Reference|NOTE9}*(9) Le personnage peut gagner des points d’honneur de cette manière une fois par mois.*
|- CLASS="note"
| COLSPAN="2" | {s:Reference|NOTE10}*(10) Par tranche de 40 000 po du prix de l’objet.*
|}
...
|-
| Gagner les faveurs d’un PNJ honorable<sup>[11](./honneur.md#NOTE11)</sup> || +2
|-
...
|-
| Aider un allié politique de statut inférieur<sup>[12](./honneur.md#NOTE12)</sup> || +1
|-
...
|- CLASS="note"
| COLSPAN="2" | {s:Reference|NOTE11}*(11) Le personnage gagne cette récompense une fois par PNJ. Le PNJ doit avoir au moins 10 points d’honneur de plus que le personnage.*
|- CLASS="note"
| COLSPAN="2" | {s:Reference|NOTE12}*(12) Le personnage peut gagner cette récompense une fois par mois. Le PNJ doit avoir au moins 10 points d’honneur de moins que le personnage.*
|}
...
|-
| Faire 30 ou plus sur un test d’[Artisanat](./Artisanat.md) pour créer une oeuvre d’art ou un objet de maître<sup>[13](./honneur.md#NOTE13)</sup> || +2
|-
| Faire 30 ou plus sur un test de [Représentation](./Représentation.md)[13](./honneur.md#NOTE13)</sup> || +2
|-
| Effectuer une action contre son alignement à cause d’un serment qu’on a prêté<sup>[14](./honneur.md#NOTE14)</sup> || +1
|-
| Attirer un kami dans une joute d’esprit || +1
|-
| Se vanter à l’excès de ses réussites<sup>[15](./honneur.md#NOTE15)</sup> || -1
|-
