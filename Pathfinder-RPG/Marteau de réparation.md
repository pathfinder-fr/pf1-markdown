---
Name: Pathfinder-RPG.Marteau de réparation
Title: Marteau de réparation
LastModified: 2026-05-24 15:48
Categories:
- Sort
- Sort conjurateur 5
- Sort magicien 5
...
*Marteau de réparation* peut réparer les objets magiques détruits (les objets ayant 0 point de vie ou moins), et restaure les propriétés magiques de l'objet si le [[NLS|niveau de lanceur de sorts]] du personnage est au moins deux fois supérieur à celui de l'objet. Les objets chargés (comme les [[Baguettes magiques|baguettes]]) et les objets à usage unique (comme les [[Potions magiques|potions]] et les [[Parchemins magiques|parchemins]]) ne peuvent pas être réparés de cette manière.
