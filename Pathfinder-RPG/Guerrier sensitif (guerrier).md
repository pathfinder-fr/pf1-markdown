---
Name: Pathfinder-RPG.Guerrier sensitif (guerrier)
Title: Guerrier sensitif
...
[[FAQ- Aventures occultes#9|→]] Guerrier sensitif : Le guerrier sensitif ne mentionne pas qu'il remplace l'entraînement aux armes 1, mais obtient une capacité très similaire au niveau 5, le même niveau que l'entraînement aux armes 1. Devrait-elle remplacer l'entraînement aux armes 1 ?**'

Oui. Cela sera reflété dans le prochain errata. *(Retour à l'<u>[[Guerrier sensitif (guerrier)|archétype]]</u>)*}Un guerrier sensitif de niveau 5 peut focaliser ses sens par une [[types dactions#MOUVEMENT|action de mouvement]]. Ceci fait, il bénéficie d’un bonus d’intuition de +1 aux [[valeurs de combat#JETDATTAQUE|jets d’attaque]], aux [[valeurs de combat#DEGATS|jets de dégâts]] effectués avec des armes et aux jets de Volonté. Ce bonus augmente de +1 au niveau 9 et tous les 4 niveaux par la suite. Le guerrier sensitif perd cette focalisation s’il devient [[confus]], [[hébété]], [[fasciné]], [[chancelant]] ou [[étourdi]], s’il tombe [[inconscient]] ou s’il rate un jet de Volonté. Cette aptitude remplace celle d’[[guerrier#ENTRAINEMENTAUXARMES|entraînement aux armes]] 1, 2, 3 et 4.

#### Esquive instinctive supérieure (Sur)
Un guerrier sensitif de niveau 7 acquiert l’[[barbare#ESQUIVEINSTINCTIVESUPERIEURE|esquive instinctive supérieure]], comme l’aptitude du même nom des barbares, sauf que cette aptitude est un pouvoir surnaturel. Cette aptitude remplace celle d’[[guerrier#ENTRAINEMENTAUXARMURES|entraînement aux armures]] 2.

#### Esquive totale (Sur)
Un guerrier sensitif de niveau 11 acquiert l’[[roublard#ESQUIVETOTALE|esquive totale]] aussi longtemps que ses sens sont focalisés. Cette aptitude fonctionne comme l’aptitude du même nom des roublards, sauf que c’est un pouvoir surnaturel qui fonctionne quelle que soit l’armure ou la charge transportée. Cette aptitude remplace celle d’[[guerrier#ENTRAINEMENTAUXARMURES|entraînement aux armures]] 3.

#### Sensé (Sur)
Un guerrier sensitif de niveau 15 peut focaliser ses sens par une [[types dactions#RAPIDE|action rapide]]. Cette aptitude remplace celle d’[[guerrier#ENTRAINEMENTAUXARMURES|entraînement aux armures]] 4.

#### Sens infaillibles (Sur)
Les organes sensoriels d’un guerrier sensitif de niveau 19 atteignent la perfection et le personnage peut aisément dévoiler les illusions et repérer les ennemis invisibles en utilisant tous ses sens. Quand ses sens sont focalisés, il bénéficie des effets d’une *[[vision lucide]]* ainsi que la [[perception aveugle]] jusqu’à 18 mètres. Une créature invisible, silencieuse et inodore (comme une créature sous les effets d’une *[[invisibilité]]*, d’un *[[silence]]* et d’une *[[négation de larôme|négation de l’arôme]]*) peut quand même éviter les effets de la *[[vision lucide]]* et de la [[perception aveugle]]. Cette aptitude remplace celle de [[guerrier#MAITRISEDESARMURES|maîtrise des armures]].

#### Précision critique (Sur)
Si ses sens sont focalisés, un guerrier sensitif de niveau 20 effectue deux jets pour confirmer ses coups critiques et conserve le résultat le plus favorable. Les adversaires doivent effectuer deux jets pour confirmer leurs coups critiques contre lui et conservent le résultat le moins favorable. Cette dernière possibilité ne fonctionne pas si le guerrier sensitif ne bénéficie plus de son bonus de [[Dextérité]]. Cette aptitude remplace celle de [[guerrier#MAITRISEDESARMES|maîtrise des armes]].
