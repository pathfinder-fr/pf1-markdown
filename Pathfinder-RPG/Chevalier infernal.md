...
#### Aura de loi (Ext)
La puissance de l’aura de loi d’un Légionnaire infernal (voir le sort *[[détection de la loi]]*) est égale à son niveau de
personnage.
...
Chaque jour, au niveau 2, le Légionnaire infernal peut utiliser *[[détection du mensonge]]* comme un pouvoir magique un nombre de fois égal à 3 + son modificateur de [[Charisme]]. Son [[NLS|niveau de lanceur de sorts]] est égal à son niveau de personnage.

{s:Reference|ARMUREDELÉGIONNAIREINFERNAL}
#### Armure de Légionnaire infernal (Ext)
Au niveau 2, le Légionnaire gagne le droit de porter une armure de Légionnaire infernal. Tant qu’il la porte, il réduit son malus d’armure de 1, augmente son bonus de [[Dextérité]] maximal de 1 et se déplace à sa [[VD|vitesse maximale]]. Au niveau 5, ces modificateurs passent à 2 et au niveau 8 à 3.
...
- **Souffrance (Sur ; toute cohorte).** Par une [[action simple]], le Légionnaire infernal peut faire une attaque de contact qui inflige d’incroyables souffrances à sa cible. La créature touchée reçoit 1d6 points de dégâts + modificateur de Charisme du Légionnaire et doit réussir un jet de [[Volonté]] ou être [[chancelant|chancelante]] pendant 1d4 rounds.
- **Terrifiant (Ext ; toute cohorte).** Un Légionnaire infernal qui utilise sa compétence [[Intimidation]] pour [[secoué|secouer]] une créature située dans les 3 mètres (2 {s:c}) l’[[effrayé|effraye]] à la place.
