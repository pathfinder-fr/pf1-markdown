---
Name: Pathfinder-RPG.Cératioïde
Title: Cératioïde
...
{s:BDTexte|**Réf** +4, **Vig** +3, **Vol** +6}
{s:BDTexte|**Immunité** effets mentaux}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9 m (6 {s:c}), nage 15 m (10 {s:c})}
{s:BDTexte|**Corps à corps** 2 épieux, +8 (1d6+3) ou 2 coups, +7 (1d4+3)}
{s:BDTexte|**A distance** 2 épieux, +5 (1d6+3)}
{s:BDTexte|**Attaque spéciale** leurre}
...
{s:BDTexte|**Environnement** eaux salées}
