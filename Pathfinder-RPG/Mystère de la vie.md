---
Name: Pathfinder-RPG.Mystère de la vie
Title: Mystère de la vie
LastModified: 2024-07-13 17:00
Categories:
...
**Canalisation (Sur).** L’oracle [[canalisation|canalise]] l’énergie positive comme un [[prêtre]] en utilisant son niveau d’oracle comme niveau de [[prêtre]] effectif quand il détermine le montant de dégâts soignés (ou infligé à des [[type mort-vivant|morts-vivants]]) et les [[DD]]. Chaque jour, il peut utiliser ce pouvoir un nombre de fois égal à 1 + modificateur de [[Charisme]].

{s:um}Voir aussi les [[variantes de canalisation]].

{s:FAQ|***[[FAQ- Manuel des joueurs - Règles avancées#33|→]] Oracle, Corps d'énergie : Combien de fois par round puis-je utiliser cette capacité pour soigner quelqu'un ?***
...
**Guérison sécurisée (Sur).** Quand l’oracle lance un sort qui rend des [[pv|points de vie]] à la cible, il ne provoque pas d’[[attaque dopportunité|attaque d’opportunité]] lors de l’incantation.
...
**Révélation finale.** Quand l’oracle atteint le niveau 20, il devient un conduit parfait pour la [[canalisation]] d’énergie vitale. Il est immunisé contre le [[saignement]], les attaques de [[mort]], l’[[épuisé|épuisement]], la [[fatigue]], la [[nauséeux|nausée]], les niveaux négatifs et la condition [[fiévreux|fiévreuse]]. Les absorptions et les [[affaiblissement temporaire|affaiblissements temporaires de caractéristique]] ne peuvent pas réduire une valeur à moins de 1. L’oracle réussit automatiquement tous ses [[jet de sauvegarde|jets de sauvegarde]] contre les [[Blessures et mort#DEGÂTSEXCESSIFS|dégâts excessifs]]. Quand l’oracle se trouve en dessous de 0 point de vie, il ne meurt pas tant que son total de points négatifs n’est pas égal à deux fois sa valeur de [[Constitution]].
