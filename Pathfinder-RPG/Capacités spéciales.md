...
*Résistance à la magie* : la [[RM|résistance à la magie]] protège-t-elle contre un pouvoir de ce type ?

*Zone d’antimagie* : est-ce qu’une *[[zone dantimagie|zone d’antimagie]]* réprime ce type de pouvoir ?
...
:**La Force.** Les augmentations temporaires à la [[Force]] accordent un bonus aux [[test de compétence|tests de compétences]] dépendant de cette caractéristique, aux [[jet dattaque|jets d’attaque]] de corps à corps et aux [[jet de dégâts]] d’une arme s’ils dépendent de la [[Force]]. Ce bonus s’applique également au [[BMO|bonus de manœuvre offensive]] (si le personnage est au moins de [[taille P]]) et à son score de [[DMD|Manœuvre défensive]].

:**La Dextérité.** Les augmentations temporaires à la [[Dextérité]] accordent un bonus aux [[test de compétence|tests de compétences]] dépendant de cette caractéristique, aux [[jet dattaque|jets d’attaque]] à distance, aux jets d’[[initiative]] et aux jets de [[Réflexes]]. Ce bonus s’applique également à la [[CA|classe d’armure]], au [[BMO|Bonus de manœuvre offensive]] (si le personnage est au au plus de [[taille TP]]) et au [[DMD|bonus de Manœuvre défensive]].

:**La Constitution.** Les augmentations temporaires à la [[Constitution]] accordent un bonus aux jets de [[Vigueur]]. De plus, il convient de multiplier le nombre total des [[DV]] du personnage par ce bonus, et d’ajouter le résultat à ses [[pv|points de vie]]. Lorsque le bonus ne s’applique plus, enlevez les points de vie ainsi ajoutés.

:**L’Intelligence.** Les augmentations temporaires à l’[[Intelligence]] accordent un bonus aux [[test de compétence|tests de compétences]] dépendant de cette caractéristique. Ce bonus s’applique également au [[DD]] des sorts dépendant de l’[[Intelligence]].

:**La Sagesse.** Les augmentations temporaires à la [[Sagesse]] accordent un bonus aux [[test de compétence|tests de compétences]] dépendant de cette caractéristique, ainsi qu’aux jets de [[Volonté]]. Ce bonus s’applique également au [[DD]] des sorts dépendant de la Sagesse.

:**Le Charisme.** Les augmentations temporaires au [[Charisme]] accordent un bonus aux [[test de compétence|tests de compétences]] dépendant de cette caractéristique. Ce bonus s’applique également au [[DD]] des sorts dépendant du [[Charisme]], ainsi qu’au [[DD]] d’une [[canalisation]] d’énergie.

**Les bonus permanents.** Les bonus aux caractéristiques dont la durée est supérieure à un jour augmentent la caractéristique à laquelle ils s’appliquent au bout de vingt-quatre heures. Ce bonus s’applique aux [[compétences]] et aux statistiques dépendant de cette caractéristique. Il est possible d’ainsi obtenir, entre autres, des [[rang|rangs]] de compétence et des [[pv|points de vie]] supplémentaires. Ces bonus devront être notés séparément, au cas où ils viendraient à disparaître.

### Affaiblissements temporaires, pénalité et diminutions permanentes de caractéristiques
Ce texte a été reporté sur la [[Affaiblissement temporaire (capacité)|règle universelle de monstre]] associée.

### Les afflictions
Voir la [[Afflictions|page dédiée]].

### Absorption d’énergie et niveaux négatifs
Ce texte a été reporté sur la [[Absorption dénergie (capacité)|règle universelle de monstre]] associée.
...
- Les attaques de mort tuent immédiatement. Il est impossible de [[stabilisation|stabiliser]] l’état de la victime pour la maintenir en vie.
...
Ce texte a été reporté sur les règles universelles de monstre [[Immunité (capacité)|immunité]] et [[Vulnérabilités (capacité)|vulnérabilité]].
...
L’invisibilité ne confère pas en soi l’immunité contre les [[coup critique|coups critiques]], mais elle protège contre les dommages supplémentaires d’[[ennemi juré]] et contre les [[attaque sournoise|attaques sournoises]].
...
### Odorat
Ce texte a été reporté sur la [[Odorat (capacité)|règle universelle de monstre]] associée.

### Paralysie
Ce texte a été reporté sur la [[Paralysie (capacité)|règle universelle de monstre]] associée.

### Peur
Ce texte a été reporté sur la [[Terreur (capacité)|règle universelle de monstre]] associée.

### Réduction de dégâts
Ce texte a été reporté sur la [[Réduction de dégâts (capacité)|règle universelle de monstre]] associée.

### Résistance à la canalisation
Ce texte a été reporté sur la [[Résistance à la canalisation (capacité)|règle universelle de monstre]] associée.

### Résistance à la magie
Ce texte a été reporté sur la [[Résistance à la magie (capacité)|règle universelle de monstre]] associée.

{s:Reference|VISIONDANSLENOIR}
### Vision dans le noir
Ce texte a été reporté sur la [[Vision dans le noir (capacité)|règle universelle de monstre]] associée.

### Vision et perception aveugle
Ce texte a été reporté sur les règles universelles de monstre [[Vision aveugle (capacité)|vision aveugle]] et [[Perception aveugle (capacité)|perception aveugle]].

### Vision nocturne
Ce texte a été reporté sur la [[Vision nocturne (capacité)|règle universelle de monstre]] associée.
