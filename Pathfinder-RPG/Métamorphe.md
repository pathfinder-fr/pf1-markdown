---
Name: Pathfinder-RPG.Métamorphe
Title: Le métamorphe
LastModified: 2023-02-28 13:34
Categories:
- Classe
---
...
<table CLASS="tablo">
  ...
  <tr CLASS="premier">
    ...
    <td>+0</td>
    <td CLASS="gauche">
      [[Métamorphe#ASPECT|aspect du métamorphe]], [[Métamorphe#EMPATHIESAUVAGE|empathie sauvage]],
      [[Métamorphe#GRIFFES|griffes du métamorphe]]
    </td>
  </tr>
  <tr CLASS="alt">
    <td>2</td>
    ...
    <td>+3</td>
    <td>+0</td>
    <td CLASS="gauche">[[Métamorphe#INSTINCTDEFENSIF|instinct défensif]], [[Métamorphe#PISTAGE|pistage]]</td>
  </tr>
  <tr>
    <td>3</td>
    <td>+3</td>
    ...
    <td>+1</td>
    <td CLASS="gauche">
      [[Métamorphe#GRIFFES|amélioration des griffes du métamorphe]], [[Métamorphe#DEPLACEMENTFACILITE|déplacement
      facilité]]
    </td>
  </tr>
  <tr CLASS="alt">
    ...
    <td>+1</td>
    <td CLASS="gauche">
      [[Métamorphe#INSTINCTDEFENSIF|instinct défensif (+1)]], [[Métamorphe#FORMEANIMALE|forme animale]]
    </td>
  </tr>
  <tr>
    <td>5</td>
    ...
    <td>+4</td>
    <td>+1</td>
    <td CLASS="gauche">[[Métamorphe#ASPECT|deuxième aspect]], [[Métamorphe#ABSENCEDETRACES|absence de traces]]</td>
  </tr>
  <tr CLASS="alt">
    <td>6</td>
    <td>+6/+1</td>
    ...
    <td>+5</td>
    <td>+2</td>
    <td CLASS="gauche">[[Métamorphe#FURIEDUMETAMORPHE|furie du métamorphe]]</td>
  </tr>
  <tr>
    <td>7</td>
    <td>+7/+2</td>
    ...
    <td>+5</td>
    <td>+2</td>
    <td CLASS="gauche">[[Métamorphe#GRIFFES|amélioration des griffes du métamorphe]]</td>
  </tr>
  <tr CLASS="alt">
    <td>8</td>
    <td>+8/+3</td>
    ...
    <td>+6</td>
    <td>+2</td>
    <td CLASS="gauche">[[Métamorphe#INSTINCTDEFENSIF|instinct défensif (+2)]]</td>
  </tr>
  <tr>
    <td>9</td>
    <td>+9/+4</td>
    ...
    <td>+6</td>
    <td>+3</td>
    <td CLASS="gauche">[[Métamorphe#ASPECTCHIMERIQUE|aspect chimérique]]</td>
  </tr>
  <tr CLASS="alt">
    <td>10</td>
    <td>+10/+5</td>
    ...
    <td>+7</td>
    <td>+3</td>
    <td CLASS="gauche">[[Métamorphe#ASPECT|troisième aspect]]</td>
  </tr>
  <tr>
    <td>11</td>
    <td>+11/+6/+1</td>
  ...
  <tr CLASS="alt">
    ...
    <td>+8</td>
    <td>+4</td>
    <td CLASS="gauche">[[Métamorphe#INSTINCTDEFENSIF|instinct défensif (+3)]]</td>
  </tr>
  <tr>
    <td>13</td>
    <td>+13/+8/+3</td>
  ...
  <tr CLASS="alt">
    ...
    <td>+9</td>
    <td>+4</td>
    <td CLASS="gauche">[[Métamorphe#ASPECTCHIMERIQUESUPERIEUR|aspect chimérique supérieur]]</td>
  </tr>
  <tr>
    <td>15</td>
    <td>+15/+10/+5</td>
    ...
    <td>+9</td>
    <td>+5</td>
    <td CLASS="gauche">[[Métamorphe#ASPECT|quatrième aspect]]</td>
  </tr>
  <tr CLASS="alt">
    <td>16</td>
    <td>+16/+11/+6/+1</td>
    ...
    <td>+10</td>
    <td>+5</td>
    <td CLASS="gauche">[[Métamorphe#INSTINCTDEFENSIF|instinct défensif (+4)]]</td>
  </tr>
  <tr>
    <td>17</td>
    <td>+17/+12/+7/+2</td>
  ...
  <tr CLASS="alt">
    ...
    <td>+6</td>
    <td CLASS="gauche">
      [[Métamorphe#ETERNELLEJEUNESSE|éternelle jeunesse]], [[Métamorphe#MILLEVISAGES|mille visages]]
    </td>
  </tr>
  <tr>
    <td>19</td>
  ...
  <tr CLASS="alt">
    ...
    <td>+6</td>
    <td CLASS="gauche">
      [[Métamorphe#ASPECTFINAL|aspect final]], [[Métamorphe#INSTINCTDEFENSIF|instinct défensif (+5)]]
    </td>
  </tr>
</table>
...
Un métamorphe parle la langue druidique, un langage secret connu seulement des druides et des métamorphes, laquelle s'apprend en devenant un métamorphe de niveau 1. Le druidique est un langage bonus pour un métamorphe ; qu'il connait en plus des langues qu'il peut obtenir et pour lequel il n'a pas à dépenser de rang. Il est interdit aux métamorphes d'apprendre ce langage à des non druides ou à des non métamorphes.
...
- Au niveau 7, les dégâts de ses griffes atteignent 1d6 (taille P 1d4). 
- Au niveau 11, les dégâts de ses griffes atteignent 1d8 (taille P 1d6 ). 
- Au niveau 13, les dégâts de ses griffes atteignent 1d10 (taille P 1d8). 
- Au niveau 17, le dé de dégâts n'augmente pas mais le multiplicateur de critique passe à ×3. 
- Finalement, au niveau 19, les griffes ignorent la RD/adamantine et la RD/—.

Lorsqu'un métamorphe utilise forme bestiale pour prendre la forme d'un aspect majeur, ses attaques naturelles obtiennent les mêmes bénéfices que ceux accordés par l'aptitude de griffes du métamorphe. Si la forme qu'il prend possède des griffes, il peut utiliser le meilleur des dégâts offerts par l'aptitude griffes du métamorphe ou ceux des griffes de la forme empruntée. Si la forme empruntée ne possède pas de griffe, il peut choisir jusqu'à deux attaques naturelles qui occasionnent moins de dégâts que ceux infligés par l'aptitude et bénéficier pour ces attaques les mêmes dégâts que ceux infligés par ses griffes du métamorphe.
...
{s:Reference|FURIEDUMETAMORPHE}
#### Furie du métamorphe (Ext)
(((FAQ)))
Au niveau 6, un métamorphe obtient la faculté de porter plusieurs attaques féroces avec les mêmes armes naturelles. Au lieu de l'attaquer avec toutes ses armes naturelles, le métamorphe peut choisir une unique arme naturelle et faire une attaque à outrance avec cette arme naturelle, obtenant une seconde attaque avec une pénalité de –5 comme s'il s'agissait d'une arme manufacturée. Lorsqu'il procède de la sorte, toutes ses autres attaques naturelles sont considérées comme des attaques secondaires et ne bénéficient pas de la capacité des griffes du métamorphe.

Au niveau 11, il obtient une troisième attaque avec une pénalité de –10 et au niveau 16, il obtient une quatrième attaque avec une pénalité de –15.

{s:Reference|ASPECTCHIMERIQUE}
#### Aspect chimérique (Sur)
Au niveau 9, lorsqu'un métamorphe utilise sa capacité aspect pour prendre une forme mineure, il peut choisir deux aspects et prendre la forme mineure de chacun des aspects.

{s:Reference|ASPECTCHIMERIQUESUPERIEUR}
#### Aspect Chimérique Supérieur (Sur)
Au niveau 14, lorsqu'un métamorphe utilise sa capacité aspect pour prendre une forme mineure, il peut choisir jusqu'à trois aspects et prendre la forme mineure de chacun des aspects.
