---
Name: Pathfinder-RPG.Nataka (technique)
Title: Le roi rouge
...
{s:DieuTech|Nataka|Le roi rouge| |[[Divinités#ONISDAIMYO|Onis daimyo]]
|Neutre Mauvais|Sécheresse, feux de forêt, parfum
|N'importe|Aucun
...
{s:cs}{s:BotD}
### Obédience
Méditer dans un anneau de feu tout en jetant périodiquement de l'encens dans les flammes. Gain d'un bonus de malfaisance de +4 aux [[jds|jets de sauvegarde]] contre les effets de [[registre|feu]].
...
- **1.** *[[lame de feu]]*
- **2.** *[[coupe de poussière]]* à [[extension de durée]]
- **3.** *[[boule de feu]]* à [[quintessence des sorts]]
