...
### Version mythique
{s:CMy}
Le personnage peut réduire la taille de la cible de deux [[Petites et grandes créatures#TABLEAUTAILLES|catégories]] au maximum, jusqu’à un minimum de Très petit. Si la taille de la cible est réduite de deux [[Petites et grandes créatures#TABLEAUTAILLES|catégories]], son poids est divisé par 16 et elle gagne un bonus de taille de +4 à sa [[Dextérité]], un malus de taille de -4 à sa [[Force]] et un bonus de +2 aux jets d’attaque et à la [[CA]] à cause de sa taille réduite. Une créature humanoïde de taille Moyenne ou Petite dont la taille est réduite à Très petite occupe un quart de case et possède une allonge de 0 mètre.
...
**École** [[Transmutation]] ; **Niveau** [[druide|Dru]] 2, [[rôdeur|Rôd]] 3
**Temps d'incantation** 1 [[action simple]]
**Composantes** [[composantes|V, G]]
**Portée** [[Présentation des sorts#PORTEE|contact]]
**Cible** 1 [[type animal|animal]] consentant de taille P, M, G ou TG
**Durée** 1 heure/[[niveau]] ([[Présentation des sorts#DUREE|T]])
**Jet de sauvegarde** aucun ; **Résistance à la magie** non
---
Ce sort est semblable à *[[rapetissement]]*, si ce n’est qu’il affecte un [[type animal|animal]] consentant. Réduisez les dégâts infligés par les [[attaque naturelle|attaques naturelles]] de l’[[type animal|animal]] conformément à sa nouvelle taille (voir la table "Dégâts des armes de taille TP ou G" dans le chapitre "[[Caractéristiques des armes#TAILLEARME|Taille de l'arme]]").
