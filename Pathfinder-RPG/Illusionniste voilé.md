---
Name: Pathfinder-RPG.Illusionniste voilé
Title: Illusionniste voilé
LastModified: 2021-07-02 22:32
Categories:
- Classe de prestige
...
<table CLASS="tablo">
  <caption>L'illusionniste voilé</caption>
  <tr CLASS="titre">
    <td>Niveau</td>
    <td>BBA</td>
    <td>Réflexes</td>
  ...
  <tr CLASS="premier">
    ...
    <td>+1</td>
    <td CLASS="gauche">
      [[Illusionniste voilé#VOILESDELADEESSE|Voiles de la déesse (Humain)]], [[Illusionniste
      voilé#RESERVEDEVOILES|réserve de voiles]]
    </td>
  ...
  <tr CLASS="alt">
    ...
    <td>+1</td>
    <td>+1</td>
    <td CLASS="gauche">[[Illusionniste voilé#VOILESDELADEESSE|Voiles de la déesse (Halfelin)]]</td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr>
    <td>3</td>
    ...
    <td>+1</td>
    <td>+2</td>
    <td CLASS="gauche">[[Illusionniste voilé#RESERVEDEVOILES|Réserve de voiles (auditif)]]</td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr CLASS="alt">
    <td>4</td>
    ...
    <td>+1</td>
    <td>+2</td>
    <td CLASS="gauche">[[Illusionniste voilé#VOILESDELADEESSE|Voiles de la déesse (Elfe)]]</td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr>
    <td>5</td>
    ...
    <td>+3</td>
    <td CLASS="gauche">
      [[Illusionniste voilé#RESERVEDEVOILES|Réserve de voiles (tactile)]], [[Illusionniste voilé#VOILERAPIDE|Voile
      rapide (mouvement)]]
    </td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr CLASS="alt">
    ...
    <td>+2</td>
    <td>+3</td>
    <td CLASS="gauche">[[Illusionniste voilé#VOILESDELADEESSE|Voiles de la déesse (Gnome)]]</td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr>
    <td>7</td>
    ...
    <td>+2</td>
    <td>+4</td>
    <td CLASS="gauche">[[Illusionniste voilé#VOILERAPIDE|Voile rapide (rapide)]]</td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr CLASS="alt">
    <td>8</td>
    ...
    <td>+3</td>
    <td>+4</td>
    <td CLASS="gauche">[[Illusionniste voilé#VOILESDELADEESSE|Voiles de la déesse (Cyclope)]]</td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr>
    <td>9</td>
    ...
    <td>+3</td>
    <td>+5</td>
    <td CLASS="gauche">[[Illusionniste voilé#RESERVEDEVOILES|Réserve de voiles (sens extraordinaires)]]</td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
  <tr CLASS="alt">
    <td>10</td>
    ...
    <td>+5</td>
    <td CLASS="gauche">
      [[Illusionniste voilé#VOILESDELADEESSE|Voiles de la déesse (Naga)]], [[Illusionniste
      voilé#VERITABLEVOILE|Véritable voile]]
    </td>
    <td CLASS="gauche">[[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]</td>
  </tr>
</table>
...
**Sorts.** Capacité à lancer 3 sorts de l’école de l’[[illusion]] différents, l’un d’entre eux étant de 2e niveau ou plus.

### Compétences de classe
Voici les compétences de classe de l’illusionniste voilé : [[Art de la magie]] (Int), [[Bluff]] (Cha), [[Déguisement]] (Cha), [[Connaissances]] (mystères) (Int), [[Connaissances]] (religion) (Int) et [[Discrétion]] (Dex).
...
- ***Elfe.*** Au niveau 4, un illusionniste voilé peut dépenser 1 point de sa réserve de voiles par une [[action immédiate]] pour relancer un test de [[NLS|niveau de lanceur de sorts]] pour passer la [[RM|résistance à la magie]]. Il doit utiliser cette capacité avant que les résultats du premier test ne soient annoncés et il doit forcément conserver le nouveau résultat, même s’il est pire.

- ***Gnome.*** Au niveau 6, un illusionniste voilé peut dépenser 1 point de sa réserve de voiles pour se concentrer sur un sort ou effet d’[[branche hallucination|hallucination]] ou de [[branche chimère|chimère]] par une [[action rapide]] au lieu d’une [[action simple]]. 

- ***Cyclope.*** Au niveau 8, un illusionniste voilé peut dépenser 1 point de sa réserve de voiles par une [[action libre]] pour gagner les avantages du sort *[[vision lucide]]* jusqu’au début de son prochain tour.

- ***Naga.*** Au niveau 10, par une [[action libre]] lorsqu’il incante un sort d’[[illusion]], un illusionniste voilé peut dépenser 1 point de sa réserve de voiles afin que l'illusion se plie sur elle-même. Toute créature qui dévoile l’illusion voit une seconde illusion à l’intérieur de la limite translucide de la première, comme si l’illusionniste avait lancé le sort une seconde fois. Ainsi, lorsqu’une créature a réussi à dévoiler la première illusion, elle voit la deuxième illusion à la place et elle doit tenter de la dévoiler séparément. L’illusionniste voilé doit déterminer les traits de la seconde illusion lorsqu’il lance la première. Si la deuxième illusion est très similaire à la première, les créatures qui l’étudient ou interagissent avec l’illusion reçoivent un bonus de +4 pour dévoiler l’effet. 

{s:reference|VOILERAPIDE}
#### Voile rapide
Au niveau 5, un illusionniste voilé peut revêtir ou modifier le *déguisement* de sa capacité [[Illusionniste voilé#RESERVEDEVOILES|réserve de voiles]] par une [[action de mouvement]]. Au niveau 7, il lui suffit d'une [[action rapide]].
...
L’effet dure un nombre de minutes égal au niveau de l’illusionniste voilé s’il est déguisé en humanoïde ou en rounds par niveau s’il est déguisé en cyclope ou en naga.
