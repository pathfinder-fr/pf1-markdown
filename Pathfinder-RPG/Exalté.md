...
#### Marque divine (Sur)
Au niveau 1, une marque apparaît quelque part sur le corps de l'exalté. L'emplacement de la marque dépend de chaque individu et de chaque foi, mais elle clairement la divinité choisie par l'exalté. La marque divine apparaît souvent à un endroit facilement visible, comme une main, un avant-bras, le visage ou le torse. Une marque divine qui n'est pas couverte fonctionne comme un [[Symbole sacré (objet)|symbole sacré]] (ou maudit). Si la marque est retirée de force du corps d'un exalté non consentant, elle réapparaît quelque part sur son corps après 24 heures.

{s:reference|OBEDIENCE}
#### Obédience (Ext)
Pour pouvoir garder les pouvoirs octroyés par cette classe de prestige (ce qui inclut toutes les capacités de lanceur de sorts qui ont été améliorées par cette classe de prestige), un exalté doit réaliser une obédience quotidienne envers la divinité qu'il vénère (voir le [[Divinités|profil de la divinité]]).

{s:reference|ERUDIT}
#### Érudit (Ext)
Les exaltés ont tous des origines diverses et variées et étudient des aspects différents de leur foi. Au niveau 1, un exalté peut sélectionner une compétence de [[Connaissances]] supplémentaire pour l'ajouter à sa liste de compétences de classe.

{s:reference|VITALITE}
#### Vitalité (Sur)
De l'énergie divine parcours le corps de l'exalté, ce qui le rend plus résilient. Au niveau 2, l'exalté obtient un bonus de sainteté ou de malfaisance de +2 aux jets de [[Vigueur]] ainsi qu'aux tests de [[Constitution]] pour [[Blessures et mort#STABLE|se stabiliser]].
...
#### Vision ardente (Mag)
Au niveau 8, l'exalté peut toujours discerner les ennemis de sa foi. Il peut lancer *[[détection du Bien]]*/*[[Détection du Chaos|Chaos]]*/*[[Détection de la Loi|Loi]]*/*[[Détection du Mal|Mal]]* à volonté, avec un [[niveau de lanceur de sorts]] égal à son niveau de personnage. L'exalté doit sélectionner un alignement qu'il sera capable de détecter, mais l'alignement choisi doit être opposé à celui de l'exalté (ou un au choix s'il est d'alignement neutre), et une fois ce choix fait, il ne peut plus être changé.
...
- Dupliquer n'importe quel [[Liste des sorts de prêtres|sort de prêtre]] de 6e niveau ou moins.
- Dupliquer n'importe quel autre sort de 5e niveau ou moins.
- Potentiellement annuler les effets néfastes de sorts comme *[[aliénation mentale]]* ou *[[débilité]]* qui nécessiteraient un *[[miracle]]* pour être contrés. Pour essayer d'annuler un tel sort, l'exalté doit faire un test de [[niveau de lanceur de sorts]] en utilisant son niveau dans la classe de lanceur de sorts à laquelle il a ajouté ses niveaux d'exalté (ce qui inclut donc son amélioration de [[NLS]] grâce à ses niveaux d'exalté) contre un [[DD]] de 11 + le niveau de lanceur de sorts de l'effet ciblé. Sur un succès, l'exalté contre l'effet ou le sort. Sur un échec, l'exalté ne contre pas le sort ou l'effet mais il peut réessayer après une période de 24 heures.
...
Un sort dupliqué autorise un [[jds|jet de sauvegarde]] et une [[résistance à la magie]] comme à l'accoutumée, mais les [[DD]] des jets de sauvegarde sont calculés comme s'il s'agissait d'un sort de 7e niveau. Lorsqu'un exalté utilise cette capacité pour dupliquer un sort avec une [[composantes|composante matérielle]] d'une valeur supérieure à 100 po, il doit fournir cette composante.
