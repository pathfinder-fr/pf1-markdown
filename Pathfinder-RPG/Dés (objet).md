...
*Dés pipés*. La plupart des dés pipés sont plus lourds que les autres, le poids étant concentré à l’opposé du nombre voulu. Le personnage peut repérer ce truquage avec un test d’[Estimation](./Estimation.md) ou de [Perception](./Perception.md) [DD](./DD.md) 15. Les dés pipés supérieurs (comme les dés en bois taillés autour d’un poids naturel) ont un DD allant de 20 à 30.
