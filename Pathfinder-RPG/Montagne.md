...
**Pentes douces et raides.** Elles fonctionnent de la même manière que celles décrites dans la section réservée aux [collines](./Collines.md).

**À-pic.** Il fonctionne également de la même manière que celui décrit dans la section réservée aux [collines](./Collines.md), mais fait en règle générale 2d6 x 3 m de haut. Les à-pic dépassant les vingt-quatre mètres occupent un espace horizontal de six mètres.
...
**Broussailles légères.** Elles fonctionnent de la même manière que celles décrites dans la section réservée aux [forêts](./Forêts.md).
