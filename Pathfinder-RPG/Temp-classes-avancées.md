---
Name: Pathfinder-RPG.Temp-classes-avancées
Title: page de travail des classes avancées
LastModified: 2020-06-12 22:04
Categories:
...
- suppression des références aux pages et aux tableaux faites
- archétypes créés et liens faits
...
- ancres à créer
- Mises en forme faites (blurpy : **à relire**)
...
- snippet Menuarchétypesprêtrecombattant créé
- archétypes mis en forme (blurpy) **corrigées et relues**
...
- liens créés
- tableau des talents fait (blurpy : **à relire**)
- archétypes mis en forme (blurpy : **à relire**)
...
- ~~créer des catégories nouvelles pour les nouvelles classes à sort~~ **fait**
- Rajouter pour chaque sort existant les nouvelles classes et le niveau du sort 

- Description des sorts **en cours mais sous format word pour une future intégration**
- Intégration des nouveaux sorts dans la liste des sorts de chaque classe et sur la liste des sorts par ordre alphabétique. Ne pas oublier les sorts des élémentaliste.
~~Alchimiste~~ ; ~~Antipaladin~~ ; ~~Barde~~ ; ~~Chaman~~ ; ~~Druide~~ ; ~~Ensorceleur/Magicien~~ ; ~~Inquisiteur~~ ; ~~Invocateur~~ ; ~~Magus~~ ; ~~Paladin~~ ; ~~Prêtre~~ ; ~~Rôdeur~~ ; ~~Sanguin~~ ; ~~Sorcière~~

- snippet à créer avec toutes les listes de sorts des classes pour une navigation plus aisée
...
(Djezebel, Faust)
## Errata
Un errata a été édité par Paizo en juillet 2015. Il faudra l'intégrer. [http://paizo.com/include/PZO1125-Errata-20150722-1.0.zip](http://paizo.com/include/PZO1125-Errata-20150722-1.0.zip)
...
Il peut être intégré comme les autres suppléments de contexte à condition toutefois de retrancher du texte toute référence à des noms protégés issus du "lore" de Golarion par exemple (nom des dieux, des villes, des régions, des personnages…).
- Lorsqu'ils s'agit de conditions nécessaires à la mécanique d'une capacité, d'un don, d'un sort, ils peuvent être remplacées par des équivalents. 
- Si un don nécessite par exemple de vénérér Gorum, pour respecter la mécanique, il faut mettre qu'il faut vénérer le Dieu de la Guerre. Si ce n'est que du fluff sans conséquence sur la mécanique, on peut retirer la mention.

Les règles d'intégration au wiki seront précisées au cas par cas
...
- Défenseur du Dernier-Rempart Base (combat) 269 
- Descendant de fanatiques Régional (île de Médiogalti) 275 
- Descendant des Rivains Régional (Étendue du Mwangi) 257 
...
- Videur à Absalom Base (combat) 267
...
## Intégration
- insérer dans tous les dons où c'est nécessaire, les conditions lutteur/guerrier niv x ou lutteur/moine niv x : **"Il est aussi considéré comme un guerrier et un moine vis-à-vis des dons et des objets magiques qui fonctionnent différemment avec les personnages possédant des niveaux dans ces classes**"

- Faire la liste des objets magiques qui fonctionnent différemment avec les moines et guerriers 


- Sortir l'encart audace et panache de la page du bretteur lors de la consolidation en faire une désambiguïsation ?

AUDACE, CHANCE ET PANACHE
L’audace, la chance et le panache représentent trois moyens
différents grâce auxquels les héros peuvent accéder à la même
réserve héroïque qu’ils utilisent pour accomplir des hauts-faits
incroyables. Pour les personnages qui possèdent à la fois de
l’audace, de la chance et du panache, ces trois ressources se rassemblent
dans une seule et même réserve combinée. (Ceux qui
utilisent le panache et la chance ne gagnent pas un nombre de points
égal à deux fois leur bonus de Charisme). Dans le cas des dons,
des objets magiques et d’autres effets, un utilisateur de panache
peut dépenser et gagner des points de chance à la place des
points d’audace ou de panache et vice-versa.
Un utilisateur de chance n’est pas considéré comme un utilisateur
d’audace ou de panache en ce qui concerne les conditions
requises par les dons.
