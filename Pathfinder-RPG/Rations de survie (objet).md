---
Name: Pathfinder-RPG.Rations de survie (objet)
Title: Rations de survie
...
{s:AE}**Prix** 5 pa (standard), 1 po (orque), 2 po (elfique), 2 po (gnome), 2 po (halfeline), 2 po (naine) ; **Poids** 0,5 kg (standard), 0,5 kg (orque), 0,5 kg (elfique), 0,5 kg (gnome), 0,25 kg (halfeline), 0,75 kg (naine)<sup>[1](./Nourriture et Boissons.md#1)</sup>
