---
Name: Pathfinder-RPG.Glissement de terrain
Title: Glissement de terrain
LastModified: 2022-06-14 13:52
Categories:
- Règle officielle
- Sort
- Sort druide 6
...
**École** [Transmutation](./Transmutation.md) <nowiki>[</nowiki>[terre](./Registre.md)<nowiki>]</nowiki> ; **Niveau** [Dru](./Druide.md) 6, [Ens](./Ensorceleur.md)/[Mag](./Magicien.md) 6  

**Temps d'incantation** voir description  

**Composantes** [V, G, M](./composantes.md) (argile, limon, sable et une lame de fer)  
...
Le [temps d’incantation](./temps dincantation.md) dépend de la zone que le personnage désire affecter : il s’élève à 10 minutes par carré de 45 m de côté (d’une profondeur maximale de trois mètres). Il faut donc quatre heures et dix minutes pour affecter la zone maximale (225 m de côté).
...
### Mythique
{s:CMy} Ce sort permet de faire bouger la terre plus rapidement et chaque round complet d’incantation permet de refaçonner une zone de 7,50 m² sur une profondeur maximale de 3 mètres. Toutes les créatures sur ou sous le sol, à l’intérieur de cette zone, tombent à terre et sont déplacées vers la case la plus proche située en dehors de la zone en cours de façonnement. Un jet de [Réflexes](./Réflexes.md) réussi permet à une créature de ne pas tomber à terre, mais elle est tout de même déplacée.
