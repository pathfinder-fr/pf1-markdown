---
Name: Pathfinder-RPG.Daivrat
Title: Daivrat
LastModified: 2020-12-17 14:06
Categories:
- Classe de prestige
- Règle officielle
...
**Langue.** Aquatique, aérien, igné ou terreux.
...
#### Armes et armures
Le daivrat ne gagne aucun talent particulier pour le maniement des armes et le port des armures.

#### Sorts
Aux niveaux indiqués, le daivrat gagne de nouveaux sorts par jour, comme s’il avait gagné un niveau dans la classe de lanceur de sorts qui était la sienne avant qu’il opte pour sa classe de prestige. Il ne bénéficie pas des autres avantages que les personnages de cette classe auraient gagnés, seulement des sorts supplémentaires par jour, des sorts connus (si c’est un lanceur de sorts spontanés) et une augmentation du niveau de lanceur de sorts effectif. Si le personnage avait plus d’une classe de lanceur de sorts avant de devenir daivrat, il doit choisir à quelle classe il ajoute son nouveau niveau pour calculer son nombre de sorts quotidien.
...
Le daivrat a plus de mal à préparer et à lancer un sort récupéré qu’un sort de sa connaissance. Si le sort récupéré fait partie de la liste de sorts de sa classe de lanceur de sorts, il le traite comme ayant un niveau de sort de plus que la normale, sinon comme ayant deux niveaux de sort de plus.
