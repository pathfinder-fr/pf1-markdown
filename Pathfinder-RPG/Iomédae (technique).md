...
L'Héritière|%2fPCUP%2fReligion-PNG%2fIomedae.png|[[Divinités#Principales|Divinités principales]], [[Divinités#RACIALES|Divinités halfelines]]
|Loyal Bon|Courage, commandement, honneur et justice
|Paladins, chevaliers, combattants|Lion
|[[Épée longue (arme)|Épée longue]]
|[[Domaine du Bien|Bien]], [[Domaine de la Gloire|Gloire]], [[Domaine de la Guerre|Guerre]], [[Domaine de la Loi|Loi]], [[Domaine du Soleil|Soleil]]
|[[Domaine du Bien|Archons (Bien)]], [[Domaine de la Loi|Archons (Loi)]], [[Domaine de la Gloire|Chevalerie]], [[Domaine de la Guerre|Duels]], [[Domaine de la Gloire|Héroïsme]], [[Domaine de la Gloire|Honneur]], [[Domaine du Soleil|Jour]], [[Domaine du Soleil|Lumière]], [[Domaine de la Gloire|Orgueil (Gloire)]], [[Domaine du Bien|Rédemption]], [[Domaine du Soleil|Révélation]], [[Domaine de la Loi|Souveraineté]], [[Domaine de la Guerre|Tactique]]
|[[Inquisitions#BANNISSEMENT|Bannissement]], [[Inquisitions#Chevalerie]], [[Inquisitions#CLANDESTINITE|Clandestinité]], [[Inquisitions#HERESIE|Hérésie]], [[Inquisitions#HEROISME|Héroïsme]], [[Inquisitions#JUSTICE|Justice]], [[Inquisitions#ORDRE|Ordre]], [[Inquisitions#PERSEVERANCE|Persévérance]], [[Inquisitions#REPOSETERNEL|Repos éternel]], [[Inquisitions#SEDITION|Sédition]], [[Inquisitions#VERITE|Vérité]]}{s:cs}{s:ISG}Iomédae est la déesse du courage, de la justice et de l'honneur. Ayant servit de héraut à Aroden, elle a hérité de nombreux disciples du Dernier Azlant à sa mort, et continue d'épouser ses idées d'honneur et de droiture dans la défense du bien et la lutte contre le mal.
...
**[[Sentinelle]] :**
: **1.** ***Chevalier vertueux (Mag).*** *[[bénédiction darme|bénédiction d'arme]]* 3/jour, *[[force de taureau]]* 2/jour ou *[[panoplie magique]]* 1/jour.
: **2.** ***Châtiment vertueux (Sur).*** Si le personnage possède la capacité de classe [[Paladin#CHATIMENTDUMAL|châtiment du Mal]], il gagne une utilisation quotidienne supplémentaire de cette capacité. Il ajoute ses niveaux de [[sentinelle]] à ses niveaux de [[paladin]] lorsqu'il calcule les dégâts supplémentaires infligés par son châtiment. Si le personnage réussit à infliger des dégâts avec son châtiment, sa cible doit réussir un jet de [[Volonté]] (DD = 10 + le modificateur de [[Charisme]] du personnage + la moitié de son nombre de [[DV]]) ou être [[étourdi|étourdie]] pendant 1 round, plus un round par tranche de 4 [[DV|Dés de vie]] du personnage (maximum 6 rounds). Une fois qu'une cible a réussit un jet de sauvegarde contre cet effet d'étourdissement, elle est immunisée contre l'effet d'étourdissement du châtiment du personnage pendant 24 heures.

: Si le personnage ne possède pas la capacité de classe [[Paladin#CHATIMENTDUMAL|châtiment du Mal]], il peut, par une [[action libre]], désigner un [[type Extérieur|extérieur]] de sous-type [[sous-type Mal|Mal]] ou un [[dragon]] d'alignement Mauvais qu'il a l'intention de vaincre. Contre cette cible, le personnage bénéficie d'un bonus de sainteté de +2 aux [[jet dattaque|jets d'attaque]] et d'un bonus de sainteté égal à son niveau de [[sentinelle]] aux [[Valeurs de combat#DEGATS|jets de dégâts]]. Ces bonus persistent jusqu'à la mort de la cible ou jusqu'à ce que le personnage utilise à nouveau cette capacité, selon ce qui arrive en premier. Si le personnage désigne une cible inappropriée, la capacité est gâchée. Le personnage peut utiliser cette capacité un nombre de fois par jour égal à son modificateur de [[Charisme]] (minimum 1).
