---
Name: Pathfinder-RPG.AdM-sorts-classe-temporaire
Title: AdM-sorts-classe-temporaire
LastModified: 2012-10-11 22:59
Categories:
- Art de la Magie
---
...
- ***[[Résistance à lâge mineure|Résistance à l'âge mineure]]*** *(AdM)*. Ignore les malus de l'âge moyen.
...
- ***[[Résistance à lâge|Résistance à l'âge]]*** *(AdM)*. Ignore les malus de l'âge avancé.
- ***[[Simulacre de vie supérieur]]*** *(AdM)*. Gagne 2d10 points de vie temporaire + 1/niveau.
...
- ***[[Résistance à lâge supérieure|Résistance à l'âge supérieure]]*** *(AdM)*.  Ignore les malus de l'âge vénérable.
...
- ***[[Panoplie du champion]]*** *(AdM)*. Une armure ou un bouclier reçoit un bonus d'altération de +1 par tranche de 4 niveaux.
...
- ***[[Corde déchardes|Corde d'échardes]]*** *(AdM)*. La représentation inflige 2d6 points de dégâts perforants.
...
- ***[[Jeunesse apparente]]*** *(AdM)*. La cible semble plus jeune.
- ***[[Jouer dun instrument|Jouer d'un instrument]]*** *(AdM)*. Le personnage joue d'un instrument comme s'il avait appris.

#### Niveau 2
- ***[[Allegro]]*** *(AdM)*. Rapidité pendant la représentation bardique.
...
- ***[[De la soie à lacier|De la soie à l'acier]]*** *(AdM)*. Change une écharpe en bouclier ou en fouet.
- ***[[Déguisement fantomatique]]*** *(AdM)*. La cible ressemble à son propre fantôme.
- ***[[Déguiser autrui]]*** *(AdM)*. Comme déguisement mais affecte un tiers.
- ***[[Dragon dartifice|Dragon d'artifice]]*** *(AdM)*. Crée un dragon en feu d'artifice/niveau.
...
- ***[[Hurlement perçant]]*** *(AdM)*. La cible est chancelante à cause d'un son douloureux.
...
#### Niveau 3
- ***[[Accompagnement exquis]]*** *(AdM)*. L'instrument maintient la représentation bardique au profit du personnage.
- ***[[Chagrin écrasant]]*** *(AdM)*. La cible attristée ne peut pas faire d'action et n'a plus son bonus de Dex.
- ***[[Chœur hanté]]*** *(AdM)*. Des esprits infligent des souffrances aux auditeurs.
...
#### Niveau 4
- ***[[Danse des cent coupures]]*** *(AdM)*. Bonus de +1/3 niveaux au combat.
- ***[[Écholocalisation]]*** *(AdM)*. Les sens radars du personnage lui donnent la vision aveugle à 12 mètres.
- ***[[Estoc sonore]]*** *(AdM)*. Le bruit éloigne la cible.
- ***[[Hébétement de groupe]]*** *(AdM)*. Comme  hébétement mais sur plusieurs créatures.
- ***[[Hurlement primitif]]*** *(AdM)*. Libère des effets d'enchantement et de paralysie.
- ***[[Mépris absolu]]*** *(AdM)*. L'attitude de la cible empire de deux crans.
- ***[[Mur de son]]*** *(AdM)*. Mur de son qui dévie et blesse les créatures.
- ***[[Pas de lombre|Pas de l'ombre]]*** *(AdM)*. Téléportation d'une ombre à une autre.
- ***[[Pulsion de jalousie]]*** *(AdM)*. La cible vole ou désarme autrui.
- ***[[Représentation de virtuose]]*** *(AdM)*. Commence une seconde représentation bardique alors que la première se prolonge.
- ***[[Sérénité]]*** *(AdM)*. Sentiment paisible qui blesse les créatures violentes.

#### Niveau 5
- ***[[Barde dombre|Barde d'ombre]]*** *(AdM)*. Clone d'ombre qui commence une représentation bardique.
...
#### Niveau 6
- ***[[Danse des mille coupures]]*** *(AdM)*. Comme  danse des cent coupures mais bénéficie de rapidité.
- ***[[Présence écrasante]]*** *(AdM)*. Les créatures s'inclinent devant le personnage comme devant un dieu.
- ***[[Vagues dextase|Vagues d'extase]]*** *(AdM)*. Les créatures sont étourdies et chancelantes de plaisir.

### SORTS DE CONJURATEUR
#### Niveau 1
...
- ***[[Restauration deidolon mineure|Restauration d'eidolon mineure]]*** *(AdM)*.  Restauration partielle pour un eidolon.
...
- ***[[Pluie de grenouilles]]*** *(AdM)*. Convoque une nuée de grenouilles empoisonnées.
- ***[[Possession de marionnette]]*** *(AdM)*. Comme possession mais limité à la ligne de mire.
- ***[[Restauration deidolon|Restauration d'eidolon]]*** *(AdM)*. Restauration pour un eidolon.
- ***[[Singes fous]]*** *(AdM)*. Convoque une nuée de singes espiègles.
...
- ***[[Création de demi-plan mineur]]*** *(AdM)*. Création d'un demi-plan.
- ***[[Téléportation par cristal de glace]]*** *(AdM)*. La cible est gelée puis téléportée.

#### Niveau 6
- ***[[Aire de laigle|Aire de l'aigle]]*** *(AdM)*. Convoque 1 aigle géant/3 niveaux.
- ***[[Création de demi-plan]]*** *(AdM)*. Comme création de demi-plan mineure mais plus grand et avec des caractéristiques planaires.

### SORTS DE DRUIDE
#### Niveau 1
- ***[[Convocation dalliés mineur|Convocation d'alliés mineur]]*** *(AdM)*. Convoque 1d3 animaux TP.
...
- ***[[Forme de vermine I]]*** *(AdM)*. Prend la forme et les pouvoirs de vermine P ou M.
- ***[[Infestation fongique]]*** *(AdM)*. La cible saigne quand on l'attaque.
- ***[[Invasion dorties|Invasion d'orties]]*** *(AdM)*. Une explosion inflige 3d6 points de dégâts et 1d6 d'acide.
- ***[[Pluie de grenouilles]]*** *(AdM)*. Convoque une nuée de grenouilles empoisonnées.
- ***[[Singes fous]]*** *(AdM)*. Convoque une nuée de singes espiègles.
...
#### Niveau 8
- ***[[Atavisme de groupe]]*** *(AdM)*. 1 animal/niveau gagne l'archétype évolué.
- ***[[Brume sanglante]]*** *(AdM)*. La brume cause un affaiblissement de Sagesse et déclenche la rage.

#### Niveau 9
- ***[[Convocation de froghémoth]]*** *(AdM)*. Convoque un froghémoth.
- ***[[Convocation de ver vénérable]]*** *(AdM)*. Convoque un vert pourpre géant.
...
- ***[[Altération vocale]]*** *(AdM)*. Déguise la voix.
- ***[[Anticipation du danger]]*** *(AdM)*. La cible gagne un bonus à un test d'initiative.
- ***[[Arme dombre|Arme d'ombre]]*** *(AdM)*. Crée une arme de maître quasi réelle.
...
- ***[[Hurlement dagonie|Hurlement d'agonie]]*** *(AdM)*. Une douleur à hurler limite les actions de la cible.
- ***[[Innombrables yeux]]*** *(AdM)*. Des yeux supplémentaires donnent la vision à 360°.
- ***[[Physique monstrueux I]]*** *(AdM)*. Prend la forme et les pouvoirs d'humanoïdes monstrueux P ou M.
- ***[[Pluie de grenouilles]]*** *(AdM)*. Convoque une nuée de grenouilles empoisonnées.
...
- ***[[Estoc sonore]]*** *(AdM)*. Le bruit éloigne la cible.
- ***[[Forme de vermine II]]*** *(AdM)*. Prend la forme et les pouvoirs d'une vermine TP ou G.
- ***[[Jet dacide|Jet d'acide]]*** *(AdM)*. 1d6 points de dégâts d'acide/niveau plus 1 round d'acide.
- ***[[Malédiction de dégoût]]*** *(AdM)*. Cible fiévreuse quand elle voit le déclencheur.
- ***[[Mur de son]]*** *(AdM)*. Mur de son qui dévie et blesse les créatures.
- ***[[Narcissisme suffisant]]*** *(AdM)*. La cible est distraite par sa propre personne.
- ***[[Physique monstrueux III]]*** *(AdM)*. Prend la forme et les pouvoirs d'humanoïdes monstrueux de taille Min ou TG.
- ***[[Porte-peste]]*** *(AdM)*. Les attaques de la cible transmettent la fièvre des marais.
- ***[[Possession dobjet|Possession d'objet]]*** *(AdM)*. Possède et anime un objet.
...
- ***[[Retardement de la douleur]]*** *(AdM)*. Ignore la douleur pendant 1 heure/niveau.
- ***[[Sens aiguisés]]*** *(AdM)*. Bonus aux tests de Perception.
- ***[[Surmonter laffliction|Surmonter l'affliction]]*** *(AdM)*. Supprime temporairement une condition.
...
- ***[[Hébétement de groupe]]*** *(AdM)*. Comme  hébétement mais sur plusieurs créatures.
- ***[[Infestation de vers]]*** *(AdM)*. Des vers infligent des dégâts et un affaiblissement de Dex.
- ***[[Interrogatoire supérieur]]*** *(AdM)*. Comme  interrogatoire mais avec plus de douleur et de questions.
- ***[[Lien des esprits combatifs]]*** *(AdM)*. Le personnage et un allié gagnent un bonus à l'attaque et à la CA.
- ***[[Malédiction de négation magique]]*** *(AdM)*. La cible est affectée par la plaie magique négation.
- ***[[Menottes scellées]]*** *(AdM)*. La cible est limitée à un certain périmètre.
- ***[[Réprobation]]*** *(AdM)*. Les membres de la religion du personnage fuient la cible marquée.
...
- ***[[Poursuite divine]]*** *(AdM)*. Gagne un des types de déplacement de la proie.
- ***[[Rendre un jugement supérieur]]*** *(AdM)*. Un allié bénéficie de tous les jugements.
...
- ***[[ouverturefermeture|ouverture/fermeture]]***
- ***[[prestidigitation]]***
- ***[[rayon de givre]]***
- ***[[lecture de la magie]]***
- ***[[étincelle]]***
...
- ***[[invisibilité]]***
- ***[[lévitation]]***
- ***[[Modification dapparence|modification d'apparence]]***
- ***[[nappe de brouillard]]***
...
- ***[[Poing de force]]*** *(AdM)*. La cible reçoit 1d4 points de dégâts de force par niveau et elle est repoussée.
- ***[[rapidité]]***
- ***[[Rayon dépuisement|rayon d'épuisement]]***
...
- ***[[tempête de grêle]]***
- ***[[tentacules noirs]]***
- ***[[Vol darcane|Vol d'arcane]]*** *(AdM)*. La dissipation transmet un effet au personnage.
...
- ***[[dissipation suprême]]***
- ***[[double illusoire]]***
- ***[[Endurance de lours de groupe|endurance de l'ours de groupe]]***
- ***[[flamme contagieuse]]***
...
- ***[[Diagnostic]]*** *(AdM)*. Détecte et identifie les maladies.
- ***[[Monture de guerre]]*** *(AdM)*. Un animal devient entraîné au combat.
- ***[[Mot de fermeté]]*** *(AdM)*. Les alliés relancent un jet de sauvegarde contre le charme ou la peur.
- ***[[Sanctification de cadavre]]*** *(AdM)*. Empêche un cadavre de devenir mort-vivant.

#### Niveau 2
- ***[[Bouclier sacré]]*** *(AdM)*. Accorde la protection du bouclier du personnage à un tiers.
- ***[[Flèche de loi]]*** *(AdM)*. Blesse et hébète peut-être les créatures Chaotiques.
- ***[[Panoplie du champion]]*** *(AdM)*. Une armure ou un bouclier reçoit un bonus d'altération de +1 par tranche de 4 niveaux.


#### Niveau 3
- ***[[Aura darchon|Aura d'archon]]*** *(AdM)*. L'aura pénalise l'attaque et la CA des ennemis.
- ***[[Bénédiction de la taupe]]*** *(AdM)*. 1 allié/niveau gagne vision dans le noir et +2 Discrétion.
- ***[[Lame de triomphe éclatant]]*** *(AdM)*. L'arme liée devient spectrale.
...
- ***[[Allié compatissant]]*** *(AdM)*. La cible est obligée d'aider un allié blessé.
- ***[[Animation des morts mineure]]*** *(AdM)*. Crée un squelette ou un zombi.
- ***[[Carreau de peur]]*** *(AdM)*. Blesse et hébète peut-être les créatures Bonnes.
- ***[[Contact défigurant]]*** *(AdM)*. La cible est défigurée.
- ***[[Éclat du chaos]]*** *(AdM)*. Blesse et hébète peut-être les créatures Loyales.
- ***[[Flèche de loi]]*** *(AdM)*. Blesse et hébète peut-être les créatures Chaotiques.
- ***[[Imprégner daura|Imprégner d'aura]]*** *(AdM)*. La cible imite l'aura du prêtre.
- ***[[Lance de pureté]]*** *(AdM)*.  Blesse et hébète peut-être les créatures mauvaises.
- ***[[Pénombre protectrice]]*** *(AdM)*. L'ombre protège la cible contre la lumière.
- ***[[Retardement de la douleur]]*** *(AdM)*. Ignore la douleur pendant 1 heure/niveau.
- ***[[Sang bouillant]]*** *(AdM)*. La cible reçoit des dégâts de feu, les orques gagnent +2 Force.
- ***[[Surmonter laffliction|Surmonter l'affliction]]*** *(AdM)*. Supprime temporairement une condition.
...
- ***[[Infestation de vers]]*** *(AdM)*. Des vers infligent des dégâts et un affaiblissement de Dex.
- ***[[Porte-peste]]*** *(AdM)*. Les attaques de la cible transmettent la fièvre des marais.
- ***[[Réceptacle de loracle|Réceptacle de l'oracle]]*** (oracles seulement). La cible bénéficie des avantages de la malédiction de l'oracle.
- ***[[Symbole de lenteur]]*** *(AdM)*. Déclenche une rune qui ralentit les créatures.
- ***[[Symbole de révélation]]*** *(AdM)*. Déclenche un symbole qui révèle les illusions.
- ***[[Terrible remord]]*** *(AdM)*. La créature est obligée de se blesser.
...
#### Niveau 3
- ***[[Bénédiction de la taupe]]*** *(AdM)*. 1 allié/niveau gagne vision dans le noir et +2 Discrétion.
- ***[[Creusement]]*** *(AdM)*. La cible gagne une vitesse de creusement de 4,50 m.
- ***[[Vents capricieux]]*** *(AdM)*. Mur de vent qui bloque des attaques particulières.
...
- ***[[Cheveux étrangleurs]]*** *(AdM)*. Les cheveux s'animent et sont capables d'agripper quelqu'un.
- ***[[Crachat venimeux]]*** *(AdM)*. Crache du venin de vipère noire aveuglant.
- ***[[Crâne ricanant]]*** *(AdM)*. Un crâne agit comme une bouche magique, les auditeurs sont secoués.
- ***[[Déformation douloureuse]]*** *(AdM)*. La cible subit un affaiblissement de Dex et de Con.
- ***[[Engouement téméraire]]*** *(AdM)*. La cible est obligée de rester à côté d'une autre.
- ***[[Éruption de pustules]]*** *(AdM)*. Des bubons acides explosent quand le personnage est attaqué.
- ***[[Étrange fièvre]]*** *(AdM)*. La cible est atteinte de la plaie étrange fièvre.
...
- ***[[Caresse vaseuse]]*** *(AdM)*. Le contact infeste la cible de vase verte.
- ***[[Chevaucher les vagues]]*** *(AdM)*. La cible peut respirer sous l'eau et nager.
- ***[[Forme de vermine II]]*** *(AdM)*. Comme forme de vermine I mais TP ou G.
- ***[[Fusion avec le familier]]*** *(AdM)*. Possession du familier.
- ***[[Hébétement de groupe]]*** *(AdM)*. Comme  hébétement mais sur plusieurs créatures.
- ***[[Infestation de vers]]*** *(AdM)*. Des vers infligent des dégâts et un affaiblissement de Dex.
- ***[[Malédiction de négation magique]]*** *(AdM)*. La cible est affectée par la plaie magique de négation.
- ***[[Manteau de guêpes]]*** *(AdM)*. Une nuée de guêpes défend ou porte le personnage.
- ***[[Pas de lombre|Pas de l'ombre]]*** *(AdM)*. Téléportation d'une ombre à une autre.
- ***[[Résistance à lâge mineure|Résistance à l'âge mineure]]*** *(AdM)*. Ignore les malus de l'âge moyen.
- ***[[Simulacre de vie supérieur]]*** *(AdM)*. Gagne 2d10 points de vie temporaire + 1/niveau.
- ***[[Symbole de lenteur]]*** *(AdM)*. Déclenche une rune qui ralentit les créatures.
