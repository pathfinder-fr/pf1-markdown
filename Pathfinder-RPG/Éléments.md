---
Name: Pathfinder-RPG.Éléments
Title: Les éléments du cinétiste
LastModified: 2024-10-03 14:53
Categories:
- Src Aventures occultes
---

{s:Menuclassesoccultes}Un [[cinétiste]] peut choisir les éléments de la liste suivante. Les [[Cinétiste#INJECTION|talents sauvages d’injection]] sont indiqués par un obèle (†) ; tous les autres talents sauvages des listes ci-dessous sont des [[Cinétiste#TALENTSAUVAGEUTILITAIRE|talents sauvages utilitaires]].

{s:AO}{s:Reference|AIR}
### Air
...
{s:OO}{s:Reference|VIDE}
### Vide
{s:cs}Comme l'éther, le vide se forme où l'énergie élémentaire rencontre un autre matériau, dans ce cas la substance du Plan de l'Énergie négative. Les chaocinétistes commandent cette étrange force qui dans certains aspects rappelle la manipulation de l'éther.
