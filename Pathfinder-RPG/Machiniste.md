...
{s:BDTexte|*Source : [[Bestiaire 5 (contenu)|Bestiaire 5 p.223]]*}
{s:BDTexte|**PX** 1 200}
{s:BDTexte|[[type Créature artificielle|Créature artificielle]] ([[sous-type robot|robot]]) de taille M, N}
{s:BDTexte|**Init** +1 ; **Sens** [[Vision dans le noir (capacité)|vision dans le noir]] à 18 m, [[Vision nocturne (capacité)|vision nocturne]] ; [[Perception]] +8}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 18, contact 11, pris au dépourvu 17 (Dex +1, naturelle +7)}
{s:BDTexte|**pv** 42 (4d10+20)}
{s:BDTexte|**Réf** +2, **Vig** +1, **Vol** +2}
{s:BDTexte|**Capacités défensives** [[Solidité (capacité)|solidité]] 5 ; **Immunités** [[Traits des créatures artificielles (capacité)|traits des créatures artificielles]]}
...
{s:BDTexte|**Compétences** [[Artisanat]] (n’importe lequel) +7, [[Perception]] +8, [[Profession]] (n’importe laquelle) +8, [[Psychologie]] +8, [[Sabotage]] +8}
...
{s:BDTexte|**Nanites réparatrices (Ext).** Les nanites d’un machiniste le soignent et, à chaque heure qui passe, elles lui font regagner un nombre de points de vie égal à sa quantité de [[DV|dés de vie]] (soit 4 points de vie par heure pour la plupart des machinistes). Une fois par jour, un machiniste peut, par une [[action complexe]], réparer 4d6 points de dégâts subis par lui ou un autre robot qu’il touche.}

</div></td>
<td><div><ul style="margin: 0 0 -10 0;margin-top: 6px;margin-bottom: 12px;"><li>***Voir la description des [[Robots]].***</li></ul>*Cette créature artificielle ressemble à une armure lourde complète de laiton bruni, avec un orbe brillant en guise d’oeil.*
