---
Name: Pathfinder-RPG.Disjonction
Title: Disjonction
LastModified: 2022-06-12 14:49
Categories:
- Règle officielle
- Sort
- Sort magicien 9
...
*Disjonction* a également 1 % de chance par [[NLS|niveau de lanceur de sorts]] de faire disparaître une *[[zone dantimagie|zone d’antimagie]]*. Si la *[[zone dantimagie|zone d’antimagie]]* résiste à la *disjonction*, les objets qui se trouvent en son sein ne sont pas affectés par le sort.

Il est également possible de cibler ce sort sur un unique objet. Celui-ci bénéficie d’un jet de [[Volonté]] avec un malus de -5 pour éviter d’être détruit de manière permanente. Même les [[artefacts]] peuvent être affectés par une *disjonction*, mais le sort n’a que 1 % de chances par [[NLS|niveau de lanceur de sorts]] d’être efficace. Si c’est le cas, l’enchantement de l’[[artefacts|artefact]] se désagrège et celui-ci est détruit (sans [[jet de sauvegarde]]). Lorsqu’un [[artefacts|artefact]] est ainsi détruit, le personnage doit réussir un jet de [[Volonté]] ([[DD]] 25) sous peine de perdre à tout jamais ses capacités de lanceur de sorts. Aucun sort de mortel, pas même *[[souhait]]* ou *[[miracle]]*, ne peut alors lui rendre l’usage de la magie. La destruction d’un [[artefacts|artéfact]] est une tâche dangereuse, qui a 95 % de chances d’attirer l’attention d’une créature puissante liée à l’objet ou intéressée par lui.

### Mythique
{s:CMy}
La durée s’élève à 10 minutes par [[NLS|niveau de lanceur de sorts]]. Les chances de détruire une zone d’antimagie s’élèvent à 2% par [[NLS|niveau de lanceur de sorts]].
