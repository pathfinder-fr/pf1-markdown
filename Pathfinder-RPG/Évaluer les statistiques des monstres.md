...
<table CLASS="tablo centre autoalt" WIDTH="80%">
  <caption>{s:Reference|STATMONSTRESMYTHIQUEPARFP}Statistiques des monstres par FP</caption>
  <tr CLASS="titre">
    <td ROWSPAN="2">FP</td>
    <td ROWSPAN="2">pv</td>
    <td ROWSPAN="2">CA</td>
    <td COLSPAN="2" CLASS="avecsoustitre">Attaque</td>
    <td COLSPAN="2" CLASS="avecsoustitre">Dégâts moyens</td>
    <td COLSPAN="2" CLASS="avecsoustitre">DD du pouvoir</td>
    <td COLSPAN="2" CLASS="avecsoustitre">JdS</td>
  </tr>
  <tr CLASS="soustitre">
    <td>supérieure</td>
    <td>inférieure</td>
