---
Name: Pathfinder-RPG.Connaissances magiques étendues
Title: Connaissances magiques étendues
LastModified: 2013-08-24 18:40
Categories:
- Don
...
{s:apg}*Les recherches du personnage lui ont révélé de nouveaux sorts.*

**Conditions.** [NLS](./NLS.md) 1, voir Spécial.
...
**Spécial.** Le personnage ne peut choisir ce don que s’il possède des niveaux dans une classe de lanceur de sorts dont la liste des sorts connus est limitée (comme le [barde](./Barde.md), l’[ensorceleur](./Ensorceleur.md) ou l’[oracle](./Oracle.md)). Le personnage peut acquérir ce don plusieurs fois.
