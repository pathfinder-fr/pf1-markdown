...
{s:FAQ|***[[FAQ- Manuel des joueurs (Dons et compétences)#4|→]] Attaque éclair : Puis-je utiliser Attaque éclair pour porter une attaque depuis la case d’un allié ?***
...
**Conditions.** [[Dextérité|Dex]] 13, [[Esquive]], [[Souplesse du serpent]], [[BBA|bonus de base à l’attaque]] de +4.

**Avantage.** Par une action complexe, le personnage peut se déplacer à sa [[vitesse de déplacement|vitesse de base]] et faire une attaque de corps à corps sans provoquer d’[[attaque dopportunité|attaque d’opportunité]] de la part de sa cible. Il peut se déplacer avant et après l’attaque, mais il doit parcourir au moins trois mètres avant d’attaquer et la distance parcourue au total ne doit pas dépasser sa [[vitesse de déplacement|vitesse de base]]. Le personnage ne peut pas utiliser ce don pour attaquer un ennemi qui se trouve sur une case adjacente à la sienne au début du tour.
