---
Name: Pathfinder-RPG.Domaine du Feu
Title: Domaine du Feu
LastModified: 2024-12-03 23:46
Categories:
- Classe
- Domaine
---
...
**Mur de cendres (Sur).** *(remplace résistance au feu)* Au niveau 8, le personnage peut créer un mur de cendres tourbillonnantes haut de 6 m et long de 3 m par niveau de [[prêtre]], et ce n’importe où dans un rayon de 30 m autour de lui. Le mur de cendres empêche toute visibilité et les créatures qui veulent le traverser doivent réussir un [[jet de sauvegarde|jet de Vigueur]] ou être [[aveuglé|aveuglées]] pendant 1d4 [[round|rounds]]. Il dévoile également les créatures invisibles situées à l’intérieur ou dans l’espace adjacent. Elles redeviennent cependant [[invisible|invisibles]] si elles s’éloignent. Le [[prêtre]] peut utiliser ce pouvoir un nombre de minutes par jour égal à son niveau de [[prêtre]]. Ces minutes ne doivent pas forcément être consécutives.
</div>
...
{s:racial|Gobelin (race)|gobelins|Illustrations/PNJ/Gobelin.jpg}**Appel du feu (Sur).** *(remplace trait de feu)* Par une [[action simple]], le personnage peut tendre la main vers une source de feu visible située à 18 mètres (12 {s:c}) ou moins pour lui faire signe d’approcher. Ceci crée un fin ruban de flammes qui s’approche du personnage en ligne droite (par les airs s'il le faut) depuis la source. Une créature située directement sur le chemin du ruban de feu subit 1d4 points de dégâts de feu ; un [[jds|jet de sauvegarde]] de [[Réflexes]] réussi ([[DD]] 10 + 1/2 niveau de prêtre du personnage + son modificateur de [[Sagesse]]) annule ces dégâts. Lorsque le ruban de feu atteint la main du personnage, il s’éteint ou enflamme un objet inflammable qu’il tient en main. Chaque jour, le personnage peut utiliser ce pouvoir un nombre de fois égal à 3 + son modificateur de [[Sagesse]].
</div>
</td></tr></table>
...
|- CLASS="titre"
| WIDTH="4%" | Niv
| WIDTH="26%" | Domaine du Feu
| Sous-domaine des Cendres || Sous-domaine de la Fumée || Sous-domaine des Incendies
|- CLASS="premier"
| 1er || *[[mains brûlantes]]* || *idem* || *idem* || *idem*
|-
| 2e || *[[flammes]]* || *idem* || *[[pyrotechnie]]* || *[[sphère de feu]]*
|-
| 3e || *[[boule de feu]]* || *idem* || *[[nuage nauséabond]]* || *idem*
|-
| 4e || *[[mur de feu]]* || *idem* || *idem* || *idem*
|-
| 5e || *[[bouclier de feu]]* || *idem* || *idem* || *[[colonne de feu]]*
|-
| 6e || *[[germes de feu]]* || *idem* || *idem* || *idem*
|-
| 7e || *[[corps élémentaire IV]]*  
(créature de Feu seulement) || *[[désintégration]]* || *idem* || *[[boule de feu à retardement]]*
|-
| 8e || *[[nuage incendiaire]]* || *idem* || *idem* || *idem*
|-
| 9e || *[[nuée délémentaires|nuée d’élémentaires]]* (lancé comme un sort du Feu seulement) || *[[corps enflammé]]* || *idem* || *idem*
|}
