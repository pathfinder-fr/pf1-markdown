---
Name: Pathfinder-RPG.Réceptacle des âmes
Title: Réceptacle des âmes
LastModified: 2017-06-25 14:26
Categories:
- Bestiaire 4
- Monstre
- Règles officielles
...
<div class="BD">
{s:BDTitre|Réceptacle des âmes|FP 12}
...
- **Organisation** solitaire ou atelier (1 et 2-8 autres créatures artificielles)
- **Trésor** standard (dague de maître, autres trésors)
(((Pouvoirs spéciaux)))
- **Esprit définitif (Ext)**. Un réceptacle des âmes ne peut jamais changer les sorts qu’il connait ou qu’il a préparés.
- **Focaliseur d’âme (Sur)**. L’âme intégrée au réceptacle vit à l’intérieur d’une pierre précieuse, elle-même fixée à l’intérieur de sa poitrine. Tant que ce focaliseur d’âme demeure intact, il peut être utilisé pour animer un autre réceptacle, au même coût que celui indiqué pour créer un nouveau réceptacle des âmes. Le nouveau réceptacle conserve sa personnalité et ses souvenirs. Un focaliseur d’âmes possède une solidité de 8, 12 points de résistance et un DD pour le briser de 20.
- **Sorts**. Un réceptacle des âmes lance des sorts comme un prêtre, une sorcière ou un magicien de niveau 12, mais il ne gagne aucune autre capacité de classe.
- ** Vulnérable aux effets mentaux (Ext)**. À la différence de la plupart des créatures artificielles, un réceptacle des âmes n’est pas immunisé aux effets mentaux.
