...
<div class="BD">
{s:BDTitre|Worg|FP/DV 2}
{s:BDTexte|**Init** +2 ; **Perception** +10 (vision dans le noir à 18 m, vision nocturne)}
{s:BDTexte|**Taille** M ; **VD** 15 m}
...
{s:BDTexte|**PX** 600 ; créature magique NM}
</div>
</td><td><div>Le worg est facile à créer puisqu’il s’agit d’un monstre simple.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Mastodonte|FP/DV 9}
{s:BDTexte|**Init** -1 ; **Perception** +17 (vision nocturne)}
{s:BDTexte|**Taille** TG (4,50 m) ; **VD** 12 m}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 25 (contact 13, pris au dépourvu 21) ; **Réf** +12, **Vig** +12, **Vol** +8 ; **DMD** 30 (33 contre la bousculade)}
{s:BDTexte|**pv** 151}
{s:BDSousTitre|Attaque}
{s:BDTexte|**Corps à corps** corne (allonge 4,50 m), +17 (2d8+12) et coup (allonge 4,50 m), +17 (2d6+15)}
{s:BDTexte|**Options d'attaque** science de la manoeuvre offensive (bousculade) ; **BMO** +21 (+25 pour la bousculade)}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**For** +9, **Dex** -1, **Con** +4, **Int** -4}
{s:BDTexte|**PX** 6 400 ; animal N}
</div>
</td><td><div>Grande créature un peu bête, le mastodonte ne requiert que quelques ajustements malgré son FP élevé.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Griffon|FP/DV 4}
{s:BDTexte|**Init** +2 ; **Perception** +12 (odorat, vision dans le noir à 18 m, vision nocturne)}
{s:BDTexte|**Taille** G (3 m) ; **VD** 9 m, vol 24 m (moyenne)}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 19 (contact 11, pris au dépourvu 15) ; **Réf** +7, **Vig** +7, **Vol** +3 ; **DMD** 21}
{s:BDTexte|**pv** 44}
{s:BDSousTitre|Attaque}
{s:BDTexte|**Corps à corps** morsure, +10 (1d6+10) et 2 serres, +5 (1d6+4)}
{s:BDTexte|**Options d'attaque** (DD 13) bond, pattes arrière ; **BMO** +12}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**For** +4, **Dex** +2, **Con** +2, **Int** -3 ; Acrobaties +9, **Vol** +9}
{s:BDTexte|**PX** 1 200 ; créature magique N}
</div>
</td><td><div>Le griffon est un majestueux chasseur des airs dont les seuls ajustements notables viennent de son type et de sa taille.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Guerrier gobelin|FP/DV 1/2}
{s:BDTexte|**Init** +7 ; **Perception** +5 (vision dans le noir à 18 m)}
{s:BDTexte|**Taille** P ; **VD** 9 m}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 15 (contact 14, pris au dépourvu 13) ; **Réf** +2, **Vig** +2, **Vol** +0 ; **DMD** 12}
{s:BDTexte|**pv** 11}
{s:BDSousTitre|Attaque}
{s:BDTexte|**Corps à corps** épée courte, +3 (1d4+2/19-20)}
{s:BDTexte|**À distance** arc court (portée 18 m), +3 (1d4+2/×3)}
{s:BDTexte|**BMO** +1}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**For** +2, **Dex** +3, **Con** +1, **Cha** -2 ; Discrétion +8, Équitation +8, Natation +5}
{s:BDTexte|**PX** 200 ; humanoïde (gobelinoïde) guerrier 1 CM}
</div>
</td><td><div>Le guerrier gobelin fait un sbire parfait pour n’importe quel grand seigneur, à condition qu’il ne réduise pas sa forteresse en cendres.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Minotaure zombi|FP/DV 1}
{s:BDTexte|**Init** +0 ; **Perception** +6 (vision dans le noir à 18 m)}
{s:BDTexte|**Taille** G (3 m) ; **VD** 9 m}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 14 (contact 11, pris au dépourvu 13) ; **Réf** +2, **Vig** +2, **Vol** +3 ; **DMD** 15}
{s:BDTexte|**pv** 19 ; RD 5/tranchant ; Immunité immunités des morts-vivants}
{s:BDTexte|**Faiblesse** chancelant}
{s:BDSousTitre|Attaque}
{s:BDTexte|**Corps à corps** corne (allonge 3 m), +2 (1d6+4) ou coup (allonge 3 m), +2 (1d8+3)}
{s:BDTexte|**Option d'attaque** charge puissante ; **BMO** +4}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**For** +3, **Con** —, **Int** —, **Sag** +1, **Cha** +2}
{s:BDTexte|**PX** 400 ; mort-vivant NM}
</div>
</td><td><div>Certains archétypes présentent des modifications compliquées mais l’archétype du zombi est assez simple à appliquer.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Nuée de chauves-souris|FP/DV 2}
{s:BDTexte|**Init** +3 ; **Perception** +10 (perception aveugle à 6 m, vision nocturne)}
{s:BDTexte|**Taille** Min (3 m) ; **VD** 1,50 m, vol 12 m (bonne)}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 16 (contact 16, pris au dépourvu 16) ; **Réf** +5, **Vig** +5, **Vol** +1}
{s:BDTexte|**pv** 22 ; Immunité bousculade, coups critiques, croc-en-jambe, dégâts d’arme, lutte, prise en tenaille, sorts ciblant un nombre spécifique de créatures}
{s:BDTexte|**Faiblesse** +50% des dégâts des effets de zone}
{s:BDTexte|**Options défensives** traits des nuées}
{s:BDSousTitre|Attaque}
{s:BDTexte|**Corps à corps** nuée (toutes les cibles se trouvant dans l’espace occupé par la nuée) qui touche toujours (1d6 plus 1 saignement)}
{s:BDTexte|**Option d'attaque** (DD 11) distraction}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**For** -4, **Dex** +3, **Con** +1, **Int** -4, **Sag** +2 ; Discrétion +10, **Vol** +10}
{s:BDTexte|**PX** 600 ; animal (nuée) N}
</div>
</td><td><div>La nuée de chauves-souris est très simple à créer mais le sous-type de nuée est plus compliqué et accorde des particularités supplémentaires qui distinguent ce monstre de tous les autres.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Diablotin|FP/DV 2}
{s:BDTexte|**Init** +3 ; **Perception** +7 (vision dans le noir à 18 m, vision dans les ténèbres)}
{s:BDTexte|**Taille** TP (75 cm) ; **VD** 6 m, vol 15 m (parfaite)}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 16 (contact 16, pris au dépourvu 10) ; **Réf** +5, **Vig** +1, **Vol** +3 ; **DMD** 14 ; Concentration +4}
{s:BDTexte|**pv** 20 ; Immunité feu, poison ; Résistance acide 10, froid 10}
{s:BDSousTitre|Attaque}
{s:BDTexte|**Corps à corps** dard (allonge 0 m), +6 (1d4+5 plus poison)}
{s:BDTexte|**Pouvoirs magiques** (DD 13 + niveau du sort) 1/jour – suggestion}
{s:BDTexte|**Options d'attaque** (DD 13) poison (type blessure, fréquence 1/round pendant 6 rounds, effet affaiblissement temporaire de 1d2 Dex, guérison 1 réussite) ; **BMO** +2}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**Pouvoirs magiques** utilitaires Constant – détection du Bien, détection de la magie ; à volonté – invisibilité (soi-même uniquement)}
{s:BDTexte|**Options utilitaires** changement de forme (sanglier, araignée géante, rat ou corbeau, forme bestiale I), convocation d’alliés (diablotin, 35%)}
{s:BDTexte|**For** -4, **Dex** +3, **Int** +1, **Cha** +2 ; Acrobaties +10, Bluff +10, Connaissances (mystères) +7, Connaissances (plans) +7, Déguisement +12, Discrétion +10, **Vol** +10 ; télépathie à 30 m}
{s:BDTexte|**PX** 600 ; extérieur (diable, extraplanaire, Loi, Mal) LM}
</div>
</td><td><div>Adversaire plutôt ardu, ce diablotin possède diverses options supplémentaires qui lui permettent de dérouter ses ennemis.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Géant du feu|FP/DV 10}
{s:BDTexte|**Init** +0 ; **Perception** +14 (vision nocturne)}
{s:BDTexte|**Taille** G (3 m) ; **VD** 9 m}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 28 (contact 8, pris au dépourvu 24) ; **Réf** +11, **Vig** +13, **Vol** +9 ; **DMD** 30}
{s:BDTexte|**pv** 143 ; Immunité feu}
...
{s:BDTexte|**BMO** +20}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**For** +7, **Con** +5, **Sag** +3 ; Escalade +18, **Int**imidation +14}
{s:BDTexte|**PX** 9 600 ; humanoïde (géant, feu) LM}
</div>
</td><td><div>Ce monstre est différent de celui présenté dans le Bestiaire mais a le même FP.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Satyre|FP/DV 4}
{s:BDTexte|**Init** +3 ; **Perception** +12 (vision nocturne)}
{s:BDTexte|**Taille** M ; **VD** 12 m}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 17 (contact 10, pris au dépourvu 12) ; **Réf** +5, **Vig** +3, **Vol** +9 ; **DMD** 18}
{s:BDTexte|**pv** 40 ; RD 5/fer froid}
{s:BDSousTitre|Attaque}
{s:BDTexte|**Corps à corps** cornes, +6 (1d6+13)}
{s:BDTexte|**À distance** arc court (portée 18 m), +6 (1d6+10/×3)}
{s:BDTexte|**Pouvoirs magiques** d’attaque (DD 14 + niveau du sort) 1/jour – terreur ; à volonté – charme-personne, sommeil, suggestion}
{s:BDTexte|**Option d'attaque** (DD 15) flûte de pan ; **BMO** +6}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**Option utilitaire** persuasif}
{s:BDTexte|**For** +3, **Sag** +1, **Cha** +4 ; Bluff +12, Diplomatie +9, Discrétion +12, **Int**imidation +9, Représentation (instruments à vent) +12}
{s:BDTexte|**PX** 1 200 ; créature féerique CN}
{s:BDSousTitre|Pouvoirs spéciaux}
{s:BDTexte|**Flûte de pan (Sur).** Le satyre peut jouer des mélodies entêtantes avec sa flûte de pan afin d’affecter par un sort toutes les créatures situées dans un rayon de 18 mètres (Volonté DD 15 pour annuler). Chaque fois qu’il utilise ce pouvoir, le satyre choisit charmepersonne, sommeil, suggestion ou terreur. Les créatures qui réussissent leur jet de sauvegarde ne peuvent pas être affectées par cette même flûte de pan pendant 24 heures.}
</div>
</td><td><div>Avec sa flûte de pan unique, le satyre nécessite un pouvoir sur-mesure qui n’est pas inclus dans les options de monstre.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Explorateur géant du froid|FP/DV 12}
{s:BDTexte|**Init** +0 ; **Perception** +16 (vision nocturne)}
{s:BDTexte|**Taille** G (3 m) ; **VD** 12 m ; Déplacement spécial déplacement facilité (glace)}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 29 (contact 16, pris au dépourvu 22) ; **Réf** +9, **Vig** +13, **Vol** +13 ; **DMD** 33 ; Concentration +17}
{s:BDTexte|**pv** 176 ; Immunité froid}
{s:BDTexte|**Faiblesse** vulnérabilité au feu}
{s:BDTexte|**Option défensive** lancer de rochers}
{s:BDSousTitre|Attaque}
{s:BDTexte|**Corps à corps** lance (allonge 3 m), +21/+16/+11 (2d6+27/×3) ou 2 coups (allonge 3 m), +21 (1d8+27)}
{s:BDTexte|**À distance** rocher (portée 36 m), +15 (1d8+21)}
{s:BDTexte|**BMO** +23}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**Sorts utilitaires** 1/jour – convocation d’alliés naturels VII, forme bestiale IV (animaux uniquement)}
{s:BDTexte|**Option utilitaire** invocation puissante}
{s:BDTexte|**For** +8, **Con** +4, **Sag** +5 ; Connaissances (nature) +20, Escalade +16, **Int**imidation +16, Survie +16}
{s:BDTexte|**PX** 19 200 ; humanoïde (froid, géant) CM}
</div>
</td><td><div>Cette créature a accès à la magie de la nature, un peu comme un druide. Mais il serait incongru de voir un géant du froid tout en muscles changé en lanceur de sorts. Au lieu de cela, ce profil s’appuie sur la gamme de combattant mais puise son inspiration dans les options de la greffe de classe du druide. Ce monstre est censé se battre aux côtés d’un mastodonte (voir page 244) avec lequel il forme une rencontre de FP 13.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Prêtre vampire|FP/DV 11}
{s:BDTexte|**Init** +2 ; **Perception** +19 (vision dans le noir à 18 m)}
{s:BDTexte|**Taille** M ; **VD** 9 m ; Déplacement spécial pattes d’araignée (constant)}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 25 (contact 13, pris au dépourvu 19) ; **Réf** +10, **Vig** +12, **Vol** +14 ; **DMD** 26 ; Concentration +20}
{s:BDTexte|**pv** 103 ; guérison accélérée 5 ; RD 10/argent et magique ; Immunité immunités des morts-vivants ; Résistance électricité 10, froid 10}
...
{s:BDSousTitre|Statistiques}
{s:BDTexte|**Sorts utilitaires** 3/jour – prière, ténèbres ; à volonté – changement de forme (chauve-souris ou loup, forme bestiale II)}
{s:BDTexte|**Options utilitaires** créature des ténèbres, création de rejetons, forme gazeuse}
{s:BDTexte|**For** +8, **Con** —, **Dex** +2, **Int** +1, **Sag** +9, **Cha** +5 ; Bluff +19, Connaissances (religion) +19, Déguisement +15, Discrétion +19, Psychologie +19}
{s:BDTexte|**PX** 12 800 ; mort-vivant (humanoïde altéré) prêtre 10 CM}
</div>
</td><td><div>Alternative à l’ensorceleur vampire du Bestiaire, ce vampire est un prêtre de FP légèrement supérieur.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Ogre mage|FP/DV 8}
{s:BDTexte|**Init** +6 ; **Perception** +13 (vision dans le noir à 18 m, vision nocturne)}
{s:BDTexte|**Taille** G (3 m) ; **VD** 12 m, vol 18 m (bonne)}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 23 (contact 12, pris au dépourvu 18) ; **Réf** +7, **Vig** +11, **Vol** +9 ; **DMD** 27 ; RM 19 ; Concentration +12}
{s:BDTexte|**pv** 110 ; régénération 5 (acide, feu)}
{s:BDSousTitre|Attaque}
{s:BDTexte|**Corps à corps** épée à deux mains (allonge 3 m), +17/+12 (3d6+15/19-20)}
{s:BDTexte|**À distance** arc long composite (portée 33 m), +13/+8 (2d6+12/×3)}
{s:BDTexte|**Pouvoirs magiques** d’attaque (DD 13 + niveau du sort) 1/jour – charme-monstre, cône de froid, sommeil profond}
{s:BDTexte|**BMO** +19}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**Pouvoirs magiques** utilitaires 1/jour – état gazeux ; à volonté – invisibilité, ténèbres ; constant - vol}
{s:BDTexte|**Options utilitaires** changement de forme (humanoïde de taille P, M ou G ; modification d’apparence ou forme de géant I)}
{s:BDTexte|**For** +6, **Dex** +2, **Con** +6, **Int** +2, **Sag** +2, **Cha** +4 ; Art de la magie +13, Bluff +13, Déguisement +23, **Int**imidation +13, Psychologie +13, Utilisation d’objets magiques +13}
{s:BDTexte|**PX** 4 800 ; extérieur (géant, métamorphe, natif, oni) LM}
</div>
</td><td><div>Les oni ogres mages sont des métamorphes perfides qui combinent prouesses martiales et maîtrise magique.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Guenaude noire collectionneuse d’âmes|FP/DV 9}
{s:BDTexte|**Init** +4 ; **Perception** +14 (vision dans le noir à 18 m)}
{s:BDTexte|**Taille** M ; **VD** 9 m ; Déplacement spécial passage dans l’éther (à volonté)}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 21 (contact 12, pris au dépourvu 15) ; **Réf** +9, **Vig** +9, **Vol** +12 ; **DMD** 24 ; RM 24 ; Concentration +12}
{s:BDTexte|**pv** 103 ; RD 10/fer froid et magique ; Immunité charme, feu, froid, sommeil, terreur}
{s:BDSousTitre|Attaque}
{s:BDTexte|**Corps à corps** 2 griffes, +14 (1d4+9) et morsure, +14 (1d6+9)}
{s:BDTexte|**Pouvoirs magiques** d’attaque (DD 16 + niveau du sort) 1/jour –sommeil profond ; à volonté – capture d’âme, projectile magique, rayon affaiblissant}
{s:BDTexte|**Options d'attaque** invasion des rêves, incantation spontanée (convocation de monstres) ; **BMO** +14}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**Pouvoirs magiques** utilitaires 1/jour – porte dimensionnelle ; 3/jour – dissipation de la magie, invisibilité, rapidité, ténèbres ; constant – détection du Bien, détection du Chaos, détection de la Loi, détection de la magie, détection du Mal ; double la durée des tous les sorts d’invocation (convocation)}
{s:BDTexte|**Options utilitaires** changement de forme, marchand d’âmes}
{s:BDTexte|**For** +6, **Dex** +4, **Con** +6, **Int** +4, **Sag** +3, **Cha** +3 ; Art de la magie +14, Bluff +17, Connaissances (plans) +17, Déguisement +27, Diplomatie +14, **Int**imidation +14, Perception +14, Psychologie +14}
{s:BDTexte|**PX** 6 400 ; extérieur (extraplanaire, Mal) NM}
{s:BDSousTitre|Pouvoirs spéciaux}
{s:BDTexte|**Invasion des rêves (Sur).** La guenaude noire peut envahir les rêves d’une créature tout en restant chez elle, sur le plan Éthéré. La créature qu’elle hante ainsi subit un affaiblissement temporaire de 1 point de Constitution quand elle se réveille.}
{s:BDTexte|**Marchand d’âmes (Sur).** Par une action simple, la guenaude noire peut libérer l’une de ses âmes capturées afin que celle-ci combatte à ses côtés ; voir les statistiques de l’âme perdue de la guenaude, ci-dessous.}
</div>

<div class="BD">
{s:BDTitre|Âme perdue de la guenaude noire|FP/DV 9}
{s:BDTexte|**Init** +4 ; **Perception** +14 (vision dans le noir à 18 m)}
{s:BDTexte|**Taille** G (3 m) ; **VD** 9 m, vol 18 m (bonne)}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 25 (contact 15, pris au dépourvu 18) ; **Réf** +12, **Vig** +10, **Vol** +8 ; **DMD** 28}
{s:BDTexte|**pv** 126 ; RD 10/fer froid et magique}
{s:BDSousTitre|Attaque}
{s:BDTexte|**Corps à corps** 4 morsures (allonge 4,50 m), +19 (1d8+6)}
{s:BDTexte|**Option d'attaque** bond ; **BMO** +19}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**For** +7, **Dex** +4, **Con** +3 ; Intimidation +17, **Vol** +14}
{s:BDTexte|**PX** 6 400 ; extérieur (extraplanaire) NM}
</div>
</td><td><div>La guenaude noire collectionneuse d’âmes n’est pas seulement un adversaire redoutable, elle a aussi le bras dangereusement long. Elle peut forcer les âmes capturées à accomplir sa volonté pour accroître sa propre efficacité au combat, ce qui lui permet de profiter de pouvoirs issus de la greffe de classe de l’invocateur.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Général marilith|FP/DV 17}
{s:BDTexte|**Init** +5 ; **Perception** +29 (vision dans le noir à 18 m, vision lucide)}
{s:BDTexte|**Taille** G (3 m) ; **VD** 12 m ; Déplacement spécial téléportation suprême (à volonté, soi-même plus 25 kg d’objets uniquement)}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 34 (contact 20, pris au dépourvu 25) ; **Réf** +18, **Vig** +20, **Vol** +15 ; **DMD** 39 (43 contre l’étreinte, croc-en-jambe impossible) ; RM 28 ; Concentration +25}
...
{s:BDSousTitre|Statistiques}
{s:BDTexte|**Pouvoirs magiques** utilitaires 3/jour – vol}
{s:BDTexte|**Options utilitaires** convocation d’alliés (marilith 20%, nalfeshnie 35% ou 1d4 hézrous 60%), inspiration vaillante, récupération héroïque}
{s:BDTexte|**For** +8, **Dex** +5, **Con** +11, **Int** +5, **Sag** +5, **Cha** +8 ; Bluff +29, Diplomatie +29, **Int**imidation +29, Psychologie +21, Utilisation d’objets magiques +29 ; télépathie à 30 m}
{s:BDTexte|**PX** 102 400 ; extérieur (Chaos, démon, extraplanaire, Mal) CM}
</div>
</td><td><div>Général à six bras des hordes abyssales, la marilith est réputé pour son nombre d’attaques étourdissant. Celle-ci utilise des options personnalisées qui reflètent mieux ses compétences de général.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Dragon bleu vénérable|FP/DV 18}
{s:BDTexte|**Init** +4 ; **Perception** +31 (perception aveugle à 18 m, vision dans le noir à 18 m, vision nocturne)}
{s:BDTexte|**Aura** électricité (3 m, 2d6 électricité), présence terrifiante (90 m, DD 25)}
{s:BDTexte|**Taille** Gig (6 m) ; **VD** 12 m, creusement 6 m, vol 75 m (déplorable, vol stationnaire)}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 37 (contact 11, pris au dépourvu 35) ; **Réf** +18, **Vig** +20, **Vol** +18 ; **DMD** 43 ; RM 29 ; Concentration +23}
{s:BDTexte|**pv** 330 ; RD 15/magique ; Immunité électricité, paralysie, sommeil}
{s:BDTexte|**Sorts défensifs** 1/jour – double illusoire}
{s:BDSousTitre|Attaque}
{s:BDTexte|**Corps à corps** morsure (allonge 6 m), +30 (4d6+18/19-20) et 2 griffes (allonge 4,50 m), +30 (3d6+12) et 2 ailes (allonge 4,50 m), +25 (2d6+6) et coup de queue (allonge 4,50 m), +25 (3d8+18)}
{s:BDTexte|**Sorts d'attaque** (DD 17 + niveau du sort) 1/jour – main impérieuse ; 3/jour – énergie négative, immobilisation de monstre ; à volonté – rapidité}
{s:BDTexte|**Options d'attaque** (DD 27) briseur de défense, frappe critique, souffle (ligne de 36 m, 19d6 électricité) ; **BMO** +36}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**Sorts utilitaires** 3/jour – porte dimensionnelle, terrain hallucinatoire ; à volonté – invisibilité}
{s:BDTexte|**For** +12, **Dex** -2, **Con** +8, **Int** +6, **Sag** +5, **Cha** +5 ; Art de la magie +25, Bluff +25, Connaissances (mystères) +31, **Int**imidation +31, **Vol** +31}
{s:BDTexte|**PX** 153 600 ; dragon (terre) LM}
</div>
</td><td><div>Ce vénérable dragon bleu a des attaques supplémentaires, dont les dégâts sont déterminés d’après la colonne des attaques naturelles pour un FP 18. Bien que ce soit un combattant, il possède des capacités d’incantation réduites (comme s’il était un lanceur de sorts de FP 12-15), avec un DD à mi-chemin entre celui du combattant et celui du lanceur de sorts, illustrant les prouesses magiques naturelles du dragon. Les sorts sont adaptés à ce dragon, qui ne reçoit pas d’avantage supplémentaire s’il les choisit dans l’un des listes de sorts indiquées.
...
<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Diantrefosse|FP/DV 20}
{s:BDTexte|**Init** +9 ; **Perception** +35 (vision dans le noir à 18 m, vision dans les ténèbres)}
{s:BDTexte|**Aura** de terreur (9 m, DD 20)}
{s:BDTexte|**Taille** G (3 m) ; **VD** 12 m, vol 18 m (moyenne) ; Déplacement spécial téléportation suprême (à volonté, soi-même plus 25 kg d’objets uniquement)}
{s:BDSousTitre|Défense}
...
{s:BDSousTitre|Statistiques}
{s:BDTexte|**Options utilitaires** convocation d’alliés (généralement un diable barbelé ou un diable des glaces, 60%)}
{s:BDTexte|**For** +13, **Dex** +9, **Con** +13, **Int** +6, **Sag** +9, **Cha** +6 ; Bluff +28, **Int**imidation +35, Psychologie +28 ; télépathie à 30 m}
{s:BDTexte|**PX** 307 200 ; extérieur (diable, extraplanaire, Loi, Mal) LM}
</div>
</td><td><div>Avec son large éventail de pouvoirs à la fois utiles pour le combat et l’incantation, le diantrefosse reste assez difficile à créer, même avec le système de création de monstres simplifié. Comme ce n’est pas un pur combattant, il nécessite des ajustements spéciaux de statistiques.
