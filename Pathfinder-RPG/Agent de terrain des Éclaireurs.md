---
Name: Pathfinder-RPG.Agent de terrain des Éclaireurs
Title: Agent de terrain des Explorateurs
LastModified: 2021-07-02 23:07
Categories:
- Classe de prestige
...
### Conditions requises
Pour devenir un Agent de terrain Explorateur, le personnage doit remplir les conditions suivantes :
...
- **Caché.** Afin de cacher son appartenance à la Compagnie des Explorateurs à des ennemis potentiels, l’agent de terrain qui bénéficie de cette amélioration peut rendre son guide invisible et masquer son aura magique, trois fois par jour, comme si l’objet était sous l’effet d’*[[invisibilité]]* et d’*[[aura magique]]*. À chaque fois qu’il utilise cet effet, celui-ci dure 1 heure par tranche de deux niveaux d’agent de terrain Explorateur (1 heure au minimum). L’agent peut mettre fin à l’effet par une [[action de mouvement]].
- **Message.** Le guide peut servir à lancer *[[message]]* à volonté en plus de son pouvoir magique de *[[lumière]]*. 
- **Défense.** Une fois par jour, l’agent de terrain Explorateur peut activer son guide pour bénéficier d’un bonus de parade de +2 à la [[CA]] pendant un nombre de minutes égal à son niveau d’agent de terrain. Ce bonus augmente de 1 pour chaque tranche de cinq niveaux d’agent de terrain Explorateur. 
- **Silence.** Une fois par jour, l’agent de terrain Explorateur peut utiliser son guide pour émettre une aura de *[[silence]]*, comme le sort du même nom. L’effet de silence est centré sur le guide. L’agent peut choisir cette amélioration à plusieurs reprises, chacune lui octroyant une utilisation quotidienne supplémentaire. 
- **Stabilisation.** Le guide permet de lancer *[[stabilisation]]* à volonté. 
...
- **Incantation supérieure.** L’agent de terrain Explorateur gagne de nouveaux sorts quotidiens comme s’il avait gagné un niveau dans la classe de lanceur de sorts à laquelle il appartenait avant de choisir cette classe de prestige. Il ne gagne aucun des avantages de cette autre classe, seulement les sorts quotidiens, les sorts connus et l’augmentation du [[NLS|niveau de lanceur de sorts]]. Si l’agent possédait déjà des niveaux dans plusieurs classes de lanceur de sorts avant de choisir cette classe de prestige, il doit choisir à laquelle il applique cette augmentation quand il suit cette formation d’Explorateur.
- **Magnétisme animal (Ext).** Ce pouvoir fonctionne comme l’[[Druide#EMPATHIESAUVAGE|empathie sauvage]] du [[druide]] mais l’Explorateur utilise son niveau d’agent de terrain comme niveau effectif de druide. Quand il s’agit de déterminer son bonus d’empathie sauvage total, le niveau d’agent de terrain Explorateur se cumule avec ceux des autres classes donnant accès à ce pouvoir.
- **Mémoire eidétique (Ext).** Après des années de formation dans les bibliothèques d’un nombre incalculable de loges d'Explorateur, l’agent de terrain a développé une mémoire extraordinaire. Celui qui a suivi cette formation ajoute la moitié de son niveau de classe (1 au minimum) à ses tests de [[Connaissances]] et peut tenter n’importe quel test de Connaissances, même s’il n’a pas de rang dedans.
- **Recherche des pièges.** Ce pouvoir fonctionne comme la capacité de [[roublard]] du même nom. Les niveaux d’agent de terrain Explorateur se cumulent avec ceux des autres classes offrant ce pouvoir quand il s’agit de déterminer le bonus total de l’agent pour la [[Roublard#RECHERCHEDESPIEGES|recherche de pièges]]. 
- **Spécialisation de compétence (Ext).** L’agent de terrain Explorateur peut choisir n’importe quelle [[Compétences|compétence]] qui devient alors une [[compétence de classe]]. De plus, il gagne un bonus égal à la moitié de son niveau pour tous les tests effectués avec cette compétence. Il peut choisir cette formation à plusieurs reprises tant qu’il l’applique à chaque fois à une compétence différente.
- **Talent de roublard.** L’agent de terrain Explorateur peut choisir un [[Talents|talent de roublard]] pour lequel il remplit les conditions requises.

{s:Reference|DONSUPPLÉMENTAIRE}
#### Don supplémentaire
Au niveau 2, puis tous les trois niveaux, l’agent de terrain Explorateur choisit un [[Dons|don]] supplémentaire. Il s’agit forcément du don [[Talent]] ou d’un [[Dons déquipe|don de travail en équipe]]. L’agent doit remplir les conditions requises du don.

{s:Reference|DÉCOUVERTEDESLÉGENDES}
#### Découverte des légendes (Sur)
Au niveau 10, l’agent de terrain Explorateur apprend à percer les secrets du lointain passé. Quand il fait des recherches sur une personne, un lieu ou un artefact d’une époque reculée, il peut se consacrer à la tâche et, une fois par jour, gagner les avantages d’un sort de *[[mythes et légendes]]*.
