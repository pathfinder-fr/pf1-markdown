...
| +0
| 1d6
| CLASS="gauche" | [[Fantômes (Spirite)#LIEN|Lien]], [[Fantômes (Spirite)#PARTAGEDESORTS|Transfert de sorts]], [[Fantômes (Spirite)#VISIONDANSLENOIR|Vision dans le noir]]
|- CLASS="alt"
| 2
| 2
| +2
...
| +1
| 1d6
| CLASS="gauche" | [[Fantômes (Spirite)#TOUCHSPELLS|Livrer un sort de contact (9m)]]
|- CLASS="alt"
| 4
| 3
| +3
...
| +1
| 1d6
| CLASS="gauche" | [[Fantômes (Spirite)#ATTAQUEMAGIQUE|Attaques magiques]]
|-
| 5
| 4
| +4
...
| +2
| 1d8
| CLASS="gauche" | [[Fantômes (Spirite)#AUGMENTATIONCARAC|Accroissement d'une caractéristique]]
|- CLASS="alt"
| 6
| 5
| +5
...
| +2
| 1d8
| CLASS="gauche" | [[Fantômes (Spirite)#DEVOTION|Dévotion]]
|-
| 7
| 6
| +6
...
| +3
| 1d10
| CLASS="gauche" | [[Fantômes (Spirite)#VOLINTANGIBLE|Vol sous forme intangible]]
|- CLASS="alt"
| 10
| 8
| +8
...
| +5
| 1d10
| CLASS="gauche" | [[Fantômes (Spirite)#TOUCHSPELLS|Livrer un sort de contact (15m)]]
|-
| 13
| 10
| +10
...
**Jets de sauvegarde forts/faibles.** Ce sont les bonus de base des jets de sauvegarde du fantôme. Un fantôme possède 2 jets de sauvegarde forts et un faible. Ceux-ci sont déterminés par l’[[Fantômes (Spirite)#EMOTIONDOMINANTE|émotion dominantes]] du fantôme.
...
: {s:Reference|ATTAQUEMAGIQUE}*Attaques magiques (Sur).* Un fantôme manifesté sous forme ectoplasmique traite toutes ses attaques de coup comme si elles étaient magiques lorsqu’il s’agit d’ignorer la [[Réduction de dégâts (capacité)|réduction des dégâts]]. Si le spirite est de niveau 10 ou plus, toutes les armes du fantôme sont considérées comme alignées sur le même alignement que le fantôme lorsqu’il s’agit d’ignorer la [[Réduction de dégâts (capacité)|réduction des dégâts]].
...
: {s:Reference|DEVOTION}*Dévotion (Ext).* Le fantôme bénéficie d’un bonus de moral de +4 aux jets de [[Volonté]] contre les sorts et effets d’enchantement.
...
- **Caractéristiques.** [[Force|For]] 12, [[Dextérité|Dex]] 14, [[Constitution|Con]] 13, [[Intelligence|Int]] 7, [[Sagesse|Sag]] 10, [[Charisme|Cha]] 13.
...
- **Intangible.** Quand le spirite manifeste son fantôme sous forme intangible, celui-ci apparaît à 9 mètres ou moins de lui en adoptant une apparence spectrale. Il acquiert le sous-type [[sous-type intangible|intangible]], en ajoutant un bonus de parade à la [[CA]] égal à son modificateur de [[Charisme]]. Il n’est pas un mort-vivant et ne subit donc pas les dégâts infligés par l’eau bénite ou l’énergie positive. À la différence des autres créatures intangibles, un fantôme intangible ne peut pas attaquer des créatures tangibles, sauf s’il place des sorts d’attaque de contact en utilisant le pouvoir [[fantômes (spirite)#TOUCHSPELLS|livrer un sort de contact]]. Un fantôme manifesté sous forme intangible peut effectuer des attaques de coup contre d’autres créatures elles aussi intangibles comme s’il était sous forme ectoplasmique.
...
**Pouvoir du désespoir**. Le fantôme bénéficie d’un bonus de +2 aux jets d’attaque et de dégâts effectués contre les créatures [[États préjudiciables#Secoué|secouées]], [[États préjudiciables#Effrayé|effrayées]], [[États préjudiciables#Paniqué|paniquées]], [[États préjudiciables#Recroquevillé|recroquevillées sur elles-mêmes]] ou affectées par une [[Antipaladin#AURADEDESESPOIR|aura de désespoir]], un *[[désespoir foudroyant]]* ou des effets similaires.
...
**Cri désespérant (Sur)**. À partir du niveau 12 de spirite, le fantôme peut pousser un cri qui produit les mêmes effets qu’un *[[désespoir foudroyant]]* et ce, trois fois par jour et par une [[action simple]]. Dans le cadre de cet effet, le [[NLS|niveau de lanceur de sorts]] du fantôme est égal à son nombre de Dés de Vie et le DD de l’effet à 10 + la moitié du nombre de Dés de Vie du fantôme + le modificateur de [[Charisme]] du fantôme. Le fantôme peut utiliser ce pouvoir sous forme ectoplasmique ou intangible.
...
**Dévotion inébranlable (Sur)**. À partir du niveau 17 de spirite, le fantôme devient immunisé aux effets mentaux néfastes et à toutes les formes de possession, telles qu’une [[possession]] ou une [[possession spirituelle (sort)|possession spirituelle]]. Il est également immunisé au bannissement, au renvoi et aux effets similaires.
...
**Attaque sournoise (Sur)**. À partir du niveau 12 de spirite, le fantôme acquiert l’aptitude d’[[roublard#ATTAQUESOURNOISE|attaque sournoise]] +3d6 qu’il peut effectuer uniquement contre son ennemi haï. Au niveau 18, les dégâts de l’[[roublard#ATTAQUESOURNOISE|attaque sournoise]] augmentent à +5d6.
...
#### Remords
{s:cs}Les esprits des créatures qui sont morts avec un lourd fardeau sur la conscience manifestent une puissante émotion de remords. Ces fantômes, dont la forme est souvent obscurcie par des ombres, forcent leurs adversaires à endurer leurs regrets et leur mépris de soi. Un spirite possédant l'archétype [[Guide destiné (spirite)|guide destiné]] doit choisir cette émotion dominante pour son fantôme. Mais les autres spirites peuvent également la choisir pour leur fantôme.

**Compétences.** Le fantôme gagne un nombre de rangs en [[Perception]] et en [[Psychologie]] égal à son nombre de [[DV|Dés de Vie]]. Lorsqu'il est confiné dans la conscience du spirite, le fantôme confère au spirite le don [[Talent]] pour chacune de ces compétences.

**Jets de sauvegarde favorables.** [[Vigueur]] et [[Volonté]].

**Antagoniste.** Le fantôme gagne [[Antagoniste]] comme don supplémentaire.

**Frappe de longue souffrance (Sur).** Quand un fantôme avec cette émotion dominante frappe une créature avec son attaque de coup, cette créature doit réussir un jet de [[Volonté]] ([[DD]] = 10 + 1/2 du nombre de [[DV|Dés de Vie]] du fantôme + le modificateur de [[Charisme]] du fantôme) pour éviter que toute attaque qui la cible bénéficie un bonus de +1 aux [[jet dattaque|jets d'attaque]] et [[Valeurs de combat#DEGATS|de dégâts]] jusqu'au début du prochain tour du fantôme. Les malus de plusieurs coups ne se cumulent pas entre eux.

**Aura de regrets (Sur).** Lorsque le spirite atteint le niveau 7, son fantôme peut émettre une aura de regrets de 3 mètres de rayon par une [[action rapide]]. Les ennemis dans l'aura subissent un malus de -2 à leurs tests de [[Compétences|compétence]], de [[NLS|niveau de lanceur de sorts]], de [[BMO|manœuvre offensive]] et à leur [[DMD]]. Mettre fin à l'aura est une [[action libre]]. Le fantôme peut utiliser cette capacité sous forme ectoplasmique et intangible.

**Impatience (Sur).** Lorsque le spirite atteint le niveau 12, son fantôme peut se lamenter sur ses fautes une fois par jour par une [[action simple]], affectant toutes les créatures dans un cône de 9 mètres avec le sort *[[terrible remords]]*. Le fantôme utilise son nombre de [[DV|Dés de Vie]] comme [[NLS|niveau de lanceur de sorts]] pour en déterminer l'effet, et le [[DD]] est égal à 10 + 1/2 du nombre de Dés de Vie du fantôme + le modificateur de [[Charisme]] du fantôme. Le fantôme peut utiliser cette capacité sous forme ectoplasmique et intangible.

**Misère absolue (Sur).** Lorsque le spirite atteint le niveau 17, la frappe de longue souffrance de son fantôme rend également les créatures qui ratent le jet de sauvegarde [[étourdi|étourdies]] jusqu'au début du prochain tour du fantôme.
...
**Coup terrifiant (Ext)**. Si le fantôme touche une créature avec son attaque de coup, celle-ci doit réussir un jet de [[Volonté]] ([[DD]] = 10 + la moitié du nombre de Dés de Vie du fantôme + le modificateur de [[Charisme]] du fantôme) pour ne pas être [[États préjudiciables#Secoué|secouée]] pendant 1d4 rounds. Plusieurs attaques réussies sur une même créature ne permettent pas de l’[[États préjudiciables#Effrayé|effrayer]]. C’est un effet mental de terreur.

**Intensification de la terreur (Sur)**. À partir du niveau 7 de spirite, le fantôme peut, par une [[action rapide]], émettre une aura de 6 mètres de rayon qui amplifie les états préjudiciables de peur infligés aux ennemis situés à l’intérieur s’ils ratent leur jet de [[Volonté]] ([[DD]] = 10 + la moitié du nombre de Dés de Vie du fantôme + le modificateur de [[Charisme]] du fantôme). Un ennemi [[États préjudiciables#Secoué|secoué]] dans l’aura devient [[États préjudiciables#Effrayé|effrayé]], une créature [[États préjudiciables#Effrayé|effrayée]] devient [[États préjudiciables#Paniqué|paniquée]] et une créature [[États préjudiciables#Paniqué|paniquée]] se [[États préjudiciables#Recrquevillé|recroqueville sur elle-même]]. Cet effet dure aussi longtemps que l’ennemi reste dans l’aura tout en étant affecté par l’état préjudiciable de peur initial, ou pendant un nombre de rounds après être sorti de l’aura égal à la moitié du nombre de Dés de Vie du fantôme, ou jusqu’à la fin de la durée de l’effet de peur initial, selon ce qui se produit en premier. Une créature qui réussit son jet de sauvegarde est immunisée contre l’effet du même fantôme pendant 24 heures. C’est un effet mental de terreur. Le fantôme peut utiliser ce pouvoir sous forme ectoplasmique ou intangible.

**Attaque effrayante (Sur)**. À partir du niveau 12 de spirite, pour chaque attaque de coup réussie, le fantôme peut [[États préjudiciables#Effrayé|effrayer]] les créatures touchées au lieu de les [[États préjudiciables#Secoué|secouer]] (le fantôme choisit l’état préjudiciable au moment où il effectue l’attaque). C’est un effet mental de terreur.
