...
Au niveau 11, la vitesse de déplacement de la monture du guerrier n'est pas réduite lorsqu'elle porte une charge lourde ou lorsqu'elle est équipée d'une [[armure lourde|barde lourde]]. Le cavalier peut également relancer un test d'[[équitation]] ou l'un des [[jet de sauvegarde|jets de sauvegarde]] de sa monture, mais il doit conserver le second résultat même s'il est pire. Il peut utiliser cette capacité une fois par jour au niveau 11, plus une fois de plus par tranche de quatre niveaux au delà du niveau 11. Cette capacité remplace [[guerrier#ENTRAINEMENTAUXARMURES|entraînement aux armures 3]].

#### Abattez-les (Ext).
Au niveau 15, le monteur de bêtes peut éperonner sa monture pendant qu'il prépare une attaque. Si elle effectue un seul déplacement, il peut faire une [[attaque à outrance]] et porter ses attaques n'importe quand durant ce déplacement. Si la monture possède le don [[piétinement]], il peut substituer une manœuvre de [[renversement]] à chacune de ses attaques.  Le déplacement provoque des [[attaque dopportunité|attaques d'opportunités]] contre le cavalier mais pas contre l'animal. Cette capacité remplace [[guerrier#ENTRAINEMENTAUXARMURES|entraînement aux armures 4]].

#### Assaut inévitable (Ext).
Au niveau 15, la charge du cavalier et de sa monture n'est pas bloquée par les créatures amicales ou un [[terrain difficile]]. Cette capacité remplace [[guerrier#ENTRAINEMENTAUXARMURES|entraînement aux armures 4]].

#### Monture invincible(Ext).
Au niveau 19, lorsque le cavalier est sur le dos de sa monture, ils reçoivent tous deux une [[RD]] de 5/-. Cette capacité remplace [[guerrier#MAITRISEDESARMURES|maîtrise des armures]].
