---
Name: Pathfinder-RPG.Ver du néant
Title: Protéen, Ver du néant
LastModified: 2021-04-04 10:30
Categories:
- Monstre
- Règle officielle
- Src Bestiaire 2
...
<div class="BD">
{s:BDTitre|Ver du néant|FP 2}
{s:pucem|Extérieur|Ciel|Extraplanaire}
{s:BDTexte|*Source : Bestiaire 2* p.227}
{s:BDTexte|**PX** 600}
{s:BDTexte|[[type Extérieur|Extérieur]] ([[sous-type Chaos|Chaos]], [[sous-type extraplanaire|extraplanaire]], [[sous-type métamorphe|métamorphe]], [[sous-type protéen|protéen]]) de taille TP, CN}
{s:BDTexte|**Init** +3 ; **Sens** *[[détection de la loi]]*, [[Perception aveugle]] 9 m (6 {s:c}), [[vision dans le noir]] 9 m (6 {s:c}) ; [[Perception]] +8}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 15, contact 15, pris au dépourvu 12 (Dex +3, taille +2)}
{s:BDTexte|**pv** 16 (3d10) ; [[guérison accélérée]] 2}
{s:BDTexte|**Réf** +6, **Vig** +1, **Vol** +2}
{s:BDTexte|**Capacités défensives** anatomie changeante, *[[liberté de mouvement]]* ; **Immunités** acide ; **Résistances** électricité 10, son 10}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 6 m (4 {s:c}), vol 15 m (10 {s:c}) (parfaite)}
{s:BDTexte|**Corps à corps** morsure, +8 (1d3-2) et coup de queue, +3 (1d3-2 plus confusion)}
...
{s:BDSorts|À volonté - *[[lumières dansantes]]*, *[[prestidigitation]]*, *[[son imaginaire]]* ([[DD]] 11)}
{s:BDSorts|3/jour - *[[brume de dissimulation]]*, *[[flou]]* (personnel uniquement)}
{s:BDSorts|1/semaine - *[[communion]]* ([[NLS]] 12, 6 questions)}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 7, **Dex** 17, **Con** 10, **Int** 8, **Sag** 8, **Cha** 13}
{s:BDTexte|**BBA** +3 ; **BMO** +4 ; **DMD** 12 ([[croc-en-jambe]] impossible)}
{s:BDTexte|**Dons** [[Attaque en finesse]], [[Talent]] ([[Perception]])}
{s:BDTexte|**Compétences** [[Acrobaties]] +9 (+5 pour [[Acrobaties#SAUTER|sauter]]), [[Bluff]] +7, [[Connaissances]] (mystères) +5, [[Discrétion]] +15, [[Évasion]] +7, [[Perception]] +8, [[Vol]] +19}
{s:BDTexte|**Langues** commun, protéen}
{s:BDTexte|**Particularités** changement de forme (2 formes qui doivent être toutes les deux des animaux de taille TP ; *[[forme bestiale II]]*)}
{s:BDSousTitre|Écologie}
{s:BDTexte|**Environnement** tous (Limbes)}
{s:BDTexte|**Organisation sociale** solitaire, couple ou banc (3-18)}
{s:BDTexte|**Trésor** aucun}
{s:BDSousTitre|Pouvoirs spéciaux}
{s:BDTexte|**Confusion (Sur).** Toute créature touchée par un coup de queue de ver du néant doit réussir un jet de [[Volonté]] de [[DD]] 12 pour ne pas être [[confus|confuse]] pendant 1 [[round]]. Il s'agit d'un effet mental. Le [[DD]] du [[jet de sauvegarde]] dépend du [[Charisme]].}

</div>
</td><td><div><ul style="margin: 0 0 -10 0;margin-top: 6px;margin-bottom: 12px;"><li>***Voir la description des [[Protéen|protéens]].***</li></ul>*Ce minuscule serpent iridescent glisse dans le vide et fait vibrer l’air autour de lui comme s’il émettait de la chaleur.*
