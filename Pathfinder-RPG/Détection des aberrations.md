---
Name: Pathfinder-RPG.Détection des aberrations
Title: Détection des aberrations
LastModified: 2022-06-12 14:31
Categories:
- Règle officielle
- Sort
- Sort druide 1
...
Premier [[round]] : présence ou absence de créatures de [[type aberration]] recherchées dans la [[zone deffet|zone d’effet]].

Deuxième [[round]] : nombre de créatures de [[type aberration]] recherchées dans la [[zone deffet|zone d’effet]], ainsi que l’état de l’individu ou du spécimen le plus sain.

Troisième [[round]] : état de toutes les créatures de [[type aberration]] recherchées présentes dans la [[zone deffet|zone d’effet]]. Si l’une d’elle se trouve hors du champ de vision du lanceur de sort, le sort révèle la direction dans laquelle elle se trouve mais pas la distance à laquelle elle se situe.
...
(((Ce sort fonctionne comme *[[détection de la faune ou de la flore]]*, hormis qu'il détecte les créatures de [[type aberration]].)))
