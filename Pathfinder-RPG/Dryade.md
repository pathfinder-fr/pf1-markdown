---
Name: Pathfinder-RPG.Dryade
Title: Dryade
LastModified: 2013-02-07 23:24
Categories:
- Bestiaire
- Monstre
- Règles officielles
...
<div class="BD">
{s:BDTitre|Dryade|FP 3}
{s:pucem|Fée|Forêt-jungle|Tempéré}
{s:BDTexte|*Source : Bestiaire p.120*}
{s:BDTexte|**PX** 800}
{s:BDTexte|[[type Fée|Fée]] de taille M, CB}
{s:BDTexte|**Init** +4 ; **Sens** [[vision nocturne]] ; [[Perception]] +11}
...
{s:BDTexte|**Faiblesses** arbre lié}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9 m (6 {s:c})}
{s:BDTexte|**Corps à corps** dague, +7 (1d4)}
{s:BDTexte|**Distance** arc long de maître, +8 (1d8)}
{s:BDTexte|**Pouvoirs magiques** (NLS 6<sup>e</sup>)}
{s:BDSorts|Constant — *[[communication avec les plantes]]*}
{s:BDSorts|À volonté — *[[enchevêtrement]]* (DD 15), *[[façonnage du bois]]* (1/2 kg uniquement), *[[forme darbre|forme d'arbre]]*}
{s:BDSorts|3/jour — *[[charme-personne]]* (DD 15), *[[sommeil profond]]* (DD 17), *[[voyage par les arbres]]*}
{s:BDSorts|1/jour — *[[suggestion]]* (DD 17)}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 10, **Dex** 19, **Con** 13, **Int** 14, **Sag** 15, **Cha** 18}
{s:BDTexte|**BBA** +3, **BMO** +3, **DMD** 17}
{s:BDTexte|**Dons** [[Attaque en finesse]], [[Discret]], [[Vigueur surhumaine]]}
{s:BDTexte|**Compétences** [[Artisanat]] (sculpture) +11, [[Connaissances]] (nature) +11, [[Discrétion]] +15, [[Dressage]] +10, [[Escalade]] +9, [[Évasion]] +15, [[Perception]] +11, [[Survie]] +8 ; **Modificateurs raciaux** [[Artisanat]] +6 (bois)}
{s:BDTexte|**Langues** commun, elfique, sylvestre ; *[[communication avec les plantes]]*}
{s:BDTexte|**Particularités** empathie sauvage, fusion dans les arbres, travail du bois}
{s:BDSousTitre|Écologie}
{s:BDTexte|**Environnement** forêts tempérées}
{s:BDTexte|**Organisation sociale** solitaire, couple ou bosquet (3-8)}
{s:BDTexte|**Trésor** standard (arc long de maître avec 20 flèches, dague, autres trésors)}
...
Les dryades sont les fées des arbres. Elles préfèrent vivre dans les
forêts isolées, à l’écart des bûcherons humanoïdes. Elles s’intéressent
...
en eux le même respect ou la même empathie envers la nature.
...
ou de repousser les attaquants. Après avoir mis leurs ennemis hors
combat, les alliés de la dryade les ramènent généralement à l’orée
de la forêt et les abandonnent là, mais ceux qui sont maléfiques ou
extrêmement hostiles sont tués dès la fin de l’affrontement.
</div></td></tr></table>
