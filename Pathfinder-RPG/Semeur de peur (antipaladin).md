...
{s:menuarchétypepaladin}{s:cm}**Cet archétype est réservé aux [[gobelours]]**
...
Le semeur de peur doit choisir la [[Antipaladin#CRUAUTE|cruauté]] secoué au niveau 3, hébété au niveau 6 et effrayé au niveau 9. Au niveau 12, il gagne la cruauté paniqué.
- **Paniqué.** La cible est [[paniqué|paniquée]] pendant 1 [[round]] par tranche de quatre niveaux d’antipaladin. L’antipaladin doit posséder les cruautés secoué et effrayé avant de pouvoir choisir celle-ci. Ce pouvoir de classe modifie le pouvoir de [[Antipaladin#CRUAUTE|cruauté]].

#### Se nourrir de la peur (Sur)
À partir du niveau 2, quand, pour la première fois du [[round]], une créature rate son [[jds|jet de sauvegarde]] contre un effet de terreur induit par un sort, un pouvoir magique ou un pouvoir surnaturel du gobelours (y compris un pouvoir rendant sa victime secouée, effrayée ou paniquée), ce dernier est soigné de 1 point de vie par tranche de deux niveaux d’antipaladin.  
...
Chaque jour, l’antipaladin peut utiliser ce pouvoir un nombre de fois égal à la moitié de son niveau d’antipaladin plus son bonus de [[Charisme]]. Ce pouvoir remplace [[Antipaladin#TOUCHERDECORRUPTION|toucher de corruption]].
