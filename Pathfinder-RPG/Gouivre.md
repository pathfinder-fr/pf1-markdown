---
Name: Pathfinder-RPG.Gouivre
Title: Gouivre
LastModified: 2021-04-25 11:43
Categories:
- Src Bestiaire 4
---
...
<div class="BD">
{s:BDTitre|Gouivre (~~Guivre~~)|FP 12}
...
{s:BDTexte|**Réf** +11, **Vig** +9, **Vol** +14 ; +4 contre les effets mentaux}
{s:BDTexte|**Capacités défensives** esprit résolu ; **Immunités** froid ; **Résistances** feu 10, son 10}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9 m (6 {s:c}), vol 12 m (médiocre), nage 15 m}
{s:BDTexte|**Corps à corps** morsure, +20 (3d6+4 et étreinte) et 2 griffes, +20 (2d6+4/19- 20) et 2 ailes, +14 (1d8+2)}
...
{s:BDTexte|**Environnement** forêts, rivières ou lacs tempérés}
...
Lorsqu’une gouivre meurt, sa tête de dragon régurgite un oeuf vitreux de 60 centimètres de diamètre. Au bout de 6 semaines environ, celui-ci éclot pour donner vie à une ou deux gouivres qui atteignent la maturité en 7 ans. Ces petits ont l’aspect des humanoïdes dévorés par leur mère, voilà pourquoi celle-ci préfère dévorer des victimes fortes et séduisantes. Les jeunes gouivres prennent également l’aspect des créatures reptiliennes proches de leur habitat.

*<u>Note :</u> Depuis toujours le Wyvern(e) a été traduit par "Vouivre" ou "Wiverne" en Français. Une tradition que n'a pas rompu BBE - Pathfinder en traduisant le "Wyvern" (V.O.) par "Vouivre" (V.F.), ce qui n'avait jamais posé problème... jusqu'à l'apparition de cette toute autre créature nommée en V.O. "Vouivre". La créature correspond à celle du mythe Gallois que l'on appelle en V.F. Gouivre (avec un O), mais il semblerait que sur les premières V.F. du Bestiaire 4 les traducteurs aient oublié la lettre O. C'est une grave méprise car "Guivre" (sans O) est déjà la traduction V.F. de "Wyrm" (ou "Wurm"), une famille de créatures de type Dragon. Cette erreur devrait normalement être corrigée dans les prochaines publications.*</div></td></tr></table>
