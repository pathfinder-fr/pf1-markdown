---
Name: Pathfinder-RPG.Maîtrise du fouet supérieure
Title: Maîtrise du fouet supérieure
LastModified: 2021-04-30 15:57
Categories:
- Don
- Don combat
- Règle officielle
...
{s:uc}*Le personnage exécute les manœuvres offensives au fouet avec une facilité déconcertante. *
...
Si la différence entre les deux allonges est inférieure à 0 (si une créature de [[taille|taille M]] tente de lutter avec une créature de taille [[taille|Gig]] par l’intermédiaire d’un fouet), le personnage ne peut pas utiliser son fouet pour lutter. Si le personnage doit [[attirer]] une créature vers lui pour poursuivre une lutte au fouet, il provoque une [[attaque dopportunité|attaque d’opportunité]] de la part de cette créature, à moins qu’il ne dispose du don [[Science de la lutte]].
...
- *Mains libres.* Quand le personnage utilise son fouet pour faire une [[lutte]], il ne reçoit aucun malus dû à l’absence de mains libres.


{s:PU}
#### Astuce martiale ([[Endurance et Astuces martiales|règles]])
Quand le personnage initie une [[lutte]] avec un [[fouet (arme)|fouet]], il peut dépenser 5 points d’endurance pour tenter un second test de lutte par une [[action rapide]] pour déplacer ou blesser la créature qu’il agrippe. Ce test ne sert pas à maintenir sa prise.
