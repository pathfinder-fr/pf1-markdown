---
Name: Pathfinder-RPG.Créature féerique, archétype
Title: Créature féerique, archétype
LastModified: 2013-11-23 12:44
Categories:
- Bestiaire 3
---
...
- **FP.** +1 par rapport à celui de la créature de base, si celle-ci possède 9 [DV](./DV.md) ou moins ; +2 par rapport à la créature de base si celle-ci possède 10 [DV](./DV.md) ou plus.
- **Alignement.** Tous sauf Loyal.
- **Type.** Le type de la créature change pour devenir [fée](./type Fée.md). Ne recalculez pas les [DV](./DV.md), le [BBA](./BBA.md) et les [jets de sauvegarde](./jet de sauvegarde.md).
...
- **Pouvoirs spéciaux.** Les créatures féeriques gagnent l’une des capacités suivantes tous les 4 [DV](./DV.md).
  ...
  - *Disparition (Sur).* Par une [action rapide](./Action rapide.md), la créature féerique peut disparaître pendant 1 [round](./round.md) comme si elle était sous l’effet du sort *[invisibilité](./Invisibilité.md)*. Elle peut utiliser cette capacité 1 [round](./round.md) par jour par [dé de vie](./DV.md).
  ...
  - *Grand pas (Sur).* La créature féerique peut se téléporter à un maximum de 3 mètres (2 {s:c}) par [dé de vie](./DV.md) par une [action de mouvement](./Action de mouvement.md). Elle peut utiliser cette capacité une fois tous les 1d4 [rounds](./round.md).
...
- **Pouvoirs magiques.** Une créature féerique ayant une valeur d’[Intelligence](./Intelligence.md) ou de [Sagesse](./Sagesse.md) de 8 ou plus possède un nombre cumulable de pouvoirs magiques dépendant de ses [DV](./DV.md). Sauf indication contraire, ces pouvoirs ne s’utilisent qu’une fois par jour. Le [niveau de lanceur de sorts](./NLS.md) est égal au nombre de [DV](./DV.md) de la créature ou au [niveau de lanceur de sorts](./NLS.md) des pouvoirs magiques de la créature de base (le plus haut des deux). Voir le tableau des pouvoirs magiques ci-contre
...
- **Compétences.** Une créature féerique ayant des [dés de vie](./DV.md) raciaux gagne un nombre de points de [compétences](./Compétences.md) par ([DV|dé de vie égal]] à 6 + son modificateur d’[Intelligence](./Intelligence.md). Elle gagne [Acrobaties](./Acrobaties.md), [Bluff](./Bluff.md), [Discrétion](./Discrétion.md) et [Vol](./Vol.md) comme [compétences de classe](./compétences de classe.md).
