...
{s:menuracesextraordinaires}<div style="background-color: #fff; float: right; padding: 0 0 8px 8px"><nav class="wiki-toc"></nav></div>{s:MR}***Voir aussi la [[Aquatique|fiche de créature]] d'un aquatique standard.***
...
- **+2 [[Constitution]], +2 [[Charisme]], -2 [[Sagesse]].** Les aquatiques sont beaux et vigoureux, mais la domination qu’exercent les aboleths sur eux a affaibli leur volonté.
- **Taille M.** Les aquatiques sont des créatures de [[taille M]] et n’ont aucun bonus ni malus de taille.
- **Aquatique.** Les aquatiques sont des [[type Humanoïde|humanoïdes]] de sous-type [[sous-type aquatique|aquatique]].
- **Vitesse normale.** Les aquatiques ont une [[VD|vitesse de base]] de 9 mètres sur la terre ferme. En tant que créatures aquatiques, ils ont aussi une [[Natation#Spécial_2|vitesse de nage]] de 9 mètres, peuvent se déplacer dans l’eau sans faire de test de [[Natation]], et considèrent toujours Natation comme une compétence de classe.
- **Amphibie.** Les aquatiques ont le sous-type [[sous-type aquatique|aquatique]], mais peuvent [[Amphibie (capacité)|respirer à l’air libre et sous l’eau]].
- **Résistance à l’enchantement.** Les aquatiques gagnent un bonus racial de +2 à leurs [[jds|jets de sauvegarde]] contre les sorts et effets d’[[enchantement]] des non-aboleths, mais reçoivent un malus de -2 à leurs jets de sauvegarde contre les sources [[Aboleth|aboleths]].
...
- **Langues.** Les aquatiques commencent le jeu en sachant parler le commun et l’aboleth. Ceux qui ont une valeur d’[[Intelligence]] élevée  peuvent apprendre d’autres langues parmi celles-ci : aklo, aquatique, draconique et elfique.
...
{s:MR}**[[Ensorceleur]].** Ajoutez un sort connu de la [[Liste des sorts densorceleursmagiciens|liste des sorts d’ensorceleur]]. Ce sort doit être inférieur d’au moins un niveau au plus haut niveau de sort que l’ensorceleur peut lancer.

{s:MR}**[[Guerrier]].** Ajoutez +1 au [[DMD]] du guerrier pour résister à deux manoeuvres offensives choisies par le personnage.
</td><td width="1%">
<td style="border-left:1px solid #4b3124" width="1%"></td>
</td><td width="49%">
{s:MR}**[[Magicien]].** Ajoutez un sort de la [[Liste des sorts densorceleursmagiciens|liste des sorts de magicien]]. Ce sort doit être inférieur d’au moins un niveau au plus haut niveau de sort qu’il peut lancer.
...
- [[Pilleur occulte (roublard)]] *(MR)*

#### Équipement
- [[couteau de mer (arme)|Couteau de mer]] *(MR)*
...
#### Objets magiques
- [[Errani kamaki]] *(ISR)*
- [[Masque des identités volées]] *(ISR)*

#### Sorts
- [[Poumons dAboleth|Poumons d'aboleth]] *(MR)*
