---
Name: Pathfinder-RPG.PNJ milices
Title: PNJ - Les milices
LastModified: 2015-11-24 22:12
Categories:
- Classe de PNJ
- Guide du maître
---

{s:GdM}Du shérif solitaire qui surveille un paisible bourg jusqu’aux officiers hautement entraînés qu’on trouve dans les grandes métropoles, les membres de la milice patrouillent, contrarient les plans des criminels et protègent les innocents. Les milices les mieux organisées emploient des membres aux talents divers, allant des experts du combat aux lanceurs de sorts, qui sont organisés en grades comme dans les ordres militaires. Si les gardes sont généralement des alliés accueillants, plusieurs d’entre eux sont des miliciens malhonnêtes et mêmes les meilleurs d’entre eux ne rendent service qu’à ceux qui peuvent prouver qu’ils respectent la loi.
...
{s:BDTexte|**Corps à corps** hallebarde, +5 (1d10+3/×3) ou fléau d’armes lourd, +5 (1d10+3/19–20) ou matraque, +5 (1d6+2 non létal)}
...
{s:BDTexte|**Réf** +2, **Vig** +6, **Vol** +1 ; +1 contre la terreur}
{s:BDTexte|**Capacités défensives** courage +1}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 6 m (4 {s:c})}
{s:BDTexte|**Corps à corps** guisarme de maître, +9 (2d4+5/×3) ou matraque, +7 (1d6+3 non létal) (1d4+3/19–20)}
{s:BDTexte|**A distance** filet, +5 contact à distance (enchevêtrement) ou javeline, +5 (1d6+2)}
{s:BDTexte|**Espace** 1,50 m ; **Allonge** 1,50 m (3 m avec la guisarme)}
{s:BDSousTitre|Caractéristiques}
...
{s:BDTexte|**Réf** +4, **Vig** +8, **Vol** +4 ; +2 contre la terreur}
{s:BDTexte|**Capacités défensives** courage +2}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9 m (6 {s:c})}
{s:BDTexte|**Corps à corps** *hallebarde +1*, +14/+9 (1d10+10/×3) ou matraque, +11/+6 (1d6+4 non létal)}
{s:BDTexte|**A distance** arc long composite, +8/+3 (1d8+4/×3)}
{s:BDTexte|**Attaque spéciale** entraînement aux armes (armes d’hast +1)}
{s:BDSousTitre|Caractéristiques}
