...
**Aura** [[Transmutation]] modérée ; **NLS** 3 ; **Emplacement** [[Objets merveilleux sans emplacement|aucun]] ; **Prix** 3 000 po ; **Poids** 1,5 kg
(((Description)))
...
On peut lui ordonner de se transformer en corde à nœuds (et inversement), ce qui a pour effet de faire apparaître de gros nœuds distants de 30 cm environ. La longueur de la corde diminue alors sensiblement (elle tombe à 15 m), mais il devient plus facile d’y grimper (-10 au [[DD]] des tests d’[[Escalade]]). Le possesseur de la corde doit tenir une de ses extrémités pour faire appel à son enchantement.
(((Création)))
**Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[corde animée]]* ; **Coût** 1 500 po
</div>
