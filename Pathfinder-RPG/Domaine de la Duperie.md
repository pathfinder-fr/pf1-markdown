...
{s:MenuDomaines}
### Pouvoirs accordés
Le personnage est un maître de l’illusion et de la tromperie. Les compétences suivantes sont des compétences de classe pour lui : [[Bluff]], [[Déguisement]], [[Discrétion]].
...
{s:plume}<div class="description">**Source :** Kobolds of Golarion (KoG).</div>**Aspect du caméléon (Sur).** *(remplace double)* Par une [[action rapide]], le personnage peut adapter la couleur de sa peau à l'environnement. Il bénéficie donc d'un [[camouflage]] vis à vis de tout ennemi situé à plus de 3 mètres (2 {s:c}) de lui, et d'un [[camouflage total]] vis à vis de tout ennemi situé à plus de 12 mètres (8 {s:c}) de lui. Le [[prêtre]] peut utiliser ce pouvoir un nombre de round par jour égal à 3 + son modificateur de [[Sagesse]].
</div>
</td><td width="2%">
</td><td width="49%">
<div class="presentation arrondi">
...
|- CLASS="premier"
| 1er || *[[sort Déguisement|déguisement]]* || *idem* || *[[alarme]]* || *[[implantation de pensées]]* || *idem* || *idem*
|-
| 2e || *[[invisibilité]]* || *[[transformation de maître]]* || *idem* || *idem* || *[[image miroir]]* || *idem*
|-
| 3e || *[[antidétection]]* || *idem* || *idem* || *[[suggestion]]* || *idem* || *[[localisation dobjet|localisation d'objet]]*
|-
| 4e || *[[confusion]]* || *idem* || *idem* || *idem* || *idem* || *idem*
|-
| 5e || *[[leurre]]* || *idem* || *[[mur illusoire]]* || *idem* || *idem* || *idem*
|-
| 6e || *[[double illusoire]]* || *[[défense magique]]* || *[[voile]]* || *[[suggestion de groupe]]* || *idem* || *idem*
|-
| 7e || *[[écran]]* || *idem* || *idem* || *idem* || *[[projection dimage|projection d'image]]* || *[[forme éthérée]]*
|-
| 8e || *[[invisibilité de groupe]]* || *[[création de demi-plan]]* || *idem* || *idem* || *idem* || *idem*
|-
| 9e || *[[arrêt du temps]]* || *idem* || *idem* || *idem* || *idem* || *idem*
|}
