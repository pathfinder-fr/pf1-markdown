...
{s:MenuÉcoles}{s:Desambi|Plus d'information sur les sorts de cette école [[Présentation des sorts#ENCHANTEMENT|ici]].}*Les enchanteurs utilisent la magie pour contrôler et manipuler l’esprit de leurs victimes.*
...
**Toucher captivant (Mag).** Le [[magicien]] peut charmer une créature vivante en la touchant. Les créatures qui possèdent un nombre de [[DV]] supérieur au [[niveau]] du [[magicien]] ne sont pas affectées, tout comme les créatures qui sont en combat et celles qui ont une attitude hostile envers le [[magicien]]. La cible reçoit un jet de [[Volonté]] pour annuler l’effet. Le [[DD]] de ce [[jet de sauvegarde]] vaut 10 + la moitié du [[niveau]] du [[magicien]] + son modificateur d’[[Intelligence]]. Les créatures qui ratent leur [[jet de sauvegarde]] sont affectées par un sort de *[[charme-monstre]]* pendant un nombre de [[round|rounds]] égal à la moitié du [[niveau]] du [[magicien]] (minimum 1 [[round]]). Il s’agit d’un effet mental. Le [[magicien]] peut utiliser cette capacité un nombre de fois par jour égal à 3 + son modificateur d’[[Intelligence]].

**Façonnage des émotions (Sur).** Au [[niveau]] 8, le [[magicien]] peut émettre une aura de 9 m (6 {s:c}) qui va faciliter ou empêcher les influences émotionnelles pendant un nombre de [[round|rounds]] par jour égal à son [[niveau]] de [[magicien]] (ces [[round|rounds]] ne doivent pas forcément être consécutifs). Si le [[magicien]] choisit d’empêcher les influences émotionnelles, lui et ses alliés situés dans l’aura reçoivent un bonus de moral de +4 aux [[jet de sauvegarde|jets de sauvegarde]] contre les sorts et les effets mentaux et tous les effets de terreur qui ciblent l’un d’entre eux sont réduits d’une catégorie (« [[secoué]] » est annulé, « [[effrayé]] » devient « [[secoué]] » et « [[paniqué]] » devient « [[effrayé]] »). Si le [[magicien]] choisit de faciliter les influences émotionnelles, les ennemis situés dans l’aura reçoivent un malus de –2 aux [[jet de sauvegarde|jets de sauvegarde]] contre les sorts et effets mentaux.
</div>
</table>
