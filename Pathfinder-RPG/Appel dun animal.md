---
Name: Pathfinder-RPG.Appel dun animal
Title: Appel d'un animal
LastModified: 2022-06-11 19:10
Categories:
- Règle officielle
- Sort
- Sort druide 1
...
Quand l'animal arrive, il s'approche à 1,50 m (1 {s:c}) du personnage et reste à côté de lui pendant toute la durée du sort. Au départ, il est indifférent et son attitude varie en fonction des circonstances et des interactions. À part cette attitude de départ, ce sort ne permet pas d'influer sur la bête ni de communiquer avec elle, bien que le personnage puisse utiliser d'autres sorts ou pouvoirs pour ce faire.
