...
La créature affectée conserve son type, sa classe, ses niveaux et ses [[DV|Dés de vie]]. Son bonus de base à l'attaque, son bonus de base aux jets de sauvegarde et ses points de vie ne sont pas modifiés. Elle conserve toutes ses capacités de classe et peut toujours lancer des sorts, bien qu'elle doive le faire en utilisant sa nouvelle valeur d'Intelligence. Tous les objets équipés dans l'emplacement de la tête de la créature se fondent dans son corps. Les objets affectés qui accordent des bonus passifs continuent de le faire, mais ceux qui nécessitent une activation deviennent inutilisables tant que le sort fait effet.

Si la cible ne résiste pas à *bénédiction de Baphomet*, elle devient immunisée contre les sorts de [[branche métamorphose|métamorphose]] (à l'exception de celui-ci) tant que le sort fait effet. Les créatures mortes-vivantes, ingantibles ou gazeuses sont immunisés contre *bénédiction de Baphomet*.
