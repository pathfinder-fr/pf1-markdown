...
{s:BDTexte|**Init** +6 ; **Sens** [[Odorat surdéveloppé (capacité)|odorat surdéveloppé]], [[Vision nocturne (capacité)|vision nocturne]] ; [[Perception]] +15}
...
{s:BDTexte|**VD** 1,50 m, nage 6 m, [[Propulsion (capacité)|propulsion]] 27 m}
{s:BDTexte|**Corps à corps** tentacules, +19 (4d8+9/19-20 plus [[Étreinte (capacité)|étreinte]]) et morsure, +19 (2d8+9/19-20)}
{s:BDTexte|**Espace occupé** 4,50 m ; **Allonge** 4,50 m}
{s:BDTexte|**Attaques spéciales** ceinturage, [[Constriction (capacité)|constriction]] (4d8+13)}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 28, **Dex** 14, **Con** 21, **Int** 2, **Sag** 17, **Cha** 5}
{s:BDTexte|**BBA** +12 ; **BMO** +23 (+27 en [[lutte]]) ; **DMD** 35 (croc-en-jambe impossible)}
{s:BDTexte|**Dons** [[Attaques réflexes]], [[Combat en aveugle]]<sup>S</sup>, [[Fente]], [[Frappe décisive]], [[Science de linitiative|Science de l'initiative]], [[Science du critique]] (morsure), [[Science du critique]] (tentacules), [[Talent]] (Discrétion), [[Volonté de fer]]}
{s:BDTexte|**Compétences** [[Discrétion]] +14, [[Natation]] +17, [[Perception]] +15 ; **Modificateurs raciaux** +4 en Perception}
...
#### Le camérocéras comme [[Liste des compagnons animaux|compagnon animal]]
**Caractéristiques de départ :** **Taille** M ; **Vitesse** 1,50 m, nage 6 m, propulsion 27 m ; **CA** armure naturelle +1 ; **Attaque** tentacules (1d4 plus [[Étreinte (capacité)|étreinte]]), morsure (1d3) ; **Caractéristiques** For 14, Dex 15, Con 11, Int 2, Sag 12, Cha 2 ; **Particularités** [[Vision nocturne (capacité)|vision nocturne]], acclimaté à la pression

**Développement au niveau 7 :** **Taille** G ; **CA** armure naturelle +2 ; **Attaque** tentacules (1d6 plus [[Étreinte (capacité)|étreinte]]), morsure (1d4) ; **Caractéristiques** For +4, Dex -2, Con +2 ; **Attaques spéciales** [[Constriction (capacité)|constriction]] (1d6)
</div></td></tr></table>
