---
Name: Pathfinder-RPG.Animal mangeur dhommes, archétype
Title: Animal mangeur d'hommes, archétype
LastModified: 2019-11-17 15:11
Categories:
- Archétype
---
...
<div class="BD">
{s:BDTitre|Créer un animal mangeur d'hommes|}
{s:BDTexte|*Source : La colère des Justes p.508*}
"Mangeur d'hommes" est un archétype hérité ou acquis que l’on peut ajouter à une créature de type animal (qui devient alors la créature de base). Un animal mangeur d'hommes utilise le profil complet et les pouvoirs spéciaux de la créature de base, à l'exception des points suivants :
- **FP.** DV 4 ou moins, comme la créature de base +1; DV 5 à 10, comme la créature de base +2; DV 11 ou plus, comme la créature de base +3.
- **Alignement.** [Chaotique Mauvais](./Alignement.md).
...
- **BBA.** Le bonus de base à l'attaque d'un animal mangeur d'hommes est égal à son nombre de dés de vie.
- **Compétences.** Un animal mangeur d'hommes gagne un bonus racial de +4 aux tests de [survie](./Survie.md) effectuées pour suivre des traces.
- **Langues.** Un animal mangeur d'hommes comprend l'abyssal et le commun, mais ne peut pas parler.
</div></td>
<td><div>Voir un exemple : l'[auroch mangeur d'hommes](./Auroch mangeur dhommes.md).
...
#### Sang de Baphomet
Le seigneur démon des bêtes permet à ses fidèles les plus dévoués de changer des animaux ordinaires en mangeurs d'hommes grâce à un élixir magiques. Cet ichor appelé le *sang de Baphomet* est censé contenir un distillat de sauvagerie animale. Un prêtre de Baphomet peut accéder aux sorts requis grâce à ses domaines : [forme bestiale III](./Forme bestiale III.md) via le domaine de la [Faune](./Domaine de la Faune.md) ou de la [Fourrure](./Domaine de la Faune.md) et [rage](./Rage.md) via le sous-domaine des [Démons](./Domaine du Chaos.md#SOUSDOMAINES) ou de la [férocité](./Domaine de la Force.md#SOUSDOMAINES).
...
Si le buveur est un animal, il est [étourdi](./Étourdi.md) pendant un round et doit réussir un jet de Volonté DD 17 pour ne pas acquérir définitivement l’archétype *mangeur d'hommes*. Si le *Sang de Baphomet* est consommé en même temps que de la chair d’humanoïde, l'animal ne peut pas faire de jet de sauvegarde.
Si le buveur n'est pas un animal, il entre dans une rage frénétique comme s'il était sou l'effet d'un sort de [rage](./Rage.md); Il doit réussir un jet de Volonté DD 17 pour ne pas être [confus](./Confus.md) tant que dure la rage. Si le *Sang de Baphomet* est bu tout en dévorant de la chair d’humanoïde (un acte Chaotique Mauvais), le buveur ne peut pas faire de jet de sauvegarde.
**Conditions** [Création d’objets merveilleux](./Création dobjets merveilleux.md), *[forme bestiale III](./Forme bestiale III.md)*, [rage](./Rage.md)
**Coût** : 1 125p
