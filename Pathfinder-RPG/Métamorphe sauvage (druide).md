...
Au niveau 1, un métamorphe sauvage peut, par une [[action rapide]], bénéficier d’un aspect animal pour gagner un bonus ou un pouvoir spécial en fonction du type d’animal imité. Ceci fonctionne comme l’aptitude de classe [[Chasseur#IMITATIONANIMALE|imitation animale]] du [[Chasseur]]. Chaque jour, le métamorphe sauvage peut utiliser cette aptitude pendant un nombre de minutes égal à son niveau de druide. Cette durée n’est pas nécessairement consécutive, mais doit être dépensée par fractions d’une minute au minimum. Il peut imiter un seul animal à la fois. Cette aptitude remplace pacte avec la nature.
