...
|- CLASS="titre"
| [[vitesse de déplacement|VD]] || 4,50 m (3 cases) || 6 m (4 cases) || 9 m (6 cases) || 12 m (8 cases)
|- CLASS="premier"
| COLSPAN="5" | **UN ROUND (TACTIQUE)***
|-
| &emsp;[[Déplacements#MARCHE|Marche]] || 4,50 m || 6 m || 9 m || 12 m
|- CLASS="alt"
| &emsp;[[Déplacements#FOOTING|Footing]] || 9 m || 12 m || 18 m || 24 m
|-
| &emsp;[[Déplacements#COURSE|Course]] (x3) || 13,50 m || 18 m || 27 m || 36 m
|- CLASS="alt"
| &emsp;[[Déplacements#COURSE|Course]] (x4) || 18 m || 24 m || 36 m || 48 m
|- CLASS="premier"
| COLSPAN="5" | **UNE MINUTE (COURTE DISTANCE)**
|-
| &emsp;[[Déplacements#COURTEMARCHE|Marche]] || 45 m || 60 m || 90 m || 120 m
|- CLASS="alt"
| &emsp;[[Déplacements#COURTEFOOTING|Footing]] || 90 m || 120 m || 180 m || 240 m
|-
| &emsp;[[Déplacements#COURTECOURSE|Course]] (x3) || 135 m || 180 m || 270 m || 360 m
|- CLASS="alt"
| &emsp;[[Déplacements#COURTECOURSE|Course]] (x4) || 180 m || 240 m || 360 m || 480 m
|- CLASS="premier"
| COLSPAN="5" | **UNE HEURE / UN JOUR (LONGUE DISTANCE)**
|-
| &emsp;[[Déplacements#LONGUEMARCHE|Marche]] || 2,25 km / 18 km || 3 km / 24 km || 4,5 km / 36 km || 6 km / 48 km
|- CLASS="alt"
| &emsp;[[Déplacements#LONGUEFOOTING|Footing]] || 4,5 km / — || 6 km / — || 9 km / — || 12 km / —
|-
| &emsp;[[Déplacements#LONGUECOURSE|Course]] || — / — || — / — || — / — || — / —
|- CLASS="note"
...
{s:Reference|MARCHE}*Marche.* En se déplaçant normalement et sans s’arrêter, un [[humain]] non chargé parcourt généralement 4,5 km en une heure.

{s:Reference|FOOTING}*Footing.* Le footing est un déplacement en petites foulées qui permet à un [[humain]] de parcourir de 9 km/h quand il n’est pas chargé. Il équivaut à un personnage se déplaçant deux fois dans le même [[round]], ou effectuant une autre [[Types dactions|action]] (attaque, incantation ou autre action de mouvement), puis se déplaçant dans le même [[round]].

{s:Reference|COURSE}*Course (x3).* Se déplacer à trois fois sa vitesse de déplacement est le rythme de course pour un personnage en [[armure lourde]]. Cela correspond environ à 10,5 km/h pour un [[humain]] en [[Tableau récapitulatif des armures|harnois]].

*Course (x4).* Cette cadence plus rapide est réservée aux personnages sans armure ou en [[armure légère]] ou [[armure intermédiaire|intermédiaire]]. Elle correspond environ à 18 km/h pour un [[humain]] non chargé, et à 13,5 km/h pour un [[humain]] en [[Tableau récapitulatif des armures|cotte de mailles]]. Référez-vous à la table ci-contre pour plus de détails.

### Déplacement tactique
On utilise ce déplacement lors d’un combat. Dans cette situation, il est évident que les personnages ne marchent pas, ils courent ou se déplacent en petites foulées. Un personnage qui se déplace normalement avant d’accomplir une autre [[Types dactions|action]] trottine pendant la première moitié du [[round]] puis fait autre chose pendant l’autre moitié.
...
{s:Reference|COURTECOURSE}**Course.** Un personnage peut courir pendant un nombre de [[round|rounds]] égal à son score de [[Constitution]] sans avoir besoin de faire une pause. (Voir aussi les [[Actions complexes#COURIR|règles]] concernant les longues périodes de course).
...
Un personnage [[fatigué]] ne peut ni [[courir]] ni [[charge|charger]] et subit un malus de -2 à la [[Force]] et à la [[Dextérité]]. Éliminer les [[dégâts non-létaux]] élimine aussi la [[fatigue]].

{s:Reference|LONGUECOURSE}**Course.** Il est impossible de courir sur une longue période. Un personnage qui alterne course et temps de repos progresse comme s’il faisait un [[Déplacements#FOOTING|footing]].
...
Mais il est possible de continuer son chemin en ayant recours à la marche forcée. Pour chaque heure de marche au-delà des 8 heures de base, le personnage doit effectuer un [[test]] de [[Constitution]] ([[DD]] 10 + 2 par heure supplémentaire). Un échec se traduit par 1d6 points de [[dégâts non-létaux]]. Un personnage qui subit des [[dégâts non-létaux]] à cause d’une marche forcée devient aussitôt [[fatigué]]. Éliminer les [[dégâts non-létaux]] élimine aussi la [[fatigue]]. On peut sombrer dans l’[[États préjudiciables#Inconscient|inconscience]] à force de marcher trop longtemps.

**Déplacement à cheval.** Un cheval portant un cavalier peut avancer au trot (équivalent du [[Déplacements#FOOTING|footing]]) mais, dans ce cas, les dégâts qu’il subit sont [[dégâts létaux|létaux]], plutôt que [[dégâts non-létaux|non-létaux]]. De même, on peut le pousser en permanence, ce qui correspond à une marche forcée, mais il rate automatiquement ses [[test|tests]] de [[Constitution]] et, là encore, il encaisse des [[dégâts létaux]]. Les montures deviennent elles aussi fatiguées si elles subissent des [[dégâts non-létaux]] à cause d’un [[Déplacements#FOOTING|footing]] ou d’une marche forcée. La vitesse des chevaux et des véhicules tirés par des animaux de trait est présentée dans le tableau ci-dessous.
...
|- CLASS="alt"
| &emsp;Cheval léger (87,5–262,5 kg)<sup>[[Déplacements#NOTE1|1]]</sup> || 5,25 km || 42 km
|-
| &emsp;Cheval lourd || 7,5 km || 60 km
|- CLASS="alt"
| &emsp;Cheval lourd (114,5–345 kg)<sup>[[Déplacements#NOTE1|1]]</sup> || 5,25 km || 42 km
|-
| &emsp;Poney || 6 km || 48 km
|- CLASS="alt"
| &emsp;Poney (75,5–225 kg)<sup>[[Déplacements#NOTE1|1]]</sup> || 4,5 km || 36 km
|-
| &emsp;Chien de selle || 6 km || 48 km
|- CLASS="alt"
| &emsp;Chien de selle (50,5–150 kg)<sup>[[Déplacements#NOTE1|1]]</sup> || 4,5 km || 36 km
|-
| &emsp;Chariot ou charrette || 3 km || 24 km
|- CLASS="premier"
| COLSPAN="3" | **BATEAU (MODE DE LOCOMOTION)**
|-
| &emsp;Radeau ou barge (perche ou tracté)<sup>[[Déplacements#NOTE2|2]]</sup> || 750 m || 7,5 km
|- CLASS="alt"
| &emsp;Bateau à fond plat (rames)<sup>[[Déplacements#NOTE2|2]]</sup> || 1,5 km || 15 km
|-
| &emsp;Barque (rames)<sup>[[Déplacements#NOTE2|2]]</sup> || 2,25 km || 22,5 km
|- CLASS="alt"
...
Quand les deux personnages se déplacent à la même [[vitesse de déplacement|vitesse]], la chasse est très simple : si une créature en poursuit une autre et qu’elles se déplacent toutes deux à la même [[vitesse de déplacement|vitesse]], la poursuite continue sur quelques [[round|rounds]] avant qu’elles fassent des [[test|tests]] de [[Dextérité]] opposés pour savoir laquelle s’est déplacée le plus rapidement pendant ces quelques [[round|rounds]]. Si la créature pourchassée gagne, elle parvient à s’enfuir, sinon, son poursuivant la rattrape.

Il arrive que la poursuite se déroule sur une [[Déplacements#LONGUEDISTANCE|longue distance]] et dure toute la journée, les deux créatures s’apercevant de temps à autre dans le lointain. Dans ce cas, c’est un [[test]] de [[Constitution]] qui décidera laquelle maintient son allure le plus longtemps. Si la créature pourchassée gagne, elle parvient à s’enfuir, sinon, son poursuivant, plus résistant, finit par la rattraper.
