...
{s:BDTexte|**Init** +2 ; **Sens** [[odorat]], [[Vision nocturne (capacité)|vision nocturne]] ; [[Perception]] +8}
...
{s:BDTexte|**Dons** [[Attaque en puissance]], [[Course]], [[Science de la bousculade]]}
{s:BDTexte|**Compétences** [[Discrétion]] +2, [[Perception]] +8}
{s:BDSousTitre|Écologie}
{s:BDTexte|**Environnement** plaines chaudes ou tempérées}
{s:BDTexte|**Organisation** solitaire ou couple}
{s:BDTexte|**Trésor** aucun}
{s:BDSousTitre|Pouvoirs spéciaux}
{s:BDTexte|**Charge percutante (Ext).** Lorsque le pachycéphalosaure touche une cible avec une attaque de coup à la fin d’une [[charge]], il peut entreprendre une [[bousculade]], par une [[action libre]], pour repousser la cible frappée dans la direction de sa charge. Le pachycéphalosaure ne peut pas se déplacer avec la cible de la bousculade. Si, avec une attaque de coup à la fin d’une charge, il réussit un [[coup critique]] contre une créature, celle-ci est également [[chancelant|chancelante]] pendant 1 [[round]]. Si la victime réussit un [[jet de sauvegarde|jet de Vigueur]] DD 18, l’effet chancelant est annulé
