...
### E
- ***[[Eau améliorée]] ([[Cayden Cailéan (technique)|Cayden Cailéan]])*** *(D&M)* (Bard 1, Pal 1, Prê 1). Transforme de l'eau en une boisson alcoolisée.
- ***[[Eau rouge]] ([[Sahuagin]])*** *(CM)* (Hyp 2, Ens/Mag 2, Prê 2, Psy 2). Confère la frénésie inspirée par le sang aux créatures dans la zone.
- ***[[Eaux de Lamashtu|Eaux de folie]] (M, Y)*** *(CCMI)* (Alch 2, Apal 2, Dru 3, Prê 3, Sor 3). Créé un poison qui a l'apparence d'eau pure et propre.
...
- ***[[Échange dobjet|Échange d'objet]]*** *(UI)* (Bard 3, Con 3, ConU 3, Hyp 3, Ens/Mag 4). Téléporte l'objet ciblé à la place de l'objet utilisé et vice versa.
...
- ***[[Effacement dimpression|Effacement d'impression]]*** *(AO)* (Hyp 4, Méd 3, Occ 3, Psy 5, Spi 4). Efface les impressions psychiques émanant d’un objet.
...
- ***[[Effigie majestueuse]]*** *(UI)* (Bard 4, Hyp 4, Ens/Mag 4, Méd 4, Occ 4, Prê 4, Spi 4). Comme *entrer dans une image* mais offre des avantages sociaux en étant dans l'image.
...
- ***[[Empathie de la meute]]*** *(UI)* (Con 3, ConU 3, Dru 3, Inq 3, Ens/Mag 3, Méd 2, Rôd 2, San 3, Spi 3). Crée un lien empathique avec les alliés.
...
- ***[[Emprunt de chance]] ([[Oracle]] uniquement)*** *(MJRA)* (Méd 3, Prê 3, Psy 3). Relance immédiatement un test ou une attaque mais fait pire aux deux suivants.
...
- ***[[Endurance de lours|Endurance de l'ours]]*** (Alch 2, Cham 2, Con 2, ConU 2, Dru 2, Ens/Mag 2, Magus 2, Méd 2, Prê 2, Psy 2, Rôd 2, San 2). Confère +4 en Con pendant 1 minute/niveau.
- ***[[Endurance de lours de groupe|Endurance de l'ours de groupe]]*** (Cham 6, Con 4, ConU 6, Dru 6, Ens/Mag 6, Magus 6, Prê 6, Psy 6). Comme *endurance de l'ours*, mais affecte un sujet/niveau.
...
- ***[[Esprit de larc|Esprit de l'arc]]*** *(MJRA)* (Rôd 4). Convoque un esprit invisible qui tire des flèches à la place du personnage.
...
- ***[[Étreinte du Premier Monde|Étreinte du Monde féerique]] (M)*** *(MMI)* (Bard 4, Dru 4). Imprègne une créature avec l'énergie brute du Monde féerique.
...
- ***[[Exploiter la beauté intérieure]] ([[Shélyn (technique)|Shélyn]])*** *(D&M)* (Bard 1, Prê 1, Sor 1). Confère un bonus d'intuition de +2 aux tests relatifs au Charisme.
...
- ***[[Fabrication de déguisement]]*** *(UI)* (Alch 1, Apal 1, Bard 1, Inq 1, Ens/Mag 1, Psy 1, Sor 1). Crée un déguisement instantanément.
...
- ***[[Faux avenir]] (M)*** *(UI)* (Bard 3, Cham 4, Hyp 3, Ens/Mag 5, Méd 3, Prê 4, Psy 4, Sor 4, Spi 4). Les divinations qui dévoilent l'avenir de la cible montrent une invention du personnage à la place.
...
- ***[[Faveur conditionnelle]]*** *(UI)* (Apal 1, Bard 2, Hyp 2, Inq 2, Occ 2, Pal 1, Prê 2, Sor 2). Confère les effets d'un autre sort qui s'inversent si la cible ignore une restriction établie.
...
- ***[[Festin onirique]] ([[Desna (technique)|Desna]])*** *(ESR2/6)* (Cham 1, Dru 1, Prê 1, Rôd 1). Nourrit une créature dans son sommeil.
...
- ***[[Fléau dinsectes|Fléau d'insectes]]*** (Cham 5, Con 4, ConU 5, Dru 5, Prê 5). Nuée de criquets attaquant des créatures.
...
- ***[[Flèche du Borgne]] ([[Érastil (technique)|Érastil]])*** *(D&M)* (Dru 1, Inq 1, Magus 1, Pal 1, Prê 2, Rôd 1, San 1). Créé une flèche d'électricité crépitante pour blesser les ennemis ou alerter les alliés.
...
- ***[[Fléchettes dargent|Fléchettes d'argent]]*** *(MCA)* (Ens/Mag 3, Magus 3, San 3, Sor 3). Cône de fléchettes en argent qui inflige 1d6 points de dégâts perforants par niveau, mais moins contre les cibles en armure.
...
- ***[[Forme darbre|Forme d'arbre]]*** (Cham 2, Dru 2, Rôd 3). Transforme le PJ en arbre pendant 1 heure/niveau.
...
- ***[[Forme de vermine I]] (Y)*** *(AM, LD)* (Alch 4, Dru 3, Ens/Mag 4, Magus 4, San 4, Sor 3). Prend la forme et les pouvoirs d'une vermine P ou M.
- ***[[Forme de vermine II]] (Y)*** *(AM, LD)* (Alch 5, Dru 4, Ens/Mag 5, Magus 5, Sor 4). Comme *forme de vermine I* mais TP ou G.
...
- ***[[Fouet affaiblissant]] ([[Gobelin (race)|Gobelin]])*** *(MR)* (Ens/Mag 2, Sor 2). Paralyse un ennemi en affaiblissant ses caractéristiques physiques.
- ***[[Fouet daraignées|Fouet d'araignées]]*** *(MCA)* (Bard 2, Con 2, ConU 2, Dru 2, Ens/Mag 2, Sor 2). Crée un fouet composé d’araignées empoisonnées.
...
- ***[[Foulée urbaine]]*** *(UI)* (Bard 2, Con 3, ConU 3, Ens/Mag 3, Magus 3, Occ 3). Lie deux entrées afin que passer dans l'une téléporte à l'autre.
- ***[[Fracassement]] (Y)*** (Bard 2, Ens/Mag 2, Magus 2, Occ 2, Prê 2, Psy 2, San 2). Endommage objets ou créatures cristallines.
- ***[[Fractionnement des soins et des blessures]] ([[Néthys (technique)|Néthys]])*** *(ISG)* (Bard 3, Ens/Mag 3, Prê 3, San 3). Soigne le lanceur avec le prochain sort de dégâts qu'il incante.
...
- ***[[Fureur de Rovagug]] ([[Rovagug (technique)|Rovagug]])*** *(D&M)* (Inq 2, Ens/Mag 2, Prê 2, San 2, Sor 2). Créé un tremblement de terre mineur pour faire tomber des créatures.
...
- ***[[Globe dinvulnérabilité partielle|Globe d'invulnérabilité partielle]]*** (Ens/Mag 4, Occ 4, Psy 4). Bloque les sorts de 3e niveau ou moins.
- ***[[Globe dinvulnérabilité renforcée|Globe d'invulnérabilité renforcée]] (Y)*** (Ens/Mag 6, Occ 6, Psy 6). Comme *globe d'invulnérabilité partielle*, mais bloque aussi les sorts du 4e niveau.
...
- ***[[Gorgée de poison]]*** *(UI)* (Alch 5, Cham 5, Dru 5, Sor 5). Protège le personnage contre les poisons ingérés, puis permet de les recracher en cône.
...
- ***[[Goutte dorchidée|Goutte d'orchidée]] (M)*** *(MMI)* (Alch 3). Ajoute un puissant effet guérisseur aux mutagènes du personnage.
- ***[[Grâce (sort)|Grâce]]*** *(MJRA)* (Pal 1, Prê 2). Les mouvements ne provoquent pas d’attaque d’opportunité.
...
- ***[[Grâce des néréides]] ([[Ondin (race)|Ondin]])*** *(MR)* (Dru 1, Sor 1). Confère un bonus de parade à la CA égal au modificateur de Charisme du personnage tant qu'il ne porte pas d'armure.
...
- ***[[Grand banquet]]*** *(UI)* (Bard 4, Cham 4, Dru 4, Prê 4). Crée un festin luxueux pour 2 créatures/niveau.
...
- ***[[Grappin opportun]]*** *(UI)* (Inq 1, Ens/Mag 1, Rôd 1). Transforme un objet semblable à une corde en grappin rétractable.
...
- ***[[Guérison de la cécitésurdité|Guérison de la cécité/surdité]]*** (Alch 3, Cham 3, Hyp 3, Pal 3, Prê 3, Sor 3, Spi 3). Soigne la cécité ou la surdité.
...
- ***[[Havresombre]] ([[Fetchelin (race)|Fetchelin]])*** *(MR)* (Ens/Mag 4, Psy 4). Ce sort crée un abri extra-dimensionnel temporaire
...
- ***[[Imprégner daura|Imprégner d'aura]]*** *(AM)* (Prê 2). La cible imite l'aura du prêtre.
...
- ***[[Insectes espions]]*** *(UI)* (Con 3, ConU 3, Dru 3, Ens/Mag 4, Rôd 3, Sor 4). Le personnage utilise des coléoptères magiques comme espions.
- ***[[Insectes espions suprême]]*** *(UI)* (Con 6, ConU 6, Dru 6, Ens/Mag 7, Sor 7). Le personnage utilise des coléoptères magiques comme espions et partage leurs sens.
...
- ***[[Instrument dagonie|Instrument d'agonie]]*** *(AG)* (Inq 2, Prê 2). L’arme émet une fureur divine qui donne un bonus aux tests d’Intimidation.
...
- ***[[Intuition de lennemi|Intuition de l'ennemi]]*** *(MCA)* (Rôd 2). Accorde aux autres un bonus contre les ennemis jurés du personnage.
...
- ***[[Invocation instantanée suprême]] (M)*** *(UI)* (Ens/Mag 8, Psy 8, Sor 8). Comme *invocation instantanée* mais pour plusieurs objets et créatures.
...
- ***[[Jouer dun instrument|Jouer d'un instrument]]*** *(AM)* (Bard 1). Le personnage joue d'un instrument comme s'il avait appris.
- ***[[Joueur de flûte]]*** *(MJRA)* (Bard 6). Oblige des créatures similaires similaires à vous suivre.
- ***[[Jugement par anticipation]] ([[Pharasma (technique)|Pharasma]])*** *(D&M)* (Inq 2, Prê 2, Sor 1). Montre à une créature la récompense ou la punition qui l'attend après la mort.
...
- ***[[Jumeau de vomi]] (Y) ([[Gobelin (race)|Gobelin]])*** *(MR)* (Alch 3, Con 3, ConU 3, Ens/Mag 4, Magus 3, Psy 4). Le lanceur crée un double de lui-même avec lequel il peut échanger sa place.
...
### L
- ***[[Lesprit dépasse la matière|L'esprit dépasse la matière]]*** *(OO)* (Hyp 2, Psy 2, Spi 2). Réattribue les affaiblissements/diminutions d'une caractéristique à une autre.
- ***[[La mort venue den bas|La mort venue d'en bas]] ([[Gnome]])*** *(MR)* (Bard 3, Ens/Mag 2, San 2). La cible obtient un bonus d'esquive à la CA contre les créatures plus grandes qu'elle.
...
- ***[[Lame éblouissante]]*** *(MPNJ)* (Bard 1, Ens/Mag 1). Rend une arme brillante et éblouissante, facilitant les désarmements et les feintes au combat.
- ***[[Lame éblouissante de groupe]]*** *(MPNJ)* (Ens/Mag 3). Comme *lame éblouissante*, mais affecte plusieurs armes.
- ***[[Lame spirituelle (sort)|Lame spirituelle]]*** *(AO)* (Cham 4, Méd 4, Occ 4, Spi 3). Donne la propriété spectrale et un autre pouvoir lié aux émotions à une arme.
...
- ***[[Langage codé]]*** *(UI)* (Bard 2, Hyp 2, Ens/Mag 2, Méd 2, Occ 2, Psy 2). Le personnage et les cibles parlent, lisent et écrivent un langage unique.
...
- ***[[Lecture dobjet|Lecture d'objet]]*** *(AO)* (Hyp 2, Méd 1, Occ 1, Psy 2, Spi 2). Lit les impressions psychiques laissées sur un objet.
...
- ***[[Lecture de la météo]] ([[Gozreh (technique)|Gozreh]])*** *(D&M)* (Bard 1, Cham 1, Dru 1, Prê 1, Rôd 1, Sor 1). Prédit la météo des prochaines 48 heures.
- ***[[Lecture du tourment|Lecture du destin]] (Y)*** *(CCMI)* (Bard 3, Cham 3, Ens/Mag 3, Sor 3). Le personnage utilise un jeu du destin pour prédire le futur.
...
- ***[[Lecture rapide de Kreighton|Lecture rapide]]*** *(RSE)* (Bard 1, Ens/Mag 1, Magus 1, Prê 1). Le personnage a une compréhension partielle d'un livre comme s'il l'avait parcouru pendant 1 heure.
...
- ***[[Leurre suprême]] (M)*** *(UI)* (Bard 6, Hyp 6, Ens/Mag 7, Psy 7). Comme *leurre* mais se déplace avec la cible.
...
- ***[[Lien avec linvocateur|Lien avec l'invocateur]]*** *(AG)* (Con 4, ConU 4, Ens/Mag 5, Occ 4, Prê 4, Psy 5, Sor 5). La cible subit des dégâts à chaque fois que ses créatures invoquées en reçoivent.
...
- ***[[Localisation dobjet|Localisation d'objet]]*** (Bard 2, Hyp 2, Inq 3, Ens/Mag 2, Méd 2, Occ 2, Prê 3, Psy 2, Sor 3, Spi 3). Indique la direction de l'objet cherché.
...
- ***[[Loup fantomatique]] ([[Orque (race)|Orque]])*** *(MR)* (Con 2, ConU 2, Ens/Mag 4, Psy 4, San 4). Appelle une monture loup sanguinaire faite de fumée noire dont émane une aura de peur.
...
- ***[[Lumière argentée]]*** *(CSU)* (Bard 3, Dru 3, Ens/Mag 3, Pal 3, Prê 3). Créé un éclat lumineux argenté qui affaibli les créatures sensibles à l'argent alchimique.
...
- ***[[Mâchoires dacier|Mâchoires d'acier]]*** *(MJRA)* (Dru 2, Rôd 2). La créature gagne l’aptitude étreinte avec une attaque naturelle.
...
- ***[[Main ectoplasmique]]*** *(OO)* (Occ 5, Psy 5, Spi 4). Manifeste une main fantomatique animée qui accomplit la volonté du personnage.
...
- ***[[Main rouge de lassassin|Main rouge de l'assassin]]*** *(UI)* (Bard 4, Inq 4, Ens/Mag 5, Méd 3, Occ 4, Pal 4, Prê 4, Psy 5, Sor 5, Spi 4). Teint en rouge la main du meurtrier du cadavre utilisé.
...
- ***[[Maîtrise élémentaire]] ([[Ifrit (race)|Ifrit]], [[Ondin (race)|Ondin]], [[Oréade (race)|Oréade]], [[Suli (race)|Suli]], [[Sylphe (race)|Sylphe]])*** *(ISR)* (Dru 4, Ens/Mag 4, Magus 4, Rôd 4, San 4). Affine la maîtrise de l'essence élémentaire du personnage, offrant un bonus au déplacement et à l'attaque.
...
- ***[[Manoir resplendissant]] (F)*** *(UI)* (Ens/Mag 9, Psy 9). Crée un manoir opulent de plusieurs étages.
- ***[[Manoir somptueux]] (F)*** (Ens/Mag 7, Psy 7). Demeure extradimensionnelle.
- ***[[Manteau dombre|Manteau d'ombre]]*** *(MJRA)* (Dru 1, Rôd 1). Réduit les effets de l’exposition au soleil et à la châleur.
...
- ***[[Marque de chasse]] ([[Érastil (technique)|Érastil]])*** *(KM2/6)* (Dru 1, Pal 1, Prê 1, Rôd 1, San 1). Accorde une capacité surnaturelle pour détecter les traces et autres indices.
...
- ***[[Marteau de réparation]] ([[Torag (technique)|Torag]])*** *(ISG)* (Con 5, ConU 5, Ens/Mag 5, Prê 6). Libère une vague d'énergie qui répare les objets et les créatures artificielles.
- ***[[Marteau du chaos]] (Y)*** (Inq 4, Prê 4). Blesse et ralentit les créatures Loyales (1d8 pts de dégâts/2 niveaux).
- ***[[Marteau de Geb|Marteau du Mort]]*** *(MMI)* (Ens/Mag 4, Sor 4). Rassemble les restes de morts-vivants détruits à proximité en un amas pour les lancer sur les adversaires.
...
- ***[[Membre fantôme]]*** *(OO)* (Psy 6, Spi 5). Crée une manifestation psychique semi-visible d'un membre, permettant à une créature de remplacer des parties manquantes de son corps.
...
- ***[[Mixture pour bombe dombre|Mixture pour bombe d'ombre]]*** *(AG)* (Alch 2). La bombe du personnage recouvre sa cible d’une substance sombre qui lui donne un camouflage mais limite sa visibilité.
...
- ***[[Modification dapparence|Modification d'apparence]]*** (Alch 2, Bard 2, Cham 2, Con 2, ConU 2, Hyp 2, Ens/Mag 2, Magus 2, Méd 2, Psy 2, Sor 2). Permet d'adopter la forme d'une créature de taille P ou M.
- ***[[Modification daura|Modification d'aura]]*** *(AO)* (Hyp 3, Méd 3, Occ 3, Psy 4, Spi 4). Masque les auras d’alignement, d’émotion, de santé et de magie d’une créature ou d’un objet.
...
- ***[[Montée dadrénaline|Montée d'adrénaline]]*** *(AO)* (Hyp 1, Psy 1, Spi 1). Bonus de +8 à la For, la Dex ou la Con pour un jet puis fatigue pendant 1 round.
...
- ***[[Morsure magique suprême]] (Y)*** (Con 3, ConU 3, Dru 3, Rôd 3, Spi 3). Une arme naturelle du sujet gagne +1 à l'attaque et aux dégâts/4 niveaux (max. +5).
...
- ***[[Mur dépines|Mur d'épines]] (Y)*** (Cham 5, Dru 5). Épines blessant quiconque tente de passer.
- ***[[Mur de cécité surdité|Mur de cécité/surdité]]*** *(MCA)* (Bard 4, Ens/Mag 4, Prê 5, Psy 4, Sor 4). Mur translucide qui aveugle ou assourdit les créatures qui le traversent.
...
- ***[[Négation de larôme|Négation de l'arôme]]*** *(MJRA)* (Alch 1, Dru 1, Occ 1, Rôd 1). Impossible de traquer le personnage à l’ôdeur.
- ***[[Négation de linvisibilité|Négation de l'invisibilité]]*** (Inq 3, Occ 3, Prê 3, Spi 3). Dissipe l'invisibilité sur 1,50 m/niveau.
- ***[[Négligence]] ([[Halfelin]])*** *(ISR)* (Bard 3). Aide le personnage a paraître petit et insignifiant, améliorant sa Discrétion.
- ***[[Neuf vies]] ([[Homme-félin (race)|Homme-félin]])*** *(MR)* (Prê 8, Sor 8). Annule jusqu'à 9 effets néfastes qui devraient affecter la cible.
...
- ***[[Nuage de toile]] ([[Drow (race)|Drow]])*** *(MR)* (Ens/Mag 4, Sor 4). Nuage de toile d'araignée sur un espace de 6 m de rayon et de 6 m de haut.
...
- ***[[Nuée délémentaires|Nuée d'élémentaires]]*** (Cham 9, Dru 9, Sor 9). Appelle plusieurs élémentaires.
- ***[[Nuée de crocs]] ([[Troglodyte]])*** *(CM)* (Con 3, ConU 3, Dru 3, Ens/Mag 3, Psy 3, Sor 3). Appelle une nuée de crocs animés volants.
...
- ***[[Nuée distordante]] ([[Drow (race)|Drow]])*** *(ISR)* (Con 3, Ens/Mag 3, Sor 3). Comme *nuée grouillante*, mais la nuée rend les créatures plus vulnérables aux transmutations et inflige un malus à la Dex.
...
- ***[[Nuit de lames]] ([[Norgorber (technique)|Norgorber]])*** *(D&M)* (Apal 4, Con 3, ConU 3, Inq 3, Ens/Mag 3, Rôd 4). Créé un mur immobile fait de minuscules lames noires.
...
- ***[[Œil vigilant]] ([[Nain]])*** *(MR)* (Pal 1, Prê 1). Comme *protection d’autrui*, mais dure moins longtemps et nécessite une ligne de vue direct avec la créature liée.
...
- ***[[Os protecteur]] ([[Pharasma (technique)|Pharasma]])*** *(D&M)* (Inq 2, Ens/Mag 2, Magus 2, Prê 2, Sor 2). Anime un os qui flotte autour du personnage et bloque les attaques physiques.
- ***[[Oubliette aliénante]] ([[Zon-Kuthon (technique)|Zon-Kuthon]])*** *(ISG)* (Ens/Mag 7, Prê 7, Sor 7). Transporte la cible vers une prison sinistre dans un demi-plan effroyable.
- ***[[Ouvertfermé|Ouvert/fermé]]*** *(UI)* (Bard 1, Inq 1, Ens/Mag 1, Sor 1). Manipule l'apparence d'une porte pour qu'elle paraisse fermée ou ouverte.
- ***[[Ouverturefermeture|Ouverture/fermeture]]*** (Bard 0, Con 0, ConU 0, Hyp 0, Ens/Mag 0, Magus 0, Méd 0, Occ 0, Psy 0, Spi 0). Ouvre ou ferme portes, fenêtres ou objets.
