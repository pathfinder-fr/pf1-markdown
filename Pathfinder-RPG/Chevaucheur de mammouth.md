...
Au niveau 2, un chevaucheur de mammouth obtient un bonus de +1 aux [[jet dattaque|jets d'attaque]] et [[Valeurs de combat#DEGATS|de dégâts]] des armes contre les créatures Grandes (G) et Très Grandes (TG). Ce bonus passe à +2 contre les créatures Gigantesques (Gig) et Colossales (C).

{s:reference|CHEVAUCHEMENTECLAIR}
#### Chevauchement éclair (Ext)
Au niveau 3, un chevaucheur de mammouth peut faire un test d'[[Équitation]] pour monter ou descendre de la selle de son [[Chevaucheur de mammouth#DESTRIER|destrier]] rapidement, même si le destrier est plus grand d'une [[Petites et grandes créatures#TABLEAUTAILLES|catégorie de taille]], tant qu'il lui reste une [[action de mouvement]] disponible à ce tour.

{s:reference|DESTRIERROBUSTE}
#### Destrier robuste (Ext)
Au niveau 3 et tous les 2 niveaux par la suite, le bonus d'armure naturelle du [[Chevaucheur de mammouth#DESTRIER|destrier]] d'un chevaucheur de mammouth augmente de 1.
...
Au niveau 5, le [[Chevaucheur de mammouth#DESTRIER|destrier]] obtient un bonus de moral de +4 aux jets contre les effets de [[branche charme|charme]], de [[branche coercition|coercition]] et de peur.
