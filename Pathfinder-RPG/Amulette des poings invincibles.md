---
Name: Pathfinder-RPG.Amulette des poings invincibles
Title: Amulette des poings invincibles
LastModified: 2024-07-04 15:08
Categories:
- Objet mag merveilleux
---

<div class="BD">
{s:BDTitre|Amulette des poings invincibles|}
**Aura** [[Évocation]] faible ; **NLS** 5 ; **Emplacement** [[Objets merveilleux portés autour du cou|cou]] ; **Prix** 4 000 po (+1), 16 000 po (+2), 36 000 po (+3), 64 000 po (+4) ou 100 000 po (+5) ; **Poids** —
(((Description)))
...
Elle peut également conférer des propriétés spéciales d'armes de corps à corps, tant qu'elles sont applicables aux attaques à mains nues. Référez-vous à la Table "[[Armes magiques#DTMSPECIALE|Propriétés spéciales des armes de corps-à-corps]]" pour les déterminer. On considère que ces pouvoirs sont des bonus supplémentaires lorsqu’il s’agit de calculer le prix de vente de l’objet, mais ils ne modifient en aucune manière les bonus à l’attaque ou aux dégâts. Le bonus modifié d’une *amulette des poings invincibles* ne peut être supérieur à +5 ([[bonus daltération|bonus d’altération]] plus bonus des pouvoirs spéciaux). Il n’est pas nécessaire que l’amulette ait un [[bonus daltération|bonus d’altération]] de +1 pour conférer un pouvoir spécial d’arme de contact.
(((Création)))
**Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[morsure magique suprême]]*, niveau de lanceur de sorts au moins égal à trois fois le bonus conféré par l’amulette ; **Coût** 2 000 po (+1), 8 000 po (+2), 18 000 po (+3), 32 000 po (+4) ou 50 000 po (+5)
</div>
