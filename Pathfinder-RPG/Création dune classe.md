---
Name: Pathfinder-RPG.Création dune classe
Title: Création d'une classe
LastModified: 2018-12-12 21:17
Categories:
- Classe
...
Enfin, il est temps de tester la classe en jeu. Créez quelques personnages en appliquant les règles de classe puis organisez
un combat-test contre des monstres et d’autres personnages. Si vous effectuez cette démonstration avec un personnage qui
...
Lorsque vous créerez votre classe, il vous faudra sûrement effectuer toutes ces étapes plusieurs fois. Ne vous découragez
pas si vos premières tentatives demandent beaucoup de travail.
Concevez, testez et modifiez votre création jusqu’à ce que vous
obteniez une forme finale qui vous convient. Rappelez-vous que
la création d’une nouvelle classe est l’un des éléments du jeu les
