...
{s:BDTexte|**Corps à corps** cimeterre, +2 (1d6+1/18–20) ou dague, +2 (1d4+1/19–20)}
{s:BDTexte|**A distance**arc long composite, +2 (1d8+1/×3)}
...
<td><div>
Les matelots sont des marins ordinaires, des membres d’équipage normaux qui permettent aux vaisseaux petits et grands de continuer à flotter et à avancer. Ils sont attentifs aux dangers, pleins de bon sens, habitués aux vents, aux vagues et au
soleil mais toujours impatients de découvrir ce qui les attend au delà de l’horizon.
...
{s:BDTexte|**Réf** +6, **Vig** +7, **Vol** +6 ; +1 contre la terreur}
{s:BDTexte|**Capacités défensives** courage +1}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9 m (6 {s:c})}
{s:BDTexte|**Corps à corps** *épée courte +1*, +15/+10 (1d6+6/17–20) ou *épée courte +1*, +13/+8 (1d6+6/17–20), *épée courte +1*, +13/+8 (1d6+5/17–20) ou *épée courte +1*, +13/+8 (1d6+6/17–20), fouet de maître, +11 (1d3+1 non létal)}
{s:BDTexte|**A distance** arbalète lourde de maître, +13 (1d10/19–20)}
{s:BDTexte|**Espace** 1,50 m ; **Allonge** 1,50 m (4,50 m avec fouet)}
{s:BDTexte|**Attaque spéciale** entraînement aux armes (lames légères +1)}
{s:BDSousTitre|Caractéristiques}
...
{s:BDTexte|**Réf** +5, **Vig** +11, **Vol** +8 ; +2 contre la terreur}
{s:BDTexte|**Capacités défensives** courage +2}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9 m (6 {s:c})}
{s:BDTexte|**Corps à corps** *trident d’alerte sous-marine*, +22/+17 (1d8+11) ou lamétoile, +18/+13 (1d4+7/×3)}
{s:BDTexte|**A distance** arc long composite +1, +14/+9 (1d8+7/×3) ou lamétoile, +14 (1d4+7/×3}
{s:BDTexte|**Espace** 1,50 m ; **Allonge** 1,50 m (4,50 m avec fouet)}
{s:BDTexte|**Attaque spéciale** entraînement aux armes (arcs +1, armes de lancer +2)}
{s:BDSousTitre|Caractéristiques}
