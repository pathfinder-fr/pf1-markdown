...
Par exemple, si un [[champion mythique|champion]] [[barbare]] charge au cœur de la mêlée et abat un puissant scélérat suite à un coup critique chanceux à l’aide de sa hache, vous pouvez le récompenser sans oublier le [[filou mythique|filou]] [[roublard]] qui a pris en tenaille ce même scélérat au moment de la charge du [[barbare]], ni le [[maréchal mythique|maréchal]] [[barde]] qui lui a conféré un bonus au jet d’attaque grâce à sa performance bardique. Un personnage ne devrait pas recevoir plus d’une faveur par rencontre, mais le MJ peut faire une exception lors de circonstances particulières.
...
- **Acrobate.** Au cours d’un même round, le personnage utilise [[Acrobaties]] pour se déplacer au travers des zones contrôlées d’au moins cinq adversaires sans provoquer d’[[AO|attaque d’opportunité]].
...
- **Attaque massive.** Le personnage effectue une unique attaque contre une créature [[mythique]] et lui inflige des dégâts massifs (d’un montant supérieur ou égal à la moitié de son total maximum de [[pv|points de vie]], 50 au minimum).

- **Au seuil de la mort.** Le total actuel de [[pv|points de vie]] du personnage est à 0 ou moins mais il parvient tout de même à confirmer un [[coup critique]] contre un adversaire [[mythique]].

- **C’était moins une.** Le personnage élimine une créature qui l’avait [[enchevêtré]], [[agrippé]] ou [[Engloutissement (capacité)|englouti]].
...
- **Combattant solitaire.** Le personnage élimine une créature [[mythique]] sans l’aide d’aucun allié, y compris les [[Druide#PACTEAVECLANATURE|compagnons animaux]], les suivants, etc.
...
- **Danse mortelle.** En un [[round]], le personnage provoque au moins quatre [[AO|attaques d’opportunité]] sans qu’aucune ne le touche.
...
- **Don ultime.** Alors que son total de [[pv|points de vie]] actuel est à 0, le personnage utilise un sort, un objet ou un pouvoir spécial qui lui permet de soigner un allié au lieu de lui-même. Il tombe alors dans l’[[inconscient|inconscience]] et devient [[mourant]].
...
- **Épreuve mythique.** Au cours d’une même journée, le groupe élimine un nombre de créatures [[mythique|mythiques]] dont le total combiné des [[grade|grades]] mythiques est égal ou supérieur à 3 × le grade mythique le plus élevé parmi les personnages du groupe.
...
- **Extermination.** Le personnage utilise une catapulte, une baliste ou un bélier pour infliger des dégâts massifs à une créature [[mythique]] (pour un montant supérieur ou égal à la moitié du total maximum de [[pv|points de vie]] de la créature, 50 au minimum).

- **Fléau des morts-vivants.** À l’aide d’une unique [[canalisation dénergie|canalisation d’énergie]], le personnage élimine au moins huit morts-vivants ou au moins quatre morts-vivants [[mythique|mythiques]].

</td><td width="2%">
</td><td width="49%">
- **Imbattable.** Le personnage est victime des effets d’au moins trois des états préjudiciables suivants en même temps lors d’un combat contre un adversaire mythique : [[aveuglé]], [[confus]], [[assourdi]], [[hors de combat]], [[épuisé]], [[effrayé]], [[nauséeux]], [[paralysé]], [[immobilisé]] et [[étourdi]].

- **Indestructible.** Le personnage survit après avoir encaissé trois [[coup critique|coups critiques]].
...
- **Maître guérisseur.** À l’aide d’un unique sort, objet ou pouvoir, le personnage soigne la totalité des dégâts en [[pv|points de vie]] subis par une créature [[mourant|mourante]].
...
- **Performance bardique décisive.** Le personnage utilise sa [[représentation bardique]] pour inspirer ses alliés pendant au moins huit [[round|rounds]].
...
- **Succession de contresorts.** Le personnage [[contresort|contre]] trois sorts ou plus lancés par un unique lanceur de sorts adverse.

- **Succession de coups critiques.** Le personnage confirme trois [[coup critique|coups critiques]] d’affilée en réussissant tous ses [[jet dattaque|jets d’attaque]].

- **Survivre malgré tout.** Le personnage survit suite à une unique attaque qui lui inflige des dégâts massifs (dont le montant est supérieur ou égal à la moitié de son total maximum de [[pv|points de vie]], 50 au minimum) et obtient une marge de réussite de 5 ou plus au jet de [[Vigueur]] qui en résulte.

- **Victoire éclair.** Le groupe neutralise toutes les menaces d’une rencontre au cours du premier [[round]].

- **Victoire sans effusion de sang.** Les [[PJ]] neutralisent un adversaire [[mythique]] en lui infligeant uniquement des [[Blessures et mort#NONLETAL|dégâts non létaux]].
