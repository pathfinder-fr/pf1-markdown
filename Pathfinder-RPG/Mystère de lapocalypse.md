---
Name: Pathfinder-RPG.Mystère de lapocalypse
Title: Mystère de l'apocalypse
LastModified: 2020-10-03 16:31
---

{s:MenuMystères}{s:CM}**Ce mystère est réservé aux [[Géant du feu|géants du feu]].**
...
[[résistance]] de 5 ou il augmente une de ses précédentes [[résistance|résistances]]
...
fait une unique manoeuvre de [[destruction|destruction d’arme]], en utilisant son
...
ennemis qu’ils en sont [[secoué|secoués]]. L’adversaire doit se trouver
...
ses imprécations. Ce pouvoir ne peut pas [[effrayé|effrayer]] ou [[paniqué|paniquer]]
une cible, même si elle était déjà [[secoué|secouée]] à cause d’un autre effet.
...
créature [[mourant|mourante]] pour transmettre sa force vitale à une autre
...
dans le sol dans un rayonnement de 1,50 mètre et le transforme en [[terrain difficile]]. Lors des rounds suivants,
...
Il augmente alors le rayon du [[terrain difficile]] de 1,50 mètre par
...
lorsqu’il a commencé à utiliser ce pouvoir. Le [[terrain difficile]] né
...
manoeuvres de [[renversement]] contre des adversaires d’au
maximum deux catégories de taille de plus que lui. À partir
du niveau 5, il gagne [[Science du renversement]] comme don
supplémentaire et à partir du niveau 10 il obtient [[Renversement supérieur]] comme don supplémentaire. Il n’a pas besoin de
...
rounds égal à la moitié de son niveau d’[[oracle]] et peut le désactiver
...
ou plusieurs [[Absorption dénergie|niveaux négatifs]], il en inflige 1d4 de plus. Quand
...
sa victime par une action rapide, comme avec *[[sort malédiction|malédiction]]*, mais
la victime n’a pas droit au moindre jet de [[Volonté]] pour annuler
