...
Un ensorceleur de sang mêlé reçoit des [[compétences de classe]] supplémentaires issues de ses deux lignages. Si les deux lignées offrent les mêmes, il n’en tire aucun avantage.
...
*Exemple* : Au niveau 3, un ensorceleur de sang mêlé [[lignage aberrant|aberrant]]/[[lignage abyssal|abyssal]] peut apprendre *[[frayeur]]* ou *[[agrandissement]]* comme sort supplémentaire de lignage. S’il choisit *[[frayeur]]* comme sort supplémentaire de niveau 3, il peut utiliser son sort supplémentaire de niveau 5 pour apprendre *[[agrandissement]]* au lieu de *[[force de taureau]]* ou de *[[détection de linvisibilité|détection de l’invisibilité]]* et il l’ajoute à sa liste de sorts connus de niveau 1 (comme s’il l’avait appris en sort supplémentaire de niveau 3).
...
#### Inconvénients
L’ensorceleur de sang mêlé apprend un sort de moins à chaque niveau que dans la table des "[[ensorceleur#SORTSCONNUSDELENSORCELEUR|sorts connus par l’ensorceleur]]" (y compris pour les [[ensorceleur#TOURSDEMAGIE|tours de magie]]). De plus, les impulsions conflictuelles qui naissent de la divergence naturelle des héritages duaux de l’ensorceleur l’obligent à faire des efforts mentaux constants pour se concentrer sur sa situation et ses besoins actuels, ce qui lui laisse moins de force mentale pour s’occuper des dangers extérieurs.

L’ensorceleur de sang mêlé a toujours un malus de -2 aux jets de [[Volonté]].
