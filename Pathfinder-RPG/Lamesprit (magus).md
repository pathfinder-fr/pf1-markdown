---
Name: Pathfinder-RPG.Lamesprit (magus)
Title: Lamesprit
LastModified: 2021-05-14 16:31
Categories:
- Archétype
- Archétype magus
---

{s:Menuarchétypemagus}{s:AO}*L’association des talents psychiques et martiaux d’une lamesprit produit des effets redoutables. En créant des armes par la seule force de son esprit, elle dispose toujours des outils appropriés, quelles que soient les situations.*
...
Une lamesprit de niveau 4 accède à une liste de sorts élargie. Elle ajoute deux sorts de la [[Sorts de psychiste|liste de sorts de psychiste]] à sa liste de sorts de magus. Elle les considère comme des sorts de magus du même niveau que ceux de psychiste. Ces sorts doivent être d’un niveau que la lamesprit est capable de lancer. Aux niveaux 7, 11, 14 et 19, elle ajoute deux sorts de psychiste supplémentaires à sa liste de sorts, en appliquant les mêmes restrictions. Si une lamesprit choisit l’arcane de [[arcanes#MELANGEDESSORTS|mélange des sorts]], elle ajoute des sorts issus de la liste de sorts de psychiste à la place de ceux de la liste de magiciens. Cette aptitude remplace celles de [[magus#SOUVENIRMAGIQUE|souvenir magique]], [[magus#RESERVEDECONNAISSANCES|réserve de connaissances]], [[magus#SCIENCEDUSOUVENIRMAGIQUE|science du souvenir magique]], [[magus#COMBATMAGIQUESUPERIEUR|combat magique supérieur]] et [[magus#ACCESAUXSORTSSUPERIEUR|accès aux sorts supérieurs]].


#### Armes doubles (Sur)

Une lamesprit de niveau 7 peut manifester deux armes psychiques à la fois ou une arme double psychique, mais chaque arme (ou chaque extrémité de l’arme double) bénéficie d’un bonus d’altération diminué de 1 par rapport à la normale. À partir du niveau 12, chacune des deux armes psychiques (ou chaque extrémité de l’arme double) bénéficie d’un bonus d’altération diminué de 2 par rapport à la normale. Quand elle se bat avec une arme psychique dans chaque main ou une arme double psychique, la lamesprit peut utiliser son aptitude de [[magus#COMBATMAGIQUE|combat magique]] comme si elle avait une main libre. Cette aptitude remplace celle d’[[magus#ARMUREINTERMEDIAIRE|armure intermédiaire]].


#### Manifestation rapide (Sur)

Une lamesprit de niveau 8 peut manifester une arme psychique par une [[types dactions#RAPIDE|action rapide]]. Cette aptitude remplace celle de [[magus#SCIENCEDUCOMBATMAGIQUE|science du combat magique]].


#### Double manifestation (Sur)

Une lamesprit de niveau 13 peut manifester deux armes psychiques lors de la même action. Elle doit régler le coût pour ces deux armes. De plus, quand elle manie une arme à deux mains, elle peut utiliser son aptitude de combat magique comme si elle avait une main libre. Cette aptitude remplace celle d’[[magus#ARMURELOURDE|armure lourde]].
