---
Name: Pathfinder-RPG.Jeux
Title: Jeux
LastModified: 2023-07-28 16:20
---
...
{s:AE}{s:Reference|Balle}
#### Balle
**Prix** 8 pc (5 cm de diamètre), 2 pa (12 cm de diamètre), 6 po (25 cm de diamètre) ; **Poids** — (5 cm de diamètre), — (12 cm de diamètre), 0,5 kg (25 cm de diamètre)  
<hr />
...
{s:racial|Halfelin|halfelins|Illustrations/PNJ/Halfelin.jpg}{s:MR}{s:Reference|Bâtons du diable halfelins}
#### Bâtons du diable halfelins
...
{s:AE}{s:Reference|Boîte à secrets}
#### Boîte à secrets
**Prix** 1 po–1.000 po ; **Poids** 0,5 kg–2,5 kg  
<hr />
Cette boîte contient des pièces amovibles, des panneaux secrets ou des codes et des mécanismes de verrouillage curieux. Selon son modèle, elle s’ouvre avec un test de [[Sabotage]], de [[Connaissances]] (ingénierie), de [[Linguistique]] ou simplement d’[[Intelligence]]. Le [[DD]] du test dépend de la complexité de la boîte mais il se situe généralement entre 15 et 20 (on peut réessayer une fois par jour). Il arrive qu’il faille faire plusieurs tests de compétence à différentes étapes du casse-tête. Si la boîte à secrets a été construite pour qu’une personne spécifique soit en mesure de l’ouvrir, cette personne reçoit un bonus de circonstances de +5 au test.


{s:AE}{s:Reference|Cartes marquées}
#### Cartes marquées
...
{s:AE}{s:Reference|Cerf-volant}
#### Cerf-volant
**Prix** 1 pa–2.000 po ; **Poids** 0,5 kg–2,5 kg  
<hr />
Les cerfs-volants peuvent être de simples jouets de toile ou des œuvres d’art ornementées en soie.


{s:racial|Tengu (race)|tengus|Illustrations/PNJ/Tengu.jpg}{s:MR}{s:Reference|Cerf-volant de terreur}
#### Cerf-volant de terreur
**Prix** 20 po ; **Poids** —  
<hr />
Ce petit cerf-volant arbore généralement un visage féroce et des couleurs vives, et il est bordé de lames de bois en dents de scie. On renforce sa ficelle en la plongeant dans de la colle et en l’agrémentant parfois de verre pilé pour lui donner un peu de tranchant. Le cerf-volant a une [[solidité]] de 5 et 3 points de vie. Ceux qui participent à une bataille de cerfs-volants alternent les manœuvres offensives de [[destruction]] contre les cerfs-volants des autres ; chaque manœuvre offensive réussie permet au participant de lancer 1d6 points de dégâts contre le cerf-volant de l’adversaire. Lorsqu’un cerf-volant tombe à 0 point de vie, il est cassé ou sa ficelle se rompt, et le joueur perd la partie. Dans certaines compétitions, on attribue des points à la ficelle de l’adversaire lorsqu’on touche le sommet du cerf-volant, le vainqueur étant le premier à atteindre le total de points fixé. Ceux qui s’intéressent aux batailles de cerfs-volants peuvent prendre le cerf-volant de terreur comme arme pour des dons comme [[Arme de prédilection]] et [[Spécialisation martiale]], et appliquer ces bonus à leurs [[valeurs de combat#DEGATS|jets de dégâts]] de cerf-volant et à leurs tests de manœuvre offensive de destruction lorsqu’ils utilisent des cerfs-volants de terreur.


{s:AE}{s:Reference|Dés}
#### Dés
**Prix** 1 pa (standard), 10 po (pipés), 50 po (pipés, supérieurs) ; **Poids** — (standard), — (pipés), — (pipés, supérieurs)  
<hr />
...
{s:AE}{s:Reference|Dominos}
#### Dominos
**Prix** 1 pa–25 po ; **Poids** 0,5 kg  
<hr />
...
{s:AE}{s:Reference|Jeu de bowling}
#### Jeu de bowling
**Prix** 5 pa–10 po ; **Poids** 7,5 kg  
<hr />
Ce simple jeu de 10 quilles est souvent compliqué par les irrégularités de la boule, des quilles et du terrain de jeu.


{s:AE}{s:Reference|Jeu de cartes}
#### Jeu de cartes
**Prix** 1 pa–100 po ; **Poids** 0,5 kg  
<hr />
...
{s:AE}{s:Reference|Jeu de fléchettes}
#### Jeu de fléchettes
**Prix** 5 pa ; **Poids** 5 kg  
<hr />
...
{s:AE}{s:Reference|Jeu de société}
#### Jeu de société
**Prix** 1 pa–10 po ; **Poids** 1 kg  
<hr />
Il existe différents types et différentes variantes de jeux de société. Siège, un jeu de stratégie où les joueurs cherchent à encercler l’adversaire, est populaire parmi les adultes d’âge mûr, tandis que les jeux plus chaotiques comme La Course de la vouivre ou Doppel sont plus répandus dans les tavernes.


{s:AE}{s:Reference|Jeu du tourment}
#### Jeu du tourment
**Prix** 100 po ; **Poids** —  
<hr />
...
{s:AE}{s:Reference|Mallette de baseball}
#### Mallette de baseball
...
{s:MCA}{s:Reference|Recueil dénigmes}
#### Recueil d'énigmes
