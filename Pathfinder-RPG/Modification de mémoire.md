---
Name: Pathfinder-RPG.Modification de mémoire
Title: Modification de mémoire
LastModified: 2022-06-17 22:12
Categories:
- Règle officielle
- Sort
- Sort barde 4
...
**École** [Enchantement](./Enchantement.md) ([coercition](./coercition.md)) <nowiki>[</nowiki>[mental](./Registre.md)<nowiki>]</nowiki> ; **Niveau** [Bard](./Barde.md) 4, [Hyp](./Hypnotiseur.md) 4, [Méd](./Médium.md) 4, [Psy](./Psychiste.md) 5  

**Temps d'incantation** 1 [round](./round.md) (voir description)  
...
- Éliminer tous les souvenirs d’un événement auquel la cible a assisté. Ce sort ne permet pas d’annuler des sorts tels que *[charme](./charme.md)*, *[quête](./Quête.md)* ou *[suggestion](./Suggestion.md)*.
- Permettre à la cible de se souvenir avec une clarté absolue d’un événement auquel elle a assisté.
...
L’incantation nécessite 1 [round](./round.md). Si la cible rate son [jet de sauvegarde](./jet de sauvegarde.md), le [barde](./Barde.md) travaille sur l’esprit de celle-ci en visualisant le souvenir qu’il cherche à modifier (ce qui lui prend jusqu’à cinq minutes, le laps de temps exact étant égal à la durée du souvenir qu’il altère ou implante). Si le [barde](./Barde.md) est déconcentré avant d’avoir terminé (ou si la créature sort des limites de portée), le sort échoue automatiquement.
