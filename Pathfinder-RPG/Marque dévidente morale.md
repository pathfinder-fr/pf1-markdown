---
Name: Pathfinder-RPG.Marque dévidente morale
Title: Marque d'évidente morale
LastModified: 2024-10-10 16:41
Categories:
- Règle officielle
- Sort
- Sort prêtre 3
...
{s:MCA}**École** [[école divination|Divination]] <nowiki>[</nowiki>[[registre|malédiction]]<nowiki>]</nowiki> ; **Niveau** [[Prêtre|Prê]] 3</br>
**Temps d’incantation** 1 [[action simple]]</br>
**Composantes** [[COMPOSANTES|V, G]]</br>
**Portée** contact</br>
**Cible** la créature touchée</br>
**Durée** 1 jour/[[niveau]]</br>
...
Le personnage est conscient de la direction où se trouve la cible et de la distance qui les sépare à partir du moment où la cible reste dans un rayon de 160 kilomètres autour lui et sur le même plan.
