---
Name: Pathfinder-RPG.enlaceur de lombre
Title: Créature de l'ombre, Enlaceur de l'ombre
LastModified: 2021-02-11 23:39
---

<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Enlaceur de l'ombre|FP 13}
...
- **pv** 162 (12d8+108)
- **Réf **+5, **Vig **+13, **Vol **+13
- **Capacités défensives** fusion avec les ombres ; **RD** 10/magie ; **Immunités** électricité ; **Résistances** froid 15 ; RM 27
- **Faiblesses** vulnérabilité au feu
(((Attaque)))
- **VD** 3 m
- **Corps à corps** morsure, +20 (4d8+18/19-20)
- **Distance** 6 filaments, +10 (attaque de contact, affaiblissement temporaire 1d6 For)
- **Espace** 3 m ; **Allonge** 3 m
- **Attaques spéciales** attirer (filaments, 1,50 m), filaments
(((Statistiques)))
...
- **Organisation** solitaire, couple ou portée (3-6)
- **Trésor** standard
(((Pouvoirs spéciaux)))
- ** Filaments (Ext)**. Un enlaceur de l’ombre peut projeter jusqu’à six filaments fins et collants en même temps, à une portée maximale de 15 mètres. Ces attaques de filaments fonctionnent comme des attaques de contact à distance. Ces filaments sont plutôt résistants, mais on peut les trancher en leur infligeant un nombre quelconque de points de dégâts tranchants ; chaque filament possède une CA de 20. Lorsqu’un filament touche une créature, celle-ci est engourdie et affaiblie par l’étrange substance qu’il sécrète. Elle doit réussir un jet de Vigueur DD 25 pour ne pas subir un affaiblissement temporaire de 1d6 points de Force. Le DD du jet de sauvegarde est basé sur la Constitution.
