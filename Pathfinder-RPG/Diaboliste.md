---
Name: Pathfinder-RPG.Diaboliste
Title: Diaboliste
LastModified: 2023-03-16 17:38
Categories:
- Classe de prestige
...
|- CLASS="premier"
| 1 || +0 || +0 || +0 || +1
| CLASS="gauche" | [[Diaboliste#CHARISMEINFERNAL|Charisme infernal +2]], [[Diaboliste#DAMNE|damné]], [[Diaboliste#FAMILIERDIABLOTIN|familier diablotin]], [[Diaboliste#OBEDIENCE|obédience]]
| CLASS="gauche" | -
|-
| 2 || +1 || +1 || +1 || +1
| CLASS="gauche" | [[Diaboliste#CANALISATIONFEUINFERNAL|Canalisation de feu infernal]], [[Diaboliste#MARCHEINFERNAL|marché infernal]]
| CLASS="gauche" | [[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]
|-
| 3 || +1 || +1 || +1 || +2
| CLASS="gauche" | [[Diaboliste#AMELIORATIONCREATURECONVOQUEES|Amélioration des créatures convoquées]], [[Diaboliste#FAVEURDIABOLIQUE|faveur diabolique 1]], [[Diaboliste#HERESIE|hérésie +2]]
| CLASS="gauche" | [[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]
|-
| 4 || +2 || +1 || +1 || +2
| CLASS="gauche" | [[Diaboliste#CHARISMEINFERNAL|Charisme infernal +4]]
| CLASS="gauche" | [[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]
|-
| 5 || +2 || +2 || +2 || +3
| CLASS="gauche" | [[Diaboliste#AMEINFERNAL|Âme infernal]], [[Diaboliste#FAMILIERDIABLOTIN|pouvoirs magiques du diablotin]]
| CLASS="gauche" | [[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]
|-
| 6 || +3 || +2 || +2 || +3
| CLASS="gauche" | [[Diaboliste#FAVEURDIABOLIQUE|Faveur diabolique 2]], [[Diaboliste#TRANSPORTINFERNAL|transport infernal]]
| CLASS="gauche" | [[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]
|-
| 7 || +3 || +2 || +2 || +4
| CLASS="gauche" | [[Diaboliste#CHARISMEINFERNAL|Charisme infernal +6]]
| CLASS="gauche" | [[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]
|-
| 8 || +4 || +3 || +3 || +4
| CLASS="gauche" | [[Diaboliste#RAYONDEFEUINFERNAL|Rayon de feu infernal]], [[Diaboliste#FAMILIERDIABLOTIN|pouvoirs magiques du diablotin]]
| CLASS="gauche" | [[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]
|-
| 9 || +4 || +3 || +3 || +5
| CLASS="gauche" | [[Diaboliste#FAVEURDIABOLIQUE|Faveur diabolique 3]], [[Diaboliste#HERESIE|hérésie +4]]
| CLASS="gauche" | [[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]
|-
| 10 || +5 || +3 || +3 || +5
| CLASS="gauche" | [[Diaboliste#MAITREINVOCATEUR|Maître invocateur]]
| CLASS="gauche" | [[Classes de prestige#SORTSPARJOUR|+1 niveau dans une classe de lanceur de sorts existante]]
|}
...
**Spécial.** Le personnage doit vénérer un archidémon, un duc infernal ou une malebranche ; doit avoir conjuré un diable à l'aide d’*[[allié doutreplan|allié d'outreplan]]* ou de *[[contrat]]* (ou un sort similaire) et réussir à lui ordonner d'accomplir une tâche qui prend au minimum 1 jour.
...
{s:reference|FAMILIERDIABLOTIN}
#### Familier diablotin (Ext)
Un diaboliste forme un lien étroit avec un [[diablotin]] particulier, de la même manière qu'un magicien acquiert un [[familier]]. Cela fonctionne comme la capacité de classe de classe de magicien [[Magicien#PACTEMAGIQUE|pacte magique]], mais comme si le diaboliste avait le don [[Familier supérieur]]. Si un diaboliste a des niveaux de classe dans une autre classe qui accorde un familier, les niveaux de cette classe et les niveaux de diaboliste s'additionnent pour déterminer les capacités globales de son familier diablotin. Le familier diablotin peut communiquer avec son maître par télépathie tant que le diablotin est en contact physique avec lui.

Au niveau 5, le familier diablotin du diaboliste peut choisir n'importe lequel des sorts suivants pour l'ajouter à sa liste de pouvoirs magiques utilisables à volonté : *[[anathème]]*, *[[détection de la Loi]]*, *[[détection du Mal]]*, *[[manipulation à distance]]*, *[[message]]*, *[[perception de la mort]]*, *[[Ouverturefermeture|ouverture/fermeture]]*, *[[prestidigitation]]*, *[[saignement]]* ou *[[son imaginaire]]*. Le diablotin peut également ajouter n'importe lequel des sorts suivants à sa liste de pouvoirs magiques utilisables 1 fois par jour : *[[disque flottant]]*, *[[graisse]]*, *[[identification]]*, *[[image silencieuse]]*, *[[malédiction de leau|malédiction de l'eau]]*, *[[serviteur invisible]]*, *[[ventriloquie]]* ou *[[verrouillage]]*. La portée de la télépathie du diablotin avec le diaboliste passe à 18 m.
...
#### Marché infernal (Ext)
Au niveau 2, un diaboliste utilisant *[[allié majeur doutreplan|allié majeur d'outreplan]]* (ou un sort similaire) peut faire un test de [[Charisme]] opposé à celui d'un diable [[branche appel|appelé]] (mais pas [[branche convocation|convoqué]]). S'il réussit, le diable réduit de moitié le prix qu'il demande pour un service.

{s:reference|AMELIORATIONCREATURECONVOQUEES}
...
{s:reference|AMEINFERNAL}
#### Âme infernal (Ext)
Au niveau 5, un diaboliste est estimé suffisamment utile à la cause de l'Enfer pour se voir accorder un bref répit vis-à-vis de la damnation. S'il est tué par quelque moyen que ce soit en dehors de la volonté du [[Asmodéus|prince des Ténèbres]], des archidiables ou d'une autre force influente de l'Enfer, le diaboliste peut-être ressuscité normalement.

{s:reference|TRANSPORTINFERNAL}
...
{s:reference|RAYONDEFEUINFERNAL}
#### Rayon de feu infernal (Mag)
Au niveau 8, un diaboliste peut lancer *[[rayon de feu infernal]]* deux fois par jour comme un [[Pouvoirs magiques (capacité)|pouvoir magique]].

{s:reference|MAITREINVOCATEUR}
#### Maître invocateur (Ext)
Au niveau 10, lorsqu'un diaboliste appelle un diable dont il connait le nom, il peut lancer le sort d'[[branche appel|appel]] par une [[action simple]] et négocier avec lui par une [[action de mouvement]]. Il ajoute la moitié de son modificateur de [[Bluff]], [[Diplomatie]] ou [[Intimidation]] à ses tests de [[Charisme]] pour négocier de cette façon (le cas échéant).
