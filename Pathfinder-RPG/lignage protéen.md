...
**Dons supplémentaires.** [[École renforcée]], [[Extension de portée]], [[Maîtrise du combat défensif]], [[Manoeuvres agiles]], [[Robustesse]], [[Science de la vigueur surhumaine]], [[Talent]] ([[Artisanat]] <nowiki>[[</nowiki>n’importe quel domaine<nowiki>]]</nowiki>), [[Vigueur surhumaine]].
...
**Protoplasme (Mag).** Au [[niveau]] 1, l’[[ensorceleur]] peut créer une boule de protoplasme entropique et la lancer sur une cible située dans un rayon de 9 m (6 {s:c}). Ce protoplasme fonctionne comme une [[Sacoche immobilisante (objet)|sacoche immobilisante]] qui infligerait également 1 point de dégâts d’acide par [[round]] aux créatures qu’elle enchevêtre. Le protoplasme se dissout en 1d3 [[round|rounds]]. L’[[ensorceleur]] peut utiliser cette capacité un nombre de fois par jour égal à 3 + son modificateur de [[Charisme]].

**Résistances des protéens (Ext).** Au [[niveau]] 3, l’[[ensorceleur]] gagne une [[résistance (capacité)|résistance à l’acide]] de 5 points et un bonus de +2 aux [[jet de sauvegarde|jets de sauvegarde]] contre les sorts et effets de [[Présentation des sorts#METAMORPHOSE|métamorphose]], de pétrification et de [[transmutation]]. Au [[niveau]] 9, il gagne une [[résistance (capacité)|résistance à l’acide]] de 10 points et le bonus aux [[jet de sauvegarde|jets de sauvegarde]] augmente à +4.

**Plis dans la réalité (Mag).** Au [[niveau]] 9, l’[[ensorceleur]] peut s’entourer d’une émanation de 3 m (2 {s:c}) de rayon qui accompagne ses mouvements et où la réalité peut être modifiée. Cette zone de distorsion est similaire à un *[[brouillard dense]]* mais n’offre aucun [[camouflage]] et ne bloque pas le champ de vision. L’aura ne réduit pas les capacités de déplacement de l’[[ensorceleur]]. Les attaques provenant de l’extérieur subissent une chance d’échec de 20% contre les cibles situées dans l’aura. L’[[ensorceleur]] peut utiliser cette capacité pendant un nombre de [[round|rounds]] par jour égal à son niveau d’[[ensorceleur]] mais ces rounds ne doivent pas forcément être consécutifs.
...
**Avatar du Chaos (Ext).** Au [[niveau]] 20, l’[[ensorceleur]] est complètement envahi par l’essence du Chaos. Il devient [[immunité (capacité)|immunisé]] contre l’acide, la pétrification et la métamorphose et reçoit un bonus de +2 aux [[DD]] des [[jet de sauvegarde|jets de sauvegarde]] ainsi qu’aux tests visant à pénétrer la [[RM|résistance à la magie]] des créatures du sous-type de la Loi.
...
**Sauvage contrecoup (Sur).** Au niveau 3, quand le personnage dissipe ou contre un sort adverse, le lanceur reçoit 1d6 points de dégâts + 1 par niveau du sort affecté (s’il se trouve à moins de 30 mètres (20{s:c})). Ce pouvoir de lignage remplace les résistances des protéens.
