---
Name: Pathfinder-RPG.Inventeur alchimiste (alchimiste)
Title: Inventeur alchimiste
LastModified: 2021-02-26 18:10
Categories:
- Archétype
- Archétype alchimiste
---

{s:Menuarchétypealchimiste}{s:AO}''Obnubilés par leurs recherches sur l’origine de la vie, les inventeurs
alchimistes construisent des créatures artificielles aux caractéristiques
...
<center>
{| CLASS="tablo"
|+ Caractéristique de base du compagnon homoncule {s:Reference|TABLECOMPAGNONHOMONCULE}
|- CLASS="titre"
| ROWSPAN="2" | Niveau
| ROWSPAN="2" | DV
| ROWSPAN="2" | BBA
| ROWSPAN="2" | Jets de sauvegardes
| ROWSPAN="2" | Compétences
| ROWSPAN="2" | Dons
| ROWSPAN="2" | Bonus Dex/For
...
{s:Reference|CONTACTTÉLÉPATHIQUE}
