---
Name: Pathfinder-RPG.Sage ésotérique (magicien)
Title: Sage ésotérique
LastModified: 2023-05-28 12:52
Categories:
- Archétype
- Archétype magicien
- Règle officielle
...
Une fois par jour, un sage ésotérique peut lancer de manière spontanée un sort extrait de la [liste des sorts de bardes](./Liste des sorts de bardes.md), [de prêtre](./Liste des sorts de prêtres.md) ou [de druide](./Liste des sorts de druides.md) comme si c’était un sort de magicien connu et préparé.
...
- Par exemple, si un sage ésotérique souhaite utiliser l’étude des sorts pour lancer *[soins légers](./Soins légers.md)* (sort de prêtre de niveau 1), le temps d’incantation dure 2 rounds entiers et il doit dépenser deux sorts de magicien préparés de niveau 1 ou plus.
