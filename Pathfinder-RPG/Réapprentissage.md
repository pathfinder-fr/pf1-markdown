...
- **L’alchimiste.** Changement d’une [[Alchimiste#DECOUVERTES|découverte]].
- **L’antipaladin.** Changement d’une [[Antipaladin#CRUAUTE|cruauté]] ou changement de [[Antipaladin#FAVEURDESFIELONS|faveur des fiélons]], remplaçant l’arme liée par un serviteur fiélon ou vice versa. 
- **Le barbare.** Changement d’un [[Barbare#POUVOIRDERAGE|pouvoir de rage]]. 
- **Le barde.** Changement d’un type de compétence [[Représentation]] associée à l’aptitude de classe de [[Barde#VERSATILITEARTISTIQUE|versatilité artistique]]. Voir également le [[Réapprentissage#RANGSDECOMPETENCE|changement de rangs de compétences]] et le [[Réapprentissage#SORTSCONNUS|changement de sorts connus]].
- **Le chevalier.** Changement d'[[Chevalier#ORDRE|ordre]]. Voir également le [[Réapprentissage#DONS|changement de dons]].
- **Le conjurateur.** Changement d’une [[Conjurateur#EIDOLON|évolution d’eidolon]] ou changement de la forme de base de son eidolon. Si l’eidolon a une évolution nécessitant sa forme de base originale, le personnage doit d’abord changer cette évolution pour une autre qui ne nécessite pas cette condition. Voir également le [[Réapprentissage#SORTSCONNUS|changement de sorts connus]].
- **Le druide.** Changement de [[Druide#PACTEAVECLANATURE|pacte avec la nature]]. Le personnage peut remplacer son domaine par un compagnon animal ou vice versa, ou changer un domaine : le nouveau domaine doit être accessible à sa classe ou à son archétype. Ce faisant, le personnage remplace sa liste de sorts de domaine et les pouvoirs accordés par son domaine.
- **L’ensorceleur.** Changement de [[Ensorceleur#LIGNAGE|lignage]]. Ce faisant, le personnage remplace ses sorts supplémentaires, ses arcanes de lignage, ses dons de lignage et ses pouvoirs de lignage. Cette formation prend 5 jours pour chaque don supplémentaire, arcane de lignage et pouvoir de lignage que le personnage perd en changeant de lignage. Voir également le [[Réapprentissage#DONS|changement de dons]] et le [[Réapprentissage#SORTSCONNUS|changement de sorts connus]]. 
- **Le guerrier.** Changement d’un groupe d’armes de guerrier que le personnage a choisi pour son aptitude de classe d'[[Guerrier#ENTRAINEMENTAUXARMES|entraînement aux armes]]. Voir également le [[Réapprentissage#DONS|changement de dons]]. 
- **l’inquisiteur.** Changement d’un [[Inquisiteur#DOMAINE|domaine]]. Le nouveau domaine doit être accordé par la divinité ou la philosophie du personnage. Ce faisant, le personnage remplace les pouvoirs accordés par son domaine. Voir également le [[Réapprentissage#DONS|changement de dons]] et le [[Réapprentissage#SORTSCONNUS|changement de sorts connus]].
- **Le magicien.** Changement de [[Magicien#PACTEMAGIQUE|pacte magique]] en remplaçant un objet lié par un autre, en remplaçant son objet lié par un familier ou en remplaçant son familier par un objet lié. Voir également le [[Réapprentissage#DONS|changement de dons]]. Sinon, le personnage peut changer son école de magie (y compris à partir d’une école universelle ou vers une école universelle). Ce faisant, le personnage remplace les emplacements de sorts supplémentaires de son école et les pouvoirs de son école. Cette formation prend 5 jours pour chaque pouvoir d’école que le personnage perd en changeant d’école.
- **Le magus.** Changement d’un [[Magus#ARCANE|arcane de magus]]. 
- **Le moine.** Voir le [[Réapprentissage#DONS|changement de dons]].
- **Le ninja.** Changement d’une [[Ninja#ASTUCEDENINJA|astuce de ninja]] ou d’une [[Ninja#ASTUCEDEMAÎTRE|astuce de maître]].
- **L’oracle.** Changement d’une [[Oracle#REVELATION|révélation]] ou changement du choix qui ajoute tous les sorts de *soins* ou tous les sorts de *blessure* à sa liste de sorts. Voir également le [[Réapprentissage#SORTSCONNUS|changement de sorts connus]].
- **Le paladin.** Changement d’une [[Paladin#GRACE|grâce]] ou changement du [[Paladin#PACTEDIVIN|pacte divin]] du personnage qui remplace alors son arme liée par une monture liée ou vice versa.
- **Le pistolier.** Changement d’un type d’armes à feu que le personnage a choisi pour son [[Pistolier#ENTRAÎNEMENTAUXARMESÀFEU|entraînement aux armes à feu]] ou changement d’un [[Pistolier#EXPLOITS|exploit]] que le personnage a choisi pour audace absolue. Voir également le [[Réapprentissage#DONS|changement de dons]].
- **Le prêtre.** Changement d’un [[Prêtre#DOMAINES|domaine]]. Le nouveau domaine doit être accessible via la divinité du personnage. Ce faisant, le personnage remplace sa liste de sorts de domaine et les pouvoirs accordés par son domaine. Si c’est un prêtre Neutre d’une divinité Neutre, il peut, à la place, changer le type d’énergie (positive ou négative) qu’il canalise, ce qui change également sa capacité à lancer spontanément soit des sorts de *soins*, soit des sorts de *blessure*.
- **Le rôdeur.** Changement d’un [[Rôdeur#ENNEMIJURE|ennemi juré]] (prend 5 jours pour chaque bonus de +2 dont bénéficie le personnage contre l’ennemi juré qu’il remplace), changement de [[Rôdeur#DONDESTYLEDECOMBAT|style de combat]] (remplace tous les dons supplémentaires de son style de combat actuel, prend 5 jours pour chaque don de style de combat qu’elle remplace), changement d'[[Rôdeur#ENVIRONNEMENTDEPREDILECTION|environnement de prédilection]] (prend 5 jours pour chaque bonus de +2 dont bénéficie le personnage dans l’environnement de prédilection qu’il remplace), ou changement de [[Rôdeur#PACTEDUCHASSEUR|pacte du chasseur]] (remplace son lien avec ses compagnons contre un compagnon animal ou vice versa). Voir également le [[Réapprentissage#DONS|changement de dons]].
- **Le roublard.** Changement d’un [[Roublard#TALENTDEROUBLARD|talent de roublard]] ou d’un [[Roublard#TALENTDEMAITREROUBLARD|talent de maître roublard]].
- **Le samouraï.** Changement de l’arme que le personnage a choisie pour son pouvoir de classe [[Samouraï#EXPERTISEMARTIALE|expertise martiale]], ou changement d'[[Samouraï#ORDRE|ordre de samouraï]]. Voir également le [[Réapprentissage#DONS|changement de dons]].
- **La sorcière.** Changement d’un [[Sorcière#MALEFICE|maléfice]], d’un [[Sorcière#MALEFICE|maléfice majeur]] ou d’un [[Sorcière#MALEFICE|grand maléfice]].
...
<p class="tablo-caption">Les synergies de réapprentissage</p>
...
</div></div>{s:FAQ|***[[FAQ- Guide de campagne#2|→]] Réapprentissage : Puis-je utiliser le réapprentissage pour changer mes classes de base et utiliser mes niveaux de classe de prestige pour remplir les conditions de ladite classe de prestige ?***

Non.
Les règles de <u>[[réapprentissage]]</u> indiquent « Si le réapprentissage d’un niveau de classe fait que le personnage ne se qualifie plus pour un don, une classe de prestige ou une autre des capacités qu’il possède, il ne bénéficie plus de ce don, de cette classe de prestige ou de cette capacité tant qu’il ne remplit plus les conditions requises ». Ainsi, si un personnage réentraîne sa classe de base et que cela a pour conséquence de ne plus remplir les conditions de la classe de prestige, il n’a plus accès aux capacités de classe de ladite classe de prestige, et ne peut donc pas l’utiliser pour remplir quelconque condition (y compris les siennes).
...
{s:Reference|DONS}
#### Les dons
{s:FAQ|***[[FAQ- Guide de campagne#1|→]] Réapprentissage : Puis-je réentraîner un don ou le remplacer par un don dont je ne remplissais pas les conditions au moment où je l’ai obtenu ?***
...
Par exemple, si le personnage est un roublard de niveau 3 qui a sélectionné [[Science de linitiative|Science de l’initiative]] au niveau 1, il peut réentraîner ce don et le remplacer par [[Arme de prédilection]]. Bien que Arme de prédilection possède la condition « BBA +1 » (qui signifie que le personnage ne pouvait pas le sélectionner en tant que roublard de niveau 1), c’est un don valide pour son niveau actuel (3), et est donc un choix valide pour le <u>[[réapprentissage]]</u>.
(Note : De la même façon, la capacité de classe du guerrier qui lui permet de [[Guerrier#DONSUPPLEMENTAIRE|remplacer ses dons supplémentaires de guerrier]] ne nécessite pas de remplir toutes les conditions du nouveau don au niveau où il a été obtenu à l’origine.)}Le personnage peut changer un don pour un autre grâce au réapprentissage. Pour rapprendre un don, il doit passer 5 jours avec un personnage ayant le don voulu. L’ancien don ne peut pas être une condition requise pour un don, une classe de prestige, un archétype, une classe de prestige ou une autre capacité que possède le personnage. Si l’ancien don est un don supplémentaire accordé par une aptitude de classe, le personnage doit le remplacer par un don qu’il pourrait prendre avec cette aptitude de classe.
