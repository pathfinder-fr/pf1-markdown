...
Pour abandonner un archétype, le personnage doit passer cinq jours pour chaque aptitude de classe alternative qu’il possède déjà pour cet archétype. À la fin du réapprentissage, le personnage perd les aptitudes de classe de l’archétype et gagne les aptitudes de classe normales de la classe.
...
- *Exemple.* Le guerrier de niveau 4 de Logan possède l’archétype archer. Étant de niveau 4, il possède deux aptitudes de classe alternatives de cet archétype (Œil de faucon au niveau 2 et coup vicieux au niveau 3) donc il doit passer 10 jours et dépenser 400 po pour changer de formation et abandonner cet archétype. S’il était de niveau 5, il aurait également l’aptitude de classe alternative expert à l’arc, ce qui monterait le temps de sa formation à 15 jours et son coût à 750 po.


#### Les aptitudes de classe
Nombre des choix que vous faites au niveau des aptitudes de classe de votre personnage peuvent être sujets à un réapprentissage. Il faut 5 jours pour changer une aptitude de classe. Le réapprentissage nécessite de passer du temps avec un personnage de sa classe dont le niveau de classe est supérieur d’au moins 1 à celui du personnage et qui possède l’aptitude de classe voulue. Par exemple, si votre personnage est un magicien illusionniste de niveau 5 souhaitant devenir un nécromancien, il doit être formé par un nécromancien qui sera au moins de niveau 6.
...
- **L’alchimiste.** Changement d’une [découverte](./Alchimiste.md#DECOUVERTES).
- **L’antipaladin.** Changement d’une [cruauté](./Antipaladin.md#CRUAUTE) ou changement de [faveur des fiélons](./Antipaladin.md#FAVEURDESFIELONS), remplaçant l’arme liée par un serviteur fiélon ou vice versa. 
- **Le barbare.** Changement d’un [pouvoir de rage](./Barbare.md#POUVOIRDERAGE). 
- **Le barde.** Changement d’un type de compétence [Représentation](./Représentation.md) associée à l’aptitude de classe de [versatilité artistique](./Barde.md#VERSATILITEARTISTIQUE). Voir également le [changement de rangs de compétences](./Réapprentissage.md#RANGSDECOMPETENCE) et le [changement de sorts connus](./Réapprentissage.md#SORTSCONNUS).
- **Le chevalier.** Changement d'[ordre](./Chevalier.md#ORDRE). Voir également le [changement de dons](./Réapprentissage.md#DONS).
- **Le conjurateur.** Changement d’une [évolution d’eidolon](./Conjurateur.md#EIDOLON) ou changement de la forme de base de son eidolon. Si l’eidolon a une évolution nécessitant sa forme de base originale, le personnage doit d’abord changer cette évolution pour une autre qui ne nécessite pas cette condition. Voir également le [changement de sorts connus](./Réapprentissage.md#SORTSCONNUS).
- **Le druide.** Changement de [pacte avec la nature](./Druide.md#PACTEAVECLANATURE). Le personnage peut remplacer son domaine par un compagnon animal ou vice versa, ou changer un domaine : le nouveau domaine doit être accessible à sa classe ou à son archétype. Ce faisant, le personnage remplace sa liste de sorts de domaine et les pouvoirs accordés par son domaine.
- **L’ensorceleur.** Changement de [lignage](./Ensorceleur.md#LIGNAGE). Ce faisant, le personnage remplace ses sorts supplémentaires, ses arcanes de lignage, ses dons de lignage et ses pouvoirs de lignage. Cette formation prend 5 jours pour chaque don supplémentaire, arcane de lignage et pouvoir de lignage que le personnage perd en changeant de lignage. Voir également le [changement de dons](./Réapprentissage.md#DONS) et le [changement de sorts connus](./Réapprentissage.md#SORTSCONNUS). 
- **Le guerrier.** Changement d’un groupe d’armes de guerrier que le personnage a choisi pour son aptitude de classe d'[entraînement aux armes](./Guerrier.md#ENTRAINEMENTAUXARMES). Voir également le [changement de dons](./Réapprentissage.md#DONS). 
- **l’inquisiteur.** Changement d’un [domaine](./Inquisiteur.md#DOMAINE). Le nouveau domaine doit être accordé par la divinité ou la philosophie du personnage. Ce faisant, le personnage remplace les pouvoirs accordés par son domaine. Voir également le [changement de dons](./Réapprentissage.md#DONS) et le [changement de sorts connus](./Réapprentissage.md#SORTSCONNUS).
- **Le magicien.** Changement de [pacte magique](./Magicien.md#PACTEMAGIQUE) en remplaçant un objet lié par un autre, en remplaçant son objet lié par un familier ou en remplaçant son familier par un objet lié. Voir également le [changement de dons](./Réapprentissage.md#DONS). Sinon, le personnage peut changer son école de magie (y compris à partir d’une école universelle ou vers une école universelle). Ce faisant, le personnage remplace les emplacements de sorts supplémentaires de son école et les pouvoirs de son école. Cette formation prend 5 jours pour chaque pouvoir d’école que le personnage perd en changeant d’école.
- **Le magus.** Changement d’un [arcane de magus](./Magus.md#ARCANE). 
- **Le moine.** Voir le [changement de dons](./Réapprentissage.md#DONS).
- **Le ninja.** Changement d’une [astuce de ninja](./Ninja.md#ASTUCEDENINJA) ou d’une [astuce de maître](./Ninja.md#ASTUCEDEMAÎTRE).
- **L’oracle.** Changement d’une [révélation](./Oracle.md#REVELATION) ou changement du choix qui ajoute tous les sorts de *soins* ou tous les sorts de *blessure* à sa liste de sorts. Voir également le [changement de sorts connus](./Réapprentissage.md#SORTSCONNUS).
- **Le paladin.** Changement d’une [grâce](./Paladin.md#GRACE) ou changement du [pacte divin](./Paladin.md#PACTEDIVIN) du personnage qui remplace alors son arme liée par une monture liée ou vice versa.
- **Le pistolier.** Changement d’un type d’armes à feu que le personnage a choisi pour son [entraînement aux armes à feu](./Pistolier.md#ENTRAÎNEMENTAUXARMESÀFEU) ou changement d’un [exploit](./Pistolier.md#EXPLOITS) que le personnage a choisi pour audace absolue. Voir également le [changement de dons](./Réapprentissage.md#DONS).
- **Le prêtre.** Changement d’un [domaine](./Prêtre.md#DOMAINES). Le nouveau domaine doit être accessible via la divinité du personnage. Ce faisant, le personnage remplace sa liste de sorts de domaine et les pouvoirs accordés par son domaine. Si c’est un prêtre Neutre d’une divinité Neutre, il peut, à la place, changer le type d’énergie (positive ou négative) qu’il canalise, ce qui change également sa capacité à lancer spontanément soit des sorts de *soins*, soit des sorts de *blessure*.
- **Le rôdeur.** Changement d’un [ennemi juré](./Rôdeur.md#ENNEMIJURE) (prend 5 jours pour chaque bonus de +2 dont bénéficie le personnage contre l’ennemi juré qu’il remplace), changement de [style de combat](./Rôdeur.md#DONDESTYLEDECOMBAT) (remplace tous les dons supplémentaires de son style de combat actuel, prend 5 jours pour chaque don de style de combat qu’elle remplace), changement d'[environnement de prédilection](./Rôdeur.md#ENVIRONNEMENTDEPREDILECTION) (prend 5 jours pour chaque bonus de +2 dont bénéficie le personnage dans l’environnement de prédilection qu’il remplace), ou changement de [pacte du chasseur](./Rôdeur.md#PACTEDUCHASSEUR) (remplace son lien avec ses compagnons contre un compagnon animal ou vice versa). Voir également le [changement de dons](./Réapprentissage.md#DONS).
- **Le roublard.** Changement d’un [talent de roublard](./Roublard.md#TALENTDEROUBLARD) ou d’un [talent de maître roublard](./Roublard.md#TALENTDEMAITREROUBLARD).
- **Le samouraï.** Changement de l’arme que le personnage a choisie pour son pouvoir de classe [expertise martiale](./Samouraï.md#EXPERTISEMARTIALE), ou changement d'[ordre de samouraï](./Samouraï.md#ORDRE). Voir également le [changement de dons](./Réapprentissage.md#DONS).
- **La sorcière.** Changement d’un [maléfice](./Sorcière.md#MALEFICE), d’un [maléfice majeur](./Sorcière.md#MALEFICE) ou d’un [grand maléfice](./Sorcière.md#MALEFICE).
...
|}
</div></div>{s:FAQ|***[→](./FAQ- Guide de campagne.md#2) Réapprentissage : Puis-je utiliser le réapprentissage pour changer mes classes de base et utiliser mes niveaux de classe de prestige pour remplir les conditions de ladite classe de prestige ?***

Non.
Les règles de <u>[réapprentissage](./Réapprentissage.md)</u> indiquent « Si le réapprentissage d’un niveau de classe fait que le personnage ne se qualifie plus pour un don, une classe de prestige ou une autre des capacités qu’il possède, il ne bénéficie plus de ce don, de cette classe de prestige ou de cette capacité tant qu’il ne remplit plus les conditions requises ». Ainsi, si un personnage réentraîne sa classe de base et que cela a pour conséquence de ne plus remplir les conditions de la classe de prestige, il n’a plus accès aux capacités de classe de ladite classe de prestige, et ne peut donc pas l’utiliser pour remplir quelconque condition (y compris les siennes).
Mise à jour 16/10/2023 : Dans tous les cas, il est impossible d’utiliser des éléments de règle d’une classe de prestige pour remplir les conditions de cette classe de prestige.
Mise à jour 16/10/2023 : Nouvelle décision : Il est impossible d’utiliser le réapprentissage pour remplacer un niveau de classe de base par un niveau de classe de prestige.}L’un des choix les plus critiques qu’il vous faut faire à propos de votre personnage, c’est la classe qu’il prend quand il gagne un niveau.

En général, il faut 7 jours pour échanger un niveau dans une classe contre un niveau dans une autre classe. Certaines classes sont plus adaptées que d’autres à ce genre de réapprentissage puisqu’elles ont un objectif ou un intérêt similaire : c’est ce que l’on appelle la synergie de réapprentissage. Si l’ancienne classe du personnage présente une synergie de réapprentissage avec sa nouvelle classe, le changement de ce niveau de classe ne prend que 5 jours au lieu de 7. Déterminez les synergies de réapprentissage en vous appuyant sur la table ci-contre.
...
Pour réapprendre quelque chose, il faut passer du temps avec quelqu’un ayant au moins 1 niveau de plus que le personnage dans la classe pour laquelle il souhaite changer de formation. S’il n’y a pas le moindre instructeur disponible (si le personnage a, par exemple, atteint le plus haut niveau dans sa classe), il peut changer de formation sans instructeur en y passant le double du temps requis.

Quand le personnage change de formation pour un niveau de classe, il perd tous les avantages du plus haut niveau qu’il a dans cette classe. Il choisit aussitôt une autre classe, y ajoute un niveau et bénéficie de tous les avantages de ce nouveau niveau de classe.

Ce réapprentissage ne permet pas au personnage de reprendre les dons qu’il a gagnés aux niveaux impairs ni les augmentations de valeurs de caractéristiques qu’il a gagnées tous les quatre niveaux (mais il peut changer ces options indépendamment). Si le réapprentissage pour un niveau de classe fait que le personnage ne se qualifie plus pour un don, une classe de prestige ou une autre des capacités qu’il possède, il ne bénéficie plus de ce don, de cette classe de prestige ou de cette capacité tant qu’il ne remplit plus les conditions requises (il peut quand même changer ce don, cette classe de prestige ou cette capacité).
...
{s:Reference|DONS}
#### Les dons
{s:FAQ|***[→](./FAQ- Guide de campagne.md#1) Réapprentissage : Puis-je réentraîner un don ou le remplacer par un don dont je ne remplissais pas les conditions au moment où je l’ai obtenu ?***

Oui. Tant que le nouveau don est un choix valide pour le personnage tel qu’il est actuellement, il est possible de réentraîner l’ancien don pour le remplacer par le nouveau don.
Par exemple, si le personnage est un roublard de niveau 3 qui a sélectionné [Science de l’initiative](./Science de linitiative.md) au niveau 1, il peut réentraîner ce don et le remplacer par [Arme de prédilection](./Arme de prédilection.md). Bien que Arme de prédilection possède la condition « BBA +1 » (qui signifie que le personnage ne pouvait pas le sélectionner en tant que roublard de niveau 1), c’est un don valide pour son niveau actuel (3), et est donc un choix valide pour le <u>[réapprentissage](./Réapprentissage.md)</u>.
(Note : De la même façon, la capacité de classe du guerrier qui lui permet de [remplacer ses dons supplémentaires de guerrier](./Guerrier.md#DONSUPPLEMENTAIRE) ne nécessite pas de remplir toutes les conditions du nouveau don au niveau où il a été obtenu à l’origine.)}Le personnage peut changer un don pour un autre grâce au réapprentissage. Pour rapprendre un don, il doit passer 5 jours avec un personnage ayant le don voulu. L’ancien don ne peut pas être une condition requise pour un don, une classe de prestige, un archétype, une classe de prestige ou une autre capacité que possède le personnage. Si l’ancien don est un don supplémentaire accordé par une aptitude de classe, le personnage doit le remplacer par un don qu’il pourrait prendre avec cette aptitude de classe.
...
La nouvelle langue ne compte pas dans le nombre maximum de langues (langues raciales + langues supplémentaires d’[Intelligence](./Intelligence.md) + rangs en [Linguistique](./Linguistique.md)). Le personnage ne peut suivre ce genre de formation qu’un nombre de fois égal à 1 + son bonus d’Intelligence.
