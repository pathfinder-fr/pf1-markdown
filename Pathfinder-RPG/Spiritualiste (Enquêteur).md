...
Au niveau 5, il peut utiliser *[[augure]]*. Au niveau 7, il peut utiliser *[[communication avec les morts]]* et *[[localisation dobjet|localisation d’objet]]*. Au niveau 9, il peut utiliser *[[mythes et légendes]]*. L’incantation de ces sorts dépense une utilisation de cette aptitude.
...
Au niveau 2, quand un spiritualiste effectue un [[jet de sauvegarde]] contre un pouvoir ou un effet produit par une créature intangible, il peut dépenser une utilisation de son inspiration au lieu de deux pour améliorer ce jet de sauvegarde. Si le spiritualiste possède le talent d’enquêteur [[Talents (enquêteur)#INSPIRATIONMARTIALE|inspiration martiale]], il n’est pas nécessaire qu’il dépense de l’inspiration pour améliorer ce [[jet de sauvegarde]]. Cette aptitude remplace connaissance des poisons.
