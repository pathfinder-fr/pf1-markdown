...
« Tsukumogami » est un archétype acquis qui s’ajoute à n’importe quel [[objet animé]] (ensuite appelé créature de base). Le tsukumogami conserve les statistiques et pouvoirs spéciaux de la créature de base, à l’exception de ce qui suit.
- **Facteur de puissance.** FP de la créature de base +2.
- **Alignement.** Au choix.
- **Type.** Le type de la créature devient [[type Extérieur|extérieur]] ([[sous-type Kami|kami]], [[sous-type Natif|natif]]). Un tsukumogami a des jets de [[Réflexes]] et de [[Volonté]] favorables, augmentez donc ceux de la créature de base de manière à atteindre la valeur suivante : 2 + la moitié de ses [[DV]] + son modificateur de caractéristique approprié.
