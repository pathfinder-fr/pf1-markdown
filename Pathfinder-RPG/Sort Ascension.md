---
Name: Pathfinder-RPG.Sort Ascension
Title: Ascension
LastModified: 2026-04-26 03:26
Categories:
- Magie
- Règle officielle
- Sort
...
### Mythique
Si le personnage dépense une utilisation de [[pouvoir mythique]] lorsqu’il lance ce sort, la durée s’élève à 1 jour par niveau et le personnage peut faire de sa propre personne le focaliseur du sort au lieu d’utiliser un [[Artefacts#Les_artefacts_mineurs_2|artefact mineur]]. Le cas échéant, les cibles conservent leur [[grade]] mythique tant qu’elles restent à 30 mètres ou moins de lui. Si le personnage meurt, le sort prend fin immédiatement et toutes les cibles reçoivent 1d4 [[niveau négatif|niveaux négatifs]] permanents.
