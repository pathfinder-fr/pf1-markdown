---
Name: Pathfinder-RPG.Aperçu
Title: Un aperçu de Pathfinder RPG
LastModified: 2010-07-21 00:18
Categories:
- Divers
---

{s:MenuDécouverte}<center>{s:ImageCentre|%2fLogos%2fPathfinder%20RPG.png|50%}</center>
...
<div style="width: 250px; float: right;">{s:ADJ|PRESENT|Présentation de Pathfinder|%2fADJ%2fPathfinder-RPG%2fPresentMini.jpg|%2fADJ%2fPathfinder-RPG%2fPresent.swf|Une mini-présentation des différences entre Pathfinder et 3.5 (lecture en ligne)|Dalvyn|right}</div> Si vous connaissez les règles de la version 3.5, vous n'aurez aucun mal à vous adaptez à Pathfinder. Voici quelques unes des principales différences entre ces versions.
