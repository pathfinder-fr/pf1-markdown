---
Name: Pathfinder-RPG.Creer des familiers
Title: Créer des nouveaux familiers
...
Le tableau des familiers approximatifs présente les familiers animaux qui se prêtent le mieux à la représentation d’autres types de créatures, propose des exemples de créatures qu’ils pourraient représenter, et indique les sources contenant les profils des animaux de base. Les suggestions accompagnant chaque entrée ne sont bien entendu pas exhaustives ; elles servent uniquement de lignes directrices pour vous aider à concevoir le familier idéal pour votre personnage.

## Méthode avancée

Vous pourriez souhaiter un familier radicalement différent de toutes les autres créatures de la liste. Dans ce cas, le mieux consiste à choisir le familier qui se rapproche le plus de ce que vous recherchez, puis à travailler avec votre MJ afin de déterminer des substitutions d’aptitudes ou des modifications de caractéristiques appropriées, de manière à faire correspondre le profil au familier que vous imaginez. N’oubliez pas de toujours obtenir l’accord de votre MJ avant de modifier le profil d’une créature ou d’utiliser des éléments de règles maison au cours de la partie.

Vous devrez bien maîtriser les règles figurant dans les appendices du Bestiaire afin de créer une créature équilibrée. Même si vos calculs sont irréprochables, votre MJ peut néanmoins décider que la créature obtenue est trop puissante. En règle générale, moins les modifications apportées à la créature de base de votre familier sont importantes, plus le résultat sera équilibré. Avant d’ajuster les caractéristiques d’un familier, les joueurs devraient toujours avoir un thème précis en tête, de préférence un concept visant à créer un familier appartenant à un type existant, mais doté de compétences légèrement spécialisées. Les créatures uniques qui restent relativement naturelles tout en étant liées à l’histoire personnelle d’un personnage font également de bons concepts.

Les joueurs qui envisagent de modifier un familier existant devraient considérer une ou plusieurs des modifications suivantes, classées de la moins influente à la plus importante pour les mécanismes de jeu.
...
Vitesse : il est généralement préférable d’éviter de modifier les modes ou les vitesses de déplacement d’une créature. Cela peut toutefois rester relativement sûr si vous remplacez une vitesse de déplacement inhabituelle, comme une vitesse de creusement de 3 mètres, par une autre vitesse inhabituelle de valeur équivalente, comme une vitesse d’escalade de 3 mètres. Il est également possible de réduire la vitesse de déplacement terrestre de base de la créature afin de lui accorder un mode de déplacement inhabituel, par exemple en réduisant une vitesse terrestre de 12 mètres à 3 mètres afin de lui accorder une vitesse de nage de 9 mètres.

Valeurs de caractéristique : modifier les valeurs de caractéristique d’une créature constitue le moyen le plus sûr de créer accidentellement une créature déséquilibrée. Cette pratique n’est donc pas recommandée pour concevoir de nouveaux familiers.
