---
Name: Pathfinder-RPG.Classes de prestige
Title: Les classes de prestige
LastModified: 2024-08-27 07:14
Categories:
- Classe de prestige
- Règle officielle
...
- [[Acolyte de la Foi verte|Acolyte de la Nature]] (*PP*). Membre talentueux d'un ordre druidique.
...
- [[Agent de la Cour des ombres|Agent de l'Ombre]] (*PP*). Saboteur discret de l'État serviteur de l'Ombre.
- [[Agent de terrain des Éclaireurs|Agent de terrain des Explorateurs]] (RSE). Équippé d'une grande variété de compétences et entraîné à garder la tête froide même dans les situations les plus tendues, un agent de terrain accompli est une bénédiction pour un groupe d'aventuriers.
- [[Agent du Consortium de lAspis|Agent du consortium]] (*PP*). Mercenaire et chasseur de primes sans scrupule.
- [[Agent du Réseau Campanule|Agent du réseau]] (*PP*). Halfelin combattant pour la liberté à l'Empire diabolique.
- [[Arcaniste de Magaambya|Arcaniste de l'académie du Vieux-Mage]] (*PP*). Apprenti bienveillant du Vieux-Mage.
...
- [[Arpenteur dhorizon|Arpenteur d'horizon]] (MJRA). Un scout et un vagabond à l'aise même dans les environnements les plus étranges.
- [[Aspirant à lIllumination|Aspirant à l'Illumination]] (MR). Voyant adoré du peuple elfe.
- [[Assassin des mantes rouges|Assassin pourpre]] (CCMI). Assassin d'élite du culte des assassins pourpres.
...
- [[Jardinier gris|Bourreau gris]] (*PP*). Agent meurtrier du conseil dirigant de la Révolution éternelle.
- [[Buveur dâmes|Buveur d'âmes]] (LD). Dévoué aux Cavaliers de l'Apocalypse, le buveur d'âmes verse dans les pires travers de la magie daémonique afin de pouvoir lier et dévorer des âmes.
- [[Champion dIrori|Champion de la perfection]] (*PP*). Dévot maître du combat rapproché.
...
- [[Chevalier dOzem|Chevalier de la vie]] (*PP*). Destructeur de morts-vivants zélé.
...
- [[Prophète de Kalistrade|Disciple des Prophéties]] (*PP*). Lanceur de sorts doué en affaires.
...
- [[Dissident de la Fleur de laube|Dissident de l'aube]] (*PP*). Émissaire secret de la déesse-ange du soleil.
...
- [[Empoisonneur de Dague|Empoisonneur de la guilde]] (*PP*). Toxicologue habile et sournois.
...
- [[Estimateur dAbadar|Estimateur légal]] (CSU). Chercheur de trésors fidèle au dieu de la civilisation.
...
- [[Éclaireur explorateur|Explorateur]] (RSE). Grand passionné d'aventures de la Compagnie des Explorateurs.
- [[Éclaireur savant|Explorateur savant]] (RSE). Maître sage de la Compagnie des Explorateurs.
- [[Prêtre razmirien|Faux prêtre]] (*PP*). Faux lanceur de sorts divins du faux-dieu.
...
- [[Légionnaire doré|Garde de la liberté]] (*PP*). Protecteur haut placé du Berceau de la liberté.
...
- [[Chevalier infernal|Légionnaire infernal]] (CCMI). Executeur de la loi discipliné.
...
- [[Faucon dacier|Missionnaire de la liberté]] (RSE). Membre de la force militaire d'élite du Berceau de la liberté.
...
- [[Pirate de la Mer intérieure|Pirate de Haute mer]] (PMI). Pirate talentueux des Îles pirates.
...
- [[Seigneur de lArche du Nex|Seigneur de l'arche]] (*PP*). Devin de la Grande magiocratie officiellement formé.
- [[Seigneur des épées aldori|Seigneur des épées]] (*PP*). Duelliste discipliné du Royaume divisé.
...
- [[Sorcière de lhiver|Sorcière de l'hiver]] (*PP*). Maître de la glace et de la neige.
- [[Templier déchu|Templier parjure]] (CCMI). Croisé zélé combattant les rejetons de la Faille démoniaque.
...
- [[Liseuse de tourment|Voyante]] (CCMI). Lanceur de sorts capable de mêler les cartes du destin à ses sorts.

{s:Reference|DEFINITIONS}
...
**Classe de base.** L’une des [[classes|classes accessibles aux nouveaux personnages]] au moment de leur création.
