---
Name: Pathfinder-RPG.Combat de spectacle
Title: Les combats de spectacle
LastModified: 2025-08-05 19:51
Categories:
- Règle officielle
- Src Art de la guerre
---

{s:MenuCombat}<div style="float: right; padding: 0 0 8px 8px"><nav class="wiki-toc"></nav></div>{s:UC}La survie n’est pas l’enjeu de tous les affrontements. Les guerriers participent parfois à des combats où la réaction de la foule est aussi importante que l’issue de la bataille. Qu’il s’agisse d’une bagarre de comptoir dont le but est de soulever la populace pour se dresser contre une bande de tyrans ou d’une arène ensanglantée brûlée par le soleil où la vie et la mort dépendent des faveurs de la foule, lors d’un combat de spectacle, il vaut mieux avoir un style artistique et théâtral que faire preuve d’une efficacité impitoyable.
...
{s:Reference|TYPECOMBATSPECTACLE}
...
**À mort.** Ces combats se terminent seulement à la [Pathfinder-RPG.mort|mort] de l’un des camps. Parfois, la réaction de la foule n’a aucun effet sur la bataille en cours mais d’autres fois, elle agit réellement sur l’issue du combat. Certains sports sanglants imposent au vainqueur de retenir son bras avant de porter le coup de grâce pour que la foule puisse exprimer son plaisir ou sa désapprobation, généralement avec un tonnerre d’applaudissements, en levant ou en baissant le pouce. Les pouces en l’air autorisent le vaincu à survivre et à se battre plus tard, des pouces tournés vers le bas mettent un terme au combat dans une gerbe de sang.

**Avec un objectif.** Ces combats élaborés reconstituent une bataille historique ou opposent juste les combattants aux dangers et aux pièges du terrain. Qu’il s’agisse d’une course (qui mêle les règles du combat de spectacle à celles des [Pathfinder-RPG.Véhicules en combat|combats en véhicule]) ou d’un combat où il faut capturer un drapeau, ce type d’affrontement teste les aptitudes des participants à atteindre un objectif donné.

**Combats chorégraphiés.** Ces combats sont moins dangereux que les victoires par KO. Les combattants s’arrangent pour porter des coups qui effleurent à peine leur adversaire, qui n’infligent pas de dégâts, ni létaux ni non létaux, mais la réaction de la foule se détermine comme d’habitude. Ce type de combat demande généralement beaucoup d’entraînement (voir le don [Pathfinder-RPG.Combat chorégraphié|Combat chorégraphié]). Une personne peut participer à ce genre de combat sans y être entraînée mais elle subit un malus de -6 aux jets d’attaque pour faire croire que ses attaques touchent sans infliger de points de dégâts.
...
Quand le personnage utilise une [arme de spectacle](./Caractéristiques des armes.md#SPECTACLE), il gagne un bonus de +2 aux tests de combat de spectacle. Certains dons, sorts et autres peuvent aussi apporter un bonus au test.

Quand le personnage réussit un test de manoeuvre de spectacle, l’attitude de la foule s’améliore d’un cran. Contrairement aux tests de compétence, si le personnage fait un 20 naturel, il réussit automatiquement. S’il rate son test de moins de 5, l’attitude de la foule ne change pas mais si c’est raté de 5 ou plus, elle empire d’un cran. C’est l’attitude actuelle du public qui détermine le [Pathfinder-RPG.DD|DD] du test, avec quelques ajustements en fonction des circonstances dans lesquelles le personnage effectue le test. Si la foule est serviable, un test réussi rapporte 1 [Pathfinder-RPG.Combat de spectacle|point de victoire].
...
| Amical || 15
|-
| Serviable || 20<sup>[1](./Combat de spectacle.md#NOTE1)</sup>
|- CLASS="note"
...
- *Public ordinaire.* Ce public compte entre 26 et 100 créatures. Il augmente le [Pathfinder-RPG.DD|DD] des tests de combat de spectacle de +2.

- *Large public.* Le public regroupe de 101 à 300 créatures et augmente le [Pathfinder-RPG.DD|DD] des tests de combat de spectacle de +3.

- *Public très nombreux.* Le public rassemble au moins 301 créatures et peut atteindre des milliers de spectateurs. Il augmente le [Pathfinder-RPG.DD|DD] des tests de combat de spectacle de +4.


**Nombre total de combattants.** Quand le combat rassemble beaucoup de participants, ils ont plus de mal à gagner les faveurs de la foule car cette dernière peine à suivre tout ce qui se passe sur le champ de bataille et à repérer les actions d’éclat individuelles qui pourraient changer son attitude. Ajustez le modificateur quand des combattants entrent en lice ou sortent.
- *Petite bataille.* Si la bataille compte de 2 à 8 participants, le [Pathfinder-RPG.DD|DD] des tests qui permettent de modifier l’attitude de la foule ou de gagner des [Pathfinder-RPG.Combat de spectacle|points de victoire] ne change pas.

- *Bataille normale.* Si le combat rassemble de 9 à 16 participants, le [Pathfinder-RPG.DD|DD] des tests qui permettent de modifier l’attitude de la foule ou de gagner des [Pathfinder-RPG.Combat de spectacle|points de victoire] augmente de +4.

- *Grande bataille.* Si le combat compte 17 combattants ou plus, le [Pathfinder-RPG.DD|DD] des tests qui permettent de modifier l’attitude de la foule ou de gagner des [Pathfinder-RPG.Combat de spectacle|points de victoire] augmente de +8.
...
Pour qu’un combattant modifie l’attitude de la foule, il doit accomplir une action d’éclat ostensible, capable de faire évoluer l’attitude du public. Si la foule ne voit pas le personnage (parce qu’il bénéficie d’un [Pathfinder-RPG.camouflage total|camouflage total], de l’*[Pathfinder-RPG.invisibilité|invisibilité]*, d’un [Pathfinder-RPG.abri partiel|abri amélioré] ou d’un [Pathfinder-RPG.abri total|abri total]), ce dernier ne peut pas modifier son attitude. En revanche, le camouflage et les autres formes d’abri ne l’empêchent pas d’affecter la foule.

Quand un combattant réussit un mouvement ou déclenche un des déclencheurs décrits dans la partie suivante, il peut améliorer l’attitude de la foule avec un test de combat de spectacle par une [Pathfinder-RPG.action rapide|action rapide] (ou une [Pathfinder-RPG.action libre|action libre] si la créature possède le don [Pathfinder-RPG.Maître du combat de spectacle|Maître du combat de spectacle]). L’action rapide se traduit généralement par un mouvement épique, une démonstration pleine de panache, quelque chose qui retient l’attention des spectateurs. Si le personnage possède un don de spectacle, l’action qui déclenche le test comprend parfois un déplacement ou un effet. De temps à autre, le test de combat de spectacle demande une [Pathfinder-RPG.action libre|action libre] ou [Pathfinder-RPG.action immédiate|immédiate]. Si le personnage opte pour une [Pathfinder-RPG.action libre|action libre], il ne peut pas faire d’action spéciale liée à un don de spectacle (à moins d’avoir le don [Pathfinder-RPG.Maître du combat de spectacle|Maître du combat de spectacle]). S’il choisit une [Pathfinder-RPG.action immédiate|action immédiate] ou pas d’action du tout, il n’a pas droit à la moindre action spéciale, pas même avec [Pathfinder-RPG.Maître du combat de spectacle|Maître du combat de spectacle].
...
{s:Reference|TESTACTIONRAPIDE}
### Tests d’action rapide
Les déclencheurs suivants permettent à un personnage qui participe à un combat de spectacle de faire un test de combat de spectacle par une [Pathfinder-RPG.action rapide|action rapide]. Il peut toujours refuser de faire un test de combat de spectacle qui demande une [Pathfinder-RPG.action rapide|action rapide]. Certains dons, appelés des dons de spectacle, permettent à un personnage d’accomplir une action supplémentaire lors du test. Ces dons figurent dans le chapitre 2.

**Attaques multiples.** Si un combattant a droit à plusieurs attaques à son tour et qu’il touche avec au moins deux d’entre elles, il peut faire un test de combat de spectacle par une [Pathfinder-RPG.action rapide|action rapide]. Il gagne un bonus de +2 au test pour chaque attaque qui touche en plus de la deuxième.

**Charge.** Quand un combattant touche son adversaire lors d’une [Pathfinder-RPG.charge|charge], il peut faire un test de combat de spectacle par une [Pathfinder-RPG.action rapide|action rapide].

**Faire tomber son adversaire.** Quand un combattant renverse son adversaire, il peut faire un test de combat de spectacle par une [Pathfinder-RPG.action rapide|action rapide].

**Feinte.** Si un combattant réussit une [Pathfinder-RPG.feinte|feinte], il peut faire un test de combat de spectacle par une [Pathfinder-RPG.action rapide|action rapide].

**Infliger un maximum de dégâts.** Quand un combattant inflige les dégâts maximaux lors d’un jet de dégâts (avec une arme, un sort mais pas avec une [Pathfinder-RPG.roublard|attaque sournoise] ou d’autres dégâts de précision variable), il peut faire un test de combat de spectacle par une [Pathfinder-RPG.action rapide|action rapide]. Il gagne un bonus ou un malus au test en fonction du type d’arme ou de sort qu’il utilise. Une [Pathfinder-RPG.arme légère|arme légère] impose un malus de -4 au test, une [Pathfinder-RPG.arme à une main|arme à une main] n’a aucun effet et une arme exotique ou à deux mains donne un bonus de circonstances de +2. Les sorts donnent un bonus au test égal à la moitié de leur niveau.

**Manœuvre offensive.** Quand un combattant réussit une [Pathfinder-RPG.manoeuvre offensive|manoeuvre offensive], il peut faire un test de combat de spectacle par une [Pathfinder-RPG.action rapide|action rapide].

**Sorts et effets d’énergie.** La foule aime les sorts et les effets voyants. Si un combattant lance un sort ou utilise un effet qui produit des dégâts visibles d’[Pathfinder-RPG.registre|acide], d’[Pathfinder-RPG.registre|électricité], de [Pathfinder-RPG.registre|feu], de [Pathfinder-RPG.registre|force], de [Pathfinder-RPG.registre|froid] ou de [Pathfinder-RPG.registre|son] (ce qui fonctionne aussi avec les propriétés spéciales des armes comme de [Pathfinder-RPG.feu intense (propriété)|feu intense] ou de [Pathfinder-RPG.foudre intense (propriété)|foudre intense] qui provoquent une explosion d’énergie en cas de [Pathfinder-RPG.coup critique|coup critique]), il peut faire un test de combat de spectacle par une [Pathfinder-RPG.action rapide|action rapide].

{s:Reference|TESTACTIONLIBRE}{s:Reference|TESTACTIONIMMEDIATE}
### Tests d’action libre ou immédiate
Les déclencheurs suivants permettent à un combattant de faire un test de combat de spectacle par une [Pathfinder-RPG.action libre|action libre] ou [Pathfinder-RPG.action immédiate|immédiate]. Il peut décider d’y consacrer une [Pathfinder-RPG.action rapide|action rapide] et bénéficier ainsi de ses dons de spectacle. Il peut toujours refuser de faire un test de combat de spectacle qui demande une [Pathfinder-RPG.action libre|action libre] ou [Pathfinder-RPG.action immédiate|immédiate]. Il peut aussi dépenser 1 [Pathfinder-RPG.Combat de spectacle|point de victoire] pour faire ce test par une [Pathfinder-RPG.action libre|action libre] en dehors de son tour, ce qui lui évite de dépenser une [Pathfinder-RPG.action immédiate|action immédiate].

**Coup critique.** Quand le personnage confirme un [Pathfinder-RPG.coup critique|coup critique], il peut faire un test de combat de spectacle par une [Pathfinder-RPG.action libre|action libre] ou [Pathfinder-RPG.action immédiate|immédiate]. Dans ce cas, s’il échoue de 5 ou plus, l’attitude de la foule ne se dégrade pas. S’il bénéficie d’un effet spécial grâce à un don de critique, il gagne un bonus de +2 au test de combat de spectacle.

**Enragé.** Le premier personnage qui s’[Pathfinder-RPG.barbare|enrage] lors d’un combat de spectacle peut faire un test de combat de spectacle par une [Pathfinder-RPG.action libre|action libre] ou [Pathfinder-RPG.action immédiate|immédiate].

**Premier sang.** Si le personnage est le premier à verser le sang lors d’un combat de spectacle (ou le premier à toucher son adversaire en cas de combat chorégraphié), il peut faire un test de combat de spectacle par une [Pathfinder-RPG.action libre|action libre] ou [Pathfinder-RPG.action immédiate|immédiate].

**Vaincre un adversaire.** Quand un combattant réduit une créature à 0 point de vie ou moins, il peut faire un test de combat de spectacle par une [Pathfinder-RPG.action libre|action libre] ou [Pathfinder-RPG.action immédiate|immédiate].

{s:Reference|TESTOBLIGATOIRE}
### Tests obligatoires
...
**Guérison magique.** Le public n’aime pas les soins magiques et, dans certains spectacles, ils sont considérés comme de la triche. Un combattant doit faire un test de combat de spectacle quand il lance un sort de soin ou utilise un effet de guérison, ou encore s’il utilise un sort de soins à déclenchement, un objet à fin d’incantation ou un objet à utilisation unique (même s’il force un adversaire à avaler une [Pathfinder-RPG.potion|potion] de *[Pathfinder-RPG.soins légers|soins légers]* ou similaire). En cas de succès, l’attitude du public ne change pas mais en cas d’échec, elle empire d’un cran.

**Faire un 1 naturel.** Un combattant doit faire un test de combat de spectacle quand il fait un 1 naturel sur un jet d’attaque ou de [Pathfinder-RPG.jet de sauvegarde|sauvegarde]. En cas de succès, l’attitude du public ne change pas mais en cas d’échec, elle empire d’un cran.

**Battre en retraite.** Un combattant doit faire un test de combat de spectacle par une [Pathfinder-RPG.action libre|action libre] quand il utilise l’action battre en [retraite (action)|retraite]. Il subit un malus de -5 au test. En cas de succès, l’attitude du public ne change pas mais en cas d’échec, elle empire d’un cran.

{s:Reference|POINTDEVICTOIRE}
### Points de victoire
...
Un combattant peut dépenser un point de victoire pour faire un test de combat de spectacle qui demande une [Pathfinder-RPG.action libre|action libre] ou [Pathfinder-RPG.action immédiate|immédiate] sans dépenser la moindre action, ce qui lui permet de faire ce test en dehors de son tour sans dépenser d’action immédiate.
...
{s:Reference|COMBATSPECTACLEVAINQUEUR}
...
{s:Reference|COMBATSPECTACLESERIE}
...
Si une équipe commence un combat alors que tous ses membres ont au moins 1 [Pathfinder-RPG.Combat de spectacle|point de victoire], la foule se montre amicale envers elle dès le début de l’affrontement. Si l’équipe a au moins 3 points de victoire par membre, la foule est serviable dès le début.
