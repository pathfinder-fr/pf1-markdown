...
### Mythique
{s:CMy}
Le nombre de DV de créatures tuées par ce sort s’élève à 1d6 par [[NLS|niveau de lanceur de sorts]] (20d6 maximum). Ajoutez le [[grade]] du personnage au nombre maximum de DV des créatures pouvant être affectées par le sort (par exemple, au 3ème [[grade]], une créature de 12 DV ne peut être affectée).

**[[Amplifié]] (6ème).** Si le personnage dépense deux utilisations de [[pouvoir mythique]], les créatures qui réussissent leur jet de sauvegarde contre ce sort subissent 1d6 points de dégâts par [[grade]].
