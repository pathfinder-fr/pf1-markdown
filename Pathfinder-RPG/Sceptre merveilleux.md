...
**Aura** [[Enchantement]] modéré ; **NLS** 10 ; **Emplacement** aucun ([[Sceptres magiques|sceptre]]) ; **Prix** 12 000 po ; **Poids** 2,5 kg
(((Description)))
Le sceptre merveilleux est un objet étrange et imprévisible, qui génère des effets surprenants à chaque utilisation. Il faut une [[action simple]] pour l’activer. Certains pouvoirs typiques du sceptre sont présentés ci-après.
...
| 47–49 | Six cents gros papillons jaillissent du sceptre et volettent alentour pendant 2 rounds avant de disparaître. Leur présence [[aveuglé|aveugle]] toutes les créatures comprises dans un rayon de 7,50 m, y compris le porteur (jet de [[Réflexes]] de [[DD]] 14 pour annuler). |
...
| 91–95 | Des lueurs dansantes apparaissent dans un rectangle de 12 m x 9 m devant le sceptre. Toutes les créatures prises dans cette zone sont [[aveuglé|aveuglées]] pendant 1d6 rounds (jet de [[Vigueur]] de [[DD]] 15 pour annuler). |
