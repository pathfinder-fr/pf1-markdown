...
{s:BDTexte|**Init** +0 ; **Sens** [[perception des vibrations]] à 18 m (12 {s:c}), [[vision dans le noir]] à 18 m (12 {s:c}) ; [[Perception]] +0}
...
{s:BDTexte|**Corps à corps** morsure +10 (2d8+7 plus [[étreinte]])}
...
{s:BDTexte|**BBA** +6, **BMO** +12 (+16 [[lutte]]), **DMD** 22 (30 contre le [[croc-en-jambe]])}
...
{s:BDTexte|**Piège de sable (Ext)** LLe fourmilion géant peut créer une fosse de 18 m de diamètre (12 {s:c}) pour une profondeur de 6 m (4 {s:c}) dans le sable ou dans tout autre sol mou. Il lui faut une heure pour créer un piège de sable. Un test de [[Perception]] [[DD]] 15 permet de remarquer qu’une dépression dans le sable est en réalité un piège de sable. Les créatures posant le pied sur ce piège glissent jusqu’en son centre si elles ratent un jet de [[Réflexes]] de [[DD]] 14 : les victimes ne reçoivent aucun dégât mais tombent [[à terre]]. Le fourmilion géant peut tenter une [[attaque dopportunité|attaque d’opportunité]] contre les créatures qui tombent au fond de son piège de sable. Il peut se déplacer dans le piège de sable à sa vitesse normale et est immunisé contre ses effets. Les autres créatures doivent escalader les parois du piège en effectuant un test d’[[Escalade]] de [[DD]] 20.}
</div>

</td><td><div><div style="float:right; background-color: #fff; padding: 0 0 0 0; margin: 0 0 4px 8px">

<p class="tablo-caption">Variantes de fourmillion</p>
