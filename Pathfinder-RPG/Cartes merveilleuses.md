...
- **Balance.** Le personnage adopte un alignement radicalement différent. S’il ne se comporte pas conformément à ce nouvel alignement, il gagne un [[niveau négatif]].
...
- **Chevalier.** Le [[guerrier]] surgit de nulle part et sert fidèlement le personnage jusqu’à sa mort. Il est de la même race (ou espèce) et du même sexe que le personnage. Si ce dernier possède le don [[Prestige]], il peut le choisir comme compagnon d’armes.
- **Clef.** Le personnage doit pouvoir utiliser l’arme offerte. Elle apparaît soudainement dans sa main.
- **Comète.** Pour que la carte fasse effet, le personnage doit vaincre seul le ou les prochains monstres rencontrés. S’il y parvient, il gagne assez de [[PX]] pour atteindre le prochain niveau.
- **Crâne.** Une [[âme-en-peine|âme-en-peine effroyable]] apparaît. Le personnage doit l’affronter seul, si d’autres lui viennent en aide, d’autres [[âme-en-peine|âmes-en-peine effroyables]] apparaissent pour les combattre. Si le personnage se fait tuer, personne ne peut le ressusciter, pas même à l’aide d’un *[[souhait]]* ou d’un *[[miracle]]*.
- **Donjon.** Cette carte est synonyme d’*[[emprisonnement]]*, soit par le sort du même nom, soit par un puissant individu. Dans les deux cas, la victime est dépouillée de tout son équipement et ne peut plus tirer de cartes.
...
- **Euryale.** Le visage de gorgone peint sur cette carte porte une malédiction que seule peut lever la carte des **Parques** ou une divinité, sinon, le malus de –1 à tous les [[jds|jets de sauvegarde]] est permanent.
- **Flammes.** Un [[type Extérieur|Extérieur]], motivé par la colère, la jalousie, l’envie ou autre devient l’ennemi du personnage et cette inimitié ne prend fin qu’à la mort d’un des deux. Déterminez qui est cet [[type Extérieur|Extérieur]] au hasard. Il attaque le personnage (ou le harcèle) dans les 1d20 jours.
- **Fou.** La perte de [[PX]] et le nouveau tirage sont obligatoires. Cette carte est toujours défaussée après utilisation, comme le **Bouffon** et contrairement aux autres.
...
- **Idiot.** Cette carte fait perdre immédiatement 1d4+1 points d’[[Intelligence]]. Le nouveau tirage est facultatif.
- **Lune.** Cette carte représente une pierre de lune avec le nombre de *[[souhait|souhaits]]* approprié représentés par des rayons en son sein. Parfois, elle représente une lune dont la phase représente le nombre de *[[souhait|souhaits]]* (pleine = 4, gibbeuse = 3, demi = 2 et quart = 1). Ce sont les mêmes *[[souhait|souhaits]]* que ceux octroyés par le sort de magicien de niveau 9 et il faut les utiliser avant que ne s’écoule un nombre de minutes égal au nombre de *[[souhait|souhaits]]* reçus.
- **Le Néant.** Cette carte noire est synonyme de désastre immédiat. Le corps du personnage continue de fonctionner, comme s’il était plongé dans le coma, mais son esprit est piégé ailleurs, dans un objet sur une planète ou un plan éloigné, peut-être en possession d’un [[type Extérieur|Extérieur]]. Il est impossible de le ramener avec un *[[souhait]]* ou
un *[[miracle]]*, ces sorts révèlent seulement le plan où il se trouve. Il ne peut plus tirer de cartes.
...
| CLASS="gauche" | Changement immédiat d’[[alignement]].
|-
| Bouffon || XII. Le Pendu || Joker (noir et blanc)
| CLASS="gauche" | Gagne 10 000 [[PX]] ou tire deux nouvelles cartes.
|-
| Chevalier || Valet d’épée || Valet de cœur
| CLASS="gauche" | Gagne les services d’un [[guerrier]] de niveau 4.
|-
| Clef || V. Le Pape || Dame de cœur
| CLASS="gauche" | Gagne une puissante [[armes magiques|arme magique]].
|-
...
| CLASS="gauche" | Triompher d’une [[âme-en-peine|âme-en-peine effroyable]] ou être détruit à jamais.
|-
...
| CLASS="gauche" | -1 à tous les [[jds|jets de sauvegarde]].
|-
| Flammes || XV. Le Diable || Dame de trèfle
| CLASS="gauche" | Un [[type Extérieur|Extérieur]] devient votre ennemi.
|-
...
| CLASS="gauche" | Perd 1d4+1 points d'[[Intelligence]]. Peut tirer une nouvelle carte.
|-
| Lune || XVIII. La Lune || Dame de carreau
| CLASS="gauche" | Vous avez droit à 1d4 *[[souhait|souhaits]]*.
|-
...
| CLASS="gauche" | Gain d’un [[objets merveilleux|objet merveilleux]] de puissance intermédiaire et de 50 000 [[PX]].
|-
| Trône || 4 de bâton || Roi de cœur
| CLASS="gauche" | Gain d’un petit château et d’un bonus de +6 aux tests de [[Diplomatie]].
|-
