---
Name: Pathfinder-RPG.Gallu
Title: Démon, Gallu
LastModified: 2021-07-31 14:13
Categories:
- Monstre
...
<td>
<div class="BD">
{s:BDtitre|Gallu|FP 19}
{s:pucem|Extérieur|Ville|Extraplanaire}
{s:BDtexte|*Source : [[Courts suppléments univers (Contenu)|Guide de la Plaie du monde p.46]]*}
...
{s:BDtexte|**Init** +8 ; **Sens** [[vision dans le noir (capacité)|vision dans le noir]] à 18 m, *[[vision lucide]]* ; [[Perception]] +36}
{s:BDtexte|**Aura** *[[manteau du Chaos]]* (6 m, DD 25), perturbation (9 m)}
{s:BDsoustitre|Défense}
{s:BDtexte|**CA** 34, contact 18, pris au dépourvu 30 (armure +8, Dex +4, naturelle +8, parade +4)}
{s:BDtexte|**pv** 332 (19d10+228) ; [[Guérison accélérée (capacité)|guérison accélérée]] 10}
{s:BDtexte|**Réf** +16, **Vig** +27, **Vol** +21}
{s:BDtexte|**Capacités défensives** blindage ; **RD** 15/fer froid et Bien ; **Immunités** saignement, électricité, poison ; **RM** 30}
{s:BDsoustitre|Attaque}
{s:BDtexte|**VD** 15 m, vol 15 m (bonne)}
{s:BDtexte|**Corps à corps** cimeterre à deux mains sanglant +1, +31/+26/+21/+16 (2d4+17/15-20) et morsure, +25 (1d8+5) et corne, +25 (1d6+5)}
{s:BDtexte|**Attaques spéciales** pluie de sang, sang hémorragique}
{s:BDtexte|**Pouvoirs magiques** ([[NLS]] 19 ; [[concentration]] +26)}
{s:BDsorts|Constant — *[[manteau du chaos]]* (DD 25), *[[vision lucide]]*}
{s:BDsorts|À volonté — *[[confusion]]* (DD 21), *[[quête]]*, *[[télékinésie]]* (DD 22), *[[téléportation suprême]]* (soi-même plus 25 kg d’objets uniquement), *[[terreur]]* (DD 21)}
{s:BDsorts|3/jour — *[[chant de discorde]]* (DD 22), *[[immobilisation de monstre]]* à [[incantation rapide]] (DD 22), *[[verrou dimensionnel]]*}
{s:BDsorts|1/jour — *[[Convocation (capacité)|convocation]]* (niveau 7, 1 gallu 20%, 1 [[marilith]] 35% ou 1d4 [[Nalfeshnie|nalfeshnies]] 60%), *[[immobilisation de monstre de groupe]]* (DD 26), *[[parole du Chaos]]* (DD 24), *[[symbole daliénation mentale|symbole d’aliénation mentale]]* (DD 25)}
{s:BDsoustitre|Caractéristiques}
{s:BDtexte|**For** 33, **Dex** 18, **Con** 34, **Int** 18, **Sag** 23, **Cha** 25}
{s:BDtexte|**BBA** +19, **BMO** +30 (+32 pour la [[bousculade]]), **DMD** 48 (50 contre la [[bousculade]])}
{s:BDtexte|**Dons** [[Attaque en puissance]], [[Critique ralentissant]], [[Don pour les critiques]], [[Frappe décisive]], [[Pouvoir magique rapide]] (*immobilisation de monstre*), [[Réflexes surhumains]], [[Science de linitiative|Science de l’initiative]], [[Science de la bousculade]], [[Science de la frappe décisive]], [[Science du critique]] (cimeterre à deux mains)}
{s:BDtexte|**Compétences** [[Bluff]] +29, [[Connaissances]] (histoire) +26, [[Connaissances]] (ingénierie) +26, [[Connaissances]] (plans) +26, [[Déguisement]] +29, [[Équitation]] +26, [[Intimidation]] +37, [[Perception]] +36, [[Psychologie]] +28, [[Vol]] +30 ; **Modificateurs raciaux** +8 en Intimidation, +8 en Perception}
{s:BDtexte|**Langues** abyssal, céleste, draconique ; [[Télépathie (capacité)|télépathie]] à 30 m}
{s:BDtexte|**Particularités** [[Changement de forme (capacité)|changement de forme]] (*[[modification dapparence|modification d’apparence]]*, humanoïde de taille P ou M}
{s:BDsoustitre|Écologie}
{s:BDtexte|**Environnement** tous (Abysses)}
{s:BDtexte|**Organisation sociale** solitaire ou unité (1 gallu, 1-3 [[Marilith|mariliths]] et 3-12 [[Vrock|vrocks]])}
{s:BDtexte|**Trésor** standard (*[[cimeterre à deux mains (arme)|cimeterre à deux mains]] +1*, autre trésor)}
{s:BDsoustitre|Pouvoirs spéciaux}
{s:BDtexte|**Aura de perturbation (Sur).** La présence du gallu sème le chaos sur les champs de bataille qu’elle imprègne d’éléments chaotiques et entropiques qui perturbent la coordination et la précision tactique en manipulant le destin et la chance. Cette aura s’étend sur un rayon de 9 mètres autour du gallu. Au sein de cette zone, l’action [[aider qqn|aider quelqu’un]] n’accorde jamais de bonus et la [[prendre en tenaille|prise en tenaille]] ne donne pas non plus de bonus pour toucher (même si les ennemis pris en tenaille restent sujets aux dégâts d’[[Roublard#ATTAQUESOURNOISE|attaque sournoise]]). Une créature convoquée dans cette zone par n’importe quelle créature autre que les démons doit réussir un jet de [[Volonté]] [[DD]] 26 pour ne pas être [[confus|confuse]] pendant 1d4 [[round|rounds]]. Les [[Paladin|paladins]] et les créatures de sous-type [[sous-type Loi|Loi]] doivent réussir un jet de Volonté DD 26 tous les rounds où ils commencent leur tour dans cette aura pour ne pas être [[nauséeux]] pendant 1 round. Les démons ignorent les effets de l’aura de perturbation des gallus. Le DD des jets de sauvegarde est basé sur le [[Charisme]].}
{s:BDtexte|**Blindage (Sur).** Les plaques d’armure qui couvrent la majorité du corps du gallu lui accordent un bonus d’armure de +8. Elles fonctionnent également comme des [[pointes pour armure (arme)|pointes d’armure]] lors d’une [[lutte]] mais ne peuvent pas être utilisées comme armes secondaires. En outre, ces plaques d’armure peuvent bénéficier d’une propriété spéciale d’armure choisie parmi les suivantes : [[résistance aux énergies destructives (propriété)|résistance]] à l’acide 20, résistance au froid 20, résistance au feu 20, [[spectrale (propriété armure)|spectrales]], de [[défense intermédiaire (propriété)|défense intermédiaire]] ou résistance au son 20. Le démon gallu peut changer la propriété spéciale d’armure active une fois par heure par une [[action rapide]]. En règle générale, le gallu conserve son blindage en mode de défense intermédiaire. Ces plaques d’armure n’encombrent pas le gallu et ne lui imposent de [[Caractéristiques des armures#MALUSARMURE|malus d’armure]], de [[Caractéristiques des armures#BONUSDEXMAX|limite au bonus de Dex]] ou de [[Caractéristiques des armures#RISQUEECHECPROFANE|risque d’échec des sorts profanes]]. Il est impossible de les retirer, de les briser ou de les détruire tant que le gallu est en vie et elles rouillent, se transformant en morceaux de fer non-magiques quand il meurt.}
{s:BDtexte|**Pluie de sang (Sur).** Par une [[action simple]], une fois par minute, le gallu peut forcer les blessures des créatures situées dans un rayon de 9 mètres à exploser dans un déluge de sang répugnant : toutes les créatures blessées dans la zone d’effet reçoivent immédiatement 3d6 points de dégâts de cette pluie de sang et doivent réussir un jet de [[Vigueur]] [[DD]] 31. En cas d’échec, les dégâts subits deviennent hémorragiques et la créature affectée est [[chancelant|chancelante]] à cause de la douleur tant que dure le saignement. Les créatures immunisées aux dégâts de [[saignement]] sont immunisées aux effets de ce pouvoir. Le DD du jet de sauvegarde est basé sur la [[Constitution]].}
{s:BDtexte|**Sang hémorragique (Sur).** Les pointes qui maintiennent les plaques d’armure du gallu en place s’enfoncent aussi profondément dans le corps du démon qu’elles en dépassent : des filets de sang s’échappent donc sans cesse du corps de la créature. Cette perte de sang continue ne gêne ni ne blesse le gallu : au lieu de cela, elle accorde la propriété spéciale [[sanglante (propriété)|sanglante]] à toutes les armes manufacturées que manie le gallu. Le sang versé n’affecte pas les attaques naturelles du gallu.}
</div>
</td>
<td>
