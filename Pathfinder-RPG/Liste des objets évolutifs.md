...
- **Niveau 6.** L’*armure de l’Armageddon* est un *[[harnois (armure)|harnois]] de [[défense légère (propriété)|défense légère]] +1*.
- **Niveau 8.** L’*armure de l’Armageddon* riposte face aux attaquants au corps à corps quand sa propriété de *défense* se déclenche. Quand un adversaire frappe son porteur avec une arme de corps à corps et que l’armure annule un [[coup critique]] ou une [[attaque sournoise]], le pouvoir de l’armure rend l’attaquant [[secoué]] pendant 1d4 [[round|rounds]] ([[Volonté]] [[DD]] 16 pour annuler). Il s’agit d’un effet mental de terreur qui se cumule avec lui-même pour rendre l’attaquant [[effrayé]] ou [[paniqué]].
- **Niveau 11.** L’*armure de l’Armageddon* est un *[[harnois (armure)|harnois]] de [[défense intermédiaire (propriété)|défense intermédiaire]] +1*.
- **Niveau 13.** L’*armure de l’Armageddon* est un *[[harnois (armure)|harnois]] de [[défense intermédiaire (propriété)|défense intermédiaire]] +2*. Le DD du jet sauvegarde contre son effet de terreur passe à 20 et affecte les adversaires qui manient des armes de corps à corps et à distance.
- **Niveau 16.** L’*armure de l’Armageddon* est un *[[harnois (armure)|harnois]] d’[[invulnérabilité (propriété)|invulnérabilité]] de [[défense intermédiaire (propriété)|défense intermédiaire]] +2*. Elle confère une [[RD]] 5/— au lieu d’une [[RD]] 5/magie.
- **Niveau 18.** L’*armure de l’Armageddon* est un *[[harnois (armure)|harnois]] de [[détermination (propriété)|détermination]] d’[[invulnérabilité (propriété)|invulnérabilité]] et de [[défense intermédiaire (propriété)|défense intermédiaire]]  en [[adamantium]] +2*. La [[RD|réduction de dégâts]] conféré par l’adamantium se cumule avec l’effet modifié d’invulnérabilité pour une RD totale de 8/—.
- **Niveau 20.** L’*armure de l’Armageddon* est un *[[harnois (armure)|harnois]] de [[détermination (propriété)|détermination]] d’[[invulnérabilité (propriété)|invulnérabilité]] et de [[défense lourde (propriété)|défense lourde]]  en [[adamantium]] +2*. Une fois par jour, son porteur peut faire croître les épines de l’armure et libérer une volée de six épines en réalisant une [[attaque à outrance]]. Toutes appliquent le plus haut [[BBA|bonus de base à l’attaque]] du porteur avec un facteur de portée de 36 mètres. Chaque épine qui touche inflige 2d10 points de dégâts + le bonus de [[Force]] du porteur. Si les épines attaquent plusieurs cibles, toutes doivent se trouver à moins de 9 mètres les unes des autres. Une fois par jour, le porteur peut augmenter sa vitesse de base au sol à 15 mètres pendant 1 [[round]] par une [[action libre]]. S’il décide d’activer ce dernier pouvoir, il n’applique aucune autre modification qui augmente sa vitesse de déplacement pour ce [[round]].

(((Fabrication)))
- **Conditions** [[Création darmes et armures magiques|Création d'armes et armures magiques]], *[[miracle]]* ou *[[souhait limité]]*, *[[souffle de vie]]*, *[[terreur]]* ;  
- **Coût** 133 650 po
...
- **Niveau 11.** Le porteur peut utiliser *[[sort Vol|vol]]* sur commande une fois par jour.
- **Niveau 13.** L’armure est une *[[cotte de mailles (armure)|cotte de mailles]] +3* et son [[Caractéristiques des armures#BONUSDEXMAX|bonus de Dextérité maximal]] passe à +7.
- **Niveau 15.** L’armure est une *[[cotte de mailles (armure)|cotte de mailles]] +4*. Son [[Caractéristiques des armures#BONUSDEXMAX|bonus de Dextérité maximal]] passe à +8 et le [[Caractéristiques des armures#MALUSARMURE|malus d’armure aux tests]] passe à -1.
- **Niveau 17.** L’armure est une *[[cotte de mailles (armure)|cotte de mailles]] +5* et le porteur peut activer le pouvoir de *[[sort Vol|vol]]* sur commande par une [[action rapide]].
- **Niveau 19.** L’armure fait pousser des ailes de plumes blanches sur le dos porteur, ce qui lui confère une vitesse de vol constante de 18 mètres avec une [[Vol#SPECIAL|bonne manœuvrabilité]].

(((Fabrication)))
- **Conditions** [[Création darmes et armures magiques|Création d'armes et armures magiques]], *[[sort Vol|vol]]*, le créateur doit être d’alignement Bon ;   
- **Coût** 51 375 po
...
- **Niveau 12.** Le bouclier gagne la propriété spéciale de bouclier *[[renforcement (propriété)|renforcement]]*. Le bonus au [[jds|jet de sauvegarde]] conféré par cette propriété est augmenté de 1 contre les créatures du type dragon et de 2 contre les dragons du même type que la peau de dragon utilisée pour fabriquer le bouclier.
- **Niveau 14.** Le bouclier gagne la propriété spéciale *[[résistance aux énergies destructives (propriété)|résistance à l’énergie]]*. Le type de résistance correspond au type d’énergie destructive produit par le souffle du dragon dont la peau a servi à la fabrication du bouclier.
- **Niveau 16.** Le bonus d’altération du bouclier passe à +2 et le porteur gagne un bonus de moral de +6 aux [[jds|jets de sauvegarde]] contre la présence terrifiante des dragons.

(((Fabrication)))
- **Conditions** [[Création darmes et armures magiques|Création d'armes et armures magiques]], *[[héroïsme]]*, *[[regain dassurance|regain d’assurance]]*, *[[résistance aux énergies destructives]]* ;  
- **Coût** 47 557 po
...
- **Niveau 6.** La flèche est dotée de la propriété spéciale *[[longue portée (propriété)|longue portée]]*, qui n’est normalement pas applicable aux munitions. Quand elle est tirée, elle perd cette propriété et toutes celles de niveau supérieur pendant une journée.
- **Niveau 9.** La flèche possède les propriétés spéciales *[[longue portée (propriété)|longue portée]]* et *[[traqueuse (propriété)|traqueuse]]*.
...
- **Niveau 14.** Une fois par jour par une [[action simple]], le propriétaire de la flèche peut décréter qu’il s’agit d’une flèche *[[tueuse (propriété)|tueuse]]* pour une catégorie de créatures de son choix. La flèche conserve cette propriété *tueuse* jusqu’à ce qu’elle soit modifiée. Elle regagne normalement son utilisation *tueuse* au bout de 10 minutes.
- **Niveau 16.** La flèche conserve ses propriétés spéciales *[[tueuse (propriété)|tueuse]]*, *[[longue portée (propriété)|longue portée]]* et *[[traqueuse (propriété)|traqueuse]]* après avoir été tirée.
- **Niveau 18.** Une fois par semaine, le porteur peut entreprendre une [[action simple]] pour tirer la flèche sous forme d’une [[Flèche mortelle|flèche mortelle supérieure]] (propriété liée à la même catégorie que la propriété *[[tueuse (propriété)|tueuse]]*), qui possède également ses autres propriétés spéciales. Quand elle a été tirée, la flèche perd toutes ses propriétés spéciales pendant une semaine.
- **Niveau 20.** La propriété [[Flèche mortelle|flèche mortelle supérieure]] est utilisable une fois par jour (après quoi la flèche perd toutes ses propriétés spéciales pendant une journée) au lieu d’une fois par semaine. La flèche ignore la [[RD|réduction de dégâts]] comme si elle était en [[adamantium]].

(((Fabrication)))
- **Conditions** [[Création darmes et armures magiques|Création d'armes et armures magiques]], [[Augmentation dintensité|Augmentation d’intensité]], *[[clairaudienceclairvoyance|clairaudience/clairvoyance]]*, *[[convocation de monstres I]]*, *[[doigt de mort]]*, *[[vision lucide]]* ;
- **Coût** 22 000 po
...
- **Niveau 8.** La *lame assoiffée* est une *[[dague (arme)|dague]] [[acérée (propriété)|acérée]] +1*.
- **Niveau 10.** La *lame assoiffée* inflige 1 point de dégâts de saignement sur un coup critique confirmé.
- **Niveau 14.** La *lame assoiffée* est une *[[dague (arme)|dague]] [[sanglante (propriété)|sanglante]] [[acérée (propriété)|acérée]] +1*. Sur un [[coup critique]] réussi, la dague inflige 2 points de dégâts de [[saignement]] au lieu de 1.
- **Niveau 15.** La *lame assoiffée* est une *[[dague (arme)|dague]] [[sanglante (propriété)|sanglante]] [[acérée (propriété)|acérée]] +2*.
- **Niveau 16.** La *lame assoiffée* est une *[[dague (arme)|dague]] [[sanglante (propriété)|sanglante]] [[acérée (propriété)|acérée]] +3*.
- **Niveau 17.** La *lame assoiffée* est une *[[dague (arme)|dague]] [[sanglante (propriété)|sanglante]] [[acérée (propriété)|acérée]] +4*.
...
- **Niveau 20.** La *lame assoiffée* est une *[[dague (arme)|dague]] [[sanglante (propriété)|sanglante]] [[vicieuse (propriété)|vicieuse]] [[acérée (propriété)|acérée]] +5*.

(((Fabrication)))
- **Conditions** [[Création darmes et armures magiques|Création d'armes et armures magiques]], *[[affûtage]]*, *[[baiser du vampire]]*, *[[énergie négative]]*, *[[sort Saignement|saignement]]* ;
- **Coût** 132 000 po
...
- **Niveau 10.** Un porteur qui possède le pouvoir de classe [[Rôdeur#PROIEDUCHASSEUR|proie du chasseur]] peut se servir de la lance pour lancer une *[[localisation de créature]]* une fois par jour afin de trouver sa proie. Si sa proie est à portée, l’ambre qui forme la tête de la lance se met à briller vivement quand le porteur la pointe dans la bonne direction.
- **Niveau 12.** La lance gagne la propriété spéciale *[[boomerang (propriété)|boomerang]]*.

(((Fabrication)))
- **Conditions** [[Création darmes et armures magiques|Création d'armes et armures magiques]], *[[détection de la faune ou de la flore]]*, *[[localisation de créature]]*, *[[repérage]]*, *[[télékinésie]]* ;
- **Coût** 10 380 po
...
- **Niveau 12.** La *masse d’armes multi-métallique* est une *[[masse darmes légère (arme)|masse d’armes légère]] +2*.

(((Fabrication)))
- **Conditions** [[Création darmes et armures magiques|Création d'armes et armures magiques]], *[[cœur du métal]]* ;
- **Coût** 11 405 po
...
- **Niveau 8.** La *vengeresse sacrée* est une *[[épée longue (arme)|épée longue]] en [[fer froid]] +1* qui devient une *[[épée longue (arme)|épée longue]] en [[fer froid]] +2* entre les mains d’un [[paladin]].
- **Niveau 10.** La *vengeresse sacrée* devient une *[[épée longue (arme)|épée longue]] en [[fer froid]] +3* entre les mains d’un [[paladin]].
- **Niveau 12.** La *vengeresse sacrée* est une *[[épée longue (arme)|épée longue]] en [[fer froid]] +2* qui devient une *[[épée longue (arme)|épée longue]] en [[fer froid]] +4* entre les mains d’un [[paladin]].
- **Niveau 14.** La *vengeresse sacrée* devient une *[[épée longue (arme)|épée longue]] en [[fer froid]] +5* entre les mains d’un [[paladin]].
- **Niveau 17.** La *vengeresse sacrée* permet au [[paladin]] d’utiliser la version de dissipation de zone d’une *[[dissipation suprême]]* à volonté par une [[action simple]]. De plus, elle confère au paladin et à ses alliés adjacents une [[RM|résistance à la magie]] égale à 5 + le niveau de paladin du porteur.

(((Fabrication)))
- **Conditions** [[Création darmes et armures magiques|Création d'armes et armures magiques]], *[[aura sacrée]]*, le créateur doit être d’alignement Bon ;
- **Coût** 64 500 po
...
(((Fabrication)))
- **Conditions** [[Création danneaux magiques|Création d'anneaux magiques]], *[[forme draconique II]]*, *[[rapidité]]*, *[[résistance aux énergies destructives]]* ;
- **Coût** 66 000 po
...
- **Niveau 20.** Le porteur de l’anneau peut se transformer en [[drake des forêts]] une fois par jour. Ce pouvoir fonctionne comme si le porteur se métamorphosait en un dragon vert grâce à *[[forme draconique II]]* à la seule différence que le souffle acide du porteur affecte une étendue de 3 mètres de rayon à une portée de 18 mètres ou moins, qui reste en place comme une *[[brume de dissimulation]]* pendant 1d4 [[round|rounds]].
...
- **Niveau 20.** Le porteur de l’anneau peut se transformer en [[drake du froid]] une fois par jour. Ce pouvoir fonctionne comme si le porteur se métamorphosait en un dragon blanc grâce à *[[forme draconique II]]* à la seule différence que le souffle de froid du porteur affecte une étendue de 3 mètres de rayon à une portée de 18 mètres ou moins. Toutes les surfaces situées dans la zone d’effet sont recouvertes d’une pellicule de glace glissante qui transforme la zone en un [[terrain difficile]] pendant 2d4 [[round|rounds]].
...
(((Fabrication)))
- **Conditions** [[Création danneaux magiques|Création d'anneaux magiques]], *[[création majeure]]*, *[[image miroir]]*, *[[prestidigitation]]* ;
- **Coût** 18 000 po
...
- **Niveau 8.** Le porteur peut aussi utiliser *[[ramollissement de la terre et de la pierre]]* une fois par jour. Il parle le terreux et bénéficie d’un bonus de résistance de +2 aux [[jds|jets de sauvegarde]] contre les attaques des créatures du plan de la Terre, ainsi qu’un bonus de moral de +4 aux [[jet dattaque|jets d’attaque]] contre ces créatures. En outre, ces créatures subissent un malus de -1 à leurs jets d’attaque contre le porteur. Ce dernier subit un malus de -2 aux jets de sauvegarde contre les effets d’air et d’électricité.
...
(((Fabrication)))
- **Conditions** [[Création danneaux magiques|Création d'anneaux magiques]], *[[convocation de monstres VI]]*, *[[façonnage de la pierre]]*, *[[fusion dans la pierre]]*, *[[mur de pierre]]*, *[[passe-muraille]]*, *[[peau de pierre]]* ;
- **Coût** 79 500 po
...
(((Fabrication)))
- **Conditions** [[Création darmes et armures magiques|Création d'armes et armures magiques]], *[[protection contre les énergies destructives]]*, *[[rayon ardent]]*, *[[sphère de feu]]* ;
- **Coût** 23 625 po
...
(((Fabrication)))
- **Conditions** [[Création de sceptres magiques]], *[[création majeure]]*, *[[énergie négative]]*, *[[main spectrale]]*, *[[sort Malédiction|malédiction]]* ;
- **Coût** 67 505 po
...
(((Fabrication)))
- **Conditions** [[Création de bâtons magiques]], *[[grand pas]]*, *[[liberté de mouvement]]*, *[[orientation]]*, *[[pattes daraignée|pattes d’araignée]]*, *[[poisson-singe]]*, *[[respiration aquatique]]*, *[[repli expéditif]]*, *[[sort Vol|vol]]* ;
- **Coût** 66 500 po
...
- **Niveau 14.** Le bâton permet d’utiliser *[[convocation de monstres VI]]* pour 2 charges afin d’invoquer des [[Élémentaire du Feu|élémentaires du Feu]] uniquement.
- **Niveau 16.** Le bâton remplace *[[convocation de monstres VI]]* par *[[convocation de monstres VIII]]* pour 3 charges afin d’invoquer des [[Élémentaire du Feu|élémentaires du Feu]] uniquement. Il permet également d’utiliser *[[tempête de feu]]* pour 2 charges.
- **Niveau 18.** Le bâton permet d’utiliser *[[nuée de météores]]* pour 3 charges. Le coût de *[[convocation de monstres VIII]]* est réduit à 2 charges et celui de *[[boule de feu]]* à [[Extension deffet|Extension d’effet]] ne coûte plus qu’une charge.
- **Niveau 20.** Le coût de *[[nuée de météores]]* et de *[[tempête de feu]]* est réduit à 1 charge.

(((Fabrication)))
- **Conditions** [[Création de bâtons magiques]], [[Extension deffet|Extension d’effet]], *[[boule de feu]]*, *[[convocation de monstres VI]]*, *[[convocation de monstres VIII]]*, *[[étincelles]]*, *[[nuée de météores]]*, *[[rayon ardent]]*, *[[tempête de feu]]* ;
- **Coût** 132 000 po
...
- **Niveau 12.** Les bottes permettent à leur porteur d’ignorer complètement les effets de déplacement négatifs provoqués par des [[terrain difficile|terrains difficiles]].
...
- **Niveau 20.** Les bottes permettent au porteur de bénéficier des effets d’une *[[rapidité]]* pendant 10 [[round|rounds]] par jour, comme des [[bottes de rapidité]]. Si le porteur porte aussi la [[Liste des objets évolutifs#CAPEDELESPRITELFIQUE|cape de l’esprit elfique]], les bottes lui permettent d’utiliser *[[voyage par les arbres]]*, comme le sort du même nom, et donc d’entrer dans un maximum de vingt arbres chaque jour.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[démarche aérienne]]*, *[[rapidité]]*, *[[repli expéditif]]*, *[[voyage par les arbres]]*, le créateur doit être un [[elfe]] ;
- **Coût** 22 000 po
...
- **Niveau 10.** Si le porteur confirme un [[coup critique]] lors d’une attaque avec les bottes, il peut effectuer un [[BMO|test de manœuvre offensive]] pour faire un [[croc-en-jambe]] contre la cible. Cette manœuvre ne provoque pas d’[[AO|attaque d’opportunité]].
- **Niveau 12.** Les [[jet dattaque|jets d’attaque]] et [[Valeurs de combat#DEGATS|de dégâts]] effectués avec les bottes bénéficient d’un bonus d’altération de +1.
- **Niveau 14.** Si une créature située à portée du porteur des bottes tombe [[à terre]], cette créature provoque une [[AO|attaque d’opportunité]] de la part du porteur. Cette attaque d’opportunité doit être effectuée avec les *bottes de la brute*.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[télékinésie]]* ;
- **Coût** 13 200 po
...
- **Niveau 13.** Avant d’engager son premier tour en combat, le porteur peut se déplacer à sa vitesse normale par une [[action immédiate]] sans provoquer d’[[AO|attaque d’opportunité]]. Il ne peut plus utiliser ce pouvoir quand arrive son premier tour, même s’il retarde son action.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[moment de prescience]]*, *[[rapidité]]* ;
- **Coût** 3 500 po
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[bouclier]]*, *[[main impérieuse]]* ;
- **Coût** 8 100 po
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[charme-personne]]*, *[[invisibilité]]*, le créateur doit être une [[type Fée|créature féerique]] ;
- **Coût** 825 po
...
- **Niveau 10.** Le porteur peut saisir les bords de la cape pour voler (comme avec le sort de *[[sort Vol|vol]]*) pendant un maximum de 7 minutes trois fois par jour, mais uniquement si la lumière alentour est faible ou moins intense. Après chaque utilisation de ce pouvoir, le porteur doit attendre au moins aussi longtemps que la durée du dernier vol avant de pouvoir réutiliser ce pouvoir.
- **Niveau 12.** Pour chaque utilisation quotidienne de *[[sort Vol|vol]]*, le porteur peut choisir, à la place, de se transformer en une [[chauve-souris]] ordinaire comme avec le sort de *[[forme bestiale III]]* pendant la même durée.
- **Niveau 14.** Le porteur peut utiliser *[[sort Vol|vol]]* ou *[[forme bestiale III]]* autant de fois par jour qu’il le souhaite mais doit quand même respecter les restrictions en terme de lumière et de durée d’attente avant de pouvoir réutiliser cette capacité.
...
- **Niveau 18.** Le porteur obtient le pouvoir constant d’écholocalisation des [[Chauve-souris|chauves-souris]]. Il perçoit les sons très aigus tels que l’écholocalisation des autres chauves-souris et dispose du sens de [[perception aveugle (capacité)|perception aveugle]] à 6 mètres. Cette perception aveugle est basée sur le son et se retrouve bloquée par les sorts tels que *[[silence]]*.
- **Niveau 20.** La portée de la [[perception aveugle (capacité)|perception aveugle]] du porteur s’élève à 18 mètres, comme celle des [[chauve-souris sanguinaire|chauves-souris sanguinaires]]. Plutôt que d’utiliser *[[forme bestiale III|forme bestiale]]* ou *[[sort Vol|vol]]*, il peut se transformer en une [[nuée de chauves-souris]] et obtenir les pouvoirs d’une chauve-souris, comme avec le sort de *[[forme bestiale III]]*, ainsi que la [[distraction (capacité)|distraction]], l’immunité contre les dégâts des armes, les traits des nuées et les pouvoirs de blessure des nuées de chauves-souris.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[écholocalisation]]*, *[[forme bestiale III]]*, *[[nuée grouillante]]*, *[[sort Vol|vol]]* ;
- **Coût** 66 000 po
...
- **Niveau 10.** On considère que le porteur est sous l’effet constant d’un sort de *[[pattes daraignée|pattes d’araignée]]*.
- **Niveau 12.** Le porteur ne peut pas être piégé par des sorts de *[[toile daraignée|toile d’araignée]]* ni par aucune forme de toile d’araignée et il peut escalader les murs comme une araignée, s’y déplaçant à sa vitesse d’escalade normale.
- **Niveau 14.** Les araignées normales, y compris les nuées d’araignées et les araignées anormalement grandes, n’attaquent pas le porteur de la cape à moins que celui-ci ne les attaque le premier ou qu’une autre créature ne le leur ordonne par l’intermédiaire d’un sort ou d’un pouvoir d’[[Flétrisseur (druide)|empathie avec la vermine]]. Le porteur de la cape peut convoquer une [[Nuée daraignées|nuée d’araignées]] une fois par jour, comme avec le sort *[[nuée grouillante]]*.
...
- **Niveau 17.** Le porteur de la cape peut convoquer une [[Nuée daraignées|nuée d’araignées]] à volonté au lieu d’une fois par jour. Quand il se transforme en araignée, il peut prendre l’apparence d’une araignée de taille TP, P, M ou G comme avec le sort de *[[forme de vermine II]]*.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[forme de vermine II]]*, *[[nuée grouillante]]*, *[[pattes daraignée|pattes d’araignée]]*, *[[toile daraignée|toile d’araignée]]* ;
- **Coût** 30 750 po
...
- **Niveau 14.** La cape confère à son porteur l’aptitude de [[Rôdeur#CAMOUFLAGE|camouflage]] du rôdeur en forêt.
...
- **Niveau 20.** Si le porteur porte également les [[Liste des objets évolutifs#BOTTESDELESPRITELFIQUE|bottes de l’esprit elfique]], il peut se concentrer sur l’effet d’*[[invisibilité]]* de la cape. Par une [[action libre]], il peut décider que ses attaques ne mettent pas fin à son effet d’*invisibilité* pendant 1 [[round]]. Il peut utiliser ce pouvoir pendant 10 rounds par jour, mais ceux-ci ne doivent pas forcément être consécutifs.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[caméléon]]*, *[[invisibilité]]*, *[[invisibilité suprême]]*, le créateur doit être un [[elfe]] ;
- **Coût** 22 000 po
...
- **Niveau 9.** Le porteur peut aussi activer le grain de guérison du chapelet pour lancer *[[soins importants]]* une fois par jour.
- **Niveau 10.** Le porteur peut également activer le grain de guérison du chapelet pour lancer *[[guérison de la cécitésurdité|guérison de la cécité/surdité]]* ou *[[guérison des maladies]]* à la place de *[[soins importants]]*.
- **Niveau 14.** Le porteur peut aussi activer le grain de châtiment du chapelet pour lancer *[[marteau du chaos]]*, *[[châtiment sacré]]*, *[[courroux de lordre|courroux de l’ordre]]* ou *[[ténèbres maudites]]* (en fonction du sort utilisé pour fabriquer l’objet) une fois par jour.
- **Niveau 16.** Le porteur peut également activer le grain de karma du chapelet pour lancer ses sorts avec un bonus de +4 au [[NLS|niveau de lanceur de sorts]] pendant 10 minutes, une fois par jour.
- **Niveau 19.** Le porteur peut aussi activer le grain de vent divin du chapelet pour lancer *[[vent divin]]* une fois par jour.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[bénédiction]]*, *[[force du colosse]]*, *[[guérison de la cécitésurdité|guérison de la cécité/surdité]]*, *[[guérison des maladies]]*, *[[soins importants]]*, *[[vent divin]]* et soit *[[châtiment sacré]]*, soit *[[courroux de lordre|courroux de l’ordre]]*, soit *[[marteau du chaos]]*, soit *[[ténèbres maudites]]* ;
- **Coût** 51 375 po
...
- **Niveau 11.** Quand le porteur est ancré au sol, les racines interfèrent avec les adversaires adjacents au porteur, qui doivent réussir un jet de [[Réflexes]] [[DD]] 13 tous les [[round|rounds]] pour ne pas être [[enchevêtré|enchevêtrés]] par les racines comme avec le sort d’*[[enchevêtrement]]*. Si les racines du porteur disparaissent à cause d’un déplacement, tous les ennemis enchevêtrés sont aussitôt libérés.
...
- **Niveau 17.** Le porteur gagne le pouvoir universel de monstre [[attirer (capacité)|attirer]] (racine, 3 mètres).
- **Niveau 20.** Tant que les racines du porteur sont ancrées dans le sol, il bénéficie des effets d’un [[anneau de régénération]]. Quand les racines disparaissent, on considère que le porteur a retiré l’anneau : il ne régénère donc les dégâts subis qu’après avoir planté les racines et avant de se déplacer. Tant que le porteur active ses racines pendant au moins 8 heures chaque jour, il n’a pas besoin de dormir. Le bonus de +4 aux [[jds|jets de sauvegarde]] que confère le cœur à son porteur quand il plante ses racines s’applique désormais à la [[paralysé|paralysie]], aux [[poisons]], aux effets de [[branche métamorphose|métamorphose]], aux effets de sommeil et à l’[[étourdi|étourdissement]].

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[distorsion du bois]]*, *[[enchevêtrement]]*, *[[forme végétale III]]* ;
- **Coût** 132 000 po
...
- **Niveau 12.** Le collier fonctionne comme un [[Collier à boules de feu|collier à boules de feu (2ème modèle)]] avec une sphère supplémentaire à 4d6.
- **Niveau 14.** Le collier fonctionne comme un [[Collier à boules de feu|collier à boules de feu (4ème modèle)]] avec une sphère à 9d6 au lieu d’une sphère à 8d6.
- **Niveau 16.** Le collier fonctionne comme un [[Collier à boules de feu|collier à boules de feu (7ème modèle)]] avec une sphère supplémentaire à 5d6.
- **Niveau 18.** Les sphères se reforment en une journée plutôt qu’en une semaine.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[boule de feu]]* ;
- **Coût** 39 750 po
...
- **Niveau 9.** Une fois par jour par une [[action rapide]], le porteur peut bénéficier d’un bonus d’altération de +9 mètres à sa vitesse de déplacement de base pendant 1 [[round]]. Pendant ce round, il ignore les effets de ralentissement du déplacement dus au terrain et ses déplacements ne provoquent pas d’[[AO|attaque d’opportunité]].
- **Niveau 11.** Le porteur peut se relever après être tombé [[à terre]] par une [[action immédiate]] qui ne provoque pas d’[[AO|attaque d’opportunité]].
- **Niveau 12.** Le porteur peut utiliser le pouvoir de la ceinture pour augmenter sa vitesse de déplacement et ignorer les [[terrain difficile|terrains difficiles]] trois fois par jour.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[grâce]]*, *[[grâce féline]]*, le créateur doit avoir 10 rangs dans la compétence [[Acrobaties]] ;
- **Coût** 8 100 po
...
- **Niveau 5.** Une fois par jour, le porteur peut convoquer un [[Élémentaire de la glace#_0|élémentaire de la glace de taille P]] comme avec une *[[convocation de monstres II]]*.
...
- **Niveau 12.** Une fois par jour, le porteur peut invoquer une *[[tempête de grêle]]*. Quand il utilise le diadème pour convoquer des [[Élémentaire de la glace|élémentaires de la glace]], il peut convoquer soit 1d4 élémentaires de la glace de taille P, soit un élémentaire de la glace de taille M, comme avec une *[[convocation de monstres IV]]*.
- **Niveau 14.** Une fois par jour, le porteur peut se rendre dans un endroit sûr qui lui est très familier, comme s’il avait lancé *[[téléportation par cristal de glace]]* sur lui-même. Quand il utilise le diadème pour convoquer des [[Élémentaire de la glace|élémentaires de la glace]], il peut convoquer soit 1d3 élémentaires de la glace de taille M, soit un élémentaire de la glace de taille G, comme avec une *[[convocation de monstres V]]*.
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[baie nourricière]]*, *[[création de nourriture et deau|création de nourriture et d’eau]]*, *[[délivrance de la paralysie]]*, *[[festin des héros]]*, *[[restauration partielle]]*, *[[ralentissement du poison]]*, *[[soins modérés]]* ;
- **Coût** 6 000 po
...
- **Niveau 12.** L’effet de sens partagés dure 10 minutes. Lorsqu’il partage ses sens, le porteur découvre automatiquement le nombre et l’emplacement des passages secrets situés dans un cône de 18 mètres en face de lui, comme s’il avait étudié la zone pendant 2 [[round|rounds]] avec une *[[détection des passages secrets]]* (cet effet n’accorde aucun des autres avantages conférés par une *détection des passages secrets*).
- **Niveau 14.** Lorsqu’il partage ses sens, le porteur bénéficie des avantages d'une *[[détection de linvisibilité|détection de l’invisibilité]]*.
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[détection de linvisibilité|détection de l’invisibilité]]*, *[[détection des passages secrets]]*, *[[lien télépathique]]*, *[[vision lucide]]* ;
- **Coût** 23 625 po
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[transmission alchimique]]* ;
- **Coût** 6 000 po
...
- **Niveau 11.** Les gantelets du maître des forges sont des *[[gantelet (arme)|gantelets]] +1*.
- **Niveau 12.** Le porteur des *gantelets du maître des forges* peut chauffer les objets qu’il touche. Il peut utiliser *[[métal brûlant]]* ([[DD]] 13) à volonté. S’il cible un objet en métal que porte un ennemi, il doit réussir une attaque de contact au corps à corps. Si l’objet ciblé est tenu en main ou manié, le porteur des *gantelets du maître des forges* doit effectuer un [[NLS|test de manœuvre offensive]] pour détruire l’objet. Cette manœuvre ne provoque pas d’[[AO|attaque d’opportunité]], même si le porteur ne possède pas le don [[Science de la destruction]].
- **Niveau 13.** La résistance au feu du porteur est augmentée à 10.
- **Niveau 14.** Les gantelets du maître des forges sont des *[[gantelet (arme)|gantelets]] de [[feu (propriété)|feu]] +1*.
- **Niveau 15.** Les gantelets du maître des forges sont des *[[gantelet (arme)|gantelets]] de [[feu intense (propriété)|feu intense]] +1*.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]] ; soit *[[boule de feu]]*, soit *[[colonne de feu]]*, soit *[[lame de feu]]* ; *[[étincelles]]*, *[[métal brûlant]]*, *[[résistance aux énergies destructives]]*, le créateur doit avoir au moins 5 rangs en [[Artisanat]] (armures) et en [[Artisanat]] (armes) ;
- **Coût** 18 000 po
...
- **Niveau 9.** Si le porteur se sert de ses gants pour effectuer des attaques à mains nues (y compris quand il effectue un [[BMO|test de manœuvre offensive]] pour blesser un adversaire en situation de [[lutte]]), ces attaques infligent 1d6 points de dégâts d’électricité supplémentaires sur chaque coup réussi, comme si le porteur utilisait une arme dotée de la propriété spéciale de *[[foudre (propriété)|foudre]]*.
- **Niveau 11.** Tous les objets que le porteur tient en main bénéficient d’une puissante charge d’électricité statique et toutes les créatures qui tentent de [[désarmement|désarmer]] le porteur d’un objet qu’il tient (ou d’effectuer une manœuvre offensive de [[subtilisation]] de ses gants) subissent 1d6 points de dégâts d’électricité et doivent réussir un jet de [[Vigueur]] [[DD]] 19 pour ne pas être [[chancelant|chancelantes]] pendant 1 [[round]] sous l’effet du choc électrique. La charge d’électricité statique n’endommage pas les objets que le porteur tient en main.
- **Niveau 13.** La propriété de *[[foudre (propriété)|foudre]]* des gantelets se renforce et devient de *[[foudre intense (propriété)|foudre intense]]*.
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[décharge électrique]]*, *[[éclair multiple]]* ;
- **Coût** 18 302 po
...
- **Niveau 10.** Les guenilles grouillent désormais d’insectes et d’araignées, familiarisant le porteur avec la sensation de toutes petites créatures grouillant partout sur son corps. Après avoir porté les guenilles pendant vingt-quatre heures consécutives, le porteur bénéficie d’un bonus de circonstances de +2 aux [[jds|jets de sauvegarde]] contre le pouvoir de [[distraction (capacité)|distraction]] des nuées. Une fois par jour, il peut ordonner aux araignées de ses guenilles de se regrouper et d’aller attaquer ses ennemis : les guenilles expulsent alors les [[Nuée daraignées|araignées]] de la même façon que le sort *[[vomir une nuée]]*.
- **Niveau 11.** Des guêpes construisent une petite ruche quelque part à l’intérieur des guenilles. Quand le porteur utilise *[[vomir une nuée]]*, il a le choix entre les [[Nuée daraignées|araignées]] et les [[Nuée de guêpes|guêpes]].
- **Niveau 13.** Les maladies des guenilles deviennent plus contagieuses. Toute créature vivante qui touche le porteur avec une attaque de morsure contracte la [[Maladies#FIEVREDESMARRAIS|fièvre des marais]]. Un jet de [[Vigueur]] [[DD]] 14 réussi annule la maladie. Les vases et les vermines sont immunisées contre cet effet, tout comme les créatures telles que les [[Otyugh|otyughs]] et les [[Rat|rats]] qui sont chez eux dans les lieux incroyablement sales.
- **Niveau 16.** Des fourmis soldats construisent une colonie à l’intérieur des guenilles et la saleté de ces robes devient franchement ignoble. Le porteur a aussi le choix des [[Nuée de fourmis soldats|fourmis soldats]] quand il utilise *[[vomir une nuée]]*. Toute créature qui mord le porteur et rate son [[jds|jet de sauvegarde]] contre la [[Maladies#FIEVREDESMARRAIS|fièvre des marais]] des guenilles est [[nauséeux|nauséeuse]] pendant 1d4 [[round|rounds]] ou [[fiévreux|fiévreuse]] pendant 1 [[round]] si elle réussit.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[contagion]]*, *[[guérison des maladies]]*, *[[nuage nauséabond]]*, *[[vomir une nuée]]* ;
- **Coût** 23 625 po
...
- **Niveau 13.** Une fois par jour, le porteur peut libérer les lumières de la lanterne sous forme de *[[poussière détoile|poussière d’étoile]]* ([[Volonté]] [[DD]] 16). La lumière du pendentif s’éteint pendant la durée de l’effet.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[lueur féerique]]*, *[[lumière]]*, *[[lumières dansantes]]*, *[[lumière du jour]]*, *[[poussière détoile|poussière d’étoile]]* ;
- **Coût** 10 500 po
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], [[Sort éloigné]], *[[clairaudienceclairvoyance|clairaudience/clairvoyance]]*, *[[sens aiguisés]]* ;
- **Coût** 6 000 po
...
- **Niveau 9.** Quand le porteur se concentre, il peut percevoir les pensées d’une seule créature sous forme de mots écrits dans les airs, dans la langue natale du sujet. Cet effet fonctionne comme si le porteur s’était concentré sur la créature pendant 3 [[round|rounds]] en utilisant *[[détection de pensées]]* et peut être bloqué avec un jet de [[Volonté]] réussi contre un [[DD]] égal au niveau de personnage du porteur + 6 (jusqu’à un [[DD]] maximum de 20). Une créature qui réussit son [[jds|jet de sauvegarde]] ne peut plus être affectée par ce même pouvoir pendant 24 heures. Le maintien de la concentration nécessite une [[action simple]] à chaque [[round]] (comme pour un sort) et, une fois que le porteur cesse de se concentrer sur une créature, il ne peut plus observer ses pensées pendant 1 minute. Ce pouvoir est utilisable pendant un total de 5 minutes par jour, qui ne doivent pas forcément être consécutives mais doivent être utilisées par incréments de 1 minute au minimum. Les lentilles ne fonctionnent pas contre les créatures ayant une valeur d’[[Intelligence]] de 2 ou moins ou dont la langue ne s’écrit pas.
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[détection de pensées]]*, le créateur doit avoir au moins 10 rangs en [[Psychologie]] ;
- **Coût** 15 250 po
...
- **Niveau 10.** La créature qui prononce le mot de commande peut substituer *[[sort Cauchemar|cauchemar]]* à *[[modification de mémoire]]*, avec le même [[DD]]. En outre, le porteur du masque peut comprendre et lire (mais pas parler) toutes les langues maîtrisées par la créature ciblée.
...
- **Niveau 14.** Si la créature ciblée est un humanoïde, le porteur peut prendre sa forme comme avec une *[[modification dapparence|modification d’apparence]]* et non plus comme un *[[déguisement]]*.
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[sort Cauchemar|cauchemar]]*, *[[communication avec les morts]]*, *[[contact avec les plans]]*, *[[déguisement]]*, *[[détection de pensées]]*, *[[don des langues]]*, *[[modification dapparence|modification d’apparence]]*, *[[modification de mémoire]]*, *[[physique monstrueux I]]* ;
- **Coût** 30 750 po
...
- **Niveau 9.** La perle fonctionne comme une [[Perle de thaumaturge|perle de thaumaturge (niveau 2)]].
- **Niveau 11.** La perle fonctionne comme une [[Perle de thaumaturge|perle de thaumaturge (niveau 3)]].
- **Niveau 14.** La perle fonctionne comme une [[Perle de thaumaturge|perle de thaumaturge (niveau 5)]], mais accorde un bonus de +1 au [[NLS|niveau de lanceur de sorts]] uniquement si elle sert à se rappeler un sort de niveau 4 ou moins.
- **Niveau 15.** La perle fonctionne comme une [[Perle de thaumaturge|perle de thaumaturge (niveau 6)]], mais accorde un bonus de +1 au [[NLS|niveau de lanceur de sorts]] uniquement si elle sert à se rappeler un sort de niveau 5 ou moins.
- **Niveau 16.** La perle fonctionne comme une [[Perle de thaumaturge|perle de thaumaturge (niveau 7)]], mais accorde un bonus de +1 au [[NLS|niveau de lanceur de sorts]] uniquement si elle sert à se rappeler un sort de niveau 6 ou moins.
- **Niveau 17.** La perle fonctionne comme une [[Perle de thaumaturge|perle de thaumaturge (niveau 8)]], mais accorde un bonus de +1 au [[NLS|niveau de lanceur de sorts]] uniquement si elle sert à se rappeler un sort de niveau 7 ou moins.
- **Niveau 19.** La perle fonctionne comme une [[Perle de thaumaturge|perle de thaumaturge (niveau 9)]], mais accorde un bonus de +1 au [[NLS|niveau de lanceur de sorts]] uniquement si elle sert à se rappeler un sort de niveau 8 ou moins. Sinon, la perle peut fonctionner comme une [[Perle de thaumaturge|perle de thaumaturge (deux sorts)]] mais n’accorde aucun bonus au [[NLS|niveau de lanceur de sorts]] si elle utilisée de cette façon.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], le créateur doit être capable de lancer des sorts de niveau 9 ;
- **Coût** 51 375 po
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[espoir]]* ;
- **Coût** 13 875 po
...
- **Niveau 7.** La plume peut devenir une [[Plume magique|plume magique (éventail)]].
- **Niveau 9.** La plume peut devenir une [[Plume magique|plume magique (oiseau)]].
- **Niveau 11.** La plume peut devenir une [[Plume magique|plume magique (arbre)]].
- **Niveau 13.** La plume peut devenir une [[Plume magique|plume magique (bateau)]] ou une [[Plume magique|plume magique (fouet)]].
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[création majeure]]*, *[[réparation intégrale]]* ;
- **Coût** 6 000 po
...
- **Niveau 8.** Le manteau magnifie et aiguise la beauté du porteur, si bien que son bonus de compétence de +4 s’applique désormais à tous ses tests de [[Charisme]], de compétences basées sur le [[Charisme]] et de [[Psychologie]] contre toutes les créatures. Contre les créatures [[type Fée|féeriques]], ce bonus passe à +6.
...
- **Niveau 12.** Une fois par jour, le porteur peut intensifier le scintillement du manteau pour créer une unique et vive explosion de couleur qui [[aveuglé|aveugle]] les créatures situées dans un rayon de 3 mètres ([[Réflexes]] [[DD]] 19 pour annuler) pendant 1d4 [[round|rounds]] et dissipe complètement tous les sorts de *[[ténèbres]]* de niveau 6 ou moins dont la source se trouve dans la zone d’effet.
...
- **Niveau 20.** Le type du porteur change pour celui de créature [[type Fée|féerique]] et il gagne une [[RD]] 10/[[fer froid]]. Si le type du porteur était déjà celui de créature féerique et qu’il possédait déjà une RD 10/fer froid, sa RD augmente de 10 et les armes magiques avec un bonus d’altération de +3 ou plus ne sont pas considérées comme des armes en fer froid quand il s’agit d’ignorer sa RD.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[explosion de lumière]]*, *[[lueur féerique]]*, *[[manoir somptueux]]*, *[[splendeur de laigle|splendeur de l’aigle]]*, *[[suggestion]]*, *[[sort Vol|vol]]*, le créateur doit être une créature [[type Fée|féerique]] ;
- **Coût** 132 000 po
...
- **Niveau 14.** Le porteur peut utiliser *[[souffle de dragon|souffle de dragon (dragon rouge)]]* une fois par jour. Le [[DD]] du [[jds|jet de sauvegarde]] est égal à 13 + le modificateur de [[Constitution]] du porteur, et l’effet n’autorise aucune [[RM|résistance à la magie]].
- **Niveau 16.** Le bonus d’altération à l’armure naturelle du porteur passe à +4 et sa résistance au feu est s’élève à 20.
- **Niveau 18.** Le porteur peut utiliser *[[souffle de dragon]]* trois fois par jour. Il peut également utiliser *[[forme draconique III]]* une fois par jour, avec un [[DD]] du [[jds|jet de sauvegarde]] égal à 22 + le modificateur de [[Constitution]] du porteur.
- **Niveau 20.** Le bonus d’altération à l’armure naturelle du porteur passe à +5 et sa résistance au feu s’élève à 30. En outre, tout effet de *[[souffle de dragon]]* généré par cet objet est amélioré par une [[Quintessence des sorts]].

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], [[Quintessence des sorts]], *[[souffle de dragon]]*, *[[forme draconique III]]*, *[[résistance aux énergies destructives]]*, *[[vision dans le noir]]* ;
- **Coût** 132 000 po
...
- **Niveau 12.** La capacité et le poids du sac augmentent, devenant l’équivalent d’un [[Sac sans fond|sac sans fond (modèle II)]].
- **Niveau 14.** La capacité et le poids du sac augmentent, devenant l’équivalent d’un [[Sac sans fond|sac sans fond (modèle III)]].
- **Niveau 15.** La capacité et le poids du sac augmentent, devenant l’équivalent d’un [[Sac sans fond|sac sans fond (modèle IV)]].

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[coffre secret]]* ;
- **Coût** 6 000 po
...
- **Niveau 10.** Le porteur peut augmenter la puissance de la poudre de pixie une fois par jour pour produire un effet de *[[poussière scintillante]]* (V[[olonté]] [[DD]] 13 pour annuler la cécité) pendant 3 [[round|rounds]]. Il doit jeter la poudre comme une arme de jet avec un facteur de portée de 3 mètres contre une [[CA]] de 5 pour toucher la bonne intersection du quadrillage. S’il échoue, traitez la poussière comme une [[arme à aspersion]] afin de déterminer le centre de l’effet.
- **Niveau 13.** Le porteur peut utiliser le pouvoir de *[[poussière scintillante]]* trois fois par jour.
- **Niveau 15.** Le porteur peut saupoudrer sa propre personne ou une cible consentante adjacente de poussière de pixie une fois par jour, pour conférer à la cible la capacité de voler (comme avec le sort de *[[sort Vol|vol]]*) pendant 5 minutes.
- **Niveau 18.** Le porteur peut utiliser le pouvoir de *[[sort Vol|vol]]* trois fois par jour et peut également jeter la poussière de pixie pour accorder le pouvoir de *[[sort Vol|vol]]* à une cible non-adjacente. Pour toucher une cible consentante non-adjacente avec la poussière de pixie, il doit jeter la poussière comme une arme de jet avec un facteur de portée de 3 mètres contre une [[CA]] de 5 + tous les modificateurs qui augmentent la [[CA]] au contact et [[pris au dépourvu]] de la cible, comme les bonus de parade et d’[[abri]], par exemple. S’il échoue, traitez la poussière comme une [[arme à aspersion]] : s’il y a des créatures dans la case d’arrivée, déterminez au hasard celle ciblée par l’effet de *[[sort Vol|vol]]*.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[lueur féerique]]*, *[[poussière scintillante]]*, *[[sort Vol|vol]]* ;
- **Coût** 13 250 po
...
- **Niveau 11.** Une fois par jour, le porteur peut tenter d’[[effrayé|effrayer]] une créature avec un test d’[[Intimidation]] plutôt que de la démoraliser. Il doit déclarer cette action avant d’effectuer son test d’[[Intimidation]]. L’augmentation du malus sur les tests et les jets impliquant le porteur s’applique également si la créature est effrayée de la sorte.
- **Niveau 14.** Le porteur peut tenter de démoraliser ses adversaires par une [[action de mouvement]] plutôt que par une [[action simple]]. Si le porteur peut déjà le faire grâce au pouvoir de [[Pouvoirs de rage#REGARDINTIMIDANT|regard intimidant]] du barbare ou une aptitude similaire, il peut, à la place, démoraliser ses adversaires par une [[action rapide]].

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[anathème]]*, *[[frayeur]]* ;
- **Coût** 4 625 po
...
- **Niveau 10.** La monture gagne un bonus de résistance de +1 aux [[jds|jets de sauvegarde]] et un bonus de parade de +1 à la [[CA]].
...
- **Niveau 13.** Les bonus de la selle aux [[jds|jets de sauvegarde]] et à la [[CA]] passent à +2.
- **Niveau 15.** Les bonus de la selle aux [[jds|jets de sauvegarde]] et à la [[CA]] passent à +3. Quand le cavalier commande à la selle d’accorder des points de vie temporaires à la monture, le cavalier gagne également un nombre de points de vie temporaires égal à la moitié du nombre conféré à sa monture.

(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[aide]]*, *[[protection dautrui|protection d’autrui]]*, *[[sort Résistance|résistance]]* ;
- **Coût** 18 000 po
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[caméléon]]*, *[[empire végétal]]*, *[[flou]]*, *[[forme darbre|forme d’arbre]]*, *[[œil du mage]]*, *[[œil indiscret]]*, *[[voyage par les arbres]]* ;
- **Coût** 66 000 po
...
- **Niveau 11.** Une fois par jour, le porteur peut annuler par simple contact l’état [[secoué]] ou [[fiévreux]] dont lui ou un allié est affligé. Il s’agit d’une [[action simple]], ou d’une [[action rapide]] s’il se soigne lui-même. En outre, il est impossible de forcer le porteur à garder un [[Objets maudits|objet maudit]]. Ceci n’empêche pas les effets de l’objet maudit d’agir mais permet au porteur de se débarrasser librement de l’objet.
- **Niveau 13.** Une fois par jour par une [[action immédiate]], le porteur peut utiliser *[[annulation denchantement|annulation d’enchantement]]* contre un effet qui vient tout juste de s’activer sur lui, même si cet effet lui fait perdre conscience ou le contrôle de ses actions. Un seul effet peut être pris pour cible par cette *[[annulation denchantement|annulation d’enchantement]]*. Il est possible de recharger cette protection en lançant *[[annulation denchantement|annulation d’enchantement]]* sur la veste.
...
(((Fabrication)))
- **Conditions** [[Création dobjets merveilleux|Création d'objets merveilleux]], *[[annulation denchantement|annulation d’enchantement]]* ;
- **Coût** 18 000 po
