...
### Mythique
{s:CMy}
Considérez que le total actuel de points de vie de la cible est diminué d’un montant égal à 5 fois le [[grade]] du personnage. Par exemple, un [[archimage mythique|archimage]] de [[grade]] 3 qui lance un mot de pouvoir aveuglant mythique considérera une créature avec 60 pv comme une créature avec 45 pv et le sort l’aveuglera donc de manière permanente.
