---
Name: Pathfinder-RPG.Mystère du temps
Title: Mystère du temps
LastModified: 2025-02-12 23:31
---

{s:MenuMystères}{s:um}
**Compétences de classe.** Un oracle du mystère du temps ajoute [[Vol]], [[Connaissances]] (mystères), [[Perception]] et [[Utilisation dobjets magiques|Utilisation d'objets magiques]] à sa liste de compétences de classe.
...
**Contact vieillissant (Sur).** Le contact du personnage suffit à faire vieillir les créatures vivantes et les objets. Par une [[attaque de contact au corps à corps]], il peut infliger 1 point d’[[affaiblissement temporaire]] de [[Force]] par tranche de deux niveaux d’[[oracle]] aux créatures vivantes. Il inflige 1d6 points de dégâts par niveau d’[[oracle]] aux objets et aux [[type Créature artificielle|créatures artificielles]]. Si l’[[oracle]] utilise ce pouvoir contre un objet qui se trouve en possession d’une autre créature, cette attaque est considérée comme une tentative de [[destruction]]. Chaque jour, le personnage peut utiliser ce pouvoir une fois et une fois de plus tous les cinq niveaux.
...
**Saut temporel (Sur).** Par une [[action de mouvement]], le personnage peut se téléporter sur une distance maximale de 3 mètres par niveau d’[[oracle]] par jour. Cette distance de téléportation se divise en segments de 1,50 mètre. Ce mouvement ne provoque pas d’[[attaque dopportunité|attaques d’opportunité]]. Il doit voir sa destination pour se servir de ce pouvoir. Il peut emmener des créatures consentantes avec lui mais il doit faire une dépense de distance supplémentaire pour chacune. Il doit être au moins de niveau 7 pour choisir cette révélation.
