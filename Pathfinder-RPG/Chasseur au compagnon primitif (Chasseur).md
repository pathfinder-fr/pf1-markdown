...
#### Maître primitif (Sur)
Au niveau 20, un chasseur au compagnon primitif s’accorde avec sa nature primitive. Il peut activer la transformation primitive de son compagnon par une [[action libre]]. Quand il utilise l’éruption primitive, il peut conférer à son compagnon deux évolutions au lieu d’une seule (au coût maximum de 4 points chacune). Cette aptitude remplace maître chasseur.
