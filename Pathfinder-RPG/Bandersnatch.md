---
Name: Pathfinder-RPG.Bandersnatch
Title: Bandersnatch
LastModified: 2021-02-21 15:20
Categories:
- Bestiaire 3
- Monstre
- Règles officielles
...
<div class="BD">
{s:BDTitre|Bandersnatch|FP 17}
{s:pucem|Créature magique|Forêt-Jungle|Tempéré}
{s:BDTexte|*Source : Bestiaire 3 p.28*}
{s:BDTexte|**PX** 102 400}
{s:BDTexte|[[type Créature magique|Créature magique]] de taille Gig, N}
{s:BDTexte|**Init** +11 ; **Sens** [[odorat]], [[perception aveugle]] à 36 m (24 {s:c}), [[vision dans le noir]] à 36 m (24 {s:c}), [[vision nocturne]] ; [[Perception]] +26}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 33, contact 13, pris au dépourvu 26 (Dex +7, naturelle +20, taille -4)}
{s:BDTexte|**pv** 310 (23d10+184) ; guérison accélérée 10}
{s:BDTexte|**Réf** +20, **Vig** +21, **Vol** +11}
{s:BDTexte|**Capacité défensive** piquants protecteurs, récupération rapide ; **Immunités** paralysie, poison, sommeil, terreur}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 18 m (12 {s:c}), escalade 6 m (4 {s:c})}
{s:BDTexte|**Corps à corps** 2 griffes, +32 (2d6+13/19-20) et morsure, +32 (2d8+13 plus étreinte) et queue, +27 (2d8+19/x3 plus douleur}
{s:BDTexte|**A distance** 4 piquants, +24 (1d10+13/19-20)}
{s:BDTexte|**Espace occupé** 6 m (4 {s:c}) ; **Allonge** 4,50 m (3 {s:c}) (6 m (4 {s:c}) avec la queue)}
{s:BDTexte|**Attaques spéciales** [[bond (capacité)|bond]], charge bondissante, coup violent, [[éventration (capacité)|éventration]] (2 griffes, 2d6+19), [[pattes arrière (capacité)|pattes arrière]] (4 griffes, +32, 2d6+13/19-20), queue brutale, regard}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 36, **Dex** 25, **Con** 27, **Int** 2, **Sag** 15, **Cha** 18}
{s:BDTexte|**BBA** +23, **BMO** +40 (+44 [[lutte]]), **DMD** 57 (65 contre le [[croc-en-jambe]])}
{s:BDTexte|**Dons**  [[Attaques réflexes]], [[Critique épuisant]], [[Critique fatigant]], [[Critique sanglant]], [[Don pour les critiques]], [[Maîtrise du critique]], [[Science de la volonté de fer]], [[Science de linitiative|Science de l’initiative]], [[Science du critique]] (griffes), [[Science du critique]] (piquants), [[Talent]] ([[Discrétion]]), [[Volonté de fer]]}
{s:BDTexte|**Compétences**  [[Acrobaties]] +19 (+31 pour le saut), [[Discrétion]] +18 (+26 en forêt), [[Escalade]] +21, [[Perception]] +26, [[Survie]] +3 (+23 pistage)}
{s:BDTexte|**Modificateurs raciaux**  +8 en [[Acrobaties]], +4 en [[Discrétion]] (+12 en forêt), +10 en [[Perception]], +20 en [[Survie]] pour le pistage}
{s:BDTexte|**Particularités** acclimatation planaire, traqueur infatigable}
...
{s:BDTexte|**Piquants (Ext).** Lorsqu’il donne un coup de queue, le bandersnatch peut lancer une volée de quatre piquants en une [[action simple]] (faites un jet d’attaque pour chacun d’eux). Cette attaque a une portée de 90 m (60 {s:c}), sans facteurs de portée. Toutes les cibles doivent se trouver à moins de 9 m (6 {s:c}) les unes des autres. Les piquants envoyés repoussent en un [[round]] au cours duquel le bandersnatch ne perd rien de ses capacités défensives.}
{s:BDTexte|**Piquants protecteurs (Ext).** Une créature attaquant le bandersnatch avec une arme de corps à corps sans allonge, à mains nues ou avec une arme naturelle reçoit 1d10 points de dégâts perforants dus aux piquants du bandersnatch et souffre de son attaque de douleur.}
{s:BDTexte|**Queue brutale (Ext).** Les pointes et piquants de la queue du bandersnatch infligent le triple des dégâts sur un [[coup critique]] effectué avec la queue. Le bandersnatch ajoute de plus 1,5 fois son bonus de [[Force]] à ses jets d’attaque lorsqu’il frappe avec sa queue.}
{s:BDTexte|**Récupération rapide (Sur).** Un bandersnatch affaibli récupère à une vitesse impressionnante. S’il commence son tour d’action en étant affligé par l’un ou par la totalité des états cités ci-dessous, ces états se dissipent à la fin de son tour : [[confus]], [[ébloui]], [[épuisé]], [[étourdi]], [[fatigué]], [[fiévreux]], [[hébété]] et [[nauséeux]]. En outre, un bandersnatch victime d’un [[affaiblissement temporaire|affaiblissement temporaire ou permanent]] de caractéristique, ou soumis à un effet mental autorisant un [[jet de sauvegarde]], a droit, à la fin de son tour, à un unique [[jet de sauvegarde]] supplémentaire (même [[DD]] que le premier) pour dissiper l’effet de son choix.}
{s:BDTexte|**Regard (Sur).** [[confus|Confusion]] pendant 1 [[round]], portée 9 m (6 {s:c}), JdS [[Vigueur]] [[DD]] 29 [[Présentation des sorts#JETSDESAUVEGARDE|annule]]. Le bandersnatch peut diriger une attaque de regard sur un unique ennemi par une [[action rapide]]. C’est un effet mental de coercition. Le [[DD]] du [[jet de sauvegarde]] est basé sur la [[Constitution]].}
{s:BDTexte|**Traqueur infatigable (Ext).** Le bandersnatch peut se déplacer au double de sa vitesse maximale tout en suivant une piste, sans malus. Il bénéficie d’un bonus de compétence de +10 aux tests de [[Survie]] pour pister les créatures qu’il a blessées.}
...
- **Bandersnatch annihilateur de magie (FP +3).** Ces bandersnatchs dégagent une aura anti-magique de 6 mètres (4 {s:c}) de rayon. Si cette aura disparaît, elle réapparaît automatiquement au tour suivant du bandersnatch, par une [[action libre]]. Les athamés n’ont pas les capacités de regard et de récupération rapide des autres bandersnatchs. 
...
- **Bandersnatch primitif (FP +2).** Les primtifs sont encore liés à l’ancien monde des fées. Ils ont le [[sous-type extraplanaire]], une [[RM]] égale à 11 plus leur FP, une [[RD]] de 10/fer froid, et l’archétype simple de [[Archétypes#CREATUREEVOLUEE|créature évoluée]]. 
