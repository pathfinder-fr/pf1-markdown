---
Name: Pathfinder-RPG.Achaïéraï
Title: Achaïéraï
LastModified: 2013-02-02 13:04
Categories:
- Bestiaire 2
- Monstre
- Règles officielles
...
<div class="BD">
{s:BDTitre|Achaïéraï|FP 5}
{s:pucem|Extérieur|Plaines|Extraplanaire}
{s:BDTexte|*Source : Bestiaire 2 page 9*}
{s:BDTexte|**PX** 1.600}
{s:BDTexte|[Extérieur](./type Extérieur.md) ([extraplanaire](./sous-type extraplanaire.md), [Loi](./sous-type Loi.md), [Mal](./sous-type Mal.md)) de taille G, LM}
{s:BDTexte|**Init** +1 ; **Sens** [vision dans le noir](./vision dans le noir.md) 18 m (12 {s:c}) ; [Perception](./Perception.md) +12}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 20, contact 11, pris au dépourvu 18 (Dex +1, naturelle +9, taille -1)}
{s:BDTexte|**pv** 52 (7d10+14)}
{s:BDTexte|**Réf** +6, **Vig** +7, **Vol** +4}
{s:BDTexte|**RM** 20 }
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 15 m (12 {s:c})}
{s:BDTexte|**Corps à corps** morsure, +10 (2d6+4) et 2 griffes, +10 (1d6+4)}
{s:BDTexte|**Espace** 3 m (2 {s:c}) ; **Allonge** 3 m (2 {s:c}) pour les griffes}
{s:BDTexte|**Attaques spéciales** nuage noir}
{s:BDSousTitre|Statistiques}
{s:BDTexte|**For** 19, **Dex** 13, **Con** 14, **Int** 11, **Sag** 14, **Cha** 16}
{s:BDTexte|**BBA** +7, **BMO** +12, **DMD** 24 (28 contre [croc-en-jambe](./croc-en-jambe.md))}
{s:BDTexte|**Dons** [Attaque éclair](./Attaque éclair.md), [Attaques réflexes](./Attaques réflexes.md), [Esquive](./Esquive.md), [souplesse du serpent](./Souplesse du serpent.md)}
{s:BDTexte|**Compétences** [Acrobaties](./Acrobaties.md) +11 (+19 pour sauter), [Discrétion](./Discrétion.md) +7, [Escalade](./Escalade.md) +14, [Natation](./Natation.md) +14, [Perception](./Perception.md) +12, [Psychologie](./Psychologie.md) +12, [Vol](./Vol.md) +0}
{s:BDTexte|**Langues** infernal}
{s:BDSousTitre|Écologie}
{s:BDTexte|**Environnement** terre ferme (enfer)}
{s:BDTexte|**Organisation sociale** solitaire ou troupeau (5-8)}
{s:BDTexte|**Trésor** standard}
{s:BDSousTitre|Capacités spéciales}
{s:BDTexte|**Nuage noir (Sur).** Un achaïéraï peut expirer un nuage de fumée étouffante et toxique trois fois par jour. Toutes les créatures situées dans un rayon de 3 mètres autour de l’achaïéraï voient leurs chairs fondre et pourrir et subissent immédiatement 2d6 points de dégâts. Le nuage n’attaque pas seulement la chair mais aussi l’esprit : toutes les créatures qui ont été blessées par le nuage doivent réussir un [jet de Vigueur](./jet de sauvegarde.md) de [DD](./DD.md) 15 pour ne pas être [confuses](./Confus.md). Chaque [round](./round.md), la victime peut tenter un nouveau [jet de Vigueur](./jet de sauvegarde.md) contre un [DD](./DD.md) de 15 pour mettre un terme à la confusion. La confusion persiste jusqu’à ce que la victime réussisse un [jet de sauvegarde](./jet de sauvegarde.md) (à moins qu’on y mette un terme en employant un sort ou une autre méthode). L’effet de confusion est un [effet mental](./effet mental.md). Le [DD](./DD.md) du jet de sauvegarde dépend de la [Constitution](./Constitution.md). Il s’agit d’un effet de [poison](./poison.md). Les achaïéraïs sont immunisés contre les effets du nuage noir.}
</div>
</td><td><div>
