---
Name: Pathfinder-RPG.Estimateur dAbadar
Title: Estimateur légal
LastModified: 2021-12-06 18:17
Categories:
- Classe de prestige
- Src Guide du Katapesh
---

{s:MenuClassesDePrestige}{s:cs}{s:CSU|8}<u>***Contenu issu d'un supplément 3.5***</u>
...
<table CLASS="tablo centre autoalt">
  <caption>L'estimateur légal</caption>
  <tr CLASS="titre">
    <td>Niveau</td>
    <td>BBA</td>
    <td>Réflexes</td>
  ...
  <tr CLASS="premier">
    ...
    <td>+0</td>
    <td>+2</td>
    <td CLASS="gauche">[[Estimateur dAbadar#PASSERUNEPROTECTIONMAGIQUE|Passer une protection magique]]</td>
    <td CLASS="gauche">—</td>
  </tr>
  <tr>
    <td>2</td>
    ...
    <td>+0</td>
    <td>+3</td>
    <td CLASS="gauche">[[Estimateur dAbadar#EVALUATION|Évaluation]]</td>
    <td CLASS="gauche">[[Estimateur dAbadar#SORTS|+1 niveau dans une classe de lanceur de sorts divins existante]]</td>
  </tr>
  <tr>
    <td>3</td>
    <td>+1</td>
    ...
    <td>+3</td>
    <td CLASS="gauche">
      [[Estimateur dAbadar#SACDECONTENANCE|Sac de contenance (2e modèle)]], [[Estimateur dAbadar#ACCESAUCOFFRE|Accès
      au Coffre (objet non-magique)]]
    </td>
    <td CLASS="gauche">[[Estimateur dAbadar#SORTS|+1 niveau dans une classe de lanceur de sorts divins existante]]</td>
  </tr>
  <tr>
    ...
    <td>+1</td>
    <td>+4</td>
    <td CLASS="gauche">[[Estimateur dAbadar#NEGOCIATEURELOQUENT|Négociateur éloquent]]</td>
    <td CLASS="gauche">[[Estimateur dAbadar#SORTS|+1 niveau dans une classe de lanceur de sorts divins existante]]</td>
  </tr>
  <tr>
    <td>5</td>
    ...
    <td>+1</td>
    <td>+4</td>
    <td CLASS="gauche">[[Estimateur dAbadar#ACCESAUCOFFRE|Accès au Coffre (objet magique)]]</td>
    <td CLASS="gauche">[[Estimateur dAbadar#SORTS|+1 niveau dans une classe de lanceur de sorts divins existante]]</td>
  </tr>
  <tr>
    <td>6</td>
    ...
    <td>+5</td>
    <td CLASS="gauche">
      [[Estimateur dAbadar#PASSAGEPARLECOFFRE|Passage par le Coffre]], [[Estimateur dAbadar#SACDECONTENANCE|sac de
      contenance (2e modèle)]]
    </td>
    <td CLASS="gauche">[[Estimateur dAbadar#SORTS|+1 niveau dans une classe de lanceur de sorts divins existante]]</td>
  </tr>
</table>
...
Pour obtenir la permission d’entrer dans des ruines gorgées de trésors, il faut parfois parler aux bonnes personnes et échanger quelques pièces à titre de pots-de-vin, « d’honoraires d’intermédiaire », et ainsi de suite. Au niveau 4, un estimateur apprend quelles sont les pattes à graisser et quelles sont les promesses à faire, gagnant ainsi un bonus de +2 aux tests de Diplomatie lorsqu’il propose le pot-de-vin approprié pendant la discussion (minimum de 10 po × le niveau du destinataire). De plus, il reçoit un bonus sacré de +2 sur les tests de Charisme visant à contraindre une créature liée à exécuter un service lorsqu’il use des sorts de contrat.
...
Comme il n’existe qu’une seule copie parfaite de chaque objet dans le Premier Coffre, il y a une infime chance (approximativement 1%) pour que l’objet que le personnage désire soit indisponible car une autre personne l’a emprunté. Si cela se produit, l’invocation n’épuise pas la capacité hebdomadaire de l’estimateur et il peut de nouveau essayer au prochain round d’invoquer cet objet ou un autre.

Certains érudits religieux avancent la théorie que les objets invoqués par ce pouvoir ne proviennent pas réellement du Premier Coffre, car leur dieu ne prêterait pas ses propres copies parfaites, et qu’ils sont en réalité des copies de ces objets parfaits, peut-être placés dans un autre coffre divin créé à cette fin ou qui joue le rôle de réserve de secours.
