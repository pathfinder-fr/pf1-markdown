---
Name: Pathfinder-RPG.PNJ Archer timide
Title: Archer timide
LastModified: 2025-02-17 17:06
Categories:
- PNJ
- Src Manuel des PNJ
---
...
{s:BDTexte|**Réf** +4, **Vig** +6, **Vol** +2 ; +2 contre les enchantements}
{s:BDTexte|**Immunités** sommeil}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 6 m}
{s:BDTexte|**Corps à corps** lame elfique incurvée, +10/+5 (1d10+3/18–20)}
{s:BDTexte|**Distance** *arc long composite +1*, +12/+7 (1d8+3/×3)}
{s:BDSousTitre|Tactique}
{s:BDTexte|**Pendant le combat** L’homme d’armes utilise ses *flèches de feu +1* sur les cibles dangereuses comme les lanceurs de sorts. Il se recule et continue de tirer à mesure que les ennemis s’approchent, évitant le combat au corps à corps aussi longtemps que possible.}
