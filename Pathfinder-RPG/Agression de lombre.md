---
Name: Pathfinder-RPG.Agression de lombre
Title: Agression de l'ombre
LastModified: 2019-08-15 18:21
Categories:
- Don
...
Le personnage doit soit effectuer une attaque de contact au corps à corps, soit conférer à la cible un jet de sauvegarde (Vigueur ou Réflexes) pour résister aux dégâts (voir plus bas).

S’il choisit l’attaque de contact au corps à corps, il applique son bonus d’attaque de contact au corps à corps et, s’il rate, le sort n’inflige aucun dégâts. S’il permet à la cible d’effectuer un jet de sauvegarde, la réussite de ce jet permet de réduire de moitié les dégâts infligés.

L’attaque des ombres inflige 1d6 points de dégâts par niveau du sort. Si la cible réfute l’illusion ou voit au travers, les dégâts sont réduits de moitié.
