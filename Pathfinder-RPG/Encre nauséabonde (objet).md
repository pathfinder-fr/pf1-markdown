---
Name: Pathfinder-RPG.Encre nauséabonde (objet)
Title: Encre nauséabonde
...
{s:racial|Homme-rat (race)|h-rats|Illustrations/PNJ/Homme-rat.jpg}{s:MR}**Prix** 5 po (standard), spécial (magique) ; **Poids** 0,5 kg (standard), 0,5 kg (magique) ; **DD d'Artisanat (alchimie)** 15 (standard), — (magique)
