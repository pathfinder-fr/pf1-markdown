---
Name: Pathfinder-RPG.Ijiraq
Title: Ijiraq
LastModified: 2017-03-19 11:42
---

<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Ijiraq|FP 9}
...
(((Attaque)))
- **VD **9 m
- **Corps à corps** 2 griffes, +10 (2d4+3) et morsure, +10 (2d6+3) et cornes, +10 (2d6+3)
...
- **Trésor **standard (surtout des gravures précieuses sur ivoire)
(((Pouvoirs spéciaux)))
- **Caché en pleine lumière (Sur)**. L’ijiraq peut utiliser la compétence de Discrétion même lorsqu’il est observé. Tant qu’il se trouve sur un terrain couvert de glace ou de neige, il peut se soustraire à la vue d’autrui dans une zone dégagée, même s’il ne dispose d’aucun abri derrière lequel se cacher. Il ne peut pas utiliser cette compétence en volant et ce pouvoir n’a aucun effet si l’ijiraq ne se trouve pas sur un terrain couvert de glace ou de neige.
- **Regard déconcertant (Sur)**. De son regard de glace, l’ijiraq peut fixer une créature située à 9 mètres ou moins. Celle-ci subit un malus de -20 aux tests de Perception et de Survie pendant 24 heures (Vigueur DD 23 annule). Le DD du jet de sauvegarde est basé sur le Charisme. L’ijiraq peut utiliser ce pouvoir sous forme d’élan.
