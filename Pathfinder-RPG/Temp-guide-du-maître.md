...
Elle fait une référence à une feuille de ville. Il faudrait l'intégrer en document quelque part.

Faut-il créer plusieurs pages ? Une page avec les règles et une page avec les exemples de ville ?
...
- <nowiki>{s:gdm}</nowiki> pour faire apparaître le logo du Guid du Maître à droite
- Les pages de redirection seront à faire : d'abord créer les ancres sur la page vers lesquelles il faut rediriger puis créer la page de redirection en partant du lien en rouge en copiant l'instruction suivante <nowiki>{s:Redirection|Pathfinder-RPG.pagededestination|ANCRECREEE}</nowiki>


### Ne pas oublier

- ~~de créer une catégorie de page intitulée guide du maître~~
- de cocher les cases : règles officielles, guide du maître pour chaque page créée.
- de renseigner les keywords, les principaux termes utilisés sur la page (par exemple, folie, santé mentale) et guide du maître
- de signaler sur le fil les termes que vous souhaitez intégrer dans le wiki pour permettre de faire des redirections vers les explications qui les concernent.
- de signaler sur le fil les snippet qu'il faut créer
- placer le snippet <nowiki>{s:gdm}</nowiki>


Lorsqu'une page est terminée. Il faut le signaler sur le fil du wiki pour faire un appel aux relecteurs.


**La consolidation de la page d'accueil du wiki peut être faite soit au fur et à mesure, soit lorsque toutes les pages auront été créées au choix du coordinateur. **
