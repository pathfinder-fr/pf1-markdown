---
Name: Pathfinder-RPG.Wécufe
Title: Wécufe (ou Huécuva)
LastModified: 2021-04-11 17:31
---

<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Wécufe (ou Huécuva)|FP 2}
{s:pucem|Mort-vivant|Souterrain|Tempéré}
{s:BDTexte|*Source : Bestiaire 3 p280*}
{s:BDTexte|**PX** 600}
...
{s:BDTexte|**Aura** hérésie 9 m (6 {s:c})}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 15, contact 12, pris au dépourvu 13 (Dex +2, naturelle +3)}
{s:BDTexte|**pv** 16 (3d8+3)}
{s:BDTexte|**Réf** +3, **Vig** +2, **Vol** +4}
{s:BDTexte|**Immunités** [traits des morts-vivants](./Traits des morts-vivants.md) ; **RD** 5/magique ou argent }
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9 m (6 {s:c})}
{s:BDTexte|**Corps à corps** 2 griffes +4 (1d6+1 et maladie)}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 13, **Dex** 14, **Con** -, **Int** 4, **Sag** 12, **Cha** 12}
{s:BDTexte|**BBA** +2, **BMO** +3, **DMD** 15}
{s:BDTexte|**Dons** [Arme de prédilection](./Arme de prédilection.md) (griffe), [Science de l'initiative](./Science de linitiative.md)}
{s:BDTexte|**Compétences** [Discrétion](./Discrétion.md) +7, [Perception](./Perception.md) +5}
{s:BDTexte|**Langues** commun}
{s:BDTexte|**Particularités** fausse humanité}
{s:BDSousTitre|Écologie}
{s:BDTexte|**Environnement** tous}
{s:BDTexte|**Organisation sociale** solitaire, couple ou cloître (3-10)}
{s:BDTexte|**Trésor** standard}
{s:BDSousTitre|Capacités spéciales}
{s:BDTexte|**Aura d'hérésie** (Sur) Le Le wécufe et toutes les créatures mortes-vivantes situées dans un rayon de 9 mètres reçoivent un bonus de malfaisance de +2 à leurs [jets de Volonté](./jet de sauvegarde.md) pour résister à l’[énergie canalisée](./canalisation.md) et aux effets d’énergie positive.}
{s:BDTexte|**Fausse humanité** (Sur) Pendant le jour, le wécufe est dissimulé derrière une illusion auditive, visuelle et tactile qui le fait apparaître comme la créature vivante qu’il était autrefois. Cet effet fonctionne comme *[déguisement](./Déguisement.md)* : si une créature interagit directement avec le wécufe, elle peut tenter un [jet de Volonté](./jet de sauvegarde.md) [DD](./DD.md) 12 pour voir au travers de l’illusion. Cela dit, l’odeur du wécufe ne change pas : il a toujours une légère odeur de poussière et de décomposition. Les créatures ayant la capacité [odorat](./Odorat (capacité).md) reçoivent un bonus de +4 à leurs jets de Volonté pour voir au travers de l’illusion. De nuit (que le wécufe sache ou non que la nuit est tombée), cette illusion se dissipe et révèle la créature telle qu’elle est vraiment. Le [DD](./DD.md) du [jet de sauvegarde](./jet de sauvegarde.md) est basé sur le [Charisme](./Charisme.md).}
{s:BDTexte|**Maladie (Ext)** *Fièvre des marais* - Blessure ; *JS* Vigueur DD 12 ; *incubation* 1d3 jours ; *fréquence* 1/jour ; *effet* Affaiblissement temporaire de 1d3 Dex et 1d3 For ; *guérison* 2 réussites consécutives. Le [jet de sauvegarde](./jet de sauvegarde.md) dépend du [Charisme](./Charisme.md).}
</td><td><div>
