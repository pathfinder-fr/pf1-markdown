...
{s:BDTexte|**Réf** +0, **Vig** +8, **Vol** +5}
{s:BDTexte|**Capacités défensives** abandon de la chair, armure de chair, affinité avec l’énergie négative}
...
{s:BDTexte|**Organisation** sociale solitaire ou nid (2-20)}
{s:BDTexte|**Trésor** standard}
(((Pouvoirs spéciaux)))
{s:BDTexte|**Abandon de la chair (Sur).** Par une action rapide, un vermlek peut
...
{s:BDTexte|**Armure de chair (Sur).** Lorsqu’un vermlek occupe un corps d’humanoïde
...
{s:BDTexte|**Possession corporelle (Sur).** Un vermlek peut s’introduire dans le
...
{s:BDTexte|**Affinité avec l’énergie négative (Ext)**. L’énergie négative soigne
...
<div>
#### Écologie
Les vermleks naissent des âmes de ceux qui ont perturbé de leur
...
#### Habitat et société
Les vermleks pullulent généralement sur les sites abyssaux où se
