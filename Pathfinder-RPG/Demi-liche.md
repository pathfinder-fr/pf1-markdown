...
{s:BDTexte|**Init** +7 ; **Sens** [[vision dans le noir]] 18 m (12 {s:c}), *[[vision lucide]]* ; [[Perception]] +27}
...
{s:BDTexte|**Capacités défensives** grâce impie, reconstruction, [[Résistance à la canalisation (capacité)|résistance à la canalisation]] +5 ; **[[Réduction de dégâts (capacité)|RD]]** 20/— ; **[[Immunité (capacité)|Immunité]]** acide, électricité, froid, magie, métamorphose, [[Traits des morts-vivants (capacité)|traits des morts-vivants]]}
{s:BDTexte|**Faiblesses** sensibilité aux effets vorpals, torpeur}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** [[Vol (capacité)|vol]] 9 m (6 {s:c}) (parfaite)}
...
{s:BDSorts|À volonté — malédiction suprême (DD 21), *[[plainte doutre-tombe|plainte d’outre-tombe]]* (zone de 6 m (4 {s:c}) de rayon centrée sur la demi-liche ; DD 24), *[[télékinésie]]* (DD 20)}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 6, **Dex** 17, **Con** —, **Int** 21, **Sag** 20, **Cha** 21}
{s:BDTexte|**BBA** +11 ; **BMO** +12 ; **DMD** 30}
{s:BDTexte|**Dons** [[Attaque en vol]], [[Esquive]], [[Maîtrise du combat défensif]], [[Attaque spéciale renforcée]] (engloutissement d’âmes), [[Réflexes surhumains]], [[Science de linitiative|Science de l’initiative]], [[Souplesse du serpent]], [[Vigilance]], [[Volonté de fer]]}
{s:BDTexte|**Compétences** [[Art de la magie]] +23, [[Bluff]] +20, [[Connaissances]] (exploration souterraine) +20, [[Connaissances]] (histoire) +15, [[Connaissances]] (mystères) +23, [[Connaissances]] (plans) +15, [[Connaissances]] (religion) +18, [[Discrétion]] +24, [[Perception]] +27, [[Psychologie]] +27, [[Vol]] +23}
...
{s:BDTexte|**Engloutissement d’âmes (Sur).** Par une [[action simple]] et avec une portée de 90 m (60 {s:c}), la demi-liche peut emprisonner l’âme d’une créature vivante au sein de l’un des dix joyaux spéciaux enchâssés dans son crâne. Si la cible réussit un [[Valeurs de combat#JETDESAUVEGARDE|jet de Vigueur]] DD 24, elle reçoit deux [[Absorption dénergie (capacité)|niveaux négatifs permanents]]. Si elle échoue, son âme est immédiatement aspirée dans l’un des joyaux du crâne de la demi-liche. Son âme y reste piégée, n’apparaissant que comme une simple lueur, sauf avec *[[vision lucide]]*. Le corps dépourvu de son âme se corrompt et se décompose rapidement, se transformant en cendres en un round. Tant que l’âme de la créature morte reste piégée dans le joyau, elle ne peut être ramenée à la vie par aucun moyen à l’exception d’une intervention divine directe. On peut récupérer les joyaux renfermant les âmes sur une demi-liche détruite et les briser pour relâcher les âmes piégées dans l’au-delà, ou les utiliser comme composantes matérielles pour restaurer l’âme et le corps avec *[[résurrection]]* ou *[[résurrection suprême]]*.  
Une demi-liche peut consumer une âme piégée depuis 24 heures dans ses joyaux, se soignant de 1d6 points de vie par dé de vie de l’âme : à ce moment, seuls *[[miracle]]* ou *[[souhait]]* peuvent ramener à la vie la créature morte. Le DD du jet de sauvegarde est basé sur le Charisme et inclut un bonus de +2 pour le don [[Attaque spéciale renforcée]].}
{s:BDTexte|**Grâce impie (Sur).** La demi-liche reçoit un bonus à ses [[Valeurs de combat#JETDESAUVEGARDE|jets de sauvegarde]] et un bonus de malfaisance à la [[Valeurs de combat##CA|CA]] égal à son modificateur de Charisme.}
{s:BDTexte|**Immunité contre la magie (Sur).** La demi-liche est [[Immunité (capacité)|immunisée]] contre tous les sorts ou pouvoirs magiques qui autorisent une résistance à la magie. En outre, certains sorts fonctionnent différemment contre la créature, comme indiqué ci-dessous : 
Un sort de *[[rejet du Mal]]* inflige 2d6 points de dégâts, sans [[Valeurs de combat#JETDESAUVEGARDE|jet de sauvegarde]].  
*[[Châtiment sacré]]* affecte la demi-liche normalement.   
Un *[[mot de pouvoir mortel]]* prononcé par un lanceur de sorts éthéré inflige 50 points de dégâts à la demi-liche si celle-ci rate un [[Valeurs de combat#JETDESAUVEGARDE|jet de Vigueur]] (dont le DD est déterminé comme si le sort autorisait un jet de sauvegarde).  
Un sort de *[[fracassement]]* inflige 1d6 points de dégâts par tranche de deux niveaux de lanceur de sorts (maximum 10d6), sans [[Valeurs de combat#JETDESAUVEGARDE|jet de sauvegarde]].}
{s:BDTexte|**Malédiction suprême (Mag).** Ce pouvoir magique spécial fonctionne comme *[[malédiction]]*, à la seule différence qu’il peut avoir l’un des effets suivants : -12 à une valeur de caractéristique ; -6 à deux valeurs de caractéristiques ; un malus de -8 aux jets d’attaque, de sauvegarde et aux tests ; ou 25% de chance d’agir normalement. Ce pouvoir est considéré comme un sort de niveau 6.}
{s:BDTexte|**Ouragan télékinésique (Sur).** En faisant une utilisation spéciale de son pouvoir magique télékinésie, la demi-liche peut agiter son trésor ainsi que la poussière, les os et tous les autres décombres de la zone pour former une tempête tournoyant autour de son crâne. Cette tempête obstrue le champ de vision, comme une nappe de brouillard, dans une zone de 6 m (4 {s:c}) de rayon centrée sur le crâne de la demi-liche. Les créatures situées dans la tempête reçoivent 12d6 points de dégâts contondants par round au tour de la demi-liche ([[Valeurs de combat#JETDESAUVEGARDE|Réflexes]] DD 20, 1/2 dégâts). La demi-liche peut maintenir sa tempête indéfiniment en restant concentrée.}
{s:BDTexte|**Reconstruction (Sur).** Une demi-liche détruite se recompose en 2d6 jours. Pour la détruire de manière permanente, il faut asperger ses restes d’eau bénite dans la zone d’un sort de *[[sanctification]]*. Pour finaliser la destruction, il faut lancer *[[parole sacrée]]* ou *[[rejet du Mal]]*. Si le lanceur de sorts réussit un jet de lanceur de sorts d’un DD égal à 10 + DV de la demi-liche, la demi-liche est définitivement détruite.}
{s:BDTexte|**Sensibilité aux effets vorpals (Ext).** Les armes vorpales, quelles qu’elles soient, ignorent la [[Réduction de dégâts (capacité)|réduction de dégâts]] de la demi-liche.}
