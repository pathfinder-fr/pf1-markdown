...
{s:MenuMythique}{s:CMy}Les archétypes simples qui suivent peuvent servir à transformer n’importe quel monstre en créature mythique. Une créature qui se voit attribuer l’un de ces archétypes est considérée comme une créature mythique en ce qui concerne les sorts, les pouvoirs et les objets magiques même si elle n’a pas le [[sous-type mythique]]. Notez que, comme elle ne possède pas le sous-type mythique, elle ne profite pas des nombreux avantages qu’apporte ce sous-type : la créature ne profite que des avantages présentés dans l’archétype simple.
...
**Règles de reconstruction.** ; **Init** bonus +20 ; **CA** bonus d’esquive +2 ; **pv** [[points de vie mythiques supplémentaires]] ; **Capacités défensives** [[Roublard#ESQUIVETOTALE|esquive totale]] (comme le pouvoir de classe du [[roublard]]) ; **VD** +9 mètres pour tous les types de déplacement (jusqu’au double de la vitesse de déplacement de base de la créature, au maximum) ; **Attaques spéciales** [[Initiative double (capacité)|initiative double]].
...
**Règles de reconstruction.** ; **CA** bonus de parade +2 ; **pv** [[points de vie mythiques supplémentaires]] ; **RM** elle gagne une [[RM]] égale à son nouveau [[FP]] + 11 ; **Attaques spéciales** [[Incantation profane simple (capacité)|incantation profane simple]], [[Magie mythique (capacité)|magie mythique]].
...
**Règles de reconstruction.** ; **Aura** aura de grâce (la créature et tous ses alliés dans un rayon de 9 mètres reçoivent un bonus de sainteté de +2 aux [[jds|jets de sauvegarde]] ou un bonus de malfaisance si la créature possédant l’archétype est Mauvaise) ; **CA** bonus de parade +2 ; **pv** [[points de vie mythiques supplémentaires]] ; **Attaques spéciales** [[Incantation divine simple (capacité)|incantation divine simple]], [[Magie mythique (capacité)|magie mythique]].
