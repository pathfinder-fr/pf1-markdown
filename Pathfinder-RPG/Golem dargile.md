---
Name: Pathfinder-RPG.Golem dargile
Title: Golem, Golem d'argile
...
<div class="BD">
{s:BDTitre|Golem d'argile|FP 10}
...
{s:BDTexte|**Attaques spéciales** fureur dévastatrice, rapidité}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 24, **Dex** 9, **Con** -, **Int** -, **Sag** 11, **Cha** 1}
{s:BDTexte|**BBA** +13, **BMO** +21, **DMD** 30}
...
de kilt de métal ou de cuir rigide autour des hanches. Ils mesurent
un peu plus de 2,40 mètres et pèsent 300 kg.

### Construction

Le corps d’un golem d’argile doit être sculpté dans un unique bloc
d’argile pesant au moins 500 kg, puis traité avec des huiles et des
poudres précieuses valant 1 500 po.
