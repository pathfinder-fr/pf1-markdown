---
Name: Pathfinder-RPG.Wivaran
Title: Wivaran
LastModified: 2017-02-16 20:46
---

<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Wivaran|FP 1/2}
...
(((Attaque)))
- **VD **9 m, vol 9 m (déplorable) (6 m, vol 6 m (déplorable) en armure)
...
- **BBA **+0 ; **BMO **+0 ; **DMD **12
- **Dons** Arme de prédilection (épieu)
- **Compétences **Connaissances (religion) +2, Intimidation +6, Perception +7, Vol -6
- **Langues** commun, draconique
- **Particularités **jugement 1/jour, connaissance des monstres +3, regard sévère
(((Écologie)))
- **Environnement **montagnes tempérées
- **Organisation **solitaire, aile (2-8) ou escadrille (4-12)
- **Trésor **équipement de PNJ (épieu, armure d’écailles, symbole sacré, autres trésors)
...
- ** Queue fouettante (Ext)**. Les wivarans disposent d’une attaque de queue fouettante qu’ils utilisent uniquement pour effectuer des attaques d’opportunité. Cette attaque de queue fouettante inflige 1d8 points de dégâts plus le modificateur de Force du wivaran.
- ** Vision dans le noir** jusqu’à 18 mètres. Les wivarans peuvent voir dans le noir jusqu’à 18 mètres.
- **Vision nocturne.** Les wivarans sont dotés de la vision nocturne.
- **Langues**. Les wivarans parlent le commun et le draconique. Ceux avec une valeur d’Intelligence suffisamment élevée peuvent sélectionner des langues supplémentaires parmi la liste suivante : nain, elfe, gnome, gobelin et orque.
</div></td></tr></table>
