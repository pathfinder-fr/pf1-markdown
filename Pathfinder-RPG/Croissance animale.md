...
Tout l’équipement porté ou tenu par l’[[type animal|animal]] est proportionnellement agrandi, en revanche cela n’affecte pas les propriétés magiques de l’objet. Si la créature lâche ou se défait d’un tel objet, celui-ci retrouve instantanément sa taille d’origine.

Ce sort ne permet pas de contrôler ou d’influencer un [[type animal|animal]] touché.
