...
|- CLASS="premier"
| [[Amplifications phréniques#ARMUREINVOQUÉE|Armure invoquée]] || [[Amplifications phréniques#FRAPPEPHRÉNIQUE|Frappe phrénique]]  || [[Amplifications phréniques#RESTAURATIONTÉLEMPHATIQUE|Restauration télemphatique]]
|-
| [[Amplifications phréniques#CONTREMESURECOMPLEXE|Contre-mesure complexe]] || [[Amplifications phréniques#INCANTATIONIMPLACABLE|Incantation implacable]] || [[Amplifications phréniques#SOINSBIOCINÉTIQUES|Soins biocinétiques]]
|-
| [[Amplifications phréniques#DÉFENSEPERSISTANTE|Défense persistante]] || [[Amplifications phréniques#PRÉDICTIONDÉFENSIVE|Prédiction défensive]] || [[Amplifications phréniques#SONDEMENTALE|Sonde mentale]]
|-
| [[Amplifications phréniques#ESPRITDOMINANT|Esprit dominant]] || [[Amplifications phréniques#PROTECTIONMENTALE|Protection mentale]] || [[Amplifications phréniques#SOUFFLEDEDRAGON|Souffle de dragon]]
|-
| [[Amplifications phréniques#FOCALISATIONINTENSIFIÉE|Focalisation intensifiée]] || [[Amplifications phréniques#PSYCHO-RÉACTION|Psycho-réaction]] || [[Amplifications phréniques#TRANSFÉRERLAPEUR|Transférer la peur]]
|-
| [[Amplifications phréniques#FORCEINTENSIFIÉE|Force intensifiée]] || [[Amplifications phréniques#RENFORCEMENTDESINCANTATIONSRÉDUITES|Renforcement des incantations réduites]] || [[Amplifications phréniques#VOLONTÉDESMORTS|Volonté des morts]]
|- CLASS="titre"
| &emsp;
|- CLASS="titre"
| CLASS="centre" COLSPAN="3" | Amplifications majeures
|- CLASS="premier"
| [[Amplifications phréniques#BOUCLIERDERENVOIDESSORTS|Bouclier de renvoi des sorts]] || [[Amplifications phréniques#CIBLAGETÉLÉPATHIQUE|Ciblage télépathique]] || [[Amplifications phréniques#IMITATIONDEMÉTAMAGIE|Imitation de métamagie]]
|-
| [[Amplifications phréniques#CHAMPDEPARADE|Champ de parade]] || [[Amplifications phréniques#DISTORSIONDESDISTANCES|Distorsion des distances]] || [[Amplifications phréniques#PULSATIONDISSIPATRICE|Pulsation dissipatrice]]
|-
| [[Amplifications phréniques#CHOCSYNAPTIQUE|Choc synaptique]] || [[Amplifications phréniques#DOUBLEAMPLIFICATION|Double amplification]] || [[Amplifications phréniques#SORTSUBORDONNÉ|Sort subordonné]]
|}
...
Tant que le psychiste a encore 1 point dans sa [[Psychiste#RESERVEPHRENIQUE|réserve phrénique]], il peut tenter une manœuvre de [[désarmement]] à la place d'une attaque de contact pour toucher avec un sort. Cette manœuvre de désarmement provoque des [[AO|attaques d'opportunité]] comme à l’accoutumée sauf si le psychiste peut porter des attaques à mains nues sans provoquer d'attaque d'opportunité.
...
#### Psycho-réaction (Sur)
Le psychiste peut dépenser 2 points de sa [[Psychiste#RESERVEPHRENIQUE|réserve phrénique]] pour sacrifier un sort lié de niveau 2 ou plus. Ce faisant, le psychiste obtient un bonus d'altération de +1 à la [[Force]], la [[Dextérité]] ou la [[Constitution]] par niveau du sort sacrifié. Ce bonus dure pendant 1 minute par niveau de psychiste du personnage.
...
Lorsque le psychiste lance le sort *[[lien télépathique]]*, il peut dépenser 1 point de sa [[Psychiste#RESERVEPHRENIQUE|réserve phrénique]] pour retirer l'état [[ébloui]], [[effrayé]], [[paniqué]], [[secoué]], ou [[étourdi]] de la cible du lien. Le faire retire l'état préjudiciable dont souffrait la cible du sort lié mais l'applique immédiatement au psychiste (avec sa durée restante normale).

{s:cs}{s:OO}{s:Reference|SOINSBIOCINÉTIQUES}
#### Soins biocinétiques (Sur)
Lorsque le psychiste lance un sort lié de l'école de la [[transmutation]], il peut dépenser 1 point de sa [[Psychiste#RESERVEPHRENIQUE|réserve phrénique]] pour récupérer 2 [[pv|points de vie]] par niveau du sort lié.
...
Le psychiste peut dépenser 2 points de sa [[Psychiste#RESERVEPHRENIQUE|réserve phrénique]] pour modifier la zone d’effet d’un sort lié de [[ligne]] ou de [[rayonnement]] en un [[cône]] de 9 m qui émane de sa bouche comme une [[Souffle (capacité)|attaque de souffle]].

{s:cs}{s:OO}{s:Reference|TRANSFÉRERLAPEUR}
#### Transférer la peur (Sur)
Lorsque le psychiste réussit à imposer un effet de peur à une créature, il peut dépenser 1 point de sa [[Psychiste#RESERVEPHRENIQUE|réserve phrénique]] pour annuler un effet de peur dont lui ou un de ses alliés avec qui il est en contact télépathique souffre.
...
#### Champ de parade (Sur)
Chaque fois que le psychique lance un sort lié qui lui accorde un bonus de parade à la [[CA]], il peut dépenser 2 points de sa [[Psychiste#RESERVEPHRENIQUE|réserve phrénique]] pour refléter automatiquement la première attaque à distance qui la rate (tant que le sort lié reste actif) sur son lanceur. Cette attaque réfléchie utilise le [[jet dattaque|jet d'attaque]] original plus un bonus de circonstances égal au [[NLS|niveau de lanceur de sorts]] du psychiste.
...
En dépensant 2 points de sa [[Psychiste#RESERVEPHRENIQUE|réserve phrénique]], le psychiste peut cibler toute créature avec laquelle il est en communication télépathique (via sa capacité [[Psychiste#LIENTELEPATHIQUE|lien télépathique]], la capacité [[Télépathie (capacité)|télépathie]] d'une créature, ou un autre effet) avec le sort lié, même si la créature est hors de portée du sort. Le sort lié doit être un effet mental avec une portée de contact ou supérieure.
