---
Name: Pathfinder-RPG.Plans ésotériques
Title: Plans ésotériques
LastModified: 2024-08-23 20:28
Categories:
- Règle officielle
- Src Aventures occultes
---

{s:Menuaventuresoccultes}<nav class="wiki-toc"></nav>{s:AO}Les plans du Grand Au-delà englobent toute l’existence,
...
représentent un véritable péril pour les visiteurs.{br}
...
sept vortex d’énergie colorée que l’on nomme des chakras.{br}
...
informations sur ses dispositions et son état émotionnel.{br}
...
concentrer pour observer les interactions entre ces forces.{br}
...
réfugier dans leurs songes et les tourmenter.{br}
...
ensuite à une clientèle éparpillée sur tous les plans.{br}
...
{s:Reference|LESANNALESAKASHIQUES}
