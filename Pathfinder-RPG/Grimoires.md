---
Name: Pathfinder-RPG.Grimoires
Title: Les grimoires
LastModified: 2024-08-28 16:12
Categories:
- Magie
- Règle officielle
- Src Art de la magie
...
{s:MenuMagie}<div style="float: right; padding: 0 0 8px 8px"><nav class="wiki-toc"></nav></div>{s:um}Chaque grimoire ou livre de formules est un reflet unique de la personnalité et des capacités de son créateur. Beaucoup contiennent bien plus que des sorts et abritent aussi les notes de recherche du lanceur de sorts, son journal personnel, des esquisses de naturaliste ou même des traités politiques. Certains contiennent des indications pour un rituel de préparation qui donne un avantage (ou un inconvénient) au personnage qui les utilise pour préparer ses sorts.

Les exemples de grimoires et de livres de formules donnés présentent une description de l’ouvrage, des informations sur l’école de prédilection et les écoles d’opposition du lanceur de sorts (le cas échéant), les sorts du livre et les préparations de rituel (s’il y a lieu). Certains sont protégés contre les regards indiscrets.

On peut mélanger les descriptions, les protections, les rituels de préparation et les sorts contenus dans chaque ouvrage. Les livres de haut niveau peuvent aussi servir pour des lanceurs de sorts de bas niveau, il suffit d’enlever les sorts de niveau trop élevé et d’éliminer les sorts de bas niveau en trop. De même, si vous désirez des livres plus épais, fusionnez-en deux ou ajoutez des sorts ou des formules de votre choix aux niveaux désirés. Ces ouvrages peuvent aussi servir de grimoires ou de livres de sorts pour de nouveaux personnages. Recopiez la liste et remettez-la au joueur.

Un grimoire de base comprend tous les tours de magie du Manuel des Joueurs, sauf ceux de l’école d’opposition. Les grimoires qui contiennent des tours de magie issus d’autres sources sont annotés.

Chaque livre s’accompagne d’un prix qui indique combien un personnage doit dépenser pour l’obtenir sur un marché légal, même s’il aura du mal à trouver un vendeur. Un personnage peut le revendre pour la moitié de ce prix. Tout livre qui contient un rituel de préparation a deux prix, un avec le rituel et un sans.

### Utiliser un rituel de préparation
Quand un personnage prépare ses sorts avec un grimoire ou un livre de formules qui contient un rituel de préparation, tant qu’il prépare au moins trois sorts (sans compter les tours de magie) ou trois formules il gagne un avantage temporaire qui dure jusqu’à ce qu’il fasse effet (comme indiqué dans sa description) ou jusqu’à ce que le personnage prépare de nouveaux sorts (il peut bénéficier à nouveau de l’avantage en préparant trois sorts du livre). Quand le personnage prépare des sorts, il ne peut bénéficier que d’un seul rituel de préparation à la fois, quel que soit le nombre de grimoires contenant des rituels de préparation utilisés. Un S en exposant (<sup>S</sup>) indique que le sort est issu de l’école de prédilection tandis qu’un OP en exposant (<sup>OP</sup>) indique un sort de l’école d’opposition.

### Les grimoires
{s:Reference|PRECISDEDEFENSE}
#### Précis de défense (abjurateur 1)
...
#### Carnet d'apprentis de Rul Thaven (devin 2)
...
#### Journal sans nom (universaliste 3)
*Voici un grimoire tout simple, sans le moindre ornement. Les marges sont encombrées de notes visant à améliorer l’efficacité de chaque sort mais la plupart sont, malheureusement, erronées.*
...
#### Livre des douleurs (évocateur 5)
...
#### Journal de laboratoire d'afflux constant (alchimiste 5)
*La couverture d’acier de ce mince journal a subi son lot d’abus : des traces d’acide et des scories témoignent de son exposition à des conditions de travail intenses. Les marges sont parsemées d’équations, d’équivalences et d’annotations alchimiques et pour quelques formules, il est difficile de savoir où s’arrêtent ces notes et où commence la formule.*
...
#### Livre de la tombe (nécromancien 6)
...
#### Grimoire des yeux luisants (illusionniste 7)
...
#### Tome du transmutateur (transmutateur 8)
...
#### Livre d'expert de Rul Thaven (devin 9)
...
#### Journal de la bête intérieure (alchimiste 10)
*Cette collection malmenée de notes tachées et roussies est reliée par une ficelle entre deux couvertures de bois. On dirait que certaines formules ont été volontairement effacées et grattées avec tant de soin que le parchemin est déchiré en plusieurs endroits.*
...
#### Manuscrit de Jack Were-Son (universaliste 10)
...
#### Savoir de Taernis Loinvoyant (convocateur 12)
...
#### Héritage du grand-père (nécromancien 14)
...
#### Guide du chymiste (alchimiste 15)
...
#### Grimoire du gardien (abjurateur 15)
...
#### Mystères des ombres (illusionniste 16)
...
{s:Reference|BIBLIOTHEQUEDULANCEURDEPEAU}
#### Bibliothèque du danseur de peaux (universaliste 19)
*Ces quatre livres sont maintenus ensemble par un lien d’argent luisant passé autour d’eux et attaché avec un nœud complexe. À l’intérieur, l’écriture est ample et désordonnée, pleine d’annotations en marge. Les notes de l’auteur indiquent une passion certaine pour ses découvertes mais, même s’il est, à l’évidence, brillant, il est également très désordonné.*
...
#### Les formules de Maître Gebr (alchimiste 20)
...
#### La maîtrise des mots et des pensées (enchanteur 20)
