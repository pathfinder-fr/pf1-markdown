...
[[FAQ- lArt de la magie#38|→]] Antagoniste : Le DD pour utiliser le don Antagoniste (page 143) est listé comme étant égal au nombre de DV de la cible + son modificateur de Sagesse. Est-ce correct ?**'
...
Mise à jour : (page 143), dans le don Antagoniste, dans la section avantages, dans le premier paragraphe, deuxième phrase, remplacez « DD égal aux dés de vie de la cible » par « DD égal à 10 + le nombre de DV de la cible ».}**Avantage.** Le personnage peut faire des tests de [[Diplomatie]] ou d’[[Intimidation]] pour pousser les créatures à se montrer hostiles envers lui. Quelle que soit la compétence qu’il utilise, ceci lui demande une [[action simple]] qui ne provoque pas d’[[attaque dopportunité|attaque d’opportunité]], avec un [[DD]] égal à 10 + le nombre de [[DV]] de la cible + le modificateur de [[Sagesse]] de la cible. Le personnage ne peut pas faire ce test contre une créature qui ne le comprend pas ou qui a une [[Intelligence]] de 3 ou moins. 
