---
Name: Pathfinder-RPG.Ver mortel
Title: Ver mortel
LastModified: 2024-06-21 15:36
Categories:
- Monstre
- Règle officielle
- Src Bestiaire 2
...
<div class="BD">
{s:BDTitre|Ver mortel|FP 6}
{s:pucem|Créature magique|Désert|Tropical}
{s:BDTexte|*Source : Bestiaire 2* p.285}
{s:BDTexte|**PX** 2 400}
{s:BDTexte|[[type Créature magique|Créature magique]] de taille G, N}
{s:BDTexte|**Init** +1 ; **Sens** [[Perception des vibrations]] 18 m (12 {s:c}), [[vision dans le noir]] 18 m (12 {s:c}), [[vision nocturne]] ; [[Perception]] +11}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 19, contact 10, pris au dépourvu 18 (Dex +1, naturelle +9, taille -1)}
{s:BDTexte|**pv** 68 (8d10+24)}
{s:BDTexte|**Réf** +7, **Vig** +9, **Vol** +4}
{s:BDTexte|**Capacités défensives** peau venimeuse, sang corrosif ; **Immunités** acide, électricité, poison}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 6 m (4 {s:c}), creusement 6 m (4 {s:c})}
{s:BDTexte|**Corps à corps** morsure, +11 (2d8+6 plus poison)}
{s:BDTexte|**Distance** choc électrique, +8 contact à distance (4d6 électricité)}
{s:BDTexte|**Attaque spéciales** souffle (ligne de 9 m (6 {s:c}), 8d6 acide, [[Réflexes]] [[DD]] 17, 1/2 dégâts, utilisable tous les 1d4 [[round|rounds]]}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 18, **Dex** 13, **Con** 16, **Int** 3, **Sag** 11, **Cha** 5}
{s:BDTexte|**BBA** +8 ; **BMO** +13 ; **DMD** 24}
{s:BDTexte|**Dons** [[Attaque en puissance]], [[Enchaînement]], [[Science du renversement]], [[Volonté de fer]]}
{s:BDTexte|**Compétences** [[Discrétion]] -3 (+13 dans le désert), [[Perception]] +11 ; **Modificateurs raciaux** +16 en [[Discrétion]] dans le désert ou les zones rocheuses}
{s:BDTexte|**Langues** terreux}
{s:BDSousTitre|Écologie}
{s:BDTexte|**Environnement** déserts, plaines ou collines chaudes}
{s:BDTexte|**Organisation sociale** solitaire}
{s:BDTexte|**Trésor** aucun}
{s:BDSousTitre|Pouvoirs spéciaux}
{s:BDTexte|**Choc électrique (Sur).** Un ver mortel peut projeter une décharge électrique depuis sa gueule par une [[action simple]]. Le [[FP|facteur de portée]] de cette [[attaque de contact]] est de 18 mètres (12 {s:c}).}
{s:BDTexte|**Peau vénimeuse (Ext).** La peau d’un ver mortel sécrète une substance huileuse toxique. Cette couche empoisonnée affecte toutes les créatures qui touchent le ver mortel avec une [[attaque de contact]] ou en effectuent une attaque à main nue ou une attaque à l’aide d’une arme naturelle. Les créatures qui [[lutte|agrippent]] un ver mortel sont également exposées au poison qui recouvre sa peau.}
{s:BDTexte|**Poison (Ext).** Morsure — blessure ou peau — contact ; *JdS* [[Vigueur]] [[DD]] 17 ; *fréquence* 1/[[round]] pendant 6 [[round|rounds]] ; *effet* [[affaiblissement temporaire]] 1d2 [[Constitution|Con]] ; *guérison* 2 réussites consécutives.}
{s:BDTexte|**Sang corrosif (Ext).**  Le sang d’un ver mortel corrode tous les objets de métal qu’il touche. Si une créature blesse un ver mortel avec une arme tranchante ou perforante en métal, le sang de la créature inflige 3d6 points de dégâts d’acide à l’arme (contrairement à la plupart des dégâts d’énergie, ceux-ci ne sont pas divisés par deux quand ils sont appliqués à un objet en métal, même si la solidité du métal rentre toujours en ligne de compte). Le porteur de l’arme peut diviser ces dégâts par deux en réussissant un jet de [[Réflexes]] contre un [[DD]] de 17. Les créatures métalliques qui infligent des dégâts de type tranchant ou perforant à un ver mortel à l’aide d’une attaque naturelle subissent 3d6 points de dégâts d’acide ([[Réflexes]] [[DD]] 17, 1/2 dégâts). Le sang du ver mortel perd ses propriétés corrosives 1 [[round]] après qu’il ait quitté le corps du ver ou que celui-ci soit mort. Le [[DD]] du [[jet de sauvegarde]] dépend de la [[Constitution]].}
</div>
</td><td><div>
