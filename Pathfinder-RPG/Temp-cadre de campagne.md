---
Name: Pathfinder-RPG.Temp-cadre de campagne
Title: Page de travail du Cadre de campagne
LastModified: 2017-07-14 18:32
---
...
#### intégration
- snippet créé : <nowiki>{s:CCMI}</nowiki>
- ~~modifier la page d'accueil du wiki pour intégrer les classes de prestige supplémentaires~~ fait
- insertion à prévoir des dons dans le tableau récapitulatif des dons
