---
Name: Pathfinder-RPG.Ambassadeur animal
Title: Ambassadeur animal
LastModified: 2023-01-24 19:14
Categories:
- Sort barde 4
- Sort chaman 4
- Sort druide 4
...
{s:cs}{s:UI}**École**  [Enchantement](./Enchantement.md) ([coercition](./branche coercition.md)) <nowiki>[</nowiki>[effet mental](./Registre.md)<nowiki>]</nowiki> ; **Niveau** [Cham](./Chaman.md) 4, [Bard](./Barde.md) 4, [Dru](./Druide.md) 4, [Rôd](./Rôdeur.md) 3
**Temps d'incantation** 10 minutes
**Composantes** [V, G, M](./composantes.md) (un morceau d'une nourriture que l'animal apprécie)
...
Le personnage ordonne à un unique animal de se rendre à un lieu choisi et de délivrer un message à une créature connue. Ce sort est similaire à *[messager animal](./Messager animal.md)*, mais peut affecter des animaux plus grands. De plus, la conscience de l'animal ciblé s'éveille temporairement (comme avec le sort *[éveil](./Éveil.md)*) pendant toute la durée du sort, et il peut utiliser ses facultés mentales améliorées pour surmonter les obstacles de façon créative afin de délivrer son message plus efficacement. L'animal éveillé parle l'une des langues connues du personnage. De plus, le personnage peut offrir jusqu'à 5 rangs de compétence à l'animal dans les compétences suivantes : [Bluff](./Bluff.md), [Diplomatie](./Diplomatie.md), [Connaissances](./Connaissances.md) (folklore local), [Connaissances](./Connaissances.md) (noblesse), [Linguistique](./Linguistique.md) ou [Psychologie](./Psychologie.md). L'animal traite ces compétences comme des compétences de classe si elles le sont pour le personnage. Le nombre de rangs de compétence offerts dans une compétence donnée ne peut dépasser ni le nombre de [DV](./../Ressources/DV.md) de l'animal ciblé, ni le nombre de rangs que le personnage possède dans celle-ci.
