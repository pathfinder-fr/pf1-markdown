...
<div class="BD">
{s:BDTitre|Dépendance mineure}
**Type** maladie, variable ; **Jet de sauvegarde** variable{br}
**Incubation** 1 jour ; **Fréquence** 1/jour{br}
**Effet** malus de –2 à la [[Constitution|Con]] ; **Guérison** 2 [[jet de sauvegarde|jets de sauvegarde]] consécutifs
</div>
<div class="BD">

{s:BDTitre|Dépendance modérée}
**Type** maladie, variable ; **Jet de sauvegarde** variable{br}
**Incubation** 1 jour ; **Fréquence** 1/jour{br}
**Effet** malus de –2 à la [[Constitution|Con]] et à la [[For]] ; la cible ne peut pas soigner naturellement les affaiblissements de caractéristique provoqués par la drogue à l’origine de la dépendance ;**Guérison** 3 [[jet de sauvegarde|jets de sauvegarde]] consécutifs
</div>
</td><td width="50%">
<div class="BD">
{s:BDTitre|Dépendance sévère}
**Type** maladie, variable ; **Jet de sauvegarde** variable{br}
**Incubation** 1 jour ; **Fréquence** 1/jour{br}
**Effet** malus de –2 à la [[Dex]], la [[Constitution|Con]], la [[For]] et la [[Sag]] ; la cible ne peut pas soigner naturellement les affaiblissements de caractéristique provoqués par la drogue à l’origine de la dépendance ;**Guérison** 3 [[jet de sauvegarde|jets de sauvegarde]] consécutifs Soigner la dépendance
</div>
</td></tr></table>

Comme la dépendance est une [[maladie]], on peut la soigner comme telle, à l’aide de sorts comme *[[Guérison des maladies]]* ou en réussissant plusieurs [[jet de sauvegarde|jets de sauvegarde]] consécutifs. Contrairement aux autres maladies, un personnage dépendant ne peut faire de jet de [[Vigueur]] qu’à condition de ne pas avoir pris sa drogue pendant une journée. Le [[DD]] du jet de [[Vigueur]] est égal au [[DD]] le plus haut atteint par sa dépendance à la drogue (donc pas forcément le [[DD]] auquel il a succombé pour la première fois s’il a continué de consommer de la drogue une fois dépendant). Ce [[DD]] diminue de –2 pour chaque jour où le personnage ne prend pas de drogue, jusqu’à un minimum égal au DD qui a provoqué la dépendance.
...
<div class="BD">
{s:Reference|ABSINTHEELFIQUE}{s:BDTitre|Absinthe elfique}
- **Type** ingestion ; **Dépendance** modérée, **[[Vigueur]]** [[DD]] 16
- **Prix** 500 po
...
<div class="BD">
{s:Reference|ADYTON}{s:BDTitre|Adyton|{s:BotD}}
- **Type** contact; **Dépendance** sévère, **[[Vigueur]]** [[DD]] 20
- **Prix** 2 000 po
- **Effet** Une créature affectée qui réussit un jet de sauvegarde de [[Volonté]] [[DD]] 20 supplémentaire voit sa conscience transportée dans le [[paysages mentaux|paysage mental]] appelé Adyton, où elle peut s'attarder aussi longtemps qu'elle le souhaite et revenir par une [[action complexe]] quand elle le veut. Ceux qui échouent à ce second jet de sauvegarde dorment profondément pendant 2d4 heures et se réveillent en se souvenant de bribes de rêves surréalistes.
...
<div class="BD">
{s:Reference|BIEREDEFEUNAINE}{s:BDTitre|Bière de feu naine}
- **Type** ingestion ; **Dépendance** modérée, **[[Vigueur]]** [[DD]] 20
- **Prix** 50 po
- **Effet** 1d4 rounds ; *[[rage]]* comme avec le sort
- **Effet** 1 heure ; [[Résistance]] au froid 5
- **Dégâts** 1d2 points d’[[affaiblissement temporaire]] de [[Constitution]]

</div>

<div class="BD">
{s:CSU|1}{s:Reference|CHIQUEDESINFIDELES}{s:BDTitre|Chique des infidèles}
...
<div class="BD">
{s:Reference|ECORCHEFEUILLE}{s:BDTitre|Écorchefeuille}
- **Type** inhalation ou ingestion ; **Dépendance** mineure, **[[Vigueur]]** [[DD]] 12
- **Prix** 10 po
- **Effet** 1 heure ; bonus alchimique de +2 aux jets de sauvegarde contre les [[effet mental|effets mentaux]] et la fatigue
- **Dégâts** 1 point d’[[affaiblissement temporaire]] de [[Sagesse]]

</div>

<div class="BD">
{s:Reference|ETHER}{s:BDTitre|Éther}
...
<div class="BD">
{s:Reference|FRISSON}{s:BDTitre|Frisson}
...
<div class="BD">
{s:Reference|GRAINEDEDAEMON}{s:BDTitre|Graine de daémon|{s:BotD}}
- **Type** ingestion ou inhalation ; **Dépendance** majeure, **[[Vigueur]]** [[DD]] 20 (non-[[sous-type daémon|daémon]] uniquement)
- **Prix** 1 000 po
- **Effet** 1 heure ; bonus de malfaisance de +1d4 aux [[jds|jets de sauvegarde]] et aux tests de [[Compétences|compétence]], bonus de malfaisance de +1d6 à une compétence
- **Dégâts** 15% de chances de devenir [[aveuglé|aveugle]] et [[assourdi|sourd]] pendant 1 heure et 1 [[niveau négatif]] (DD 20)
...
Les [[sous-type daémon|daémons]] sont immunisés aux effets négatifs de la graine de daémon et ne peuvent devenir dépendants.
</div>

<div class="BD">
{s:MPNJ}{s:Reference|LARMESDELESCLAVAGISTE}{s:BDTitre|Larmes de l’esclavagiste}
- **Type** ingestion ; **Dépendance** mineure, **[[Vigueur]]** [[DD]] 13
- **Prix** 20 po
- **Effet** 3 heures ; -3 aux jets de [[Volonté]], +3 aux tests de [[Perception]]
- **Dégâts** 1d2 points d’[[affaiblissement temporaire]] de [[Force]]
...
<div class="BD">
{s:Reference|OPIUM}{s:BDTitre|Opium}
- **Type** inhalation, ingestion ou blessure ; **Dépendance** sévère, **[[Vigueur]]** [[DD]] 20
- **Prix** 25 po
- **Effet** 1 heure ; +1d8 points de vie temporaires, bonus alchimique de +2 aux jets de [[Vigueur]] et aux [[jet de sauvegarde|jets de sauvegarde]] contre la fatigue
- **Dégâts** 1d2 points d’[[affaiblissement temporaire]] de [[Constitution]] et de [[Sagesse]]

</div>

<div class="BD">
{s:Reference|PESH}{s:BDTitre|Pesh}
- **Type** ingestion ou inhalation ; **Dépendance** modérée, **[[Vigueur]]** [[DD]] 20
- **Prix** 15 po
- **Effet** 1 heure ; bonus alchimique +1d2 [[Force]], malus de –2 aux [[jet de sauvegarde|jets de sauvegarde]] contre les [[illusion|illusions]] et [[effet mental|effets mentaux]]
- **Effet** après 1 heure, 1d2 heures de fatigue
- **Dégâts** 1d2 points d’[[affaiblissement temporaire]] de [[Constitution]] et de [[Sagesse]]
</div>

<div class="BD">
{s:Reference|PURGE}{s:BDTitre|Purge}
...
<div class="BD">
{s:MPNJ}{s:Reference|SEVEDESANG}{s:BDTitre|Sève de sang}
- **Type** ingestion ; **Dépendance** modérée, **[[Vigueur]]** [[DD]] 20
- **Prix** 150 po
- **Effet** 30 minutes ; +1d4 points de [[Force]] et +1d3 points de [[Dextérité]], puis ralenti (comme avec le sort *[[lenteur]]*) pendant 3 heures
- **Dégâts** 1d4 points d’[[affaiblissement temporaire]] de [[Constitution]]
...
<div class="BD">
{s:MPNJ}{s:Reference|THEDESSONGES}{s:BDTitre|Thé des songes}
- **Type** ingestion ; **Dépendance** modérée, **[[Vigueur]]** [[DD]] 20
- **Prix** 120 po
...
- **Dégâts** 1d3 points d’[[affaiblissement temporaire]] de [[Sagesse|Sag]]
...
<div class="BD">
{s:Reference|ZERK}{s:BDTitre|Zerk}
