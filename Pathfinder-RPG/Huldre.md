---
Name: Pathfinder-RPG.Huldre
Title: Huldre
LastModified: 2017-03-19 11:32
---

<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Huldre|FP 4}
...
- **pv **38 (7d6+14) ; régénération 3 (acide ou feu)
- **Réf **+8, **Vig **+4, **Vol **+7
- **Immunité **effets de charme, effets de coercition ; **Résistance **froid 10
(((Attaque)))
- **VD **9 m
...
- **Organisation **solitaire, couple ou famille (3-9)
- **Trésor **standard
(((Pouvoirs spéciaux)))
- **Queue flagellante (Sur).** Le coup de queue de l’huldre constitue son attaque primaire. De plus, chaque fois qu’elle blesse une créature avec son attaque de queue, elle l’afflige d’un affaiblissement temporaire de 1d4 points de Charisme, la rendant un peu plus laide et déformée à chaque coup qu’elle lui porte. Un jet de Vigueur DD 15 permet d’annuler l’affaiblissement de Charisme. Le DD du jet de sauvegarde est basé sur la Constitution. 
- **Manipulation de la chance (Sur).** Une fois par jour, l’huldre peut manipuler la chance d’une créature en dépensant une action complexe pendant laquelle elle doit rester en contact physique avec sa cible. Quand l’huldre utilise ce pouvoir, elle doit décider si elle afflige la cible de malchance ou lui fait profiter de la bonne fortune. Une créature qui se voit accorder la bonne fortune gagne un bonus de chance de +2 à tous les jets de sauvegarde et d’attaque et aux tests de compétence tandis qu’une créature affligée de malchance reçoit un malus de -4 à tous les jets de sauvegarde et d’attaque et aux tests de compétence. Un jet de Volonté DD 17 permet d’annuler l’effet. Les huldres ne peuvent pas être prises pour cible de ce pouvoir. C’est un effet de malédiction qui dure 24 heures. Le DD du jet de sauvegarde est basé sur le Charisme.
