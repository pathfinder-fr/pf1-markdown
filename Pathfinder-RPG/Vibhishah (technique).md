---
Name: Pathfinder-RPG.Vibhishah (technique)
Title: Le chercheur
...
{s:DieuTech|Vibhishah|Le chercheur| |[[Divinités#RAKSHASASIMMORTELS|Rakshasas immortels]]
|Loyal Mauvais|Aucun
|N'importe|Aucun
|[[Kukri (arme)|Kukri]]
...
{s:cs}{s:BotD}
### Obédience
Jeter les moustaches d'un chat dans un tas de feuilles ou une botte de foin et les rechercher méticuleusement. Gain d'un bonus de malfaisance de +4 aux [[jds|jets de sauvegarde]] contre les effets qui provoque la [[confus|confusion]].
