...
{s:BDTexte|*Source : [[Bestiaire 5 (contenu)|Bestiaire 5 p.226]]*}
{s:BDTexte|**PX** 9 600}
{s:BDTexte|[[type Mort-vivant|Mort-vivant]] de taille M, CM}
{s:BDTexte|**Init** +4 ; **Sens** [[Vision dans le noir (capacité)|vision dans le noir]] à 18 m ; [[Perception]] +12}
...
{s:BDTexte|**RD** 10/— ; **Immunités** [[Traits des morts-vivants (capacité)|traits des morts-vivants]]}
...
{s:BDTexte|**Dons** [[Attaque en puissance]], [[Attaques réflexes]], [[Avance et frappe]], [[Poursuite]], [[Robustesse]], [[Savancer|S'avancer]], [[Science du critique]]<sup>S</sup> (morsure), [[Vigueur surhumaine]]}
{s:BDTexte|**Compétences** [[Discrétion]] +16, [[Perception]] +12}
...
{s:BDTexte|**Aura de servilité (Sur).** Toutes les créatures dans un rayon de 9 mètres autour du roi maudit et qui peuvent le voir doivent chacune réussir un jet de [[Volonté]] DD 20 pour ne pas être asservies par la terreur. Une créature qui rate son jet de sauvegarde doit se [[recroquevillé|recroqueviller sur elle-même]] (voir l’état préjudiciable du même nom) pendant 1d4 rounds. Une créature qui réussit son jet de sauvegarde est immunisée contre l’aura de servilité d’un même roi maudit pendant 24 heures. C’est un [[registre|effet mental]] de terreur et le DD du jet de sauvegarde est basé sur le Charisme.}
