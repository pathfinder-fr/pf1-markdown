...
*Image miroir* crée 1d4 doubles, +1 tous les trois [[niveau|niveaux]] (jusqu’à un maximum de huit images). Ces [[Présentation des sorts#CHIMERE|chimères]] restent toujours dans la case du lanceur de sorts et se déplacent en même temps que lui. Elles reproduisent ses mouvements, ses bruits et ses actes à la perfection. Quand le personnage est attaqué ou victime d’un sort qui nécessite un [[jet dattaque|jet d’attaque]], il y a des chances qu’une image soit touchée au lieu du personnage. Si l’attaque touche, il faut lancer un dé pour déterminer si l’attaque touche le personnage ou une de ses images. Une attaque réussie contre une [[Présentation des sorts#CHIMERE|chimère]] la fait disparaître instantanément. Si une attaque rate le personnage de 5 ou moins, elle détruit une [[Présentation des sorts#CHIMERE|chimère]] au passage. Les sorts de zone affectent le personnage normalement et n’abîment pas ses [[Présentation des sorts#CHIMERE|chimères]]. De même, les sorts et les effets qui ne nécessitent pas de [[jet dattaque|jet d’attaque]] affectent le personnage normalement et ne détruisent pas ses images. Un sort qui nécessite une [[attaque de contact]] se décharge sans effet si on l’utilise sur une [[Présentation des sorts#CHIMERE|chimère]] (qui est alors détruite).
