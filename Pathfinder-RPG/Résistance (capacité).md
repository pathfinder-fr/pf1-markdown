---
Name: Pathfinder-RPG.Résistance (capacité)
Title: Résistance (aux énergies destructrices) (Ext)
...
Chaque fois qu’une créature dotée de cette particularité subit des dégâts du type indiqué (généralement acide, électricité, feu ou froid), elle peut en ignorer une partie. La description indique le type de dégâts et la quantité ignorée.

*Format :* Résistance acide 10. *Emplacement :* Résistances.
