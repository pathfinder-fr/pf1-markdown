---
Name: Pathfinder-RPG.Contremaître formien
Title: Formien, Contremaître formien
LastModified: 2024-02-08 17:05
Categories:
- Monstre
- Src Bestiaire 4
---
...
<div class="BD">
{s:BDTitre|Contremaître formien|FP 7}
...
{s:BDTexte|**Trésor** standard (10 fléchettes, autre trésor)}
{s:BDSousTitre|Pouvoirs spéciaux}
{s:BDTexte|**Modèle mental (Sur).** Le contremaître formien peut inspirer le talent ou la
...
{s:BDTexte|**Poison (Ext).** Dard — blessure ; JdS Vigueur DD 18 ; fréquence 1/
...
la voix rauque et difficile à comprendre.

Comme les myrmarques, les contremaîtres ont un
