---
Name: Pathfinder-RPG.Extensions de compétences
Title: Extensions de compétences
LastModified: 2021-02-26 15:16
Categories:
- Src Pathfinder unchained
---

{s:MenuPathfinderunchained}{s:PU}Les extensions de compétences offrent aux personnages de nouvelles possibilités d’utiliser les compétences lorsqu’ils investissent 5, 10, 15 et 20 rangs dans celles-ci. Un personnage doté du don [[Compétence de marque]] accède aux extensions d’une unique compétence. Ces extensions sont l’une des caractéristiques majeures de la [[Roublard unchained|version révisée de la classe du roublard]]. En effet, l’aptitude de [[Roublard unchained#SPECILITEDUROUBLARD|spécialité du roublard]] permet aux personnages de cette classe de bénéficier des extensions sur plusieurs compétences essentielles à ce rôle. Le [[MJ]] peut permettre à tous les personnages d’accéder aux extensions mais il doit savoir qu’elles augmentent de manière significative la puissance et la polyvalence des compétences. Ainsi, les autres classes, surtout celles de [[barde]] et d’[[enquêteur]] qui bénéficient d’un grand nombre de compétences, verront également leur pouvoir augmenter. Par conséquent, le MJ peut décider d’interdire l’accès au don de [[Compétence de marque]] pour que les roublards, et seulement eux, aient accès aux extensions de compétences.
...
- **20 rangs.** Quand il effectue un test de [[NLS|niveau de lanceur de sorts]], le personnage peut effectuer un test d’Art de la magie contre le même [[DD]] avec un malus de -20. Si le test d’Art de la magie est une réussite, il gagne un bonus de circonstances de +2 au test de niveau de lanceur de sorts.
...
- **10 rangs.** Quand le personnage réussit à identifier une créature, il gagne un bonus de compétence de +1 aux [[jet dattaque|jets d’attaque]], aux [[Caractéristiques|tests de caractéristique]] opposés, aux [[Compétences|tests de compétence]] et aux tests de [[NLS|niveau de lanceur de sorts]] effectués contre les créatures de la même espèce (par exemple, contre les [[Glabrezu|démons glabrezus]], mais pas contre les autres démons ou extérieurs Mauvais) pendant une minute. Ce bonus augmente de +1 pour chaque tranche de 5 rangs dans la compétence de Connaissances appropriée au-dessus du dixième.
...
- **10 rangs.** Le personnage peut confectionner un déguisement en 1d3 [[round|rounds]]. S’il consacre le temps normalement requis à la confection de son déguisement, il ne subit aucun malus s’il tente de se déguiser en une créature d’un sexe, d’une race ou d’un âge différent.
...
- **5 rangs.** La monture du personnage gagne un bonus de +2 aux jets de [[Vigueur]] ou aux tests de [[Constitution]] pour éviter de devenir [[fatigué|fatiguée]] ou [[épuisé|épuisée]]. Ce bonus augmente de +1 par tranche de 5 rangs en Équitation au-dessus du cinquième.
...
- **15 rangs.** Quand un adversaire réalise une manœuvre offensive de [[bousculade]], d’[[entraînement]], de [[renversement]], de [[repositionnement]] ou de [[croc-en-jambe]] contre le personnage ou sa monture pendant qu’il la chevauche, il peut remplacer son [[DMD]] (ou celui de sa monture) par le résultat d’un test d’Équitation.
...
- **5 rangs.** La réussite d’un test d’Estimation [[DD]] 20 permet de déterminer si un objet est magique ou non et la réussite d’un deuxième test (DD = 25 + [[NLS|niveau de lanceur de sorts]] de l’objet) révèle ses propriétés. Le personnage peut utilise l’Estimation pour détecter des contrefaçons non-écrites.
...
- **15 rangs.** Le personnage peut repérer l’objet le plus précieux comme décrit ci-dessus par une [[action de mouvement]]. Le personnage peut effectuer un test d’Estimation avec un malus de -10 à la place d’un jet de [[Volonté]] pour réfuter une [[branche Chimère|chimère]] ou une [[branche Hallucination|hallucination]].

- **20 rangs.** Le personnage peut repérer l’objet le plus précieux comme décrit ci-dessus par une [[action de mouvement]] et, si ce test réussit, il bénéficie d’un bonus de circonstances de +2 aux [[BMO|tests de manœuvre offensives]] effectués pour subtiliser cet objet ou pour que la créature qui le manie le lâche (manœuvre offensive de [[désarmement]]).

### Évasion
Lorsqu’il possède le nombre de rangs indiqués en [[Évasion]], le personnage acquiert les avantages suivants.
- **5 rangs.** Si le personnage accepte un malus de -10, le temps requis pour utiliser cette compétence diminue de moitié. Il lui faut une [[action de mouvement]] pour échapper à une [[étreinte (capacité)|étreinte]] ou à une [[immobilisé|immobilisation]] en situation de [[lutte]] nécessite et une [[action simple]] pour se libérer d’un [[filet (arme)|filet]], d’une *[[corde animée]]*, d’un *[[contrôle des plantes]]* ou d’un *[[empire végétal]]*.

- **10 rangs.** Par une [[action simple]], le personnage peut tenter de se libérer de n’importe quel effet qui l’entrave grâce à un test d’Évasion ([[DD]] = DD du [[jds|jet de sauvegarde]] de l’effet + 10). Le personnage peut effectuer un test d’Évasion par une [[action de mouvement]] pour déterminer le DD du test qu’une créature qu’il a ligotée doit réussir pour se libérer. Il gagne un bonus de +10 s’il effectue ce test par une [[action complexe]].

- **15 rangs.** Le personnage peut tenter de se libérer de n’importe quel effet qui l’entrave (comme décrit ci-dessus) par une [[action de mouvement]]. Par une [[action simple]], il peut effectuer un test d’Évasion ([[DD]] = DD du [[jds|jet de sauvegarde]] de l’effet + 20) pour annuler un effet de *[[lenteur]]* ou de [[paralysie (capacité)|paralysie]] pendant un [[round]], plus un [[round]] pour chaque tranche de 5 points obtenus au-dessus du DD. C’est une action purement mentale, ce qui explique pourquoi elle peut être accomplie en étant [[paralysé]].

- **20 rangs.** Le personnage peut se libérer des entraves, des [[étreinte (capacité)|étreintes]] et des [[immobilisé|immobilisations]] en situation de [[lutte]] par une [[action immédiate]] grâce à un test d’Évasion ([[DD]] = DD de l’effet + 10, ou [[BMO]] de l’attaquant + 10). Il peut tenter d’annuler un effet de *[[lenteur]]* ou de [[paralysie (capacité)|paralysie]] par une [[action simple]] (ce qui augmente le DD de 10), par une [[action de mouvement]] (ce qui augmente le DD de 15) ou par une [[action immédiate]] (ce qui augmente le DD de 20).
...
- **5 rangs.** Si le personnage dépasse le [[DD]] pour démoraliser une cible d’au moins 10 points, celle-ci est [[effrayé|effrayée]] pendant un [[round]] puis [[secoué|secouée]]*. Un jet de [[Volonté]] (DD = 10 + le nombre de rangs du personnage en Intimidation) annule l’état préjudiciable effrayé mais la cible reste secouée, même si elle possède l’aptitude développement de la résistance.

- **10 rangs.** Si le personnage dépasse le [[DD]] pour démoraliser une cible d’au moins 10 points, celle-ci est [[paniqué|paniquée]] pendant un [[round]] ou [[effrayé|effrayée]] pendant 1d4 rounds (au choix du joueur) puis [[secoué|secouée]]*. Un jet de [[Volonté]] (DD = 10 + le nombre de rangs du personnage en Intimidation) annule l’état préjudiciable effrayé ou paniqué mais la cible reste secouée, même si elle possède l’aptitude développement de la résistance.

- **15 rangs.** Si le personnage dépasse le [[DD]] pour démoraliser une cible d’au moins 20 points, celle-ci se [[recroquevillé|recroqueville sur elle-même]] pendant un [[round]] ou est [[paniqué|paniquée]] pendant 1d4 rounds (au choix du joueur), puis [[effrayé|effrayée]]*. Un jet de [[Volonté]] (DD = 10 + le nombre de rangs du personnage en Intimidation) annule les états préjudiciables recroquevillé sur soi-même, paniqué et effrayé mais la cible reste [[secoué|secouée]], même si elle possède l’aptitude développement de la résistance.

- **20 rangs.** Si le personnage dépasse le [[DD]] pour démoraliser une cible d’au moins 20 points, celle-ci se [[recroquevillé|recroqueville sur elle-même]] pendant 1d4 [[round|rounds]] puis devient [[paniqué|paniquée]]*. Un jet de [[Volonté]] (DD = 10 + le nombre de rangs du personnage en Intimidation) annule les états préjudiciables recroquevillé sur soi-même et paniqué mais la cible reste [[secoué|secouée]], même si elle possède l’aptitude développement de la résistance.
...
- **15 rangs.** Le personnage peut décrypter les écrits magiques (comme avec une *[[lecture de la magie]]*) en réussissant un test de Linguistique ([[DD]] = 25 + [[NLS|niveau de lanceur de sorts]]). S’il identifie un piège magique écrit grâce à ce test, il gagne un bonus de circonstances de +2 aux tests de [[Sabotage]] pour le désamorcer.
...
- **15 rangs.** Le personnage peut lire les pensées superficielles d’une créature comme indiqué plus haut après un [[round]] de conversation. De plus, quand il est attaqué et par une [[action immédiate]], le personnage peut effectuer un test de Psychologie opposé au [[jet dattaque|jet d’attaque]] de sa cible. La réussite de ce test lui confère un bonus d’intuition de +2 à la [[CA]] contre les attaques de cette créature spécifique pendant une minute.
...
- **10 rangs.** Chaque fois que le personnage lance un sort du registre des [[registre|émotions]] ou du [[registre|langage]], il peut effectuer un test de Représentation [[DD]] 25 pour augmenter le DD du [[jds|jet de sauvegarde]] de 1.

- **15 rangs.** Chaque fois que le personnage lance un sort du registre des [[registre|émotions]] ou du [[registre|langage]], il peut effectuer un test de Représentation [[DD]] 30 pour augmenter son [[NLS|niveau de lanceur de sorts]] de 1. Il doit décider s’il utilise cette extension ou celle à 10 rangs au moment où il lance le sort.
...
- **5 rangs.** Le personnage peut réduire le temps requis pour désamorcer un piège ou crocheter une serrure en subissant un malus de -5 au test de Sabotage pour chaque catégorie de réduction du temps choisie : 2d4 [[round|rounds]], 1d4 rounds, 1 round, une [[action simple]], une [[action de mouvement]], une [[action rapide]].

- **10 rangs.** Le personnage peut tenter de désamorcer des pièges magiques en subissant un malus de -10 même s’il ne possède pas l’aptitude [[Roublard#RECHERCHEDESPIEGES|recherche des pièges]]. S’il possède cette aptitude, il ne déclenche jamais les pièges magiques quand il tente de les désamorcer, même s’il effectue leur action de déclenchement (comme examiner un symbole, par exemple). Le piège se déclenche toujours si le personnage rate son test et le personnage ne peut pas utiliser cette extension pour le contourner.

- **15 rangs.** Quand le personnage est victime d’un piège, il peut effectuer un test de Sabotage par une [[action immédiate]] (en ajoutant l’éventuel bonus conféré par l’aptitude [[Roublard#SENSDESPIEGES|sens des pièges]]) opposé au résultat du [[jet dattaque|jet d’attaque]] du piège ou au [[DD]] du [[jds|jet de sauvegarde]]. S’il réussit ce test, il subit la moitié des dégâts seulement (ou aucun dégât si le résultat du test dépasse de 10 points ou plus le DD).

- **20 rangs.** Le personnage diminue de moitié les malus quand il désamorce rapidement un piège comme décrit dans la section 5 rangs de cette compétence. S’il possède l’aptitude [[Roublard#RECHERCHEDESPIEGES|recherche des pièges]] et accepte de subir un malus de -20 alors qu’il utilise l’extension de cette compétence à 15 rangs, tous les alliés proches bénéficient de l’avantage conféré par cette extension et le personnage peut désamorcer le piège par une [[action immédiate]] avant qu’il ne se déclenche si le résultat de son test dépasse le [[DD]] de 10 points ou plus.

### Survie
Lorsqu’il possède le nombre de rangs indiqués en [[Survie]], le personnage acquiert les avantages suivants.
- **5 rangs.** Le personnage réduit tous les [[Blessures et mort#NONLETAL|dégâts non-létaux]] infligés par la [[Dangers naturels#CHALEUR|chaleur]], le [[Dangers naturels#FROID|froid]], la [[Dangers naturels#FAIMSOIF|faim]] ou la [[Dangers naturels#FAIMSOIF|soif]] de 1 point par tranche de 5 rangs qu’il possède en Survie.

- **10 rangs.** Le personnage peut pister les créatures qui ne laissent aucune empreinte, y compris celles qui volent, qui nagent ou qui utilisent l’aptitude [[Druide#ABSENCEDETRACES|absence de traces]] ou le sort *[[passage sans trace]]*, mais son test de Survie subit un malus de -20.

- **15 rangs.** Une fois par jour, le personnage peut passer une heure à effectuer un test de Survie [[DD]] 30. La réussite de ce test lui confère une [[Résistance (capacité)|résistance]] au froid ou au feu de 5 pendant 24 heures. Il peut partager cette résistance avec un allié pour chaque tranche de 5 points obtenus au test au-dessus du DD.

- **20 rangs.** Le personnage subit un malus de -10 seulement quand il piste des créatures qui ne laissent aucune empreinte.

### Utilisation d’objets magiques
Lorsqu’il possède le nombre de rangs indiqués en [[UOM|Utilisation d’objets magiques]], le personnage acquiert les avantages suivants.
- **5 rangs.** Le personnage peut utiliser l’action [[aider qqn|aider quelqu’un]] pour renforcer le test d’Utilisation d’objets magiques d’une autre créature en effectuant un test contre le [[DD]] d’Utilisation d’objets magiques de l’objet.
