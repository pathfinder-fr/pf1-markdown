...
**Aura** [[Invocation]] écrasante ; **NLS** 21 ; **Emplacement** [[Objets merveilleux portés autour du cou|cou]] ; **Prix** [[Artefacts|artefact]] ; **Poids** —
(((Description)))
...
Les *talismans bilieux* sont considérés comme des [[Objets intelligents|objets magiques intelligents]] dotés d’un [[Objets intelligents#EGO|Égo]] de 20, qui accordent à leur porteur un bonus de +4 en [[Charisme]] et les effets permanents du sort *[[prémonition]]*. De plus, une fois par jour, le porteur peut appeler le diable enchaîné par une [[action libre]] pour bénéficier des effets des sorts *[[communion]]*, *[[orientation]]*, *[[mythes et légendes]]*, ou *[[coup au but]]*.
...
(((Destruction)))
Un *talisman bilieux* peut être détruit en étant immergé dans de l’[[Eau bénite (objet)|eau bénite]] pendant une semaine dans une zone soumise aux effets du sort *[[sanctification]]*, puis en étant écrasé avec un *[[marteau de guerre (arme)|Marteau de guerre]] [[sacrée (propriété)|sacré]] +3* (ou une arme contondante de puissance similaire ou supérieure). Si cela détruit le talisman, cela libère également le puissant noble infernal qui est emprisonné à l’intérieur.
</div>
</td>
<td>
<div class="BD">
{s:BDTitre|Talisman mélancolique|{s:BotD}{s:Reference|MELANCOLIQUE}}
**Aura** [[Invocation]] puissante ; **NLS** 18 ; **Emplacement** [[Objets merveilleux portés autour du cou|cou]] ; **Prix** 50 000 po ;**Poids** —
(((Description)))
...
(((Création)))
**Conditions** [[Création dobjets merveilleux|Création d’objets merveilleux]], *[[portail]]* ; **Coût** 25 000 po
</div>

<div class="BD">
{s:BDTitre|Talisman sanguin|{s:BotD}{s:Reference|SANGUIN}}
**Aura** [[Invocation]] puissante ; **NLS** 13 ; **Emplacement** [[Objets merveilleux portés autour du cou|cou]] ; **Prix** variable ;**Poids** —
(((Description)))
...
Par exemple, en considérant un *talisman sanguin* enchaînant un [[diable barbu|barbazu]] : Le talisman accorde un bonus de malfaisance de +2 à la [[CA]] du personnage et lui offre un lien télépathique avec le diable enchaîné à l’intérieur. Une fois par jour, le personnage peut faire un test de [[Charisme]] opposé à celui du barbazu (modificateur de +0) pour l’invoquer pendant 5 rounds, comme avec le sort *[[convocation de monstres]]*. Le barbazu enchaîné dans le *talisman sanguin* est connu sous le nom de Kalvaddas l’Étrangleur. C’est un sadique brutal qui adore se bagarrer au corps à corps et étrangler les elfes. Il s’y connaît en menteurs et peut utiliser sa compétence [[Psychologie]] pour aider un maître qu’il soutien.
(((Création)))
**Conditions** [[Création dobjets merveilleux|Création d’objets merveilleux]] ; *[[contrat]]*, *[[contrat intermédiaire]]*, *[[contrat suprême]]* ou *[[portail]]* ; **Coût** variable
</div>
</td></tr></table>
