---
Name: Pathfinder-RPG.Détection du Chaos
Title: Détection du Chaos
LastModified: 2022-06-12 14:40
Categories:
- Règle officielle
- Sort
- Sort adepte 1
...
Grâce à *détection du Chaos*, le lanceur de sorts peut détecter la présence du Chaos. Les informations qu’il reçoit dépendent du temps passé à étudier la zone ou le sujet choisi.

Premier [round](./round.md) : présence ou absence d’auras chaotiques.

Deuxième [round](./round.md) : nombre d’auras chaotiques (émanant de créatures, de sorts ou d’objets) dans la zone sondée et intensité de la plus puissante.

Si le jeteur de sorts est d’[alignement](./Alignement.md) Loyal, si l’aura détectée est surpuissante (voir ci-dessous) et correspond à une créature possédant un nombre de [dés de vie](./dés de vie.md) supérieur ou égal au double du [niveau](./niveau.md) du personnage, il est [étourdi](./Étourdi.md) pendant 1 [round](./round.md) et le sort prend fin immédiatement.
...
(((Ce sort fonctionne comme *[détection du Mal](./Détection du Mal.md)*, si ce n’est qu’il détecte les créatures, [prêtres](./Prêtre.md), sorts et objets magiques d’[alignement](./Alignement.md) Chaotique. Si le lanceur de sorts est d’[alignement](./Alignement.md) Loyal, il est vulnérable à une aura Chaotique particulièrement prononcée.)))
