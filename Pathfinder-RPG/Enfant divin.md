---
Name: Pathfinder-RPG.Enfant divin
Title: Enfant divin
LastModified: 2020-11-24 23:18
Categories:
- Classe de prestige
- Règle officielle
...
<table CLASS="tablo autoalt">
  ...
  <tr CLASS="premier">
    ...
    <td>+0</td>
    <td>+1</td>
    <td CLASS="gauche">[[Enfant divin#ALIGNEMENTOPPOSÉ|Alignement opposé]]</td>
    <td CLASS="gauche">[[Enfant divin#SORTS|+1 niveau dans une classe de lanceur de sorts divins]]</td>
  </tr>
  <tr>
    <td>2</td>
    <td>+1</td>
  ...
  <tr>
    ...
    <td>+1</td>
    <td>+2</td>
    <td CLASS="gauche">[[Enfant divin#SPÉCIALISATIONDEDOMAINE|Spécialisation de domaine]]</td>
    <td CLASS="gauche">[[Enfant divin#SORTS|+1 niveau dans une classe de lanceur de sorts divins]]</td>
  </tr>
  <tr>
    <td>4</td>
    ...
    <td>+1</td>
    <td>+2</td>
    <td CLASS="gauche">[[Enfant divin#COLÈREDIVINE|Colère divine]]</td>
    <td CLASS="gauche">[[Enfant divin#SORTS|+1 niveau dans une classe de lanceur de sorts divins]]</td>
  </tr>
  <tr>
    <td>5</td>
  ...
  <tr>
    ...
    <td>+2</td>
    <td>+4</td>
    <td CLASS="gauche">[[Enfant divin#DÉFENSEDIVINE|Défense divine]]</td>
    <td CLASS="gauche">[[Enfant divin#SORTS|+1 niveau dans une classe de lanceur de sorts divins]]</td>
  </tr>
  <tr>
    <td>8</td>
    ...
    <td>+3</td>
    <td>+4</td>
    <td CLASS="gauche">[[Enfant divin#STUPEURDIVINE|Stupeur divine]]</td>
    <td CLASS="gauche">[[Enfant divin#SORTS|+1 niveau dans une classe de lanceur de sorts divins]]</td>
  </tr>
  <tr>
    <td>9</td>
  ...
  <tr>
    ...
    <td>+3</td>
    <td>+5</td>
    <td CLASS="gauche">[[Enfant divin#REJETONVÉRITABLE|Rejeton véritable]]</td>
    <td CLASS="gauche">[[Enfant divin#SORTS|+1 niveau dans une classe de lanceur de sorts divins]]</td>
  </tr>
</table>
...
Voici les compétences de classe de l’enfant divin (et la caractéristique associée à chacune)  : [[Art de la magie]] (Int), [[Connaissances]] (plans) (Int), [[Connaissances]] (religion) (Int), [[Diplomatie]] (Cha), [[Perception]] (Sag), [[Profession]] (Sag), [[Représentation]] (Cha), [[Vol]] (Dex).
...
- **Eau.** *[[marche sur londe|marche sur l’onde]]* 1/jour ; +4 aux tests de [[Natation]]. 
- **Faune.** *[[Forme bestiale I|forme bestiale I]]* 1/jour ; +4 aux tests de [[Dressage]]. 
...
- **Force.** *[[briser les liens]]* 3/jour  ; +4 aux tests de [[BMO|manœuvre offensive]].
- **Gloire.** *[[aura darchon|aura d’archon]]* 1/jour ; +4 aux tests d’[[Intimidation]]. 
- **Guérison.** *[[symbole de guérison]]* 1/jour ; +4 aux tests de [[Premiers secours]].
- **Guerre.** *[[coup au but]]* 3/jour ; +1 aux [[Valeurs de combat#DEGATS|jets de dégâts]] des armes. 
...
- **Obscurité.** *[[arme dombre|arme d’ombre]]* 3/jour ; +4 aux tests de [[Perception]].
- **Protection.** *[[manteau de colère]]* 1/jour ; +1 à la [[CA|Classe d’Armure]]. 
- **Repos.** *[[sanctification de cadavre]]* 3/jour ; +2 aux jets de [[Vigueur]]. 
- **Reptiles et Amphibiens.** *[[convocation dalliés naturels III|convocation d’alliés naturels III]]* (créatures reptiliennes uniquement) 1/jour  ; +2 aux jets de [[Réflexes]]. 
...
#### Rejeton véritable
Au niveau  10, l’enfant divin devient un véritable rejeton de sa divinité. Le montant de soins conférés par sa [[Enfant divin#SPÉCIALISATIONDEDOMAINE|spécialisation de domaine]] est multiplié par deux. Son aptitude de [[Enfant divin#COLÈREDIVINE|colère divine]] inflige désormais +2 points de dégâts par dé contre les créatures de son alignement opposé. La [[RD|réduction de dégâts]] conférée par sa [[Enfant divin#DÉFENSEDIVINE|défense divine]] s’élève à 5. Enfin, il augmente définitivement sa valeur de [[Sagesse]] ou de [[Charisme]] (au choix) de +1.
