---
Name: Pathfinder2.ADJA
Title: Aventures officielles pour Pathfinder 2 (aides de jeu)
LastModified: 2023-06-29 13:08
---
...
### Little Problem in Big Absalom

<div class="itemmenu">
{s:ItemPF2NoImg|Scènes|Des images pour les scènes et des configurations de lumières pour Foundry par Blackbiji (pour les utiliser : créer une nouvelle scène, clic droit puis importer le fichier json, puis ajouter l'illustration comme image de fond)|/Wiki/public/Upload/ADJ/PF2/LTBA-scenes.zip}

{s:ItemPF2|Illustrations|Des illustrations (en version acteur et en version token) pour les créatures par BlackBiji|/Wiki/public/Upload/ADJ/PF2/LTBA-Illustrations.zip|/Wiki/public/Upload/ADJ/PF2/vig LTBA.jpg}

{s:ItemPF2NoImg|Se Souvenir|Des textes prêts à l'emploi pour les tests de Se Souvenir/Recall Knowledge par Blackbiji (format DOC)|/Wiki/public/Upload/ADJ/PF2/LTBA-Se Souvenir.doc}
