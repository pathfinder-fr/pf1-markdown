---
Name: Pathfinder2.Otari-NousZombis
Title: Nous zombis !
...
<div class="blocPF2">
{s:titrePF2|Zombis gobelins (4)|Créature 1}
{s:traitRareté|Peu commun} {s:traitAlignement|NM} {s:traitTaille|Taille P} {s:trait|Sans esprit} {s:trait|Mort-vivant} {s:trait|zombi}

**Perception** +0 ; vision dans le noir

**Compétences** Acrobaties +3, Athlétisme +4
...
**Mâchoires** {s:PF2a|1a} (attaque) ; **Conditions** le zombi gobelin a agrippé ou immobilisé une créature ; **Effet** Le zombi gobelin effectue une Frappe au corps à corps sans arme de mâchoires contre la créature agrippée ou immobilisée avec un modificateur de +7 pour 1d8+3 points de dégâts perforants.


Il s'agit d'une rencontre modérée pour des personnages de niveau 1, ou d'une rencontre faible pour des personnages de niveau 2. Pour adapter cette rencontre à des groupes de plus haut niveau, ajoutez plus de zombis ou donnez-leur la capacité spéciale Intuable qui augmente leur niveau de 1.
