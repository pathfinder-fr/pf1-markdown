---
Name: Pathfinder2.PlaytestGG Inventeur-dons
Title: L'inventeur (Playtest Guns & Gears) - dons de classe
...
### Niveau 1
<div class="blocPF2">
{s:titrePF2|Outils intégrés (Built-in Tools)|Don 1}
{s:trait|Inventeur} {s:trait|Modification}

Vous avez intégré des outils dans votre innovation, ce qui vous permet de les utiliser facilement. Quand vous prenez ce don, choisissez un type d'outils que vous possédez correspondant à 1 Encombrement ou moins et qui deviendra partie intégrante de votre innovation sans augmenter son Encombrement. Tant que vous maniez, portez ou êtes adjacent à votre innovation, vous pouvez accéder à ces outils aussi rapidement que si vous les portiez, et ils ne comptent pas dans le calcul de la limite du nombre d'outils que vous pouvez porter.
</div>

<div class="blocPF2">
{s:titrePF2|Saut explosif {s:PF2a|inv1a} (Explosive Leap)|Don 1}
{s:trait|Feu} {s:trait|Inventeur} {s:trait|Déplacement} {s:trait|Instable}

Vous dirigez une explosion vers le bas et directement sous vos pieds afin de vous propulser dans les airs. Vous sautez 9 m dans la direction de votre choix sans toucher le sol. Vous devez atterrir dans un espace de sol compact à 9 m de vous, sinon vous chutez après l’utilisation de votre prochaine action.

**Spécial.** Si votre innovation est un sbire, il peut utiliser cette action à votre place.
</div>

<div class="blocPF2">
{s:titrePF2|Compagnon prototype (Prototype Companion)|Don 1}
{s:trait|Inventeur}

Vous avez créé un compagnon artificiel et, même s'il n'est pas une innovation, il vous sert de sbire fidèle. Vous gagnez un prototype de compagnon artificiel.
</div>

<div class="blocPF2">
{s:titrePF2|Sabotage {s:PF2a|inv1a} (Tamper)|Don 1}
...
<div class="blocPF2">
{s:titrePF2|Réparation instable {s:PF2a|inv1a} (Unstable Repair)|Don 1}
{s:trait|Inventeur}

Vous réparez rapidement votre innovation, même si cela la rend moins stable. Vous Réparez votre innovation. Réparer dispose du trait Instable lorsque cette action est utilisée de cette manière. Il n'est pas nécessaire de poser votre innovation sur une surface plane mais vous devez la tenir, la porter ou lui être adjacent et posséder un kit de réparation.
</div>

### Niveau 2
<div class="blocPF2">
{s:titrePF2|Frappe avec recul {s:PF2a|inv2a} (Kickback Strike)|Don 2}
{s:trait|Inventeur}
...
<div class="blocPF2">
{s:titrePF2|Non, non ! Je t'ai créé ! {s:PF2a|invra} (No! No! I created you!)|Don 2}
...
<div class="blocPF2">
{s:titrePF2|Restauration brûlante {s:PF2a|inv1a} (Searing Restoration)|Don 2}
{s:trait|Feu} {s:trait|Guérison} {s:trait|Inventeur} {s:trait|Manipulation} {s:trait|Instable}

Certains prétendaient qu'il était impossible de soigner avec des explosions, mais c'était des idiots, des idiots qui ne comprenaient pas votre génie ! Vous créez une explosion mineure en utilisant votre innovation afin de cautériser des blessures et de faire s'évaporer des herbes médicinales, ce qui restaure 1d4 Points de Vie pour chacun de vos niveaux à vous ou à une créature vivante adjacente.

**Spécial.** Si votre innovation est un sbire, il peut entreprendre cette action à votre place. Comme il ne s'agit pas d'une créature vivante, il ne peut pas l'utiliser pour se soigner.
</div>

<div class="blocPF2">
{s:titrePF2|Transformation d'armure {s:PF2a|inv1a} (Transform Armor)|Don 2}
...
<div class="blocPF2">
{s:titrePF2|Transformation de créature artificielle {s:PF2a|inv1a} (Transform Construct)|Don 2}
{s:trait|Inventeur} {s:trait|Manipulation} {s:trait|Modification}
...
### Niveau 4
<div class="blocPF2">
{s:titrePF2|Compagnon artificiel avancé (Advanced Construct Companion)|Don 4}
{s:trait|Inventeur}
...
<div class="blocPF2">
{s:titrePF2|Armure de plongée (Diving Armor)|Don 4}
{s:trait|Inventeur} {s:trait|Modification}
...
<div class="blocPF2">
{s:titrePF2|Arme à forme duale (Dual-Form Weapon)|Don 4}
{s:trait|Inventeur} {s:trait|Modification}
...
<div class="blocPF2">
{s:titrePF2|Frappe mégatonne {s:PF2a|inv2a} (Megaton Strike)|Don 4}
{s:trait|Inventeur} {s:trait|Instable}

Vous activez des engrenages, des explosifs et d'autres gadgets cachés dans votre innovation pour réaliser une attaque puissante. Si vous portez votre innovation, effectuez une Frappe à mains nues au corps à corps ou une Frappe au corps à corps avec une arme que vous choisissez pendant vos préparatifs quotidiens ; si vous avez une innovation sbire, elle réalise une Frappe ; et si vous avez une innovation arme, effectuez une Frappe avec votre innovation. Si la Frappe touche, elle inflige le double du nombre habituel de dés de dégâts d'arme (deux pour une arme sans rune de frappe, quatre pour une arme de frappe, six pour une arme de frappe supérieure et huit pour une arme de frappe majeure).

**Spécial.** Si votre innovation est un sbire, elle peut réaliser cette action à votre place.
</div>

### Niveau 6
<div class="blocPF2">
{s:titrePF2|Célérité mécanique {s:PF2a|invra} (Clockwork Celerity)|Don 6}
...
• **Armure** Vous pouvez utiliser l'action supplémentaire pour Marcher rapidement, Faire un pas ou utiliser une autre action de déplacement autorisée par votre innovation (comme Nager si vous possédez le don Armure de plongée).

• **Créature artificielle** Vous pouvez utiliser l'action supplémentaire pour Diriger un sbire.

</div>

<div class="blocPF2">
{s:titrePF2|Mégavolt {s:PF2a|inv2a} (Megavolt)|Don 6}
{s:trait|Électricité} {s:trait|Inventeur} {s:trait|Manipulation} {s:trait|Instable}

Vous faites en sorte que votre innovation projette un éclair d'électricité qui blesse les créatures dans une ligne. Les créatures situées dans une ligne de 18 m subissent 3d12 points de dégâts d'électricité avec un jet de Réflexes basique contre votre DD de classe.

Les dégâts d'électricité augmentent de 1d12 au niveau 8 et tous les 2 niveaux par la suite. Vous pouvez choisir d'allonger la ligne jusqu'à 27 m si vous possédez l'aptitude de classe d'innovation capitale, et jusqu'à 27 m ou 36 m si vous possédez l'aptitude de classe d'innovation révolutionnaire.

**Spécial.** Si votre innovation est un sbire, elle peut utiliser cette action à votre place.
</div>

<div class="blocPF2">
{s:titrePF2|Fidélité visuelle (Visual Fidelity)|Don 6}
{s:trait|Inventeur}

Vous avez trouvé une méthode vous permettant d'utiliser une combinaison hétéroclite d'engins pour améliorer vos capacités visuelles dans toutes les situations. Vous gagnez les capacités de vision nocturne et de vision dans le noir et vous pouvez voir les créatures et les objets invisibles sous la forme de silhouettes translucides, même si ces silhouettes sont suffisamment indistinctes pour être camouflées pour vous. Si un effet devait vous infliger la condition aveuglé, celui-ci doit réussir un test de contre à votre encontre. En cas d'échec, vous n'êtes pas aveuglé, car vos divers engins parviennent à compenser.
</div>
...
<div class="blocPF2">
{s:titrePF2|Frappe gigatonne (Gigaton Strike)|Don 8}
{s:trait|Inventeur}
...
<div class="blocPF2">
{s:titrePF2|Compagnon artificiel incroyable (Incredible Construct Companion)|Don 8}
{s:trait|Inventeur}
...
<div class="blocPF2">
{s:titrePF2|Allié en surpuissance {s:PF2a|inv1a} (Overdrive Ally)|Don 8}
{s:trait|Inventeur} {s:trait|Manipulation}
...
### Niveau 10
<div class="blocPF2">
{s:titrePF2|Armure électrifiée {s:PF2a|inv1a} (Electrify Armor)|Don 10}
{s:trait|Inventeur} {s:trait|Manipulation} {s:trait|Instable}
...
<div class="blocPF2">
{s:titrePF2|Modifications multiples (Manifold Modifications)|Don 10}
{s:trait|Inventeur} {s:trait|Modification}
...
<div class="blocPF2">
{s:titrePF2|Intervention du bricoleur {s:PF2a|inv1a} (Tinker's Meddling)|Don 10}
{s:trait|Inventeur} {s:trait|Manipulation}
...
### Niveau 12
<div class="blocPF2">
{s:titrePF2|Boost modulaire (Boost Modulation)|Don 12}
{s:trait|Inventeur} {s:trait|Manipulation}
...
<div class="blocPF2">
{s:titrePF2|Gigavolt (Gigavolt)|Don 12}
{s:trait|Inventeur}
...
<div class="blocPF2">
{s:titrePF2|Surpuissance partagée (Shared Overdrive)|Don 12}
{s:trait|Inventeur}
...
### Niveau 14
<div class="blocPF2">
{s:titrePF2|Bricoleur éternel (Eternal Meddler)|Don 14}
{s:trait|Inventeur}
...
<div class="blocPF2">
{s:titrePF2|Compagnon parangon (Paragon Companion)|Don 14}
{s:trait|Inventeur}
...
<div class="blocPF2">
{s:titrePF2|Redondances instables {s:PF2a|invra} (Unstable Redundancies)|Don 14}
{s:trait|Inventeur}
...
### Niveau 16
<div class="blocPF2">
{s:titrePF2|Armure volante (Soaring Armor)|Don 16}
{s:trait|Inventeur} {s:trait|Modification}
...
<div class="blocPF2">
{s:titrePF2|Tu n'avais pas prévu... ceci ! {s:PF2a|invra} (You Failed to Account for... This!)|Don 16}
{s:trait|Inventeur}
...
### Niveau 18
<div class="blocPF2">
{s:titrePF2|Arme dévastatrice {s:PF2a|inv3a} (Devastating Weaponry)|Don 18}
{s:trait|Inventeur}
...
<div class="blocPF2">
{s:titrePF2|Engin de destruction {s:PF2a|inv3a} (Engine of Destruction)|Don 18}
{s:trait|Inventeur}
...
<div class="blocPF2">
{s:titrePF2|Bricoleur polyvalent (Multifarious Meddler)|Don 18}
{s:trait|Inventeur}
...
<div class="blocPF2">
{s:titrePF2|Annuler les dégâts {s:PF2a|invra} (Negate Damage)|Don 18}
{s:trait|Inventeur} {s:trait|Instable}
...
### Niveau 20
<div class="blocPF2">
{s:titrePF2|Automatisation totale (Full Automation)|Don 20}
{s:trait|Inventeur}
...
• **Armure** Vous pouvez utiliser l'action supplémentaire pour Marcher rapidement, Faire un pas ou utiliser une autre action de déplacement autorisée par votre innovation (comme Nager ou Voler) car l'armure répond au moindre stimulus lorsque vous la portez.

• **Créature artificielle** Vous pouvez utiliser l'action supplémentaire pour Diriger votre sbire, car votre capacité pour commander à votre créature artificielle devient instinctive.
</div>

<div class="blocPF2">
{s:titrePF2|Surpuissance omniprésente (Ubiquitous Overdrive)|Don 20}
{s:trait|Inventeur}
