---
Name: Ressources.Le maître du niten
Title: Le maître du niten
LastModified: 2019-03-09 14:35
---

<u>**Le Maître du Niten**</u>, archétype du samouraï.
...
Le maître du niten dispose de cette liste de compétences de classe :
Acrobatie (dex), Artisanat (int), Connaissance : noblesse (int), Connaissance : religion (int), Discretion (dex), Diplomatie (cha), Dressage (cha), Escalade (for), Equitation (dex), Intimidation (cha), Natation (for).
