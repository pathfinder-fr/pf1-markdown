---
Name: Ressources.Archer mage (build)
Title: Archer mage
LastModified: 2016-03-02 12:38
---

<div class="fright">***Retour aux [[builds]].***</br>
***Voir le [sujet de discussion](http://www.pathfinder-fr.org/Forum/yaf_postst7901_Un-archer-mage.aspx#post311009)***</div><nav class="wiki-toc"></nav>
...
Bien qu'il lance des sorts, ce n'est pas son rôle principal, aussi ce n'est pas sur sa caractéristique de lancement de sort (ici le charisme) qu'on se concentrera. On cherchera donc à atteindre le minimum requis pour avoir accès aux niveaux de sorts auxquels on aura droit. On a accès au maximum aux sorts de niveau 8 quand on arrive aux niveaux 19 et 20, on visera donc le 18 en charisme. Un [[Pathfinder-RPG.Bandeau de belle allure.ashx|bandeau de belle allure]] nous permettra d'obtenir jusqu'à +6 en charisme, on pourrait donc se contenter de démarrer à 12. Avec 12, on tient jusqu'au niveau 7, après quoi on obtient les sorts de niveau 3 au niveau 8. On peut espérer avoir un [[Pathfinder-RPG.Bandeau de belle allure.ashx|bandeau de belle allure]] +2 d'ici là. Si on se sent peut à l'aise avec un score aussi faible, on peut commencer à 14 de charisme. Au delà, c'est du gaspillage.
...
[[Pathfinder-RPG.Paladin.ashx|Paladin]] [[Pathfinder-RPG.Chasseur divin (paladin).ashx|chasseur divin]] 2 / [[Pathfinder-RPG.Ensorceleur.ashx|Ensorceleur]] ([[Pathfinder-RPG.lignages.ashx|lignage]] au choix) 6 / [[Pathfinder-RPG.Champion occultiste.ashx|Champion occultiste]] X

##### 3.1 Bonus de classe de prédilection

[[Pathfinder-RPG.Ensorceleur.ashx|Ensorceleur]] (points de vie en bonus)

##### 3.2 Traits
[[Pathfinder-RPG.Traits de base.ashx#LESTRAITSDEMAGIE|Don pour la magie]]

##### 3.3 Capacités de classe et dons

**3.3.1 Capacités de classe**

- [[Pathfinder-RPG.paladin.ashx#AURADUBIEN|Aura du bien]]
- [[Pathfinder-RPG.paladin.ashx#DETECTIONDUMAL|Détection du mal]]
- [[Pathfinder-RPG.paladin.ashx#CHATIMENTDUMAL|Châtiment du mal]]
- [[Pathfinder-RPG.Tir de précision.ashx|Tir de précision]]
- [[Pathfinder-RPG.paladin.ashx#GRACEDIVINE|Grâce divine]]
- [[Pathfinder-RPG.paladin.ashx#IMPOSITIONDESMAINS|Imposition des mains]]
- [[Pathfinder-RPG.ensorceleur.ashx#LIGNAGE|Pouvoir de lignage]]
- [[Pathfinder-RPG.ensorceleur.ashx#TOURSDEMAGIE|Tours de magie]]
- [[Pathfinder-RPG.ensorceleur.ashx#DISPENSEDECOMPOSANTES|Dispense de composantes]]
- [[Pathfinder-RPG.ensorceleur.ashx#LIGNAGE|Sorts de lignage]]
- [[Pathfinder-RPG.ensorceleur.ashx#LIGNAGE|Don de lignage]] : option que ne verra probablement jamais, puisqu'elle arrive au niveau 7 d'ensorceleur, donc au niveau 19 de notre build.
- [[Pathfinder-RPG.champion occultiste.ashx#DONSUPPLEMENTAIRE|Don supplémentaire]]
- [[Pathfinder-RPG.champion occultiste.ashx#ENTRAINEMENTDIVERSIFIE|Entraînement diversifié]]
- [[Pathfinder-RPG.champion occultiste.ashx#SORTILEGEDEVASTATEUR|Sortilège dévastateur]]

**3.3.2 Dons**

- [[Pathfinder-RPG.Tir à bout portant.ashx|Tir à bout portant]] : indispensable pour aller chercher [[Pathfinder-RPG.Tir rapide.ashx|tir rapide]].
- [[Pathfinder-RPG.Tir de précision.ashx|Tir de précision]] : inutile de le prendre avec nos dons, on en dispose gratuitement grâce au [[Pathfinder-RPG.Chasseur divin (paladin).ashx|chasseur divin]].
- [[Pathfinder-RPG.Tir rapide.ashx|Tir rapide]] : tout simplement indispensable !
- [[Pathfinder-RPG.Frappe magique.ashx|Frappe magique]] : autant profiter de nos niveaux de lanceur de sort profane pour qu'ils augmentent nos dégâts à l'arc ! De plus, nos flèches deviennent magiques si elles ne le sont pas déjà, ça peut servir...
- [[Pathfinder-RPG.Viser.ashx|Viser]] : Encore un moyen de monter nos dégâts.
- [[Pathfinder-RPG.Feu nourri.ashx|Feu nourri]] : Encore une attaque supplémentaire !
- [[Pathfinder-RPG.Port de larmure magique.ashx|Port de l'armure magique]] : quand on tente de lancer des sorts en armure, c'est mieux de ne pas échouer à cause d'elle !
- [[Pathfinder-RPG.Tirs groupés.ashx|Tirs groupés]] : afin de minimiser l'impact des RD.
- [[Pathfinder-RPG.Arme de prédilection.ashx|Arme de prédilection]] (arc long) : histoire de gratter un peu de toucher, et surtout de débloquer [[Pathfinder-RPG.Spécialisation martiale.ashx|spécialisation martiale]]. Pour rappel, tous les dons qui concernent l'arc long fonctionnent également pour l'arc composite, de force ou non.
- [[Pathfinder-RPG.Spécialisation martiale.ashx|spécialisation martiale]] (arc long) : +2 points de dégâts sur chaque flèche, vu le nombre qu'on en tire, c'est pas négligeable ! On peut le prendre malgré le prérequis qui nécessite d'être guerrier 4 grâce à l'[[Pathfinder-RPG.champion occultiste.ashx#ENTRAINEMENTDIVERSIFIE|entraînement diversifié]] du [[Pathfinder-RPG.Champion occultiste.ashx|Champion Occultiste]]
- [[Pathfinder-RPG.Science du tir de précision.ashx|Science du tir de précision]]
...
Détection de la magie (pour bénéficier du bonus de race en Art de la magie),
Message,
Prestidigitation,
Lumière

**3.4.1 [[Pathfinder-RPG.Liste des sorts densorceleursmagiciens.ashx#1|Sorts de niveau 1]]**
Armure de mage (en attendant d'avoir Port des armures magiques),
Compréhension des langages,
Démarche aérienne (pour pouvoir se déplacer sur le champs de bataille sans difficulté),
Déguisement,
Feuille Morte,
Endurance aux énergies destructives,
Image silencieuse (éventuellement si personne d'autre ne l'a dans le groupe),
...
Flamme éternelle,
Appel des pierres (dégâts sur grosse zone+terrain difficile)
Simulacre de vie,
Lévitation,
Pattes d'araignée,
Grâce féline
...
<p class="tablo-caption">Évolution de l'archer-mage</p>
