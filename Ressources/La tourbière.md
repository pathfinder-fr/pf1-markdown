---
Name: Ressources.La tourbière
Title: La tourbière
LastModified: 2013-04-16 13:51
---
...
<div class="BD">
{s:BDTitre|Mimique touchée par la magie|FP 7}
{s:BDTexte|**XP** 3 200}
{s:BDTexte|Aberration (métamorphe) de taille TG, N}
{s:BDTexte|**Init** +2 ; **Sens** vision dans le noir 18m (12 cases) ; Perception +14}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 17, contact 7, pris au dépourvu 17 (armure naturelle +10, Dex -1, taille -2)}
{s:BDTexte|**pv** 125 (10d8+80)}
{s:BDTexte|**Réf** +4, **Vig** +11, **Vol** +8}
{s:BDTexte|**Capacités défensives** protection magique ; **Immunités** acide}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 3m (2 cases)}
{s:BDTexte|**Corps à corps** coup +16 (2d8+15 plus adhésif) ou coup avec attaque en puissance +14 (2d8+21 plus adhésif)}
{s:BDTexte|**Espace** 4,50m (3 cases) ; **Allonge** 4,5m (3 cases)}
{s:BDTexte|**Attaques spéciales** constriction (coup, 2d8+15)}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 31, **Dex** 8, **Con** 26, **Int** 10, **Sag** 13, **Cha** 10}
{s:BDTexte|**BBA** +7, **BMO** +19, **DMD** 28}
{s:BDTexte|**Dons** Arme de prédilection (coup), Attaque en puissance, Réflexes surnaturels, Science de l’initiative, Talent (Perception)}
{s:BDTexte|**Compétences** Connaissances (exploration) +10, Déguisement +13 (+33 pour imiter des objets), Escalade +23, Perception +14 ; **modificateur racial** Déguisement +20 pour imiter des objets}
{s:BDTexte|**Langues** commun}
{s:BDTexte|**Particularités** aura magique, changement de forme mineur, imitation d’objets, touché par la magie}
{s:BDSousTitre|Particularités}
{s:BDTexte|**Adhésif (Ext).** Une mimique sécrète un mucus épais qui fonctionne comme un puissant adhésif et colle toutes les créatures et tous les objets qui le touchent. Une mimique recouverte de cette substance adhésive agrippe automatiquement toute créature touchée par son attaque de coup. Les adversaires ainsi agrippées ne peuvent pas se libérer tant que la mimique est vivante, à moins de tout d’abord enlever la substance adhésive. Toute arme touchant la mimique est également collée, à moins que son utilisateur ne réussisse un jet de Réflexes de DD 23. Un test de Force réussi contre un DD de 23 permet de détacher une arme collée. Un alcool fort ou du solvant universel peut dissoudre la substance adhésive mais la mimique peut encore agripper ses adversaires en suivant la procédure normale. La mimique peut dissoudre sa substance adhésive à volonté ; celle-ci s’effrite également 5 rounds après sa mort. Le DD dépend de la Force.}
<div>

{s:Image|/ADJ/Ressources/mimique (wiki ressources).jpg|300px|centre|}
</td></tr></table>
