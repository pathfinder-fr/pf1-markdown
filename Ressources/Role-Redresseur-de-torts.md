---
Name: Ressources.Role-Redresseur-de-torts
Title: Redresseur de torts
LastModified: 2013-03-07 14:57
Categories:
- Role
---

Ce rôle est destiné à tout lanceur de sorts dont le background implique une vengeance à accomplir contre un personnage puissant, voire une ville ou une province. Il peut s'agir d'un druide dont le domaine a été ravagé par la surexploitation des hommes, une sorcière ou un ensorceleur qui a échappé au bûcher, etc.

### Caractéristiques générales
**Race / Ethnie :** toutes{br}
**Classe principale :** Alchimiste, Barde, Druide, Ensorceleur, Inquisiteur, Magicien, Magus, Moine, Oracle, Prêtre, Sorcière{br}
**Classe secondaire :** Rôdeur, Roublard... et dans les cas extrême : Assassin{br}
Des personnages de n'importe quelle race peuvent devenir redresseur de torts, le fait d'appartenir à une race minoritaire peut être le point de départ d'un rôle de redresseur de torts.{br}
Les classes secondaires suggérées ici sont choisies par le personnage dans le seul but d'accomplir sa vengeance.

### Options de l'Alchimiste
**Archétypes :** Tous{br}
**Découvertes de l'Alchimiste :** Toute découverte qui améliore les bombes de l'Alchimiste{br}
...
### Options du Druide
**Archétypes :** Tous{br}
**Pacte avec la nature :** Au choix... un compagnon animal féroce est le plus courant.{br}
...
**Lignage :** Aberrant, Abyssal, Efrit, Infernal, Maudit, Morts-vivants, Serpentin, Pestilence{br}
Pour la plupart des lanceurs de sorts profane, le statut de "redresseur de torts" correspond au besoin de protéger la minorité dont il font partie, en particulier dans une société ou l'usage de la magie est interdit ou fortement réglementé. Dans cette optique, les lignages les plus fréquents sont également les moins fréquentables.

### Options de l'Inquisiteur
**Archétypes :** Tous{br}
**Inquisitions :** Colère, Justice, Vengeance{br}
**Jugements :** Châtiment, Destruction, Justice{br}
...
### Options du Magicien
**Ecole de Magie :** Evocation, Elementaire, voir aussi "Magicien qui brûle tout"{br}
**Decouvertes arcaniques :** Multimorphe, Véritable nom.{br}
...
Moines et Magus sont des classes parfaitement adaptées au combat, les options sont à sélectionner en fonction des points faibles de l'ennemi du personnage.{br}
...
### Options raciales
Si l'événement qui a fait du personnage un "redresseur de torts" est lié à sa race, il est fort probable que le personnage ait développé certains traits à l'extrême, les dons raciaux (en particulier ceux qui suivent) sont donc particulièrement appropriés :{br}
...
### Options diverses
**Compétences :** Artisanat (Armes, Pièges), Connaissances (Folklore local, Histoire, Nature), Discrétion, Dressage, Evasion, Survie{br}
**Dons :** Coup dans l'ombre, Discret, Dur à cuire, Ecole renforcée, Efficacité des sorts accrue, Endurance{br}
