---
Name: Ressources.Lîle flottante
Title: Lîle flottante
LastModified: 2015-02-07 18:37
---
...
<div class="BD">
{s:BDTitre|hylaeosaures|FP 5}
{s:BDTexte|**XP** 1 600}
{s:BDTexte|Jeune ankylosaure}
{s:BDTexte|Animal de taille G, N}
...
{s:BDTexte|**pv** 55 (10d8+10)}
{s:BDTexte|**Réf** +19, **Vig** +10, **Vol** +4}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9m (6 cases)}
{s:BDTexte|**Corps à corps** queue +13 (2d6+9 plus étourdissement)}
{s:BDTexte|**Espace** 3m (2 cases) ; **Allonge** 3m (2 cases)}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 23, **Dex** 14, **Con** 13, **Int** 2, **Sag** 13, **Cha** 8}
{s:BDTexte|**BBA** +5, **BMO** +15, **DMD** 27 (31 contre la mise à terre)}
...
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 6m (4 cases), nage 15m (10 cases)}
{s:BDTexte|**Corps à corps** morsure +13 (2d8+12)}
{s:BDTexte|**Espace** 4,5m (3 cases) ; **Allonge** 3m (2 cases)}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 26, **Dex** 15, **Con** 20, **Int** 2, **Sag** 13, **Cha** 9}
{s:BDTexte|**BBA** +7, **BMO** +17, **DMD** 30 (34 contre la mise à terre)}
{s:BDTexte|**Dons** Esquive, Mobilité, Robustesse, Vigueur surhumaine, Volonté de fer}
{s:BDTexte|**Compétences** Natation +16, Perception +14}
<div>

<div class="BD">
{s:BDTitre|Déinonychus évolué|FP 4}
{s:BDTexte|**XP** 1 200}
{s:BDTexte|Animal de taille M, N}
{s:BDTexte|**Init** +8 ; **Sens** odorat, vision nocturne ; Perception +16}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 17, contact 12, pris au dépourvu 15 (Dex +2, naturelle +5)}
{s:BDTexte|**pv** 42 (4d8+24)}
{s:BDTexte|**Réf** +10, **Vig** +8, **Vol** +4}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 18m (12 cases)}
{s:BDTexte|**Corps à corps** griffes +7 (1d8+4), morsure +7 (1d6+4), pattes avant +2 (1d4+2)}
{s:BDTexte|**Attaques spéciales** bond}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 19, **Dex** 19, **Con** 23, **Int** 2, **Sag** 16, **Cha** 18}
{s:BDTexte|**BBA** +5, **BMO** +7, **DMD** 21}
{s:BDTexte|**Dons** Course, Science de l’initiative}
{s:BDTexte|**Compétences** Acrobaties +12 (+24 pour le saut), Discrétion +17, Perception +16 ; **Modificateurs raciaux** +8 Acrobaties, +8 Discrétion, +8 Perception}
<div>

</td><td>

<div class="BD">
{s:BDTitre|Déinonychus évolué demi-dragon (2)|FP 6}
{s:BDTexte|**XP** 4 800 si rencontrés ensemble}
{s:BDTexte|Dragon de taille M, N}
{s:BDTexte|**Init** +8 ; **Sens** odorat, vision dans le noir 18m (12 cases), vision nocturne ; Perception +10}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 23, contact 14, pris au dépourvu 19 (Dex +4, naturelle +9)}
{s:BDTexte|**pv** 54 (4d8+36)}
{s:BDTexte|**Réf** +10, **Vig** +11, **Vol** +4}
{s:BDTexte|**Immunités** acide, paralysie, sommeil}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 18m (12 cases), nage 36m (24 cases)}
{s:BDTexte|**Corps à corps** 2 griffes +11 (1d8+8), morsure +11 (1d6+8), pattes avant +6 (1d4+4)}
{s:BDTexte|**Attaques spéciales** bond, souffle (1/jour, ligne de 12 cases, 4d6 acide, Réflexes DD 21)}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 27, **Dex** 19, **Con** 29, **Int** 6, **Sag** 16, **Cha** 20}
{s:BDTexte|**BBA** +9, **BMO** +11, **DMD** 25}
{s:BDTexte|**Dons** Course, Science de l’initiative}
{s:BDTexte|**Compétences** Acrobaties +11 (+23 pour le saut), Discrétion +11, Natation +15, Perception +10 ; **Modificateurs raciaux** +8 Acrobaties, +8 Discrétion, +8 Perception}
{s:BDSousTitre|Description}
{s:BDTexte|Les déinonychus demi-dragons ressemblent à des déinonychus normaux mais leur peau est couverte d’écailles noires et leur tête, garnie de cornes qui ressemblent à des cornes de dragon noir en version réduite. Ils possèdent également une crête osseuse qui court le long de leur cou. Ils chassent en meute et collaborent. Ils s’arrangent pour ne pas se multiplier au-delà du nombre actuel car leur intelligence supérieure à celle des autres habitants de l’île leur permet de comprendre qu’il n’y a pas suffisamment de ressources pour un nombre plus grand de dinosaures. Ils sillonnent l’île en groupes de deux individus ou plus, ce qui fait que les PJ peuvent les rencontrer à n’importe quel endroit. Ces demi-dragons possèdent une vitesse de nage au lieu d’une vitesse de vol.}
<div>

<div class="BD">
{s:BDTitre|Tyranosaure demi-dragon noir|FP 11}
{s:BDTexte|**XP** 12 800}
{s:BDTexte|Dragon de taille Gig, N}
{s:BDTexte|**Init** +5 ; **Sens** vision dans le noir 18m (12 cases), vision nocturne ; Perception +37}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 25, contact 7, pris au dépourvu 24 (Dex +1, naturelle +18, taille -4)}
{s:BDTexte|**pv** 207 (18d8+126)}
{s:BDTexte|**Réf** +12, **Vig** +15, **Vol** +10}
{s:BDTexte|**Immunités** acide, paralysie, sommeil}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 12m (8 cases), vol 24m (16 cases) (moyenne)}
{s:BDTexte|**Corps à corps** 2 griffes +28 (2d6+15), morsure +28 (4d6+30/19–20 et étreinte)}
{s:BDTexte|**Espace** 6m (4 cases) ; **Allonge** 6m (4 cases)}
{s:BDTexte|**Attaques spéciales** engloutissement (2d8+11, CA 17, 15 pv), souffle (1/jour, ligne de 12 cases d’acide, 18d6, Réflexes DD 26 moitié)}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 40, **Dex** 13, **Con** 25, **Int** 4, **Sag** 15, **Cha** 12}
{s:BDTexte|**BBA** +13, **BMO** +32 (+36 lutte), **DMD** 43}
{s:BDTexte|**Dons** Course, Critique sanglant, Don pour les critiques, Dur à cuire, Endurance, Science de l’initiative, Science du critique (morsure), Talent (Perception), Volonté de fer}
{s:BDTexte|**Compétences** Natation +36, Perception +37, Vol +16 ; **Modificateurs raciaux** +8 Perception}
{s:BDSousTitre|Capacités spéciales}
{s:BDTexte|**Morsure puissante (Ext).** Le tyrannosaure ajoute deux fois son modificateur de Force aux dégâts de sa morsure.}
<div>

<div class="BD">
{s:BDTitre|Istador|FP 10}
{s:BDTexte|**XP** 9 600}
{s:BDTexte|Demi Tyrannosaure demi dragon Elu Divin 6 de taille TG, CM}
{s:BDTexte|**Init** +1 ; **Sens** odorat, vision dans le noir 18m (12 cases), vision nocturne ; Perception +17}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 18, contact 9, pris au dépourvu 17 (Dex +1, naturelle +9, taille -2)}
{s:BDTexte|**pv** 264 (18d8+108 + 6d8+36)}
{s:BDTexte|**Réf** +19, **Vig** +24, **Vol** +15}
{s:BDTexte|**Immunités** acide, paralysie, sommeil ; **Résistances** feu (10)}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 12m (8 cases), nage 18m (12 cases), vol 24m (16 cases) (moyenne)}
{s:BDTexte|**Corps à corps** 2 griffes +30 (1d8+13), morsure +28 (3d6+6)}
{s:BDTexte|**Espace** 4,50m (3 cases) ; **Allonge** 3m (2 cases)}
{s:BDTexte|**Attaques spéciales** étreinte améliorée, engloutissement (2d8+11, CA 17, 15 pv), souffle (1/jour, ligne de 36 cases d’acide, 6d8, Réflexes DD 25 moitié)}
{s:BDTexte|**Sorts d'élu divin connu** (NLS 6<sup>e</sup>)}
{s:BDSorts|3 (3/jour)- *malédiction* (DD 15), *contagion* (DD 15), *soins importants*}
{s:BDSorts|2 (5/jour)- *force de taureau*, *soins modérés*, *restauration partielle*, ''résistance
aux énergies destructives''}
{s:BDSorts|1 (7/jour)- *soins mineurs*, *faveur divine*, *bouclier entropique*, *bouclier de la foi*, *vigueur (inférieure)**}
{s:BDSorts|0 (6/jour)- *création d’eau*, *détection de la magie*, *détection du poison*, *assistance divine*, *résistance*, *stimulant*}
{s:BDTexte|**vigueur (inférieure) : le sujet obtient guérison accélérée 1 pendant 10 + 1 round par niveau de lanceur (max 15 rounds).*}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 36, **Dex** 12, **Con** 23, **Int** 5, **Sag** 15, **Cha** 13}
{s:BDTexte|**BBA** +13, **BMO** +32 (+36 lutte), **DMD** 43}
{s:BDTexte|**Dons** Attaque naturelle améliorée (morsure), Attaques multiples, Attaque en vol, Course, Don pour les critiques, Robustesse (x3),
Vigilance}
{s:BDTexte|**Compétences** Discrétion +6, Natation +18, Perception +17, Survie +7, Vol +16 ; **Modificateurs raciaux** +8 Perception}
{s:BDTexte|**Particularités** morsure puissante}
{s:BDSousTitre|Capacités spéciales}
{s:BDTexte|**Souffle (Sur).** Une fois par jour, Istador peut souffl er une ligne d’acide de 27m (18 cases) de long qui inflige 6d8 points de dégâts (Réf. DD 25 moitié).}
{s:BDTexte|**Etreinte améliorée (Ext).** Pour utiliser cette faculté, Istador doit toucher un adversaire d’au moins une taille inférieure à la sienne avec son attaque de morsure. Il peut alors essayer de l’agripper au prix d’une action gratuite sans provoquer d’attaque d’opportunité. S’il parvient à agripper son adversaire, il peut alors essayer de l’engloutir le round suivant.}
{s:BDTexte|**Engloutissement (Ext).** Istador peut essayer d’engloutir une créature qu’il est parvenue à agripper d’au moins deux tailles inférieures à la sienne en réussissant un jet de lutte. La créature avalée subit 2d8+10 points de dégâts contondants et 8 points de dégâts d’acide par round dans le gésier d’Istador. Une créature engloutie peut se frayer un chemin en utilisant une arme légère perçante ou tranchante et en infligeant 25 points de dégâts au gosier (CA 12). Une fois que la créature est sortie, l’action musculaire ferme le trou ; un autre adversaire englouti doit se frayer son propre chemin. Le gésier d’Istador peut contenir 2 créatures de taille M, 8 de taille P, 32 TP ou 128 de taille M.}
<div>
