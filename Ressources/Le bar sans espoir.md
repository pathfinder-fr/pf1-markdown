---
Name: Ressources.Le bar sans espoir
Title: Le bar sans espoir
LastModified: 2013-04-17 18:40
---
...
<div class="BD">
{s:BDTitre|Élixir de désespoir d'Histenia|}
...
<div class="BD">
{s:BDTitre|L'antidote à l'élixir de désespoir d'Histenia|}
...
le sens où il ne faut pas abandonner le PJ à son triste sort (il ne quittera pas le lieu). Si les PJ se rendent compte qu’Histenia est à l’origine du problème, elle les combat, mais pas jusqu’à la mort. Si elle se rend compte qu’elle va perdre, elle utilise son sort de voyage par les arbres pour se déplacer le plus loin possible. Elle a déjà eu l’occasion de visiter l’ensemble de la région au cas où elle en aurait besoin.

### Créatures rencontrées
<div class="BD">
{s:BDTitre|Hystenia|FP 9}
{s:BDTexte|**XP** 6 400}
{s:BDTexte|Humaine (f) druide 9}
{s:BDTexte|Humanoïde de taille M, NM}
{s:BDTexte|**Init** +1 ; Perception +12}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 12, contact 12, pris au dépourvu 11 (Dex +1, Par +1)}
{s:BDTexte|**pv** 49 (9d8+9)}
{s:BDTexte|**Réf** +4, **Vig** +7, **Vol** +9}
{s:BDTexte|**Capacités défensives** absence de traces ; **Immunités** immunité aux venins ; **Résistance** résistance à l'appel de la nature}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9m (6 cases)}
{s:BDTexte|**Corps à corps** bâton, +6 (1d6/x2)}
...
{s:BDTexte|**Sorts de druide préparés** (NLS 9<sup>e</sup>, DD13 + Niveau du sort)}
{s:BDSorts|5 (1)- *voyage par les arbres*}
{s:BDSorts|4 (2)- *colonne de feu*, *dissipation de la magie*}
{s:BDSorts|3 (4)- *communication avec les plantes*, *contagion*, *croissance d’épines*, *soins modérés*}
{s:BDSorts|2 (5)- *forme d’arbre*, *nappe de brouillard*, *peau d’écorce*, *résistance aux énergies destructrices*, *sphère de feu*}
{s:BDSorts|1 (5)- *brume de dissimulation*, *charme-animal*, *communication avec les animaux*, *enchevêtrement*, *soins légers*}
{s:BDSorts|0 (4/à volonté)- *création d’eau*, *détection de la magie*, *lecture de la magie*, *purificaton de nourriture et d’eau*}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 10, **Dex** 12, **Con** 12, **Int** 13, **Sag** 16, **Cha** 14}
{s:BDTexte|**BBA** +6, **BMO** +6, **DMD** 17}
{s:BDTexte|**Dons** Autonome, Incantation animale, Magie de guerre, Vigilance, +1 don supplémentaire}
{s:BDTexte|**Compétences** Art de la magie +9, Artisanat (alchimie) +9, connaissances (nature) +11, Diplomatie +6, Dressage +10, Équitation +9, Estimation +5, Perception +12, Premiers secours +12, Psychologie +5, Survie +14}
{s:BDTexte|**Langues** commun, druidique, +1 langue supplémentaire}
{s:BDTexte|**Particularités** empathie sauvage (+11), instinct naturel, pacte avec la nature (compagnon animal), déplacement facilité}
{s:BDTexte|**Trésor** anneau de contresort, anneau de protection +1, bâton, sac à malice ocre}
<div>

<div class="BD">
{s:BDTitre|Pattes d'Argent|}
{s:BDTexte|Cheval de guerre lourd, compagnon animal}
{s:BDTexte|Animal de taille G, N}
{s:BDTexte|**Init** +3 ; **Sens** vision nocturne, odorat ; Perception +6}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 24, contact 14, pris au dépourvu 20 (Dex +3, Esq +1, Nat +10)}
{s:BDTexte|**pv** 60 (8d8+24)}
{s:BDTexte|**Réf** +9, **Vig** +11, **Vol** +3}
{s:BDTexte|**Capacités défensives** absence de traces ; **Immunités** immunité aux venins ; **Résistance** résistance à l'appel de la nature}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 15m (12 cases)}
{s:BDTexte|**Corps à corps** morsure +12/+7 (1d8+5), 2 sabots +10 (1d8+2)}
{s:BDTexte|**Espace** 3 mètres (2 cases) ; **Allonge** 1,5 mètres (1 case)}
{s:BDTexte|**Attaques spéciales** attaques multiples}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 21, **Dex** 16, **Con** 17, **Int** 2, **Sag** 12, **Cha** 6}
{s:BDTexte|**BBA** +6, **BMO** +12, **DMD** 25}
{s:BDTexte|**Dons** Arme naturelle supérieure (sabot), Course, Endurance, Esquive}
{s:BDTexte|**Compétences** Acrobatie +8, Discrétion +8, Perception +6, Survie +6}
{s:BDTexte|**Particularités** tours (attaque, attaque créatures surnaturelles, viens, protège, arrête, garde, Au pied, cherche, attends, suis), lien, transfert de sorts}
<div>
</td></tr></table>
