---
Name: Ressources.Barde archer (build)
Title: Barde archer
...
Tous les dons sont occupés par des dons de tir. Il n'y a de place pour la fantaisie.
...
#### 4. Équipement
Arc magique: privilégier en priorité le bonus d'altération {br}
Flèches: en fer froid, argent et adamantium contre les DR. Il existe aussi un type de flèches qui inflige des degâts contondants plutôt que perforants. Pour les flèches chères (comme celles en adamantium), il existe la qualité non-magique "durable" dans un supplément obscur. {br}
Gantelet clouté: arme de mêlée toujours prête à l'emploi. Marche aussi avec un cestus {br}
Armure: chemise de mailles (en mithral), cotte de mailles elfiques, mistmail et armure céleste sont de bonnes armures légères. À voir en fonction des moyens. {br}
Carquois efficace: pour stocker flèches, arcs et sceptres de métamagie {br}
Sceptre mineur d'Extension de durée: principalement pour Héroïsme. {br}

### Évolution proposée


<p class="tablo-caption">Évolution du barde archer</p>
