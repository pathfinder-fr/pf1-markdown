---
Name: Ressources.Demi-fee
Title: Demi-fée
LastModified: 2012-01-03 16:36
Categories:
- Règles maison
---
...
{s:BDTexte|**Distance** arc court, +3 (1d6-1/x3)}
{s:BDTexte|**Pouvoir magique**  (NLS 1)}
{s:BDTexte|1/jour - *Charme personne* (DD14)}
{s:BDTexte|**Sorts de bardes connus**  (NLS 1)}
{s:BDTexte|1<sup>er</sup> (2/jour) - *Déguisement* ou  *Fou rire*(DD14)}
{s:BDTexte|0 (à volonté) - *Détection de la magie, Convocation d'instrument, Message, Prestidigitation*}
{s:BDTexte|**Représentation bardiques** 7 rnd/jour}
{s:BDTexte|*Inspiration vaillante*(+1), *Contrechant*, *Distraction*, *Fascination* (DD13)}
...
{s:BDTexte|**Organisation sociale** Solitaire, couple, troupe de saltimbanque (3-6)}
{s:BDTexte|**Trésor** équipement de PNJ (arc court avec 20 flèches, armure de cuir, dague, rapière, instrument de musique, autres trésors)}
...
Les demi-fées ne possèdent pas de dés de vie raciaux et progressent en acquérant des niveaux de classe. Leurs traits raciaux sont les suivants :
- **Dex  +2, Cha +2, Con -2**. Les demi-fées sont agiles et possèdent une beauté étrange mais sont plus fragiles que les autres races.   
- **Compétences raciales** Discrétion et Perception sont automatiquement des compétences de classes pour un demi-fée.   
- **Taille moyenne.**   
