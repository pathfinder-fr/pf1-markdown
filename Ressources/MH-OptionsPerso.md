---
Name: Ressources.MH-OptionsPerso
Title: Options du Personnage
LastModified: 2014-07-06 13:48
---

<div class="chapeau">Cette vue vous permet de définir quelques règles relatives à ce personnage en particulier.

<b>Accès :</b> Mon Personnage/Onglet Autres/Options

[My Hero|Retour racine du Manuel]</div>

<table style="width: 100%"><tr style="vertical-align: top"><td style="width: 49%">{s:Image|/Illustrations/P63/My Hero/Slide42.jpg|100%|middle cadre|}</td><td style="width: 2%"></td><td style="width: 49%">
<OL><LI>Retour vers [MH-MonPerso|Mon Personnage]
<LI>Définition de la langue utilisée pour ce personnage. Le changement de langue peut prendre quelques secondes.
<LI>Définition de l’utilisation de la règle des points héroïques. Vous pouvez modifier ceux-là avec la [MH-GestPerso|Gestion du Personnage].
