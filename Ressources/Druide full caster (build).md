---
Name: Ressources.Druide full caster (build)
Title: Druide caster (build)
...
La caractéristique principale est la Sagesse. Les statistiques secondaires sont comme tout caster : la Constitution et la Dextérité. Les dump stats sont le Charisme et la Force.

##### 2.2 Exemple de répartition

Pré modificateur raciaux.

En 15pts : F10 D12 C14 I10 S16 C8 (possibilité de dumper la force)

En 20pts : F10 D14 C14 I10 S16 C10 (sans dumping)

##### 2.3 Race

La classe de druide est assez feat heavy, l'humain s'impose donc comme race de premier choix. On positionne son +2 sur la sagesse et le point de compétence bonus est toujours utile.

Le nain est un bon choix alternatif avec son +2 en Constitution et en Sagesse. Outre les statistiques on retrouve robustesse, la vision dans le noir et la vitesse de déplacement non réduite par la charge (utile vu qu'en forme animale on passe au delà des 6 mètres).

Une troisième alternative est le tengu qui comporte un +2 en Dextérité et en Sagesse. En contre partie le -2 concerne une statistique secondaire (la Constitution) donc attention. Le trait furtif est intéressant puisqu'il améliore la Perception qui est utile pour tout le monde.

#### 3. Plan de carrière

##### 3.1 Bonus de classe de prédilection

Vu les bonus de la classe de druide d'humain, nain et tengu (qui n'en a pas) la meilleure option reste encore les points de vie.
...
Pour ce qui est du full caster, on va plutôt s'orienter sur un domaine pour bénéficier de sorts supplémentaires qui vont pas mal soulager le manque de sorts. Certains préfèreront s'orienter sur un compagnon pour être plus utile à bas niveau, mais personnellement je préfère un domaine solide avec une liste de sort intéressante.

Niveau forme animale, à bas niveau on peut partir sur des formes volantes de taille P ou TP et plus tard sur les élémentaux, le plus souvent air, pour bénéficier de bons bonus de survivabilité, de vision et de mode de déplacement spéciaux (vol par exemple pour l'élémental d'air).
