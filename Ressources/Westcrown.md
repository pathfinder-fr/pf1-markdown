---
Name: Ressources.Westcrown
Title: Westcrown (add-ons)
LastModified: 2017-06-21 19:29
Categories:
...
<div class="BD">
{s:BDTitre|Garde municipal de Westcrown|FP 1}
...
- **Équipement de combat**:arbalète lourde, hallebarde (pas d'allonge!), potion de soins légers (x2), armure de plaques, 10 carreaux d'arbalète, matraque, 5po{br}

##### Garde municipal, noble mineur de Westcrown ou du Cheliax
<div class="BD">
{s:BDTitre|Garde à cheval municipal|FP 2}
- humanoïde de taille M,LN
...
- **SQ**: docile, riding, odorat, vision nocturne, {br}

##### Emissaire municipal, noble mineur honoré
<div class="BD">
{s:BDTitre|Garde à cheval municipal|FP 5}
- humanoïde de taille M,LN
...
''
Contenu proposé par CaptainAbsalom''{br}
(MJ sur [http://paizo.com/pathfinder/adventurePath/councilOfThieves|Le Conseil des voleurs (Paizo)])
