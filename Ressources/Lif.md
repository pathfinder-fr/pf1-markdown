...
<div class="BD">
{s:BDTitre|Taxine (substance létale extraire de l'if)|}
...
{s:BDTexte|**XP** 4 800}
{s:BDTexte|Plante de taille TG, LM}
...
{s:BDTexte|**Faiblesses** vulnérabilité au feu}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9m (6 cases)}
{s:BDTexte|**Corps à corps** 2 coups +17 (2d6+9/19–20)}
{s:BDTexte|**Distance** rochers +7 (2d6+9)}
{s:BDTexte|**Espace** 4,50 m (3 cases) ; Allonge 4,50 m (3 cases)}
{s:BDTexte|**Attaques spéciales** lancer de Rochers 18 m (12 cases), piétinement (2d6+13, DD 25)}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 29, **Dex** 8, **Con** 21, **Int** 12, **Sag** 16, **Cha** 13}
{s:BDTexte|**BBA** +9, **BMO** +20, **DMD** 29}
{s:BDTexte|**Dons** Arme de prédilection (coups), Attaque en puissance, Science de la destruction, Science du critique (coups), Vigilance, Volonté de fer}
{s:BDTexte|**Compétences** Connaissance (Nature) +9, Diplomatie +9, Discrétion -9 (+7 en forêt), Intimidation +9, Perception +12, Psychologie +9 ; **Modificateurs Raciaux** Discrétion +16 en forêt}
...
{s:BDTexte|**Equipement** standard}
{s:BDSousTitre|Capacités spéciales}
{s:BDTexte|**Animation des arbres (Mag).** Un sylvanien peut animer n’importe quel arbre situé à moins de 54 mètres (36 cases) à volonté et jusqu’à deux arbres en même temps. Cela prend 1 round complet à un arbre pour se déraciner, après quoi il se déplace à la vitesse de 3 m (2 cases) et combat comme un sylvanien (il n’a qu’une seule attaque de branche et ne possède pas les capacités d’animation et de lancer de rochers). Il est aussi vulnérable au feu qu’un sylvanien. Si le sylvanien termine l’animation, ou est trop éloigné ou ne peut plus contrôler l’arbre, celui-ci se réenracine et redevient un arbre comme les autres.}
{s:BDTexte|**Dommages Doublés contre les objets (Ext).** Un sylvanien ou un arbre animé qui eff ectue une attaque à outrance contre un objet ou une structure lui inflige le double de dégâts}
{s:BDTexte|**Communication avec les plantes (Ext).** Un sylvanien est capable de parler aux plantes, comme s’il était soumis au sort communication avec les plantes continuellement. La plupart des plantes sont amicales avec lui et lui portent assistance.}
<div>

<div class="BD">
{s:BDTitre|Piémarchin et Foxlin|FP 9}
{s:BDTexte|**XP** 1 200}
{s:BDTexte|Pixie mâle ensorceleur (lignage féerique) 6}
{s:BDTexte|Fée de taille P, LB (Piémarchin) / CM (Foxlin)}
{s:BDTexte|**Init** +5 ; **Sens** vision nocturne ; Perception +9}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 20, contact 17, pris au dépourvu 14 (armure +2, Dex +5, esquive +1, naturelle +1, taille +1)}
{s:BDTexte|**pv** 35 (4d6 plus 6d6)}
{s:BDTexte|**Réf** +12, **Vig** +3, **Vol** +12}
{s:BDTexte|**Capacités défensives** invisibilité ; **RD** 10/fer froid ; **RM** 15}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 6m (4 cases), vol 18 m (12 cases, bonne)}
{s:BDTexte|**Corps à corps** épée courte de maître +12 (1d4/19–20)}
{s:BDTexte|**Distance** arc long de maître +12 (1d6/x3)}
{s:BDTexte|**Attaques spéciales** flèches spéciales}
{s:BDTexte|**Sorts d'ensorceleur** (NLS 6<sup>e</sup>, DD +2 pour les sorts de coercition)}
{s:BDSorts|3 (4/jour)- *image accomplie*}
{s:BDSorts|2 (7/jour)- *fou rire*<sup>B</sup> (DD 21), *idiotie* (DD 21), *rayon ardent* (DD 19)}
{s:BDSorts|1 (8/jour)- *bouclier*, *charme personne* (DD 18), *décharge électrique*, *enchevêtrement*<sup>B</sup> (DD 18), *rayon affaiblissant* (DD 18)}
{s:BDSorts|0 (à volonté)- *détection de la magie*, *fatigue*, *hébétement* (DD 19), *manipulation à distance*, *message*, *prestidigitation*, *rayon de givre*}
{s:BDTexte|**Pouvoirs magiques** (NLS 8<sup>e</sup>)}
{s:BDSorts|Constant- *détection du Bien*, *détection du Chaos*, *détection de la Loi*, *détection du Mal*}
{s:BDSorts|9/jour- *toucher hilarant* (lignage)}
{s:BDSorts|1/jour- *confusion mineure* (DD 18), *détection des pensées* (DD 19), *dissipation de la magie*, *enchevêtrement* (DD 18), *image permanente* (DD 23, éléments visuels et sonores seulement), *lumières dansantes*}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 10, **Dex** 23, **Con** 10, **Int** 16, **Sag** 17, **Cha** 22 (avec le bandeau)}
{s:BDTexte|**BBA** +5, **BMO** +3, **DMD** 20}
{s:BDTexte|**Dons** Attaques en finesse, Dispense de composantes<sup>B</sup>, Esquive, Incantation silencieuse, Incantation statique, Sort à distance<sup>*</sup>}
{s:BDTexte|**Compétences** Acrobaties +19, Bluff +14, Connaissances (nature) +16, Discrétion +23, Évasion +19, Perception +16, Psychologie +10, Utilisation d’objets magiques +14, Vol +19}
{s:BDTexte|**Langues** commun, sylvestre}
{s:BDTexte|**Particularités** déplacement facilité}
{s:BDTexte|**Equipement** *bracelets d’armure +2*, petite épée courte de maître, petit arc long de maître, 14 flèches et carquois, *bandeau de Charisme +2*.}
{s:BDSousTitre|Capacités spéciales}
{s:BDTexte|**Flèches spéciales (Ext).** Les pixies peuvent employer des flèches qui ne causent aucun dégât mais ont certains eff ets spéciaux :
