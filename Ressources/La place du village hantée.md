---
Name: Ressources.La place du village hantée
Title: La place du village hantée
LastModified: 2013-04-15 21:58
---
...
<div class="chapeau">
{s:Dit|Alors que le jour touche à sa fin, un léger vent apporte jusqu’à à vos narines le fumet d’un plat en cours de cuisson. Devant vous, il y a une taverne. Une faible lumière illumine ses minuscules fenêtres.}
</div>
...
Rien de tout cela n’explique ce qui est arrivé aux trois personnes manquantes du village. Ils ont été victimes
...
Dans le passé, un mage excentrique a créé un (petit) portail intelligent en utilisant les arches de la fontaine. Il lui permettait de se déplacer plus rapidement. Il avait une tour en cours de construction à proximité et ne se formalisait pas d’avoir les pieds mouillés durant les travaux. Néanmoins, lorsque la bataille eut lieu, le mage fut appelé en renfort pour combattre et il décéda alors qu’il protégeait la zone et
se battait contre une autre lanceur de sorts très puissant. La puissante magie dépensée ici lors de la mort des deux mages a détruit le village et a étrangement affecté le portail qui est maintenant défaillant.
...
<div class="BD">
{s:BDTitre|Fronn (contre des opposants du plan matériel)|FP 11}
{s:BDTexte|**XP** 12 800}
{s:BDTexte|Humain (m) fantôme rôdeur 9}
{s:BDTexte|Mort-vivant (humanoïde évolué, intangible) de taille M, N}
{s:BDTexte|**Init** +1 ; **Sens** Perception +8}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 15, contact 15, pris au dépourvu 13 (Dex +1, Esq +1, Par +3)}
{s:BDTexte|**pv** 85 (9d10+27+9)}
{s:BDTexte|**Réf** +7, **Vig** +6, **Vol** +6}
{s:BDTexte|**Capacités défensives** Intangible, Reconstitution, Résistance à la canalisation +4 ; Immunités traits des morts-vivants}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** vol 18m (12 cases) (parfait)}
{s:BDTexte|**Corps à corps** toucher de corruption +9 (11d6, Vig DD 17 pour la moitié)}
{s:BDTexte|**Attaques spéciales** Lamentation d’épouvante (DD 17), Télékinésie}
{s:BDTexte|**Sorts de rôdeur préparés** (NLS 10<sup>e</sup>)}
{s:BDSorts|1 - *résistance aux énergies destructrices (x2)*}
{s:BDSousTitre|Tactique}
{s:BDTexte|**Avant le combat** Fronn essaiera de faire fuir les aventuriers, à l’aide de ses attaques spéciales Lamentaton d’épouvante ou de télékinésie.}
{s:BDTexte|**Pendant le combat** Fronn se défend mais essaiera de ne pas blesser les aventuriers. Il ne souhaite pas la mort.}
{s:BDTexte|**Moral** Si il se rend compte qu’il ne peut faire autre chose que blesser un des aventuriers, il préfèrera fuir dans le plan éthéré.}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** -, **Dex** 13, **Con** -, **Int** 8, **Sag** 11, **Cha** 17}
{s:BDTexte|**BBA** +9, **BMO** +9, **DMD** 20}
{s:BDTexte|**Dons** Combat à deux armes<sup>B</sup>, Esquive, Robustesse, Science du combat à deux armes<sup>B</sup>, Souplesse du serpent, Tir à bout portant, Tir de précision, Volonté de fer}
{s:BDTexte|**Compétences** Connaissances (exploration souterraine) +10, Connaissances (nature) +10, Discrétion +18, Escalade +5, Intimidation +13, Perception +18, Survie +11 ; **Modificateurs raciaux** +8 perception, +8 discrétion}
{s:BDTexte|**Langues** commun}
{s:BDTexte|**Particularités** déplacement facilité, empathie sauvage (+12), ennemi juré (elfes) +2, ennemi juré (géants) +4, environnement de prédilection (plaines) +4, environnement de prédilection (forêts) +2, esquive totale, pacte du chasseur (compagnon animal), pistage (+4), pistage accéléré}
...
|- CLASS="alt"
| 06-10 || Le portail ne fonctionne pas mais la tentative draine de l’énergie magique à partir des objets magiques de l’utilisateur. Un nombre aléatoire de ces objets (1d10) est touché par un effet similaire à une *dissipation de la magie suprême* avec un NLS de 17. Utilisez la table 9–2 : Objets affectés par les attaques magiques (page 216 en VO et en VF) pour déterminer quels objets sont touchés. Une dissipation réussie bloque les objets magiques permanents pendant 1d4 rounds. Les objets à charges ou à nombre d’utilisations limitée perdent 1d4 charges ou utilisations comme s’ils avaient été utilisés sans produire d’effet et sont inertes pendant le même nombre de rounds (pour autant qu’ils soient encore magiques après la perte des charges).
|-
| 11-20 || Le portail ne fonctionne pas. L’utilisateur est propulsé en arrière comme s’il avait été touché par un sort de télékinésie avec un NLS de 17. L’utilisateur peut tenter un jet de Volonté (DD 17) pour annuler cet effet. Il subit 1d6 points de dégâts s’il est projeté contre une surface solide.
|- CLASS="alt"
| 21-25 || Le portail ne fonctionne pas. Au lieu de cela, une vague d’énergie positive (50%) ou négative (50%) en émane, sur un rayon de 9m (6 cases). L’énergie négative fonctionne comme un sort de blessure importante lancé avec un NLS de 17 (3d8+15 points de dégâts, Volonté DD 14 pour diviser les dégâts par deux). L’énergie positive fonctionne comme un sort de soin important lancé avec un NLS de 17.
|-
| 26-40 || Le portail fonctionne mais il envoie l’utilisateur vers une mauvaise destination. Pour déterminer celle-ci, utilisez la table qui se trouve dans la description du sort de téléportation et lancez 1d20+80 sur la ligne « destination erronée ».
|- CLASS="alt"
| 41-50 || Rien ne se produit. Le portail ne fonctionne pas.
|-
| 51-100 || Le portail fonctionne normalement.
|}
</center>
