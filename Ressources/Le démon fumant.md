---
Name: Ressources.Le démon fumant
Title: Le démon fumant
LastModified: 2013-02-28 07:59
---
...
<div class="BD">
{s:BDTitre|Gorsshhh|FP 5}
{s:BDTexte|**XP** 800}
{s:BDTexte|Méphite de vapeur mâle barde 4}
{s:BDTexte|Extérieur de taille P, N}
{s:BDTexte|**Init** +6 ; **Sens** vision dans le noir 18 m ; Perception +12}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 18, contact 15, pris au dépourvu 14 (Dex +3, esquive +1, naturelle +3, taille +1)}
{s:BDTexte|**pv** 59 (3d10+9 plus 4d8+12) ; guérison rapide 2 (dans l’eau bouillante ou la vapeur)}
{s:BDTexte|**Réf** +10, **Vig** +5, **Vol** +7 (+4 contre les représentations de bardes, les effets dépendant du langage et les effets de son)}
{s:BDTexte|**Immunités** feu ; **RD** 5/magique ; **Vulnérabilités** froid}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9m (6 cases), vol 12m (8 cases, moyenne)}
{s:BDTexte|**Corps à corps** 2 griffes +9 (1d3)}
{s:BDTexte|**Attaques spéciales** représentation bardique (20 rounds/jour, contrechant, distraction, fascination, inspiration valeureuse +2), souffle (cône de vapeur de 4,50 m de long, 1d4 points de dégâts de feu et rend fiévreux pendant 3 rounds, Réflexes DD 15 pour la moitié des dégâts et éviter l’état fiévreux)}
{s:BDTexte|**Sorts de barde** (NLS 4<sup>e</sup>)}
{s:BDSorts|2 (2/jour)- *cacophonie* (DD 16), *invisibilité*}
{s:BDSorts|1 (4/jour)- *brume de dissimulation*, *charme-animal*, *communication avec les animaux*, *enchevêtrement*, *soins légers*}
{s:BDSorts|0 (à volonté)- *détection de la magie*, *harpe fantomatique* (voir plus loin), *lumières dansantes*, *manipulation à distance*, *prestidigitation*, *son imaginaire*}
{s:BDTexte|**Pouvoirs magiques** (NLS 6<sup>e</sup>)}
{s:BDSorts|1/jour- convocation (niveau 2, 1 méphite de vapeur 25%), *flou*, pluie bouillante}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 11, **Dex** 17, **Con** 16, **Int** 8, **Sag** 11, **Cha** 18}
{s:BDTexte|**BBA** +6, **BMO** +6, **DMD** 20}
{s:BDTexte|**Dons** Attaque en finesse, Esquive, Représentations supplémentaires, Science de l’initiative}
{s:BDTexte|**Compétences** Acrobaties +10, Bluff +14, Connaissances (toutes) +1, Diplomatie +14 (représentation versatile), Discrétion +17, Dressage d’animaux +14 (représentation versatile), Perception +10, Représentation (siffler) +14, Vol +11}
{s:BDTexte|**Langues** commun, igneux}
{s:BDTexte|**Particularités** déplacement facilité, représentation versatile (siffler), savoir de barde}
{s:BDSousTitre|Capacités spéciales}
{s:BDTexte|**Pluie bouillante (Sur).** Une fois par jour, le méphite peut créer une pluie d’eau bouillante dans une zone de 6 mètres de rayon. Les créatures vivantes situées dans la zone subissent 2d6 points de dégâts de feu (Vigueur DD 18 pour la moitié, NLS 6). Cette capacité équivaut à un sort de 2e niveau.}
{s:BDTexte|**Souffle (Sur).** Utilisable tous les 4 rounds en une action simple. Le DD est basé sur la Constitution et inclut un bonus racial de +1.}
<div>

<div class="BD">
{s:BDTitre|Vooss|FP 5}
{s:BDTexte|**XP** 800}
{s:BDTexte|Méphite de vapeur mâle ensorceleur (lignage élémentaire/électricité) 4}
{s:BDTexte|Extérieur de taille P, N}
{s:BDTexte|**Init** +6 ; **Sens** vision dans le noir 18 m ; Perception +6}
{s:BDSousTitre|Défense}
{s:BDTexte|**CA** 19, contact 16, pris au dépourvu 14 (Dex +4, esquive +1, naturelle +3, taille +1)}
{s:BDTexte|**pv** 44 (3d10+6 plus 4d6+8) ; guérison rapide 2 (dans l’eau bouillante ou la vapeur)}
{s:BDTexte|**Réf** +8, **Vig** +4, **Vol** +6}
{s:BDTexte|**Immunités** feu ; **RD** 5/magique ; **Résistances** électricité 5 ; **Vulnérabilités** froid}
{s:BDSousTitre|Attaque}
{s:BDTexte|**VD** 9m (6 cases), vol 12m (8 cases, moyenne)}
{s:BDTexte|**Corps à corps** 2 griffes +7 (1d3+2)}
{s:BDTexte|**Attaques spéciales** souffle (cône de vapeur de 4,50 m de long, 1d4 points de dégâts de feu et rend fiévreux pendant 3 rounds, Réflexes DD 14 pour la moitié des dégâts et éviter l’état fiévreux)}
{s:BDTexte|**Sorts de barde** (NLS 4<sup>e</sup>)}
{s:BDSorts|2 (4/jour)- *miasme* (DD 16, voir plus bas)}
{s:BDSorts|1 (7/jour)- *bouclier*, *brume de dissimulation*, *mains brûlantes<sup>B</sup>* (DD 15, dégâts d’électricité), *rapetissement* (DD 15)}
{s:BDSorts|0 (à volonté)- *aspersion d’acide*, *décharge électrique* (voir plus loin), *détection de la magie*, *manipulation à distance*, *ouverture/fermeture*}
{s:BDTexte|**Pouvoirs magiques** (NLS 6<sup>e</sup>)}
{s:BDSorts|7/jour- rayon élémentaire (+9 contact, portée 9m (6 cases), 1d6+2 points de dégâts d’électricité)}
{s:BDSorts|1/jour- convocation (niveau 2, 1 méphite de vapeur 25%), *flou*, pluie bouillante}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For** 15, **Dex** 19, **Con** 14, **Int** 6, **Sag** 9, **Cha** 18}
{s:BDTexte|**BBA** +5, **BMO** +3, **DMD** 15}
{s:BDTexte|**Dons** Dispense de composantes<sup>B</sup>, Esquive, Science de l’initiative}
{s:BDTexte|**Compétences** Bluff +10, Discrétion +18, Perception +5, Vol +12}
{s:BDTexte|**Langues** commun, igneux}
...
{s:BDTitre|Distorsion des paroles|}
