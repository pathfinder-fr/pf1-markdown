---
Name: Ressources.Tacticien défenseur
Title: Tacticien défenseur
LastModified: 2012-01-10 23:07
Categories:
- Règles maison
---
...
{br}
*Le personnage surveille du coin de l’œil les ennemis qui pourraient venir à son contact et gagne un avantage tactique contre eux*
...
**Normal :** Les mouvements ne provoquent d'attaque d'opportunité que si un ennemi quitte une case contrôlée par le personnage. Même avec le don [[Pathfinder-RPG.Attaques réflexes|Attaques réflexes]], il est impossible de porter plus d'une AO sur un même ennemi pour une même action déclenchant une [[Pathfinder-RPG.attaque dopportunité|AO]]. Il est par contre normalement possible de porter plusieurs attaques d'opportunités à un même ennemi s'il effectue plusieurs actions différentes déclenchant des [[Pathfinder-RPG.attaque dopportunité|attaques d'opportunités]].
