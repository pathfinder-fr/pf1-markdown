---
Name: Ressources.Colibri mécanique(fanmade)
Title: Colibri mécanique
LastModified: 2016-03-29 19:39
---

<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Colibri mécanique réparateur|FP 4}
...
{s:BDTexte|**Trésor** Pièce runique}
{s:BDSousTitre|Capacité spéciales}
{s:BDTexte|**Réparation instantanée (Sur)**: Tous les 1d6 rounds, le colibri peut au contact rendre 2d6 points de vie à une créature artificielle ou un objet}



</div>
</td><td><div>*Ce petit oiseau mécanique d'une dixaine de centimètres se déplace avec un bruit rapide de battement d'ailes. Il fait assez souvent du sur-place. Le bout de ses ailes sont peintes en vert et le reste de son corps a un aspect argenté. *

Les colibris de réparation ont été créés tant dans un but esthétique que pratique.
