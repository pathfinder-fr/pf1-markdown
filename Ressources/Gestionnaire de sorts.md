...
Un [Guide d'utilisation du gestionnaire de sorts](./guide gestionnaire de sorts.md) est disponible pour vous aider à prendre en main l'application.
...
Pour discuter de l'application il existe un sujet [sur le forum](http://www.pathfinder-fr.org/Forum/default.aspx?g=posts&t=276).
...
[en chantier](./guide gestionnaire de sorts.md)
## Le Deck
