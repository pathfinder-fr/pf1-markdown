---
Name: Ressources.Role-Druide-de-village
Title: Sorcier de village
...
**Race / Ethnie :** selon la région, un étranger d'une ethnie proche est acceptable{br}
**Classe Principale :** Alchimiste, Barde, Druide, Ensorceleur, Magicien, Oracle, Prêtre, Sorcière{br}
...
**Archétype :** Quelconque{br}
**Découvertes d'Alchimiste :** Infusion (indispensable, aucun alchimiste ne peut prendre ce rôle s'il est incapable de soigner les autres.{br}

### Options du Barde
**Archétype :** Barde standard, Barde funèbre, Marchand de sable, Orateur animal, Soignechant{br}
...
### Options du Druide
**Archétype :** Quelconque, sauf "druide urbain"{br}
Pacte avec la nature : au choix. Un compagnon animal "local" est bien pratique pour un druide sédentaire,
La majorité des archétypes peuvent correspondre... un sage des menhirs sera craint et respecté, un flétrisseur sera un peu moins respecté, mais craint deux fois plus.{br}
...
Pour toutes ces raisons, c'est surtout dans les campagnes que les chasseurs de sorciers sont les plus actifs.{br}

### Options du Magicien
**Pacte magique :** quelconque, un familier donne au magicien "l'apparence" classique d'un honnête sorcier de village tel que les villageois se l'imaginent, mais l'objet fétiche peut être précieux lorsque les habitants du coin lui demandent un service inattendu.{br}
**Découvertes arcaniques :** Baguette baton, diviser un emplacement, Langage sauvage, multimorphe{br}
...
### Options de l'Oracle
**Archétype :** quelconque{br}
**Mystère de l'oracle :** quelconque{br}
**Malédiction de l'oracle :** quelconque, Boiteux est un des plus fréquents{br}
...
**Domaines :** Artisanat, Communauté, Connaissance, Faune, Flore, Guérison, Protection{br}
...
**Archétype :** tous (selon la localisation du village) sauf Marchetombe; Sorcière de village est le plus fréquent.{br}
**Protecteurs Conseillés :** Ancêtre et Guérison{br}
**Protecteurs Déconseillés :** Démense, Hiver, Mort, Occulte, Pestilence, Tromperie, Vengeance
**Maléfices :** Chance, Charme, Don des langues, Guérison, Langage sauvage, Sceau{br}
**Maléfices Majeurs :** Brouet de la sorcière, Demeure cachée, Guérison majeure, Parler en rêve, Vision{br}
**Grands Maléfices :** Donneuse de vie, Hutte de la sorcière

### Options diverses
**Compétences :** Connaissances (Folklore local, Nature, Religion), Dressage, Equitation, Premiers secours, Profession (Brasseur, Herboriste, Trappeur), Survie{br}
**Dons :** Autonome, Familier supérieur, Fraternité animale{br}
**Traits :** Adepte de la foi verte, Adopté, Aide soignant, Enfant de la nature (Gozreh), Marque de naissance, Optimiste patient (Érastil), Passé d'hérétique, Toucher sacré{br}
