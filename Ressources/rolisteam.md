---
Name: Ressources.rolisteam
Title: Introduction à la Table Virtuelle Rolisteam
...
- Jouer une musique d'ambiance depuis une "playlist" pour tous ses joueurs
- D'utiliser des outils de dessin
- D'avoir accès a un bloc note
- De jeter des dés virtuels de x faces (dx) vu par tous ou en privé
- De "Tchater" avec les PJ dans un chat commun, ou en privé
- D'afficher des images
- D'afficher des cartes dévoilées a tous, ou couvertes d'un brouillard de guerre
- De placer, déplacer, et éditer l'état de jetons sur les plans actifs
- De sauvegarder notes et scénario en cours
- ...
...
- 3 La zone principale, la ou s'affiche les images, les fenêtres de tchat,... Ici, un plan, qui pour les PJ, apparait complètement caché
- 4 Les journaux de la partie, heure de connexion, création de PJ,...
- 5 La liste des Joueurs et de leur(s) PJ(s). C'est aussi ici que l'on initialise un tchat avec un ou les joueurs
- 6 Le gestionnaire de Musiques. Les Joueurs auront au préalable récupéré la "playlist" qu'ils auront placé dans un répertoire donné de **Rolisteam**. Une fois que le MJ lancera le son, il sera automatiquement joué chez les joueurs 
- 7 La barre de menu, pour afficher les plan, dessins, sauvegarder la partie, accéder a la documentation,...
...
Le site du projet, en constante évolution : http://code.google.com/p/rolisteam/

Rolistik, la source de l'autre: http://rolistik.free.fr/

TeamSpeak: http://www.teamspeak.com/

RoleDD: http://bonnarien.dyndns.org/programme/roleDD.php
