---
Name: MainPage
Title: Bienvenue sur les wikis de Pathfinder-fr !
LastModified: 2017-04-01 20:54
---

<p class="description">Vous vous trouvez dans la section "wiki" du site Pathfinder-FR. C'est une partie importante de ce site mais son organisation peut sembler un peu complexe si vous n'êtes pas familier avec la gamme Pathfinder. Ces pages, qui sont le produit du travail des rédacteurs, concepteurs, relecteurs, enjoliveurs et autres fans motivés de la communauté Pathfinder-FR, regroupent une grande quantité d'informations diverses qui grandit encore de jour en jour ! Prenez donc quelques minutes pour parcourir les explications qui suivent afin de pouvoir en profiter le mieux possible !</p>
...
<td width="16%">
<center><img src="/Wiki/public/upload/Illustrations/PNJ/Happygob.jpg" width="100%"/></center>
</td>
<td width="42%">
...
<table class="page espace-col deuxcol espaceul">
<tr><td>
### Pathfinder-FR pour les joueurs
...
[Le blog](http://www.pathfinder-fr.org/Blog/) pour se tenir au courant des nouvelles du site ou de la gamme, tant en VF qu'en VO.

#### Forums

[Les forums](http://www.pathfinder-fr.org/Forum/) pour se présenter, poser des questions, participer à des projets communautaires, parler de sa passion, ou même jouer en ligne !

#### Galerie

- [Une galerie](http://www.pathfinder-fr.org/Media/) reprenant toutes les illustrations que les sites de fans peuvent réutiliser librement.
...
[La galerie](http://www.pathfinder-fr.org/Media/) contenant un dossier reprenant de nombreuses battlemaps toutes prêtes à l'utilisation (et où les MJ peuvent également partager leurs créations).
