---
Name: Golarion.Couronne-Ouest
Title: Couronne-d'Ouest
LastModified: 2010-02-17 17:23
Categories:
- Chéliax
- Géographie
- Ville
...
- **Regicona** (le Palais Flottant) représente l'île centrale de la ville. Elle est composée de :
  - **Rego Corna** (le Secteur de la Couronne), secteur de l'ancienne Cour Impériale et ses dépendances.
  - **Rego Laina** (le Secteur de la Lame), secteur des forges et armureries. On y rencontre aussi des nobles.
  - **Rego Aerum** (le Secteur du Trésor), l'ensemble de ce secteur est maintenant devenu un parc urbain.
- **Dospera** (l'Autel du Désespoir)  représente la partie en ruines, au nord de la ville. Elle est composée de :
  - **Rego Cader** (le Secteur des Morts), secteur complètement laissé à l'abandon. Anciennement les classes les plus pauvres et les esclaves étaient parqués dans ce secteur. Aujourd'hui, on y rencontre surtout des vagabonds et des voleurs.
  - **Rego Cura** (le Secteur du Sang), secteur où est situé le marché aux esclaves de la ville.
...
- le **Korradath**, dans le Regicona, est l'ancien siège de l'Empire Chélaxien.
- le **Vaneo Drovenge**, dans le Regicona, est le manoir de la Maison Drovenge.
- la **Vira Oberigo**, dans le Regicona, est la plus ancienne propriété de la Maison Oberigo à qui elle appartient depuis plusieurs siècles.
