---
Name: Starfinder.Altérations magiques
Title: Altérations magiques
LastModified: 2019-08-28 00:08
---
...
<div class="article_2col">{s:Reference|ANALYSERAPIDE}
**Analyse rapide (Sur)**
...
{s:Reference|CONTRESMESURESANTISORTS}
...
{s:Reference|CREATIONTECHNOLOGIQUE}
...
{s:Reference|INFLUENCEROBOTIQUE}
...
{s:Reference|MAITRISETECHNOMANCIENNE}
...
<div class="article_2col">{s:Reference|CONTRESMESURESTECHNOLOGIQUES}
...
{s:Reference|TELEPORTATIONECLAIR}
...
<div class="article_2col">{s:Reference|REINITIALISATIONMENTALE}
...
{s:Reference|SENTINELLEDECONTRETECHNOLOGIE}
...
<div class="article_2col">{s:Reference|BIBLIOTHEQUEDESORTS}
