...
table.menuconvoctab td.menuconvoctitre {
...
table.menuconvoctab tr.menuconvocitem td {
...
table.menuconvoctab tr.menuconvocitem td:hover {
background-color: #e7dfc6;
color: #000;
}
</style>
<div width="100%" class="menuconvoc">
<table width="100%">
<tr>
<td width="49%">
<table width="100%" class="menuconvoctab">
<tr>
