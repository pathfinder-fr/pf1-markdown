...
Cette FAQ est inspirée du travail effectué par Tim Shadow sur le site [d20PFsrd](https://www.pathfindersrd.com).
Il s'agit d'une compilation de questions fréquemment posées sur les forums de Paizo. Si une réponse mentionne un nom, cela signifie
qu'il s'agit d'une réponse officielle écrite par un employé officiel de Paizo. Si aucun nom n'est indiqué, la réponse retranscrit
le consensus le plus souvent rencontré.
</td></tr></table></div>
