...
contenu += "Ordre  
<input id='iordre' type='text' value='" + currelem.ordre + "'/>  
";
contenu += "Points de vie  
<input id='ipv' type='text' value='" + currelem.pv + "'/>  
";
contenu += "Points de vie max  
<input id='ipvmax' type='text' value='" + currelem.pvmax + "'/></td>";
contenu += "<td>";
if (currelem.joue) {
contenu += "<input id='rdejajoue' name='vis' type='radio' value='A déjà joué' checked='checked'/> <span style='color: gray'>A déjà joué</span>  
";
contenu += "<input id='rdoitjouer' name='vis' type='radio' value='Doit encore jouer'/> Doit encore jouer  
";
} else {
contenu += "<input id='rdejajoue' name='vis' type='radio' value='A déjà joué'/> A déjà joué  
";
contenu += "<input id='rdoitjouer' name='vis' type='radio' value='Doit encore jouer' checked='checked'/> Doit encore jouer  
";
}
contenu += "État actuel  
<select id='setat'>";
...
contenu += "<tr><td>";
contenu += "Ordre  
<input id='iordre' type='text' value='0'/>  
";
contenu += "Points de vie  
<input id='ipv' type='text' value='1'/>  
";
contenu += "Points de vie max  
<input id='ipvmax' type='text' value='1'/>";
contenu += "</td><td>";
contenu += "<input id='rdejajoue' name='joue' type='radio' value='A déjà joué'/> <span style='color: gray'>A déjà joué</span>  
";
contenu += "<input id='rdoitjouer' name='joue' type='radio' value='Doit jouer' checked='checked'/> Doit encore jouer  
";
contenu += "État actuel  
<select id='setat'>";
contenu += "<option value='Mort'>Mort</option>";
