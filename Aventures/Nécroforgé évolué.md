---
Name: Aventures.Nécroforgé évolué
Title: Nécroforgé évolué
LastModified: 2026-03-30 02:10
---

<table class="Bestiaire"><tr><td>
<div class="BD">
{s:BDTitre|Nécroforgé|FP 7}
{s:pucem|Mort-vivant|Plaines|Tempéré}
{s:BDTexte|*Source : Souyfer, à partir du Bestiaire 4 page 194*}
- **3200PX**
- type Mort-vivant de taille G, NM
- **Init **+1 ; **Sens** vision dans le noir à 18 m ; Perception +0
(((Défense)))
- **CA** 18, contact 10, pris au dépourvu 17 (taille-1, Dex +1, naturelle +6, armure +2)
- **pv** 60 (10d8+8)
- **Réf **+2, **Vig **+2, **Vol **+4
- **Immunités** traits des morts-vivants
(((Attaque)))
- **VD** 9 m,
- **Corps à corps** 2 griffes, +7 (1d4+2) et morsure, +7 (1d6+2)
(((Statistiques)))
...
permet de lancer *Ordre assassin* (DD 12) **CA **: 16 (taille +2, naturelle +4)
(((Écologie)))
...
*Fiévreux *: Le personnage reçoit un malus de -2 aux jets d’attaque, de dégâts d’armes et de sauvegarde ainsi qu’aux tests de compétence et de caractéristique.
...
- *Ajout personnel*. Une main avec une bouche sort au niveau de la nuque et lance le sort *ordre assassin* DD12

</div>
</td><td><div>
*Puissamment musclé et doté d’une ossature saillante, ce prédateur semblable à un humain, est composé de multiples corps amalgamés.*
