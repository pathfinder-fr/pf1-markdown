---
Name: Aventures.Conversion E1
Title: E1 - La foire aux larmes - Aides de jeu et conversion
LastModified: 2013-02-07 10:16
Categories:
- Conversion
---
...
| 1
| 2
|  class="gauche"  |  Donner l'aumône aux mendiants
| o/n
|-
| 2
| Course traineaux
...
| 4
| 2
|  class="gauche"  |  Libérer les villageois gelés
| o/n
|-
| 3
| Ménagerie
...
| 1
| 3
|  class="gauche"  |  Faire fuir Bredouille
| o/n
|-
| 5
| Roue du Titan
...
| 0
| 3
|  class="gauche"  |  Sauver l'enfant happé par la machinerie
| o/n
|-
| 9
| Berges du lac
...
| 0
| 2
|  class="gauche"  |  Sauver l'enfant qui s'étouffe avec une pomme
|  o/n
|-
| 12
...
| 10:00
| CT1
|  class="gauche"  | Ouverture des guichets
| 0
|-
| -
| -
|  class="gauche"  | Les concours de la foire
| 0
|-
| 18:00
| -
|  class="gauche"  | Couché du soleil
| 0
|-
| 18:00
| CT2
|  class="gauche"  | Sathelbry envouté par les fées : enlèvement 6 villageois / heure
| 0
|-
| 19:30
| CT12
|  class="gauche"  | Quinn est présent pour faire sa démonstration
| 0
|-
| 20:30
| CT14
|  class="gauche"  | Terreur dans le labyrinthe (ND 4)
| 5
|-
| 20:50
| -
|  class="gauche"  | Convocation Syntira (document 1)
| 0
|-
| 21:00
| CT9
|  class="gauche"  | Feu d'artifice : Attaque des fées
| 0
|}
...
| Concours d'archérie
| 1 pa
| class="gauche" | Tir à l'arc long de 3 flèches à 30m{br}Jet d'attaque à distance vs. CA des cercles de la cible{br}CA 10, 15, 20, 25 et 30 et donne autant de points
| class="gauche" | Si **1ère place** : Poupée de la foire{br} Si **90 points** : flèche tueuse d'humains
|-
| Marche sur braises
| 1 pa
| class="gauche" | Tapis 3m de braises {br}Pari contre les spectateurs{br}Jet de volonté DD25 pour traverser jusqu'au bout{br}La traversé inflige 1d4 dégâts de feu par round.
| class="gauche" | Poupée de la foire et 50% des gains des paris
|-
| Le lancer d'oeufs
| 1 pa
| class="gauche" | Nécessite 2 participants A et B{br}A. Jet d'attaque distance (-2/3m) VS CA 0{br}B. Jet de Réflexes DD0+2/3m{br}
| class="gauche" | Poupée de la foire
|-
...
### Rencontres
Ici les rencontres converties au format pathfinder.
Elles sont présentées selon leur ordre d'apparition dans la Fiche guide ci-dessus.

#### Forain
<div class="BD">
{s:BDTitre|Forain|FP 1}
{s:BDTexte|Humain expert 2}
{s:BDTexte|Humanoïde de taille M, N}
{s:BDTexte|**Init** +0 ; **Sens** **Perception** +0}
{s:BDSousTitre|Capacités défensives}
{s:BDTexte|**CA** 10, contact 10, dépourvu 10 }
{s:BDTexte|**pv** 9 (2d8)}
{s:BDTexte|**Réf** +0, **Vig** +0, **Vol** +3}
{s:BDSousTitre|Capacités offensives}
{s:BDTexte|**VD** 9m (6 cases)}
{s:BDTexte|**Corps à corps** dague +0 (1d4-1)}
{s:BDTexte|**Distance** dague +1 (1d4-1)}
{s:BDSousTitre|Tactique}
{s:BDTexte|**Avant le combat**  Les bagarres sont mauvaises pour les affaires, les forains essayent d'en rester à l'écart, s'ils sont forcés d'y participer ils essayent de maîtriser leur opposant ou se battent à mains nues.}
{s:BDTexte|**Pendant le combat** Si un forain est menacé, il se bat armé et appelle l'aide des forains proches qui arrivent rapidement (généralement 1d4 forain par round, dépendant de la disponibilité).}
{s:BDTexte|**Moral** Un forain ne veut pas mourrir, il fuit le combat quand il est face à un conflit important ou si l'attaquant faire montre d'une force supérieure.}
...
{s:BDTexte|**Immunités** froid; RM 16}
{s:BDTexte|**Faiblesses** feu }
{s:BDSousTitre|Capacités offensives}
{s:BDTexte|**VD** 9m (6 cases)}
...
{s:BDTexte|**Moral** Lâche de nature, il fuit si ses pv sont réduit à 10 pv ou moins}
{s:BDSousTitre|Caractéristiques}
...
{s:BDTexte|**Immunités** attaques de regard, effets visuels}
{s:BDTexte|**Faiblesses** aveugle}
{s:BDSousTitre|Capacités offensives}
{s:BDTexte|**VD** 9m (6 cases)}
{s:BDTexte|**Corps à corps** Hache d’armes +4 (1d8+3/x3)}
{s:BDSousTitre|Caractéristiques}
...
{s:BDTexte|**Distance** dague de maître +9 (1d4+3 plus poison)}
{s:BDTexte|**Attaque spéciale** black adder venom (injury, DC 11, 1/rd. for 6 rds., 1d2 Con, 1 save), sneak attack +3d6, rogue talent (surprise attack)}
{s:BDSousTitre|Tactique}
{s:BDTexte|**Avant le combat** Kabran utilise sa diplomatie pour éviter de provoquer une esclandre, offering the PCs a free sample of Ralla's wares if they leave him alone. If this fails, he tries to intimidate them with a snarl and a "don't get between an orc and his earners, you tuskless pig." }
{s:BDTexte|**Pendant le combat** Kabran Quick Draws his poisoned +1 dagger and attacks the nearest PC before backing away to hurl his poisoned masterwork daggers at the others. }
{s:BDTexte|**Moral** If successfully Intimidated or brought below 20 hit points, Kabran backs down and lets Ralla go, but he promises "this is far from over." If the PCs press their attack further, the downs his potion of gaseous form, and floats away to fight another day.}
{s:BDSousTitre|Caractéristiques}
{s:BDTexte|**For **17, **Dex **14, **Con **17, **Int **12, **Sag **15, **Cha **12}
{s:BDTexte|**BBA **+5 ; **BMC **+8 ; **DMD **21}
