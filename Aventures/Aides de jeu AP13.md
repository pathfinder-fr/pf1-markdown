---
Name: Aventures.Aides de jeu AP13
Title: Aides de jeu pour La colère des justes
LastModified: 2022-08-20 15:35
Categories:
- Campagne
---
...
{s:Reference|CHAMPSDERUINES}
#### Un champ de ruines (niveau 3)
<table>
{s:ADJStart}
<tr STYLE="vertical-align: top;"><td  COLSPAN=4>
...
{s:Reference|HERITAGEPIERREDEGARDE}
#### L'héritage de la pierre de garde (niveau 4)
<table>
{s:ADJStart}
<tr STYLE="vertical-align: top;"><td COLSPAN=4>
...
|-
| potion d'[[++Pathfinder-RPG.espoir | espoir]] (NLS 5) |
|-
| potion de [[++Pathfinder-RPG.délivrance des malédictions | délivrance des malédictions]] (NLS 5) |
|-
| potions de [[++Pathfinder-RPG.soins importants | soins importants]] (NLS 5) |
|-
...
#### La redoute du démon (niveau 10.4)

{s:Reference|LESANCTUAIREDIVOIRE}
#### Le sanctuaire d'Ivoire (niveau 11.4)
