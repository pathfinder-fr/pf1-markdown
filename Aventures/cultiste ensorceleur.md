---
Name: Aventures.cultiste ensorceleur
Title: cultiste ensorceleur
LastModified: 2020-11-15 23:35
---

<div class="BD">
{s:BDTitre|Cultiste ensorceleur |FP 4}
- **XP** 1 200
- Ensorceleur 5, mâle
...
- **Sorts d'ensorceleur connus** (NLS 5, concentration +9)
  ...
  - 1 (7/jour) — *mains brûlantes* (DD 15), *Frayeur* (DD 15), *armure de mage*, *projectile magique*, *rayon affaiblissant* (DD 15)
...
- **Équipement de combat** *anneau de lévitation* (*lévitation* une fois par jour, soi-même uniquement, NLS 3) ; **Autre équipement** dague de maître, *anneau de protection +1* 
</div>
