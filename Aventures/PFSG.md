...
Il s'agit ici de la **version 9.0** (14 août 2017) du **Guide de la Campagne Organisée de la Société des Éclaireurs** (*Guide to Pathfinder Society Organized Play*) dont la version originale peut être téléchargée gratuitement sur le site de [Paizo](http://paizo.com/products/btpy84k4?Guide-to-Pathfinder-Society-Organized-Play).

### Informations légales (VF)
{s:ImageGaucheExt|http://www.pathfinder-fr.org/Wiki/GetFile.aspx?File=%2fIllustrations%2fPFS%2flettrine%20PFS%20L.jpg&AsStreamAttachment=1&Provider=ScrewTurn.Wiki.FilesStorageProvider&NoHit=1|100px}a présente traduction a été effectuée par l'équipe de Pathfinder-FR à partir du guide publié par [Paizo](http://paizo.com) avec l'autorisation de [Black Book Éditions](http://www.black-book-editions.fr/). Vous pouvez naturellement distribuer le texte au sein de votre groupe de jeu et les organisateurs d'évènements peuvent imprimer des copies de ce guide pour les fournir aux nouveaux joueurs.
...
La version originale du présent document est téléchargeable gratuitement sur le site de [Paizo](http://paizo.com), nous vous invitons à vous inscrire sur le site de [Paizo](http://paizo.com) et à télécharger un exemplaire du guide en VO.

<div class="chapeau">Un pdf de la traduction disponible sur ce site est téléchargeable en cliquant [ici](http://www.pathfinder-fr.org/Wiki/GetFile.aspx?File=%2fADJ%2fAventures%2fPFS%20Traduction%20Guide%20de%20jeu.pdf&AsStreamAttachment=1&Provider=ScrewTurn.Wiki.FilesStorageProvider&NoHit=1). Le site Pathfinder-fr tient à remercier BBE pour nous avoir donné l'accord de mettre ce document à disposition et sab69 pour avoir réalisé cette aide de jeu.</div>
