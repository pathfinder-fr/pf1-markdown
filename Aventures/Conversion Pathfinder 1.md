---
Name: Aventures.Conversion Pathfinder 1
Title: Conversion Pathfinder
LastModified: 2017-04-14 15:11
Categories:
- Conversion
---
...
<div class="BD">
{s:BDTitre|Commando Gobelin|FP 1}
- **XP**  400
- Gobelin (m) rôdeur 1
- Humanoïde (goblinoïde) de taille P, NM
...
<div class="BD">
{s:BDTitre|Chef de guerre Volpépite|FP 1}
- **XP**  1200
- Gobelin guerrier 4
- Humanoïde (goblinoïde) de taille P, NM
...
(((Attaque)))
- **VD** 9 m (6 {s:c})
- **Corps à corps** 2 griffes +5 (1d2-4), morsure +5 (1d3-4)
...
<div class="BD">
{s:BDTitre|Orik Vancaskerkin|FP 2}
- **XP**  600
- Humain (M) guerrier 3
