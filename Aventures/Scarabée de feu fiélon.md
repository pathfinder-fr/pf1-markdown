---
Name: Aventures.Scarabée de feu fiélon
Title: Scarabée de feu fiélon
LastModified: 2019-05-28 15:04
---
...
{s:BDTexte|**Organisation sociale** solitaire, portée (2-6) ou colonie (7-12)}
{s:BDTexte|**Trésor** aucun}
{s:BDSousTitre|Capacités spéciales}
{s:BDTexte|**Luminescence (Ext).** Les glandes brillantes des punaises de feu illuminent les alentours dans un rayon de 3 m (2 {s:c}). Après la mort de la punaise, ces glandes continuent de briller pendant 1d6 jours.}
</div>
</td><td><div>''Ce coléoptère de la taille d’un chat possède une carapace brun terne garnie
de deux taches luisantes de couleur vert-jaune.''

Les punaises de feu vivent la nuit mais elles ne voient pas dans le
noir : elles se servent de leurs glandes brillantes pour illuminer
leurs environs. Les mineurs et les individus les plus excentriques
utilisent souvent des punaises de feu enfermées dans une cage
comme source de lumière de longue durée.

#### Créature fiélonne

Les créatures qui possèdent cet archétype vivent dans les plans inférieurs comme les Abysses et l’Enfer mais elles peuvent être invoquées via des sorts tels qu’invocation de monstres et allié d’outreplan.
