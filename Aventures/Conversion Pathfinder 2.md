---
Name: Aventures.Conversion Pathfinder 2
Title: Conversion Pathfinder
LastModified: 2011-05-15 16:14
---

<div class="BD">
{s:BDTitre|Grayst Sevilla|FP ½}
- **XP** 200
- Humain (m) guerrier 4
...
<div class="BD">
{s:BDTitre|Garde de Pointesable|FP ½}
- **XP** 200
...
<div class="BD">
{s:BDTitre|Nuée de charognes|FP 1}
- **XP** 400 
...
<div class="BD">
{s:BDTitre|Iesha Ganrenard, Revenant|FP 6}
- **XP** 2.400 
...
<div class="BD">
{s:BDTitre|Nuée de rats malades|FP 2}
- **XP** 600 
...
<div class="BD">
{s:BDTitre|Chauve-souris goule|FP 5}
- **XP** 1.600 
...
<div class="BD">
{s:BDTitre|Aldern Ganrenard, l'Écorcheur|FP 6}
- **XP** 2.400 
...
<div class="BD">
{s:BDTitre|Traqueur sans visage (Ugothol)|FP 4}
- **XP** 1.200 
...
<div class="BD">
{s:BDTitre|Membre du culte des Écorcheurs|FP 2}
- **XP** 600 
...
- **Sorts préparés** (NLS 1)
  - 1 — *injonction* (DD 13), *déguisement*<sup>D</sup> (DD 13), *bouclier de la foi* (+2 CA)
...
- **Sorts préparés **(NLS 7, concentration +8)
  - 3 — *malédiction* (DD 15), *soins des blessures graves, suggestion*<sup>D</sup> (DD 15)
  - 2 — *alignement indétectable, endurance de l'ours, grâce du félin, invisibilité*<sup>D</sup>*, soin des blessures modérées*
  - *1 — bouclier de la foi, charme-personne*<sup>D</sup> (DD 13), *faveur divine, injonction* (DD 13), *soin des blessures légères*
