...
<div class="BD">
{s:BDTitre|Telrùnÿr Ellädan Valendil|FP 2}
- **XP 600**
...
{s:BDTexte|**Sorts préparés** (NLS 2<sup>e</sup>)}
{s:BDSorts|1 — *bouclier* (1), *arme magique* (1) (DD14)}
{s:BDSorts|0 — *cône, jet de flamme*(Mot de pouvoir), *jet de flamme*(Mot de pouvoir), *rayon de givre*, *destruction des morts-vivants* (DD 13)}
(((Caractéristiques)))'''
