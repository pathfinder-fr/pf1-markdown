---
Name: Aventures.Traqueur de géant
Title: Traqueur de géant
LastModified: 2013-09-28 11:14
Categories:
- PNJ
---
...
{s:BDTexte|**CA **17, contact 14, dépourvu 13 (armure +3, Dex +4)}
{s:BDTexte|**pv **38 (5d10+10)}
...
{s:BDTexte|**Avant le combat**. Throma approchera sa proie avec maintes précautions et choisira avec soin un endroit où il pourra atteindre sa cible à l'arc et où il pourra se cacher. Conscient du danger que peut représenter le jet des rochers, il choisira toujours en endroit pourvu d'abrits en dur. Contre un adversaire bien plus puissant que lui, il utilisera quelques huiles magiques sur ses flèches.}
{s:BDTexte|**Pendant le combat**. Tant qu'il est hors de portée de l'ennemi, Throma essaie d'affaiblir à distance son adversaire, en utilisant notamment son attaque handicapante. S'il se retrouve au corps à corps, il tentera de rompre le contact si l'affrontement ne tourne pas rapidement en sa faveur.}
{s:BDSousTitre|CARACTÉRISTIQUES}
{s:BDTexte|**For **12, **Dex **18, **Con **14, **Int **8, **Sag **14, **Cha **8}
{s:BDTexte|**BBA **+5 ; **BMO **+6 ; **DMD **25}
{s:BDTexte|**Dons **Arme de prédilection (arc long), Viser, Tir à bout portant, tir de loin, tir rapide, endurance}
{s:BDTexte|**Compétences **Acrobaties +9, Discrétion +12 (16 en montagne), Connaissances (nature) +7, Équitation +8, Escalade +7, Dressage +3, Linguistique +0, Natation +3, Perception +10, Survie +10 (+15 pour pister) }
